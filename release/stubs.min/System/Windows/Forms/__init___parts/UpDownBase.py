class UpDownBase:
 ...
 def DownButton(self):
  ...
  DownButton(self: UpDownBase)
   When overridden in a derived class,handles the clicking of the down button on the spin 
 ...
 def UpButton(self):
  ...
  UpButton(self: UpDownBase)
   When overridden in a derived class,handles the clicking of the up button on the spin box 
 ...
 def UpdateEditText(self,*args):
  ...
  UpdateEditText(self: UpDownBase)
   When overridden in a derived class,updates the text displayed in the spin box (also 
 ...
 def ValidateEditText(self,*args):
  ...
  ValidateEditText(self: UpDownBase)
   When overridden in a derived class,validates the text displayed in the spin box (also 
    known as an up-down control).
  """
  pass
