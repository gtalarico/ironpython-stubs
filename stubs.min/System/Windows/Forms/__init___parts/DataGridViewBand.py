...
"""
    ...
    DefaultHeaderCellType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HasDefaultCellStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
