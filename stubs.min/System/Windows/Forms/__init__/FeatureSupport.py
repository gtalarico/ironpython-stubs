class FeatureSupport(object, IFeatureSupport):
    ...
    def GetVersionPresent(*__args):
        ...
        GetVersionPresent(featureClassName: str, featureConstName: str) -> Version
            ...
            featureClassName: The fully qualified name of the class to query for information about the specified feature. This class must implement the System.Windows.Forms.IFeatureSupport interface or inherit from a class that 
    ...
    def IsPresent(*__args):
        ...
        IsPresent(self: FeatureSupport, feature: object, minimumVersion: Version) -> bool
            ...
            Returns: true if the feature is present and its version number is greater than or equal to the specified minimum version number; false if the feature is not installed or its version number is below the specified 
             minimum number.
