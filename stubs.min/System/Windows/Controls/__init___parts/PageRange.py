class PageRange(object):
 ...
 def Equals(self,*__args):
  ...
  Equals(self: PageRange,pageRange: PageRange) -> bool
   ...
   Returns: true if the two System.Windows.Controls.PageRange objects are equal; otherwise,
    false.
  ...
  Equals(self: PageRange,obj: object) -> bool
   ...
   Returns: true if the object is of type System.Windows.Controls.PageRange and is equal to 
    this System.Windows.Controls.PageRange; otherwise,false.
  """
  pass
 ...
 def ToString(self):
  ...
  ToString(self: PageRange) -> str
   ...
   Returns: A string that represents the range of pages in the format 
    "System.Windows.Controls.PageRange.PageFrom-System.Windows.Controls.PageRange.Pa
    geTo".
  """
  pass
