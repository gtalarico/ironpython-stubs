class PowerStatus(object):
    ...
    BatteryChargeStatus = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    BatteryFullLifetime = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    BatteryLifePercent = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    BatteryLifeRemaining = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    PowerLineStatus = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
