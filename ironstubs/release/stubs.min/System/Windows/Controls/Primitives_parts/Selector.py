class Selector(ItemsControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 ...
 def AddSelectedHandler(element,handler):
  ...
  AddSelectedHandler(element: DependencyObject,handler: RoutedEventHandler)
   Adds a handler for the System.Windows.Controls.Primitives.Selector.Selected 
    attached event.
 ...
 def AddUnselectedHandler(element,handler):
  ...
  AddUnselectedHandler(element: DependencyObject,handler: RoutedEventHandler)
   Adds a handler for the System.Windows.Controls.Primitives.Selector.Unselected 
    attached event.
 ...
 def ClearContainerForItemOverride(self,*args):
  ...
  ClearContainerForItemOverride(self: Selector,element: DependencyObject,item: object)
   Returns an item container to the state it was in before 
    ...
    ows.DependencyObject,System.Object).
 ...
 def GetIsSelected(element):
  ...
  GetIsSelected(element: DependencyObject) -> bool
   ...
   Gets the value of the System.Windows.Controls.Primitives.Selector.IsSelected�
    attached property that indicates whether an item is selected.
  
  
   element: Object to query concerning the 
    System.Windows.Controls.Primitives.Selector.IsSelected property.
  
   Returns: Boolean value,true if the 
    System.Windows.Controls.Primitives.Selector.IsSelected property is true.
  """
  pass
 @staticmethod
 ...
 def OnItemsChanged(self,*args):
  ...
  OnItemsChanged(self: Selector,e: NotifyCollectionChangedEventArgs)
   Updates the current selection when an item in the 
    System.Windows.Controls.Primitives.Selector has changed
 ...
 def OnSelectionChanged(self,*args):
  ...
  OnSelectionChanged(self: Selector,e: SelectionChangedEventArgs)
   ...
   e: The event data.
  OnSelectionChanged(self: ComboBox_21$22,e: SelectionChangedEventArgs)
  """
  pass
 ...
 def RemoveSelectedHandler(element,handler):
  ...
  RemoveSelectedHandler(element: DependencyObject,handler: RoutedEventHandler)
   Removes a handler for the System.Windows.Controls.Primitives.Selector.Selected 
    attached event.
 ...
 def RemoveUnselectedHandler(element,handler):
  ...
  RemoveUnselectedHandler(element: DependencyObject,handler: RoutedEventHandler)
   Removes a handler for the 
    System.Windows.Controls.Primitives.Selector.Unselected attached event.
