class UInt32(object, IComparable, IFormattable, IConvertible, IComparable[UInt32], IEquatable[UInt32]):
    ...
    def CompareTo(self, value):
        ...
        CompareTo(self: UInt32, value: UInt32) -> int
            ...
            Returns: A signed number indicating the relative values of this instance and value.Return value Description Less than zero This instance is less than value. Zero This instance is equal to value. Greater than zero 
    ...
    def TryParse(s, *__args):
        ...
        TryParse(s: str, style: NumberStyles, provider: IFormatProvider) -> (bool, UInt32)
            ...
            Tries to convert the string representation of a number in a specified style and culture-specific format to its 32-bit unsigned integer equivalent. A return value indicates whether the conversion succeeded 
             or failed.
