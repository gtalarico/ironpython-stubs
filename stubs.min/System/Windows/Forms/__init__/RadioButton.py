class RadioButton(ButtonBase, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent):
    ...
    def PerformClick(self):
        ...
        PerformClick(self: RadioButton)
            Generates a System.Windows.Forms.Control.Click event for the control, simulating a click by a user.
        """
        pass
    ...
    def ToString(self):
        ...
        ToString(self: RadioButton) -> str
            ...
            Returns: A string representation of the System.Windows.Forms.RadioButton that indicates whether it is checked.
        """
        pass
...
"""
    ...
    AutoCheck = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CheckAlign = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
