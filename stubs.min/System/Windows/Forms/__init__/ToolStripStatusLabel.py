...
"""
    ...
    BorderSides = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    Spring = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
