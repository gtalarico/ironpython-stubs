class DataGridViewRow(DataGridViewBand, ICloneable, IDisposable):
    ...
    def AdjustRowHeaderBorderStyle(self, dataGridViewAdvancedBorderStyleInput, dataGridViewAdvancedBorderStylePlaceholder, singleVerticalBorderAdded, singleHorizontalBorderAdded, isFirstDisplayedRow, isLastVisibleRow):
        ...
        AdjustRowHeaderBorderStyle(self: DataGridViewRow, dataGridViewAdvancedBorderStyleInput: DataGridViewAdvancedBorderStyle, dataGridViewAdvancedBorderStylePlaceholder: DataGridViewAdvancedBorderStyle, singleVerticalBorderAdded: bool, singleHorizontalBorderAdded: bool, isFirstDisplayedRow: bool, isLastVisibleRow: bool) -> DataGridViewAdvancedBorderStyle
            ...
            dataGridViewAdvancedBorderStyleInput: A System.Windows.Forms.DataGridViewAdvancedBorderStyle that represents the row header border style to modify.
            dataGridViewAdvancedBorderStylePlaceholder: A System.Windows.Forms.DataGridViewAdvancedBorderStyle that is used to store intermediate changes to the row header border style.
            ...
            isFirstDisplayedRow: true if the row is the first row displayed in the System.Windows.Forms.DataGridView; otherwise, false.
            isLastVisibleRow: true if the row is the last row in the System.Windows.Forms.DataGridView that has its System.Windows.Forms.DataGridViewRow.Visible property set to true; otherwise, false.
    ...
    def CreateAccessibilityInstance(self, *args): #cannot find CLR method
        ...
        CreateAccessibilityInstance(self: DataGridViewRow) -> AccessibleObject
            ...
            Returns: A new System.Windows.Forms.DataGridViewRow.DataGridViewRowAccessibleObject for the System.Windows.Forms.DataGridViewRow.
        """
        pass
    ...
    def DrawFocus(self, *args): #cannot find CLR method
        ...
        DrawFocus(self: DataGridViewRow, graphics: Graphics, clipBounds: Rectangle, bounds: Rectangle, rowIndex: int, rowState: DataGridViewElementStates, cellStyle: DataGridViewCellStyle, cellsPaintSelectionBackground: bool)
            ...
            bounds: A System.Drawing.Rectangle that contains the bounds of the System.Windows.Forms.DataGridViewRow that is being painted.
            rowIndex: The row index of the cell that is being painted.
            rowState: A bitwise combination of System.Windows.Forms.DataGridViewElementStates values that specifies the state of the row.
            cellStyle: The System.Windows.Forms.DataGridViewCellStyle used to paint the focus rectangle.
            cellsPaintSelectionBackground: true to use the System.Windows.Forms.DataGridViewCellStyle.SelectionBackColor property of cellStyle as the color of the focus rectangle; false to use the 
             System.Windows.Forms.DataGridViewCellStyle.BackColor property of cellStyle as the color of the focus rectangle.
        """
        pass
    ...
    def GetContextMenuStrip(self, rowIndex):
        ...
        GetContextMenuStrip(self: DataGridViewRow, rowIndex: int) -> ContextMenuStrip
            ...
            Returns: A System.Windows.Forms.ContextMenuStrip that belongs to the System.Windows.Forms.DataGridViewRow at the specified index.
        """
        pass
    ...
    def GetState(self, rowIndex):
        ...
        GetState(self: DataGridViewRow, rowIndex: int) -> DataGridViewElementStates
            ...
            Returns: A bitwise combination of System.Windows.Forms.DataGridViewElementStates values indicating the row state.
        """
        pass
    ...
    def Paint(self, *args): #cannot find CLR method
        ...
        Paint(self: DataGridViewRow, graphics: Graphics, clipBounds: Rectangle, rowBounds: Rectangle, rowIndex: int, rowState: DataGridViewElementStates, isFirstDisplayedRow: bool, isLastVisibleRow: bool)
            ...
            graphics: The System.Drawing.Graphics used to paint the System.Windows.Forms.DataGridViewRow.
            clipBounds: A System.Drawing.Rectangle that represents the area of the System.Windows.Forms.DataGridView that needs to be painted.
            rowBounds: A System.Drawing.Rectangle that contains the bounds of the System.Windows.Forms.DataGridViewRow that is being painted.
            rowIndex: The row index of the cell that is being painted.
            rowState: A bitwise combination of System.Windows.Forms.DataGridViewElementStates values that specifies the state of the row.
            isFirstDisplayedRow: true to indicate whether the current row is the first row displayed in the System.Windows.Forms.DataGridView; otherwise, false.
            isLastVisibleRow: true to indicate whether the current row is the last row in the System.Windows.Forms.DataGridView that has the System.Windows.Forms.DataGridViewRow.Visible property set to true; otherwise, false.
        """
        pass
    ...
    def PaintCells(self, *args): #cannot find CLR method
        ...
        PaintCells(self: DataGridViewRow, graphics: Graphics, clipBounds: Rectangle, rowBounds: Rectangle, rowIndex: int, rowState: DataGridViewElementStates, isFirstDisplayedRow: bool, isLastVisibleRow: bool, paintParts: DataGridViewPaintParts)
            ...
            isFirstDisplayedRow: true to indicate whether the current row is the first row displayed in the System.Windows.Forms.DataGridView; otherwise, false.
            isLastVisibleRow: true to indicate whether the current row is the last row in the System.Windows.Forms.DataGridView that has the System.Windows.Forms.DataGridViewRow.Visible property set to true; otherwise, false.
            paintParts: A bitwise combination of System.Windows.Forms.DataGridViewPaintParts values indicating the parts of the cells to paint.
        """
        pass
    ...
    def PaintHeader(self, *args): #cannot find CLR method
        ...
        PaintHeader(self: DataGridViewRow, graphics: Graphics, clipBounds: Rectangle, rowBounds: Rectangle, rowIndex: int, rowState: DataGridViewElementStates, isFirstDisplayedRow: bool, isLastVisibleRow: bool, paintParts: DataGridViewPaintParts)
            ...
            rowIndex: The row index of the cell that is being painted.
            rowState: A bitwise combination of System.Windows.Forms.DataGridViewElementStates values that specifies the state of the row.
            isFirstDisplayedRow: true to indicate that the current row is the first row displayed in the System.Windows.Forms.DataGridView; otherwise, false.
            isLastVisibleRow: true to indicate that the current row is the last row in the System.Windows.Forms.DataGridView that has the System.Windows.Forms.DataGridViewRow.Visible property set to true; otherwise, false.
            paintParts: A bitwise combination of System.Windows.Forms.DataGridViewPaintParts values indicating the parts of the cells to paint.
        """
        pass
    ...
    def SetValues(self, values):
        ...
        SetValues(self: DataGridViewRow, *values: Array[object]) -> bool
            ...
            values: One or more objects that represent the cell values in the row.-or-An System.Array of System.Object values.
...
"""
    ...
    DataBoundItem = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    Displayed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DividerHeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsNewRow = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
