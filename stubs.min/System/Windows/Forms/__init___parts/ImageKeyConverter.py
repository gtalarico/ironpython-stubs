class ImageKeyConverter(StringConverter):
    ...
    def GetStandardValues(self, context=None):
        ...
        GetStandardValues(self: ImageKeyConverter, context: ITypeDescriptorContext) -> StandardValuesCollection
            ...
            Returns: A System.ComponentModel.TypeConverter.StandardValuesCollection that contains the standard set of image key values.
        """
        pass
    ...
    def GetStandardValuesExclusive(self, context=None):
        ...
        GetStandardValuesExclusive(self: ImageKeyConverter, context: ITypeDescriptorContext) -> bool
            ...
            Determines whether the list of standard values for the System.Windows.Forms.ImageKeyConverter is exclusive (that is, whether it allows values other than those returned by 
            ...
            Returns: true to indicate the list does not allow additional values; otherwise, false. Always returns true.
        """
        pass
