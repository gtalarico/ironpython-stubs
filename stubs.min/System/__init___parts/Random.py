class Random(object):
    ...
    def Next(self, *__args):
        ...
        Next(self: Random, maxValue: int) -> int
            ...
            Returns: A 32-bit signed integer greater than or equal to zero, and less than maxValue; that is, the range of return values ordinarily includes zero but not maxValue. However, if maxValue equals zero, maxValue is 
             returned.
