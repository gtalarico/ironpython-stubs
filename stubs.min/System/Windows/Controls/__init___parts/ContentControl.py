class ContentControl(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def ShouldSerializeContent(self):
  ...
  ShouldSerializeContent(self: ContentControl) -> bool
   ...
   Returns: true if the System.Windows.Controls.ContentControl.Content property should be 
    persisted; otherwise,false.
  
  ShouldSerializeContent(self: Window_16$17) -> bool
  ShouldSerializeContent(self: Label_17$18) -> bool
  ShouldSerializeContent(self: Button_19$20) -> bool
  ShouldSerializeContent(self: CheckBox_20$21) -> bool
  """
  pass
