class SizeAnimation(SizeAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: SizeAnimation) -> SizeAnimation
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.SizeAnimation, making deep copies of this object's values. When copying dependency properties, this method copies resource references and 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: SizeAnimation, defaultOriginValue: Size, defaultDestinationValue: Size, animationClock: AnimationClock) -> Size
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.SizeAnimation.
