class BooleanKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: BooleanKeyFrameCollection,keyFrame: BooleanKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.BooleanKeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.BooleanKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: BooleanKeyFrameCollection)
   Removes all System.Windows.Media.Animation.BooleanKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: BooleanKeyFrameCollection) -> BooleanKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.BooleanKeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: BooleanKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.BooleanKeyFrameCollection. When copying 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: BooleanKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.BooleanKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: BooleanKeyFrameCollection,array: Array[BooleanKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.BooleanKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: BooleanKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.BooleanKeyFrameCollection 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: BooleanKeyFrameCollection,sourceFreezable: Freezable)
   ...
   sourceFreezable: The System.Windows.Media.Animation.BooleanKeyFrameCollection object to clone 
    and freeze.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: BooleanKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.BooleanKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: BooleanKeyFrameCollection,keyFrame: BooleanKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.BooleanKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: BooleanKeyFrameCollection,index: int,keyFrame: BooleanKeyFrame)
   Inserts a System.Windows.Media.Animation.BooleanKeyFrame into a specific 
    location within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.BooleanKeyFrame 
    is inserted.
  
   keyFrame: The System.Windows.Media.Animation.BooleanKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: BooleanKeyFrameCollection,keyFrame: BooleanKeyFrame)
   Removes a System.Windows.Media.Animation.BooleanKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.BooleanKeyFrame to remove from 
    the collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: BooleanKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.BooleanKeyFrame at the specified 
    index position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.BooleanKeyFrame to be 
    removed.
  """
  pass
