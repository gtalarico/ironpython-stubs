class AnimationTimeline(Timeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: AnimationTimeline) -> AnimationTimeline
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.AnimationTimeline, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
    ...
    def CreateClock(self, hasControllableRoot=None):
        ...
        CreateClock(self: AnimationTimeline) -> AnimationClock
            ...
            Creates a new System.Windows.Media.Animation.AnimationClock from this System.Windows.Media.Animation.AnimationTimeline.
    ...
    def GetCurrentValue(self, defaultOriginValue, defaultDestinationValue, animationClock):
        ...
        GetCurrentValue(self: AnimationTimeline, defaultOriginValue: object, defaultDestinationValue: object, animationClock: AnimationClock) -> object
            ...
            defaultOriginValue: The origin value provided to the animation if the animation does not have its own start value. If this animation is the first in a composition chain it will be the base value of the property being 
    ...
    IsDestinationDefault = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
