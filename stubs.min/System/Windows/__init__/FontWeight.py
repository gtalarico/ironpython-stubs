class FontWeight(object, IFormattable):
    ...
    def Compare(left, right):
        ...
        Compare(left: FontWeight, right: FontWeight) -> int
            ...
            Returns: An System.Int32 value that indicates the relationship between the two instances of System.Windows.FontWeight. When the return value is less than zero, left is less than right. When this value is zero, it 
             indicates that both operands are equal. When the value is greater than zero, it indicates that left is greater than right.
        """
        pass
    ...
    def FromOpenTypeWeight(weightValue):
        ...
        FromOpenTypeWeight(weightValue: int) -> FontWeight
            ...
            weightValue: An integer value between 1 and 999 that corresponds to the usWeightClass definition in the OpenType specification.
    ...
    def ToOpenTypeWeight(self):
        ...
        ToOpenTypeWeight(self: FontWeight) -> int
            ...
            Returns: An integer value between 1 and 999 that corresponds to the usWeightClass definition in the OpenType specification.
        """
        pass
    ...
    def ToString(self):
        ...
        ToString(self: FontWeight) -> str
            ...
            Returns: A System.String that represents the value of the System.Windows.FontWeight object, such as "Light", "Normal", or "UltraBold".
        """
        pass
