class CustomPopupPlacement(object):
    ...
    def Equals(self, o):
        ...
        Equals(self: CustomPopupPlacement, o: object) -> bool
            ...
            Compares this structure with another System.Windows.Controls.Primitives.CustomPopupPlacement structure to determine whether they are equal.
...
"""
    ...
    PrimaryAxis = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
