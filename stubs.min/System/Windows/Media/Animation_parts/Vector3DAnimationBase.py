class Vector3DAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: Vector3DAnimationBase) -> Vector3DAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Vector3DAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource 
