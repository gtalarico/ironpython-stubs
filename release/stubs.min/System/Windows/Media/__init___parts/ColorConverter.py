class ColorConverter(TypeConverter):
 ...
 def CanConvertFrom(self,*__args):
  ...
  CanConvertFrom(self: ColorConverter,td: ITypeDescriptorContext,t: Type) -> bool
   ...
   Returns: true if the type can be converted to a System.Windows.Media.Color; otherwise,
    false.
  """
  pass
 def CanConvertTo(self,*__args):
  ...
  CanConvertTo(self: ColorConverter,context: ITypeDescriptorContext,destinationType: Type) -> bool
   ...
   destinationType: The desired type this System.Windows.Media.Color is being evaluated for 
    conversion.
  
   Returns: true if this System.Windows.Media.Color can be converted to destinationType; 
    otherwise,false.
  """
  pass
