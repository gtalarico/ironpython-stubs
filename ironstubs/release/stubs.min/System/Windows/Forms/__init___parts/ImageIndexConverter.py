class ImageIndexConverter(Int32Converter):
 ...
 def GetStandardValues(self,context=None):
  ...
  GetStandardValues(self: ImageIndexConverter,context: ITypeDescriptorContext) -> StandardValuesCollection
   ...
   Returns a collection of standard index values for the image list associated 
    with the specified format context.
   ...
   Returns: A System.ComponentModel.TypeConverter.StandardValuesCollection that holds a 
    standard set of valid index values. If no image list is found,this collection 
    will contain a single object with a value of -1.
  """
  pass
 def GetStandardValuesExclusive(self,context=None):
  ...
  GetStandardValuesExclusive(self: ImageIndexConverter,context: ITypeDescriptorContext) -> bool
   ...
   Determines if the list of standard values returned from the 
    erload:System.Windows.Forms.ImageIndexConverter.GetStandardValues method is an 
    exclusive list.
  
  
   context: A formatter context.
   Returns: true if the erload:System.Windows.Forms.ImageIndexConverter.GetStandardValues 
    method returns an exclusive list of valid values; otherwise,false. This 
 ...
 def GetStandardValuesSupported(self,context=None):
  ...
  GetStandardValuesSupported(self: ImageIndexConverter,context: ITypeDescriptorContext) -> bool
   ...
   Determines if the type converter supports a standard set of values that can be 
    picked from a list.
   ...
   Returns: true if the erload:System.Windows.Forms.ImageIndexConverter.GetStandardValues 
    method returns a standard set of values; otherwise,false. Always returns true.
  """
  pass
