 ...
 def OnSplitterMoved(self,*args):
  ...
  OnSplitterMoved(self: Splitter,sevent: SplitterEventArgs)
   Raises the System.Windows.Forms.Splitter.SplitterMoved event. 
    System.Windows.Forms.Splitter.OnSplitterMoved(System.Windows.Forms.SplitterEvent
    Args) has been replaced by 
    System.Windows.Forms.SplitContainer.OnSplitterMoved(System.Windows.Forms.Splitte
    rEventArgs) and is provided only for compatibility with previous versions.
 ...
 def OnSplitterMoving(self,*args):
  ...
  OnSplitterMoving(self: Splitter,sevent: SplitterEventArgs)
   Raises the System.Windows.Forms.Splitter.SplitterMoving event. 
    System.Windows.Forms.Splitter.OnSplitterMoving(System.Windows.Forms.SplitterEven
    tArgs) has been replaced by 
    System.Windows.Forms.SplitContainer.OnSplitterMoving(System.Windows.Forms.Splitt
    erCancelEventArgs) and is provided only for compatibility with previous 
    versions.
