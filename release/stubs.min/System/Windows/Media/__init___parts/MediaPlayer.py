class MediaPlayer(Animatable,ISealable,IAnimatable,IResource):
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: MediaPlayer,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.MediaPlayer. When copying dependency properties,this 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: MediaPlayer,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.MediaPlayer using current property values. Resource 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: MediaPlayer,sourceFreezable: Freezable)
   Makes this instance a clone of the specified System.Windows.Media.MediaPlayer 
    object.
 ...
 def WritePreamble(self,*args):
  ...
  WritePreamble(self: MediaPlayer)
   Verifies that the MediaPlayer is not frozen and that it is being accessed from 
    a valid threading context.
