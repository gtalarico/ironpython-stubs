class DataGridRowHeader(ButtonBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ICommandSource):
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: DataGridRowHeader,availableSize: Size) -> Size
   ...
   Measures the children of a System.Windows.Controls.Primitives.DataGridRowHeader 
    to prepare for arranging them during the 
    System.Windows.Controls.Control.ArrangeOverride(System.Windows.Size) pass.
  
  
   availableSize: The available size that this element can give to child elements. Indicates an 
    upper limit that child elements should not exceed.
  
   Returns: The size that the System.Windows.Controls.Primitives.DataGridRowHeader 
    determines it needs during layout,based on its calculations of child object 
    allocated sizes.
  """
  pass
 ...
 def OnClick(self,*args):
  ...
  OnClick(self: DataGridRowHeader)
   Raises the System.Windows.Controls.Primitives.ButtonBase.Click event and 
    initiates row selection or drag operations.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: DataGridRowHeader) -> AutomationPeer
   ...
   Returns a new System.Windows.Automation.Peers.DataGridRowHeaderAutomationPeer 
    for this row header.
