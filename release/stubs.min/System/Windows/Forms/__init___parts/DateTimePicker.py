class DateTimePicker:
 ...
 def ToString(self):
  ...
  ToString(self: DateTimePicker) -> str
   ...
   Returns: A string that represents the current System.Windows.Forms.DateTimePicker. The string 
    includes the type and the System.Windows.Forms.DateTimePicker.Value property of the 
    control.
  """
  pass
