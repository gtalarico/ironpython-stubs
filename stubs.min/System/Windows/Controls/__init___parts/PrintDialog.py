class PrintDialog(object):
    ...
    def PrintDocument(self, documentPaginator, description):
        ...
        PrintDocument(self: PrintDialog, documentPaginator: DocumentPaginator, description: str)
            Prints a System.Windows.Documents.DocumentPaginator object to the System.Printing.PrintQueue that is currently selected.
        
            documentPaginator: The System.Windows.Documents.DocumentPaginator object to print.
            description: A description of the job that is to be printed. This text appears in the user interface (UI) of the printer.
        """
        pass
    ...
    def PrintVisual(self, visual, description):
        ...
        PrintVisual(self: PrintDialog, visual: Visual, description: str)
            Prints a visual (non-text) object, which is derived from the System.Windows.Media.Visual class, to the System.Printing.PrintQueue that is currently selected.
    ...
    def ShowDialog(self):
        ...
        ShowDialog(self: PrintDialog) -> Nullable[bool]
            ...
            Returns: true if a user clicks Print; false if a user clicks Cancel; or null if a user closes the dialog box without clicking Print or Cancel.
        """
        pass

    CurrentPageEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: CurrentPageEnabled(self: PrintDialog) -> bool

Set: CurrentPageEnabled(self: PrintDialog) = value
"""

    MaxPage = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MinPage = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    PageRangeSelection = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    PrintableAreaHeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    PrintableAreaWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    PrintQueue = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectedPagesEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: SelectedPagesEnabled(self: PrintDialog) -> bool

Set: SelectedPagesEnabled(self: PrintDialog) = value
"""

    UserPageRangeEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
