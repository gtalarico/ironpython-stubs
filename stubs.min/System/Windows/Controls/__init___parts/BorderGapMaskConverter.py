class BorderGapMaskConverter(object, IMultiValueConverter):
    ...
    def Convert(self, values, targetType, parameter, culture):
        ...
        Convert(self: BorderGapMaskConverter, values: Array[object], targetType: Type, parameter: object, culture: CultureInfo) -> object
            ...
            Creates a System.Windows.Media.VisualBrush that draws the border for a System.Windows.Controls.GroupBox control.
        
            values: An array of three numbers that represent the System.Windows.Controls.GroupBox control parameters.  See Remarks for more information.
            targetType: This parameter is not used.
            parameter: The width of the visible line to the left of the System.Windows.Controls.HeaderedContentControl.Header in the System.Windows.Controls.GroupBox.
            culture: This parameter is not used.
            Returns: A System.Windows.Media.VisualBrush that draws the border around a System.Windows.Controls.GroupBox control that includes a gap for the System.Windows.Controls.HeaderedContentControl.Header content.
        """
        pass
