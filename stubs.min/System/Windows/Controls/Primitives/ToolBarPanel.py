class ToolBarPanel(StackPanel, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IScrollInfo, IStackMeasure):
    ...
    def ArrangeOverride(self, *args): #cannot find CLR method
        ...
        ArrangeOverride(self: ToolBarPanel, arrangeSize: Size) -> Size
            ...
            Arranges and sizes System.Windows.Controls.ToolBar items inside a System.Windows.Controls.Primitives.ToolBarPanel.
        
            arrangeSize: The size that the System.Windows.Controls.Primitives.ToolBarPanel assumes to position its children.
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: ToolBarPanel, constraint: Size) -> Size
            ...
            constraint: The measurement constraints; a System.Windows.Controls.Primitives.ToolBarPanel cannot return a size larger than the constraint.
