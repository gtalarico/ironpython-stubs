...
"""
    ...
    DragIndicator = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DropLocationIndicator = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
