class DataGridTextBox(TextBox,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def ProcessKeyMessage(self,*args):
  ...
  ProcessKeyMessage(self: DataGridTextBox,m: Message) -> (bool,Message)
   ...
   Indicates whether the key pressed is processed further (for example,to 
    navigate,or escape). This property is read-only.
 ...
 def SetDataGrid(self,parentGrid):
  ...
  SetDataGrid(self: DataGridTextBox,parentGrid: DataGrid)
   Sets the System.Windows.Forms.DataGrid to which this 
    System.Windows.Forms.TextBox control belongs.
 ...
 def WndProc(self,*args):
  ...
  WndProc(self: DataGridTextBox,m: Message) -> Message
   ...
   Raises the System.Windows.Forms.Control.WndProc(System.Windows.Forms.Message@) 
    event.
