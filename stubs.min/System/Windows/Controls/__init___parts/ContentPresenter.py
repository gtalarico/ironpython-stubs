class ContentPresenter(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient):
    ...
    def ArrangeOverride(self, *args): #cannot find CLR method
        ...
        ArrangeOverride(self: ContentPresenter, arrangeSize: Size) -> Size
            ...
            Positions the single child element and determines the content of a System.Windows.Controls.ContentPresenter object.
        
            arrangeSize: The size that this System.Windows.Controls.ContentPresenter object should use to arrange its child element.
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: ContentPresenter, constraint: Size) -> Size
            ...
            Determines the size of the System.Windows.Controls.ContentPresenter object based on the sizing properties, margin, and requested size of the child content.
    ...
    def ShouldSerializeContentTemplateSelector(self):
        ...
        ShouldSerializeContentTemplateSelector(self: ContentPresenter) -> bool
            ...
            Returns a value that indicates whether serialization processes should serialize the effective value of the System.Windows.Controls.ContentPresenter.ContentTemplateSelector property on instances of this 
             class.
        
            Returns: true if the System.Windows.Controls.ContentPresenter.ContentTemplateSelector property value should be serialized; otherwise, false.
        """
        pass
...
"""
    ...
    RecognizesAccessKey = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
