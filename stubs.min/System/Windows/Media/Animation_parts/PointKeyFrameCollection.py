class PointKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: PointKeyFrameCollection,keyFrame: PointKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.PointKeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.PointKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: PointKeyFrameCollection)
   Removes all System.Windows.Media.Animation.PointKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: PointKeyFrameCollection) -> PointKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.PointKeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: PointKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.PointKeyFrameCollection. When copying dependency 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: PointKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.PointKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: PointKeyFrameCollection,array: Array[PointKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.PointKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: PointKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.PointKeyFrameCollection 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: PointKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.PointKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: PointKeyFrameCollection,keyFrame: PointKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.PointKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: PointKeyFrameCollection,index: int,keyFrame: PointKeyFrame)
   Inserts a System.Windows.Media.Animation.PointKeyFrame into a specific location 
    within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.PointKeyFrame is 
    inserted.
  
   keyFrame: The System.Windows.Media.Animation.PointKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: PointKeyFrameCollection,keyFrame: PointKeyFrame)
   Removes a System.Windows.Media.Animation.PointKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.PointKeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: PointKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.PointKeyFrame at the specified index 
    position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.PointKeyFrame to be 
    removed.
  """
  pass
