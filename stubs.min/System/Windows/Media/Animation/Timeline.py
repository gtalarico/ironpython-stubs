class Timeline(Animatable, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: Timeline) -> Timeline
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Timeline, making deep copies of this object's values.
    ...
    def CloneCurrentValue(self):
        ...
        CloneCurrentValue(self: Timeline) -> Timeline
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Timeline object, making deep copies of this object's current values.
            Returns: A modifiable clone of the current object. The cloned object's System.Windows.Freezable.IsFrozen property is false even if the source's System.Windows.Freezable.IsFrozen property is true.
        """
        pass
    ...
    def CreateClock(self, hasControllableRoot=None):
        ...
        CreateClock(self: Timeline, hasControllableRoot: bool) -> Clock
            ...
            Creates a new System.Windows.Media.Animation.Clock from this System.Windows.Media.Animation.Timeline and specifies whether the new System.Windows.Media.Animation.Clock is controllable. If this 
             System.Windows.Media.Animation.Timeline has children, a tree of clocks is created with this System.Windows.Media.Animation.Timeline as the root.
        
        
            hasControllableRoot: true if the root System.Windows.Media.Animation.Clock returned should return a System.Windows.Media.Animation.ClockController from its System.Windows.Media.Animation.Clock.Controller property so that the 
             System.Windows.Media.Animation.Clock tree can be interactively controlled; otherwise, false.
        
            Returns: A new System.Windows.Media.Animation.Clock constructed from this System.Windows.Media.Animation.Timeline. If this System.Windows.Media.Animation.Timeline is a System.Windows.Media.Animation.TimelineGroup 
             that contains child timelines, a tree of System.Windows.Media.Animation.Clock objects is created with a controllable System.Windows.Media.Animation.Clock created from this 
             System.Windows.Media.Animation.Timeline as the root.
        
        CreateClock(self: Timeline) -> Clock
        
            Creates a new, controllable System.Windows.Media.Animation.Clock from this System.Windows.Media.Animation.Timeline. If this System.Windows.Media.Animation.Timeline has children, a tree of clocks is created 
             with this System.Windows.Media.Animation.Timeline as the root.
        
            Returns: A new, controllable System.Windows.Media.Animation.Clock constructed from this System.Windows.Media.Animation.Timeline. If this System.Windows.Media.Animation.Timeline is a 
             System.Windows.Media.Animation.TimelineGroup that contains child timelines, a tree of System.Windows.Media.Animation.Clock objects is created with a controllable System.Windows.Media.Animation.Clock 
             created from this System.Windows.Media.Animation.Timeline as the root.
        """
        pass
    ...
    def GetNaturalDurationCore(self, *args): #cannot find CLR method
        ...
        GetNaturalDurationCore(self: Timeline, clock: Clock) -> Duration
            ...
            Returns the length of a single iteration of this System.Windows.Media.Animation.Timeline. This method provides the implementation for 
    ...
    AccelerationRatio = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AutoReverse = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    BeginTime = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DecelerationRatio = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    FillBehavior = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RepeatBehavior = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
