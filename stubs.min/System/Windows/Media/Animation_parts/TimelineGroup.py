class TimelineGroup(Timeline, ISealable, IAnimatable, IResource, IAddChild):
    ...
    def Clone(self):
        ...
        Clone(self: TimelineGroup) -> TimelineGroup
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.TimelineGroup, making deep copies of this object's values. When copying dependency properties, this method copies resource references and 
    ...
    def CloneCurrentValue(self):
        ...
        CloneCurrentValue(self: TimelineGroup) -> TimelineGroup
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.TimelineGroup object, making deep copies of this object's current values. Resource references, data bindings, and animations are not 
