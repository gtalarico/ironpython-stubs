class Canvas(Panel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: Canvas,arrangeSize: Size) -> Size
   ...
   arrangeSize: The size that this System.Windows.Controls.Canvas element should use to arrange 
    its child elements.
  
   Returns: A System.Windows.Size that represents the arranged size of this 
    System.Windows.Controls.Canvas element and its descendants.
  """
  pass
 ...
 def GetBottom(element):
  ...
  GetBottom(element: UIElement) -> float
   ...
   Returns the value of the System.Windows.Controls.Canvas.Bottom�attached 
    property for a given dependency object.
 ...
 def GetLeft(element):
  ...
  GetLeft(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.Canvas.Left�attached property for 
    a given dependency object.
 ...
 def GetRight(element):
  ...
  GetRight(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.Canvas.Right�attached property 
 ...
 def GetTop(element):
  ...
  GetTop(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.Canvas.Top�attached property for 
    a given dependency object.
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: Canvas,constraint: Size) -> Size
   ...
   Measures the child elements of a System.Windows.Controls.Canvas in anticipation 
    ...
    System.Windows.Controls.Canvas.ArrangeOverride(System.Windows.Size) pass.
  
  
   constraint: An upper limit System.Windows.Size that should not be exceeded.
   Returns: A System.Windows.Size that represents the size that is required to arrange 
    child content.
  """
  pass
 ...
 def SetBottom(element,length):
  ...
  SetBottom(element: UIElement,length: float)
   Sets the value of the System.Windows.Controls.Canvas.Bottom�attached property 
    for a given dependency object.
  
  
   element: The element to which the property value is written.
   length: Sets the System.Windows.Controls.Canvas.Bottom coordinate of the specified 
    element.
  """
  pass
 @staticmethod
 def SetLeft(element,length):
  ...
  SetLeft(element: UIElement,length: float)
   Sets the value of the System.Windows.Controls.Canvas.Left�attached property for 
    a given dependency object.
  
  
   element: The element to which the property value is written.
   length: Sets the System.Windows.Controls.Canvas.Left coordinate of the specified 
    element.
  """
  pass
 @staticmethod
 def SetRight(element,length):
  ...
  SetRight(element: UIElement,length: float)
   Sets the value of the System.Windows.Controls.Canvas.Right�attached property 
    for a given dependency object.
  
  
   element: The element to which the property value is written.
   length: Sets the System.Windows.Controls.Canvas.Right coordinate of the specified 
    element.
  """
  pass
 @staticmethod
 def SetTop(element,length):
  ...
  SetTop(element: UIElement,length: float)
   Sets the value of the System.Windows.Controls.Canvas.Top�attached property for 
    a given dependency object.
