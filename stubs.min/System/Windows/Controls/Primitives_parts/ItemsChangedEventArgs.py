...
"""
    ...
    ItemUICount = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    OldPosition = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
