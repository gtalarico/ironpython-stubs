...
"""
    ...
    ResolvedState = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
class GH_TimeLine(GH_DoubleBufferedPanel, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent):
    ...
    ActiveEntry = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SpanEnd = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: SpanEnd(self: GH_TimeSpan) -> DateTime

Set: SpanEnd(self: GH_TimeSpan) = value
"""

    SpanStart = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: SpanStart(self: GH_TimeSpan) -> DateTime

Set: SpanStart(self: GH_TimeSpan) = value
"""

    SpanText = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
