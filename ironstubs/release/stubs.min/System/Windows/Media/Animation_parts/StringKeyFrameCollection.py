class StringKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: StringKeyFrameCollection,keyFrame: StringKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.StringKeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.StringKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: StringKeyFrameCollection)
   Removes all System.Windows.Media.Animation.StringKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: StringKeyFrameCollection) -> StringKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.StringKeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: StringKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.StringKeyFrameCollection. When copying 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: StringKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.StringKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: StringKeyFrameCollection,array: Array[StringKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.StringKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: StringKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.StringKeyFrameCollection 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: StringKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.StringKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: StringKeyFrameCollection,keyFrame: StringKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.StringKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: StringKeyFrameCollection,index: int,keyFrame: StringKeyFrame)
   Inserts a System.Windows.Media.Animation.StringKeyFrame into a specific 
    location within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.StringKeyFrame 
    is inserted.
  
   keyFrame: The System.Windows.Media.Animation.StringKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: StringKeyFrameCollection,keyFrame: StringKeyFrame)
   Removes a System.Windows.Media.Animation.StringKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.StringKeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: StringKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.StringKeyFrame at the specified 
    index position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.StringKeyFrame to be 
    removed.
  """
  pass
