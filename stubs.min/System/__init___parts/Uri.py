class Uri(object, ISerializable):
    ...
    def CheckHostName(name):
        ...
        CheckHostName(name: str) -> UriHostNameType
            ...
            Returns: A System.UriHostNameType that indicates the type of the host name. If the type of the host name cannot be determined or if the host name is null or a zero-length string, this method returns 
    ...
    def Compare(uri1, uri2, partsToCompare, compareFormat, comparisonType):
        ...
        Compare(uri1: Uri, uri2: Uri, partsToCompare: UriComponents, compareFormat: UriFormat, comparisonType: StringComparison) -> int
            ...
            Returns: An System.Int32 value that indicates the lexical relationship between the compared System.Uri components.ValueMeaningLess than zerouri1 is less than uri2.Zerouri1 equals uri2.Greater than zerouri1 is 
             greater than uri2.
        """
        pass
    ...
    def HexUnescape(pattern, index):
        ...
        HexUnescape(pattern: str, index: int) -> (Char, int)
            ...
            Returns: The character represented by the hexadecimal encoding at position index. If the character at index is not hexadecimal encoded, the character at index is returned. The value of index is incremented to point 
             to the character following the one returned.
        """
        pass
    ...
    def MakeRelative(self, toUri):
        ...
        MakeRelative(self: Uri, toUri: Uri) -> str
            ...
            Returns: If the hostname and scheme of this URI instance and toUri are the same, then this method returns a System.String that represents a relative URI that, when appended to the current URI instance, yields the 
             toUri parameter.If the hostname or scheme is different, then this method returns a System.String that represents the toUri parameter.
        """
        pass
    ...
    def MakeRelativeUri(self, uri):
        ...
        MakeRelativeUri(self: Uri, uri: Uri) -> Uri
            ...
            Returns: If the hostname and scheme of this URI instance and uri are the same, then this method returns a relative System.Uri that, when appended to the current URI instance, yields uri.If the hostname or scheme is 
             different, then this method returns a System.Uri  that represents the uri parameter.
        """
        pass
