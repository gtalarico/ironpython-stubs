class Popup(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def GetUIParentCore(self,*args):
  ...
  GetUIParentCore(self: Popup) -> DependencyObject
   ...
   Returns: If the System.Windows.Controls.Primitives.Popup does not have a defined parent 
    and the System.Windows.Controls.Primitives.Popup.PlacementTarget is not null,
    the System.Windows.Controls.Primitives.Popup.PlacementTarget is returned. 
    Otherwise,the return values are the same as 
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: Popup,availableSize: Size) -> Size
   ...
   Determines the required size of the System.Windows.Controls.Primitives.Popup 
    content within the visual tree of the logical parent.
  
  
   availableSize: The available size that this element can give to the child. You can use 
    infinity as a value to indicate that the element can size to whatever content 
    is available.
 ...
 def OnClosed(self,*args):
  ...
  OnClosed(self: Popup,e: EventArgs)
   Responds when the value of the System.Windows.Controls.Primitives.Popup.IsOpen 
    property changes from to true to false.
 ...
 def OnOpened(self,*args):
  ...
  OnOpened(self: Popup,e: EventArgs)
   Responds to the condition in which the value of the 
    System.Windows.Controls.Primitives.Popup.IsOpen property changes from false to 
    true.
 ...
 def OnPreviewMouseLeftButtonDown(self,*args):
  ...
  OnPreviewMouseLeftButtonDown(self: Popup,e: MouseButtonEventArgs)
   Provides class handling for the 
    System.Windows.UIElement.PreviewMouseLeftButtonDown event.
 ...
 def OnPreviewMouseLeftButtonUp(self,*args):
  ...
  OnPreviewMouseLeftButtonUp(self: Popup,e: MouseButtonEventArgs)
   Provides class handling for the 
    System.Windows.UIElement.PreviewMouseLeftButtonUp event.
 ...
 def OnPreviewMouseRightButtonDown(self,*args):
  ...
  OnPreviewMouseRightButtonDown(self: Popup,e: MouseButtonEventArgs)
   Provides class handling for the 
    System.Windows.UIElement.PreviewMouseRightButtonUp event.
 ...
 def OnPreviewMouseRightButtonUp(self,*args):
  ...
  OnPreviewMouseRightButtonUp(self: Popup,e: MouseButtonEventArgs)
   Provides class handling for the 
    System.Windows.UIElement.PreviewMouseRightButtonDown event.
