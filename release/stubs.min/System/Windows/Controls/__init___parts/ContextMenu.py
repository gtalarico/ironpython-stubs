class ContextMenu(MenuBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: ContextMenu) -> AutomationPeer
   ...
   Creates and returns a System.Windows.Automation.Peers.ContextMenuAutomationPeer 
    object for this System.Windows.Controls.ContextMenu.
 ...
 def OnKeyDown(self,*args):
  ...
  OnKeyDown(self: ContextMenu,e: KeyEventArgs)
   Called when a System.Windows.ContentElement.KeyDown event is raised by an 
    object inside the System.Windows.Controls.ContextMenu.
