class PixelFormat(object,IEquatable[PixelFormat]):
 ...
 def Equals(self,*__args):
  ...
  Equals(self: PixelFormat,pixelFormat: PixelFormat) -> bool
   ...
   Determines whether the pixel format equals the given 
  ...
  Equals(left: PixelFormat,right: PixelFormat) -> bool
   ...
   Determines whether the specified System.Windows.Media.PixelFormat instances are 
    considered equal.
 ...
 def GetHashCode(self):
  ...
  GetHashCode(self: PixelFormat) -> int
   ...
   Creates a hash code from this pixel format's 
    System.Windows.Media.PixelFormat.Masks value.
 ...
 def ToString(self):
  ...
  ToString(self: PixelFormat) -> str
   ...
   Returns: A System.String containing a representation of the 
    System.Windows.Media.PixelFormat.
  """
  pass
...
"""
 ...
 Masks=property(lambda self: object(),lambda self,v: None,lambda self: None)
