class NotifyIcon(Component, IComponent, IDisposable):
    ...
    BalloonTipIcon = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    BalloonTipText = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    BalloonTipTitle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
