class VectorAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: VectorAnimationBase) -> VectorAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.VectorAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
