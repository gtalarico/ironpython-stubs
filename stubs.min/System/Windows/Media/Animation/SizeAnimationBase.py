class SizeAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: SizeAnimationBase) -> SizeAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.SizeAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
