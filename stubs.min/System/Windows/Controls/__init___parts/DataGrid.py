class DataGrid(MultiSelector, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IGeneratorHost, IContainItemStorage):
    ...
    def BeginEdit(self, editingEventArgs=None):
        ...
        BeginEdit(self: DataGrid, editingEventArgs: RoutedEventArgs) -> bool
            ...
            Invokes the System.Windows.Controls.DataGrid.BeginEdit command, which will place the current cell or row into edit mode.
    ...
    def BeginUpdateSelectedItems(self, *args): #cannot find CLR method
        """
    ...
    def CancelEdit(self, editingUnit=None):
        ...
        CancelEdit(self: DataGrid, editingUnit: DataGridEditingUnit) -> bool
            ...
            Invokes the System.Windows.Controls.DataGrid.CancelEditCommand command for the specified cell or row in edit mode.
        ...
        CancelEdit(self: DataGrid) -> bool
            ...
            Invokes the System.Windows.Controls.DataGrid.CancelEditCommand command for the cell or row currently in edit mode.
            Returns: true if the current cell or row exits edit mode, or if no cells or rows are in edit mode; otherwise, false.
        """
        pass

    def ClearContainerForItemOverride(self, *args): #cannot find CLR method
        """
    ...
    def ClearDetailsVisibilityForItem(self, item):
        ...
        ClearDetailsVisibilityForItem(self: DataGrid, item: object)
            Clears the System.Windows.Controls.DataGridRow.DetailsVisibility property for the System.Windows.Controls.DataGridRow that represents the specified data item.
        
            item: The data item in the row for which System.Windows.Controls.DataGridRow.DetailsVisibility is cleared.
        """
        pass
    ...
    def ColumnFromDisplayIndex(self, displayIndex):
        ...
        ColumnFromDisplayIndex(self: DataGrid, displayIndex: int) -> DataGridColumn
            ...
            Returns: The System.Windows.Controls.DataGridColumn at the specified System.Windows.Controls.DataGridColumn.DisplayIndex.
        """
        pass
    ...
    def CommitEdit(self, editingUnit=None, exitEditingMode=None):
        ...
        CommitEdit(self: DataGrid, editingUnit: DataGridEditingUnit, exitEditingMode: bool) -> bool
            ...
            Invokes the System.Windows.Controls.DataGrid.CommitEditCommand command for the specified cell or row currently in edit mode.
        ...
        CommitEdit(self: DataGrid) -> bool
            ...
            Invokes the System.Windows.Controls.DataGrid.CommitEditCommand command for the cell or row currently in edit mode.
            Returns: true if the current cell or row exits edit mode, or if no cells or rows are in edit mode; otherwise, false.
        """
        pass

    def EndUpdateSelectedItems(self, *args): #cannot find CLR method
        """
    ...
    def GetContainerForItemOverride(self, *args): #cannot find CLR method
        """
    ...
    def GetDetailsVisibilityForItem(self, item):
        ...
        GetDetailsVisibilityForItem(self: DataGrid, item: object) -> Visibility
            ...
            Gets the System.Windows.Controls.DataGridRow.DetailsVisibility property for the System.Windows.Controls.DataGridRow that represents the specified data item.
        
            item: The data item in the row for which System.Windows.Controls.DataGridRow.DetailsVisibility is returned.
    ...
    def IsItemItsOwnContainerOverride(self, *args): #cannot find CLR method
        """
    ...
    def OnAddingNewItem(self, *args): #cannot find CLR method
        """ OnAddingNewItem(self: DataGrid, e: AddingNewItemEventArgs) """
        pass

    def OnAlternationCountChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnAutoGeneratedColumns(self, *args): #cannot find CLR method
        """
    ...
    def OnAutoGeneratingColumn(self, *args): #cannot find CLR method
        """
    ...
    def OnBeginningEdit(self, *args): #cannot find CLR method
        """
    ...
    def OnCanExecuteBeginEdit(self, *args): #cannot find CLR method
        """
        OnCanExecuteBeginEdit(self: DataGrid, e: CanExecuteRoutedEventArgs)
            Provides handling for the System.Windows.Input.CommandBinding.CanExecute event associated with the System.Windows.Controls.DataGrid.BeginEditCommand command.
        
            e: The data for the event.
        """
        pass

    def OnCanExecuteCancelEdit(self, *args): #cannot find CLR method
        """
        OnCanExecuteCancelEdit(self: DataGrid, e: CanExecuteRoutedEventArgs)
            Provides handling for the System.Windows.Input.CommandBinding.CanExecute event associated with the System.Windows.Controls.DataGrid.CancelEditCommand command.
        
            e: The data for the event.
        """
        pass

    def OnCanExecuteCommitEdit(self, *args): #cannot find CLR method
        """
        OnCanExecuteCommitEdit(self: DataGrid, e: CanExecuteRoutedEventArgs)
            Provides handling for the System.Windows.Input.CommandBinding.CanExecute event associated with the System.Windows.Controls.DataGrid.CommitEditCommand command.
        
            e: The data for the event.
        """
        pass

    def OnCanExecuteCopy(self, *args): #cannot find CLR method
        """
        OnCanExecuteCopy(self: DataGrid, args: CanExecuteRoutedEventArgs)
            Provides handling for the System.Windows.Input.CommandBinding.CanExecute event associated with the System.Windows.Input.ApplicationCommands.Copy command.
        
            args: The data for the event.
        """
        pass

    def OnCanExecuteDelete(self, *args): #cannot find CLR method
        """
        OnCanExecuteDelete(self: DataGrid, e: CanExecuteRoutedEventArgs)
            Provides handling for the System.Windows.Input.CommandBinding.CanExecute event associated with the System.Windows.Controls.DataGrid.DeleteCommand command.
        
            e: The data for the event.
        """
        pass

    def OnCellEditEnding(self, *args): #cannot find CLR method
        """
    ...
    def OnColumnHeaderDragCompleted(self, *args): #cannot find CLR method
        """
    ...
    def OnColumnHeaderDragDelta(self, *args): #cannot find CLR method
        """
    ...
    def OnColumnHeaderDragStarted(self, *args): #cannot find CLR method
        """
    ...
    def OnColumnReordering(self, *args): #cannot find CLR method
        """
    ...
    def OnCopyingRowClipboardContent(self, *args): #cannot find CLR method
        """
    ...
    def OnDisplayMemberPathChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnExecutedBeginEdit(self, *args): #cannot find CLR method
        """
        OnExecutedBeginEdit(self: DataGrid, e: ExecutedRoutedEventArgs)
            Provides handling for the System.Windows.Input.CommandBinding.Executed event associated with the System.Windows.Controls.DataGrid.BeginEditCommand command.
        
            e: The data for the event.
        """
        pass

    def OnExecutedCancelEdit(self, *args): #cannot find CLR method
        """
        OnExecutedCancelEdit(self: DataGrid, e: ExecutedRoutedEventArgs)
            Provides handling for the System.Windows.Input.CommandBinding.Executed event associated with the System.Windows.Controls.DataGrid.CancelEditCommand command.
        
            e: The data for the event.
        """
        pass

    def OnExecutedCommitEdit(self, *args): #cannot find CLR method
        """
        OnExecutedCommitEdit(self: DataGrid, e: ExecutedRoutedEventArgs)
            Provides handling for the System.Windows.Input.CommandBinding.Executed event associated with the System.Windows.Controls.DataGrid.CommitEditCommand command.
        
            e: The data for the event.
        """
        pass

    def OnExecutedCopy(self, *args): #cannot find CLR method
        """
    ...
    def OnExecutedDelete(self, *args): #cannot find CLR method
        """
        OnExecutedDelete(self: DataGrid, e: ExecutedRoutedEventArgs)
            Provides handling for the System.Windows.Input.CommandBinding.Executed event associated with the System.Windows.Controls.DataGrid.DeleteCommand command.
    ...
    def OnGroupStyleSelectorChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnInitializingNewItem(self, *args): #cannot find CLR method
        """
    ...
    def OnItemBindingGroupChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnItemContainerStyleChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnItemContainerStyleSelectorChanged(self, *args): #cannot find CLR method
        """
        OnItemContainerStyleSelectorChanged(self: ItemsControl, oldItemContainerStyleSelector: StyleSelector, newItemContainerStyleSelector: StyleSelector)
            Invoked when the System.Windows.Controls.ItemsControl.ItemContainerStyleSelector property changes.
    ...
    def OnItemsPanelChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnItemsSourceChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnItemStringFormatChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnItemTemplateChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnItemTemplateSelectorChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnLoadingRow(self, *args): #cannot find CLR method
        """
    ...
    def OnLoadingRowDetails(self, *args): #cannot find CLR method
        """
    ...
    def OnMouseMove(self, *args): #cannot find CLR method
        ...
        OnMouseMove(self: DataGrid, e: MouseEventArgs)
            Updates the collection of items that are selected due to the user dragging the mouse in the System.Windows.Controls.DataGrid.
    ...
    def OnPreparingCellForEdit(self, *args): #cannot find CLR method
        """
    ...
    def OnRowDetailsVisibilityChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnRowEditEnding(self, *args): #cannot find CLR method
        """
    ...
    def OnSelectedCellsChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnUnloadingRow(self, *args): #cannot find CLR method
        """
    ...
    def OnUnloadingRowDetails(self, *args): #cannot find CLR method
        """
    ...
    def PrepareContainerForItemOverride(self, *args): #cannot find CLR method
        """
    ...
    def ScrollIntoView(self, item, column=None):
        ...
        ScrollIntoView(self: DataGrid, item: object, column: DataGridColumn)
            Scrolls the System.Windows.Controls.DataGrid vertically and horizontally to display a cell for the specified data item and column.
        
            item: The data item to bring into view.
            column: The column to bring into view.
        ScrollIntoView(self: DataGrid, item: object)
            Scrolls the System.Windows.Controls.DataGrid vertically to display the row for the specified data item.
    ...
    def SetDetailsVisibilityForItem(self, item, detailsVisibility):
        ...
        SetDetailsVisibilityForItem(self: DataGrid, item: object, detailsVisibility: Visibility)
            Sets the value of the System.Windows.Controls.DataGridRow.DetailsVisibility property for the System.Windows.Controls.DataGridRow that contains the specified object.
        
            item: The object in the row for which System.Windows.Controls.DataGridRow.DetailsVisibility is being set.
            detailsVisibility: The System.Windows.Visibility to set for the row that contains the item.
        """
        pass

    def ShouldApplyItemContainerStyle(self, *args): #cannot find CLR method
        """
        ShouldApplyItemContainerStyle(self: ItemsControl, container: DependencyObject, item: object) -> bool
        
            Returns a value that indicates whether to apply the style from the System.Windows.Controls.ItemsControl.ItemContainerStyle or System.Windows.Controls.ItemsControl.ItemContainerStyleSelector property to the 
    ...
    AlternatingRowBackground = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AreRowDetailsFrozen = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AutoGenerateColumns = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanSelectMultipleItems = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanUserAddRows = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanUserDeleteRows = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanUserReorderColumns = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanUserResizeColumns = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanUserResizeRows = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanUserSortColumns = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CellsPanelHorizontalOffset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CellStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ClipboardCopyMode = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeaderHeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeaderStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CurrentCell = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DragIndicatorStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DropLocationIndicatorStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    EnableColumnVirtualization = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    EnableRowVirtualization = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    FrozenColumnCount = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    GridLinesVisibility = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HeadersVisibility = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HorizontalGridLinesBrush = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HorizontalScrollBarVisibility = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsUpdatingSelectedItems = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MaxColumnWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MinColumnWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MinRowHeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    NewItemMargin = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: NewItemMargin(self: DataGrid) -> Thickness

"""

    NonFrozenColumnsViewportHorizontalOffset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowBackground = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowDetailsTemplate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowDetailsTemplateSelector = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowDetailsVisibilityMode = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowHeaderActualWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowHeaderStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowHeaderTemplate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowHeaderTemplateSelector = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowHeaderWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowStyleSelector = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowValidationErrorTemplate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowValidationRules = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectionUnit = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    VerticalGridLinesBrush = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    VerticalScrollBarVisibility = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
