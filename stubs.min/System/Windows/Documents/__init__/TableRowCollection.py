class TableRowCollection(object, IList[TableRow], ICollection[TableRow], IEnumerable[TableRow], IEnumerable, IList, ICollection):
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: TableRowCollection, array: Array[TableRow], index: int)
            Copies the contents of the collection and inserts them into a specified System.Windows.Documents.TableRow array of starting at a specified index position in the array.
        
            array: A one-dimensional System.Windows.Documents.TableRow array to which the collection contents will be copied.  This array must use zero-based indexing.
    ...
    def TrimToSize(self):
        ...
        TrimToSize(self: TableRowCollection)
            Optimizes memory consumption for the collection by setting the underlying collection System.Windows.Documents.TableRowCollection.Capacity equal to the System.Windows.Documents.TableRowCollection.Count of 
