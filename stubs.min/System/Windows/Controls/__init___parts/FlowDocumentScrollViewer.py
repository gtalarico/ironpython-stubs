class FlowDocumentScrollViewer(Control, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IServiceProvider, IJournalState):
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: FlowDocumentScrollViewer) -> AutomationPeer
            ...
            Creates and returns an System.Windows.Automation.Peers.AutomationPeer object for this System.Windows.Controls.FlowDocumentScrollViewer.
            Returns: An System.Windows.Automation.Peers.AutomationPeer object for this System.Windows.Controls.FlowDocumentScrollViewer.
        """
        pass
    ...
    def OnKeyDown(self, *args): #cannot find CLR method
        ...
        OnKeyDown(self: FlowDocumentScrollViewer, e: KeyEventArgs)
            ...
            e: A System.Windows.Input.KeyEventArgs object containing the arguments associated with the System.Windows.UIElement.KeyDown routed event.
        """
        pass
    ...
    def Print(self):
        ...
        Print(self: FlowDocumentScrollViewer)
            Invokes a standard Print dialog which can be used to print the contents of the System.Windows.Controls.FlowDocumentScrollViewer and configure printing preferences.
        """
        pass
...
"""
    ...
    IsSelectionEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsToolBarVisible = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
