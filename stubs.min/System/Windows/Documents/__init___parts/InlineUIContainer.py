class InlineUIContainer(Inline,IInputElement,IAnimatable,IFrameworkInputElement,ISupportInitialize,IQueryAmbient,IAddChild):
 """
 An inline-level flow content element which enables System.Windows.UIElement elements (i.e. a System.Windows.Controls.Button) to be embedded (hosted) in flow content.
 
 InlineUIContainer()
 InlineUIContainer(childUIElement: UIElement)
 InlineUIContainer(childUIElement: UIElement,insertionPosition: TextPointer)
 """
 ...
 def __init__(self,*args):
  ...
  pass
 @staticmethod
 def __new__(self,childUIElement=None,insertionPosition=None):
  """
  __new__(cls: type)
  __new__(cls: type,childUIElement: UIElement)
  __new__(cls: type,childUIElement: UIElement,insertionPosition: TextPointer)
  """
  pass
 Child=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.UIElement hosted by the System.Windows.Documents.InlineUIContainer.

Get: Child(self: InlineUIContainer) -> UIElement

Set: Child(self: InlineUIContainer)=value
"""
