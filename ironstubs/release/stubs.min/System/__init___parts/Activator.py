class Activator(object,_Activator):
 ...
 def CreateComInstanceFrom(assemblyName,typeName,hashValue=None,hashAlgorithm=None):
  ...
  CreateComInstanceFrom(assemblyName: str,typeName: str,hashValue: Array[Byte],hashAlgorithm: AssemblyHashAlgorithm) -> ObjectHandle
   ...
   Creates an instance of the COM object whose name is specified,using the named 
    assembly file and the default constructor.
  
  
   assemblyName: The name of a file that contains an assembly where the type named typeName is 
    sought.
 ...
 def CreateInstance(*__args):
  ...
  CreateInstance(assemblyName: str,typeName: str,ignoreCase: bool,bindingAttr: BindingFlags,binder: Binder,args: Array[object],culture: CultureInfo,activationAttributes: Array[object]) -> ObjectHandle
   ...
   assemblyName: The name of the assembly where the type named typeName is sought. If 
    assemblyName is null,the executing assembly is searched.
  
   typeName: The name of the preferred type.
   ignoreCase: true to specify that the search for typeName is not case-sensitive; false to 
    specify that the search is case-sensitive.
   ...
   binder: An object that uses bindingAttr and args to seek and identify the typeName 
    constructor. If binder is null,the default binder is used.
  
   args: An array of arguments that match in number,order,and type the parameters of 
   ...
   activationAttributes: An array of one or more attributes that can participate in activation. This is 
  ...
  CreateInstance(activationContext: ActivationContext) -> ObjectHandle
   ...
   Creates an instance of the type designated by the specified 
    System.ActivationContext object.
  ...
  CreateInstance(activationContext: ActivationContext,activationCustomData: Array[str]) -> ObjectHandle
   ...
   Creates an instance of the type that is designated by the specified 
    System.ActivationContext object and activated with the specified custom 
    activation data.
  ...
  CreateInstance(domain: AppDomain,assemblyName: str,typeName: str,ignoreCase: bool,bindingAttr: BindingFlags,binder: Binder,args: Array[object],culture: CultureInfo,activationAttributes: Array[object],securityAttributes: Evidence) -> ObjectHandle
   ...
   Creates an instance of the type whose name is specified in the specified remote 
    domain,using the named assembly and the constructor that best matches the 
  ...
  CreateInstance(type: Type,bindingAttr: BindingFlags,binder: Binder,args: Array[object],culture: CultureInfo) -> object
   ...
   type: The type of object to create.
   bindingAttr: A combination of zero or more bit flags that affect the search for the type 
    constructor. If bindingAttr is zero,a case-sensitive search for public 
    constructors is conducted.
  
   binder: An object that uses bindingAttr and args to seek and identify the type 
    constructor. If binder is null,the default binder is used.
   ...
   culture: Culture-specific information that governs the coercion of args to the formal 
    types declared for the type constructor. If culture is null,the 
    System.Globalization.CultureInfo for the current thread is used.
  ...
  CreateInstance(type: Type,nonPublic: bool) -> object
   ...
   type: The type of object to create.
   nonPublic: true if a public or nonpublic default constructor can match; false if only a 
    public default constructor can match.
 ...
 def CreateInstanceFrom(*__args):
  ...
  CreateInstanceFrom(domain: AppDomain,assemblyFile: str,typeName: str) -> ObjectHandle
   ...
   domain: The remote domain where the type named typeName is created.
   assemblyFile: The name of a file that contains an assembly where the type named typeName is 
    sought.
  ...
  CreateInstanceFrom(assemblyFile: str,typeName: str) -> ObjectHandle
   ...
   Creates an instance of the type whose name is specified,using the named 
    assembly file and default constructor.
 ...
 def GetObject(type,url,state=None):
  ...
  GetObject(type: Type,url: str,state: object) -> object
   ...
   Creates a proxy for the well-known object indicated by the specified type,URL,
    and channel data.
  ...
  GetObject(type: Type,url: str) -> object
   ...
   Creates a proxy for the well-known object indicated by the specified type and 
    URL.
