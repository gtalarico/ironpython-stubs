class ThicknessAnimation(ThicknessAnimationBase,ISealable,IAnimatable,IResource):
 ...
 def Clone(self):
  ...
  Clone(self: ThicknessAnimation) -> ThicknessAnimation
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.ThicknessAnimation,making deep copies of this 
 ...
 def GetNaturalDurationCore(self,*args):
  ...
  GetNaturalDurationCore(self: AnimationTimeline,clock: Clock) -> Duration
   ...
   clock: The clock that was created for this 
    System.Windows.Media.Animation.AnimationTimeline.
  
   Returns: The animation's natural duration. This method always returns a 
    System.Windows.Duration of 1 second.
  """
  pass
