class DragEventArgs(EventArgs):
    ...
    AllowedEffect = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    KeyState = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
