class ContentPresenter(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: ContentPresenter,arrangeSize: Size) -> Size
   ...
   arrangeSize: The size that this System.Windows.Controls.ContentPresenter object should use 
    to arrange its child element.
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: ContentPresenter,constraint: Size) -> Size
   ...
   Determines the size of the System.Windows.Controls.ContentPresenter object 
    based on the sizing properties,margin,and requested size of the child 
    content.
 ...
 def OnContentStringFormatChanged(self,*args):
  ...
  OnContentStringFormatChanged(self: ContentPresenter,oldContentStringFormat: str,newContentStringFormat: str)
   Invoked when the System.Windows.Controls.ContentPresenter.ContentStringFormat 
    property changes.
  
  
   oldContentStringFormat: The old value of the 
    System.Windows.Controls.ContentPresenter.ContentStringFormat property.
  
   newContentStringFormat: The new value of the 
    System.Windows.Controls.ContentPresenter.ContentStringFormat property.
  """
  pass
 def OnContentTemplateChanged(self,*args):
  ...
  OnContentTemplateChanged(self: ContentPresenter,oldContentTemplate: DataTemplate,newContentTemplate: DataTemplate)
   Invoked when the System.Windows.Controls.ContentPresenter.ContentTemplate 
    changes.
  
  
   oldContentTemplate: The old value of the System.Windows.Controls.ContentPresenter.ContentTemplate 
    property.
  
   newContentTemplate: The new value of the System.Windows.Controls.ContentPresenter.ContentTemplate 
    property.
  """
  pass
 def OnContentTemplateSelectorChanged(self,*args):
  ...
  OnContentTemplateSelectorChanged(self: ContentPresenter,oldContentTemplateSelector: DataTemplateSelector,newContentTemplateSelector: DataTemplateSelector)
   Invoked when the 
    System.Windows.Controls.ContentPresenter.ContentTemplateSelector property 
    changes.
 ...
 def ShouldSerializeContentTemplateSelector(self):
  ...
  ShouldSerializeContentTemplateSelector(self: ContentPresenter) -> bool
   ...
   Returns a value that indicates whether serialization processes should serialize 
    ...
    System.Windows.Controls.ContentPresenter.ContentTemplateSelector property on 
    instances of this class.
  
   Returns: true if the System.Windows.Controls.ContentPresenter.ContentTemplateSelector 
    property value should be serialized; otherwise,false.
  """
  pass
