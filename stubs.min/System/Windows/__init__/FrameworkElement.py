class FrameworkElement(UIElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient):
    ...
    def BeginStoryboard(self, storyboard, handoffBehavior=None, isControllable=None):
        ...
        BeginStoryboard(self: FrameworkElement, storyboard: Storyboard, handoffBehavior: HandoffBehavior, isControllable: bool)
            ...
            handoffBehavior: A value of the enumeration that describes behavior to use if a property described in the storyboard is already animated.
            isControllable: Declares whether the animation is controllable (can be paused) after it is started.
    ...
    def FindResource(self, resourceKey):
        ...
        FindResource(self: FrameworkElement, resourceKey: object) -> object
            ...
            Returns: The requested resource. If no resource with the provided key was found, an exception is thrown. An System.Windows.DependencyProperty.UnsetValue value might also be returned in the exception case.
        """
        pass
    ...
    def GetBindingExpression(self, dp):
        ...
        GetBindingExpression(self: FrameworkElement, dp: DependencyProperty) -> BindingExpression
            ...
            Returns: A System.Windows.Data.BindingExpression if the target property has an active binding; otherwise, returns null.
        """
        pass
    ...
    def GetFlowDirection(element):
        ...
        GetFlowDirection(element: DependencyObject) -> FlowDirection
            ...
            Gets the value of the System.Windows.FrameworkElement.FlowDirection�attached property for the specified System.Windows.DependencyObject.
    ...
    def MoveFocus(self, request):
        ...
        MoveFocus(self: FrameworkElement, request: TraversalRequest) -> bool
            ...
            Returns: Returns true if focus is moved successfully; false if the target element in direction as specified does not exist or could not be keyboard focused.
        """
        pass
    ...
    def PredictFocus(self, direction):
        ...
        PredictFocus(self: FrameworkElement, direction: FocusNavigationDirection) -> DependencyObject
            ...
            Returns: The next element that focus would move to if focus were actually traversed. May return null if focus cannot be moved relative to this element for the provided direction.
        """
        pass
    ...
    def SetBinding(self, dp, *__args):
        ...
        SetBinding(self: FrameworkElement, dp: DependencyProperty, path: str) -> BindingExpression
            ...
            Returns: Records the conditions of the binding. This return value can be useful for error checking.
    ...
    def SetFlowDirection(element, value):
        ...
        SetFlowDirection(element: DependencyObject, value: FlowDirection)
            Sets the value of the System.Windows.FrameworkElement.FlowDirection�attached property for the provided element.
    ...
    def ShouldSerializeResources(self):
        ...
        ShouldSerializeResources(self: FrameworkElement) -> bool
            ...
            Returns whether serialization processes should serialize the contents of the System.Windows.FrameworkElement.Resources property.
            Returns: true if the System.Windows.FrameworkElement.Resources property value should be serialized; otherwise, false.
        """
        pass
    ...
    def ShouldSerializeStyle(self):
        ...
        ShouldSerializeStyle(self: FrameworkElement) -> bool
            ...
            Returns whether serialization processes should serialize the contents of the System.Windows.FrameworkElement.Style property.
            Returns: true if the System.Windows.FrameworkElement.Style property value should be serialized; otherwise, false.
        """
        pass
    ...
    def ShouldSerializeTriggers(self):
        ...
        ShouldSerializeTriggers(self: FrameworkElement) -> bool
            ...
            Returns whether serialization processes should serialize the contents of the System.Windows.FrameworkElement.Triggers property.
            Returns: true if the System.Windows.FrameworkElement.Triggers property value should be serialized; otherwise, false.
        """
        pass
