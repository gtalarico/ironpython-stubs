class Animatable(Freezable,ISealable,IAnimatable,IResource):
 ...
 def ApplyAnimationClock(self,dp,clock,handoffBehavior=None):
  ...
  ApplyAnimationClock(self: Animatable,dp: DependencyProperty,clock: AnimationClock,handoffBehavior: HandoffBehavior)
   ...
   clock: The clock with which to animate the specified property. If handoffBehavior is 
    System.Windows.Media.Animation.HandoffBehavior.SnapshotAndReplace and clock is 
    null,all animations will be removed from the specified property (but not 
    stopped). If handoffBehavior is 
    System.Windows.Media.Animation.HandoffBehavior.Compose and clock is null,this 
    method has no effect.
  
   handoffBehavior: A value that specifies how the new animation should interact with any current 
  ...
  ApplyAnimationClock(self: Animatable,dp: DependencyProperty,clock: AnimationClock)
   ...
   dp: The property to animate.
   clock: The clock with which to animate the specified property. If clock is null,all 
    animations will be removed from the specified property (but not stopped).
  """
  pass
 def BeginAnimation(self,dp,animation,handoffBehavior=None):
  ...
  BeginAnimation(self: Animatable,dp: DependencyProperty,animation: AnimationTimeline,handoffBehavior: HandoffBehavior)
   Applies an animation to the specified System.Windows.DependencyProperty. The 
    animation is started when the next frame is rendered. If the specified property 
    is already animated,the specified 
   ...
   animation: The animation used to animate the specified property.If handoffBehavior is 
    ...
    current animations will be removed and the current value of the property will 
    be held. If handoffBehavior is 
    System.Windows.Media.Animation.HandoffBehavior.SnapshotAndReplace and animation 
    is a null reference,all animations will be removed from the property and the 
    property value will revert back to its base value.If handoffBehavior is 
    System.Windows.Media.Animation.HandoffBehavior.Compose,this method will have 
    no effect if the animation or its 
    System.Windows.Media.Animation.Timeline.BeginTime is null.
  ...
  BeginAnimation(self: Animatable,dp: DependencyProperty,animation: AnimationTimeline)
   ...
   animation: The animation used to animate the specified property.If the animation's 
    System.Windows.Media.Animation.Timeline.BeginTime is null,any current 
    animations will be removed and the current value of the property will be 
    held.If animation is null,all animations will be removed from the property and 
    the property value will revert back to its base value.
  """
  pass
 def Clone(self):
  """
 ...
 def GetAnimationBaseValue(self,dp):
  ...
  GetAnimationBaseValue(self: Animatable,dp: DependencyProperty) -> object
   ...
   Returns the non-animated value of the specified 
