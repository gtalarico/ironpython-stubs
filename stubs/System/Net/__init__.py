...
class CookieCollection(object, ICollection, IEnumerable):
    ...
    def GetEnumerator(self):
        ...
        GetEnumerator(self: CookieCollection) -> IEnumerator
            ...
            Returns: An instance of an implementation of an System.Collections.IEnumerator interface 
             that can iterate through a System.Net.CookieCollection.
        """
        pass
...
class CredentialCache(object, ICredentials, ICredentialsByHost, IEnumerable):
    ...
    def Add(self, *__args):
        ...
        Add(self: CredentialCache, host: str, port: int, authenticationType: str, credential: NetworkCredential)
            Adds a System.Net.NetworkCredential instance for use with SMTP to the 
             ...
             authentication protocol. Credentials added using this method are valid for SMTP 
             only. This method does not work for HTTP or FTP requests.
        ...
        Add(self: CredentialCache, uriPrefix: Uri, authType: str, cred: NetworkCredential)
            ...
            uriPrefix: A System.Uri that specifies the URI prefix of the resources that the credential 
             grants access to.
    ...
    def GetCredential(self, *__args):
        ...
        GetCredential(self: CredentialCache, host: str, port: int, authenticationType: str) -> NetworkCredential
            ...
            Returns the System.Net.NetworkCredential instance associated with the specified 
    ...
    def Union(self, target):
        ...
        Union(self: DnsPermission, target: IPermission) -> IPermission
            ...
            Returns: A System.Net.DnsPermission instance that represents the union of the current 
             ...
             returns a System.Net.DnsPermission instance that is unrestricted; otherwise, it 
             returns a System.Net.DnsPermission instance that is restricted.
        """
        pass
...
class SecurityProtocolType(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum (flags) SecurityProtocolType, values: Ssl3 (48), Tls (192), Tls11 (768), Tls12 (3072)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class ServicePointManager(object):
    ...
    def SetTcpKeepAlive(enabled, keepAliveTime, keepAliveInterval):
        ...
        SetTcpKeepAlive(enabled: bool, keepAliveTime: int, keepAliveInterval: int)
            ...
            keepAliveTime: Specifies the timeout, in milliseconds, with no activity until the first 
             keep-alive packet is sent.The value must be greater than 0.  If a value of less 
             than or equal to zero is passed an System.ArgumentOutOfRangeException is 
             thrown.
    ...
    def IsUnrestricted(self):
        ...
        IsUnrestricted(self: SocketPermission) -> bool
            ...
            Returns: true if the System.Net.SocketPermission instance is created with the 
             Unrestricted value from System.Security.Permissions.PermissionState; otherwise, 
             false.
        """
        pass
...
class WebPermission(CodeAccessPermission, IPermission, ISecurityEncodable, IStackWalk, IUnrestrictedPermission):
    ...
    def AddPermission(self, access, *__args):
        ...
        AddPermission(self: WebPermission, access: NetworkAccess, uriString: str)
            ...
            access: A System.Net.NetworkAccess that specifies the access rights that are granted to 
             the URI.
    ...
    def IsUnrestricted(self):
        ...
        IsUnrestricted(self: WebPermission) -> bool
            ...
            Returns: true if the System.Net.WebPermission was created with the 
             System.Security.Permissions.PermissionState.UnrestrictedSystem.Security.Permissi
             ons.PermissionState; otherwise, false.
        """
        pass
    ...
    def Union(self, target):
        ...
        Union(self: WebPermission, target: IPermission) -> IPermission
            ...
            Returns the logical union between two instances of the System.Net.WebPermission 
             class.
