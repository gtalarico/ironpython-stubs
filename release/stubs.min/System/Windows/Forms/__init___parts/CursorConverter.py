class CursorConverter:
 ...
 def GetStandardValues(self,context=None):
  ...
  GetStandardValues(self: CursorConverter,context: ITypeDescriptorContext) -> StandardValuesCollection
   ...
   Retrieves a collection containing a set of standard values for the data type this 
    validator is designed for. This will return null if the data type does not support a 
   ...
   Returns: A collection containing a standard set of valid values,or null. The default 
 ...
 def GetStandardValuesSupported(self,context=None):
  ...
  GetStandardValuesSupported(self: CursorConverter,context: ITypeDescriptorContext) -> bool
   ...
   Determines if this object supports a standard set of values that can be picked from a 
    list.
  
  
   context: A type descriptor through which additional context may be provided.
   Returns: Returns true if GetStandardValues should be called to find a common set of values the 
    object supports.
  """
  pass
