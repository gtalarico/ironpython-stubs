class Point3DAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: Point3DAnimationBase) -> Point3DAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Point3DAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: Point3DAnimationBase, defaultOriginValue: Point3D, defaultDestinationValue: Point3D, animationClock: AnimationClock) -> Point3D
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.Point3DAnimation.
