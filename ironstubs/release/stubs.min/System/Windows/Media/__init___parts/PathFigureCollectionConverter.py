class PathFigureCollectionConverter(TypeConverter):
 ...
 def CanConvertFrom(self,*__args):
  ...
  CanConvertFrom(self: PathFigureCollectionConverter,context: ITypeDescriptorContext,sourceType: Type) -> bool
   ...
   Indicates whether an object can be converted from a given type to an instance 
    of a System.Windows.Media.PathFigureCollection.
   ...
   Returns: true if object of the specified type can be converted to a 
    System.Windows.Media.PathFigureCollection; otherwise,false.
  """
  pass
 def CanConvertTo(self,*__args):
  ...
  CanConvertTo(self: PathFigureCollectionConverter,context: ITypeDescriptorContext,destinationType: Type) -> bool
   ...
   Determines whether instances of System.Windows.Media.PathFigureCollection can 
    be converted to the specified type.
  
  
   context: Describes the context information of a type.
   destinationType: The desired type this System.Windows.Media.PathFigureCollection is being 
    evaluated to be converted to.
  
   Returns: true if instances of System.Windows.Media.PathFigureCollection can be converted 
    to destinationType; otherwise,false.
  """
  pass
 ...
 def ConvertTo(self,*__args):
  ...
  ConvertTo(self: PathFigureCollectionConverter,context: ITypeDescriptorContext,culture: CultureInfo,value: object,destinationType: Type) -> object
   ...
   Converts the specified System.Windows.Media.PathFigureCollection to the 
    specified type.
