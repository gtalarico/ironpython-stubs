class EasingThicknessKeyFrame(ThicknessKeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames key frame animation.
 
 EasingThicknessKeyFrame()
 EasingThicknessKeyFrame(value: Thickness)
 EasingThicknessKeyFrame(value: Thickness,keyTime: KeyTime)
 EasingThicknessKeyFrame(value: Thickness,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingThicknessKeyFrame) -> Freezable
  
   Creates a new instance of the System.Windows.Freezable derived class. When 
    creating a derived class,you must override this method.
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingThicknessKeyFrame,baseValue: Thickness,keyFrameProgress: float) -> Thickness
  
   Interpolates,according to the easing function used,between the previous key 
    frame value and the value of the current key frame,using the supplied progress 
    increment.
  
  
   baseValue: The value to animate from.
   keyFrameProgress: A value between 0.0 and 1.0,inclusive,that specifies the percentage of time 
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  """
  __new__(cls: type)
  __new__(cls: type,value: Thickness)
  __new__(cls: type,value: Thickness,keyTime: KeyTime)
  __new__(cls: type,value: Thickness,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingThicknessKeyFrame) -> IEasingFunction

Set: EasingFunction(self: EasingThicknessKeyFrame)=value
"""
