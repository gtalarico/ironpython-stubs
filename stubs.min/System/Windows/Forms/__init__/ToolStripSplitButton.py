class ToolStripSplitButton(ToolStripDropDownItem, IComponent, IDisposable, IDropTarget, ISupportOleDropSource, IArrangedElement):
    ...
    def PerformButtonClick(self):
        ...
        PerformButtonClick(self: ToolStripSplitButton)
            If the System.Windows.Forms.ToolStripItem.Enabled property is true, calls the System.Windows.Forms.ToolStripSplitButton.OnButtonClick(System.EventArgs) method.
        """
        pass
...
"""
    ...
    ButtonBounds = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ButtonPressed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ButtonSelected = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DefaultItem = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DropDownButtonBounds = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DropDownButtonPressed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DropDownButtonSelected = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DropDownButtonWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SplitterBounds = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
