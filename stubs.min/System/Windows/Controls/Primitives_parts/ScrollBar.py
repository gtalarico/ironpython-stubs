class ScrollBar(RangeBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 ...
 def OnContextMenuClosing(self,*args):
  ...
  OnContextMenuClosing(self: ScrollBar,e: ContextMenuEventArgs)
   Provides class handling for the 
    System.Windows.FrameworkElement.ContextMenuClosing event that occurs when the 
    System.Windows.Controls.ContextMenu for a 
 ...
 def OnContextMenuOpening(self,*args):
  ...
  OnContextMenuOpening(self: ScrollBar,e: ContextMenuEventArgs)
   Provides class handling for the 
    System.Windows.FrameworkElement.ContextMenuOpening event that occurs when the 
    System.Windows.Controls.ContextMenu for a 
 ...
 def OnMaximumChanged(self,*args):
  ...
  OnMaximumChanged(self: RangeBase,oldMaximum: float,newMaximum: float)
   Called when the System.Windows.Controls.Primitives.RangeBase.Maximum property 
    changes.
 ...
 def OnMinimumChanged(self,*args):
  ...
  OnMinimumChanged(self: RangeBase,oldMinimum: float,newMinimum: float)
   Called when the System.Windows.Controls.Primitives.RangeBase.Minimum property 
    changes.
 ...
 def OnValueChanged(self,*args):
  ...
  OnValueChanged(self: RangeBase,oldValue: float,newValue: float)
   Raises the System.Windows.Controls.Primitives.RangeBase.ValueChanged routed 
    event.
