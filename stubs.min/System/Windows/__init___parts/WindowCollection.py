class WindowCollection(object, ICollection, IEnumerable):
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: WindowCollection, array: Array[Window], index: int)
            Copies each System.Windows.Window object in the collection to an array, starting from the specified index.
        
            array: An array of type System.Windows.Window that the System.Windows.Window objects in the collection are copied to.
    ...
    def GetEnumerator(self):
        ...
        GetEnumerator(self: WindowCollection) -> IEnumerator
            ...
            Returns an System.Collections.IEnumerator that you can use to enumerate the System.Windows.Window objects in the collection.
            Returns: An System.Collections.IEnumerator that you can use to enumerate the System.Windows.Window objects in the collection.
        """
        pass
