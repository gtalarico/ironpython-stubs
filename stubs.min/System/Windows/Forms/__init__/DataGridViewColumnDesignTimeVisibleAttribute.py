class DataGridViewColumnDesignTimeVisibleAttribute(Attribute, _Attribute):
    ...
    def Equals(self, obj):
        ...
        Equals(self: DataGridViewColumnDesignTimeVisibleAttribute, obj: object) -> bool
            ...
            Returns: true to indicate that the specified object is a System.Windows.Forms.DataGridViewColumnDesignTimeVisibleAttribute instance with the same 
             System.Windows.Forms.DataGridViewColumnDesignTimeVisibleAttribute.Visible property value as this instance; otherwise, false.
        """
        pass
