class ToolBar(HeaderedItemsControl, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IGeneratorHost, IContainItemStorage):
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: ToolBar, constraint: Size) -> Size
            ...
            constraint: The measurement constraints. A System.Windows.Controls.ToolBar cannot return a size larger than the constraint.
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: ToolBar) -> AutomationPeer
            ...
            Provides an appropriate System.Windows.Automation.Peers.ToolBarAutomationPeer implementation for this control, as part of the WPF infrastructure.
    ...
    def OnItemsChanged(self, *args): #cannot find CLR method
        ...
        OnItemsChanged(self: ToolBar, e: NotifyCollectionChangedEventArgs)
            ...
            e: The arguments for the System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged event.
        """
        pass
    ...
    def OnKeyDown(self, *args): #cannot find CLR method
        ...
        OnKeyDown(self: ToolBar, e: KeyEventArgs)
            Provides class handling for the System.Windows.UIElement.KeyDown routed event that occurs when a key is pressed on an item in the System.Windows.Controls.ToolBar.
    ...
    def OnLostMouseCapture(self, *args): #cannot find CLR method
        ...
        OnLostMouseCapture(self: ToolBar, e: MouseEventArgs)
            Provides class handling for the System.Windows.UIElement.LostMouseCapture routed event that occurs when the System.Windows.Controls.ToolBar loses mouse capture.
    ...
    Band = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    BandIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HasOverflowItems = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsOverflowOpen = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
