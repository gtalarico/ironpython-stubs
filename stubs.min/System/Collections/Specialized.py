...
# from System,Version=4.0.0.0,Culture=neutral,PublicKeyToken=b77a5c561934e089,WindowsBase,Version=4.0.0.0,Culture=neutral,PublicKeyToken=31bf3856ad364e35
# by generator 1.145
...
class CollectionChangedEventManager(WeakEventManager):
 """ Provides a System.Windows.WeakEventManager implementation so that you can use the "weak event listener" pattern to attach listeners for the System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged event. """
 @staticmethod
 def AddHandler(source,handler):
  """ AddHandler(source: INotifyCollectionChanged,handler: EventHandler[NotifyCollectionChangedEventArgs]) """
  pass
 @staticmethod
 def AddListener(source,listener):
  """
  AddListener(source: INotifyCollectionChanged,listener: IWeakEventListener)
   Adds the specified listener to the System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged event of the specified source.
 ...
 def RemoveHandler(source,handler):
  """ RemoveHandler(source: INotifyCollectionChanged,handler: EventHandler[NotifyCollectionChangedEventArgs]) """
  pass
 @staticmethod
 def RemoveListener(source,listener):
  """
  RemoveListener(source: INotifyCollectionChanged,listener: IWeakEventListener)
   Removes the specified listener from the System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged event of the specified source.
...
class HybridDictionary(object,IDictionary,ICollection,IEnumerable):
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: HybridDictionary,array: Array,index: int)
   ...
   array: The one-dimensional System.Array that is the destination of the System.Collections.DictionaryEntry objects copied from System.Collections.Specialized.HybridDictionary. The System.Array must have zero-based 
    indexing.
...
class ListDictionary(object,IDictionary,ICollection,IEnumerable):
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: ListDictionary,array: Array,index: int)
   ...
   array: The one-dimensional System.Array that is the destination of the System.Collections.DictionaryEntry objects copied from System.Collections.Specialized.ListDictionary. The System.Array must have zero-based 
    indexing.
...
class OrderedDictionary(object,IOrderedDictionary,IDictionary,ICollection,IEnumerable,ISerializable,IDeserializationCallback):
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: OrderedDictionary,array: Array,index: int)
   ...
   array: The one-dimensional System.Array object that is the destination of the System.Collections.DictionaryEntry objects copied from System.Collections.Specialized.OrderedDictionary collection. The System.Array 
