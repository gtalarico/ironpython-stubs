class AdornerDecorator(Decorator, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    """
    Provides an System.Windows.Documents.AdornerLayer for the child elements in the visual tree.
    ...
    def ArrangeOverride(self, *args): #cannot find CLR method
        """
        ArrangeOverride(self: AdornerDecorator, finalSize: Size) -> Size
        
            Positions child elements and determines a size for the System.Windows.Documents.AdornerDecorator.
    ...
    def GetVisualChild(self, *args): #cannot find CLR method
        """
        GetVisualChild(self: AdornerDecorator, index: int) -> Visual
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        """
        MeasureOverride(self: AdornerDecorator, constraint: Size) -> Size
        
            Measures the size required for child elements and determines a size for the System.Windows.Documents.AdornerDecorator.
        
            constraint: A size to constrain the System.Windows.Documents.AdornerDecorator to.
            Returns: A System.Windows.Size object representing the amount of layout space needed by the System.Windows.Documents.AdornerDecorator.
        """
        pass
    ...
    AdornerLayer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the System.Windows.Documents.AdornerLayer associated with this System.Windows.Documents.AdornerDecorator.

Get: AdornerLayer(self: AdornerDecorator) -> AdornerLayer

"""

    Child = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the single child of an System.Windows.Documents.AdornerDecorator.

Get: Child(self: AdornerDecorator) -> UIElement

Set: Child(self: AdornerDecorator) = value
"""
...
"""
    ...
    """Gets the number of child System.Windows.Media.Visual objects in this instance of System.Windows.Documents.AdornerDecorator.
