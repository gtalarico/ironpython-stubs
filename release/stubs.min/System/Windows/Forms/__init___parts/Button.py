class Button:
 ...
 def NotifyDefault(self,value):
  ...
  NotifyDefault(self: Button,value: bool)
   Notifies the System.Windows.Forms.Button whether it is the default button so that it can 
 ...
 def OnMouseUp(self,*args):
  ...
  OnMouseUp(self: Button,mevent: MouseEventArgs)
   Raises the System.Windows.Forms.ButtonBase.OnMouseUp(System.Windows.Forms.MouseEventArgs) 
    event.
