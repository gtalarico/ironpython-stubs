class Transform(GeneralTransform,ISealable,IAnimatable,IResource,IFormattable):
 ...
 def Clone(self):
  ...
  Clone(self: Transform) -> Transform
   ...
   Creates a modifiable copy of this System.Windows.Media.Transform by making deep 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: Transform) -> Transform
   ...
   Creates a modifiable clone of this System.Windows.Media.Transform object by 
 ...
 def Parse(source):
  ...
  Parse(source: str) -> Transform
   ...
   Creates a new System.Windows.Media.Transform from the specified string 
    representation of a transformation matrix.
  
  
   source: Six comma-delimited System.Double values that describe the new 
    System.Windows.Media.Transform. See also Remarks.
