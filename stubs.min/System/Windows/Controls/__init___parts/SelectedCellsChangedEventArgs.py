class SelectedCellsChangedEventArgs(EventArgs):
    ...
    AddedCells = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RemovedCells = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
