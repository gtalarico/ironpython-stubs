class TableAutomationPeer(TextElementAutomationPeer, IGridProvider):
    ...
    def GetAutomationControlTypeCore(self, *args): #cannot find CLR method
        ...
        GetAutomationControlTypeCore(self: TableAutomationPeer) -> AutomationControlType
            ...
            Gets the control type for the System.Windows.Documents.Table that is associated with this System.Windows.Automation.Peers.TableAutomationPeer. This method is called by 
             System.Windows.Automation.Peers.AutomationPeer.GetAutomationControlType.
        
            Returns: The System.Windows.Automation.Peers.AutomationControlType.Table enumeration value.
        """
        pass
    ...
    def GetClassNameCore(self, *args): #cannot find CLR method
        ...
        GetClassNameCore(self: TableAutomationPeer) -> str
            ...
            Gets the name of the System.Windows.Documents.Table that is associated with this System.Windows.Automation.Peers.TableAutomationPeer. This method is called by 
    ...
    def GetPattern(self, patternInterface):
        ...
        GetPattern(self: TableAutomationPeer, patternInterface: PatternInterface) -> object
            ...
            Gets the control pattern for the System.Windows.Documents.Table that is associated with this System.Windows.Automation.Peers.TableAutomationPeer.
        
            patternInterface: A value from the enumeration.
            Returns: If patternInterface is System.Windows.Automation.Peers.PatternInterface.Grid, this method returns a this pointer; otherwise, this method returns null.
        """
        pass
    ...
    def IsControlElementCore(self, *args): #cannot find CLR method
        ...
        IsControlElementCore(self: TableAutomationPeer) -> bool
            ...
            Gets or sets a value that indicates whether the System.Windows.Documents.Table that is associated with this System.Windows.Automation.Peers.TableAutomationPeer is understood by the end user as interactive 
             or as contributing to the logical structure of the control in the GUI. This method is called by System.Windows.Automation.Peers.AutomationPeer.IsControlElement.
