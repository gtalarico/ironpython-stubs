class ItemsPresenter(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: ItemsPresenter,arrangeSize: Size) -> Size
   ...
   Called to arrange and size the content of an 
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: ItemsPresenter,constraint: Size) -> Size
   ...
   Overrides the base class implementation of 
    System.Windows.FrameworkElement.MeasureOverride(System.Windows.Size) to measure 
    the size of the System.Windows.Controls.ItemsPresenter object and return proper 
    sizes to the layout engine.
  
  
   constraint: Constraint size is an "upper limit." The return value should not exceed this 
    size.
