class Inline(TextElement, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild):
    ...
    """Gets or sets the baseline alignment for the System.Windows.Documents.Inline element.

Get: BaselineAlignment(self: Inline) -> BaselineAlignment

Set: BaselineAlignment(self: Inline) = value
"""
...
"""
    ...
    """Gets or sets a value that specifies the relative direction for flow of content within a System.Windows.Documents.Inline element.

Get: FlowDirection(self: Inline) -> FlowDirection

Set: FlowDirection(self: Inline) = value
"""
...
"""
    ...
    NextInline = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the next System.Windows.Documents.Inline element that is a peer to this element.

Get: NextInline(self: Inline) -> Inline

"""

    PreviousInline = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the previous System.Windows.Documents.Inline element that is a peer to this element.

Get: PreviousInline(self: Inline) -> Inline

"""

    SiblingInlines = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets an System.Windows.Documents.InlineCollection that contains the System.Windows.Documents.Inline elements that are siblings (peers) to this element.

Get: SiblingInlines(self: Inline) -> InlineCollection

"""

    TextDecorations = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a System.Windows.TextDecorationCollection that contains text decorations to apply to this element.

Get: TextDecorations(self: Inline) -> TextDecorationCollection

Set: TextDecorations(self: Inline) = value
"""


    BaselineAlignmentProperty = None
