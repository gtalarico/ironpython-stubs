class Span(Inline, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild):
    """
    Groups other System.Windows.Documents.Inline flow content elements.
    
    Span()
    Span(childInline: Inline)
    Span(childInline: Inline, insertionPosition: TextPointer)
    Span(start: TextPointer, end: TextPointer)
    """
    ...
    def ShouldSerializeInlines(self, manager):
        """
        ShouldSerializeInlines(self: Span, manager: XamlDesignerSerializationManager) -> bool
        
            Returns a value that indicates whether the content of a System.Windows.Documents.Span element should be serialized during serialization of a System.Windows.Documents.Run object.
...
"""
    ...
    """Gets an System.Windows.Documents.InlineCollection containing the top-level System.Windows.Documents.Inline elements that comprise the contents of the System.Windows.Documents.Span.

Get: Inlines(self: Span) -> InlineCollection
