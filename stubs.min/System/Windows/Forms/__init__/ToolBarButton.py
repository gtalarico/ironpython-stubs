...
"""
    ...
    DropDownMenu = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    PartialPush = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
