class TreeViewImageKeyConverter(ImageKeyConverter):
    ...
    def ConvertTo(self, *__args):
        ...
        ConvertTo(self: TreeViewImageKeyConverter, context: ITypeDescriptorContext, culture: CultureInfo, value: object, destinationType: Type) -> object
            ...
            context: A System.ComponentModel.ITypeDescriptorContext that provides a format context, which can be used to extract additional information about the environment this type converter is being invoked from. This 
