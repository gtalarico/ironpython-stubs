class ViewBase(DependencyObject):
    ...
    def GetAutomationPeer(self, *args): #cannot find CLR method
        ...
        GetAutomationPeer(self: ViewBase, parent: ListView) -> IViewAutomationPeer
            ...
            Is called when a System.Windows.Controls.ListView control creates a System.Windows.Automation.Peers.ListViewAutomationPeer for its System.Windows.Controls.ListView.View.
        
            parent: The System.Windows.Controls.ListView control to use to create the System.Windows.Automation.Peers.ListViewAutomationPeer.
            Returns: The System.Windows.Automation.Peers.IViewAutomationPeer interface that implements the System.Windows.Automation.Peers.ListViewAutomationPeer for a custom System.Windows.Controls.ListView.View.
        """
        pass
