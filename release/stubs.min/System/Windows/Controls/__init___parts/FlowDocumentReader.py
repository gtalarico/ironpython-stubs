class FlowDocumentReader(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IJournalState):
 ...
 def CanGoToPage(self,pageNumber):
  ...
  CanGoToPage(self: FlowDocumentReader,pageNumber: int) -> bool
   ...
   Returns a value that indicates whether or the 
    System.Windows.Controls.FlowDocumentReader is able to jump to the specified 
    page number.
  
  
   pageNumber: A page number to check for as a valid jump target.
   Returns: true if the System.Windows.Controls.FlowDocumentReader is able to jump to the 
    specified page number; otherwise,false.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: FlowDocumentReader) -> AutomationPeer
   ...
   Creates and returns an System.Windows.Automation.Peers.AutomationPeer object 
    for this System.Windows.Controls.FlowDocumentReader.
 ...
 def OnIsKeyboardFocusWithinChanged(self,*args):
  ...
  OnIsKeyboardFocusWithinChanged(self: FlowDocumentReader,e: DependencyPropertyChangedEventArgs)
   ...
   e: A System.Windows.DependencyPropertyChangedEventArgs object containing the 
    arguments associated with the 
    System.Windows.UIElement.IsKeyboardFocusWithinChanged routed event.
  """
  pass
 ...
 def OnSwitchViewingModeCommand(self,*args):
  ...
  OnSwitchViewingModeCommand(self: FlowDocumentReader,viewingMode: FlowDocumentReaderViewingMode)
   Handles the 
    System.Windows.Controls.FlowDocumentReader.SwitchViewingMode(System.Windows.Cont
    rols.FlowDocumentReaderViewingMode) routed command.
  
  
   viewingMode: One of the System.Windows.Controls.FlowDocumentReaderViewingMode values that 
    specifies the viewing mode to switch to.
  """
  pass
 ...
 def SwitchViewingMode(self,viewingMode):
  ...
  SwitchViewingMode(self: FlowDocumentReader,viewingMode: FlowDocumentReaderViewingMode)
   Executes the 
    System.Windows.Controls.FlowDocumentReader.SwitchViewingModeCommand command.
  
  
   viewingMode: One of the System.Windows.Controls.FlowDocumentReaderViewingMode values that 
    specifies the desired viewing mode.
  """
  pass
 def SwitchViewingModeCore(self,*args):
  ...
  SwitchViewingModeCore(self: FlowDocumentReader,viewingMode: FlowDocumentReaderViewingMode)
   Handles the 
    System.Windows.Controls.FlowDocumentReader.SwitchViewingMode(System.Windows.Cont
    rols.FlowDocumentReaderViewingMode) command.
