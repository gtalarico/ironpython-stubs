class Section(Block,IInputElement,IAnimatable,IFrameworkInputElement,ISupportInitialize,IQueryAmbient,IAddChild):
 ...
 def ShouldSerializeBlocks(self,manager):
  ...
  ShouldSerializeBlocks(self: Section,manager: XamlDesignerSerializationManager) -> bool
   ...
   Returns: true if the System.Windows.Documents.Section.Blocks property should be 
...
"""
 ...
 HasTrailingParagraphBreakOnPaste=property(lambda self: object(),lambda self,v: None,lambda self: None)
