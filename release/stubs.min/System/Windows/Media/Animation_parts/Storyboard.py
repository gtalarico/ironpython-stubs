class Storyboard(ParallelTimeline,ISealable,IAnimatable,IResource,IAddChild):
 ...
 def AddChild(self,*args):
  ...
  AddChild(self: TimelineGroup,child: object)
   ...
   child: The object to be added as the child of this 
    System.Windows.Media.Animation.TimelineGroup. If this object is a 
    System.Windows.Media.Animation.Timeline it will be added to the 
    System.Windows.Media.Animation.TimelineGroup.Children collection; otherwise,an 
 ...
 def Begin(self,containingObject=None,*__args):
  ...
  Begin(self: Storyboard,containingObject: FrameworkContentElement,handoffBehavior: HandoffBehavior)
   Applies the animations associated with this 
    System.Windows.Media.Animation.Storyboard to their targets and initiates them,
    using the specified System.Windows.Media.Animation.HandoffBehavior.
  
  
   containingObject: An object contained within the same name scope as the targets of this 
    storyboard's animations. Animations without a 
    System.Windows.Media.Animation.Storyboard.TargetName are applied to 
    containingObject.
  
   handoffBehavior: The behavior the new animation should use to interact with any current 
    animations.
  ...
  Begin(self: Storyboard,containingObject: FrameworkElement,frameworkTemplate: FrameworkTemplate,handoffBehavior: HandoffBehavior,isControllable: bool)
   Applies the animations associated with this 
    System.Windows.Media.Animation.Storyboard to their targets within the specified 
    template and initiates them.
  
  
   containingObject: The object to which the specified frameworkTemplate has been applied. 
    Animations without a System.Windows.Media.Animation.Storyboard.TargetName are 
    applied to containingObject.
  ...
  Begin(self: Storyboard,containingObject: FrameworkContentElement,handoffBehavior: HandoffBehavior,isControllable: bool)
   ...
   containingObject: An object contained within the same name scope as the targets of this 
    storyboard's animations. Animations without a specified 
    System.Windows.Media.Animation.Storyboard.TargetName are applied to 
    containingObject.
 ...
 def Clone(self):
  ...
  Clone(self: Storyboard) -> Storyboard
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.Storyboard,
 ...
 def GetCurrentGlobalSpeed(self,containingObject=None):
  ...
  GetCurrentGlobalSpeed(self: Storyboard) -> float
   ...
   Retrieves the System.Windows.Media.Animation.Clock.CurrentGlobalSpeed of the 
    System.Windows.Media.Animation.Clock that was created for this 
  ...
  GetCurrentGlobalSpeed(self: Storyboard,containingObject: FrameworkContentElement) -> Nullable[float]
   ...
   containingObject: The object specified when the 
    System.Windows.Media.Animation.Storyboard.Begin(System.Windows.FrameworkContentE
    lement,System.Boolean) method was called. This object contains the 
    System.Windows.Media.Animation.Clock objects that were created for this 
    storyboard and its children.
  ...
  GetCurrentGlobalSpeed(self: Storyboard,containingObject: FrameworkElement) -> Nullable[float]
   ...
   containingObject: The object specified when the 
    ...
    System.Boolean) method was called. This object contains the 
    System.Windows.Media.Animation.Clock objects that were created for this 
    storyboard and its children.
 ...
 def GetCurrentIteration(self,containingObject=None):
  ...
  GetCurrentIteration(self: Storyboard) -> int
   ...
   Retrieves the System.Windows.Media.Animation.Clock.CurrentIteration of the 
    System.Windows.Media.Animation.Clock that was created for this 
    System.Windows.Media.Animation.Storyboard.
  
   Returns: This clock's current iteration within its current active period,or null if 
 ...
 def GetCurrentProgress(self,containingObject=None):
  ...
  GetCurrentProgress(self: Storyboard) -> float
   ...
   Retrieves the System.Windows.Media.Animation.Clock.CurrentProgress of the 
    System.Windows.Media.Animation.Clock that was created for this 
    System.Windows.Media.Animation.Storyboard.
  
   Returns: null if this clock is System.Windows.Media.Animation.ClockState.Stopped,or 0.0 
    if this clock is active and its System.Windows.Media.Animation.Clock.Timeline 
    has a System.Windows.Media.Animation.Timeline.Duration of 
    System.Windows.Duration.Forever; otherwise,a value between 0.0 and 1.0 that 
    indicates the current progress of this clock within its current iteration. A 
    value of 0.0 indicates no progress,and a value of 1.0 indicates that the clock 
    is at the end of its current iteration.
 ...
 def GetCurrentState(self,containingObject=None):
  ...
  GetCurrentState(self: Storyboard) -> ClockState
   ...
   Retrieves the System.Windows.Media.Animation.Clock.CurrentState of the 
    System.Windows.Media.Animation.Clock that was created for this 
    System.Windows.Media.Animation.Storyboard.
  
   Returns: The current state of the clock created for this storyboard: 
    System.Windows.Media.Animation.ClockState.Active,
    System.Windows.Media.Animation.ClockState.Filling,or 
 ...
 def GetCurrentTime(self,containingObject=None):
  ...
  GetCurrentTime(self: Storyboard) -> TimeSpan
   ...
   Retrieves the System.Windows.Media.Animation.Clock.CurrentTime of the 
    System.Windows.Media.Animation.Clock that was created for this 
    System.Windows.Media.Animation.Storyboard.
  
   Returns: null if this storyboard's clock is 
    System.Windows.Media.Animation.ClockState.Stopped; otherwise,the current time 
    of the storyboard's clock.
 ...
 def GetIsPaused(self,containingObject=None):
  ...
  GetIsPaused(self: Storyboard) -> bool
   ...
   Retrieves a value that indicates whether the 
    System.Windows.Media.Animation.Clock that was created for this 
    System.Windows.Media.Animation.Storyboard is paused.
  
   Returns: true if the System.Windows.Media.Animation.Clock created for this 
    System.Windows.Media.Animation.Storyboard is paused; otherwise,false.
 ...
 def GetTarget(element):
  ...
  GetTarget(element: DependencyObject) -> DependencyObject
   ...
   Retrieves the System.Windows.Media.Animation.Storyboard.Target value of the 
    specified System.Windows.Media.Animation.Timeline.
  
  
   element: The timeline from which to retrieve the 
 ...
 def GetTargetName(element):
  ...
  GetTargetName(element: DependencyObject) -> str
   ...
   Retrieves the System.Windows.Media.Animation.Storyboard.TargetName value of the 
    specified System.Windows.Media.Animation.Timeline.
 ...
 def GetTargetProperty(element):
  ...
  GetTargetProperty(element: DependencyObject) -> PropertyPath
   ...
   Retrieves the System.Windows.Media.Animation.Storyboard.TargetProperty value of 
    the specified System.Windows.Media.Animation.Timeline.
  
  
   element: The dependency object from which to get the 
 ...
 def Pause(self,containingObject=None):
  ...
  Pause(self: Storyboard)
   Pauses the System.Windows.Media.Animation.Clock that was created for this 
    System.Windows.Media.Animation.Storyboard.
  
  Pause(self: Storyboard,containingObject: FrameworkContentElement)
   Pauses the System.Windows.Media.Animation.Clock of the specified 
    System.Windows.FrameworkContentElement associated with this 
    System.Windows.Media.Animation.Storyboard.
  ...
  Pause(self: Storyboard,containingObject: FrameworkElement)
   Pauses the System.Windows.Media.Animation.Clock of the specified 
    System.Windows.FrameworkElement associated with this 
    System.Windows.Media.Animation.Storyboard.
 ...
 def Remove(self,containingObject=None):
  ...
  Remove(self: Storyboard)
   Removes the System.Windows.Media.Animation.Clock objects that were created for 
    this System.Windows.Media.Animation.Storyboard. Animations that belong to this 
    System.Windows.Media.Animation.Storyboard no longer affect the properties they 
    once animated,regardless of their 
    System.Windows.Media.Animation.Timeline.FillBehavior setting.
 ...
 def Resume(self,containingObject=None):
  ...
  Resume(self: Storyboard)
   Resumes the System.Windows.Media.Animation.Clock that was created for this 
    System.Windows.Media.Animation.Storyboard.
 ...
 def Seek(self,*__args):
  ...
  Seek(self: Storyboard,offset: TimeSpan,origin: TimeSeekOrigin)
   Seeks this System.Windows.Media.Animation.Storyboard to the specified position. 
    The System.Windows.Media.Animation.Storyboard performs the requested seek when 
    the next clock tick occurs.
  
  
   offset: A positive or negative value that describes the amount by which the timeline 
    should move forward or backward from the specified origin.
 ...
 def SeekAlignedToLastTick(self,*__args):
  ...
  SeekAlignedToLastTick(self: Storyboard,offset: TimeSpan,origin: TimeSeekOrigin)
   Seeks this System.Windows.Media.Animation.Storyboard to a new position 
 ...
 def SetSpeedRatio(self,*__args):
  ...
  SetSpeedRatio(self: Storyboard,speedRatio: float)
   Sets the interactive speed ratio for the System.Windows.Media.Animation.Clock 
    that was created for this System.Windows.Media.Animation.Storyboard.
  
  
   speedRatio: A finite value greater than zero that is the new interactive speed ratio of the 
    storyboard. This value is multiplied against the storyboard's 
    System.Windows.Media.Animation.Timeline.SpeedRatio value to determine the 
    storyboard's effective speed. This value does not overwrite the storyboard's 
    System.Windows.Media.Animation.Timeline.SpeedRatio property. For example,
    calling this method and specifying an interactive speed ratio of 3 on a 
    storyboard with a System.Windows.Media.Animation.Timeline.SpeedRatio of 0.5 
    gives the storyboard an effective speed of 1.5.
  
  SetSpeedRatio(self: Storyboard,containingObject: FrameworkContentElement,speedRatio: float)
   Sets the interactive speed ratio of the System.Windows.Media.Animation.Clock 
    that was created for this System.Windows.Media.Animation.Storyboard.
 ...
 def SetTarget(element,value):
  ...
  SetTarget(element: DependencyObject,value: DependencyObject)
   Makes the specified System.Windows.Media.Animation.Timeline target the 
    dependency object.
  
  
   element: The System.Windows.Media.Animation.Timeline that should target the specified 
    dependency object.
 ...
 def SetTargetName(element,name):
  ...
  SetTargetName(element: DependencyObject,name: str)
   Makes the specified System.Windows.Media.Animation.Timeline target the 
    dependency object with the specified name.
 ...
 def SetTargetProperty(element,path):
  ...
  SetTargetProperty(element: DependencyObject,path: PropertyPath)
   ...
   element: The System.Windows.Media.Animation.Timeline with which to associate the 
    specified dependency property.
 ...
 def SkipToFill(self,containingObject=None):
  ...
  SkipToFill(self: Storyboard)
   Advances the current time of this storyboard's 
    System.Windows.Media.Animation.Clock to the end of its active period.
 ...
 def Stop(self,containingObject=None):
  ...
  Stop(self: Storyboard)
   Stops the System.Windows.Media.Animation.Clock that was created for this 
    System.Windows.Media.Animation.Storyboard.
