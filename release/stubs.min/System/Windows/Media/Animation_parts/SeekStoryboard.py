 ...
 def ShouldSerializeOffset(self):
  ...
  ShouldSerializeOffset(self: SeekStoryboard) -> bool
   ...
   Returns a value that indicates whether the 
    System.Windows.Media.Animation.SeekStoryboard.Offset property of this 
    System.Windows.Media.Animation.SeekStoryboard should be serialized.
  
   Returns: true if the System.Windows.Media.Animation.SeekStoryboard.Offset property of 
    this System.Windows.Media.Animation.SeekStoryboard should be serialized; 
    otherwise,false.
  """
  pass
