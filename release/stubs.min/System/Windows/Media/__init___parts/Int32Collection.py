class Int32Collection(Freezable,ISealable,IFormattable,IList,ICollection,IEnumerable,IList[int],ICollection[int],IEnumerable[int]):
 ...
 def Clone(self):
  ...
  Clone(self: Int32Collection) -> Int32Collection
   ...
   Creates a modifiable clone of this System.Windows.Media.Int32Collection,making 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: Int32Collection) -> Int32Collection
   ...
   Creates a modifiable clone of this System.Windows.Media.Int32Collection object,
 ...
 def Contains(self,value):
  ...
  Contains(self: Int32Collection,value: int) -> bool
   ...
   Returns: true if the System.Int32 is found in the System.Windows.Media.Int32Collection; 
    otherwise,false.
  """
  pass
 ...
 def GetEnumerator(self):
  ...
  GetEnumerator(self: Int32Collection) -> Enumerator
   ...
   Returns an System.Windows.Media.Int32Collection.Enumerator that can iterate 
    through the collection.
  
   Returns: An System.Windows.Media.Int32Collection.Enumerator that can iterate through the 
    collection.
  """
  pass
 def IndexOf(self,value):
  ...
  IndexOf(self: Int32Collection,value: int) -> int
   ...
   Searches for the specified System.Int32 and returns the zero-based index of the 
 ...
 def Parse(source):
  ...
  Parse(source: str) -> Int32Collection
   ...
   Returns an instance of System.Windows.Media.Int32Collection created from a 
    specified string.
 ...
 def Remove(self,value):
  ...
  Remove(self: Int32Collection,value: int) -> bool
   ...
   Returns: true if value was removed from the System.Windows.Media.Int32Collection; 
    otherwise,false.
  """
  pass
 ...
 def ToString(self,provider=None):
  ...
  ToString(self: Int32Collection,provider: IFormatProvider) -> str
   ...
   Converts the current value of a System.Windows.Media.Int32Collection to a 
