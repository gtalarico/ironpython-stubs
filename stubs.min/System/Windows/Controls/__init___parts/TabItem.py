class TabItem(HeaderedContentControl, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def OnAccessKey(self, *args): #cannot find CLR method
        ...
        OnAccessKey(self: TabItem, e: AccessKeyEventArgs)
            Responds when an System.Windows.Controls.AccessText.AccessKey for a System.Windows.Controls.TabControl is called.
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: TabItem) -> AutomationPeer
            ...
            Provides an appropriate System.Windows.Automation.Peers.TabItemAutomationPeer implementation for this control, as part of the WPF automation infrastructure.
