class AlternationConverter(object, IValueConverter):
    ...
    def Convert(self, o, targetType, parameter, culture):
        ...
        Convert(self: AlternationConverter, o: object, targetType: Type, parameter: object, culture: CultureInfo) -> object
            ...
            o: The integer to use to find an object in the System.Windows.Controls.AlternationConverter.Values property.
            targetType: The type of the binding target property.
            parameter: The converter parameter to use.
            culture: The culture to use in the converter.
            Returns: The object that is in the position of o modulo the number of items in System.Windows.Controls.AlternationConverter.Values.
        """
        pass
