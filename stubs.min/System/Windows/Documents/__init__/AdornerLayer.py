class AdornerLayer(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient):
    """ Represents a surface for rendering adorners. """
    def Add(self, adorner):
        """
        Add(self: AdornerLayer, adorner: Adorner)
            Adds an adorner to the adorner layer.
        
            adorner: The adorner to add.
        """
        pass
    ...
    def AdornerHitTest(self, point):
        """
        AdornerHitTest(self: AdornerLayer, point: Point) -> AdornerHitTestResult
        
            Gets an System.Windows.Media.AdornerHitTestResult for a specified point.
        
            point: The point to hit test.
            Returns: An System.Windows.Media.AdornerHitTestResult for the specified point.
        """
        pass
    ...
    def ArrangeOverride(self, *args): #cannot find CLR method
        """
        ArrangeOverride(self: AdornerLayer, finalSize: Size) -> Size
        
            Positions child elements and determines a size for the System.Windows.Documents.AdornerLayer.
        
            finalSize: The size reserved for this element by its parent.
            Returns: The actual size needed by the element.  This return value is typically the same as the value passed to finalSize.
        """
        pass

    @staticmethod
    def GetAdornerLayer(visual):
        """
        GetAdornerLayer(visual: Visual) -> AdornerLayer
        
            Returns the first adorner layer in the visual tree above a specified System.Windows.Media.Visual.
        
            visual: The visual element for which to find an adorner layer.
            Returns: An adorner layer for the specified visual, or null if no adorner layer can be found.
        """
        pass

    def GetAdorners(self, element):
        """
        GetAdorners(self: AdornerLayer, element: UIElement) -> Array[Adorner]
        
            Returns an array of adorners that are bound to the specified System.Windows.UIElement.
        
            element: The System.Windows.UIElement to retrieve an array of adorners for.
            Returns: An array of adorners that decorate the specified System.Windows.UIElement, or null if there are no adorners bound to the specified element.
        """
        pass
    ...
    def GetVisualChild(self, *args): #cannot find CLR method
        """
        GetVisualChild(self: AdornerLayer, index: int) -> Visual
            ...
            Returns: A System.Windows.Media.Visual child of the parent System.Windows.Documents.AdornerLayer element.
        """
        pass
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        """
        MeasureOverride(self: AdornerLayer, constraint: Size) -> Size
        
            Measures the size required for child elements and determines a size for the System.Windows.Documents.AdornerLayer.
        
            constraint: Unused.
            Returns: This method always returns a System.Windows.Size of (0,0).
        """
        pass
    ...
    def Remove(self, adorner):
        """
        Remove(self: AdornerLayer, adorner: Adorner)
            Removes the specified System.Windows.Documents.Adorner from the adorner layer.
        
            adorner: The System.Windows.Documents.Adorner to remove.
        """
        pass
    ...
    def Update(self, element=None):
        """
        Update(self: AdornerLayer, element: UIElement)
            Updates the layout and redraws all of the adorners in the adorner layer that are bound to the specified System.Windows.UIElement.
        
            element: The System.Windows.UIElement associated with the adorners to update.
        Update(self: AdornerLayer)
...
"""
    ...
    """Gets an enumerator that can iterate the logical child elements of this System.Windows.Documents.AdornerLayer element.
...
"""
    ...
    """Gets the number of child System.Windows.Media.Visual objects in this instance of System.Windows.Documents.AdornerLayer.
