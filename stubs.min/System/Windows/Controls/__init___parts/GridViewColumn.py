class GridViewColumn(DependencyObject,INotifyPropertyChanged):
 ...
 def OnHeaderStringFormatChanged(self,*args):
  ...
  OnHeaderStringFormatChanged(self: GridViewColumn,oldHeaderStringFormat: str,newHeaderStringFormat: str)
   Occurs when the System.Windows.Controls.GridViewColumn.HeaderStringFormat 
    property changes.
  
  
   oldHeaderStringFormat: The old value of the System.Windows.Controls.GridViewColumn.HeaderStringFormat 
    property.
  
   newHeaderStringFormat: The new value of the System.Windows.Controls.GridViewColumn.HeaderStringFormat 
    property.
  """
  pass
 def OnPropertyChanged(self,*args):
  ...
  OnPropertyChanged(self: GridViewColumn,e: PropertyChangedEventArgs)
   Raises the 
    System.Windows.Controls.GridViewColumn.System#ComponentModel#INotifyPropertyChan
    ged#PropertyChanged event.
 ...
 def ToString(self):
  ...
  ToString(self: GridViewColumn) -> str
   ...
   Returns: A string that identifies the object as a System.Windows.Controls.GridViewColumn 
    object and displays the value of the 
    System.Windows.Controls.GridViewColumn.Header property.
  """
  pass
