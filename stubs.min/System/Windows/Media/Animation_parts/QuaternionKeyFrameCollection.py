class QuaternionKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: QuaternionKeyFrameCollection,keyFrame: QuaternionKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.QuaternionKeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.QuaternionKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: QuaternionKeyFrameCollection)
   Removes all System.Windows.Media.Animation.QuaternionKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: QuaternionKeyFrameCollection) -> QuaternionKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.QuaternionKeyFrameCollection,making deep copies 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: QuaternionKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.QuaternionKeyFrameCollection. When copying 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: QuaternionKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.QuaternionKeyFrameCollection using current 
 ...
 def Contains(self,keyFrame):
  ...
  Contains(self: QuaternionKeyFrameCollection,keyFrame: QuaternionKeyFrame) -> bool
   ...
   keyFrame: The System.Windows.Media.Animation.QuaternionKeyFrame to locate in the 
    collection.
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: QuaternionKeyFrameCollection,array: Array[QuaternionKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.QuaternionKeyFrame objects in 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: QuaternionKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of 
    System.Windows.Media.Animation.QuaternionKeyFrameCollection read-only or 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: QuaternionKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.QuaternionKeyFrameCollection. Resource 
    references,data bindings,and animations are not copied,but their current 
    values are.
  
  
   sourceFreezable: The System.Windows.Media.Animation.QuaternionKeyFrameCollection to copy and 
    freeze.
  """
  pass
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: QuaternionKeyFrameCollection,keyFrame: QuaternionKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.QuaternionKeyFrame 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: QuaternionKeyFrameCollection,index: int,keyFrame: QuaternionKeyFrame)
   Inserts a System.Windows.Media.Animation.QuaternionKeyFrame into a specific 
    location within the collection.
  
  
   index: The index position at which the 
    System.Windows.Media.Animation.QuaternionKeyFrame is inserted.
  
   keyFrame: The System.Windows.Media.Animation.QuaternionKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: QuaternionKeyFrameCollection,keyFrame: QuaternionKeyFrame)
   Removes a System.Windows.Media.Animation.QuaternionKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.QuaternionKeyFrame to remove from 
    the collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: QuaternionKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.QuaternionKeyFrame at the specified 
    index position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.QuaternionKeyFrame to be 
    removed.
  """
  pass
