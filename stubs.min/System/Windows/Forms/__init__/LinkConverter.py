class LinkConverter(TypeConverter):
    ...
    def CanConvertFrom(self, *__args):
        ...
        CanConvertFrom(self: LinkConverter, context: ITypeDescriptorContext, sourceType: Type) -> bool
            ...
            context: An System.ComponentModel.ITypeDescriptorContext providing contextual information about the object to be converted.
            sourceType: The type of the object to be converted.
            Returns: true if this System.Windows.Forms.LinkConverter can convert the specified object; otherwise, false.
        """
        pass
    ...
    def ConvertFrom(self, *__args):
        ...
        ConvertFrom(self: LinkConverter, context: ITypeDescriptorContext, culture: CultureInfo, value: object) -> object
            ...
            context: An System.ComponentModel.ITypeDescriptorContext providing contextual information about the object to be converted.
            culture: Cultural attributes of the object to be converted. If this parameter is null, the System.Globalization.CultureInfo.CurrentCulture property value is used.
