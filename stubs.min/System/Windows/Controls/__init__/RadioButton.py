class RadioButton(ToggleButton, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, ICommandSource):
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: RadioButton) -> AutomationPeer
            ...
            Provides an appropriate System.Windows.Automation.Peers.RadioButtonAutomationPeer implementation for this control, as part of the WPF automation infrastructure.
    ...
    def OnToggle(self, *args): #cannot find CLR method
        ...
        OnToggle(self: RadioButton)
            Called by the System.Windows.Controls.Primitives.ToggleButton.OnClick method to implement a System.Windows.Controls.RadioButton control's toggle behavior.
        """
        pass
