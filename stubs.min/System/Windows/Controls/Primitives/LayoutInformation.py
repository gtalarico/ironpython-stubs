class LayoutInformation(object):
    ...
    def GetLayoutExceptionElement(dispatcher):
        ...
        GetLayoutExceptionElement(dispatcher: Dispatcher) -> UIElement
            ...
            Returns a System.Windows.UIElement that was being processed by the layout engine at the moment of an unhandled exception.
        
            dispatcher: The System.Windows.Threading.Dispatcher object that defines the scope of the operation. There is one dispatcher per layout engine instance.
            Returns: A System.Windows.UIElement that was being processed by the layout engine at the moment of an unhandled exception.
        """
        pass
    ...
    def GetLayoutSlot(element):
        ...
        GetLayoutSlot(element: FrameworkElement) -> Rect
            ...
            Returns a System.Windows.Rect that represents the layout partition that is reserved for a child element.
