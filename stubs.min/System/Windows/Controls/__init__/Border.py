class Border(Decorator, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def ArrangeOverride(self, *args): #cannot find CLR method
        ...
        ArrangeOverride(self: Border, finalSize: Size) -> Size
            ...
            Returns: The System.Windows.Size that represents the arranged size of this System.Windows.Controls.Border element and its child element.
        """
        pass
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: Border, constraint: Size) -> Size
            ...
            Measures the child elements of a System.Windows.Controls.Border before they are arranged during the System.Windows.Controls.Border.ArrangeOverride(System.Windows.Size) pass.
    ...
    def OnRender(self, *args): #cannot find CLR method
        ...
        OnRender(self: Border, dc: DrawingContext)
            Draws the contents of a System.Windows.Media.DrawingContext object during the render pass of a System.Windows.Controls.Border.
