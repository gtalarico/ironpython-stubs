class ColorConvertedBitmapExtension(MarkupExtension):
    ...
    def ProvideValue(self, serviceProvider):
        ...
        ProvideValue(self: ColorConvertedBitmapExtension, serviceProvider: IServiceProvider) -> object
            ...
            Returns an object that should be set on the property where this extension is applied. For System.Windows.ColorConvertedBitmapExtension, this is the completed 
             System.Windows.Media.Imaging.ColorConvertedBitmap.
        
        
            serviceProvider: An object that can provide services for the markup extension. This service is expected to provide results for System.Windows.Markup.IUriContext.
            Returns: A System.Windows.Media.Imaging.ColorConvertedBitmap based on the values passed to the constructor.
        """
        pass
