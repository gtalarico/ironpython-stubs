 ...
 def ShouldSerializeBlocks(self,manager):
  ...
  ShouldSerializeBlocks(self: AnchoredBlock,manager: XamlDesignerSerializationManager) -> bool
   ...
   Returns a value that indicates whether or not the effective value of the 
    System.Windows.Documents.AnchoredBlock.Blocks property should be serialized 
    during serialization of an object deriving from 
    System.Windows.Documents.AnchoredBlock.
  
  
   manager: A serialization service manager object for this object.
   Returns: true if the System.Windows.Documents.AnchoredBlock.Blocks property should be 
