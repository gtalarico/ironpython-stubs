class ToggleButton(ButtonBase, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, ICommandSource):
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: ToggleButton) -> AutomationPeer
            ...
            Provides an appropriate System.Windows.Automation.Peers.ToggleButtonAutomationPeer implementation for this control, as part of the WPF infrastructure.
    ...
    def OnIndeterminate(self, *args): #cannot find CLR method
        """
        OnIndeterminate(self: ToggleButton, e: RoutedEventArgs)
            Called when a System.Windows.Controls.Primitives.ToggleButton raises an System.Windows.Controls.Primitives.ToggleButton.Indeterminate event.
    ...
    def OnToggle(self, *args): #cannot find CLR method
        """
        OnToggle(self: ToggleButton)
            Called by the System.Windows.Controls.Primitives.ToggleButton.OnClick method to implement toggle behavior.
        """
        pass
    ...
    def OnUnchecked(self, *args): #cannot find CLR method
        ...
        OnUnchecked(self: ToggleButton, e: RoutedEventArgs)
            Called when a System.Windows.Controls.Primitives.ToggleButton raises an System.Windows.Controls.Primitives.ToggleButton.Unchecked event.
...
"""
    ...
    IsThreeState = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
