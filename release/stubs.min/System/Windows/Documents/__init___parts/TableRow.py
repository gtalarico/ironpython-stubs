 ...
 def ShouldSerializeCells(self):
  ...
  ShouldSerializeCells(self: TableRow) -> bool
   ...
   Returns a value that indicates whether or not the effective value of the 
    System.Windows.Documents.TableRow.Cells property should be serialized during 
    serialization of a System.Windows.Documents.TableRow object.
  
   Returns: true if the System.Windows.Documents.TableRow.Cells property should be 
