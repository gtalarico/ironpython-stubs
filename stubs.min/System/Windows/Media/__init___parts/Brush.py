class Brush(Animatable,ISealable,IAnimatable,IResource,IFormattable):
 ...
 def Clone(self):
  ...
  Clone(self: Brush) -> Brush
   ...
   Creates a modifiable clone of this System.Windows.Media.Brush,making deep 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: Brush) -> Brush
   ...
   Creates a modifiable clone of this System.Windows.Media.Brush object,making 
 ...
 def ToString(self,provider=None):
  ...
  ToString(self: Brush,provider: IFormatProvider) -> str
   ...
   provider: Culture-specific formatting information,or null to use the default formatting 
...
"""
 ...
 RelativeTransform=property(lambda self: object(),lambda self,v: None,lambda self: None)
