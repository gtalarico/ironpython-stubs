class DBNull(object,ISerializable,IConvertible):
 ...
 def GetObjectData(self,info,context):
  ...
  GetObjectData(self: DBNull,info: SerializationInfo,context: StreamingContext)
   Implements the System.Runtime.Serialization.ISerializable interface and returns 
    the data needed to serialize the System.DBNull object.
  
  
   info: A System.Runtime.Serialization.SerializationInfo object containing information 
    required to serialize the System.DBNull object.
  
   context: A System.Runtime.Serialization.StreamingContext object containing the source 
    and destination of the serialized stream associated with the System.DBNull 
    object.
  """
  pass
 ...
 def ToString(self,provider=None):
  ...
  ToString(self: DBNull,provider: IFormatProvider) -> str
   ...
   provider: The System.IFormatProvider to be used to format the return value.-or- null to 
    obtain the format information from the current locale setting of the operating 
    system.
