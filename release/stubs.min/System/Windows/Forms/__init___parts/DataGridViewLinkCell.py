class DataGridViewLinkCell(DataGridViewCell,ICloneable,IDisposable):
 ...
 def CreateAccessibilityInstance(self,*args):
  ...
  CreateAccessibilityInstance(self: DataGridViewLinkCell) -> AccessibleObject
   ...
   Returns: A new 
    ...
    for the System.Windows.Forms.DataGridViewLinkCell.
  """
  pass
 def Dispose(self):
  """
 ...
 def KeyUpUnsharesRow(self,*args):
  ...
  KeyUpUnsharesRow(self: DataGridViewLinkCell,e: KeyEventArgs,rowIndex: int) -> bool
   ...
   Indicates whether the row containing the cell will be unshared when a key is 
    released and the cell has focus.
   ...
   Returns: true if the SPACE key was released,the 
    System.Windows.Forms.DataGridViewLinkCell.TrackVisitedState property is true,
    the System.Windows.Forms.DataGridViewLinkCell.LinkVisited property is false,
    and the CTRL,ALT,and SHIFT keys are not pressed; otherwise,false.
  """
  pass
 ...
 def MouseLeaveUnsharesRow(self,*args):
  ...
  MouseLeaveUnsharesRow(self: DataGridViewLinkCell,rowIndex: int) -> bool
   ...
   rowIndex: The index of the row containing the cell.
   Returns: true if the link displayed by the cell is not in the normal state; otherwise,
    false.
  """
  pass
 def MouseMoveUnsharesRow(self,*args):
  ...
  MouseMoveUnsharesRow(self: DataGridViewLinkCell,e: DataGridViewCellMouseEventArgs) -> bool
   ...
   Returns: true if the mouse pointer is over the link and the link is has not yet changed 
    color to reflect the hover state; otherwise,false.
  """
  pass
