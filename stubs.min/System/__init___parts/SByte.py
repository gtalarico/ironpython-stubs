class SByte(object, IComparable, IFormattable, IConvertible, IComparable[SByte], IEquatable[SByte]):
    ...
    def CompareTo(self, *__args):
        ...
        CompareTo(self: SByte, value: SByte) -> int
            ...
            Returns: A signed integer that indicates the relative order of this instance and value.Return Value Description Less than zero This instance is less than value. Zero This instance is equal to value. Greater than 
             zero This instance is greater than value.
        ...
        CompareTo(self: SByte, obj: object) -> int
            ...
            Returns: A signed number indicating the relative values of this instance and obj.Return Value Description Less than zero This instance is less than obj. Zero This instance is equal to obj. Greater than zero This 
             instance is greater than obj.-or- obj is null.
        """
        pass
