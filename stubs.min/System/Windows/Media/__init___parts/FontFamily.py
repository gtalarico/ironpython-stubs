class FontFamily(object):
 ...
 def Equals(self,o):
  ...
  Equals(self: FontFamily,o: object) -> bool
   ...
   Gets a value that indicates whether the current font family object and the 
    specified font family object are the same.
  
  
   o: The System.Windows.Media.FontFamily object to compare.
   Returns: true if o is equal to the current System.Windows.Media.FontFamily object; 
    otherwise,false. If o is not a System.Windows.Media.FontFamily object,false 
    is returned.
  """
  pass
 def GetHashCode(self):
  ...
  GetHashCode(self: FontFamily) -> int
   ...
   Serves as a hash function for System.Windows.Media.FontFamily. It is suitable 
 ...
 def GetTypefaces(self):
  ...
  GetTypefaces(self: FontFamily) -> ICollection[Typeface]
   ...
   Returns a collection of System.Windows.Media.Typeface objects that represent 
    the type faces in the default system font location.
 ...
 def ToString(self):
  ...
  ToString(self: FontFamily) -> str
   ...
   Returns: The source location of the System.Windows.Media.FontFamily object,including 
    the directory or uniform resource identifier (URI) location reference.
  """
  pass
...
"""
 ...
 FamilyMaps=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 FamilyTypefaces=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 LineSpacing=property(lambda self: object(),lambda self,v: None,lambda self: None)
