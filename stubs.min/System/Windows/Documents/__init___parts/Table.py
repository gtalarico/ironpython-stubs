class Table(Block,IInputElement,IAnimatable,IFrameworkInputElement,ISupportInitialize,IQueryAmbient,IAddChild,IAcceptInsertion):
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: Table) -> AutomationPeer
   ...
   Creates and returns an System.Windows.Automation.Peers.AutomationPeer object 
    for this System.Windows.Documents.Table.
 ...
 def ShouldSerializeColumns(self):
  ...
  ShouldSerializeColumns(self: Table) -> bool
   ...
   Gets a value that indicates whether or not the effective value of the 
    System.Windows.Documents.Table.Columns property should be serialized during 
    serialization of a System.Windows.Documents.Table object.
  
   Returns: true if the System.Windows.Documents.Table.Columns property should be 
 ...
 def __init__(self,*args):
  ...
  pass
 CellSpacing=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 RowGroups=property(lambda self: object(),lambda self,v: None,lambda self: None)
