class KeyTimeConverter(TypeConverter):
    ...
    def CanConvertFrom(self, *__args):
        ...
        CanConvertFrom(self: KeyTimeConverter, typeDescriptorContext: ITypeDescriptorContext, type: Type) -> bool
            ...
            Determines whether an object can be converted from a given type to an instance of a System.Windows.Media.Animation.KeyTime.
    ...
    def ConvertFrom(self, *__args):
        ...
        ConvertFrom(self: KeyTimeConverter, typeDescriptorContext: ITypeDescriptorContext, cultureInfo: CultureInfo, value: object) -> object
            ...
            value: The object being converted to an instance of System.Windows.Media.Animation.KeyTime.
            Returns: A new instance of System.Windows.Media.Animation.KeyTime, based on the supplied value.
        """
        pass
    ...
    def ConvertTo(self, *__args):
        ...
        ConvertTo(self: KeyTimeConverter, typeDescriptorContext: ITypeDescriptorContext, cultureInfo: CultureInfo, value: object, destinationType: Type) -> object
            ...
            Attempts to convert an instance of System.Windows.Media.Animation.KeyTime to another type.
