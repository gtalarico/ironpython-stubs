class Attribute(object, _Attribute):
    ...
    def GetCustomAttributes(element, *__args):
        ...
        GetCustomAttributes(element: ParameterInfo, attributeType: Type, inherit: bool) -> Array[Attribute]
            ...
            Retrieves an array of the custom attributes applied to a method parameter. Parameters specify the method parameter, the type of the custom attribute to search for, and whether to search ancestors of the 
             method parameter.
    ...
    def IsDefined(element, attributeType, inherit=None):
        ...
        IsDefined(element: ParameterInfo, attributeType: Type, inherit: bool) -> bool
            ...
            Determines whether any custom attributes are applied to a method parameter. Parameters specify the method parameter, the type of the custom attribute to search for, and whether to search ancestors of the 
             method parameter.
