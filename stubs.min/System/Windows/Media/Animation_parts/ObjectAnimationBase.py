class ObjectAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: ObjectAnimationBase) -> ObjectAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.ObjectAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
