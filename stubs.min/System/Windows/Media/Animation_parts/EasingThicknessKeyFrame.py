class EasingThicknessKeyFrame(ThicknessKeyFrame, ISealable, IKeyFrame):
    ...
    def InterpolateValueCore(self, *args): #cannot find CLR method
        ...
        InterpolateValueCore(self: EasingThicknessKeyFrame, baseValue: Thickness, keyFrameProgress: float) -> Thickness
            ...
            Interpolates, according to the easing function used, between the previous key frame value and the value of the current key frame, using the supplied progress increment.
