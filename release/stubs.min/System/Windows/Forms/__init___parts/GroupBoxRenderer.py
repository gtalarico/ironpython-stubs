class GroupBoxRenderer(object):
 ...
 def DrawGroupBox(g,bounds,*__args):
  ...
  DrawGroupBox(g: Graphics,bounds: Rectangle,state: GroupBoxState)
   ...
   state: One of the System.Windows.Forms.VisualStyles.GroupBoxState values that specifies the visual state of the group box.
 ...
 def IsBackgroundPartiallyTransparent(state):
  ...
  IsBackgroundPartiallyTransparent(state: GroupBoxState) -> bool
   ...
   state: One of the System.Windows.Forms.VisualStyles.GroupBoxState values that specifies the visual state of the group box.
   Returns: true if the background of the group box has semitransparent or alpha-blended pieces; otherwise,false.
  """
  pass
