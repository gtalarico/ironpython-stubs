...
class AutomationProperties(object):
    """ Provides a means of getting or setting the value of the associated properties of the instance of the System.Windows.Automation.Peers.AutomationPeer element. """
    @staticmethod
    def GetAcceleratorKey(element):
        """
    ...
    @staticmethod
    def GetIsOffscreenBehavior(element):
        """ GetIsOffscreenBehavior(element: DependencyObject) -> IsOffscreenBehavior """
        pass

    @staticmethod
    def GetIsRequiredForForm(element):
        """
    ...
    @staticmethod
    def SetIsOffscreenBehavior(element, value):
        """ SetIsOffscreenBehavior(element: DependencyObject, value: IsOffscreenBehavior) """
        pass
    ...
    @staticmethod
    def SetName(element, value):
        """
        SetName(element: DependencyObject, value: str)
            Sets the System.Windows.Automation.AutomationProperties.Name�attached property.
    ...
    AcceleratorKeyProperty = None
    AccessKeyProperty = None
    AutomationIdProperty = None
    HelpTextProperty = None
    IsColumnHeaderProperty = None
    IsOffscreenBehaviorProperty = None
    IsRequiredForFormProperty = None
    IsRowHeaderProperty = None
    ItemStatusProperty = None
    ItemTypeProperty = None
    LabeledByProperty = None
    NameProperty = None
    __all__ = [
...
class IsOffscreenBehavior(Enum, IComparable, IFormattable, IConvertible):
    """ enum IsOffscreenBehavior, values: Default (0), FromClip (3), Offscreen (2), Onscreen (1) """
