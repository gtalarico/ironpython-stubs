class TextRenderer:
 ...
 def DrawText(dc,text,font,*__args):
  ...
  DrawText(dc: IDeviceContext,text: str,font: Font,pt: Point,foreColor: Color,flags: TextFormatFlags)
   Draws the specified text at the specified location using the specified device context,
    font,color,and formatting instructions.
  ...
  DrawText(dc: IDeviceContext,text: str,font: Font,pt: Point,foreColor: Color,backColor: Color,flags: TextFormatFlags)
   Draws the specified text at the specified location using the specified device context,
    font,color,back color,and formatting instructions
 ...
 def MeasureText(*__args):
  ...
  MeasureText(text: str,font: Font) -> Size
   ...
   Returns: The System.Drawing.Size,in pixels,of text drawn on a single line with the specified 
    font. You can manipulate how the text is drawn by using one of the 
    System.Windows.Forms.TextRenderer.DrawText(System.Drawing.IDeviceContext,System.String,Sys
    tem.Drawing.Font,System.Drawing.Rectangle,System.Drawing.Color,System.Windows.Forms.TextFo
    rmatFlags) overloads that takes a System.Windows.Forms.TextFormatFlags parameter. For 
    example,the default behavior of the System.Windows.Forms.TextRenderer is to add padding 
    to the bounding rectangle of the drawn text to accommodate overhanging glyphs. If you 
    need to draw a line of text without these extra spaces you should use the versions of 
    System.Windows.Forms.TextRenderer.DrawText(System.Drawing.IDeviceContext,System.String,Sys
    tem.Drawing.Font,System.Drawing.Point,System.Drawing.Color) and 
    System.Windows.Forms.TextRenderer.MeasureText(System.Drawing.IDeviceContext,System.String,
    System.Drawing.Font) that take a System.Drawing.Size and 
  ...
  MeasureText(text: str,font: Font,proposedSize: Size,flags: TextFormatFlags) -> Size
   ...
   Provides the size,in pixels,of the specified text when drawn with the specified font 
    and formatting instructions,using the specified size to create the initial bounding 
  ...
  MeasureText(text: str,font: Font,proposedSize: Size) -> Size
   ...
   Provides the size,in pixels,of the specified text when drawn with the specified font,
    using the specified size to create an initial bounding rectangle.
  ...
  MeasureText(dc: IDeviceContext,text: str,font: Font) -> Size
   ...
   text: The text to measure.
   font: The System.Drawing.Font to apply to the measured text.
   Returns: The System.Drawing.Size,in pixels,of text drawn in a single line with the specified 
    font in the specified device context.
  
  MeasureText(dc: IDeviceContext,text: str,font: Font,proposedSize: Size) -> Size
  
   Provides the size,in pixels,of the specified text when drawn with the specified font in 
    the specified device context,using the specified size to create an initial bounding 
    rectangle for the text.
  ...
  MeasureText(dc: IDeviceContext,text: str,font: Font,proposedSize: Size,flags: TextFormatFlags) -> Size
   ...
   Provides the size,in pixels,of the specified text when drawn with the specified device 
    context,font,and formatting instructions,using the specified size to create the 
    initial bounding rectangle for the text.
