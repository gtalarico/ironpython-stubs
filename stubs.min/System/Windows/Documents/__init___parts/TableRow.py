class TableRow(TextElement, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild, IIndexedChild[TableRowGroup], IAcceptInsertion):
    """
    A flow content element that defines a row within a System.Windows.Documents.Table.
    ...
    def ShouldSerializeCells(self):
        """
        ShouldSerializeCells(self: TableRow) -> bool
        
            Returns a value that indicates whether or not the effective value of the System.Windows.Documents.TableRow.Cells property should be serialized during serialization of a System.Windows.Documents.TableRow 
             object.
        
            Returns: true if the System.Windows.Documents.TableRow.Cells property should be serialized; otherwise, false.
        """
        pass
    ...
    """Gets a System.Windows.Documents.TableCellCollection that contains cells of a System.Windows.Documents.TableRow.
