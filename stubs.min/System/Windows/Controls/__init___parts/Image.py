class Image(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IUriContext, IProvidePropertyFallback):
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: Image, constraint: Size) -> Size
            ...
            Updates the System.Windows.UIElement.DesiredSize of the image. This method is called by the parent System.Windows.UIElement and is the first pass of layout.
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: Image) -> AutomationPeer
            ...
            Creates and returns an System.Windows.Automation.Peers.AutomationPeer object for this System.Windows.Controls.Image.
