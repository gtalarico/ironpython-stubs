class Calendar(Control, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient):
    ...
    def OnApplyTemplate(self):
        ...
        OnApplyTemplate(self: Calendar)
            Builds the visual tree for the System.Windows.Controls.Calendar control when a new template is applied.
        """
        pass
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: Calendar) -> AutomationPeer
            ...
            Returns a System.Windows.Automation.Peers.CalendarAutomationPeer for use by the  automation infrastructure.
            Returns: A System.Windows.Automation.Peers.CalendarAutomationPeer for the System.Windows.Controls.Calendar object.
        """
        pass

    def OnDisplayDateChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnSelectedDatesChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnSelectionModeChanged(self, *args): #cannot find CLR method
        """
    ...
    def ToString(self):
        ...
        ToString(self: Calendar) -> str
            ...
            Returns: A text representation of the selected date, or an empty string if System.Windows.Controls.Calendar.SelectedDate is null.
        """
        pass
    ...
    BlackoutDates = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CalendarButtonStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CalendarDayButtonStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CalendarItemStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DisplayDate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DisplayDateEnd = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DisplayDateStart = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    FirstDayOfWeek = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsTodayHighlighted = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectedDate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectedDates = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
