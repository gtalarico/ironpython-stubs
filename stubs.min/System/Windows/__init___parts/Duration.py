class Duration(object):
    ...
    def Add(self, duration):
        ...
        Add(self: Duration, duration: Duration) -> Duration
            ...
            Adds the value of the specified instance of System.Windows.Duration to the value of the current instance.
        
            duration: An instance of System.Windows.Duration that represents the value of the current instance plus duration.
            Returns: If both instances of System.Windows.Duration have values, an instance of System.Windows.Duration that represents the combined values. Otherwise this method returns null.
        """
        pass
    ...
    def Compare(t1, t2):
        ...
        Compare(t1: Duration, t2: Duration) -> int
            ...
            Returns: If t1 is less than t2, a negative value that represents the difference. If t1 is equal to t2, zero. If t1 is greater than t2, a positive value that represents the difference.
        """
        pass
    ...
    def Equals(self, *__args):
        ...
        Equals(self: Duration, duration: Duration) -> bool
            ...
            Determines whether a specified System.Windows.Duration is equal to this instance of System.Windows.Duration.
        
            duration: Instance of System.Windows.Duration to check for equality.
            Returns: true if duration is equal to the current instance of System.Windows.Duration; otherwise, false.
        Equals(self: Duration, value: object) -> bool
        
            Determines whether a specified object is equal to an instance of System.Windows.Duration.
    ...
    def Subtract(self, duration):
        ...
        Subtract(self: Duration, duration: Duration) -> Duration
            ...
            Subtracts the value of the specified instance of System.Windows.Duration from this instance.
        
            duration: The instance of System.Windows.Duration to subtract from the current instance.
            Returns: A new instance of System.Windows.Duration whose value is the result of this instance minus the value of duration.
        """
        pass
    ...
    def ToString(self):
        ...
        ToString(self: Duration) -> str
            ...
            Converts an instance of System.Windows.Duration to a System.String representation.
    ...
    def __radd__(self, *args): #cannot find CLR method
        ...
        __radd__(t1: Duration, t2: Duration) -> Duration
            ...
            Returns: If both instances of System.Windows.Duration have System.TimeSpan values, this method returns the sum of those two values. If either value is set to System.Windows.Duration.Automatic, the method returns 
             System.Windows.Duration.Automatic. If either value is set to System.Windows.Duration.Forever, the method returns System.Windows.Duration.Forever.If either t1 or t2 has no value, this method returns null.
        """
        pass
    ...
    def __rsub__(self, *args): #cannot find CLR method
        ...
        __rsub__(t1: Duration, t2: Duration) -> Duration
            ...
            Returns: If both instances of System.Windows.Duration have values, an instance of System.Windows.Duration that represents the value of t1 minus t2. If t1 has a value of System.Windows.Duration.Forever and t2 has a 
             value of System.Windows.Duration.TimeSpan, this method returns System.Windows.Duration.Forever. Otherwise this method returns null.
        """
        pass
