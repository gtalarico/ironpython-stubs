class ElasticEase(EasingFunctionBase, ISealable, IEasingFunction):
    ...
    Oscillations = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    Springiness = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
