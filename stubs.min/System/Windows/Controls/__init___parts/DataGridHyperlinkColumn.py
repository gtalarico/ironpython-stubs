class DataGridHyperlinkColumn(DataGridBoundColumn):
    ...
    """
    def OnContentBindingChanged(self, *args): #cannot find CLR method
        """
        OnContentBindingChanged(self: DataGridHyperlinkColumn, oldBinding: BindingBase, newBinding: BindingBase)
            Notifies the System.Windows.Controls.DataGrid when the System.Windows.Controls.DataGridHyperlinkColumn.ContentBinding property changes.
    ...
    ContentBinding = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
