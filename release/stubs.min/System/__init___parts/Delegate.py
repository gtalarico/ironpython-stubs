class Delegate:
 ...
 def Combine(*__args):
  ...
  Combine(a: Delegate,b: Delegate) -> Delegate
   ...
   Returns: A new delegate with an invocation list that concatenates the invocation lists of a and b 
    in that order. Returns a if b is null,returns b if a is a null reference,and returns a 
    null reference if both a and b are null references.
  ...
  Combine(*delegates: Array[Delegate]) -> Delegate
   ...
   Returns: A new delegate with an invocation list that concatenates the invocation lists of the 
    delegates in the delegates array. Returns null if delegates is null,if delegates 
 ...
 def CombineImpl(self,*args):
  ...
  CombineImpl(self: Delegate,d: Delegate) -> Delegate
   ...
   Concatenates the invocation lists of the specified multicast (combinable) delegate and 
    the current multicast (combinable) delegate.
  
  
   d: The multicast (combinable) delegate whose invocation list to append to the end of the 
    invocation list of the current multicast (combinable) delegate.
  
   Returns: A new multicast (combinable) delegate with an invocation list that concatenates the 
    invocation list of the current multicast (combinable) delegate and the invocation list of 
    d,or the current multicast (combinable) delegate if d is null.
  """
  pass
 @staticmethod
 def CreateDelegate(type,*__args):
  ...
  CreateDelegate(type: Type,target: object,method: str) -> Delegate
   ...
   Creates a delegate of the specified type that represents the specified instance method to 
    invoke on the specified class instance.
   ...
   Returns: A delegate of the specified type that represents the specified instance method to invoke 
    on the specified class instance.
  
  CreateDelegate(type: Type,target: object,method: str,ignoreCase: bool) -> Delegate
  
   Creates a delegate of the specified type that represents the specified instance method to 
    invoke on the specified class instance with the specified case-sensitivity.
  ...
  CreateDelegate(type: Type,target: object,method: str,ignoreCase: bool,throwOnBindFailure: bool) -> Delegate
   ...
   Creates a delegate of the specified type that represents the specified instance method to 
    invoke on the specified class instance,with the specified case-sensitivity and the 
  ...
  CreateDelegate(type: Type,target: Type,method: str) -> Delegate
   ...
   Creates a delegate of the specified type that represents the specified static method of 
    the specified class.
   ...
   Returns: A delegate of the specified type that represents the specified static method of the 
    specified class.
  
  CreateDelegate(type: Type,target: Type,method: str,ignoreCase: bool) -> Delegate
  
   Creates a delegate of the specified type that represents the specified static method of 
    the specified class,with the specified case-sensitivity.
  ...
  CreateDelegate(type: Type,target: Type,method: str,ignoreCase: bool,throwOnBindFailure: bool) -> Delegate
   ...
   Creates a delegate of the specified type that represents the specified static method of 
    the specified class,with the specified case-sensitivity and the specified behavior on 
    failure to bind.
  ...
  CreateDelegate(type: Type,method: MethodInfo,throwOnBindFailure: bool) -> Delegate
   ...
   Creates a delegate of the specified type to represent the specified static method,with 
    the specified behavior on failure to bind.
  
  
   type: The System.Type of delegate to create.
   method: The System.Reflection.MethodInfo describing the static or instance method the delegate is 
    to represent.
  ...
  CreateDelegate(type: Type,firstArgument: object,method: MethodInfo) -> Delegate
   ...
   type: The System.Type of delegate to create.
   firstArgument: The object to which the delegate is bound,or null to treat method as static (Shared in 
    Visual Basic).
  ...
  CreateDelegate(type: Type,firstArgument: object,method: MethodInfo,throwOnBindFailure: bool) -> Delegate
   ...
   firstArgument: An System.Object that is the first argument of the method the delegate represents. For 
    instance methods,it must be compatible with the instance type.
   ...
   throwOnBindFailure: true to throw an exception if method cannot be bound; otherwise,false.
   Returns: A delegate of the specified type that represents the specified static or instance method,
    or null if throwOnBindFailure is false and the delegate cannot be bound to method.
  ...
  CreateDelegate(type: Type,method: MethodInfo) -> Delegate
   ...
   type: The System.Type of delegate to create.
   method: The System.Reflection.MethodInfo describing the static or instance method the delegate is 
    to represent. Only static methods are supported in the .NET Framework version 1.0 and 
    1.1.
 ...
 def Equals(self,obj):
  ...
  Equals(self: Delegate,obj: object) -> bool
   ...
   Determines whether the specified object and the current delegate are of the same type and 
    share the same targets,methods,and invocation list.
 ...
 def GetMethodImpl(self,*args):
  ...
  GetMethodImpl(self: Delegate) -> MethodInfo
   ...
   Returns: A System.Reflection.MethodInfo describing the static method represented by the current 
    delegate.
  """
  pass
 ...
 def Remove(source,value):
  ...
  Remove(source: Delegate,value: Delegate) -> Delegate
   ...
   Removes the last occurrence of the invocation list of a delegate from the invocation list 
    of another delegate.
  
  
   source: The delegate from which to remove the invocation list of value.
   value: The delegate that supplies the invocation list to remove from the invocation list of 
    source.
  
   Returns: A new delegate with an invocation list formed by taking the invocation list of source and 
    removing the last occurrence of the invocation list of value,if the invocation list of 
    value is found within the invocation list of source. Returns source if value is null or 
    if the invocation list of value is not found within the invocation list of source. 
    Returns a null reference if the invocation list of value is equal to the invocation list 
    of source or if source is a null reference.
  """
  pass
 @staticmethod
 def RemoveAll(source,value):
  ...
  RemoveAll(source: Delegate,value: Delegate) -> Delegate
   ...
   Removes all occurrences of the invocation list of a delegate from the invocation list of 
    another delegate.
   ...
   Returns: A new delegate with an invocation list formed by taking the invocation list of source and 
    removing all occurrences of the invocation list of value,if the invocation list of value 
    is found within the invocation list of source. Returns source if value is null or if the 
    invocation list of value is not found within the invocation list of source. Returns a 
    null reference if the invocation list of value is equal to the invocation list of source,
    if source contains only a series of invocation lists that are equal to the invocation 
    list of value,or if source is a null reference.
  """
  pass
 def RemoveImpl(self,*args):
  ...
  RemoveImpl(self: Delegate,d: Delegate) -> Delegate
   ...
   d: The delegate that supplies the invocation list to remove from the invocation list of the 
    current delegate.
  
   Returns: A new delegate with an invocation list formed by taking the invocation list of the 
    current delegate and removing the invocation list of value,if the invocation list of 
    value is found within the current delegate's invocation list. Returns the current 
    delegate if value is null or if the invocation list of value is not found within the 
    current delegate's invocation list. Returns null if the invocation list of value is equal 
    to the current delegate's invocation list.
  """
  pass
