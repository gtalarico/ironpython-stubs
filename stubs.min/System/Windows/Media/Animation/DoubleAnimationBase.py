class DoubleAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: DoubleAnimationBase) -> DoubleAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.DoubleAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
