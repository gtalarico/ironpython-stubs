class DiscreteThicknessKeyFrame(ThicknessKeyFrame,ISealable,IKeyFrame):
 ...
 def InterpolateValueCore(self,*args):
  ...
  InterpolateValueCore(self: DiscreteThicknessKeyFrame,baseValue: Thickness,keyFrameProgress: float) -> Thickness
   ...
   Interpolates,between the previous key frame value and the value of the current 
    key frame using discrete interpolation.
  
  
   baseValue: The value to animate from.
   keyFrameProgress: A value from 0.0 through 1.0 that specifies the percentage of time that has 
