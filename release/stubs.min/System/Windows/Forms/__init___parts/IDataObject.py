class IDataObject:
 ...
 def GetData(self,format,autoConvert=None):
  ...
  GetData(self: IDataObject,format: str,autoConvert: bool) -> object
   ...
   Retrieves the data associated with the specified data format,using a Boolean 
 ...
 def GetDataPresent(self,format,autoConvert=None):
  ...
  GetDataPresent(self: IDataObject,format: str) -> bool
   ...
   format: The format for which to check. See System.Windows.Forms.DataFormats for 
    predefined formats.
  ...
  GetDataPresent(self: IDataObject,format: str,autoConvert: bool) -> bool
   ...
   Determines whether data stored in this instance is associated with the 
    specified format,using a Boolean value to determine whether to convert the 
    data to the format.
   ...
   autoConvert: true to determine whether data stored in this instance can be converted to the 
    specified format; false to check whether the data is in the specified format.
 ...
 def GetFormats(self,autoConvert=None):
  ...
  GetFormats(self: IDataObject) -> Array[str]
   ...
   Returns: An array of the names that represents a list of all formats that are supported 
    by the data stored in this object.
  
  GetFormats(self: IDataObject,autoConvert: bool) -> Array[str]
  
   Gets a list of all formats that data stored in this instance is associated with 
    or can be converted to,using a Boolean value to determine whether to retrieve 
    all formats that the data can be converted to or only native data formats.
  
  
   autoConvert: true to retrieve all formats that data stored in this instance is associated 
 ...
 def SetData(self,*__args):
  ...
  SetData(self: IDataObject,format: str,autoConvert: bool,data: object)
   Stores the specified data and its associated format in this instance,using a 
    Boolean value to specify whether the data can be converted to another format.
