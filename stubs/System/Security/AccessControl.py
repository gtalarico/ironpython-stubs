...
class GenericAce(object):
    ...
    def Equals(self, o):
        ...
        Equals(self: GenericAce, o: object) -> bool
            ...
            Returns: true if the specified System.Security.AccessControl.GenericAce object is equal to the current System.Security.AccessControl.GenericAce object; otherwise, false.
        """
        pass
    ...
    def GetHashCode(self):
        ...
        GetHashCode(self: GenericAce) -> int
            ...
            Serves as a hash function for the System.Security.AccessControl.GenericAce class. The  System.Security.AccessControl.GenericAce.GetHashCode method is suitable for use in hashing algorithms and data 
...
class CommonObjectSecurity(ObjectSecurity):
    ...
    def GetAccessRules(self, includeExplicit, includeInherited, targetType):
        ...
        GetAccessRules(self: CommonObjectSecurity, includeExplicit: bool, includeInherited: bool, targetType: Type) -> AuthorizationRuleCollection
            ...
            targetType: Specifies whether the security identifier for which to retrieve access rules is of type T:System.Security.Principal.SecurityIdentifier or type T:System.Security.Principal.NTAccount. The value of this 
             parameter must be a type that can be translated to  the System.Security.Principal.SecurityIdentifier type.
    ...
    def RemoveAccessRule(self, *args): #cannot find CLR method
        ...
        RemoveAccessRule(self: CommonObjectSecurity, rule: AccessRule) -> bool
            ...
            Removes access rules that contain the same security identifier and access mask as the specified access rule from the Discretionary Access Control List (DACL) associated with this 
    ...
    def RemoveAuditRuleAll(self, *args): #cannot find CLR method
        ...
        RemoveAuditRuleAll(self: CommonObjectSecurity, rule: AuditRule)
            Removes all audit rules that have the same security identifier as the specified audit rule from the System Access Control List (SACL) associated with this System.Security.AccessControl.CommonObjectSecurity 
             object.
    ...
    def SetAccessRule(self, *args): #cannot find CLR method
        ...
        SetAccessRule(self: CommonObjectSecurity, rule: AccessRule)
            Removes all access rules that contain the same security identifier and qualifier as the specified access rule in the Discretionary Access Control List (DACL) associated with this 
             System.Security.AccessControl.CommonObjectSecurity object and then adds the specified access rule.
...
class GenericSecurityDescriptor(object):
    ...
    def GetSddlForm(self, includeSections):
        ...
        GetSddlForm(self: GenericSecurityDescriptor, includeSections: AccessControlSections) -> str
            ...
            Returns the Security Descriptor Definition Language (SDDL) representation of the specified sections of the security descriptor that this System.Security.AccessControl.GenericSecurityDescriptor object 
             represents.
    ...
    def IsSddlConversionSupported():
        ...
        IsSddlConversionSupported() -> bool
            ...
            Returns a boolean value that specifies whether the security descriptor associated with this  System.Security.AccessControl.GenericSecurityDescriptor object can be converted to the Security Descriptor 
             Definition Language (SDDL) format.
        
            Returns: true if the security descriptor associated with this  System.Security.AccessControl.GenericSecurityDescriptor object can be converted to the Security Descriptor Definition Language (SDDL) format; 
             otherwise, false.
        """
        pass
...
class CommonSecurityDescriptor(GenericSecurityDescriptor):
    ...
    def SetDiscretionaryAclProtection(self, isProtected, preserveInheritance):
        ...
        SetDiscretionaryAclProtection(self: CommonSecurityDescriptor, isProtected: bool, preserveInheritance: bool)
            Sets the inheritance protection for the Discretionary Access Control List (DACL) associated with this System.Security.AccessControl.CommonSecurityDescriptor object. DACLs that are protected do not inherit 
             access rules from parent containers.
    ...
    def SetSystemAclProtection(self, isProtected, preserveInheritance):
        ...
        SetSystemAclProtection(self: CommonSecurityDescriptor, isProtected: bool, preserveInheritance: bool)
            Sets the inheritance protection for the System Access Control List (SACL) associated with this System.Security.AccessControl.CommonSecurityDescriptor object. SACLs that are protected do not inherit audit 
             rules from parent containers.
...
class CryptoKeySecurity(NativeObjectSecurity):
    ...
    def RemoveAuditRuleAll(self, rule):
        ...
        RemoveAuditRuleAll(self: CryptoKeySecurity, rule: CryptoKeyAuditRule)
            Removes all audit rules that have the same security identifier as the specified audit rule from the System Access Control List (SACL) associated with this System.Security.AccessControl.CryptoKeySecurity 
             object.
...
class DirectoryObjectSecurity(ObjectSecurity):
    ...
    def SetAccessRule(self, *args): #cannot find CLR method
        ...
        SetAccessRule(self: DirectoryObjectSecurity, rule: ObjectAccessRule)
            Removes all access rules that contain the same security identifier and qualifier as the specified access rule in the Discretionary Access Control List (DACL) associated with this 
             System.Security.AccessControl.DirectoryObjectSecurity object and then adds the specified access rule.
...
class FileSystemSecurity(NativeObjectSecurity):
    ...
    def AccessRuleFactory(self, identityReference, accessMask, isInherited, inheritanceFlags, propagationFlags, type):
        ...
        AccessRuleFactory(self: FileSystemSecurity, identityReference: IdentityReference, accessMask: int, isInherited: bool, inheritanceFlags: InheritanceFlags, propagationFlags: PropagationFlags, type: AccessControlType) -> AccessRule
            ...
            Initializes a new instance of the System.Security.AccessControl.FileSystemAccessRule class that represents a new access control rule for the specified user, with the specified access rights, access 
             control, and flags.
...
class DiscretionaryAcl(CommonAcl, ICollection, IEnumerable):
    ...
    def AddAccess(self, accessType, sid, *__args):
        ...
        AddAccess(self: DiscretionaryAcl, accessType: AccessControlType, sid: SecurityIdentifier, accessMask: int, inheritanceFlags: InheritanceFlags, propagationFlags: PropagationFlags, objectFlags: ObjectAceFlags, objectType: Guid, inheritedObjectType: Guid)
            Adds an Access Control Entry (ACE) with the specified settings to the current System.Security.AccessControl.DiscretionaryAcl object. Use this method for directory object Access Control Lists (ACLs) when 
             specifying the object type or the inherited object type for the new ACE.
    ...
    def RemoveAccess(self, accessType, sid, *__args):
        ...
        RemoveAccess(self: DiscretionaryAcl, accessType: AccessControlType, sid: SecurityIdentifier, accessMask: int, inheritanceFlags: InheritanceFlags, propagationFlags: PropagationFlags, objectFlags: ObjectAceFlags, objectType: Guid, inheritedObjectType: Guid) -> bool
            ...
            Removes the specified access control rule from the current System.Security.AccessControl.DiscretionaryAcl object. Use this method for directory object Access Control Lists (ACLs) when specifying the object 
             type or the inherited object type.
    ...
    def RemoveAccessSpecific(self, accessType, sid, *__args):
        ...
        RemoveAccessSpecific(self: DiscretionaryAcl, accessType: AccessControlType, sid: SecurityIdentifier, accessMask: int, inheritanceFlags: InheritanceFlags, propagationFlags: PropagationFlags, objectFlags: ObjectAceFlags, objectType: Guid, inheritedObjectType: Guid)
            Removes the specified Access Control Entry (ACE) from the current System.Security.AccessControl.DiscretionaryAcl object. Use this method for directory object Access Control Lists (ACLs) when specifying the 
             object type or the inherited object type for the ACE to be removed.
...
class EventWaitHandleSecurity(NativeObjectSecurity):
    ...
    def AuditRuleFactory(self, identityReference, accessMask, isInherited, inheritanceFlags, propagationFlags, flags):
        ...
        AuditRuleFactory(self: EventWaitHandleSecurity, identityReference: IdentityReference, accessMask: int, isInherited: bool, inheritanceFlags: InheritanceFlags, propagationFlags: PropagationFlags, flags: AuditFlags) -> AuditRule
            ...
            Returns: An System.Security.AccessControl.EventWaitHandleAuditRule object representing the specified audit rule for the specified user. The return type of the method is the base class, 
    ...
    def RemoveAccessRule(self, rule):
        ...
        RemoveAccessRule(self: EventWaitHandleSecurity, rule: EventWaitHandleAccessRule) -> bool
            ...
            Searches for an access control rule with the same user and System.Security.AccessControl.AccessControlType (allow or deny) as the specified access rule, and with compatible inheritance and propagation 
             flags; if such a rule is found, the rights contained in the specified access rule are removed from it.
        
        
            rule: An System.Security.AccessControl.EventWaitHandleAccessRule that specifies the user and System.Security.AccessControl.AccessControlType to search for, and a set of inheritance and propagation flags that a 
             matching rule, if found, must be compatible with. Specifies the rights to remove from the compatible rule, if found.
    ...
    def RemoveAuditRule(self, rule):
        ...
        RemoveAuditRule(self: EventWaitHandleSecurity, rule: EventWaitHandleAuditRule) -> bool
            ...
            Searches for an audit rule with the same user as the specified rule, and with compatible inheritance and propagation flags; if a compatible rule is found, the rights contained in the specified rule are 
             removed from it.
        
        
            rule: An System.Security.AccessControl.EventWaitHandleAuditRule that specifies the user to search for and a set of inheritance and propagation flags that a matching rule, if found, must be compatible with. 
    ...
    def RemoveAuditRuleAll(self, rule):
        ...
        RemoveAuditRuleAll(self: EventWaitHandleSecurity, rule: EventWaitHandleAuditRule)
            ...
            rule: An System.Security.AccessControl.EventWaitHandleAuditRule that specifies the user to search for. Any rights specified by this rule are ignored.
        """
        pass
    ...
    def ResetAccessRule(self, rule):
        ...
        ResetAccessRule(self: EventWaitHandleSecurity, rule: EventWaitHandleAccessRule)
            ...
            rule: The System.Security.AccessControl.EventWaitHandleAccessRule to add. The user specified by this rule determines the rules to remove before this rule is added.
        """
        pass
    ...
    def SetAuditRule(self, rule):
        ...
        SetAuditRule(self: EventWaitHandleSecurity, rule: EventWaitHandleAuditRule)
            ...
            rule: The System.Security.AccessControl.EventWaitHandleAuditRule to add. The user specified by this rule determines the rules to remove before this rule is added.
        """
        pass
...
class MutexSecurity(NativeObjectSecurity):
    ...
    def AuditRuleFactory(self, identityReference, accessMask, isInherited, inheritanceFlags, propagationFlags, flags):
        ...
        AuditRuleFactory(self: MutexSecurity, identityReference: IdentityReference, accessMask: int, isInherited: bool, inheritanceFlags: InheritanceFlags, propagationFlags: PropagationFlags, flags: AuditFlags) -> AuditRule
            ...
            Returns: A System.Security.AccessControl.MutexAuditRule object representing the specified audit rule for the specified user. The return type of the method is the base class, System.Security.AccessControl.AuditRule, 
             but the return value can be cast safely to the derived class.
        """
        pass
    ...
    def RemoveAccessRule(self, rule):
        ...
        RemoveAccessRule(self: MutexSecurity, rule: MutexAccessRule) -> bool
            ...
            Searches for an access control rule with the same user and System.Security.AccessControl.AccessControlType (allow or deny) as the specified rule, and with compatible inheritance and propagation flags; if 
             such a rule is found, the rights contained in the specified access rule are removed from it.
        
        
            rule: A System.Security.AccessControl.MutexAccessRule that specifies the user and System.Security.AccessControl.AccessControlType to search for, and a set of inheritance and propagation flags that a matching 
    ...
    def RemoveAuditRule(self, rule):
        ...
        RemoveAuditRule(self: MutexSecurity, rule: MutexAuditRule) -> bool
            ...
            Searches for an audit control rule with the same user as the specified rule, and with compatible inheritance and propagation flags; if a compatible rule is found, the rights contained in the specified rule 
             are removed from it.
        
        
            rule: A System.Security.AccessControl.MutexAuditRule that specifies the user to search for, and a set of inheritance and propagation flags that a matching rule, if found, must be compatible with. Specifies the 
             rights to remove from the compatible rule, if found.
    ...
    def RemoveAuditRuleAll(self, rule):
        ...
        RemoveAuditRuleAll(self: MutexSecurity, rule: MutexAuditRule)
            ...
            rule: A System.Security.AccessControl.MutexAuditRule that specifies the user to search for. Any rights specified by this rule are ignored.
        """
        pass
    ...
    def ResetAccessRule(self, rule):
        ...
        ResetAccessRule(self: MutexSecurity, rule: MutexAccessRule)
            ...
            rule: The System.Security.AccessControl.MutexAccessRule to add. The user specified by this rule determines the rules to remove before this rule is added.
        """
        pass
    ...
    def SetAuditRule(self, rule):
        ...
        SetAuditRule(self: MutexSecurity, rule: MutexAuditRule)
            ...
            rule: The System.Security.AccessControl.MutexAuditRule to add. The user specified by this rule determines the rules to remove before this rule is added.
        """
        pass
...
class RegistrySecurity(NativeObjectSecurity):
    ...
    def AccessRuleFactory(self, identityReference, accessMask, isInherited, inheritanceFlags, propagationFlags, type):
        ...
        AccessRuleFactory(self: RegistrySecurity, identityReference: IdentityReference, accessMask: int, isInherited: bool, inheritanceFlags: InheritanceFlags, propagationFlags: PropagationFlags, type: AccessControlType) -> AccessRule
            ...
            propagationFlags: A bitwise combination of System.Security.AccessControl.PropagationFlags values that modify the way the rule is inherited by subkeys. Meaningless if the value of inheritanceFlags is 
    ...
    def RemoveAccessRule(self, rule):
        ...
        RemoveAccessRule(self: RegistrySecurity, rule: RegistryAccessRule) -> bool
            ...
            rule: A System.Security.AccessControl.RegistryAccessRule that specifies the user and System.Security.AccessControl.AccessControlType to search for, and a set of inheritance and propagation flags that a matching 
             rule, if found, must be compatible with. Specifies the rights to remove from the compatible rule, if found.
    ...
    def RemoveAccessRuleAll(self, rule):
        ...
        RemoveAccessRuleAll(self: RegistrySecurity, rule: RegistryAccessRule)
            ...
            rule: A System.Security.AccessControl.RegistryAccessRule that specifies the user and System.Security.AccessControl.AccessControlType to search for. Any rights, inheritance flags, or propagation flags specified 
    ...
    def RemoveAuditRule(self, rule):
        ...
        RemoveAuditRule(self: RegistrySecurity, rule: RegistryAuditRule) -> bool
            ...
            rule: A System.Security.AccessControl.RegistryAuditRule that specifies the user to search for, and a set of inheritance and propagation flags that a matching rule, if found, must be compatible with. Specifies 
    ...
    def ResetAccessRule(self, rule):
        ...
        ResetAccessRule(self: RegistrySecurity, rule: RegistryAccessRule)
            ...
            rule: The System.Security.AccessControl.RegistryAccessRule to add. The user specified by this rule determines the rules to remove before this rule is added.
        """
        pass
    ...
    def SetAuditRule(self, rule):
        ...
        SetAuditRule(self: RegistrySecurity, rule: RegistryAuditRule)
            ...
            rule: The System.Security.AccessControl.RegistryAuditRule to add. The user specified by this rule determines the rules to remove before this rule is added.
        """
        pass
...
class SemaphoreSecurity(NativeObjectSecurity):
    ...
    def RemoveAccessRule(self, rule):
        ...
        RemoveAccessRule(self: SemaphoreSecurity, rule: SemaphoreAccessRule) -> bool
            ...
            rule: A System.Security.AccessControl.SemaphoreAccessRule that specifies the user and System.Security.AccessControl.AccessControlType to search for, and a set of inheritance and propagation flags that a matching 
             rule, if found, must be compatible with. Specifies the rights to remove from the compatible rule, if found.
    ...
    def RemoveAuditRule(self, rule):
        ...
        RemoveAuditRule(self: SemaphoreSecurity, rule: SemaphoreAuditRule) -> bool
            ...
            rule: A System.Security.AccessControl.SemaphoreAuditRule that specifies the user to search for, and a set of inheritance and propagation flags that a matching rule, if found, must be compatible with. Specifies 
             the rights to remove from the compatible rule, if found.
    ...
    def RemoveAuditRuleAll(self, rule):
        ...
        RemoveAuditRuleAll(self: SemaphoreSecurity, rule: SemaphoreAuditRule)
            ...
            rule: A System.Security.AccessControl.SemaphoreAuditRule that specifies the user to search for. Any rights specified by this rule are ignored.
        """
        pass
    ...
    def ResetAccessRule(self, rule):
        ...
        ResetAccessRule(self: SemaphoreSecurity, rule: SemaphoreAccessRule)
            ...
            rule: The System.Security.AccessControl.SemaphoreAccessRule to add. The user specified by this rule determines the rules to remove before this rule is added.
        """
        pass
    ...
    def SetAuditRule(self, rule):
        ...
        SetAuditRule(self: SemaphoreSecurity, rule: SemaphoreAuditRule)
            ...
            rule: The System.Security.AccessControl.SemaphoreAuditRule to add. The user specified by this rule determines the rules to remove before this rule is added.
        """
        pass
...
class SystemAcl(CommonAcl, ICollection, IEnumerable):
    ...
    def AddAudit(self, *__args):
        ...
        AddAudit(self: SystemAcl, auditFlags: AuditFlags, sid: SecurityIdentifier, accessMask: int, inheritanceFlags: InheritanceFlags, propagationFlags: PropagationFlags, objectFlags: ObjectAceFlags, objectType: Guid, inheritedObjectType: Guid)
            Adds an audit rule with the specified settings to the current System.Security.AccessControl.SystemAcl object. Use this method for directory object Access Control Lists (ACLs) when specifying the object 
             type or the inherited object type for the new audit rule.
    ...
    def RemoveAudit(self, *__args):
        ...
        RemoveAudit(self: SystemAcl, auditFlags: AuditFlags, sid: SecurityIdentifier, accessMask: int, inheritanceFlags: InheritanceFlags, propagationFlags: PropagationFlags, objectFlags: ObjectAceFlags, objectType: Guid, inheritedObjectType: Guid) -> bool
            ...
            Removes the specified audit rule from the current System.Security.AccessControl.SystemAcl object. Use this method for directory object Access Control Lists (ACLs) when specifying the object type or the 
    ...
    def RemoveAuditSpecific(self, *__args):
        ...
        RemoveAuditSpecific(self: SystemAcl, auditFlags: AuditFlags, sid: SecurityIdentifier, accessMask: int, inheritanceFlags: InheritanceFlags, propagationFlags: PropagationFlags, objectFlags: ObjectAceFlags, objectType: Guid, inheritedObjectType: Guid)
            Removes the specified audit rule from the current System.Security.AccessControl.DiscretionaryAcl object. Use this method for directory object Access Control Lists (ACLs) when specifying the object type or 
    ...
    def SetAudit(self, *__args):
        ...
        SetAudit(self: SystemAcl, auditFlags: AuditFlags, sid: SecurityIdentifier, accessMask: int, inheritanceFlags: InheritanceFlags, propagationFlags: PropagationFlags, objectFlags: ObjectAceFlags, objectType: Guid, inheritedObjectType: Guid)
            Sets the specified audit rule for the specified System.Security.Principal.SecurityIdentifier object. Use this method for directory object Access Control Lists (ACLs) when specifying the object type or the 
             inherited object type.
