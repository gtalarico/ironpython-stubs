...
class DesignerSerializationOptionsAttribute(Attribute,_Attribute):
 ...
 def __new__(self,designerSerializationOptions):
  ...
  pass
 DesignerSerializationOptions=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ClrNamespace=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 XmlNamespace=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 XamlTypeMapper=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 XmlLang=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 XmlnsDictionary=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 XmlSpace=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
class XamlDesignerSerializationManager(ServiceProviders,IServiceProvider):
 ...
 def __new__(self,xmlWriter):
  ...
  pass
 XamlWriterMode=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 KeyContext=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 NameContext=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 UidContext=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
class XamlTypeMapper(object):
 ...
 def AddMappingProcessingInstruction(self,xmlNamespace,clrNamespace,assemblyName):
  ...
  """
  pass
 def AllowInternalType(self,*args):
  """
...
class XmlLanguage(object):
 ...
 def ToString(self):
  ...
  """
  pass
 IetfLanguageTag=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 Sealed=property(lambda self: object(),lambda self,v: None,lambda self: None)
