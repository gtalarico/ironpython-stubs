...
class CodeAccessPermission(Object):
    ...
    def Demand(self):
        ...
        Demand(self: CodeAccessPermission)
            Forces a System.Security.SecurityException at run time if all callers higher 
             in the call stack have not been granted the permission specified by the 
             current instance.
        """
        pass
    ...
    def Equals(self, obj):
        ...
        Equals(self: CodeAccessPermission, obj: object) -> bool
            ...
            Determines whether the specified System.Security.CodeAccessPermission object 
             is equal to the current System.Security.CodeAccessPermission.
    ...
    def PermitOnly(self):
        ...
        PermitOnly(self: CodeAccessPermission)
            Prevents callers higher in the call stack from using the code that calls this 
             method to access all resources except for the resource specified by the 
             current instance.
        """
        pass
    ...
    def RevertAll():
        """
        RevertAll()
            Causes all previous overrides for the current frame to be removed and no 
             longer in effect.
        """
        pass
    ...
    def RevertAssert():
        """
        RevertAssert()
            Causes any previous System.Security.CodeAccessPermission.Assert for the 
...
class HostSecurityManager():
    ...
    def GetHostSuppliedAppDomainEvidenceTypes(self):
        ...
        GetHostSuppliedAppDomainEvidenceTypes(self: HostSecurityManager) -> Array[Type]
            ...
            Determines which evidence types the host can supply for the application 
             domain, if requested.
...
class ISecurityEncodable(Object):
...
class ISecurityPolicyEncodable(Object):
...
class IStackWalk(Object):
    ...
    def Assert(self):
        ...
        Assert(self: IStackWalk)
            Asserts that the calling code can access the resource identified by the 
             current permission object, even if callers higher in the stack have not been 
...
class PermissionSet(Object):
    ...
    def Assert(self):
        ...
        Assert(self: PermissionSet)
            Declares that the calling code can access the resource protected by a 
             permission demand through the code that calls this method, even if callers 
             higher in the stack have not been granted permission to access the resource. 
             Using System.Security.PermissionSet.Assert can create security 
             vulnerabilities.
        """
        pass
    ...
    def ConvertPermissionSet(inFormat, inData, outFormat):
        ...
        ConvertPermissionSet(inFormat: str, inData: Array[Byte], outFormat: str) -> Array[Byte]
            ...
            inFormat: A string representing one of the following encoding formats: ASCII, Unicode, 
             or Binary. Possible values are "XMLASCII" or "XML", "XMLUNICODE", and 
             "BINARY".
        
            inData: An XML-encoded permission set.
            outFormat: A string representing one of the following encoding formats: ASCII, Unicode, 
             or Binary. Possible values are "XMLASCII" or "XML", "XMLUNICODE", and 
             "BINARY".
    ...
    def Demand(self):
        ...
        Demand(self: PermissionSet)
            Forces a System.Security.SecurityException at run time if all callers higher 
             in the call stack have not been granted the permissions specified by the 
             current instance.
        """
        pass
    ...
    def Deny(self):
        ...
        Deny(self: PermissionSet)
            Causes any System.Security.PermissionSet.Demand that passes through the 
             calling code for a permission that has an intersection with a permission of a 
             type contained in the current System.Security.PermissionSet to fail.
        """
        pass
    ...
    def IsSubsetOf(self, target):
        ...
        IsSubsetOf(self: PermissionSet, target: PermissionSet) -> bool
            ...
            Determines whether the current System.Security.PermissionSet is a subset of 
    ...
    def PermitOnly(self):
        ...
        PermitOnly(self: PermissionSet)
            Causes any System.Security.PermissionSet.Demand that passes through the 
             calling code for any System.Security.PermissionSet that is not a subset of the 
...
class NamedPermissionSet(PermissionSet):
    ...
    def FromXml(self, et):
        ...
        FromXml(self: NamedPermissionSet, et: SecurityElement)
            Reconstructs a named permission set with a specified state from an XML 
             encoding.
...
class SecurityElement(Object):
    ...
    def Equal(self, other):
        ...
        Equal(self: SecurityElement, other: SecurityElement) -> bool
            ...
            Returns: true if the tag, attribute names and values, child elements, and text fields 
...
class SecurityManager():
    ...
    def GetZoneAndOrigin(zone, origin):
        ...
        GetZoneAndOrigin() -> (ArrayList, ArrayList)
            ...
            Gets the granted zone identity and URL identity permission sets for the 
             current assembly.
        """
        pass
    ...
    def LoadPolicyLevelFromFile(path, type):
        ...
        LoadPolicyLevelFromFile(path: str, type: PolicyLevelType) -> PolicyLevel
            ...
            type: One of the enumeration values that specifies the type of the policy level to 
             be loaded.
    ...
    def SavePolicyLevel(level):
        ...
        SavePolicyLevel(level: PolicyLevel)
            Saves a modified security policy level loaded with 
             System.Security.SecurityManager.LoadPolicyLevelFromFile(System.String,System.Se
             curity.PolicyLevelType).
