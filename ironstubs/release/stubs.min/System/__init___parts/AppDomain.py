class AppDomain(MarshalByRefObject,_AppDomain,IEvidenceFactory):
 ...
 def ClearPrivatePath(self):
  ...
  ClearPrivatePath(self: AppDomain)
   Resets the path that specifies the location of private assemblies to the empty 
    string ("").
  """
  pass
 def ClearShadowCopyPath(self):
  ...
  ClearShadowCopyPath(self: AppDomain)
   Resets the list of directories containing shadow copied assemblies to the empty 
    string ("").
  """
  pass
 def CreateComInstanceFrom(self,*__args):
  ...
  CreateComInstanceFrom(self: AppDomain,assemblyFile: str,typeName: str,hashValue: Array[Byte],hashAlgorithm: AssemblyHashAlgorithm) -> ObjectHandle
   ...
   Creates a new instance of a specified COM type. Parameters specify the name of 
    a file that contains an assembly containing the type and the name of the type.
 ...
 def CreateDomain(friendlyName,securityInfo=None,*__args):
  ...
  CreateDomain(friendlyName: str,securityInfo: Evidence,info: AppDomainSetup) -> AppDomain
   ...
   Creates a new application domain using the specified name,evidence,and 
    application domain setup information.
  
  
   friendlyName: The friendly name of the domain. This friendly name can be displayed in user 
    interfaces to identify the domain. For more information,see 
    System.AppDomain.FriendlyName.
  
   securityInfo: Evidence that establishes the identity of the code that runs in the application 
    domain. Pass null to use the evidence of the current application domain.
  ...
  CreateDomain(friendlyName: str,securityInfo: Evidence,info: AppDomainSetup,grantSet: PermissionSet,*fullTrustAssemblies: Array[StrongName]) -> AppDomain
   ...
   Creates a new application domain using the specified name,evidence,
    application domain setup information,default permission set,and array of 
    fully trusted assemblies.
  
  
   friendlyName: The friendly name of the domain. This friendly name can be displayed in user 
    interfaces to identify the domain. For more information,see the description of 
    System.AppDomain.FriendlyName.
   ...
   fullTrustAssemblies: An array of strong names representing assemblies to be considered fully trusted 
  ...
  CreateDomain(friendlyName: str,securityInfo: Evidence,appBasePath: str,appRelativeSearchPath: str,shadowCopyFiles: bool,adInit: AppDomainInitializer,adInitArgs: Array[str]) -> AppDomain
   ...
   Creates a new application domain with the given name,using evidence,
    application base path,relative search path,and a parameter that specifies 
    whether a shadow copy of an assembly is to be loaded into the application 
    domain. Specifies a callback method that is invoked when the application domain 
    is initialized,and an array of string arguments to pass the callback method.
   ...
   appBasePath: The base directory that the assembly resolver uses to probe for assemblies. For 
    more information,see System.AppDomain.BaseDirectory.
  
   appRelativeSearchPath: The path relative to the base directory where the assembly resolver should 
    probe for private assemblies. For more information,see 
    System.AppDomain.RelativeSearchPath.
  
   shadowCopyFiles: true to load a shadow copy of an assembly into the application domain.
   adInit: An System.AppDomainInitializer delegate that represents a callback method to 
    invoke when the new System.AppDomain object is initialized.
  
   adInitArgs: An array of string arguments to be passed to the callback represented by 
    adInit,when the new System.AppDomain object is initialized.
  
   Returns: The newly created application domain.
  CreateDomain(friendlyName: str,securityInfo: Evidence) -> AppDomain
  
   Creates a new application domain with the given name using the supplied 
    evidence.
 ...
 def CreateInstance(self,assemblyName,typeName,*__args):
  ...
  CreateInstance(self: AppDomain,assemblyName: str,typeName: str,ignoreCase: bool,bindingAttr: BindingFlags,binder: Binder,args: Array[object],culture: CultureInfo,activationAttributes: Array[object],securityAttributes: Evidence) -> ObjectHandle
   ...
   Creates a new instance of the specified type defined in the specified assembly. 
    Parameters specify a binder,binding flags,constructor arguments,
    culture-specific information used to interpret arguments,activation 
    attributes,and authorization to create the type.
  ...
  CreateInstance(self: AppDomain,assemblyName: str,typeName: str,ignoreCase: bool,bindingAttr: BindingFlags,binder: Binder,args: Array[object],culture: CultureInfo,activationAttributes: Array[object]) -> ObjectHandle
   ...
   Creates a new instance of the specified type defined in the specified assembly. 
    Parameters specify a binder,binding flags,constructor arguments,
    culture-specific information used to interpret arguments,and optional 
 ...
 def CreateInstanceAndUnwrap(self,assemblyName,typeName,*__args):
  ...
  CreateInstanceAndUnwrap(self: AppDomain,assemblyName: str,typeName: str,ignoreCase: bool,bindingAttr: BindingFlags,binder: Binder,args: Array[object],culture: CultureInfo,activationAttributes: Array[object],securityAttributes: Evidence) -> object
   ...
   Creates a new instance of the specified type. Parameters specify the name of 
    the type,and how it is found and created.
   ...
   culture: A culture-specific object used to govern the coercion of types. If culture is 
    null,the CultureInfo for the current thread is used.
  ...
  CreateInstanceAndUnwrap(self: AppDomain,assemblyName: str,typeName: str,activationAttributes: Array[object]) -> object
   ...
   Creates a new instance of the specified type. Parameters specify the assembly 
    where the type is defined,the name of the type,and an array of activation 
    attributes.
 ...
 def CreateInstanceFromAndUnwrap(self,*__args):
  ...
  CreateInstanceFromAndUnwrap(self: AppDomain,assemblyFile: str,typeName: str,ignoreCase: bool,bindingAttr: BindingFlags,binder: Binder,args: Array[object],culture: CultureInfo,activationAttributes: Array[object]) -> object
   ...
   Creates a new instance of the specified type defined in the specified assembly 
    file,specifying whether the case of the type name is ignored; the binding 
    attributes and the binder that are used to select the type to be created; the 
    arguments of the constructor; the culture; and the activation attributes.
  ...
  CreateInstanceFromAndUnwrap(self: AppDomain,assemblyName: str,typeName: str,activationAttributes: Array[object]) -> object
   ...
   assemblyName: The file name and path of the assembly that defines the requested type.
   typeName: The fully qualified name of the requested type,including the namespace but not 
    the assembly (see the System.Type.FullName property).
 ...
 def DefineDynamicAssembly(self,name,access,*__args):
  ...
  DefineDynamicAssembly(self: AppDomain,name: AssemblyName,access: AssemblyBuilderAccess,dir: str,evidence: Evidence,requiredPermissions: PermissionSet,optionalPermissions: PermissionSet,refusedPermissions: PermissionSet) -> AssemblyBuilder
   ...
   Defines a dynamic assembly using the specified name,access mode,storage 
    directory,evidence,and permission requests.
  ...
  DefineDynamicAssembly(self: AppDomain,name: AssemblyName,access: AssemblyBuilderAccess,dir: str,requiredPermissions: PermissionSet,optionalPermissions: PermissionSet,refusedPermissions: PermissionSet) -> AssemblyBuilder
   ...
   Defines a dynamic assembly using the specified name,access mode,storage 
    directory,and permission requests.
  ...
  DefineDynamicAssembly(self: AppDomain,name: AssemblyName,access: AssemblyBuilderAccess,dir: str,evidence: Evidence,requiredPermissions: PermissionSet,optionalPermissions: PermissionSet,refusedPermissions: PermissionSet,isSynchronized: bool) -> AssemblyBuilder
   ...
   Defines a dynamic assembly using the specified name,access mode,storage 
    directory,evidence,permission requests,and synchronization option.
  ...
  DefineDynamicAssembly(self: AppDomain,name: AssemblyName,access: AssemblyBuilderAccess,requiredPermissions: PermissionSet,optionalPermissions: PermissionSet,refusedPermissions: PermissionSet) -> AssemblyBuilder
   ...
   Defines a dynamic assembly using the specified name,access mode,and 
    permission requests.
  ...
  DefineDynamicAssembly(self: AppDomain,name: AssemblyName,access: AssemblyBuilderAccess,dir: str) -> AssemblyBuilder
   ...
   Defines a dynamic assembly using the specified name,access mode,and storage 
    directory.
 ...
 def ExecuteAssembly(self,assemblyFile,*__args):
  ...
  ExecuteAssembly(self: AppDomain,assemblyFile: str,args: Array[str]) -> int
   ...
   Executes the assembly contained in the specified file,using the specified 
    arguments.
  ...
  ExecuteAssembly(self: AppDomain,assemblyFile: str,assemblySecurity: Evidence,args: Array[str],hashValue: Array[Byte],hashAlgorithm: AssemblyHashAlgorithm) -> int
   ...
   Executes the assembly contained in the specified file,using the specified 
    evidence,arguments,hash value,and hash algorithm.
 ...
 def ExecuteAssemblyByName(self,assemblyName,*__args):
  ...
  ExecuteAssemblyByName(self: AppDomain,assemblyName: AssemblyName,assemblySecurity: Evidence,*args: Array[str]) -> int
   ...
   Executes the assembly given an System.Reflection.AssemblyName,using the 
    specified evidence and arguments.
  ...
  ExecuteAssemblyByName(self: AppDomain,assemblyName: str,assemblySecurity: Evidence,*args: Array[str]) -> int
   ...
   Executes the assembly given its display name,using the specified evidence and 
    arguments.
 ...
 def InitializeLifetimeService(self):
  ...
  InitializeLifetimeService(self: AppDomain) -> object
   ...
   Gives the System.AppDomain an infinite lifetime by preventing a lease from 
    being created.
 ...
 def IsCompatibilitySwitchSet(self,value):
  ...
  IsCompatibilitySwitchSet(self: AppDomain,value: str) -> Nullable[bool]
   ...
   Returns: A null reference (Nothing in Visual Basic) if no compatibility switches are 
    set; otherwise,a Boolean value that indicates whether the compatibility switch 
    that is specified by value is set.
  """
  pass
 def IsDefaultAppDomain(self):
  ...
  IsDefaultAppDomain(self: AppDomain) -> bool
   ...
   Returns: true if the current System.AppDomain object represents the default application 
    domain for the process; otherwise,false.
  """
  pass
 def IsFinalizingForUnload(self):
  ...
  IsFinalizingForUnload(self: AppDomain) -> bool
   ...
   Returns: true if this application domain is unloading and the common language runtime 
    has started invoking finalizers; otherwise,false.
  """
  pass
 def Load(self,*__args):
  ...
  Load(self: AppDomain,rawAssembly: Array[Byte],rawSymbolStore: Array[Byte],securityEvidence: Evidence) -> Assembly
   ...
   Loads the System.Reflection.Assembly with a common object file format (COFF) 
    based image containing an emitted System.Reflection.Assembly. The raw bytes 
    representing the symbols for the System.Reflection.Assembly are also loaded.
 ...
 def ReflectionOnlyGetAssemblies(self):
  ...
  ReflectionOnlyGetAssemblies(self: AppDomain) -> Array[Assembly]
   ...
   Returns: An array of System.Reflection.Assembly objects that represent the assemblies 
    loaded into the reflection-only context of the application domain.
  """
  pass
 ...
 def SetData(self,name,data,permission=None):
  ...
  SetData(self: AppDomain,name: str,data: object,permission: IPermission)
   Assigns the specified value to the specified application domain property,with 
    a specified permission to demand of the caller when the property is retrieved.
 ...
 def SetDynamicBase(self,path):
  ...
  SetDynamicBase(self: AppDomain,path: str)
   ...
   path: The fully qualified path that is the base directory for subdirectories where 
    dynamic assemblies are stored.
  """
  pass
