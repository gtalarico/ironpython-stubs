class TextRenderer(object):
 ...
 def MeasureText(*__args):
  ...
  MeasureText(text: str,font: Font) -> Size
   ...
   Returns: The System.Drawing.Size,in pixels,of text drawn on a single line with the specified font. You can manipulate how the text is drawn by using one of the System.Windows.Forms.TextRenderer.DrawText(System.Drawing.IDeviceContext,System.String,System.Drawing.Font,System.Drawing.Rectangle,System.Drawing.Color,System.Windows.Forms.TextFormatFlags) overloads that takes a System.Windows.Forms.TextFormatFlags 
    parameter. For example,the default behavior of the System.Windows.Forms.TextRenderer is to add padding to the bounding rectangle of the drawn text to accommodate overhanging glyphs. If you need to draw a line of text without these extra spaces you should use the versions of 
    System.Windows.Forms.TextRenderer.DrawText(System.Drawing.IDeviceContext,System.String,System.Drawing.Font,System.Drawing.Point,System.Drawing.Color) and System.Windows.Forms.TextRenderer.MeasureText(System.Drawing.IDeviceContext,System.String,System.Drawing.Font) that take a System.Drawing.Size and System.Windows.Forms.TextFormatFlags parameter. For an example,see 
