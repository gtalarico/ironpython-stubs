class DoubleAnimationUsingPath(DoubleAnimationBase,ISealable,IAnimatable,IResource):
 ...
 def Clone(self):
  ...
  Clone(self: DoubleAnimationUsingPath) -> DoubleAnimationUsingPath
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.DoubleAnimationUsingPath,making deep copies of 
 ...
 def OnChanged(self,*args):
  ...
  OnChanged(self: DoubleAnimationUsingPath)
   Called when this System.Windows.Media.Animation.DoubleAnimationUsingPath is 
    modified.
  """
  pass
