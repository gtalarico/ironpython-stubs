class DependencyProperty(object):
    ...
    def AddOwner(self, ownerType, typeMetadata=None):
        ...
        AddOwner(self: DependencyProperty, ownerType: Type, typeMetadata: PropertyMetadata) -> DependencyProperty
            ...
            typeMetadata: The metadata that qualifies the dependency property as it exists on the provided type.
            Returns: A reference to the original System.Windows.DependencyProperty identifier that identifies the dependency property. This identifier should be exposed by the adding class as a public�static�readonly field.
    ...
    def GetMetadata(self, *__args):
        ...
        GetMetadata(self: DependencyProperty, dependencyObjectType: DependencyObjectType) -> PropertyMetadata
            ...
            dependencyObjectType: A specific object that records the dependency object type from which the dependency property metadata is desired.
        ...
        GetMetadata(self: DependencyProperty, dependencyObject: DependencyObject) -> PropertyMetadata
            ...
            dependencyObject: A dependency object that is checked for type, to determine which type-specific version of the dependency property the metadata should come from.
            Returns: A property metadata object.
    ...
    def IsValidType(self, value):
        ...
        IsValidType(self: DependencyProperty, value: object) -> bool
            ...
            Returns: true if the specified value is the registered property type or an acceptable derived type; otherwise, false.
        """
        pass
    ...
    def IsValidValue(self, value):
        ...
        IsValidValue(self: DependencyProperty, value: object) -> bool
            ...
            value: The value to check.
            Returns: true if the value is acceptable and is of the correct type or a derived type; otherwise, false.
        """
        pass
    ...
    def OverrideMetadata(self, forType, typeMetadata, key=None):
        ...
        OverrideMetadata(self: DependencyProperty, forType: Type, typeMetadata: PropertyMetadata, key: DependencyPropertyKey)
            Supplies alternate metadata for a read-only dependency property when it is present on instances of a specified type, overriding the metadata that was provided in the initial dependency property 
             registration. You must pass the System.Windows.DependencyPropertyKey for the read-only dependency property to avoid raising an exception.
        
        
            forType: The type where this dependency property is inherited and where the provided alternate metadata will be applied.
        ...
        OverrideMetadata(self: DependencyProperty, forType: Type, typeMetadata: PropertyMetadata)
            Specifies alternate metadata for this dependency property when it is present on instances of a specified type, overriding the metadata that existed for the dependency property as it was inherited from base 
             types.
    ...
    def Register(name, propertyType, ownerType, typeMetadata=None, validateValueCallback=None):
        ...
        Register(name: str, propertyType: Type, ownerType: Type, typeMetadata: PropertyMetadata, validateValueCallback: ValidateValueCallback) -> DependencyProperty
            ...
            validateValueCallback: A reference to a callback that should perform any custom validation of the dependency property value beyond typical type validation.
            Returns: A dependency property identifier that should be used to set the value of a public�static�readonly field in your class. That identifier is then used to reference the dependency property later, for 
        ...
        Register(name: str, propertyType: Type, ownerType: Type) -> DependencyProperty
            ...
            name: The name of the dependency property to register. The name must be unique within the registration namespace of the owner type.
            propertyType: The type of the property.
            ownerType: The owner type that is registering the dependency property.
            Returns: A dependency property identifier that should be used to set the value of a public static readonly field in your class. That identifier is then used to reference the dependency property later, for 
             operations such as setting its value programmatically or obtaining metadata.
    ...
    def RegisterAttached(name, propertyType, ownerType, defaultMetadata=None, validateValueCallback=None):
        ...
        RegisterAttached(name: str, propertyType: Type, ownerType: Type, defaultMetadata: PropertyMetadata, validateValueCallback: ValidateValueCallback) -> DependencyProperty
            ...
            propertyType: The type of the property.
            ownerType: The owner type that is registering the dependency property.
            defaultMetadata: Property metadata for the dependency property. This can include the default value as well as other characteristics.
            validateValueCallback: A reference to a callback that should perform any custom validation of the dependency property value beyond typical type validation.
            Returns: A dependency property identifier that should be used to set the value of a public static readonly field in your class. That identifier is then used to reference the dependency property later, for 
             operations such as setting its value programmatically or obtaining metadata.
    ...
    def RegisterAttachedReadOnly(name, propertyType, ownerType, defaultMetadata, validateValueCallback=None):
        ...
        RegisterAttachedReadOnly(name: str, propertyType: Type, ownerType: Type, defaultMetadata: PropertyMetadata, validateValueCallback: ValidateValueCallback) -> DependencyPropertyKey
            ...
            validateValueCallback: A reference to a user-created callback that should perform any custom validation of the dependency property value beyond typical type validation.
            Returns: A dependency property key that should be used to set the value of a static read-only field in your class, which is then used to reference the dependency property.
        RegisterAttachedReadOnly(name: str, propertyType: Type, ownerType: Type, defaultMetadata: PropertyMetadata) -> DependencyPropertyKey
            ...
            ownerType: The owner type that is registering the dependency property.
            defaultMetadata: Property metadata for the dependency property.
            Returns: A dependency property key that should be used to set the value of a static read-only field in your class, which is then used to reference the dependency property later.
        """
        pass
