class Canvas(Panel, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def ArrangeOverride(self, *args): #cannot find CLR method
        ...
        ArrangeOverride(self: Canvas, arrangeSize: Size) -> Size
            ...
            arrangeSize: The size that this System.Windows.Controls.Canvas element should use to arrange its child elements.
            Returns: A System.Windows.Size that represents the arranged size of this System.Windows.Controls.Canvas element and its descendants.
        """
        pass
    ...
    def GetLayoutClip(self, *args): #cannot find CLR method
        ...
        GetLayoutClip(self: Canvas, layoutSlotSize: Size) -> Geometry
            ...
            Returns a clipping geometry that indicates the area that will be clipped if the System.Windows.UIElement.ClipToBounds property is set to true.
        
            layoutSlotSize: The available size of the element.
            Returns: A System.Windows.Media.Geometry that represents the area that is clipped if System.Windows.UIElement.ClipToBounds is true.
        """
        pass
