class KeysConverter(TypeConverter, IComparer):
    ...
    def CanConvertFrom(self, *__args):
        ...
        CanConvertFrom(self: KeysConverter, context: ITypeDescriptorContext, sourceType: Type) -> bool
            ...
            context: An System.ComponentModel.ITypeDescriptorContext that provides a format context, which can be used to extract additional information about the environment this converter is being invoked from. This 
    ...
    def ConvertFrom(self, *__args):
        ...
        ConvertFrom(self: KeysConverter, context: ITypeDescriptorContext, culture: CultureInfo, value: object) -> object
            ...
            context: An ITypeDescriptorContext that provides a format context, which can be used to extract additional information about the environment this converter is being invoked from. This parameter or properties of 
    ...
    def GetStandardValuesExclusive(self, context=None):
        ...
        GetStandardValuesExclusive(self: KeysConverter, context: ITypeDescriptorContext) -> bool
            ...
            context: A formatter context. This object can be used to extract additional information about the environment this converter is being invoked from. This may be null, so you should always check. Also, properties on 
             the context object may also return null.
        
            Returns: true if the collection returned from erload:System.Windows.Forms.KeysConverter.GetStandardValues is an exhaustive list of possible values; otherwise, false if other values are possible. The default 
