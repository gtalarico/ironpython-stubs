class IItemContainerGenerator:
    ...
    def GenerateNext(self, isNewlyRealized=None):
        ...
        GenerateNext(self: IItemContainerGenerator) -> (DependencyObject, bool)
            ...
            Returns: A System.Windows.DependencyObject that is the container element which is used to display the next item.
    ...
    def GeneratorPositionFromIndex(self, itemIndex):
        ...
        GeneratorPositionFromIndex(self: IItemContainerGenerator, itemIndex: int) -> GeneratorPosition
            ...
            Returns the System.Windows.Controls.Primitives.GeneratorPosition object that maps to the item at the specified index.
        
            itemIndex: The index of desired item.
            Returns: An System.Windows.Controls.Primitives.GeneratorPosition object that maps to the item at the specified index.
        """
        pass
    ...
    def GetItemContainerGeneratorForPanel(self, panel):
        ...
        GetItemContainerGeneratorForPanel(self: IItemContainerGenerator, panel: Panel) -> ItemContainerGenerator
            ...
            Returns the System.Windows.Controls.ItemContainerGenerator appropriate for use by the specified panel.
    ...
    def IndexFromGeneratorPosition(self, position):
        ...
        IndexFromGeneratorPosition(self: IItemContainerGenerator, position: GeneratorPosition) -> int
            ...
            position: The index of desired item.The System.Windows.Controls.Primitives.GeneratorPosition  for the desired index.
            Returns: An System.Int32 that is the index which maps to the specified System.Windows.Controls.Primitives.GeneratorPosition.
        """
        pass
    ...
    def PrepareItemContainer(self, container):
        ...
        PrepareItemContainer(self: IItemContainerGenerator, container: DependencyObject)
            ...
            container: The container to prepare. Normally, container is the result of the previous call to erload:System.Windows.Controls.Primitives.IItemContainerGenerator.GenerateNext.
        """
        pass
    ...
    def Remove(self, position, count):
        ...
        Remove(self: IItemContainerGenerator, position: GeneratorPosition, count: int)
            ...
            position: The System.Int32 index of the element to remove. position must refer to a previously generated (realized) item, which means its offset must be zero.
    ...
    def StartAt(self, position, direction, allowStartAtRealizedItem=None):
        ...
        StartAt(self: IItemContainerGenerator, position: GeneratorPosition, direction: GeneratorDirection, allowStartAtRealizedItem: bool) -> IDisposable
            ...
            Prepares the generator to generate items, starting at the specified System.Windows.Controls.Primitives.GeneratorPosition, and in the specified System.Windows.Controls.Primitives.GeneratorDirection, and 
             controlling whether or not to start at a generated (realized) item.
        
        
            position: A System.Windows.Controls.Primitives.GeneratorPosition, that specifies the position of the item to start generating items at.
        ...
        StartAt(self: IItemContainerGenerator, position: GeneratorPosition, direction: GeneratorDirection) -> IDisposable
            ...
            Prepares the generator to generate items, starting at the specified System.Windows.Controls.Primitives.GeneratorPosition, and in the specified System.Windows.Controls.Primitives.GeneratorDirection.
        
            position: A System.Windows.Controls.Primitives.GeneratorPosition, that specifies the position of the item to start generating items at.
            direction: A System.Windows.Controls.Primitives.GeneratorDirection that specifies the direction which to generate items.
            Returns: An System.IDisposable object that tracks the lifetime of the generation process.
        """
        pass
