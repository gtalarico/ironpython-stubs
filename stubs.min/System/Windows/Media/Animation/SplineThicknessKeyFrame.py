class SplineThicknessKeyFrame(ThicknessKeyFrame, ISealable, IKeyFrame):
    """
    Animates from the System.Windows.Thickness value of the previous key frame to its own System.Windows.Media.Animation.ThicknessKeyFrame.Value using splined interpolation.
    
    SplineThicknessKeyFrame()
    SplineThicknessKeyFrame(value: Thickness)
    SplineThicknessKeyFrame(value: Thickness, keyTime: KeyTime)
    SplineThicknessKeyFrame(value: Thickness, keyTime: KeyTime, keySpline: KeySpline)
    """
    ...
    def CreateInstanceCore(self, *args): #cannot find CLR method
        """
        CreateInstanceCore(self: SplineThicknessKeyFrame) -> Freezable
        
            Creates a new instance of System.Windows.Media.Animation.SplineThicknessKeyFrame.
            Returns: A new System.Windows.Media.Animation.SplineThicknessKeyFrame.
        """
        pass
    ...
    def InterpolateValueCore(self, *args): #cannot find CLR method
        """
        InterpolateValueCore(self: SplineThicknessKeyFrame, baseValue: Thickness, keyFrameProgress: float) -> Thickness
    ...
    def __new__(self, value=None, keyTime=None, keySpline=None):
        ...
        __new__(cls: type, value: Thickness, keyTime: KeyTime, keySpline: KeySpline)
        """
        pass

    KeySpline = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the two control points that define animation progress for this key frame.

Get: KeySpline(self: SplineThicknessKeyFrame) -> KeySpline

Set: KeySpline(self: SplineThicknessKeyFrame) = value
"""
