class DockPanel(Panel, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def ArrangeOverride(self, *args): #cannot find CLR method
        ...
        ArrangeOverride(self: DockPanel, arrangeSize: Size) -> Size
            ...
            Returns: The System.Windows.Size that represents the arranged size of this System.Windows.Controls.DockPanel element.
        """
        pass
    ...
    def GetDock(element):
        ...
        GetDock(element: UIElement) -> Dock
            ...
            Gets the value of the System.Windows.Controls.DockPanel.Dock�attached property for a specified System.Windows.UIElement.
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: DockPanel, constraint: Size) -> Size
            ...
            Measures the child elements of a System.Windows.Controls.DockPanel prior to arranging them during the System.Windows.Controls.DockPanel.ArrangeOverride(System.Windows.Size) pass.
...
"""
    ...
    LastChildFill = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
