...
class PurchaseOrders_GetHistoryLinesTableAdapter:
    ...
    Adapter = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ClearBeforeFill = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CommandCollection = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
class TableAdapterManager:
    ...
    def MatchTableAdapterConnection(self, *args): #cannot find CLR method
    ...
    def SortSelfReferenceRows(self, *args): #cannot find CLR method
    ...
    BackupDataSetBeforeUpdate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    TableAdapterInstanceCount = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: TableAdapterInstanceCount(self: TableAdapterManager) -> int

"""

    UpdateOrder = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
