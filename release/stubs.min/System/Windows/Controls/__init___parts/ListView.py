class ListView(ListBox,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 ...
 def ClearContainerForItemOverride(self,*args):
  ...
  ClearContainerForItemOverride(self: ListView,element: DependencyObject,item: object)
   Removes all templates,styles,and bindings for the object that is displayed as 
    a System.Windows.Controls.ListViewItem.
 ...
 def OnItemsChanged(self,*args):
  ...
  OnItemsChanged(self: ListView,e: NotifyCollectionChangedEventArgs)
   Responds to an 
    System.Windows.Controls.ItemsControl.OnItemsChanged(System.Collections.Specializ
    ed.NotifyCollectionChangedEventArgs).
 ...
 def PrepareContainerForItemOverride(self,*args):
  ...
  PrepareContainerForItemOverride(self: ListView,element: DependencyObject,item: object)
   ...
   element: An object that is a System.Windows.Controls.ListViewItem or that can be 
    converted into one.
