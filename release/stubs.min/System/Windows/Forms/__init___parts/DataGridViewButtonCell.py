class DataGridViewButtonCell:
 ...
 def CreateAccessibilityInstance(self,*args):
  ...
  CreateAccessibilityInstance(self: DataGridViewButtonCell) -> AccessibleObject
   ...
   Returns: A new System.Windows.Forms.DataGridViewButtonCell.DataGridViewButtonCellAccessibleObject 
    for the System.Windows.Forms.DataGridViewButtonCell.
  """
  pass
 def Dispose(self):
  """
 ...
 def KeyDownUnsharesRow(self,*args):
  ...
  KeyDownUnsharesRow(self: DataGridViewButtonCell,e: KeyEventArgs,rowIndex: int) -> bool
   ...
   Indicates whether a row is unshared if a key is pressed while the focus is on a cell in 
    the row.
 ...
 def KeyUpUnsharesRow(self,*args):
  ...
  KeyUpUnsharesRow(self: DataGridViewButtonCell,e: KeyEventArgs,rowIndex: int) -> bool
   ...
   Indicates whether a row is unshared when a key is released while the focus is on a cell 
    in the row.
