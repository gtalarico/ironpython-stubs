class AccessibleObject:
 ...
 def GetFocused(self):
  ...
  GetFocused(self: AccessibleObject) -> AccessibleObject
   ...
   Returns: An System.Windows.Forms.AccessibleObject that specifies the currently focused child. This 
    method returns the calling object if the object itself is focused. Returns null if no 
    object has focus.
  """
  pass
 def GetHelpTopic(self,fileName):
  ...
  GetHelpTopic(self: AccessibleObject) -> (int,str)
   ...
   Gets an identifier for a Help topic identifier and the path to the Help file associated 
 ...
 def GetSelected(self):
  ...
  GetSelected(self: AccessibleObject) -> AccessibleObject
   ...
   Returns: An System.Windows.Forms.AccessibleObject that represents the currently selected child. 
    This method returns the calling object if the object itself is selected. Returns null if 
    is no child is currently selected and the object itself does not have focus.
  """
  pass
 def HitTest(self,x,y):
  ...
  HitTest(self: AccessibleObject,x: int,y: int) -> AccessibleObject
   ...
   Returns: An System.Windows.Forms.AccessibleObject that represents the child object at the given 
    screen coordinates. This method returns the calling object if the object itself is at the 
    location specified. Returns null if no object is at the tested location.
  """
  pass
 ...
 def UseStdAccessibleObjects(self,*args):
  ...
  UseStdAccessibleObjects(self: AccessibleObject,handle: IntPtr)
   Associates an object with an instance of an System.Windows.Forms.AccessibleObject based 
  ...
  UseStdAccessibleObjects(self: AccessibleObject,handle: IntPtr,objid: int)
   Associates an object with an instance of an System.Windows.Forms.AccessibleObject based 
    on the handle and the object id of the object.
