class TimelineCollection(Animatable, ISealable, IAnimatable, IResource, IList, ICollection, IEnumerable, IList[Timeline], ICollection[Timeline], IEnumerable[Timeline]):
    ...
    def Add(self, value):
        ...
        Add(self: TimelineCollection, value: Timeline)
            Inserts a new System.Windows.Media.Animation.Timeline object into the System.Windows.Media.Animation.TimelineCollection.
    ...
    def Clone(self):
        ...
        Clone(self: TimelineCollection) -> TimelineCollection
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.TimelineCollection, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
    ...
    def CloneCurrentValue(self):
        ...
        CloneCurrentValue(self: TimelineCollection) -> TimelineCollection
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.TimelineCollection object, making deep copies of this object's current values. Resource references, data bindings, and animations are not 
    ...
    def Contains(self, value):
        ...
        Contains(self: TimelineCollection, value: Timeline) -> bool
            ...
            Determines whether the System.Windows.Media.Animation.TimelineCollection contains the specified System.Windows.Media.Animation.Timeline object.
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: TimelineCollection, array: Array[Timeline], index: int)
            Copies the items of the System.Windows.Media.Animation.TimelineCollection to the passed Timeline array, starting at the specified index position.
    ...
    def IndexOf(self, value):
        ...
        IndexOf(self: TimelineCollection, value: Timeline) -> int
            ...
            Gets the zero-based index position of a Timeline object in the System.Windows.Media.Animation.TimelineCollection.
    ...
    def Insert(self, index, value):
        ...
        Insert(self: TimelineCollection, index: int, value: Timeline)
            Inserts the specified Timeline object into this System.Windows.Media.Animation.TimelineCollection at the specified index position.
    ...
    def Remove(self, value):
        ...
        Remove(self: TimelineCollection, value: Timeline) -> bool
            ...
            Removes the first occurrence of a specified System.Windows.Media.Animation.Timeline from this System.Windows.Media.Animation.TimelineCollection.
    ...
    def RemoveAt(self, index):
        ...
        RemoveAt(self: TimelineCollection, index: int)
            Removes the System.Windows.Media.Animation.Timeline at the specified index position from this System.Windows.Media.Animation.TimelineCollection.
