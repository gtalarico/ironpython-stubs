class ListItem(TextElement, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild):
    """
    A flow content element that represents a particular content item in an ordered or unordered System.Windows.Documents.List.
    ...
    def ShouldSerializeBlocks(self, manager):
        """
        ShouldSerializeBlocks(self: ListItem, manager: XamlDesignerSerializationManager) -> bool
        
            Returns a value that indicates whether the effective value of the System.Windows.Documents.ListItem.Blocks property should be serialized during serialization of the System.Windows.Documents.ListItem object.
        
            manager: A serialization service manager object for the object.
            Returns: true if the System.Windows.Documents.ListItem.Blocks property should be serialized; otherwise, false.
        """
        pass
    ...
    def __new__(self, paragraph=None):
        """
        __new__(cls: type)
        __new__(cls: type, paragraph: Paragraph)
        """
        pass

    Blocks = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a block collection that contains the top-level System.Windows.Documents.Block elements of the System.Windows.Documents.ListItem.

Get: Blocks(self: ListItem) -> BlockCollection
...
Get: BorderBrush(self: ListItem) -> Brush

Set: BorderBrush(self: ListItem) = value
"""
...
Get: BorderThickness(self: ListItem) -> Thickness

Set: BorderThickness(self: ListItem) = value
"""
...
"""
    ...
    """Gets or sets the relative direction for flow of content within a System.Windows.Documents.ListItem element.

Get: FlowDirection(self: ListItem) -> FlowDirection

Set: FlowDirection(self: ListItem) = value
"""
...
Get: LineHeight(self: ListItem) -> float

Set: LineHeight(self: ListItem) = value
"""

    LineStackingStrategy = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the mechanism by which a line box is determined for each line of text within the System.Windows.Documents.ListItem.

Get: LineStackingStrategy(self: ListItem) -> LineStackingStrategy

Set: LineStackingStrategy(self: ListItem) = value
"""

    List = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the System.Windows.Documents.List that contains the System.Windows.Documents.ListItem.

Get: List(self: ListItem) -> List
...
Get: Margin(self: ListItem) -> Thickness

Set: Margin(self: ListItem) = value
"""

    NextListItem = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the next System.Windows.Documents.ListItem in the containing System.Windows.Documents.List.

Get: NextListItem(self: ListItem) -> ListItem
...
Get: Padding(self: ListItem) -> Thickness

Set: Padding(self: ListItem) = value
"""

    PreviousListItem = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the previous System.Windows.Documents.ListItem in the containing System.Windows.Documents.List.

Get: PreviousListItem(self: ListItem) -> ListItem

"""

    SiblingListItems = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a System.Windows.Documents.ListItemCollection that contains the System.Windows.Documents.ListItem elements that are siblings of the current System.Windows.Documents.ListItem element.

Get: SiblingListItems(self: ListItem) -> ListItemCollection
...
Get: TextAlignment(self: ListItem) -> TextAlignment

Set: TextAlignment(self: ListItem) = value
"""
