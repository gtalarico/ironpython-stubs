class CharKeyFrameCollection(Freezable, ISealable, IList, ICollection, IEnumerable):
    ...
    def Clone(self):
        ...
        Clone(self: CharKeyFrameCollection) -> CharKeyFrameCollection
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.CharKeyFrameCollection, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: CharKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.CharKeyFrameCollection. When copying dependency properties, this method copies resource references and data bindings (but 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: CharKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.CharKeyFrameCollection using current property values. Resource references, data bindings, and animations are not 
    ...
    def Contains(self, keyFrame):
        ...
        Contains(self: CharKeyFrameCollection, keyFrame: CharKeyFrame) -> bool
            ...
            Gets a value that indicates whether the collection contains the specified System.Windows.Media.Animation.CharKeyFrame.
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: CharKeyFrameCollection, array: Array[CharKeyFrame], index: int)
            Copies all of the System.Windows.Media.Animation.CharKeyFrame objects in a collection to a specified array.
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: CharKeyFrameCollection, isChecking: bool) -> bool
            ...
            Makes this System.Windows.Media.Animation.CharKeyFrameCollection read-only or determines whether it can be made read-only.
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: CharKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.CharKeyFrameCollection object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: CharKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.CharKeyFrameCollection. Resource references, data bindings, and animations are not copied, but their current values are.
    ...
    def IndexOf(self, keyFrame):
        ...
        IndexOf(self: CharKeyFrameCollection, keyFrame: CharKeyFrame) -> int
            ...
            Searches for the specified System.Windows.Media.Animation.CharKeyFrame and returns the zero-based index of the first occurrence within the entire collection.
    ...
    def Insert(self, index, keyFrame):
        ...
        Insert(self: CharKeyFrameCollection, index: int, keyFrame: CharKeyFrame)
            Inserts a System.Windows.Media.Animation.CharKeyFrame into a specific location within the collection.
    ...
    def RemoveAt(self, index):
        ...
        RemoveAt(self: CharKeyFrameCollection, index: int)
            Removes the System.Windows.Media.Animation.CharKeyFrame at the specified index position from the collection.
