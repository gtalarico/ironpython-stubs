class Vector3DAnimation(Vector3DAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: Vector3DAnimation) -> Vector3DAnimation
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Vector3DAnimation, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: Vector3DAnimation, defaultOriginValue: Vector3D, defaultDestinationValue: Vector3D, animationClock: AnimationClock) -> Vector3D
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.Vector3DAnimation.
