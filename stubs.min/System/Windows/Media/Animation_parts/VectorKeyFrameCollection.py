class VectorKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: VectorKeyFrameCollection,keyFrame: VectorKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.VectorKeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.VectorKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: VectorKeyFrameCollection)
   Removes all System.Windows.Media.Animation.VectorKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: VectorKeyFrameCollection) -> VectorKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.VectorKeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: VectorKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.VectorKeyFrameCollection. When copying 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: VectorKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.VectorKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: VectorKeyFrameCollection,array: Array[VectorKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.VectorKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: VectorKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.VectorKeyFrameCollection 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: VectorKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.VectorKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: VectorKeyFrameCollection,keyFrame: VectorKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.VectorKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: VectorKeyFrameCollection,index: int,keyFrame: VectorKeyFrame)
   Inserts a System.Windows.Media.Animation.VectorKeyFrame into a specific 
    location within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.VectorKeyFrame 
    is inserted.
  
   keyFrame: The System.Windows.Media.Animation.VectorKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: VectorKeyFrameCollection,keyFrame: VectorKeyFrame)
   Removes a System.Windows.Media.Animation.VectorKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.VectorKeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: VectorKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.VectorKeyFrame at the specified 
    index position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.VectorKeyFrame to be 
    removed.
  """
  pass
