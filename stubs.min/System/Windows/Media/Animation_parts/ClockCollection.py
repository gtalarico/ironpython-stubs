class ClockCollection(object, ICollection[Clock], IEnumerable[Clock], IEnumerable):
    ...
    def Add(self, item):
        ...
        Add(self: ClockCollection, item: Clock)
            Adds a new System.Windows.Media.Animation.Clock object to the end of this System.Windows.Media.Animation.ClockCollection.
    ...
    def Contains(self, item):
        ...
        Contains(self: ClockCollection, item: Clock) -> bool
            ...
            Indicates whether the System.Windows.Media.Animation.ClockCollection contains the specified System.Windows.Media.Animation.Clock object.
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: ClockCollection, array: Array[Clock], index: int)
            Copies the System.Windows.Media.Animation.Clock objects of this System.Windows.Media.Animation.ClockCollection to an array of Clocks, starting at the specified index position.
    ...
    def Equals(self, *__args):
        ...
        Equals(objA: ClockCollection, objB: ClockCollection) -> bool
            ...
            Indicates whether the two specified System.Windows.Media.Animation.ClockCollection collections are equal.
    ...
    def Remove(self, item):
        ...
        Remove(self: ClockCollection, item: Clock) -> bool
            ...
            Removes the specified System.Windows.Media.Animation.Clock from the System.Windows.Media.Animation.ClockCollection.
