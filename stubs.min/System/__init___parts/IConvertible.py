class IConvertible:
 ...
 def GetTypeCode(self):
  ...
  GetTypeCode(self: IConvertible) -> TypeCode
   ...
   Returns: The enumerated constant that is the System.TypeCode of the class or value type 
 ...
 def ToBoolean(self,provider):
  ...
  ToBoolean(self: IConvertible,provider: IFormatProvider) -> bool
   ...
   provider: An System.IFormatProvider interface implementation that supplies 
 ...
 def ToType(self,conversionType,provider):
  ...
  ToType(self: IConvertible,conversionType: Type,provider: IFormatProvider) -> object
   ...
   Returns: An System.Object instance of type conversionType whose value is equivalent to 
