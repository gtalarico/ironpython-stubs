class MatrixKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: MatrixKeyFrameCollection,keyFrame: MatrixKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.MatrixKeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.MatrixKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: MatrixKeyFrameCollection)
   Removes all System.Windows.Media.Animation.MatrixKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: MatrixKeyFrameCollection) -> MatrixKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.MatrixKeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: MatrixKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.MatrixKeyFrameCollection. When copying 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: MatrixKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.MatrixKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: MatrixKeyFrameCollection,array: Array[MatrixKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.MatrixKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: MatrixKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.MatrixKeyFrameCollection 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: MatrixKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.MatrixKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: MatrixKeyFrameCollection,keyFrame: MatrixKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.MatrixKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: MatrixKeyFrameCollection,index: int,keyFrame: MatrixKeyFrame)
   Inserts a System.Windows.Media.Animation.MatrixKeyFrame into a specific 
    location within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.MatrixKeyFrame 
    is inserted.
  
   keyFrame: The System.Windows.Media.Animation.MatrixKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: MatrixKeyFrameCollection,keyFrame: MatrixKeyFrame)
   Removes a System.Windows.Media.Animation.MatrixKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.MatrixKeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: MatrixKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.MatrixKeyFrame at the specified 
    index position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.MatrixKeyFrame to be 
    removed.
  """
  pass
