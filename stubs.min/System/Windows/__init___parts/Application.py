class Application(DispatcherObject, IHaveResources, IQueryAmbient):
    ...
    def FindResource(self, resourceKey):
        ...
        FindResource(self: Application, resourceKey: object) -> object
            ...
            Searches for a user interface (UI) resource, such as a System.Windows.Style or System.Windows.Media.Brush, with the specified key, and throws an exception if the requested resource is not found (see 
             Resources Overview).
        
        
            resourceKey: The name of the resource to find.
            Returns: The requested resource object. If the requested resource is not found, a System.Windows.ResourceReferenceKeyNotFoundException is thrown.
        """
        pass
    ...
    def GetContentStream(uriContent):
        ...
        GetContentStream(uriContent: Uri) -> StreamResourceInfo
            ...
            Returns a resource stream for a content data file that is located at the specified System.Uri (see WPF Application Resource, Content, and Data Files).
        
            uriContent: The relative System.Uri that maps to a loose resource.
            Returns: A System.Windows.Resources.StreamResourceInfo that contains a content data file that is located at the specified System.Uri. If a loose resource is not found, null is returned.
        """
        pass
    ...
    def GetCookie(uri):
        ...
        GetCookie(uri: Uri) -> str
            ...
            Returns: A System.String value, if the cookie exists; otherwise, a System.ComponentModel.Win32Exception is thrown.
        """
        pass
    ...
    def GetRemoteStream(uriRemote):
        ...
        GetRemoteStream(uriRemote: Uri) -> StreamResourceInfo
            ...
            Returns a resource stream for a site-of-origin data file that is located at the specified System.Uri (see WPF Application Resource, Content, and Data Files).
        
            uriRemote: The System.Uri that maps to a loose resource at the site of origin.
            Returns: A System.Windows.Resources.StreamResourceInfo that contains a resource stream for a site-of-origin data file that is located at the specified System.Uri. If the loose resource is not found, null is 
             returned.
        """
        pass
    ...
    def GetResourceStream(uriResource):
        ...
        GetResourceStream(uriResource: Uri) -> StreamResourceInfo
            ...
            Returns: A System.Windows.Resources.StreamResourceInfo that contains a resource stream for resource data file that is located at the specified System.Uri.
        """
        pass
    ...
    def OnFragmentNavigation(self, *args): #cannot find CLR method
        ...
        OnFragmentNavigation(self: Application, e: FragmentNavigationEventArgs)
            ...
            e: A System.Windows.Navigation.FragmentNavigationEventArgs that contains the event data.
        """
        pass
    ...
    def OnNavigating(self, *args): #cannot find CLR method
        ...
        OnNavigating(self: Application, e: NavigatingCancelEventArgs)
            ...
            e: A System.Windows.Navigation.NavigatingCancelEventArgs that contains the event data.
        """
        pass
    ...
    def OnNavigationFailed(self, *args): #cannot find CLR method
        ...
        OnNavigationFailed(self: Application, e: NavigationFailedEventArgs)
            ...
            e: A System.Windows.Navigation.NavigationFailedEventArgs that contains the event data.
        """
        pass
    ...
    def OnNavigationProgress(self, *args): #cannot find CLR method
        ...
        OnNavigationProgress(self: Application, e: NavigationProgressEventArgs)
            ...
            e: A System.Windows.Navigation.NavigationProgressEventArgs that contains the event data.
        """
        pass
    ...
    def Run(self, window=None):
        ...
        Run(self: Application, window: Window) -> int
            ...
            Returns: The System.Int32 application exit code that is returned to the operating system when the application shuts down. By default, the exit code value is 0.
    ...
    def SetCookie(uri, value):
        ...
        SetCookie(uri: Uri, value: str)
            ...
            uri: The System.Uri that specifies the location for which the cookie should be created.
