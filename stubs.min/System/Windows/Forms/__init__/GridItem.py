class GridItem(object):
    ...
    Expandable = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    GridItems = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    GridItemType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
