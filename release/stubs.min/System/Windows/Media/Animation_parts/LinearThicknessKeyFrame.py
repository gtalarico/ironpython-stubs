class LinearThicknessKeyFrame(ThicknessKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Thickness value of the previous key frame to its own System.Windows.Media.Animation.ThicknessKeyFrame.Value using linear interpolation.
 
 LinearThicknessKeyFrame()
 LinearThicknessKeyFrame(value: Thickness)
 LinearThicknessKeyFrame(value: Thickness,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearThicknessKeyFrame) -> Freezable
  
   Creates a new instance of 
    System.Windows.Media.Animation.LinearThicknessKeyFrame.
  
   Returns: A new System.Windows.Media.Animation.LinearThicknessKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearThicknessKeyFrame,baseValue: Thickness,keyFrameProgress: float) -> Thickness
  
   Interpolates,in a linear fashion,between the previous key frame value and the 
    value of the current key frame,using the supplied progress increment.
