...
class AssociativityRule(DrawingObject):
    ...
    Follow = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    OverlapVithViews = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: OverlapVithViews(self: LayoutTable) -> bool

Set: OverlapVithViews(self: LayoutTable) = value
"""

    RefCorner = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: RefCorner(self: LayoutTable) -> int

Set: RefCorner(self: LayoutTable) = value
"""

    RefTableId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    TableCorner = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: TableCorner(self: LayoutTable) -> int

Set: TableCorner(self: LayoutTable) = value
"""

    TableLayoutId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
