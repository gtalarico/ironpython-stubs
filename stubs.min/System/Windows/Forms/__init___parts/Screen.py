class Screen(object):
    ...
    def FromControl(control):
        ...
        FromControl(control: Control) -> Screen
            ...
            Returns: A System.Windows.Forms.Screen for the display that contains the largest region of the specified control. In multiple display environments where no display contains the control, the display closest to the 
             specified control is returned.
        """
        pass
    ...
    def FromHandle(hwnd):
        ...
        FromHandle(hwnd: IntPtr) -> Screen
            ...
            Returns: A System.Windows.Forms.Screen for the display that contains the largest region of the object. In multiple display environments where no display contains any portion of the specified window, the display 
             closest to the object is returned.
        """
        pass
    ...
    def FromRectangle(rect):
        ...
        FromRectangle(rect: Rectangle) -> Screen
            ...
            Returns: A System.Windows.Forms.Screen for the display that contains the largest region of the specified rectangle. In multiple display environments where no display contains the rectangle, the display closest to 
    ...
    def GetBounds(*__args):
        ...
        GetBounds(ctl: Control) -> Rectangle
            ...
            Returns: A System.Drawing.Rectangle that specifies the bounds of the display that contains the specified control. In multiple display environments where no display contains the specified control, the display 
        ...
        GetBounds(rect: Rectangle) -> Rectangle
            ...
            Returns: A System.Drawing.Rectangle that specifies the bounds of the display that contains the specified rectangle. In multiple display environments where no monitor contains the specified rectangle, the monitor 
        ...
        GetBounds(pt: Point) -> Rectangle
            ...
            Returns: A System.Drawing.Rectangle that specifies the bounds of the display that contains the specified point. In multiple display environments where no display contains the specified point, the display closest to 
    ...
    def GetWorkingArea(*__args):
        ...
        GetWorkingArea(ctl: Control) -> Rectangle
            ...
            Retrieves the working area for the display that contains the largest region of the specified control. The working area is the desktop area of the display, excluding taskbars, docked windows, and docked 
             tool bars.
        ...
        GetWorkingArea(rect: Rectangle) -> Rectangle
            ...
            Retrieves the working area for the display that contains the largest portion of the specified rectangle. The working area is the desktop area of the display, excluding taskbars, docked windows, and docked 
             tool bars.
...
"""
    ...
    WorkingArea = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
