class TextBoxBase:
 ...
 def DeselectAll(self):
  ...
  DeselectAll(self: TextBoxBase)
   Specifies that the value of the System.Windows.Forms.TextBoxBase.SelectionLength property 
 ...
 def ToString(self):
  ...
  ToString(self: TextBoxBase) -> str
   ...
   Returns: A string that represents the current System.Windows.Forms.TextBoxBase. The string 
    includes the type and the System.Windows.Forms.TextBoxBase property of the control.
  """
  pass
 def Undo(self):
  """
