...
class CableTraySizeIterator(object):
...
class CapitalizationForLoadNames(Enum):
    """
...
class CircuitLoadCalculationMethod(Enum):
    """
...
class ConduitSizeIterator(object):
...
class ConduitSizeSettingIterator(object):
    """
...
class ElectricalDemandFactorRule(Enum):
    """
...
class ElectricalDemandFactorValue(object):
    """
...
class ElectricalLoadClassificationData(Enum):
    """
...
class ElectricalLoadClassificationSpace(Enum):
    """
...
class ElectricalPhaseConfiguration(Enum):
    """
...
class LoadClassificationType(Enum):
    """
...
class PanelSchedulePhaseLoadType(Enum):
    """
...
class PowerFactorStateType(Enum):
    """
