class UniformGrid(Panel, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def ArrangeOverride(self, *args): #cannot find CLR method
        ...
        ArrangeOverride(self: UniformGrid, arrangeSize: Size) -> Size
            ...
            Returns: The actual System.Windows.Size of the grid that is rendered to display the child elements that are visible.
        """
        pass
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: UniformGrid, constraint: Size) -> Size
            ...
            Returns: The desired System.Windows.Size based on the child content of the grid and the constraint parameter.
        """
        pass
...
"""
    ...
    FirstColumn = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
