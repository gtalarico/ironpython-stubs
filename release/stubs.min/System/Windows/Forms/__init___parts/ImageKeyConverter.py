class ImageKeyConverter:
 ...
 def CanConvertFrom(self,*__args):
  ...
  CanConvertFrom(self: ImageKeyConverter,context: ITypeDescriptorContext,sourceType: Type) -> bool
   ...
   Returns whether this converter can convert an object of the given type to a string using 
 ...
 def ConvertTo(self,*__args):
  ...
  ConvertTo(self: ImageKeyConverter,context: ITypeDescriptorContext,culture: CultureInfo,value: object,destinationType: Type) -> object
   ...
   context: An System.ComponentModel.ITypeDescriptorContext that provides a format context,which can 
    be used to extract additional information about the environment this type converter is 
    being invoked from. This parameter or properties of this parameter can be null.
 ...
 def GetStandardValues(self,context=None):
  ...
  GetStandardValues(self: ImageKeyConverter,context: ITypeDescriptorContext) -> StandardValuesCollection
   ...
   Returns a collection of standard image keys for the image list associated with the 
    specified context.
   ...
   Returns: A System.ComponentModel.TypeConverter.StandardValuesCollection that contains the standard 
    set of image key values.
  """
  pass
 def GetStandardValuesExclusive(self,context=None):
  ...
  GetStandardValuesExclusive(self: ImageKeyConverter,context: ITypeDescriptorContext) -> bool
   ...
   Determines whether the list of standard values for the 
    System.Windows.Forms.ImageKeyConverter is exclusive (that is,whether it allows values 
    other than those returned by 
   ...
   Returns: true to indicate the list does not allow additional values; otherwise,false. Always 
    returns true.
  """
  pass
 def GetStandardValuesSupported(self,context=None):
  ...
  GetStandardValuesSupported(self: ImageKeyConverter,context: ITypeDescriptorContext) -> bool
   ...
   Determines whether this type converter supports a standard set of values that can be 
    picked from a list.
   ...
   Returns: true to indicate a list of standard values is supported; otherwise,false. Always returns 
    true.
  """
  pass
