class DocumentPageView(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IServiceProvider, IDisposable):
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: DocumentPageView, availableSize: Size) -> Size
            ...
            Returns the available viewport size that can be given to display the current System.Windows.Controls.Primitives.DocumentPageView.DocumentPage.
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: DocumentPageView) -> AutomationPeer
            ...
            Creates and returns an System.Windows.Automation.Peers.AutomationPeer for this System.Windows.Controls.Primitives.DocumentPageView.
