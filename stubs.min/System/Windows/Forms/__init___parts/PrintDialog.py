class PrintDialog(CommonDialog, IComponent, IDisposable):
    ...
    AllowCurrentPage = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AllowPrintToFile = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AllowSomePages = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    UseEXDialog = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
