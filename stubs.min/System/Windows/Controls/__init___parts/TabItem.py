class TabItem(HeaderedContentControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def OnContentTemplateChanged(self,*args):
  ...
  OnContentTemplateChanged(self: TabItem,oldContentTemplate: DataTemplate,newContentTemplate: DataTemplate)
   Called when the System.Windows.Controls.TabControl.ContentTemplate property 
    changes.
 ...
 def OnContentTemplateSelectorChanged(self,*args):
  ...
  OnContentTemplateSelectorChanged(self: TabItem,oldContentTemplateSelector: DataTemplateSelector,newContentTemplateSelector: DataTemplateSelector)
   Called when the System.Windows.Controls.TabControl.ContentTemplateSelector 
    property changes.
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: TabItem) -> AutomationPeer
   ...
   Provides an appropriate System.Windows.Automation.Peers.TabItemAutomationPeer 
 ...
 def OnSelected(self,*args):
  ...
  OnSelected(self: TabItem,e: RoutedEventArgs)
   Called to indicate that the System.Windows.Controls.TabItem.IsSelected property 
    has changed to true.
  
  
   e: The event data for the System.Windows.Controls.Primitives.Selector.Selected 
    event.
  """
  pass
 ...
 def OnUnselected(self,*args):
  ...
  OnUnselected(self: TabItem,e: RoutedEventArgs)
   ...
   e: The event data for the System.Windows.Controls.Primitives.Selector.Unselected 
    event.
  """
  pass
