class PathFigure(Animatable,ISealable,IAnimatable,IResource,IFormattable):
 ...
 def Clone(self):
  ...
  Clone(self: PathFigure) -> PathFigure
   ...
   Creates a modifiable clone of this System.Windows.Media.PathFigure,making deep 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: PathFigure) -> PathFigure
   ...
   Creates a modifiable clone of this System.Windows.Media.PathFigure object,
 ...
 def GetFlattenedPathFigure(self,tolerance=None,type=None):
  ...
  GetFlattenedPathFigure(self: PathFigure) -> PathFigure
   ...
   Gets a System.Windows.Media.PathFigure object that is an polygonal 
    approximation of this System.Windows.Media.PathFigure object.
  ...
  GetFlattenedPathFigure(self: PathFigure,tolerance: float,type: ToleranceType) -> PathFigure
   ...
   Gets a System.Windows.Media.PathFigure object,within the specified error of 
    tolerance,that is an polygonal approximation of this 
    System.Windows.Media.PathFigure object.
 ...
 def MayHaveCurves(self):
  ...
  MayHaveCurves(self: PathFigure) -> bool
   ...
   Determines whether this System.Windows.Media.PathFigure object may have curved 
    segments.
  
   Returns: true if this System.Windows.Media.PathFigure object may have curved segments; 
    otherwise,false.
  """
  pass
 ...
 def ToString(self,provider=None):
  ...
  ToString(self: PathFigure,provider: IFormatProvider) -> str
   ...
   Creates a string representation of this object using the specified 
    culture-specific formatting.
  
  
   provider: Culture-specific formatting information; otherwise,null to use the current 
    culture and default formatting settings.
