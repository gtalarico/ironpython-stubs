class Rotation3DKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: Rotation3DKeyFrameCollection,keyFrame: Rotation3DKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.Rotation3DKeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.Rotation3DKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: Rotation3DKeyFrameCollection)
   Removes all System.Windows.Media.Animation.Rotation3DKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: Rotation3DKeyFrameCollection) -> Rotation3DKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.Rotation3DKeyFrameCollection,making deep copies 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: Rotation3DKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.Rotation3DKeyFrameCollection. When copying 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: Rotation3DKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.Rotation3DKeyFrameCollection using current 
 ...
 def Contains(self,keyFrame):
  ...
  Contains(self: Rotation3DKeyFrameCollection,keyFrame: Rotation3DKeyFrame) -> bool
   ...
   keyFrame: The System.Windows.Media.Animation.Rotation3DKeyFrame to locate in the 
    collection.
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: Rotation3DKeyFrameCollection,array: Array[Rotation3DKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.Rotation3DKeyFrame objects in 
    a collection to a specified array.
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: Rotation3DKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of 
    System.Windows.Media.Animation.Rotation3DKeyFrameCollection unmodifiable or 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: Rotation3DKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.Rotation3DKeyFrameCollection. Resource 
    references,data bindings,and animations are not copied,but their current 
    values are.
  
  
   sourceFreezable: The System.Windows.Media.Animation.Rotation3DKeyFrameCollection to copy and 
    freeze.
  """
  pass
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: Rotation3DKeyFrameCollection,keyFrame: Rotation3DKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.Rotation3DKeyFrame 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: Rotation3DKeyFrameCollection,index: int,keyFrame: Rotation3DKeyFrame)
   Inserts a System.Windows.Media.Animation.Rotation3DKeyFrame into a specific 
    location within the collection.
  
  
   index: The index position at which the 
    System.Windows.Media.Animation.Rotation3DKeyFrame is inserted.
  
   keyFrame: The System.Windows.Media.Animation.Rotation3DKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: Rotation3DKeyFrameCollection,keyFrame: Rotation3DKeyFrame)
   Removes a System.Windows.Media.Animation.Rotation3DKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.Rotation3DKeyFrame to remove from 
    the collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: Rotation3DKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.Rotation3DKeyFrame at the specified 
    index position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.Rotation3DKeyFrame to be 
    removed.
  """
  pass
