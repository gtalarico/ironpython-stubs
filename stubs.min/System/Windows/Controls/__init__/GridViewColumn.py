class GridViewColumn(DependencyObject, INotifyPropertyChanged):
    ...
    def OnPropertyChanged(self, *args): #cannot find CLR method
        ...
        OnPropertyChanged(self: GridViewColumn, e: PropertyChangedEventArgs)
            Raises the System.Windows.Controls.GridViewColumn.System#ComponentModel#INotifyPropertyChanged#PropertyChanged event.
    ...
    def ToString(self):
        ...
        ToString(self: GridViewColumn) -> str
            ...
            Returns: A string that identifies the object as a System.Windows.Controls.GridViewColumn object and displays the value of the System.Windows.Controls.GridViewColumn.Header property.
        """
        pass
...
"""
    ...
    CellTemplateSelector = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DisplayMemberBinding = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HeaderContainerStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
