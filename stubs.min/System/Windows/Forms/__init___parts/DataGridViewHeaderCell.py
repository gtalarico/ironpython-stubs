class DataGridViewHeaderCell(DataGridViewCell,ICloneable,IDisposable):
 ...
 def Dispose(self):
  ...
  Dispose(self: DataGridViewHeaderCell,disposing: bool)
   Releases the unmanaged resources used by the 
    System.Windows.Forms.DataGridViewHeaderCell and optionally releases the managed 
    resources.
 ...
 def GetContentBounds(self,rowIndex):
  ...
  GetContentBounds(self: DataGridViewCell,graphics: Graphics,cellStyle: DataGridViewCellStyle,rowIndex: int) -> Rectangle
   ...
   Returns the bounding rectangle that encloses the cell's content area,which is 
    calculated using the specified System.Drawing.Graphics and cell style.
 ...
 def GetInheritedContextMenuStrip(self,rowIndex):
  ...
  GetInheritedContextMenuStrip(self: DataGridViewHeaderCell,rowIndex: int) -> ContextMenuStrip
   ...
   Returns: A System.Windows.Forms.ContextMenuStrip if the 
    System.Windows.Forms.DataGridViewHeaderCell or 
    System.Windows.Forms.DataGridView has a shortcut menu assigned; otherwise,
    null.
  """
  pass
 def GetInheritedState(self,rowIndex):
  ...
  GetInheritedState(self: DataGridViewHeaderCell,rowIndex: int) -> DataGridViewElementStates
   ...
   Returns a value indicating the current state of the cell as inherited from the 
    state of its row or column.
  
  
   rowIndex: The index of the row containing the cell or -1 if the cell is not a row header 
    cell or is not contained within a System.Windows.Forms.DataGridView control.
 ...
 def MouseDownUnsharesRow(self,*args):
  ...
  MouseDownUnsharesRow(self: DataGridViewHeaderCell,e: DataGridViewCellMouseEventArgs) -> bool
   ...
   Indicates whether a row will be unshared when the mouse button is held down 
    while the pointer is on a cell in the row.
   ...
   Returns: true if the user clicks with the left mouse button,visual styles are enabled,
    and the System.Windows.Forms.DataGridView.EnableHeadersVisualStyles property is 
 ...
 def MouseEnterUnsharesRow(self,*args):
  ...
  MouseEnterUnsharesRow(self: DataGridViewHeaderCell,rowIndex: int) -> bool
   ...
   Returns: true if visual styles are enabled,and the 
    System.Windows.Forms.DataGridView.EnableHeadersVisualStyles property is true; 
    otherwise,false.
  """
  pass
 def MouseLeaveUnsharesRow(self,*args):
  ...
  MouseLeaveUnsharesRow(self: DataGridViewHeaderCell,rowIndex: int) -> bool
   ...
   Returns: true if the System.Windows.Forms.DataGridViewHeaderCell.ButtonState property 
    value is not System.Windows.Forms.ButtonState.Normal,visual styles are 
    enabled,and the System.Windows.Forms.DataGridView.EnableHeadersVisualStyles 
 ...
 def MouseUpUnsharesRow(self,*args):
  ...
  MouseUpUnsharesRow(self: DataGridViewHeaderCell,e: DataGridViewCellMouseEventArgs) -> bool
   ...
   Indicates whether a row will be unshared when the mouse button is released 
    while the pointer is on a cell in the row.
 ...
 def Paint(self,*args):
  ...
  Paint(self: DataGridViewHeaderCell,graphics: Graphics,clipBounds: Rectangle,cellBounds: Rectangle,rowIndex: int,dataGridViewElementState: DataGridViewElementStates,value: object,formattedValue: object,errorText: str,cellStyle: DataGridViewCellStyle,advancedBorderStyle: DataGridViewAdvancedBorderStyle,paintParts: DataGridViewPaintParts)
   ...
   dataGridViewElementState: A bitwise combination of System.Windows.Forms.DataGridViewElementStates values 
