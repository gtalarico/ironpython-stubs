class ToggleButton(ButtonBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ICommandSource):
 ...
 def OnAccessKey(self,*args):
  ...
  OnAccessKey(self: ButtonBase,e: AccessKeyEventArgs)
   Responds when the System.Windows.Controls.AccessText.AccessKey for this control 
    is called.
  
  
   e: The event data for the System.Windows.Input.AccessKeyManager.AccessKeyPressed 
    event.
  
  OnAccessKey(self: Button_19$20,e: AccessKeyEventArgs)OnAccessKey(self: CheckBox_20$21,e: AccessKeyEventArgs)
  """
  pass
 def OnChecked(self,*args):
  ...
  OnChecked(self: ToggleButton,e: RoutedEventArgs)
   ...
   e: The event data for the System.Windows.Controls.Primitives.ToggleButton.Checked 
    event.
  
  OnChecked(self: CheckBox_20$21,e: RoutedEventArgs)
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: ToggleButton) -> AutomationPeer
   ...
   Provides an appropriate 
    System.Windows.Automation.Peers.ToggleButtonAutomationPeer implementation for 
 ...
 def OnIndeterminate(self,*args):
  ...
  OnIndeterminate(self: ToggleButton,e: RoutedEventArgs)
   ...
   e: The event data for the 
    System.Windows.Controls.Primitives.ToggleButton.Indeterminate event.
  
  OnIndeterminate(self: CheckBox_20$21,e: RoutedEventArgs)
  """
  pass
 ...
 def OnIsPressedChanged(self,*args):
  ...
  OnIsPressedChanged(self: ButtonBase,e: DependencyPropertyChangedEventArgs)
   Called when the System.Windows.Controls.Primitives.ButtonBase.IsPressed 
    property changes.
  
  
   e: The data for System.Windows.DependencyPropertyChangedEventArgs.
  OnIsPressedChanged(self: Button_19$20,e: DependencyPropertyChangedEventArgs)OnIsPressedChanged(self: CheckBox_20$21,e: DependencyPropertyChangedEventArgs)
  """
  pass
 ...
 def OnKeyDown(self,*args):
  ...
  OnKeyDown(self: ButtonBase,e: KeyEventArgs)
   Provides class handling for the System.Windows.UIElement.KeyDown routed event 
    that occurs when the user presses a key while this control has focus.
  
  
   e: The event data.
  OnKeyDown(self: Button_19$20,e: KeyEventArgs)OnKeyDown(self: CheckBox_20$21,e: KeyEventArgs)
  """
  pass
 def OnKeyUp(self,*args):
  """
  OnKeyUp(self: ButtonBase,e: KeyEventArgs)
   Provides class handling for the System.Windows.UIElement.KeyUp routed event 
    that occurs when the user releases a key while this control has focus.
  
  
   e: The event data for the System.Windows.UIElement.KeyUp event.
  OnKeyUp(self: Button_19$20,e: KeyEventArgs)OnKeyUp(self: CheckBox_20$21,e: KeyEventArgs)
  """
  pass
 ...
 def OnLostKeyboardFocus(self,*args):
  ...
  OnLostKeyboardFocus(self: Button_19$20,e: KeyboardFocusChangedEventArgs)OnLostKeyboardFocus(self: CheckBox_20$21,e: KeyboardFocusChangedEventArgs)
  """
  pass
 def OnLostMouseCapture(self,*args):
  """
  OnLostMouseCapture(self: ButtonBase,e: MouseEventArgs)
   Provides class handling for the System.Windows.UIElement.LostMouseCapture 
    routed event that occurs when this control is no longer receiving mouse event 
    messages.
  
  
   e: The event data for the System.Windows.Input.Mouse.LostMouseCapture event.
  OnLostMouseCapture(self: Button_19$20,e: MouseEventArgs)OnLostMouseCapture(self: CheckBox_20$21,e: MouseEventArgs)
  """
  pass
 ...
 def OnMouseEnter(self,*args):
  ...
  OnMouseEnter(self: ButtonBase,e: MouseEventArgs)
   Provides class handling for the 
    System.Windows.Controls.Primitives.ButtonBase.ClickMode routed event that 
    occurs when the mouse enters this control.
  
  
   e: The event data for the System.Windows.Input.Mouse.MouseEnter event.
  OnMouseEnter(self: Button_19$20,e: MouseEventArgs)OnMouseEnter(self: CheckBox_20$21,e: MouseEventArgs)
  """
  pass
 def OnMouseLeave(self,*args):
  """
  OnMouseLeave(self: ButtonBase,e: MouseEventArgs)
   Provides class handling for the System.Windows.UIElement.MouseLeave routed 
    event that occurs when the mouse leaves an element.
  
  
   e: The event data for the System.Windows.Input.Mouse.MouseLeave event.
  OnMouseLeave(self: Button_19$20,e: MouseEventArgs)OnMouseLeave(self: CheckBox_20$21,e: MouseEventArgs)
  """
  pass
 def OnMouseLeftButtonDown(self,*args):
  """
  OnMouseLeftButtonDown(self: ButtonBase,e: MouseButtonEventArgs)
   Provides class handling for the System.Windows.UIElement.MouseLeftButtonDown 
    routed event that occurs when the left mouse button is pressed while the mouse 
    pointer is over this control.
  
  
   e: The event data.
  OnMouseLeftButtonDown(self: Button_19$20,e: MouseButtonEventArgs)OnMouseLeftButtonDown(self: CheckBox_20$21,e: MouseButtonEventArgs)
  """
  pass
 def OnMouseLeftButtonUp(self,*args):
  """
  OnMouseLeftButtonUp(self: ButtonBase,e: MouseButtonEventArgs)
   Provides class handling for the System.Windows.UIElement.MouseLeftButtonUp 
    routed event that occurs when the left mouse button is released while the mouse 
    pointer is over this control.
  
  
   e: The event data.
  OnMouseLeftButtonUp(self: Button_19$20,e: MouseButtonEventArgs)OnMouseLeftButtonUp(self: CheckBox_20$21,e: MouseButtonEventArgs)
  """
  pass
 def OnMouseMove(self,*args):
  """
  OnMouseMove(self: ButtonBase,e: MouseEventArgs)
   Provides class handling for the System.Windows.UIElement.MouseMove routed event 
    that occurs when the mouse pointer moves while over this element.
  
  
   e: The event data.
  OnMouseMove(self: Button_19$20,e: MouseEventArgs)OnMouseMove(self: CheckBox_20$21,e: MouseEventArgs)
  """
  pass
 ...
 def OnRenderSizeChanged(self,*args):
  ...
  OnRenderSizeChanged(self: Button_19$20,sizeInfo: SizeChangedInfo)OnRenderSizeChanged(self: CheckBox_20$21,sizeInfo: SizeChangedInfo)
  """
  pass
 ...
 def OnToggle(self,*args):
  ...
  OnToggle(self: ToggleButton)
   Called by the System.Windows.Controls.Primitives.ToggleButton.OnClick method to 
    implement toggle behavior.
  
  OnToggle(self: CheckBox_20$21)
  """
  pass
 ...
 def OnUnchecked(self,*args):
  ...
  OnUnchecked(self: CheckBox_20$21,e: RoutedEventArgs)
  """
  pass
 ...
 def ToString(self):
  ...
  ToString(self: ToggleButton) -> str
   ...
   Returns the string representation of a 
    System.Windows.Controls.Primitives.ToggleButton object.
  
   Returns: String representation of a System.Windows.Controls.Primitives.ToggleButton 
    object.
  
  ToString(self: CheckBox_20$21) -> str
  """
  pass
