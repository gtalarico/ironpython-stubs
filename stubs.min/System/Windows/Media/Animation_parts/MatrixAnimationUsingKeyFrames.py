class MatrixAnimationUsingKeyFrames(MatrixAnimationBase, ISealable, IAnimatable, IResource, IKeyFrameAnimation, IAddChild):
    ...
    def AddChild(self, *args): #cannot find CLR method
        ...
        AddChild(self: MatrixAnimationUsingKeyFrames, child: object)
            Adds a child System.Windows.Media.Animation.MatrixKeyFrame to this System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames.
        
            child: The object to be added as the child of this System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames.
        """
        pass
    ...
    def AddText(self, *args): #cannot find CLR method
        ...
        AddText(self: MatrixAnimationUsingKeyFrames, childText: str)
            Adds a text string as a child of this System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames.
    ...
    def Clone(self):
        ...
        Clone(self: MatrixAnimationUsingKeyFrames) -> MatrixAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: MatrixAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames. When copying dependency properties, this method copies resource references and data bindings 
    ...
    def CloneCurrentValue(self):
        ...
        CloneCurrentValue(self: MatrixAnimationUsingKeyFrames) -> MatrixAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames object, making deep copies of this object's current values. Resource references, data bindings, and 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: MatrixAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames using current property values. Resource references, data bindings, and animations 
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: MatrixAnimationUsingKeyFrames, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames object unmodifiable or determines whether it can be made unmodifiable.
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: MatrixAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: MatrixAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames. Resource references, data bindings, and animations are not copied, but their current values 
             are.
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: MatrixAnimationUsingKeyFrames, defaultOriginValue: Matrix, defaultDestinationValue: Matrix, animationClock: AnimationClock) -> Matrix
            ...
            Calculates the current output value of this System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames.
    ...
    def OnChanged(self, *args): #cannot find CLR method
        ...
        OnChanged(self: MatrixAnimationUsingKeyFrames)
            Called when the current System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames object is modified.
        """
        pass
    ...
    def ShouldSerializeKeyFrames(self):
        ...
        ShouldSerializeKeyFrames(self: MatrixAnimationUsingKeyFrames) -> bool
            ...
            Returns true if the value of the System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames.KeyFrames property of this instance of System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames should be 
             value-serialized.
