class Attribute(object,_Attribute):
 ...
 def GetCustomAttribute(element,attributeType,inherit=None):
  ...
  GetCustomAttribute(element: Module,attributeType: Type,inherit: bool) -> Attribute
   ...
   element: An object derived from the System.Reflection.Module class that describes a 
  ...
  GetCustomAttribute(element: Assembly,attributeType: Type,inherit: bool) -> Attribute
   ...
   Retrieves a custom attribute applied to an assembly. Parameters specify the 
    assembly,the type of the custom attribute to search for,and an ignored search 
    option.
  
  
   element: An object derived from the System.Reflection.Assembly class that describes a 
    reusable collection of modules.
  ...
  GetCustomAttribute(element: MemberInfo,attributeType: Type,inherit: bool) -> Attribute
   ...
   attributeType: The type,or a base type,of the custom attribute to search for.
   inherit: If true,specifies to also search the ancestors of element for custom 
    attributes.
  ...
  GetCustomAttribute(element: ParameterInfo,attributeType: Type,inherit: bool) -> Attribute
   ...
   element: An object derived from the System.Reflection.ParameterInfo class that describes 
 ...
 def GetCustomAttributes(element,*__args):
  ...
  GetCustomAttributes(element: Module,attributeType: Type,inherit: bool) -> Array[Attribute]
   ...
   attributeType: The type,or a base type,of the custom attribute to search for.
   inherit: This parameter is ignored,and does not affect the operation of this method.
   Returns: An System.Attribute array that contains the custom attributes of type 
    attributeType applied to element,or an empty array if no such custom 
    attributes exist.
  ...
  GetCustomAttributes(element: Assembly,attributeType: Type,inherit: bool) -> Array[Attribute]
   ...
   Retrieves an array of the custom attributes applied to an assembly. Parameters 
    specify the assembly,the type of the custom attribute to search for,and an 
    ignored search option.
  ...
  GetCustomAttributes(element: MemberInfo) -> Array[Attribute]
   ...
   Retrieves an array of the custom attributes applied to a member of a type. A 
    parameter specifies the member.
  ...
  GetCustomAttributes(element: MemberInfo,inherit: bool) -> Array[Attribute]
   ...
   Retrieves an array of the custom attributes applied to a member of a type. 
    Parameters specify the member,the type of the custom attribute to search for,
    and whether to search ancestors of the member.
  ...
  GetCustomAttributes(element: MemberInfo,type: Type) -> Array[Attribute]
   ...
   Returns: An System.Attribute array that contains the custom attributes of type type 
  ...
  GetCustomAttributes(element: ParameterInfo,attributeType: Type,inherit: bool) -> Array[Attribute]
   ...
   Retrieves an array of the custom attributes applied to a method parameter. 
    Parameters specify the method parameter,the type of the custom attribute to 
    search for,and whether to search ancestors of the method parameter.
  ...
  GetCustomAttributes(element: ParameterInfo,inherit: bool) -> Array[Attribute]
   ...
   Retrieves an array of the custom attributes applied to a method parameter. 
    Parameters specify the method parameter,and whether to search ancestors of the 
    method parameter.
  ...
  GetCustomAttributes(element: ParameterInfo) -> Array[Attribute]
   ...
   Retrieves an array of the custom attributes applied to a method parameter. A 
    parameter specifies the method parameter.
 ...
 def IsDefaultAttribute(self):
  ...
  IsDefaultAttribute(self: Attribute) -> bool
   ...
   When overridden in a derived class,indicates whether the value of this 
    instance is the default value for the derived class.
 ...
 def IsDefined(element,attributeType,inherit=None):
  ...
  IsDefined(element: Module,attributeType: Type,inherit: bool) -> bool
   ...
   attributeType: The type,or a base type,of the custom attribute to search for.
   inherit: This parameter is ignored,and does not affect the operation of this method.
   Returns: true if a custom attribute of type attributeType is applied to element; 
    otherwise,false.
  
  IsDefined(element: Module,attributeType: Type) -> bool
  
   Determines whether any custom attributes of a specified type are applied to a 
    module. Parameters specify the module,and the type of the custom attribute to 
    search for.
