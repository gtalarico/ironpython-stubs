class Console(object):
 ...
 def Read():
  ...
  Read() -> int
   ...
   Returns: The next character from the input stream,or negative one (-1) if there are 
 ...
 def ReadKey(intercept=None):
  ...
  ReadKey(intercept: bool) -> ConsoleKeyInfo
   ...
   intercept: Determines whether to display the pressed key in the console window. true to 
   ...
   Returns: A System.ConsoleKeyInfo object that describes the System.ConsoleKey constant 
    ...
    System.ConsoleKeyInfo object also describes,in a bitwise combination of 
    System.ConsoleModifiers values,whether one or more SHIFT,ALT,or CTRL 
 ...
 def Write(*__args):
  ...
  Write(format: str,arg0: object,arg1: object,arg2: object,arg3: object)
   Writes the text representation of the specified objects and variable-length 
    parameter list to the standard output stream using the specified format 
    information.
 ...
 def WriteLine(*__args):
  ...
  WriteLine(format: str,arg0: object,arg1: object,arg2: object,arg3: object)
   Writes the text representation of the specified objects and variable-length 
    parameter list,followed by the current line terminator,to the standard output 
    stream using the specified format information.
  ...
  WriteLine(value: Char)
   Writes the specified Unicode character,followed by the current line 
    terminator,value to the standard output stream.
