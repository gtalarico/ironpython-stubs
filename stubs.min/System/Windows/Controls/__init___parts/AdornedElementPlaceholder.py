class AdornedElementPlaceholder(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: AdornedElementPlaceholder,arrangeBounds: Size) -> Size
   ...
   Positions the first visual child object and returns the size in layout required 
    by this System.Windows.Controls.AdornedElementPlaceholder object.
  
  
   arrangeBounds: The size that this System.Windows.Controls.AdornedElementPlaceholder object 
    should use to arrange its child element.
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: AdornedElementPlaceholder,constraint: Size) -> Size
   ...
   Determines the size of the System.Windows.Controls.AdornedElementPlaceholder 
    object.
  
  
   constraint: An upper limit value that the return value should not exceed.
   Returns: The desired size of this System.Windows.Controls.AdornedElementPlaceholder 
    object.
  """
  pass
 ...
 def OnInitialized(self,*args):
  ...
  OnInitialized(self: AdornedElementPlaceholder,e: EventArgs)
   Raises the System.Windows.FrameworkElement.IsInitialized event. This method is 
