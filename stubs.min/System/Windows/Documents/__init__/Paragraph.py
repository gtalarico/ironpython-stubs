class Paragraph(Block, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild):
    """
    ...
    def ShouldSerializeInlines(self, manager):
        """
        ShouldSerializeInlines(self: Paragraph, manager: XamlDesignerSerializationManager) -> bool
        
            Indicates whether the System.Windows.Documents.Paragraph.Inlines property should be persisted.
...
"""
    ...
    """Gets an System.Windows.Documents.InlineCollection containing the top-level System.Windows.Documents.Inline elements that comprise the contents of the System.Windows.Documents.Paragraph.

Get: Inlines(self: Paragraph) -> InlineCollection
...
"""
    ...
    KeepTogether = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that indicates whether the text of the paragraph may be broken by a page break or column break.

Get: KeepTogether(self: Paragraph) -> bool

Set: KeepTogether(self: Paragraph) = value
"""

    KeepWithNext = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that indicates whether a break may occur between this paragraph and the next paragraph.

Get: KeepWithNext(self: Paragraph) -> bool
...
"""
    ...
    MinOrphanLines = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that specifies the minimum number of lines that can be left before the break when a System.Windows.Documents.Paragraph is broken by a page break or column break.

Get: MinOrphanLines(self: Paragraph) -> int

Set: MinOrphanLines(self: Paragraph) = value
"""

    MinWidowLines = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that specifies the minimum number of lines that can be placed after the break when a System.Windows.Documents.Paragraph is broken by a page break or column break.

Get: MinWidowLines(self: Paragraph) -> int

Set: MinWidowLines(self: Paragraph) = value
"""

    TextDecorations = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a System.Windows.TextDecorationCollection that contains text decorations to apply to this element.

Get: TextDecorations(self: Paragraph) -> TextDecorationCollection

Set: TextDecorations(self: Paragraph) = value
"""

    TextIndent = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that indicates how far to indent the first line of a System.Windows.Documents.Paragraph.

Get: TextIndent(self: Paragraph) -> float

Set: TextIndent(self: Paragraph) = value
"""


    KeepTogetherProperty = None
    KeepWithNextProperty = None
    MinOrphanLinesProperty = None
    MinWidowLinesProperty = None
    TextDecorationsProperty = None
    TextIndentProperty = None
