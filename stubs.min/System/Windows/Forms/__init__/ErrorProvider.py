class ErrorProvider(Component, IComponent, IDisposable, IExtenderProvider, ISupportInitialize):
    ...
    BlinkRate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    BlinkStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ContainerControl = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
