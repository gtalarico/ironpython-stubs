...
class ShipmentBase(Address):
 ...
 def __reduce_ex__(self,*args):
  pass
 CommunicationArtefacts=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Get: CommunicationArtefacts(self: ShipmentBase) -> str

Set: CommunicationArtefacts(self: ShipmentBase)=value
"""

 CustomData=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Get: CustomData(self: ShipmentBase) -> Array[Byte]

Set: CustomData(self: ShipmentBase)=value
"""

 CustomReferences=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 DeliveryNotePdf=property(lambda self: object(),lambda self,v: None,lambda self: None)
