class ValueSource(object):
 ...
 def __ne__(self,*args):
  pass
 BaseValueSource=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 IsAnimated=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 IsCoerced=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 IsCurrent=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 IsExpression=property(lambda self: object(),lambda self,v: None,lambda self: None)
