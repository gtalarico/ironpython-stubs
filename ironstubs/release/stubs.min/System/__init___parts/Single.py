class Single(object,IComparable,IFormattable,IConvertible,IComparable[Single],IEquatable[Single]):
 ...
 def CompareTo(self,value):
  ...
  CompareTo(self: Single,value: Single) -> int
   ...
   Compares this instance to a specified single-precision floating-point number 
    and returns an integer that indicates whether the value of this instance is 
   ...
   Returns: A signed number indicating the relative values of this instance and 
    value.Return Value Description Less than zero This instance is less than 
    value.-or- This instance is not a number (System.Single.NaN) and value is a 
    number. Zero This instance is equal to value.-or- Both this instance and value 
    are not a number (System.Single.NaN),System.Single.PositiveInfinity,or 
    System.Single.NegativeInfinity. Greater than zero This instance is greater than 
    value.-or- This instance is a number and value is not a number 
    (System.Single.NaN).
  ...
  CompareTo(self: Single,value: object) -> int
   ...
   Returns: A signed number indicating the relative values of this instance and 
    value.Return Value Description Less than zero This instance is less than 
    value.-or- This instance is not a number (System.Single.NaN) and value is a 
    number. Zero This instance is equal to value.-or- This instance and value are 
    both not a number (System.Single.NaN),System.Single.PositiveInfinity,or 
    System.Single.NegativeInfinity. Greater than zero This instance is greater than 
    value.-or- This instance is a number and value is not a number 
 ...
 def Equals(self,obj):
  ...
  Equals(self: Single,obj: object) -> bool
   ...
   obj: An object to compare with this instance.
   Returns: true if obj is an instance of System.Single and equals the value of this 
 ...
 def IsInfinity(f):
  ...
  IsInfinity(f: Single) -> bool
   ...
   Returns: true if f evaluates to System.Single.PositiveInfinity or 
    System.Single.NegativeInfinity; otherwise,false.
  """
  pass
 @staticmethod
 def IsNaN(f):
  ...
  IsNaN(f: Single) -> bool
   ...
   Returns a value indicating whether the specified number evaluates to not a 
 ...
 def Parse(s,*__args):
  ...
  Parse(s: str,provider: IFormatProvider) -> Single
   ...
   Returns: A single-precision floating-point number equivalent to the numeric value or 
  ...
  Parse(s: str,style: NumberStyles,provider: IFormatProvider) -> Single
   ...
   Converts the string representation of a number in a specified style and 
    culture-specific format to its single-precision floating-point number 
    equivalent.
   ...
   style: A bitwise combination of enumeration values that indicates the style elements 
    ...
    System.Globalization.NumberStyles.Float combined with 
  ...
  Parse(s: str,style: NumberStyles) -> Single
   ...
   Returns: A single-precision floating-point number that is equivalent to the numeric 
 ...
 def TryParse(s,*__args):
  ...
  TryParse(s: str,style: NumberStyles,provider: IFormatProvider) -> (bool,Single)
   ...
   style: A bitwise combination of enumeration values that indicates the permitted format 
    of s. A typical value to specify is System.Globalization.NumberStyles.Float 
