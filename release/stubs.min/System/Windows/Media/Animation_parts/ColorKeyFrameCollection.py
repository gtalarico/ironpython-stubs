class ColorKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: ColorKeyFrameCollection,keyFrame: ColorKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.ColorKeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.ColorKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: ColorKeyFrameCollection)
   Removes all System.Windows.Media.Animation.ColorKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: ColorKeyFrameCollection) -> ColorKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.ColorAnimationUsingKeyFrames,making deep copies 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: ColorKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.ColorKeyFrameCollection. When copying dependency 
    properties,this method copies resource references and data bindings (but they 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: ColorKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.ColorKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: ColorKeyFrameCollection,array: Array[ColorKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.ColorKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: ColorKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.ColorKeyFrameCollection 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: ColorKeyFrameCollection,sourceFreezable: Freezable)
   ...
   sourceFreezable: The System.Windows.Media.Animation.ColorKeyFrameCollection object to clone and 
    freeze.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: ColorKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.ColorKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: ColorKeyFrameCollection,keyFrame: ColorKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.ColorKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: ColorKeyFrameCollection,index: int,keyFrame: ColorKeyFrame)
   Inserts a System.Windows.Media.Animation.ColorKeyFrame into a specific location 
    within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.ColorKeyFrame is 
    inserted.
  
   keyFrame: The System.Windows.Media.Animation.ColorKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: ColorKeyFrameCollection,keyFrame: ColorKeyFrame)
   Removes a System.Windows.Media.Animation.ColorKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.ColorKeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: ColorKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.ColorKeyFrame at the specified index 
    position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.ColorKeyFrame to be 
    removed.
  """
  pass
