class PropertyTabChangedEventArgs(EventArgs):
    ...
    NewTab = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    OldTab = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
