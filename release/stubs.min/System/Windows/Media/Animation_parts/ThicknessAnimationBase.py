class ThicknessAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 ...
 def Clone(self):
  ...
  Clone(self: ThicknessAnimationBase) -> ThicknessAnimationBase
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.ThicknessAnimationBase,making deep copies of 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  ...
  GetCurrentValue(self: ThicknessAnimationBase,defaultOriginValue: Thickness,defaultDestinationValue: Thickness,animationClock: AnimationClock) -> Thickness
   ...
   defaultOriginValue: The origin value provided to the animation if the animation does not have its 
    own start value.
  
   defaultDestinationValue: The destination value provided to the animation if the animation does not have 
   ...
   animationClock: The System.Windows.Media.Animation.AnimationClock which can generate the 
    ...
    System.Windows.Media.Animation.Clock.CurrentProgress value to be used by the 
 ...
 def GetCurrentValueCore(self,*args):
  ...
  GetCurrentValueCore(self: ThicknessAnimationBase,defaultOriginValue: Thickness,defaultDestinationValue: Thickness,animationClock: AnimationClock) -> Thickness
   ...
   Calculates a value that represents the current value of the property being 
    animated,as determined by the host animation.
