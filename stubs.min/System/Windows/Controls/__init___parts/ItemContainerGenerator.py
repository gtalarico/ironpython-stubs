class ItemContainerGenerator(object, IRecyclingItemContainerGenerator, IItemContainerGenerator, IWeakEventListener):
    ...
    def ContainerFromIndex(self, index):
        ...
        ContainerFromIndex(self: ItemContainerGenerator, index: int) -> DependencyObject
            ...
            Returns the element corresponding to the item at the given index within the System.Windows.Controls.ItemCollection.
        
            index: The index of the desired item.
            Returns: Returns the element corresponding to the item at the given index within the System.Windows.Controls.ItemCollection or returns null if the item is not realized.
        """
        pass
    ...
    def ContainerFromItem(self, item):
        ...
        ContainerFromItem(self: ItemContainerGenerator, item: object) -> DependencyObject
            ...
            Returns: A System.Windows.UIElement that corresponds to the given item. Returns null if the item does not belong to the item collection, or if a System.Windows.UIElement has not been generated for it.
        """
        pass
    ...
    def IndexFromContainer(self, container, returnLocalIndex=None):
        ...
        IndexFromContainer(self: ItemContainerGenerator, container: DependencyObject) -> int
            ...
            Returns the index to an item that corresponds to the specified, generated System.Windows.UIElement.
        
            container: The System.Windows.DependencyObject that corresponds to the item to the index to be returned.
            Returns: An System.Int32 index to an item that corresponds to the specified, generated System.Windows.UIElement or -1 if container is not found.
        """
        pass
    ...
    def ItemFromContainer(self, container):
        ...
        ItemFromContainer(self: ItemContainerGenerator, container: DependencyObject) -> object
            ...
            Returns: A System.Windows.DependencyObject that is the item which corresponds to the specified, generated System.Windows.UIElement. If the System.Windows.UIElement has not been generated, 
