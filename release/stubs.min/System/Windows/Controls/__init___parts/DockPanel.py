class DockPanel(Panel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: DockPanel,arrangeSize: Size) -> Size
   ...
   Arranges the content (child elements) of a System.Windows.Controls.DockPanel 
    element.
 ...
 def GetDock(element):
  ...
  GetDock(element: UIElement) -> Dock
   ...
   Gets the value of the System.Windows.Controls.DockPanel.Dock�attached property 
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: DockPanel,constraint: Size) -> Size
   ...
   Measures the child elements of a System.Windows.Controls.DockPanel prior to 
    arranging them during the 
    System.Windows.Controls.DockPanel.ArrangeOverride(System.Windows.Size) pass.
 ...
 def SetDock(element,dock):
  ...
  SetDock(element: UIElement,dock: Dock)
   Sets the value of the System.Windows.Controls.DockPanel.Dock�attached property 
