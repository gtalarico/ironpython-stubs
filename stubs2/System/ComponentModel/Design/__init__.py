...
class MenuCommand(object):
    ...
    def ToString(self):
        ...
        ToString(self: MenuCommand) -> str
            ...
            Returns: A string containing the value of the System.ComponentModel.Design.MenuCommand.CommandID property appended with the names of any flags that are set, separated by pipe bars (|). These flag properties include 
             System.ComponentModel.Design.MenuCommand.Checked, System.ComponentModel.Design.MenuCommand.Enabled, System.ComponentModel.Design.MenuCommand.Supported, and System.ComponentModel.Design.MenuCommand.Visible.
        """
        pass
...
class IDesignerHost(IServiceContainer, IServiceProvider):
    ...
    def CreateTransaction(self, description=None):
        ...
        CreateTransaction(self: IDesignerHost, description: str) -> DesignerTransaction
            ...
            Creates a System.ComponentModel.Design.DesignerTransaction that can encapsulate event sequences to improve performance and enable undo and redo support functionality, using the specified transaction 
             description.
...
class IInheritanceService:
    ...
    def AddInheritedComponents(self, component, container):
        ...
        AddInheritedComponents(self: IInheritanceService, component: IComponent, container: IContainer)
            Searches the specified component for fields that implement the System.ComponentModel.IComponent interface and adds each to the specified container, storing the inheritance level of each which can be 
             retrieved using the System.ComponentModel.Design.IInheritanceService.GetInheritanceAttribute(System.ComponentModel.IComponent) method.
