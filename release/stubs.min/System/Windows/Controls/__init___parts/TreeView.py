class TreeView(ItemsControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 ...
 def ExpandSubtree(self,*args):
  ...
  ExpandSubtree(self: TreeView,container: TreeViewItem) -> bool
   ...
   Returns: true if the specified System.Windows.Controls.TreeViewItem and all its child 
 ...
 def OnIsKeyboardFocusWithinChanged(self,*args):
  ...
  OnIsKeyboardFocusWithinChanged(self: TreeView,e: DependencyPropertyChangedEventArgs)
   Provides class handling for an 
    System.Windows.ContentElement.IsKeyboardFocusWithinChanged event when the 
    keyboard focus changes for a System.Windows.Controls.TreeView.
