class Color(object,IFormattable,IEquatable[Color]):
 ...
 def Add(color1,color2):
  ...
  Add(color1: Color,color2: Color) -> Color
   ...
   Returns: A new System.Windows.Media.Color structure whose color values are the results 
 ...
 def Clamp(self):
  """
  Clamp(self: Color)
   Sets the ScRGB channels of the color to within the gamut of 0 to 1,if they are 
    outside that range.
  """
  pass
 @staticmethod
 def Equals(*__args):
  ...
  Equals(self: Color,o: object) -> bool
   ...
   Returns: true if the specified object is a System.Windows.Media.Color structure and is 
    identical to the current System.Windows.Media.Color structure; otherwise,
    false.
  ...
  Equals(self: Color,color: Color) -> bool
   ...
   color: The System.Windows.Media.Color structure to compare to the current 
    System.Windows.Media.Color structure.
  
   Returns: true if the specified System.Windows.Media.Color structure is identical to the 
    current System.Windows.Media.Color structure; otherwise,false.
 ...
 def FromArgb(a,r,g,b):
  ...
  FromArgb(a: Byte,r: Byte,g: Byte,b: Byte) -> Color
   ...
   Creates a new System.Windows.Media.Color structure by using the specified sRGB 
 ...
 def FromAValues(a,values,profileUri):
  ...
  FromAValues(a: Single,values: Array[Single],profileUri: Uri) -> Color
   ...
   Creates a new System.Windows.Media.Color structure by using the specified alpha 
    channel,color channel values,and color profile.
  
  
   a: The alpha channel for the new color.
   values: A collection of values that specify the color channels for the new color. These 
    values map to the profileUri.
  
   profileUri: The International Color Consortium (ICC) or Image Color Management (ICM) color 
    profile for the new color.
 ...
 def FromRgb(r,g,b):
  ...
  FromRgb(r: Byte,g: Byte,b: Byte) -> Color
   ...
   Returns: A System.Windows.Media.Color structure with the specified values and an alpha 
    channel value of 1.
  """
  pass
 @staticmethod
 def FromScRgb(a,r,g,b):
  ...
  FromScRgb(a: Single,r: Single,g: Single,b: Single) -> Color
   ...
   Creates a new System.Windows.Media.Color structure by using the specified ScRGB 
    alpha channel and color channel values.
 ...
 def FromValues(values,profileUri):
  ...
  FromValues(values: Array[Single],profileUri: Uri) -> Color
   ...
   Creates a new System.Windows.Media.Color structure by using the specified color 
    channel values and color profile.
 ...
 def Multiply(color,coefficient):
  ...
  Multiply(color: Color,coefficient: Single) -> Color
   ...
   Multiplies the alpha,red,blue,and green channels of the specified 
    System.Windows.Media.Color structure by the specified value.
 ...
 def Subtract(color1,color2):
  ...
  Subtract(color1: Color,color2: Color) -> Color
   ...
   Subtracts a System.Windows.Media.Color structure from a 
    System.Windows.Media.Color structure.
 ...
 def ToString(self,provider=None):
  ...
  ToString(self: Color,provider: IFormatProvider) -> str
   ...
   Creates a string representation of the color by using the ScRGB channels and 
...
"""
 ...
 ColorContext=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ScA=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ScB=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ScG=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ScR=property(lambda self: object(),lambda self,v: None,lambda self: None)
