class DataGridViewRowPostPaintEventArgs(EventArgs):
 ...
 def Instance(self):
  ...
  return DataGridViewRowPostPaintEventArgs()
 ...
 def DrawFocus(self,bounds,cellsPaintSelectionBackground):
  ...
  DrawFocus(self: DataGridViewRowPostPaintEventArgs,bounds: Rectangle,cellsPaintSelectionBackground: bool)
   ...
   cellsPaintSelectionBackground: true to use the System.Windows.Forms.DataGridViewCellStyle.SelectionBackColor property of the System.Windows.Forms.DataGridViewRow.InheritedStyle property to determine the color of the focus rectangle; false to use the System.Windows.Forms.DataGridViewCellStyle.BackColor property of the System.Windows.Forms.DataGridViewRow.InheritedStyle property.
  """
  pass
 ...
 def PaintCellsBackground(self,clipBounds,cellsPaintSelectionBackground):
  ...
  PaintCellsBackground(self: DataGridViewRowPostPaintEventArgs,clipBounds: Rectangle,cellsPaintSelectionBackground: bool)
   ...
   clipBounds: A System.Drawing.Rectangle that specifies the area of the System.Windows.Forms.DataGridView to be painted.
   cellsPaintSelectionBackground: true to paint the background of the specified bounds with the color of the System.Windows.Forms.DataGridViewCellStyle.SelectionBackColor property of the System.Windows.Forms.DataGridViewRow.InheritedStyle; false to paint the background of the specified bounds with the color of the System.Windows.Forms.DataGridViewCellStyle.BackColor property of the System.Windows.Forms.DataGridViewRow.InheritedStyle.
  """
  pass
 ...
 def PaintHeader(self,*__args):
  ...
  PaintHeader(self: DataGridViewRowPostPaintEventArgs,paintSelectionBackground: bool)
   ...
   paintSelectionBackground: true to paint the row header with the color of the System.Windows.Forms.DataGridViewCellStyle.SelectionBackColor property of the System.Windows.Forms.DataGridViewRow.InheritedStyle; false to paint the row header with the System.Windows.Forms.DataGridViewCellStyle.BackColor of the System.Windows.Forms.DataGridView.RowHeadersDefaultCellStyle property.
