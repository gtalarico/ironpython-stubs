class TextChange(object):
    ...
    AddedLength = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RemovedLength = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
