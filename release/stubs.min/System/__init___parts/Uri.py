class Uri:
 ...
 def CheckHostName(name):
  ...
  CheckHostName(name: str) -> UriHostNameType
   ...
   Returns: A System.UriHostNameType that indicates the type of the host name. If the type of the 
    host name cannot be determined or if the host name is null or a zero-length string,this 
    method returns System.UriHostNameType.Unknown.
  """
  pass
 @staticmethod
 ...
 def Compare(uri1,uri2,partsToCompare,compareFormat,comparisonType):
  ...
  Compare(uri1: Uri,uri2: Uri,partsToCompare: UriComponents,compareFormat: UriFormat,comparisonType: StringComparison) -> int
   ...
   partsToCompare: A bitwise combination of the System.UriComponents values that specifies the parts of uri1 
    and uri2 to compare.
  
   compareFormat: One of the System.UriFormat values that specifies the character escaping used when the 
    URI components are compared.
   ...
   Returns: An System.Int32 value that indicates the lexical relationship between the compared 
    System.Uri components.ValueMeaningLess than zerouri1 is less than uri2.Zerouri1 equals 
 ...
 def Equals(self,comparand):
  ...
  Equals(self: Uri,comparand: object) -> bool
   ...
   Returns: A System.Boolean value that is true if the two instances represent the same URI; 
    otherwise,false.
  """
  pass
 def Escape(self,*args):
  """
  Escape(self: Uri)
   Converts any unsafe or reserved characters in the path component to their hexadecimal 
 ...
 def FromHex(digit):
  ...
  FromHex(digit: Char) -> int
   ...
   Returns: An System.Int32 value that contains a number from 0 to 15 that corresponds to the 
 ...
 def GetComponents(self,components,format):
  ...
  GetComponents(self: Uri,components: UriComponents,format: UriFormat) -> str
   ...
   components: A bitwise combination of the System.UriComponents values that specifies which parts of 
    the current instance to return to the caller.
 ...
 def GetObjectData(self,*args):
  ...
  GetObjectData(self: Uri,serializationInfo: SerializationInfo,streamingContext: StreamingContext)
   ...
   serializationInfo: A System.Runtime.Serialization.SerializationInfo object containing the information 
    required to serialize the System.Uri.
  
   streamingContext: A System.Runtime.Serialization.StreamingContext object containing the source and 
    destination of the serialized stream associated with the System.Uri.
  """
  pass
 @staticmethod
 ...
 def HexUnescape(pattern,index):
  ...
  HexUnescape(pattern: str,index: int) -> (Char,int)
   ...
   Returns: The character represented by the hexadecimal encoding at position index. If the character 
    at index is not hexadecimal encoded,the character at index is returned. The value of 
    index is incremented to point to the character following the one returned.
  """
  pass
 def IsBadFileSystemCharacter(self,*args):
  ...
  IsBadFileSystemCharacter(self: Uri,character: Char) -> bool
   ...
   Returns: A System.Boolean value that is true if the specified character is invalid; otherwise 
    false.
  """
  pass
 ...
 def IsExcludedCharacter(self,*args):
  ...
  IsExcludedCharacter(character: Char) -> bool
   ...
   character: The System.Char to test.
   Returns: A System.Boolean value that is true if the specified character should be escaped; 
    otherwise,false.
  """
  pass
 @staticmethod
 def IsHexDigit(character):
  ...
  IsHexDigit(character: Char) -> bool
   ...
   Returns: A System.Boolean value that is true if the character is a valid hexadecimal digit; 
    otherwise false.
  """
  pass
 @staticmethod
 def IsHexEncoding(pattern,index):
  ...
  IsHexEncoding(pattern: str,index: int) -> bool
   ...
   Returns: A System.Boolean value that is true if pattern is hexadecimal encoded at the specified 
 ...
 def MakeRelative(self,toUri):
  ...
  MakeRelative(self: Uri,toUri: Uri) -> str
   ...
   Returns: If the hostname and scheme of this URI instance and toUri are the same,then this method 
    returns a System.String that represents a relative URI that,when appended to the current 
    URI instance,yields the toUri parameter.If the hostname or scheme is different,then 
    this method returns a System.String that represents the toUri parameter.
  """
  pass
 def MakeRelativeUri(self,uri):
  ...
  MakeRelativeUri(self: Uri,uri: Uri) -> Uri
   ...
   Returns: If the hostname and scheme of this URI instance and uri are the same,then this method 
    returns a relative System.Uri that,when appended to the current URI instance,yields 
    uri.If the hostname or scheme is different,then this method returns a System.Uri  that 
 ...
 def Parse(self,*args):
  """
  Parse(self: Uri)
   Parses the URI of the current instance to ensure it contains all the parts required for a 
    valid URI.
  """
  pass
 def ToString(self):
  ...
  ToString(self: Uri) -> str
   ...
   Returns: A System.String instance that contains the unescaped canonical representation of the 
    System.Uri instance. All characters are unescaped except #,?,and %.
  """
  pass
 @staticmethod
