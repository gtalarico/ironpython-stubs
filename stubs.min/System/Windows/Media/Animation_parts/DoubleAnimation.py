class DoubleAnimation(DoubleAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: DoubleAnimation) -> DoubleAnimation
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.DoubleAnimation, making deep copies of this object's values. When copying dependency properties, this method copies resource references and 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: DoubleAnimation, defaultOriginValue: float, defaultDestinationValue: float, animationClock: AnimationClock) -> float
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.DoubleAnimation.
