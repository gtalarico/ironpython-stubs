...
class InvalidPrinterException(SystemException,ISerializable,_Exception):
 ...
 def Instance(self):
  """ This function has been arbitrarily put into the stubs"""
  return InvalidPrinterException()

 def GetObjectData(self,info,context):
  """
  GetObjectData(self: InvalidPrinterException,info: SerializationInfo,context: StreamingContext)
   Overridden. Sets the System.Runtime.Serialization.SerializationInfo with information about the exception.
...
class Margins(object,ICloneable):
 ...
 def Equals(self,obj):
  ...
  Equals(self: Margins,obj: object) -> bool
   ...
   Compares this System.Drawing.Printing.Margins to the specified System.Object to determine whether they have the same dimensions.
  
   obj: The object to which to compare this System.Drawing.Printing.Margins.
   Returns: true if the specified object is a System.Drawing.Printing.Margins and has the same System.Drawing.Printing.Margins.Top,System.Drawing.Printing.Margins.Bottom,System.Drawing.Printing.Margins.Right and System.Drawing.Printing.Margins.Left values as this System.Drawing.Printing.Margins; otherwise,false.
  """
  pass
...
class MarginsConverter(ExpandableObjectConverter):
 ...
 def CreateInstance(self,*__args):
  ...
  CreateInstance(self: MarginsConverter,context: ITypeDescriptorContext,propertyValues: IDictionary) -> object
   ...
   Returns: An System.Object representing the specified System.Collections.IDictionary,or null if the object cannot be created.
  """
  pass
 def GetCreateInstanceSupported(self,context=None):
  ...
  GetCreateInstanceSupported(self: MarginsConverter,context: ITypeDescriptorContext) -> bool
   ...
   Returns whether changing a value on this object requires a call to the System.Drawing.Printing.MarginsConverter.CreateInstance(System.ComponentModel.ITypeDescriptorContext,System.Collections.IDictionary) method to create a new value,using the specified context.
  
   context: An System.ComponentModel.ITypeDescriptorContext that provides a format context.
   Returns: true if changing a property on this object requires a call to System.Drawing.Printing.MarginsConverter.CreateInstance(System.ComponentModel.ITypeDescriptorContext,System.Collections.IDictionary) to create a new value; otherwise,false. This method always returns true.
  """
  pass
...
class PreviewPrintController(PrintController):
 ...
 def GetPreviewPageInfo(self):
  ...
  GetPreviewPageInfo(self: PreviewPrintController) -> Array[PreviewPageInfo]
   ...
   Returns: An array of type System.Drawing.Printing.PreviewPageInfo that contains the pages of a System.Drawing.Printing.PrintDocument as a series of images.
  """
  pass
 def OnEndPage(self,document,e):
  """
  OnEndPage(self: PreviewPrintController,document: PrintDocument,e: PrintPageEventArgs)
   ...
   e: A System.Drawing.Printing.PrintPageEventArgs that contains data about how to preview a page in the print document.
  """
  pass
 def OnEndPrint(self,document,e):
  """
  OnEndPrint(self: PreviewPrintController,document: PrintDocument,e: PrintEventArgs)
   ...
   document: A System.Drawing.Printing.PrintDocument that represents the document being previewed.
   e: A System.Drawing.Printing.PrintEventArgs that contains data about how to preview the print document.
  """
  pass
 def OnStartPage(self,document,e):
  """
  OnStartPage(self: PreviewPrintController,document: PrintDocument,e: PrintPageEventArgs) -> Graphics
   ...
   document: A System.Drawing.Printing.PrintDocument that represents the document being previewed.
   e: A System.Drawing.Printing.PrintPageEventArgs that contains data about how to preview a page in the print document. Initially,the System.Drawing.Printing.PrintPageEventArgs.Graphics property of this parameter will be null. The value returned from this method will be used to set this property.
   Returns: A System.Drawing.Graphics that represents a page from a System.Drawing.Printing.PrintDocument.
  """
  pass
 def OnStartPrint(self,document,e):
...
class PrinterSettings(object,ICloneable):
 ...
 def CreateMeasurementGraphics(self,*__args):
  ...
  CreateMeasurementGraphics(self: PrinterSettings,honorOriginAtMargins: bool) -> Graphics
   ...
   Returns: A System.Drawing.Graphics that contains printer information from the System.Drawing.Printing.PageSettings.
 ...
 def GetHdevmode(self,pageSettings=None):
  ...
  GetHdevmode(self: PrinterSettings,pageSettings: PageSettings) -> IntPtr
   ...
   pageSettings: The System.Drawing.Printing.PageSettings object that the DEVMODE structure's handle corresponds to.
   Returns: A handle to a DEVMODE structure.
  """
  pass
...
class PrinterUnitConvert(object):
 ...
 def Convert(value,fromUnit,toUnit):
  ...
  Convert(value: float,fromUnit: PrinterUnit,toUnit: PrinterUnit) -> float
   ...
   Converts a double-precision floating-point number from one System.Drawing.Printing.PrinterUnit type to another System.Drawing.Printing.PrinterUnit type.
  
   value: The System.Drawing.Point being converted.
   fromUnit: The unit to convert from.
   toUnit: The unit to convert to.
   Returns: A double-precision floating-point number that represents the converted System.Drawing.Printing.PrinterUnit.
  Convert(value: int,fromUnit: PrinterUnit,toUnit: PrinterUnit) -> int
  
   Converts a 32-bit signed integer from one System.Drawing.Printing.PrinterUnit type to another System.Drawing.Printing.PrinterUnit type.
  ...
  Convert(value: Point,fromUnit: PrinterUnit,toUnit: PrinterUnit) -> Point
   ...
   Converts a System.Drawing.Point from one System.Drawing.Printing.PrinterUnit type to another System.Drawing.Printing.PrinterUnit type.
  ...
  Convert(value: Size,fromUnit: PrinterUnit,toUnit: PrinterUnit) -> Size
   ...
   Converts a System.Drawing.Size from one System.Drawing.Printing.PrinterUnit type to another System.Drawing.Printing.PrinterUnit type.
  ...
  Convert(value: Rectangle,fromUnit: PrinterUnit,toUnit: PrinterUnit) -> Rectangle
   ...
   Converts a System.Drawing.Rectangle from one System.Drawing.Printing.PrinterUnit type to another System.Drawing.Printing.PrinterUnit type.
  ...
  Convert(value: Margins,fromUnit: PrinterUnit,toUnit: PrinterUnit) -> Margins
   ...
   Converts a System.Drawing.Printing.Margins from one System.Drawing.Printing.PrinterUnit type to another System.Drawing.Printing.PrinterUnit type.
  
   value: The System.Drawing.Printing.Margins being converted.
   fromUnit: The unit to convert from.
   toUnit: The unit to convert to.
   Returns: A System.Drawing.Printing.Margins that represents the converted System.Drawing.Printing.PrinterUnit.
  """
  pass
...
class PrintingPermission(CodeAccessPermission,IPermission,ISecurityEncodable,IStackWalk,IUnrestrictedPermission):
 ...
 def IsSubsetOf(self,target):
  ...
  IsSubsetOf(self: PrintingPermission,target: IPermission) -> bool
   ...
   target: A permission object that is to be tested for the subset relationship. This object must be of the same type as the current permission object.
...
class PrintingPermissionAttribute(CodeAccessSecurityAttribute,_Attribute):
 ...
 def Instance(self):
  """ This function has been arbitrarily put into the stubs"""
  return PrintingPermissionAttribute()

 def CreatePermission(self):
  """
  CreatePermission(self: PrintingPermissionAttribute) -> IPermission
  
   Creates the permission based on the requested access levels,which are set through the System.Drawing.Printing.PrintingPermissionAttribute.Level property on the attribute.
...
class PrintingPermissionLevel(Enum,IComparable,IFormattable,IConvertible):
 ...
 def Instance(self):
  """ This function has been arbitrarily put into the stubs"""
  return PrintingPermissionLevel()
...
class QueryPageSettingsEventArgs(PrintEventArgs):
 ...
 def Instance(self):
  """ This function has been arbitrarily put into the stubs"""
  return QueryPageSettingsEventArgs()
...
class QueryPageSettingsEventHandler(MulticastDelegate,ICloneable,ISerializable):
 ...
 def Instance(self):
  """ This function has been arbitrarily put into the stubs"""
  return QueryPageSettingsEventHandler()
...
class StandardPrintController(PrintController):
 ...
 def Instance(self):
  """ This function has been arbitrarily put into the stubs"""
  return StandardPrintController()
 ...
 def OnEndPage(self,document,e):
  ...
  OnEndPage(self: StandardPrintController,document: PrintDocument,e: PrintPageEventArgs)
   ...
   e: A System.Drawing.Printing.PrintPageEventArgs that contains data about how to print a page in the document.
  """
  pass
 def OnEndPrint(self,document,e):
  """
 ...
 def OnStartPage(self,document,e):
  ...
  OnStartPage(self: StandardPrintController,document: PrintDocument,e: PrintPageEventArgs) -> Graphics
   ...
   document: A System.Drawing.Printing.PrintDocument that represents the document being printed.
   e: A System.Drawing.Printing.PrintPageEventArgs that contains data about how to print a page in the document. Initially,the System.Drawing.Printing.PrintPageEventArgs.Graphics property of this parameter will be null. The value returned from the System.Drawing.Printing.StandardPrintController.OnStartPage(System.Drawing.Printing.PrintDocument,System.Drawing.Printing.PrintPageEventArgs) method will be used to set 
    this property.
  
   Returns: A System.Drawing.Graphics object that represents a page from a System.Drawing.Printing.PrintDocument.
  """
  pass
 def OnStartPrint(self,document,e):
  """
