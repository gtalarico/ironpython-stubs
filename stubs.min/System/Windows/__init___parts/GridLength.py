class GridLength(object, IEquatable[GridLength]):
    ...
    def Equals(self, *__args):
        ...
        Equals(self: GridLength, gridLength: GridLength) -> bool
            ...
            Determines whether the specified System.Windows.GridLength is equal to the current System.Windows.GridLength.
        
            gridLength: The System.Windows.GridLength structure to compare with the current instance.
            Returns: true if the specified System.Windows.GridLength has the same value and System.Windows.GridLength.GridUnitType as the current instance; otherwise, false.
        Equals(self: GridLength, oCompare: object) -> bool
        
            Determines whether the specified object is equal to the current System.Windows.GridLength instance.
        
            oCompare: The object to compare with the current instance.
            Returns: true if the specified object has the same value and System.Windows.GridUnitType as the current instance; otherwise, false.
        """
        pass
    ...
    def ToString(self):
        ...
        ToString(self: GridLength) -> str
            ...
            Returns: A System.String representation of the current System.Windows.GridLength structure.
        """
        pass
