class FigureLengthConverter(TypeConverter):
    ...
    def CanConvertFrom(self, *__args):
        ...
        CanConvertFrom(self: FigureLengthConverter, typeDescriptorContext: ITypeDescriptorContext, sourceType: Type) -> bool
            ...
            Indicates whether an object can be converted from a given type to an instance of a System.Windows.FigureLength.
            ...
            Returns: true if object of the specified type can be converted to a System.Windows.FigureLength; otherwise, false.
        """
        pass
    ...
    def CanConvertTo(self, *__args):
        ...
        CanConvertTo(self: FigureLengthConverter, typeDescriptorContext: ITypeDescriptorContext, destinationType: Type) -> bool
            ...
            Determines whether instances of System.Windows.FigureLength can be converted to the specified type.
        
            typeDescriptorContext: Describes the context information of a type.
            destinationType: The desired type this System.Windows.FigureLength is being evaluated to be converted to.
            Returns: true if instances of System.Windows.FigureLength can be converted to destinationType; otherwise, false.
        """
        pass
