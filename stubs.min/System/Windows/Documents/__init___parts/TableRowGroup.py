class TableRowGroup(TextElement, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild, IIndexedChild[Table], IAcceptInsertion):
    """
    Represents a flow content element used to group System.Windows.Documents.TableRow elements within a System.Windows.Documents.Table.
    ...
    def ShouldSerializeRows(self):
        """
        ShouldSerializeRows(self: TableRowGroup) -> bool
        
            Indicates whether the System.Windows.Documents.TableRowGroup.Rows property should be persisted.
...
"""
    ...
    """Gets a System.Windows.Documents.TableRowCollection that contains the System.Windows.Documents.TableRow objects that comprise the contents of the System.Windows.Documents.TableRowGroup.

Get: Rows(self: TableRowGroup) -> TableRowCollection
