...
class AnalysisDisplayColoredSurfaceSettings(object):
    """
...
class AnalysisDisplayColorEntry(object):
    """
...
class AnalysisDisplayColorSettings(object):
    """
...
class AnalysisDisplayDeformedShapeSettings(object):
    """
...
class AnalysisDisplayDiagramSettings(object):
    """
...
class AnalysisDisplayLegendSettings(object):
    """
...
class AnalysisDisplayMarkersAndTextSettings(object):
    """
...
class AnalysisDisplayStyleColorSettingsType(Enum):
    """
...
class AnalysisDisplayStyleDeformedShapeTextLabelType(Enum):
    """
...
class AnalysisDisplayStyleDiagramFenceType(Enum):
    """
...
class AnalysisDisplayStyleDiagramTextLabelType(Enum):
    """
...
class AnalysisDisplayStyleMarkerTextLabelType(Enum):
    """
...
class AnalysisDisplayStyleMarkerType(Enum):
    """
...
class AnalysisDisplayStyleVectorArrowheadScale(Enum):
    """
...
class AnalysisDisplayStyleVectorOrientation(Enum):
    """
...
class AnalysisDisplayStyleVectorPosition(Enum):
    """
...
class AnalysisDisplayStyleVectorTextType(Enum):
    """
...
class AnalysisDisplayVectorSettings(object):
    """
...
class AnalysisResultSchema(object):
    """
...
class BuildingEnvelopeAnalyzer(object):
...
class BuildingEnvelopeAnalyzerOptions(object):
    """
...
class ConceptualConstructionFloorSlabType(Enum):
    """
...
class ConceptualConstructionOpeningType(Enum):
    """
...
class ConceptualConstructionRoofType(Enum):
    """
...
class ConceptualConstructionShadeType(Enum):
    """
...
class ConceptualConstructionWallType(Enum):
    """
...
class ConceptualConstructionWindowSkylightType(Enum):
    """
...
class EnergyAnalysisDetailModelOptions(object):
    """
...
class EnergyAnalysisDetailModelTier(Enum):
    """
    Level of computation for energy analysis model.
...
class EnergyAnalysisOpeningType(Enum):
    """
...
class EnergyAnalysisSurfaceType(Enum):
    """
...
class FieldDomainPoints(object):
...
class gbXMLBuildingHVACSystem(Enum):
    """
...
class gbXMLBuildingOperatingSchedule(Enum):
    """
    Enumerations for gbXML (Green Building XML) format, used for energy
       analysis, schema version 0.34.
...
class gbXMLExportBuildingEnvelope(Enum):
    """
...
class gbXMLExportComplexity(Enum):
    """
...
class HVACLoadConstructionClass(Enum):
    """
...
class HVACLoadLoadsReportType(Enum):
    """
...
class MassGBXMLExportOptions(object):
    """
...
class MassSurfaceDataMaterialType(Enum):
    """
...
class MassSurfaceDataSource(Enum):
    """
...
class MassZoneLevelCutState(Enum):
    """
...
class MassZoneMaterialType(Enum):
    """
...
class SpatialFieldPrimitiveHideMode(Enum):
    """
