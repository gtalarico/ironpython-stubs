class LineBreak(Inline, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild):
    """
    An inline flow content element that causes a line break to occur in flow content.
    
    LineBreak()
    LineBreak(insertionPosition: TextPointer)
    """
    ...
    def __new__(self, insertionPosition=None):
        """
        __new__(cls: type)
        __new__(cls: type, insertionPosition: TextPointer)
        """
        pass
