class FlowDocument(FrameworkContentElement, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IDocumentPaginatorSource, IServiceProvider, IAddChild):
    """
    Hosts and formats flow content with advanced document features, such as pagination and columns.
    
    FlowDocument()
    FlowDocument(block: Block)
    """
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        """
        OnCreateAutomationPeer(self: FlowDocument) -> AutomationPeer
        
            When overridden in a derived class, provides specific System.Windows.Automation.Peers.AutomationPeer implementations to the Windows Presentation Foundation (WPF) infrastructure.
    ...
    def OnPropertyChanged(self, *args): #cannot find CLR method
        """
        OnPropertyChanged(self: FlowDocument, e: DependencyPropertyChangedEventArgs)
    ...
    def SetDpi(self, dpiInfo):
        """ SetDpi(self: FlowDocument, dpiInfo: DpiScale) """
        pass
    ...
    def __new__(self, block=None):
        """
        __new__(cls: type)
        __new__(cls: type, block: Block)
        """
        pass
...
Get: Background(self: FlowDocument) -> Brush

Set: Background(self: FlowDocument) = value
"""
...
Get: Blocks(self: FlowDocument) -> BlockCollection

"""

    ColumnGap = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the column gap value, which indicates the spacing between columns in a System.Windows.Documents.FlowDocument.

Get: ColumnGap(self: FlowDocument) -> float

Set: ColumnGap(self: FlowDocument) = value
"""

    ColumnRuleBrush = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the System.Windows.Media.Brush used to draw the rule between columns.

Get: ColumnRuleBrush(self: FlowDocument) -> Brush

Set: ColumnRuleBrush(self: FlowDocument) = value
"""

    ColumnRuleWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the column rule width.

Get: ColumnRuleWidth(self: FlowDocument) -> float

Set: ColumnRuleWidth(self: FlowDocument) = value
"""

    ColumnWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the minimum desired width of the columns in a System.Windows.Documents.FlowDocument.

Get: ColumnWidth(self: FlowDocument) -> float

Set: ColumnWidth(self: FlowDocument) = value
"""

    ContentEnd = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a System.Windows.Documents.TextPointer that represents the end of the content in a System.Windows.Documents.FlowDocument.

Get: ContentEnd(self: FlowDocument) -> TextPointer

"""

    ContentStart = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a System.Windows.Documents.TextPointer that represents the start of content within a System.Windows.Documents.FlowDocument.

Get: ContentStart(self: FlowDocument) -> TextPointer
...
"""
    ...
    """Gets or sets the relative direction for flow of content in a System.Windows.Documents.FlowDocument.

Get: FlowDirection(self: FlowDocument) -> FlowDirection

Set: FlowDirection(self: FlowDocument) = value
"""

    FontFamily = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the preferred top-level font family for the System.Windows.Documents.FlowDocument.

Get: FontFamily(self: FlowDocument) -> FontFamily

Set: FontFamily(self: FlowDocument) = value
"""

    FontSize = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the top-level font size for the System.Windows.Documents.FlowDocument.

Get: FontSize(self: FlowDocument) -> float

Set: FontSize(self: FlowDocument) = value
"""

    FontStretch = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the top-level font-stretching characteristics for the System.Windows.Documents.FlowDocument.

Get: FontStretch(self: FlowDocument) -> FontStretch

Set: FontStretch(self: FlowDocument) = value
"""

    FontStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the top-level font style for the System.Windows.Documents.FlowDocument.

Get: FontStyle(self: FlowDocument) -> FontStyle

Set: FontStyle(self: FlowDocument) = value
"""

    FontWeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the top-level font weight for the System.Windows.Documents.FlowDocument.

Get: FontWeight(self: FlowDocument) -> FontWeight

Set: FontWeight(self: FlowDocument) = value
"""

    Foreground = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the System.Windows.Media.Brush to apply to the text contents of the System.Windows.Documents.FlowDocument.

Get: Foreground(self: FlowDocument) -> Brush

Set: Foreground(self: FlowDocument) = value
"""

    IsColumnWidthFlexible = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that indicates whether the System.Windows.Documents.FlowDocument.ColumnWidth value is flexible or fixed.

Get: IsColumnWidthFlexible(self: FlowDocument) -> bool

Set: IsColumnWidthFlexible(self: FlowDocument) = value
"""

    IsEnabledCore = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the value of the System.Windows.ContentElement.IsEnabled property for the System.Windows.Documents.FlowDocument.
...
Get: IsHyphenationEnabled(self: FlowDocument) -> bool

Set: IsHyphenationEnabled(self: FlowDocument) = value
"""

    IsOptimalParagraphEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that indicates whether optimal paragraph layout is enabled or disabled.

Get: IsOptimalParagraphEnabled(self: FlowDocument) -> bool

Set: IsOptimalParagraphEnabled(self: FlowDocument) = value
"""

    LineHeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the height of each line of content.

Get: LineHeight(self: FlowDocument) -> float

Set: LineHeight(self: FlowDocument) = value
"""

    LineStackingStrategy = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the mechanism by which a line box is determined for each line of text within the System.Windows.Documents.FlowDocument.

Get: LineStackingStrategy(self: FlowDocument) -> LineStackingStrategy

Set: LineStackingStrategy(self: FlowDocument) = value
"""

    LogicalChildren = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets an enumerator that can iterate the logical children of the System.Windows.Documents.FlowDocument.

"""

    MaxPageHeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the maximum height for pages in a System.Windows.Documents.FlowDocument.

Get: MaxPageHeight(self: FlowDocument) -> float

Set: MaxPageHeight(self: FlowDocument) = value
"""

    MaxPageWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the maximum width for pages in a System.Windows.Documents.FlowDocument.

Get: MaxPageWidth(self: FlowDocument) -> float

Set: MaxPageWidth(self: FlowDocument) = value
"""

    MinPageHeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the minimum height for pages in a System.Windows.Documents.FlowDocument.

Get: MinPageHeight(self: FlowDocument) -> float

Set: MinPageHeight(self: FlowDocument) = value
"""

    MinPageWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the minimum width for pages in a System.Windows.Documents.FlowDocument.

Get: MinPageWidth(self: FlowDocument) -> float

Set: MinPageWidth(self: FlowDocument) = value
"""

    PageHeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the preferred height for pages in a System.Windows.Documents.FlowDocument.

Get: PageHeight(self: FlowDocument) -> float

Set: PageHeight(self: FlowDocument) = value
"""

    PagePadding = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
Get: PagePadding(self: FlowDocument) -> Thickness

Set: PagePadding(self: FlowDocument) = value
"""

    PageWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the preferred width for pages in a System.Windows.Documents.FlowDocument.

Get: PageWidth(self: FlowDocument) -> float

Set: PageWidth(self: FlowDocument) = value
"""

    TextAlignment = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that indicates the horizontal alignment of text content.

Get: TextAlignment(self: FlowDocument) -> TextAlignment

Set: TextAlignment(self: FlowDocument) = value
"""

    TextEffects = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the effects to apply to the text of a System.Windows.Documents.FlowDocument.

Get: TextEffects(self: FlowDocument) -> TextEffectCollection

Set: TextEffects(self: FlowDocument) = value
"""

    Typography = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the currently effective typography variations for the text contents of the System.Windows.Documents.FlowDocument.

Get: Typography(self: FlowDocument) -> Typography

"""


    BackgroundProperty = None
    ColumnGapProperty = None
    ColumnRuleBrushProperty = None
    ColumnRuleWidthProperty = None
    ...
    IsColumnWidthFlexibleProperty = None
    IsHyphenationEnabledProperty = None
    IsOptimalParagraphEnabledProperty = None
    LineHeightProperty = None
    LineStackingStrategyProperty = None
    MaxPageHeightProperty = None
    MaxPageWidthProperty = None
    MinPageHeightProperty = None
    MinPageWidthProperty = None
    PageHeightProperty = None
    PagePaddingProperty = None
    PageWidthProperty = None
