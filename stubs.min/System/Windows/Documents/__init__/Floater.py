class Floater(AnchoredBlock, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild):
    """
    Provides an inline-level flow content element used to host a floater. A floater displays images and other content parallel to the main content flow in a System.Windows.Documents.FlowDocument.
    
    Floater()
    Floater(childBlock: Block)
    Floater(childBlock: Block, insertionPosition: TextPointer)
    """
...
"""
    ...
    """Gets or sets a value that indicates the horizontal alignment for a System.Windows.Documents.Floater object.

Get: HorizontalAlignment(self: Floater) -> HorizontalAlignment

Set: HorizontalAlignment(self: Floater) = value
"""
...
"""
    ...
    """Gets or sets a value that indicates the width of a System.Windows.Documents.Floater object.

Get: Width(self: Floater) -> float

Set: Width(self: Floater) = value
"""
