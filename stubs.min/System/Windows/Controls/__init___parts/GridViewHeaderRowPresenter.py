class GridViewHeaderRowPresenter(GridViewRowPresenterBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IWeakEventListener):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: GridViewHeaderRowPresenter,arrangeSize: Size) -> Size
   ...
   Arranges the content of the header row elements,and computes the actual size 
    of the header row.
 ...
 def GetVisualChild(self,*args):
  ...
  GetVisualChild(self: GridViewRowPresenterBase,index: int) -> Visual
   ...
   Returns: A System.Windows.Media.Visual object that contains the child at the specified 
    index.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: GridViewHeaderRowPresenter) -> AutomationPeer
   ...
   Creates an System.Windows.Automation.Peers.AutomationPeer object for the column 
    header row.
  
   Returns: A System.Windows.Automation.Peers.GridViewHeaderRowPresenterAutomationPeer 
    object for this column header row.
  """
  pass
 ...
 def OnLostMouseCapture(self,*args):
  ...
  OnLostMouseCapture(self: GridViewHeaderRowPresenter,e: MouseEventArgs)
   Provides class handling for the System.Windows.UIElement.LostMouseCapture event 
    for the System.Windows.Controls.GridViewColumnHeader.
 ...
 def OnMouseLeftButtonDown(self,*args):
  ...
  OnMouseLeftButtonDown(self: GridViewHeaderRowPresenter,e: MouseButtonEventArgs)
   Provides class handling for the System.Windows.UIElement.MouseLeftButtonDown 
    event that occurs when the user presses the left mouse button inside a 
 ...
 def OnMouseLeftButtonUp(self,*args):
  ...
  OnMouseLeftButtonUp(self: GridViewHeaderRowPresenter,e: MouseButtonEventArgs)
   Provides class handling for the System.Windows.UIElement.MouseLeftButtonUp 
    event that occurs when the user releases the left mouse button.
