class ParallelTimeline(TimelineGroup,ISealable,IAnimatable,IResource,IAddChild):
 ...
 def Clone(self):
  ...
  Clone(self: ParallelTimeline) -> ParallelTimeline
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.ParallelTimeline,making deep copies of this 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: ParallelTimeline) -> ParallelTimeline
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.ParallelTimeline object,making deep copies of 
