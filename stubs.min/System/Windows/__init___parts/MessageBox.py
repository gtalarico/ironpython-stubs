class MessageBox(object):
    ...
    def Show(*__args):
        ...
        Show(owner: Window, messageBoxText: str, caption: str, button: MessageBoxButton, icon: MessageBoxImage) -> MessageBoxResult
            ...
            Returns: A System.Windows.MessageBoxResult value that specifies which message box button is clicked by the user.
        Show(owner: Window, messageBoxText: str, caption: str, button: MessageBoxButton, icon: MessageBoxImage, defaultResult: MessageBoxResult) -> MessageBoxResult
            ...
            button: A System.Windows.MessageBoxButton value that specifies which button or buttons to display.
            icon: A System.Windows.MessageBoxImage value that specifies the icon to display.
            defaultResult: A System.Windows.MessageBoxResult value that specifies the default result of the message box.
            Returns: A System.Windows.MessageBoxResult value that specifies which message box button is clicked by the user.
        Show(owner: Window, messageBoxText: str, caption: str, button: MessageBoxButton, icon: MessageBoxImage, defaultResult: MessageBoxResult, options: MessageBoxOptions) -> MessageBoxResult
            ...
            Displays a message box in front of the specified window. The message box displays a message, title bar caption, button, and icon; and accepts a default message box result, complies with the specified 
