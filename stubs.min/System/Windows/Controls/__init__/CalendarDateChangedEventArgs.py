class CalendarDateChangedEventArgs(RoutedEventArgs):
    ...
    AddedDate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RemovedDate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
