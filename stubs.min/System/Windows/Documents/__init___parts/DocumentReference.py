class DocumentReference(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IUriContext):
    """
    Provides access to reference a System.Windows.Documents.FixedDocument.
    ...
    def GetDocument(self, forceReload):
        """
        GetDocument(self: DocumentReference, forceReload: bool) -> FixedDocument
        
            Synchronously loads and parses the document specified by the System.Windows.Documents.DocumentReference.Source property location.
        
            forceReload: true to force a new load of the System.Windows.Documents.DocumentReference.Source document, even if it was previously loaded.
    ...
    def SetDocument(self, doc):
        """
        SetDocument(self: DocumentReference, doc: FixedDocument)
            Attaches a System.Windows.Documents.FixedDocument to the System.Windows.Documents.DocumentReference.
        
            doc: The document that is attached.
        """
        pass
...
Get: Source(self: DocumentReference) -> Uri

Set: Source(self: DocumentReference) = value
"""
