...
"""
 ...
 CompositionText=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 SystemCompositionText=property(lambda self: object(),lambda self,v: None,lambda self: None)
