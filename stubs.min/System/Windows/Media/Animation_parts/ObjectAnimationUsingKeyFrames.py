class ObjectAnimationUsingKeyFrames(ObjectAnimationBase, ISealable, IAnimatable, IResource, IKeyFrameAnimation, IAddChild):
    ...
    def AddChild(self, *args): #cannot find CLR method
        ...
        AddChild(self: ObjectAnimationUsingKeyFrames, child: object)
            Adds a child System.Windows.Media.Animation.ObjectKeyFrame to this System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames.
        
            child: The object to be added as the child of this System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames.
        """
        pass
    ...
    def AddText(self, *args): #cannot find CLR method
        ...
        AddText(self: ObjectAnimationUsingKeyFrames, childText: str)
            Adds a text string as a child of this System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames.
    ...
    def Clone(self):
        ...
        Clone(self: ObjectAnimationUsingKeyFrames) -> ObjectAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: ObjectAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames. When copying dependency properties, this method copies resource references and data bindings 
    ...
    def CloneCurrentValue(self):
        ...
        CloneCurrentValue(self: ObjectAnimationUsingKeyFrames) -> ObjectAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames object, making deep copies of this object's current values. Resource references, data bindings, and 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: ObjectAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames using current property values. Resource references, data bindings, and animations 
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: ObjectAnimationUsingKeyFrames, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames object is read-only or determines whether it can be made read-only.
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: ObjectAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: ObjectAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames. Resource references, data bindings, and animations are not copied, but their current values 
             are.
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: ObjectAnimationUsingKeyFrames, defaultOriginValue: object, defaultDestinationValue: object, animationClock: AnimationClock) -> object
            ...
            Calculates a value that represents the current value of the property being animated, as determined by this instance of System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames.
    ...
    def OnChanged(self, *args): #cannot find CLR method
        ...
        OnChanged(self: ObjectAnimationUsingKeyFrames)
            Called when the current System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames object is modified.
        """
        pass
    ...
    def ShouldSerializeKeyFrames(self):
        ...
        ShouldSerializeKeyFrames(self: ObjectAnimationUsingKeyFrames) -> bool
            ...
            Returns true if the value of the System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames.KeyFrames property of this instance of System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames should be 
             value-serialized.
