class Hyperlink(Span, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild, ICommandSource, IUriContext):
    """
    An inline-level flow content element that provides facilities for hosting hyperlinks within flow content.
    
    Hyperlink()
    Hyperlink(childInline: Inline)
    Hyperlink(childInline: Inline, insertionPosition: TextPointer)
    Hyperlink(start: TextPointer, end: TextPointer)
    """
    ...
    def DoClick(self):
        """
        DoClick(self: Hyperlink)
            Simulates the act of a user clicking the System.Windows.Documents.Hyperlink.
        """
        pass
    ...
    def OnClick(self, *args): #cannot find CLR method
        """
        OnClick(self: Hyperlink)
            Handles the System.Windows.Documents.Hyperlink.Click�routed event.
        """
        pass
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        """
        OnCreateAutomationPeer(self: Hyperlink) -> AutomationPeer
        
            Creates and returns an System.Windows.Automation.Peers.AutomationPeer object for this System.Windows.Documents.Hyperlink.
            Returns: An System.Windows.Automation.Peers.AutomationPeer object for this System.Windows.Documents.Hyperlink.
        """
        pass
    ...
    def OnKeyDown(self, *args): #cannot find CLR method
        """
        OnKeyDown(self: Hyperlink, e: KeyEventArgs)
            Handles the System.Windows.ContentElement.KeyDown�routed event.
        
            e: Arguments associated with the System.Windows.ContentElement.KeyDown event.
        """
        pass
    ...
    def OnMouseLeftButtonDown(self, *args): #cannot find CLR method
        """
        OnMouseLeftButtonDown(self: Hyperlink, e: MouseButtonEventArgs)
            Handles the System.Windows.ContentElement.MouseLeftButtonDown�routed event.
        
            e: Arguments associated with the System.Windows.ContentElement.MouseLeftButtonDown event.
        """
        pass

    def OnMouseLeftButtonUp(self, *args): #cannot find CLR method
        """
        OnMouseLeftButtonUp(self: Hyperlink, e: MouseButtonEventArgs)
            Handles the System.Windows.ContentElement.MouseLeftButtonUp�routed event.
        
            e: Arguments associated with the System.Windows.ContentElement.MouseLeftButtonUp event.
        """
        pass
    ...
    """Gets or sets a base URI for the System.Windows.Documents.Hyperlink.

"""

    Command = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a command to associate with the System.Windows.Documents.Hyperlink.

Get: Command(self: Hyperlink) -> ICommand

Set: Command(self: Hyperlink) = value
"""

    CommandParameter = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets command parameters associated with the command specified by the System.Windows.Documents.Hyperlink.Command property.

Get: CommandParameter(self: Hyperlink) -> object

Set: CommandParameter(self: Hyperlink) = value
"""

    CommandTarget = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a target element on which to execute the command specified by the System.Windows.Documents.Hyperlink.Command property.

Get: CommandTarget(self: Hyperlink) -> IInputElement

Set: CommandTarget(self: Hyperlink) = value
"""
...
"""
    ...
    """Gets a value that indicates whether or not the System.Windows.Documents.Hyperlink is enabled.
...
"""
    ...
    NavigateUri = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a URI to navigate to when the System.Windows.Documents.Hyperlink is activated.

Get: NavigateUri(self: Hyperlink) -> Uri

Set: NavigateUri(self: Hyperlink) = value
"""

    TargetName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the name of a target window or frame for the System.Windows.Documents.Hyperlink.

Get: TargetName(self: Hyperlink) -> str

Set: TargetName(self: Hyperlink) = value
"""
    ...
    RequestNavigate = None
    RequestNavigateEvent = None
