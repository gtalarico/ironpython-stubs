class DataGridBoundColumn(DataGridColumn):
    ...
    def OnBindingChanged(self, *args): #cannot find CLR method
        """
        OnBindingChanged(self: DataGridBoundColumn, oldBinding: BindingBase, newBinding: BindingBase)
            Notifies the System.Windows.Controls.DataGrid when the value of the System.Windows.Controls.DataGridBoundColumn.Binding property changes.
