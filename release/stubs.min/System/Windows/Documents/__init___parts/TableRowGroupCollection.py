 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: TableRowGroupCollection,array: Array[TableRowGroup],index: int)
   Copies the contents of the collection and inserts them into a specified 
    System.Windows.Documents.TableRowGroup array of starting at a specified index 
    position in the array.
  
  
   array: A one-dimensional System.Windows.Documents.TableRowGroup array to which the 
 ...
 def TrimToSize(self):
  ...
  TrimToSize(self: TableRowGroupCollection)
   Optimizes memory consumption for the collection by setting the underlying 
    collection System.Windows.Documents.TableRowGroupCollection.Capacity equal to 
    the System.Windows.Documents.TableRowGroupCollection.Count of items currently 
    in the collection.
  """
  pass
