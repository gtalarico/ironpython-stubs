class ToolStripItem(Component, IComponent, IDisposable, IDropTarget, ISupportOleDropSource, IArrangedElement):
    ...
    def Invalidate(self, r=None):
        ...
        Invalidate(self: ToolStripItem, r: Rectangle)
            Invalidates the specified region of the System.Windows.Forms.ToolStripItem by adding it to the update region of the System.Windows.Forms.ToolStripItem, which is the area that will be repainted at the next 
             paint operation, and causes a paint message to be sent to the System.Windows.Forms.ToolStripItem.
...
"""
    ...
    AutoToolTip = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ContentRectangle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DoubleClickEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ImageScaling = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ImageTransparentColor = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsOnDropDown = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsOnOverflow = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MergeAction = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MergeIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    TextImageRelation = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
