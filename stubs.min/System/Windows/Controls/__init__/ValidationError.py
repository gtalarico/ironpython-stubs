class ValidationError(object):
    ...
    BindingInError = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ErrorContent = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RuleInError = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
