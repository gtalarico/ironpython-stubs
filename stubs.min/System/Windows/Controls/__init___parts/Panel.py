class Panel(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def ShouldSerializeChildren(self):
        ...
        ShouldSerializeChildren(self: Panel) -> bool
            ...
            Determines whether the System.Windows.Controls.Panel.Children collection of a panel should be serialized.
            Returns: true if the System.Windows.Controls.Panel.Children collection should be serialized; otherwise, false. The System.Windows.Controls.Panel.Children collection is only serialized if it is not empty and not 
             null.
        """
        pass
...
"""
    ...
    HasLogicalOrientationPublic = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsItemsHost = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    LogicalOrientationPublic = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
