class MaskedTextBox(TextBoxBase,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def ClearUndo(self):
  ...
  ClearUndo(self: MaskedTextBox)
   Clears information about the most recent operation from the undo buffer of the 
    text box. This method is not supported by System.Windows.Forms.MaskedTextBox.
  """
  pass
 ...
 def GetFirstCharIndexFromLine(self,lineNumber):
  ...
  GetFirstCharIndexFromLine(self: MaskedTextBox,lineNumber: int) -> int
   ...
   Retrieves the index of the first character of a given line. This method is not 
    supported by System.Windows.Forms.MaskedTextBox.
 ...
 def GetFirstCharIndexOfCurrentLine(self):
  ...
  GetFirstCharIndexOfCurrentLine(self: MaskedTextBox) -> int
   ...
   Retrieves the index of the first character of the current line. This method is 
    not supported by System.Windows.Forms.MaskedTextBox.
 ...
 def GetLineFromCharIndex(self,index):
  ...
  GetLineFromCharIndex(self: MaskedTextBox,index: int) -> int
   ...
   Retrieves the line number from the specified character position within the text 
    of the control. This method is not supported by 
 ...
 def GetPositionFromCharIndex(self,index):
  ...
  GetPositionFromCharIndex(self: MaskedTextBox,index: int) -> Point
   ...
   Returns: The location of the specified character within the client rectangle of the 
    control.
  """
  pass
 ...
 def OnMultilineChanged(self,*args):
  ...
  OnMultilineChanged(self: MaskedTextBox,e: EventArgs)
   Typically raises the System.Windows.Forms.MaskedTextBox.MultilineChanged event,
    but disabled for System.Windows.Forms.MaskedTextBox.
 ...
 def ProcessKeyMessage(self,*args):
  ...
  ProcessKeyMessage(self: MaskedTextBox,m: Message) -> (bool,Message)
   ...
   Overrides the base implementation of this method to handle input language 
    changes.
 ...
 def ScrollToCaret(self):
  ...
  ScrollToCaret(self: MaskedTextBox)
   Scrolls the contents of the control to the current caret position. This method 
    is not supported by System.Windows.Forms.MaskedTextBox.
  """
  pass
 ...
 def ToString(self):
  ...
  ToString(self: MaskedTextBox) -> str
   ...
   Returns a string that represents the current masked text box. This method 
    overrides System.Windows.Forms.TextBoxBase.ToString.
  
   Returns: A System.String that contains information about the current 
    System.Windows.Forms.MaskedTextBox. The string includes the type,a simplified 
    view of the input string,and the formatted input string.
  """
  pass
 def Undo(self):
  """
 ...
 def ValidateText(self):
  ...
  ValidateText(self: MaskedTextBox) -> object
   ...
   Returns: If successful,an System.Object of the type specified by the 
    System.Windows.Forms.MaskedTextBox.ValidatingType property; otherwise,null to 
    indicate conversion failure.
  """
  pass
