class DataGridViewColumnHeaderCell(DataGridViewHeaderCell,ICloneable,IDisposable):
 ...
 def CreateAccessibilityInstance(self,*args):
  ...
  CreateAccessibilityInstance(self: DataGridViewColumnHeaderCell) -> AccessibleObject
   ...
   Returns: A new System.Windows.Forms.AccessibleObject for the System.Windows.Forms.DataGridViewColumnHeaderCell.
  """
  pass
 def Dispose(self):
  """
 ...
 def GetInheritedContextMenuStrip(self,rowIndex):
  ...
  GetInheritedContextMenuStrip(self: DataGridViewColumnHeaderCell,rowIndex: int) -> ContextMenuStrip
   ...
   rowIndex: The index of the row to get the System.Windows.Forms.ContextMenuStrip of. The index must be -1 to indicate the row of column headers.
   Returns: The System.Windows.Forms.ContextMenuStrip of the column headers if one exists; otherwise,the System.Windows.Forms.ContextMenuStrip inherited from System.Windows.Forms.DataGridView.
  """
  pass
