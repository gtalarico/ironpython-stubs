class ToolStripRenderEventArgs(EventArgs):
    ...
    AffectedBounds = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ConnectedArea = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
