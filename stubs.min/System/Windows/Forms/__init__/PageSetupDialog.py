class PageSetupDialog(CommonDialog, IComponent, IDisposable):
    ...
    AllowMargins = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AllowOrientation = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AllowPaper = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AllowPrinter = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    EnableMetric = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MinMargins = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ShowNetwork = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
