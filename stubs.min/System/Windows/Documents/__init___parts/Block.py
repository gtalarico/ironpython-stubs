class Block(TextElement, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild):
    ...
    @staticmethod
    def GetIsHyphenationEnabled(element):
        """
        GetIsHyphenationEnabled(element: DependencyObject) -> bool
        
            Returns the value of the System.Windows.Documents.Block.IsHyphenationEnabled�attached property for a specified dependency object.
        
            element: The dependency object from which to retrieve the value of the System.Windows.Documents.Block.IsHyphenationEnabled property.
            Returns: The current value of the System.Windows.Documents.Block.IsHyphenationEnabled attached property on the specified dependency object.
        """
        pass
    ...
    def GetLineHeight(element):
        ...
        GetLineHeight(element: DependencyObject) -> float
            ...
            Returns the value of the System.Windows.Documents.Block.LineHeight�attached property for a specified dependency object.
        
            element: The dependency object from which to retrieve the value of the System.Windows.Documents.Block.LineHeight property.
            Returns: The current value of the System.Windows.Documents.Block.LineHeight attached property on the specified dependency object.
        """
        pass
    ...
    def GetLineStackingStrategy(element):
        ...
        GetLineStackingStrategy(element: DependencyObject) -> LineStackingStrategy
            ...
            Returns the value of the System.Windows.Documents.Block.LineStackingStrategy�attached property for a specified dependency object.
        
            element: The dependency object from which to retrieve the value of the System.Windows.Documents.Block.LineStackingStrategy attached property.
            Returns: The current value of the System.Windows.Documents.Block.LineStackingStrategy attached property on the specified dependency object.
        """
        pass
    ...
    def GetTextAlignment(element):
        ...
        GetTextAlignment(element: DependencyObject) -> TextAlignment
            ...
            Returns the value of the System.Windows.Documents.Block.TextAlignment�attached property for a specified dependency object.
        
            element: The dependency object from which to retrieve the value of the System.Windows.Documents.Block.TextAlignment property.
            Returns: The current value of the System.Windows.Documents.Block.TextAlignment attached property on the specified dependency object.
        """
        pass
    ...
    @staticmethod
    def SetIsHyphenationEnabled(element, value):
        """
        SetIsHyphenationEnabled(element: DependencyObject, value: bool)
            Sets the value of the System.Windows.Documents.Block.IsHyphenationEnabled�attached property on a specified dependency object.
        
            element: The dependency object on which to set the value of the System.Windows.Documents.Block.IsHyphenationEnabled property.
    ...
    def SetLineHeight(element, value):
        ...
        SetLineHeight(element: DependencyObject, value: float)
            Sets the value of the System.Windows.Documents.Block.LineHeight�attached property for a specified dependency object.
        
            element: The dependency object on which to set the value of the System.Windows.Documents.Block.LineHeight property.
            value: The new value to set the property to.
        """
        pass
    ...
    def SetLineStackingStrategy(element, value):
        ...
        SetLineStackingStrategy(element: DependencyObject, value: LineStackingStrategy)
            Sets the value of the System.Windows.Documents.Block.LineStackingStrategy�attached property on a specified dependency object.
        
            element: The dependency object on which to set the value of the System.Windows.Documents.Block.LineStackingStrategy property.
            value: The new value to set the property to.
        """
        pass
    ...
    def SetTextAlignment(element, value):
        ...
        SetTextAlignment(element: DependencyObject, value: TextAlignment)
            Sets the value of the System.Windows.Documents.Block.TextAlignment�attached property for a specified dependency object.
        
            element: The dependency object on which to set the value of the System.Windows.Documents.Block.TextAlignment property.
            value: The new value to set the property to.
        """
        pass
    ...
    BorderBrush = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a System.Windows.Media.Brush to use when painting the element's border.

Get: BorderBrush(self: Block) -> Brush

Set: BorderBrush(self: Block) = value
"""

    BorderThickness = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the border thickness for the element.

Get: BorderThickness(self: Block) -> Thickness

Set: BorderThickness(self: Block) = value
"""

    BreakColumnBefore = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that indicates whether to automatically insert a column-break before this element in cases where the element participates in a column-based presentation.

Get: BreakColumnBefore(self: Block) -> bool

Set: BreakColumnBefore(self: Block) = value
"""

    BreakPageBefore = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that indicates whether to automatically insert a page-break before this element.

Get: BreakPageBefore(self: Block) -> bool

Set: BreakPageBefore(self: Block) = value
"""

    ClearFloaters = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the direction in which any System.Windows.Documents.Floater elements contained by a System.Windows.Documents.Block element should be repositioned.

Get: ClearFloaters(self: Block) -> WrapDirection

Set: ClearFloaters(self: Block) = value
"""
...
"""
    ...
    """Gets or sets the relative direction for flow of content within a System.Windows.Documents.Block element.

Get: FlowDirection(self: Block) -> FlowDirection

Set: FlowDirection(self: Block) = value
"""
...
Get: IsHyphenationEnabled(self: Block) -> bool

Set: IsHyphenationEnabled(self: Block) = value
"""

    LineHeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the height of each line of content.

Get: LineHeight(self: Block) -> float

Set: LineHeight(self: Block) = value
"""
...
Get: LineStackingStrategy(self: Block) -> LineStackingStrategy

Set: LineStackingStrategy(self: Block) = value
"""
...
Get: Margin(self: Block) -> Thickness

Set: Margin(self: Block) = value
"""

    NextBlock = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the sibling System.Windows.Documents.Block element that directly follows the current System.Windows.Documents.Block element.

Get: NextBlock(self: Block) -> Block
...
Get: Padding(self: Block) -> Thickness

Set: Padding(self: Block) = value
"""

    PreviousBlock = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the sibling System.Windows.Documents.Block element that directly precedes the current System.Windows.Documents.Block element.

Get: PreviousBlock(self: Block) -> Block

"""

    SiblingBlocks = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a collection of System.Windows.Documents.Block elements that are siblings to the current System.Windows.Documents.Block element.

Get: SiblingBlocks(self: Block) -> BlockCollection
...
Get: TextAlignment(self: Block) -> TextAlignment

Set: TextAlignment(self: Block) = value
"""


    BorderBrushProperty = None
    BorderThicknessProperty = None
    BreakColumnBeforeProperty = None
    BreakPageBeforeProperty = None
    ClearFloatersProperty = None
