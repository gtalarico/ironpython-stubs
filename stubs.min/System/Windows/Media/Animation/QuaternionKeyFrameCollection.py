class QuaternionKeyFrameCollection(Freezable, ISealable, IList, ICollection, IEnumerable):
    ...
    def Clone(self):
        ...
        Clone(self: QuaternionKeyFrameCollection) -> QuaternionKeyFrameCollection
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.QuaternionKeyFrameCollection, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: QuaternionKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.QuaternionKeyFrameCollection. When copying dependency properties, this method copies resource references and data bindings 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: QuaternionKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.QuaternionKeyFrameCollection using current property values. Resource references, data bindings, and animations are 
    ...
    def Contains(self, keyFrame):
        ...
        Contains(self: QuaternionKeyFrameCollection, keyFrame: QuaternionKeyFrame) -> bool
            ...
            Gets a value that indicates whether the collection contains the specified System.Windows.Media.Animation.QuaternionKeyFrame.
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: QuaternionKeyFrameCollection, array: Array[QuaternionKeyFrame], index: int)
            Copies all of the System.Windows.Media.Animation.QuaternionKeyFrame objects in a collection to a specified array.
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: QuaternionKeyFrameCollection, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.QuaternionKeyFrameCollection read-only or determines whether it can be made read-only.
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: QuaternionKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.QuaternionKeyFrameCollection object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: QuaternionKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.QuaternionKeyFrameCollection. Resource references, data bindings, and animations are not copied, but their current values 
             are.
    ...
    def IndexOf(self, keyFrame):
        ...
        IndexOf(self: QuaternionKeyFrameCollection, keyFrame: QuaternionKeyFrame) -> int
            ...
            Searches for the specified System.Windows.Media.Animation.QuaternionKeyFrame and returns the zero-based index of the first occurrence within the entire collection.
    ...
    def Insert(self, index, keyFrame):
        ...
        Insert(self: QuaternionKeyFrameCollection, index: int, keyFrame: QuaternionKeyFrame)
            Inserts a System.Windows.Media.Animation.QuaternionKeyFrame into a specific location within the collection.
    ...
    def RemoveAt(self, index):
        ...
        RemoveAt(self: QuaternionKeyFrameCollection, index: int)
            Removes the System.Windows.Media.Animation.QuaternionKeyFrame at the specified index position from the collection.
