class Vector3DAnimationUsingKeyFrames(Vector3DAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 ...
 def Clone(self):
  ...
  Clone(self: Vector3DAnimationUsingKeyFrames) -> Vector3DAnimationUsingKeyFrames
   ...
   Returns: A modifiable clone of this instance. The returned clone is effectively a deep 
    copy of the current object,although some copying might be deferred until 
    necessary for improved performance. The copy's 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: Vector3DAnimationUsingKeyFrames,sourceFreezable: Freezable)
   Makes the specified 
    System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames a modifiable 
    clone (deep copy) of the current object using base (non-animated,
    non-databound) property values.
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: Vector3DAnimationUsingKeyFrames) -> Vector3DAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames object,making 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: Vector3DAnimationUsingKeyFrames,source: Freezable)
   ...
   source: The System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames object to be 
    cloned.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: Vector3DAnimationUsingKeyFrames,source: Freezable)
   ...
   source: The System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames to copy and 
    freeze
  """
  pass
 ...
 def OnChanged(self,*args):
  ...
  OnChanged(self: Vector3DAnimationUsingKeyFrames)
   Called when the current 
    System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames object is 
    modified.
  """
  pass
 ...
 def ShouldSerializeKeyFrames(self):
  ...
  ShouldSerializeKeyFrames(self: Vector3DAnimationUsingKeyFrames) -> bool
   ...
   Returns true if the value of the 
    ...
    System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames should be 
    value-serialized.
