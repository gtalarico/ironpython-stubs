class MatrixAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: MatrixAnimationBase) -> MatrixAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.MatrixAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
