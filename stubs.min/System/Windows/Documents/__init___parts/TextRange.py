class TextRange(object, ITextRange):
    ...
    def CanLoad(self, dataFormat):
        ...
        CanLoad(self: TextRange, dataFormat: str) -> bool
            ...
            dataFormat: A data format to check for load-compatibility into the current selection.  See System.Windows.DataFormats for a list of predefined data formats.
            Returns: true if the current selection can be loaded with content in the specified data format; otherwise, false.
        """
        pass
    ...
    def CanSave(self, dataFormat):
        ...
        CanSave(self: TextRange, dataFormat: str) -> bool
            ...
            dataFormat: A data format to check for save compatibility with the current selection.  See System.Windows.DataFormats for a list of predefined data formats.
            Returns: true if the current selection can be saved as the specified data format; otherwise, false.
        """
        pass
    ...
    def ClearAllProperties(self):
        ...
        ClearAllProperties(self: TextRange)
            Removes all formatting properties (represented by System.Windows.Documents.Inline elements) from the current selection.
        """
        pass
    ...
    def Contains(self, textPointer):
        ...
        Contains(self: TextRange, textPointer: TextPointer) -> bool
            ...
            Checks whether a position (specified by a System.Windows.Documents.TextPointer) is located within the current selection.
        
            textPointer: A position to test for inclusion in the current selection.
            Returns: true if the specified position is located within the current selection; otherwise, false.
        """
        pass
    ...
    def Load(self, stream, dataFormat):
        ...
        Load(self: TextRange, stream: Stream, dataFormat: str)
            ...
            dataFormat: A data format to load the data as.  Currently supported data formats are System.Windows.DataFormats.Rtf, System.Windows.DataFormats.Text, System.Windows.DataFormats.Xaml, and 
    ...
    def Save(self, stream, dataFormat, preserveTextElements=None):
        ...
        Save(self: TextRange, stream: Stream, dataFormat: str, preserveTextElements: bool)
            Saves the current selection to a specified stream in a specified data format, with the option of preserving custom System.Windows.Documents.TextElement objects.
        
            stream: An empty, writable stream to save the current selection to.
            dataFormat: A data format to save the current selection as.  Currently supported data formats are System.Windows.DataFormats.Rtf, System.Windows.DataFormats.Text, System.Windows.DataFormats.Xaml, and 
             System.Windows.DataFormats.XamlPackage.
        
            preserveTextElements: true to preserve custom System.Windows.Documents.TextElement objects; otherwise, false.
    ...
    def Select(self, position1, position2):
        ...
        Select(self: TextRange, position1: TextPointer, position2: TextPointer)
            Updates the current selection, taking two System.Windows.Documents.TextPointer positions to indicate the updated selection.
