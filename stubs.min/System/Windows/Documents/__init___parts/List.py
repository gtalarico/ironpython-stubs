class List(Block,IInputElement,IAnimatable,IFrameworkInputElement,ISupportInitialize,IQueryAmbient,IAddChild):
 """
 ...
 def __init__(self,*args):
  ...
  pass
 @staticmethod
 def __new__(self,listItem=None):
  """
  __new__(cls: type)
  __new__(cls: type,listItem: ListItem)
  """
  pass
...
"""
 ...
 ListItems=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a System.Windows.Documents.ListItemCollection containing the System.Windows.Documents.ListItem elements that comprise the contents of the System.Windows.Documents.List.

Get: ListItems(self: List) -> ListItemCollection
...
"""
 ...
 MarkerOffset=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the desired distance between the contents of each System.Windows.Documents.ListItem element,and the near edge of the list marker.

Get: MarkerOffset(self: List) -> float

Set: MarkerOffset(self: List)=value
"""

 MarkerStyle=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the marker style for the System.Windows.Documents.List.

Get: MarkerStyle(self: List) -> TextMarkerStyle

Set: MarkerStyle(self: List)=value
"""
...
Get: StartIndex(self: List) -> int

Set: StartIndex(self: List)=value
"""


 MarkerOffsetProperty=None
 MarkerStyleProperty=None
 StartIndexProperty=None
