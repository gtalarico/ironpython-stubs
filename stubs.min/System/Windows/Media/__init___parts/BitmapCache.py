class BitmapCache(CacheMode,ISealable,IAnimatable,IResource):
 ...
 def Clone(self):
  ...
  Clone(self: BitmapCache) -> BitmapCache
   ...
   Creates a modifiable clone of the System.Windows.Media.BitmapCache,making deep 
    copies of the object's values. When copying the object's dependency properties,
    this method copies expressions (which might no longer resolve) but not 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: BitmapCache) -> BitmapCache
   ...
   Creates a modifiable clone (deep copy) of the System.Windows.Media.BitmapCache 
 ...
 def __new__(self,renderAtScale=None):
  ...
  """
  pass
 EnableClearType=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 RenderAtScale=property(lambda self: object(),lambda self,v: None,lambda self: None)
