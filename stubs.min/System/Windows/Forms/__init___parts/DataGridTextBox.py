class DataGridTextBox(TextBox, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent):
    ...
    def SetDataGrid(self, parentGrid):
        ...
        SetDataGrid(self: DataGridTextBox, parentGrid: DataGrid)
            Sets the System.Windows.Forms.DataGrid to which this System.Windows.Forms.TextBox control belongs.
...
"""
    ...
    IsInEditOrNavigateMode = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
