class ThemeDictionaryExtension(MarkupExtension):
    ...
    def ProvideValue(self, serviceProvider):
        ...
        ProvideValue(self: ThemeDictionaryExtension, serviceProvider: IServiceProvider) -> object
            ...
            Returns an object that should be set on the property where this extension is applied. For System.Windows.ThemeDictionaryExtension, this is the URI value for a particular theme dictionary extension.
        
            serviceProvider: An object that can provide services for the markup extension. This service is expected to provide results for System.Windows.Markup.IXamlTypeResolver.
