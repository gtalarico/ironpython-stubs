class BooleanAnimationUsingKeyFrames(BooleanAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 ...
 def Clone(self):
  ...
  Clone(self: BooleanAnimationUsingKeyFrames) -> BooleanAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames,making deep 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: BooleanAnimationUsingKeyFrames,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames. When copying 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: BooleanAnimationUsingKeyFrames) -> BooleanAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames object,making 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: BooleanAnimationUsingKeyFrames,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames using current 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: BooleanAnimationUsingKeyFrames,isChecking: bool) -> bool
   ...
   Returns: If isChecking is true,this method returns true if this object can be made 
    read-only,or false if it cannot be made read-only. If isChecking is false,
    this method returns true if this object is now read-only,or false if it cannot 
    be made read-only,with the side effect of having begun to change the frozen 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: BooleanAnimationUsingKeyFrames,source: Freezable)
   ...
   source: The System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames object to be 
    cloned.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: BooleanAnimationUsingKeyFrames,source: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames. Resource 
    references,data bindings,and animations are not copied,but their current 
    values are.
  
  
   source: The System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames to copy and 
    freeze.
  """
  pass
 ...
 def OnChanged(self,*args):
  ...
  OnChanged(self: BooleanAnimationUsingKeyFrames)
   Called when the current 
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames object is 
    modified.
  """
  pass
 ...
 def ShouldSerializeKeyFrames(self):
  ...
  ShouldSerializeKeyFrames(self: BooleanAnimationUsingKeyFrames) -> bool
   ...
   Returns true if the value of the 
    ...
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames should be 
    value-serialized.
