class TextBox(TextBoxBase, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, ITextBoxViewHost):
    ...
    def GetNextSpellingErrorCharacterIndex(self, charIndex, direction):
        ...
        GetNextSpellingErrorCharacterIndex(self: TextBox, charIndex: int, direction: LogicalDirection) -> int
            ...
            charIndex: The zero-based character index indicating a position from which to search for the next spelling error.
            direction: One of the System.Windows.Documents.LogicalDirection values that specifies the direction in which to search for the next spelling error, starting at the specified charIndex.
                """
        pass
    ...
    def GetRectFromCharacterIndex(self, charIndex, trailingEdge=None):
        ...
        GetRectFromCharacterIndex(self: TextBox, charIndex: int, trailingEdge: bool) -> Rect
            ...
            Returns: A rectangle for an edge of the character at the specified character index, or System.Windows.Rect.Empty if a bounding rectangle cannot be determined.
        GetRectFromCharacterIndex(self: TextBox, charIndex: int) -> Rect
            ...
            charIndex: The zero-based character index of the character for which to retrieve the rectangle.
            Returns: A rectangle for the leading edge of the character at the specified character index, or System.Windows.Rect.Empty if a bounding rectangle cannot be determined.
        """
        pass
    ...
    def GetSpellingError(self, charIndex):
        ...
        GetSpellingError(self: TextBox, charIndex: int) -> SpellingError
            ...
            Returns a System.Windows.Controls.SpellingError object associated with any spelling error at the specified character index.
        
            charIndex: The zero-based character index of a position in content to examine for a spelling error.
            Returns: A System.Windows.Controls.SpellingError object containing the details of the spelling error found at the character indicated by charIndex, or null if no spelling error exists at the specified character.
        """
        pass
    ...
    def GetSpellingErrorLength(self, charIndex):
        ...
        GetSpellingErrorLength(self: TextBox, charIndex: int) -> int
            ...
            charIndex: The zero-based character index of a position in content to examine for a spelling error.
            Returns: The length of any spelling error that includes the character specified by charIndex, or 0 if the specified character is not part of a spelling error.
        """
        pass
    ...
    def ShouldSerializeText(self, manager):
        ...
        ShouldSerializeText(self: TextBox, manager: XamlDesignerSerializationManager) -> bool
            ...
            Returns a value that indicates whether the effective value of the System.Windows.Controls.TextBox.Text property should be serialized during serialization of the System.Windows.Controls.TextBox object.
    ...
    CaretIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CharacterCasing = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MaxLines = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MinLines = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectionLength = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
