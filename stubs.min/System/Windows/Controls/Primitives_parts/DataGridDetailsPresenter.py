class DataGridDetailsPresenter(ContentPresenter, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient):
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: DataGridDetailsPresenter) -> AutomationPeer
            ...
            Returns a new System.Windows.Automation.Peers.DataGridDetailsPresenterAutomationPeer for this presenter.
    ...
    def OnRender(self, *args): #cannot find CLR method
        ...
        OnRender(self: DataGridDetailsPresenter, drawingContext: DrawingContext)
            Called by the layout system to draw a horizontal line below the row details section if horizontal grid lines are visible.
