...
"""
    ...
    ItemState = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SubItem = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
