class ControlBindingsCollection:
 ...
 def Add(self,*__args):
  ...
  Add(self: ControlBindingsCollection,propertyName: str,dataSource: object,dataMember: str) -> Binding
   ...
   Creates a System.Windows.Forms.Binding using the specified control property name,data 
    source,and data member,and adds it to the collection.
  ...
  Add(self: ControlBindingsCollection,propertyName: str,dataSource: object,dataMember: str,formattingEnabled: bool,updateMode: DataSourceUpdateMode) -> Binding
   ...
   Creates a binding that binds the specified control property to the specified data member 
    of the specified data source,optionally enabling formatting,propagating values to the 
    data source based on the specified update setting,and adding the binding to the 
    collection.
  ...
  Add(self: ControlBindingsCollection,propertyName: str,dataSource: object,dataMember: str,formattingEnabled: bool,updateMode: DataSourceUpdateMode,nullValue: object) -> Binding
   ...
   Creates a binding that binds the specified control property to the specified data member 
    of the specified data source,optionally enabling formatting,propagating values to the 
    data source based on the specified update setting,setting the property to the specified 
    value when System.DBNull is returned from the data source,and adding the binding to the 
    collection.
  ...
  Add(self: ControlBindingsCollection,propertyName: str,dataSource: object,dataMember: str,formattingEnabled: bool,updateMode: DataSourceUpdateMode,nullValue: object,formatString: str) -> Binding
   ...
   Creates a binding that binds the specified control property to the specified data member 
    of the specified data source,optionally enabling formatting with the specified format 
    string,propagating values to the data source based on the specified update setting,
    setting the property to the specified value when System.DBNull is returned from the data 
  ...
  Add(self: ControlBindingsCollection,propertyName: str,dataSource: object,dataMember: str,formattingEnabled: bool,updateMode: DataSourceUpdateMode,nullValue: object,formatString: str,formatInfo: IFormatProvider) -> Binding
   ...
   Creates a binding that binds the specified control property to the specified data member 
    ...
    string,propagating values to the data source based on the specified update setting,
    setting the property to the specified value when System.DBNull is returned from the data 
    source,setting the specified format provider,and adding the binding to the collection.
