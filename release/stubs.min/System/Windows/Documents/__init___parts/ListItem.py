 ...
 def ShouldSerializeBlocks(self,manager):
  ...
  ShouldSerializeBlocks(self: ListItem,manager: XamlDesignerSerializationManager) -> bool
   ...
   Returns a value that indicates whether the effective value of the 
    System.Windows.Documents.ListItem.Blocks property should be serialized during 
    serialization of the System.Windows.Documents.ListItem object.
  
  
   manager: A serialization service manager object for the object.
   Returns: true if the System.Windows.Documents.ListItem.Blocks property should be 
...
"""
 ...
 NextListItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 PreviousListItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 SiblingListItems=property(lambda self: object(),lambda self,v: None,lambda self: None)
