class Popup(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def GetUIParentCore(self, *args): #cannot find CLR method
        ...
        GetUIParentCore(self: Popup) -> DependencyObject
            ...
            Returns: If the System.Windows.Controls.Primitives.Popup does not have a defined parent and the System.Windows.Controls.Primitives.Popup.PlacementTarget is not null, the 
             System.Windows.Controls.Primitives.Popup.PlacementTarget is returned. Otherwise, the return values are the same as System.Windows.FrameworkElement.GetUIParentCore.
        """
        pass
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: Popup, availableSize: Size) -> Size
            ...
            Determines the required size of the System.Windows.Controls.Primitives.Popup content within the visual tree of the logical parent.
        
            availableSize: The available size that this element can give to the child. You can use infinity as a value to indicate that the element can size to whatever content is available.
            Returns: A System.Windows.Size structure that has the System.Windows.Size.Height and System.Windows.Size.Width properties both equal to zero (0).
        """
        pass
    ...
    def OnClosed(self, *args): #cannot find CLR method
        ...
        OnClosed(self: Popup, e: EventArgs)
            Responds when the value of the System.Windows.Controls.Primitives.Popup.IsOpen property changes from to true to false.
...
"""
    ...
    PopupAnimation = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
