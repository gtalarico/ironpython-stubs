...
"""
    ...
    ShowCheckMargin = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ShowImageMargin = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
