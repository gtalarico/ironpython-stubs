class ItemsControlAutomationPeer(FrameworkElementAutomationPeer, IItemContainerProvider):
    ...
    def GetPattern(self, patternInterface):
        ...
        GetPattern(self: ItemsControlAutomationPeer, patternInterface: PatternInterface) -> object
            ...
            Gets the control pattern for the System.Windows.Controls.ItemsControl that is associated with this System.Windows.Automation.Peers.ItemsControlAutomationPeer.
        
            patternInterface: One of the enumeration values.
            Returns: The System.Windows.Automation.Peers.ScrollViewerAutomationPeer that is associated with this System.Windows.Automation.Peers.ItemsControlAutomationPeer.
        """
        pass
