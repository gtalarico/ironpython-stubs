class CharAnimationUsingKeyFrames(CharAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 ...
 def Clone(self):
  ...
  Clone(self: CharAnimationUsingKeyFrames) -> CharAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames,making deep copies 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: CharAnimationUsingKeyFrames,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames. When copying 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: CharAnimationUsingKeyFrames) -> CharAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames object,making deep 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: CharAnimationUsingKeyFrames,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames using current 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: CharAnimationUsingKeyFrames,isChecking: bool) -> bool
   ...
   Makes this instance of 
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames object unmodifiable 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: CharAnimationUsingKeyFrames,source: Freezable)
   ...
   source: The System.Windows.Media.Animation.CharAnimationUsingKeyFrames object to clone 
    and freeze.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: CharAnimationUsingKeyFrames,source: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames. Resource 
    references,data bindings,and animations are not copied,but their current 
    values are.
  
  
   source: The System.Windows.Media.Animation.CharAnimationUsingKeyFrames to copy and 
    freeze.
  """
  pass
 ...
 def OnChanged(self,*args):
  ...
  OnChanged(self: CharAnimationUsingKeyFrames)
   Called when the current 
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames object is modified.
  """
  pass
 ...
 def ShouldSerializeKeyFrames(self):
  ...
  ShouldSerializeKeyFrames(self: CharAnimationUsingKeyFrames) -> bool
   ...
   Returns true if the value of the 
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames.KeyFrames property 
    of this instance of System.Windows.Media.Animation.CharAnimationUsingKeyFrames 
