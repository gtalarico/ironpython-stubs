class Point3DAnimationUsingKeyFrames(Point3DAnimationBase, ISealable, IAnimatable, IResource, IKeyFrameAnimation, IAddChild):
    ...
    def AddChild(self, *args): #cannot find CLR method
        ...
        AddChild(self: Point3DAnimationUsingKeyFrames, child: object)
            Adds a child System.Windows.Media.Animation.Point3DKeyFrame to this System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames.
        
            child: The object to be added as the child of this System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames.
        """
        pass
    ...
    def AddText(self, *args): #cannot find CLR method
        ...
        AddText(self: Point3DAnimationUsingKeyFrames, childText: str)
            Adds a text string as a child of this System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames.
    ...
    def Clone(self):
        ...
        Clone(self: Point3DAnimationUsingKeyFrames) -> Point3DAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: Point3DAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames. When copying dependency properties, this method copies resource references and data bindings 
    ...
    def CloneCurrentValue(self):
        ...
        CloneCurrentValue(self: Point3DAnimationUsingKeyFrames) -> Point3DAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames object, making deep copies of this object's current values. Resource references, data bindings, and 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: Point3DAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames using current property values. Resource references, data bindings, and animations 
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: Point3DAnimationUsingKeyFrames, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames object unmodifiable or determines whether it can be made unmodifiable..
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: Point3DAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: Point3DAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames. Resource references, data bindings, and animations are not copied, but their current 
             values are.
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: Point3DAnimationUsingKeyFrames, defaultOriginValue: Point3D, defaultDestinationValue: Point3D, animationClock: AnimationClock) -> Point3D
            ...
            Calculates a value that represents the current value of the property being animated, as determined by this instance of System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames.
    ...
    def OnChanged(self, *args): #cannot find CLR method
        ...
        OnChanged(self: Point3DAnimationUsingKeyFrames)
            Called when the current System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames object is modified.
        """
        pass
    ...
    def ShouldSerializeKeyFrames(self):
        ...
        ShouldSerializeKeyFrames(self: Point3DAnimationUsingKeyFrames) -> bool
            ...
            Returns true if the value of the System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames.KeyFrames property of this instance of System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames should be 
             value-serialized.
