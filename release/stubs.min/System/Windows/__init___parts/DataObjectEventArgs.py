class DataObjectEventArgs(RoutedEventArgs):
 ...
 def CancelCommand(self):
  ...
  """
  pass
 CommandCancelled=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 IsDragDrop=property(lambda self: object(),lambda self,v: None,lambda self: None)
