class DataGridCellsPresenter(ItemsControl, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IGeneratorHost, IContainItemStorage):
    ...
    def OnItemChanged(self, *args): #cannot find CLR method
        ...
        OnItemChanged(self: DataGridCellsPresenter, oldItem: object, newItem: object)
            Updates the displayed cells when the System.Windows.Controls.Primitives.DataGridCellsPresenter.Item property value has changed.
        
            oldItem: The previous value of the System.Windows.Controls.Primitives.DataGridCellsPresenter.Item property.
    ...
    def OnRender(self, *args): #cannot find CLR method
        ...
        OnRender(self: DataGridCellsPresenter, drawingContext: DrawingContext)
            Called by the layout system to draw a horizontal line below the cells if horizontal grid lines are visible.
