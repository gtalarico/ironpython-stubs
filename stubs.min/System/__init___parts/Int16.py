class Int16(object, IComparable, IFormattable, IConvertible, IComparable[Int16], IEquatable[Int16]):
    ...
    def CompareTo(self, value):
        ...
        CompareTo(self: Int16, value: Int16) -> int
            ...
            Compares this instance to a specified 16-bit signed integer and returns an integer that indicates whether the value of this instance is less than, equal to, or greater than the value of the specified 
