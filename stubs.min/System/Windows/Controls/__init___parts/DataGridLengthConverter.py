class DataGridLengthConverter(TypeConverter):
    ...
    def CanConvertFrom(self, *__args):
        ...
        CanConvertFrom(self: DataGridLengthConverter, context: ITypeDescriptorContext, sourceType: Type) -> bool
            ...
            Determines whether an instance of the specified type can be converted to an instance of the System.Windows.Controls.DataGridLength class.
    ...
    def CanConvertTo(self, *__args):
        ...
        CanConvertTo(self: DataGridLengthConverter, context: ITypeDescriptorContext, destinationType: Type) -> bool
            ...
            Determines whether an instance of the System.Windows.Controls.DataGridLength class can be converted to an instance of the specified type.
    ...
    def ConvertTo(self, *__args):
        ...
        ConvertTo(self: DataGridLengthConverter, context: ITypeDescriptorContext, culture: CultureInfo, value: object, destinationType: Type) -> object
            ...
            Converts an instance of the System.Windows.Controls.DataGridLength class to an instance of the specified type.
