class TabControl(Selector,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: TabControl) -> AutomationPeer
   ...
   Provides an appropriate 
    System.Windows.Automation.Peers.TabControlAutomationPeer implementation for 
 ...
 def OnKeyDown(self,*args):
  ...
  OnKeyDown(self: TabControl,e: KeyEventArgs)
   Provides class handling for the System.Windows.ContentElement.KeyDown routed 
 ...
 def OnSelectionChanged(self,*args):
  ...
  OnSelectionChanged(self: TabControl,e: SelectionChangedEventArgs)
   Raises the System.Windows.Controls.Primitives.Selector.SelectionChanged routed 
    event.
