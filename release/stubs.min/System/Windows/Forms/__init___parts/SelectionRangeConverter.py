class SelectionRangeConverter:
 ...
 def CanConvertFrom(self,*__args):
  ...
  CanConvertFrom(self: SelectionRangeConverter,context: ITypeDescriptorContext,sourceType: Type) -> bool
   ...
   Determines if this converter can convert an object of the specified source type to the 
    native type of the converter by querying the supplied type descriptor context.
 ...
 def ConvertTo(self,*__args):
  ...
  ConvertTo(self: SelectionRangeConverter,context: ITypeDescriptorContext,culture: CultureInfo,value: object,destinationType: Type) -> object
   ...
   Converts the specified System.Windows.Forms.SelectionRangeConverter object to another 
    type by using the specified culture.
 ...
 def CreateInstance(self,*__args):
  ...
  CreateInstance(self: SelectionRangeConverter,context: ITypeDescriptorContext,propertyValues: IDictionary) -> object
   ...
   Creates a System.Windows.Forms.SelectionRange object by using the specified type 
    descriptor and set of property values for that object.
  
  
   context: A System.ComponentModel.ITypeDescriptorContext that provides a format context.
   propertyValues: An System.Collections.IDictionary that contains the new property values.
   Returns: If successful,the newly created System.Windows.Forms.SelectionRange; otherwise,this 
 ...
 def GetCreateInstanceSupported(self,context=None):
  ...
  GetCreateInstanceSupported(self: SelectionRangeConverter,context: ITypeDescriptorContext) -> bool
   ...
   context: A System.ComponentModel.ITypeDescriptorContext that provides a format context.
   Returns: true if erload:System.Windows.Forms.SelectionRangeConverter.CreateInstance must be called 
    to make a change to one or more properties; otherwise false.
  """
  pass
 ...
 def GetPropertiesSupported(self,context=None):
  ...
  GetPropertiesSupported(self: SelectionRangeConverter,context: ITypeDescriptorContext) -> bool
   ...
   Determines whether the current object supports properties that use the specified type 
    descriptor context.
  
  
   context: A System.ComponentModel.ITypeDescriptorContext that provides a format context.
   Returns: true if erload:System.Windows.Forms.SelectionRangeConverter.GetProperties can be called 
    to find the properties of a System.Windows.Forms.SelectionRange object; otherwise,false.
  """
  pass
