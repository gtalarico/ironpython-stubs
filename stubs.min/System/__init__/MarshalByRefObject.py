class MarshalByRefObject(object):
    ...
    def InitializeLifetimeService(self):
        ...
        InitializeLifetimeService(self: MarshalByRefObject) -> object
            ...
            Returns: An object of type System.Runtime.Remoting.Lifetime.ILease used to control the lifetime policy for this instance. This is the current lifetime service object for this instance if one exists; otherwise, a 
             new lifetime service object initialized to the value of the System.Runtime.Remoting.Lifetime.LifetimeServices.LeaseManagerPollTime property.
        """
        pass
