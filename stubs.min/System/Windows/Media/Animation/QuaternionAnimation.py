class QuaternionAnimation(QuaternionAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: QuaternionAnimation) -> QuaternionAnimation
            ...
            Creates a modifiable clone of this System.Windows.Media.Media3D.Quaternion, making deep copies of this object's values. When copying dependency properties, this method copies resource references and data 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: QuaternionAnimation, defaultOriginValue: Quaternion, defaultDestinationValue: Quaternion, animationClock: AnimationClock) -> Quaternion
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.QuaternionAnimation.
