class FamilyTypefaceCollection(object,IList[FamilyTypeface],ICollection[FamilyTypeface],IEnumerable[FamilyTypeface],IEnumerable,IList,ICollection):
 ...
 def Add(self,item):
  ...
  Add(self: FamilyTypefaceCollection,item: FamilyTypeface)
   Inserts the specified System.Windows.Media.FamilyTypeface object into the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: FamilyTypefaceCollection)
   Removes all System.Windows.Media.FamilyTypeface objects from the 
 ...
 def Contains(self,item):
  ...
  Contains(self: FamilyTypefaceCollection,item: FamilyTypeface) -> bool
   ...
   Determines if the collection contains the specified 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: FamilyTypefaceCollection,array: Array[FamilyTypeface],index: int)
   Copies the System.Windows.Media.FamilyTypeface objects in the collection into 
    an array of System.Windows.Media.FamilyTypefaceCollection,starting at the 
 ...
 def IndexOf(self,item):
  ...
  IndexOf(self: FamilyTypefaceCollection,item: FamilyTypeface) -> int
   ...
   Returns the index of the specified System.Windows.Media.FamilyTypeface object 
 ...
 def Insert(self,index,item):
  ...
  Insert(self: FamilyTypefaceCollection,index: int,item: FamilyTypeface)
   Inserts the specified System.Windows.Media.FamilyTypeface object at the 
 ...
 def Remove(self,item):
  ...
  Remove(self: FamilyTypefaceCollection,item: FamilyTypeface) -> bool
   ...
   Removes the specified System.Windows.Media.FamilyTypeface object from the 
    collection.
