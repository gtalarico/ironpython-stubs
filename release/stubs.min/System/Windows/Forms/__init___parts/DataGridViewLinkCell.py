class DataGridViewLinkCell:
 ...
 def CreateAccessibilityInstance(self,*args):
  ...
  CreateAccessibilityInstance(self: DataGridViewLinkCell) -> AccessibleObject
   ...
   Returns: A new System.Windows.Forms.DataGridViewLinkCell.DataGridViewLinkCellAccessibleObject for 
    the System.Windows.Forms.DataGridViewLinkCell.
  """
  pass
 def Dispose(self):
  """
 ...
 def KeyUpUnsharesRow(self,*args):
  ...
  KeyUpUnsharesRow(self: DataGridViewLinkCell,e: KeyEventArgs,rowIndex: int) -> bool
   ...
   Indicates whether the row containing the cell will be unshared when a key is released and 
    the cell has focus.
   ...
   Returns: true if the SPACE key was released,the 
    ...
    System.Windows.Forms.DataGridViewLinkCell.LinkVisited property is false,and the CTRL,
    ALT,and SHIFT keys are not pressed; otherwise,false.
  """
  pass
 ...
 def MouseDownUnsharesRow(self,*args):
  ...
  MouseDownUnsharesRow(self: DataGridViewLinkCell,e: DataGridViewCellMouseEventArgs) -> bool
   ...
   Indicates whether the row containing the cell will be unshared when the mouse button is 
    pressed while the pointer is over the cell.
  
  
   e: A System.Windows.Forms.DataGridViewCellMouseEventArgs that contains data about the mouse 
    click.
 ...
 def MouseLeaveUnsharesRow(self,*args):
  ...
  MouseLeaveUnsharesRow(self: DataGridViewLinkCell,rowIndex: int) -> bool
   ...
   Indicates whether the row containing the cell will be unshared when the mouse pointer 
    leaves the cell.
 ...
 def MouseMoveUnsharesRow(self,*args):
  ...
  MouseMoveUnsharesRow(self: DataGridViewLinkCell,e: DataGridViewCellMouseEventArgs) -> bool
   ...
   Returns: true if the mouse pointer is over the link and the link is has not yet changed color to 
    reflect the hover state; otherwise,false.
  """
  pass
 def MouseUpUnsharesRow(self,*args):
  ...
  MouseUpUnsharesRow(self: DataGridViewLinkCell,e: DataGridViewCellMouseEventArgs) -> bool
   ...
   Indicates whether the row containing the cell will be unshared when the mouse button is 
    released while the pointer is over the cell.
