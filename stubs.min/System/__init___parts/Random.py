class Random(object):
 ...
 def Next(self,*__args):
  ...
  Next(self: Random,maxValue: int) -> int
   ...
   maxValue: The exclusive upper bound of the random number to be generated. maxValue must 
  ...
  Next(self: Random,minValue: int,maxValue: int) -> int
   ...
   maxValue: The exclusive upper bound of the random number returned. maxValue must be 
