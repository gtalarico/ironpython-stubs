class ListControl(Control, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent):
    ...
    def GetItemText(self, item):
        ...
        GetItemText(self: ListControl, item: object) -> str
            ...
            Returns: If the System.Windows.Forms.ListControl.DisplayMember property is not specified, the value returned by System.Windows.Forms.ListControl.GetItemText(System.Object) is the value of the item's ToString 
             method. Otherwise, the method returns the string value of the member specified in the System.Windows.Forms.ListControl.DisplayMember property for the object specified in the item parameter.
        """
        pass
...
"""
    ...
    FormatInfo = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    FormattingEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
