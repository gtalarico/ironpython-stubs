class TableLayoutRowStyleCollection(TableLayoutStyleCollection,IList,ICollection,IEnumerable):
 ...
 def Instance(self):
  ...
  return TableLayoutRowStyleCollection()
 ...
 def Add(self,*__args):
  ...
  Add(self: TableLayoutRowStyleCollection,rowStyle: RowStyle) -> int
   ...
   rowStyle: The System.Windows.Forms.RowStyle to add to the System.Windows.Forms.TableLayoutRowStyleCollection.
 ...
 def Contains(self,rowStyle):
  ...
  Contains(self: TableLayoutRowStyleCollection,rowStyle: RowStyle) -> bool
   ...
   rowStyle: The System.Windows.Forms.RowStyle to locate in the System.Windows.Forms.TableLayoutRowStyleCollection.
   Returns: true if the System.Windows.Forms.RowStyle is found in the System.Windows.Forms.TableLayoutRowStyleCollection; otherwise,false.
  """
  pass
 def IndexOf(self,rowStyle):
  ...
  IndexOf(self: TableLayoutRowStyleCollection,rowStyle: RowStyle) -> int
   ...
   rowStyle: The System.Windows.Forms.RowStyle to locate in the System.Windows.Forms.TableLayoutRowStyleCollection.
   Returns: The index of rowStyle if found in the System.Windows.Forms.TableLayoutRowStyleCollection; otherwise,-1.
  """
  pass
 def Insert(self,index,rowStyle):
  ...
  Insert(self: TableLayoutRowStyleCollection,index: int,rowStyle: RowStyle)
   ...
   rowStyle: The System.Windows.Forms.RowStyle to insert into the System.Windows.Forms.TableLayoutRowStyleCollection. The value can be null.
  """
  pass
 def Remove(self,rowStyle):
  ...
  Remove(self: TableLayoutRowStyleCollection,rowStyle: RowStyle)
   ...
   rowStyle: The System.Windows.Forms.RowStyle to remove from the System.Windows.Forms.TableLayoutRowStyleCollection. The value can be null.
  """
  pass
