class DateTime:
 ...
 def Add(self,value):
  ...
  Add(self: DateTime,value: TimeSpan) -> DateTime
   ...
   Returns a new System.DateTime that adds the value of the specified System.TimeSpan to the 
 ...
 def AddDays(self,value):
  ...
  AddDays(self: DateTime,value: float) -> DateTime
   ...
   Returns: An object whose value is the sum of the date and time represented by this instance and 
    the number of days represented by value.
  """
  pass
 def AddHours(self,value):
  ...
  AddHours(self: DateTime,value: float) -> DateTime
   ...
   Returns a new System.DateTime that adds the specified number of hours to the value of 
    this instance.
 ...
 def AddMilliseconds(self,value):
  ...
  AddMilliseconds(self: DateTime,value: float) -> DateTime
   ...
   Returns a new System.DateTime that adds the specified number of milliseconds to the value 
    of this instance.
  
  
   value: A number of whole and fractional milliseconds. The value parameter can be negative or 
    positive. Note that this value is rounded to the nearest integer.
 ...
 def AddMinutes(self,value):
  ...
  AddMinutes(self: DateTime,value: float) -> DateTime
   ...
   Returns a new System.DateTime that adds the specified number of minutes to the value of 
    this instance.
 ...
 def AddMonths(self,months):
  ...
  AddMonths(self: DateTime,months: int) -> DateTime
   ...
   Returns a new System.DateTime that adds the specified number of months to the value of 
    this instance.
 ...
 def AddSeconds(self,value):
  ...
  AddSeconds(self: DateTime,value: float) -> DateTime
   ...
   Returns a new System.DateTime that adds the specified number of seconds to the value of 
    this instance.
 ...
 def AddTicks(self,value):
  ...
  AddTicks(self: DateTime,value: Int64) -> DateTime
   ...
   Returns a new System.DateTime that adds the specified number of ticks to the value of 
    this instance.
  
  
   value: A number of 100-nanosecond ticks. The value parameter can be positive or negative.
   Returns: An object whose value is the sum of the date and time represented by this instance and 
    the time represented by value.
  """
  pass
 def AddYears(self,value):
  ...
  AddYears(self: DateTime,value: int) -> DateTime
   ...
   Returns a new System.DateTime that adds the specified number of years to the value of 
    this instance.
  
  
   value: A number of years. The value parameter can be negative or positive.
   Returns: An object whose value is the sum of the date and time represented by this instance and 
    the number of years represented by value.
  """
  pass
 @staticmethod
 def Compare(t1,t2):
  ...
  Compare(t1: DateTime,t2: DateTime) -> int
   ...
   Compares two instances of System.DateTime and returns an integer that indicates whether 
   ...
   Returns: A signed number indicating the relative values of t1 and t2.Value Type Condition Less 
    than zero t1 is earlier than t2. Zero t1 is the same as t2. Greater than zero t1 is later 
    than t2.
  """
  pass
 def CompareTo(self,value):
  ...
  CompareTo(self: DateTime,value: object) -> int
   ...
   Compares the value of this instance to a specified object that contains a specified 
    System.DateTime value,and returns an integer that indicates whether this instance is 
   ...
   Returns: A signed number indicating the relative values of this instance and value.Value 
    Description Less than zero This instance is earlier than value. Zero This instance is the 
  ...
  CompareTo(self: DateTime,value: DateTime) -> int
   ...
   Compares the value of this instance to a specified System.DateTime value and returns an 
   ...
   Returns: A signed number indicating the relative values of this instance and the value 
    parameter.Value Description Less than zero This instance is earlier than value. Zero This 
 ...
 def DaysInMonth(year,month):
  ...
  DaysInMonth(year: int,month: int) -> int
   ...
   Returns: The number of days in month for the specified year.For example,if month equals 2 for 
    February,the return value is 28 or 29 depending upon whether year is a leap year.
  """
  pass
 def Equals(self,*__args):
  ...
  Equals(self: DateTime,value: DateTime) -> bool
   ...
   Returns a value indicating whether the value of this instance is equal to the value of 
    the specified System.DateTime instance.
  ...
  Equals(t1: DateTime,t2: DateTime) -> bool
   ...
   Returns a value indicating whether two System.DateTime instances have the same date and 
    time value.
 ...
 def FromBinary(dateData):
  ...
  FromBinary(dateData: Int64) -> DateTime
   ...
   dateData: A 64-bit signed integer that encodes the System.DateTime.Kind property in a 2-bit field 
    and the System.DateTime.Ticks property in a 62-bit field.
 ...
 def FromFileTime(fileTime):
  ...
  FromFileTime(fileTime: Int64) -> DateTime
   ...
   Returns: An object that represents the local time equivalent of the date and time represented by 
    the fileTime parameter.
  """
  pass
 @staticmethod
 ...
 def GetDateTimeFormats(self,*__args):
  ...
  GetDateTimeFormats(self: DateTime) -> Array[str]
   ...
   Returns: A string array where each element is the representation of the value of this instance 
  ...
  GetDateTimeFormats(self: DateTime,format: Char) -> Array[str]
   ...
   Returns: A string array where each element is the representation of the value of this instance 
    formatted with the format standard date and time format specifier.
 ...
 def IsDaylightSavingTime(self):
  ...
  IsDaylightSavingTime(self: DateTime) -> bool
   ...
   Indicates whether this instance of System.DateTime is within the daylight saving time 
    range for the current time zone.
  
   Returns: true if System.DateTime.Kind is System.DateTimeKind.Local or 
    System.DateTimeKind.Unspecified and the value of this instance of System.DateTime is 
    within the daylight saving time range for the current time zone. false if 
    System.DateTime.Kind is System.DateTimeKind.Utc.
  """
  pass
 @staticmethod
 def IsLeapYear(year):
 ...
 def Parse(s,provider=None,styles=None):
  ...
  Parse(s: str,provider: IFormatProvider,styles: DateTimeStyles) -> DateTime
   ...
   styles: A bitwise combination of the enumeration values that indicates the style elements that 
    can be present in s for the parse operation to succeed and that defines how to interpret 
    the parsed date in relation to the current time zone or the current date. A typical value 
    to specify is System.Globalization.DateTimeStyles.None.
  
   Returns: An object that is equivalent to the date and time contained in s,as specified by 
    provider and styles.
  """
  pass
 @staticmethod
 def ParseExact(s,*__args):
  ...
  ParseExact(s: str,format: str,provider: IFormatProvider,style: DateTimeStyles) -> DateTime
   ...
   format: A format specifier that defines the required format of s.
   provider: An object that supplies culture-specific formatting information about s.
   style: A bitwise combination of the enumeration values that provides additional information 
    about s,about style elements that may be present in s,or about the conversion from s to 
    a System.DateTime value. A typical value to specify is 
  ...
  ParseExact(s: str,formats: Array[str],provider: IFormatProvider,style: DateTimeStyles) -> DateTime
   ...
   Converts the specified string representation of a date and time to its System.DateTime 
    ...
    style. The format of the string representation must match at least one of the specified 
 ...
 def SpecifyKind(value,kind):
  ...
  SpecifyKind(value: DateTime,kind: DateTimeKind) -> DateTime
   ...
   Creates a new System.DateTime object that has the same number of ticks as the specified 
    System.DateTime,but is designated as either local time,Coordinated Universal Time 
    (UTC),or neither,as indicated by the specified System.DateTimeKind value.
  
  
   value: A date and time.
   kind: One of the enumeration values that indicates whether the new object represents local 
    time,UTC,or neither.
  
   Returns: A new object that has the same number of ticks as the object represented by the value 
    parameter and the System.DateTimeKind value specified by the kind parameter.
  """
  pass
 def Subtract(self,value):
  ...
  Subtract(self: DateTime,value: DateTime) -> TimeSpan
   ...
   Returns: A time interval that is equal to the date and time represented by this instance minus the 
    date and time represented by value.
 ...
 def ToLocalTime(self):
  ...
  ToLocalTime(self: DateTime) -> DateTime
   ...
   Returns: An object whose System.DateTime.Kind property is System.DateTimeKind.Local,and whose 
    value is the local time equivalent to the value of the current System.DateTime object,or 
    System.DateTime.MaxValue if the converted value is too large to be represented by a 
    System.DateTime object,or System.DateTime.MinValue if the converted value is too small 
    to be represented as a System.DateTime object.
  """
  pass
 def ToLongDateString(self):
  ...
  ToLongDateString(self: DateTime) -> str
   ...
   Converts the value of the current System.DateTime object to its equivalent long date 
    string representation.
  
   Returns: A string that contains the long date string representation of the current System.DateTime 
    object.
  """
  pass
 def ToLongTimeString(self):
  ...
  ToLongTimeString(self: DateTime) -> str
   ...
   Converts the value of the current System.DateTime object to its equivalent long time 
    string representation.
  
   Returns: A string that contains the long time string representation of the current System.DateTime 
    object.
  """
  pass
 def ToOADate(self):
 ...
 def ToShortDateString(self):
  ...
  ToShortDateString(self: DateTime) -> str
   ...
   Converts the value of the current System.DateTime object to its equivalent short date 
    string representation.
 ...
 def ToShortTimeString(self):
  ...
  ToShortTimeString(self: DateTime) -> str
   ...
   Converts the value of the current System.DateTime object to its equivalent short time 
    string representation.
 ...
 def ToString(self,*__args):
  ...
  ToString(self: DateTime,format: str) -> str
   ...
   Returns: A string representation of value of the current System.DateTime object as specified by 
    format.
 ...
 def ToUniversalTime(self):
  ...
  ToUniversalTime(self: DateTime) -> DateTime
   ...
   Converts the value of the current System.DateTime object to Coordinated Universal Time 
    (UTC).
  
   Returns: An object whose System.DateTime.Kind property is System.DateTimeKind.Utc,and whose value 
    is the UTC equivalent to the value of the current System.DateTime object,or 
    System.DateTime.MaxValue if the converted value is too large to be represented by a 
    System.DateTime object,or System.DateTime.MinValue if the converted value is too small 
 ...
 def TryParse(s,*__args):
  ...
  TryParse(s: str,provider: IFormatProvider,styles: DateTimeStyles) -> (bool,DateTime)
   ...
   s: A string containing a date and time to convert.
   provider: An object that supplies culture-specific formatting information about s.
   styles: A bitwise combination of enumeration values that defines how to interpret the parsed date 
 ...
 def TryParseExact(s,*__args):
  ...
  TryParseExact(s: str,format: str,provider: IFormatProvider,style: DateTimeStyles) -> (bool,DateTime)
   ...
   Converts the specified string representation of a date and time to its System.DateTime 
    equivalent using the specified format,culture-specific format information,and style. 
    The format of the string representation must match the specified format exactly. The 
   ...
   provider: An object that supplies culture-specific formatting information about s.
   style: A bitwise combination of one or more enumeration values that indicate the permitted 
    format of s.
  ...
  TryParseExact(s: str,formats: Array[str],provider: IFormatProvider,style: DateTimeStyles) -> (bool,DateTime)
   ...
   Converts the specified string representation of a date and time to its System.DateTime 
    equivalent using the specified array of formats,culture-specific format information,and 
    style. The format of the string representation must match at least one of the specified 
    formats exactly. The method returns a value that indicates whether the conversion 
    succeeded.
 ...
 def __rsub__(self,*args):
  ...
  __rsub__(d1: DateTime,d2: DateTime) -> TimeSpan
   ...
   Subtracts a specified date and time from another specified date and time and returns a 
    time interval.
