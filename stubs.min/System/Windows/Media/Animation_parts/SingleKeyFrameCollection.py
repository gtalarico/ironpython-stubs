class SingleKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: SingleKeyFrameCollection,keyFrame: SingleKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.SingleKeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.SingleKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: SingleKeyFrameCollection)
   Removes all System.Windows.Media.Animation.SingleKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: SingleKeyFrameCollection) -> SingleKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.SingleKeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: SingleKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.SingleKeyFrameCollection. When copying 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: SingleKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.SingleKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: SingleKeyFrameCollection,array: Array[SingleKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.SingleKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: SingleKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.SingleKeyFrameCollection 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: SingleKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.SingleKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: SingleKeyFrameCollection,keyFrame: SingleKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.SingleKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: SingleKeyFrameCollection,index: int,keyFrame: SingleKeyFrame)
   Inserts a System.Windows.Media.Animation.SingleKeyFrame into a specific 
    location within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.SingleKeyFrame 
    is inserted.
  
   keyFrame: The System.Windows.Media.Animation.SingleKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: SingleKeyFrameCollection,keyFrame: SingleKeyFrame)
   Removes a System.Windows.Media.Animation.SingleKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.SingleKeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: SingleKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.SingleKeyFrame at the specified 
    index position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.SingleKeyFrame to be 
    removed.
  """
  pass
