class ListViewAutomationPeer(ListBoxAutomationPeer,IItemContainerProvider,ISelectionProvider):
 ...
 """
 def CreateItemAutomationPeer(self,*args):
  """
  ...
  """
  pass
 def FindOrCreateItemAutomationPeer(self,*args):
...
"""
 ...
 IsVirtualized=property(lambda self: object(),lambda self,v: None,lambda self: None)

 ViewAutomationPeer=property(lambda self: object(),lambda self,v: None,lambda self: None)
