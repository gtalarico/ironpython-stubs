class BindingMemberInfo(object):
    ...
    BindingField = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    BindingMember = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    BindingPath = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
