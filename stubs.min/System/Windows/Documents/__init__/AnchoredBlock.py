class AnchoredBlock(Inline, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild):
    """ An abstract class that provides a base for System.Windows.Documents.Inline elements that are used to anchor System.Windows.Documents.Block elements to flow content. """
    ...
    def ShouldSerializeBlocks(self, manager):
        """
        ShouldSerializeBlocks(self: AnchoredBlock, manager: XamlDesignerSerializationManager) -> bool
        
            Returns a value that indicates whether or not the effective value of the System.Windows.Documents.AnchoredBlock.Blocks property should be serialized during serialization of an object deriving from 
             System.Windows.Documents.AnchoredBlock.
        
        
            manager: A serialization service manager object for this object.
            Returns: true if the System.Windows.Documents.AnchoredBlock.Blocks property should be serialized; otherwise, false.
        """
        pass
    ...
    def __new__(self, *args): #cannot find CLR constructor
        """ __new__(cls: type, block: Block, insertionPosition: TextPointer) """
        pass

    Blocks = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a System.Windows.Documents.BlockCollection containing the top-level System.Windows.Documents.Block elements that comprise the contents of the element.

Get: Blocks(self: AnchoredBlock) -> BlockCollection
...
Get: BorderBrush(self: AnchoredBlock) -> Brush

Set: BorderBrush(self: AnchoredBlock) = value
"""
...
Get: BorderThickness(self: AnchoredBlock) -> Thickness

Set: BorderThickness(self: AnchoredBlock) = value
"""
...
Get: LineHeight(self: AnchoredBlock) -> float

Set: LineHeight(self: AnchoredBlock) = value
"""

    LineStackingStrategy = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the mechanism by which a line box is determined for each line of text within the text element.

Get: LineStackingStrategy(self: AnchoredBlock) -> LineStackingStrategy

Set: LineStackingStrategy(self: AnchoredBlock) = value
"""
...
Get: Margin(self: AnchoredBlock) -> Thickness

Set: Margin(self: AnchoredBlock) = value
"""
...
Get: Padding(self: AnchoredBlock) -> Thickness

Set: Padding(self: AnchoredBlock) = value
"""

    TextAlignment = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that indicates the horizontal alignment of text content.

Get: TextAlignment(self: AnchoredBlock) -> TextAlignment

Set: TextAlignment(self: AnchoredBlock) = value
"""
