class Rotation3DKeyFrameCollection(Freezable, ISealable, IList, ICollection, IEnumerable):
    ...
    def Clone(self):
        ...
        Clone(self: Rotation3DKeyFrameCollection) -> Rotation3DKeyFrameCollection
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Rotation3DKeyFrameCollection, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: Rotation3DKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.Rotation3DKeyFrameCollection. When copying dependency properties, this method copies resource references and data bindings 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: Rotation3DKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.Rotation3DKeyFrameCollection using current property values. Resource references, data bindings, and animations are 
    ...
    def Contains(self, keyFrame):
        ...
        Contains(self: Rotation3DKeyFrameCollection, keyFrame: Rotation3DKeyFrame) -> bool
            ...
            Gets a value that indicates whether the collection contains the specified System.Windows.Media.Animation.Rotation3DKeyFrame.
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: Rotation3DKeyFrameCollection, array: Array[Rotation3DKeyFrame], index: int)
            Copies all of the System.Windows.Media.Animation.Rotation3DKeyFrame objects in a collection to a specified array.
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: Rotation3DKeyFrameCollection, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.Rotation3DKeyFrameCollection unmodifiable or determines whether it can be made unmodifiable.
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: Rotation3DKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.Rotation3DKeyFrameCollection object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: Rotation3DKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.Rotation3DKeyFrameCollection. Resource references, data bindings, and animations are not copied, but their current values 
             are.
    ...
    def IndexOf(self, keyFrame):
        ...
        IndexOf(self: Rotation3DKeyFrameCollection, keyFrame: Rotation3DKeyFrame) -> int
            ...
            Searches for the specified System.Windows.Media.Animation.Rotation3DKeyFrame and returns the zero-based index of the first occurrence within the entire collection.
    ...
    def Insert(self, index, keyFrame):
        ...
        Insert(self: Rotation3DKeyFrameCollection, index: int, keyFrame: Rotation3DKeyFrame)
            Inserts a System.Windows.Media.Animation.Rotation3DKeyFrame into a specific location within the collection.
    ...
    def RemoveAt(self, index):
        ...
        RemoveAt(self: Rotation3DKeyFrameCollection, index: int)
            Removes the System.Windows.Media.Animation.Rotation3DKeyFrame at the specified index position from the collection.
