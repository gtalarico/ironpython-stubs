...
class DuctFittingAndAccessoryConnectorData(object):
...
class DuctFittingAndAccessoryData(object):
    """ The input data used by external servers for calculation of the duct fitting and duct accessory coefficient. """
    def Dispose(self):
...
class DuctFittingAndAccessoryPressureDropData(object):
...
class DuctFittingAndAccessoryPressureDropItem(object):
...
class DuctFlowConfigurationType(Enum):
    """
...
class DuctPressureDropData(object):
...
class DuctSizeSettingIterator(object):
...
class SystemCalculationLevel(Enum):
    """
