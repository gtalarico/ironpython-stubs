class TextBoxBase(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 ...
 def AppendText(self,textData):
  ...
  AppendText(self: TextBoxBase,textData: str)
   ...
   textData: A string that specifies the text to append to the current contents of the text 
    control.
  """
  pass
 ...
 def Cut(self):
  ...
  Cut(self: TextBoxBase)
   Removes the current selection from the text editing control and copies it to 
    the System.Windows.Clipboard.
  """
  pass
 ...
 def LockCurrentUndoUnit(self):
  ...
  LockCurrentUndoUnit(self: TextBoxBase)
   Locks the most recent undo unit of the undo stack of the application. This 
    prevents the locked unit from being merged with undo units that are added 
    subsequently.
  """
  pass
 ...
 def OnApplyTemplate(self):
  ...
  OnApplyTemplate(self: TextBox_18$19)
  """
  pass
 ...
 def Paste(self):
  ...
  Paste(self: TextBoxBase)
   Pastes the contents of the Clipboard over the current selection in the text 
    editing control.
  """
  pass
 def Redo(self):
  ...
  Redo(self: TextBoxBase) -> bool
   ...
   Undoes the most recent undo command. In other words,redoes the most recent 
    undo unit on the undo stack.
  
   Returns: true if the redo operation was successful; otherwise,false. This method 
    returns false if there is no undo command available (the undo stack is empty).
  """
  pass
 ...
 def Undo(self):
  ...
  Undo(self: TextBoxBase) -> bool
   ...
   Undoes the most recent undo command. In other words,undoes the most recent 
    undo unit on the undo stack.
  
   Returns: true if the undo operation was successful; otherwise,false. This method 
