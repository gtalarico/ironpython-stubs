class SingleAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: SingleAnimationBase) -> SingleAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.SingleAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
