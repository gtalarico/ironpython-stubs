class Guid(object, IFormattable, IComparable, IComparable[Guid], IEquatable[Guid]):
    ...
    def CompareTo(self, value):
        ...
        CompareTo(self: Guid, value: Guid) -> int
            ...
            Returns: A signed number indicating the relative values of this instance and value.Return value Description A negative integer This instance is less than value. Zero This instance is equal to value. A positive 
             integer This instance is greater than value.
        ...
        CompareTo(self: Guid, value: object) -> int
            ...
            Returns: A signed number indicating the relative values of this instance and value.Return value Description A negative integer This instance is less than value. Zero This instance is equal to value. A positive 
             integer This instance is greater than value, or value is null.
        """
        pass
    ...
    def ToString(self, format=None, provider=None):
        ...
        ToString(self: Guid) -> str
            ...
            Returns: The value of this System.Guid, formatted using the "D" format specifier as follows: xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx where the value of the GUID is represented as a series of lowercase hexadecimal 
             digits in groups of 8, 4, 4, 4, and 12 digits and separated by hyphens. An example of a return value is "382c74c3-721d-4f34-80e5-57657b6cbc27".
        """
        pass
