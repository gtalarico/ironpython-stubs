class Convert(object):
    ...
    def ChangeType(value, *__args):
        ...
        ChangeType(value: object, conversionType: Type, provider: IFormatProvider) -> object
            ...
            Returns: An object whose type is conversionType and whose value is equivalent to value.-or- value, if the System.Type of value and conversionType are equal.-or- A null reference (Nothing in Visual Basic), if value 
             is null and conversionType is not a value type.
        ...
        ChangeType(value: object, typeCode: TypeCode) -> object
            ...
            Returns: An object whose underlying type is typeCode and whose value is equivalent to value.-or-A null reference (Nothing in Visual Basic), if value is null and typeCode is System.TypeCode.Empty, 
    ...
    def FromBase64CharArray(inArray, offset, length):
        ...
        FromBase64CharArray(inArray: Array[Char], offset: int, length: int) -> Array[Byte]
            ...
            Converts a subset of a Unicode character array, which encodes binary data as base-64 digits, to an equivalent 8-bit unsigned integer array. Parameters specify the subset in the input array and the number 
             of elements to convert.
    ...
    def ToBase64CharArray(inArray, offsetIn, length, outArray, offsetOut, options=None):
        ...
        ToBase64CharArray(inArray: Array[Byte], offsetIn: int, length: int, outArray: Array[Char], offsetOut: int, options: Base64FormattingOptions) -> int
            ...
            Converts a subset of an 8-bit unsigned integer array to an equivalent subset of a Unicode character array encoded with base-64 digits. Parameters specify the subsets as offsets in the input and output 
             arrays, the number of elements in the input array to convert, and whether line breaks are inserted in the output array.
        ...
        ToBase64CharArray(inArray: Array[Byte], offsetIn: int, length: int, outArray: Array[Char], offsetOut: int) -> int
            ...
            Converts a subset of an 8-bit unsigned integer array to an equivalent subset of a Unicode character array encoded with base-64 digits. Parameters specify the subsets as offsets in the input and output 
             arrays, and the number of elements in the input array to convert.
    ...
    def ToBase64String(inArray, *__args):
        ...
        ToBase64String(inArray: Array[Byte], offset: int, length: int) -> str
            ...
            Converts a subset of an array of 8-bit unsigned integers to its equivalent string representation that is encoded with base-64 digits. Parameters specify the subset as an offset in the input array, and the 
        ...
        ToBase64String(inArray: Array[Byte], offset: int, length: int, options: Base64FormattingOptions) -> str
            ...
            Converts a subset of an array of 8-bit unsigned integers to its equivalent string representation that is encoded with base-64 digits. Parameters specify the subset as an offset in the input array, the 
             number of elements in the array to convert, and whether to insert line breaks in the return value.
    ...
    def ToSingle(value, provider=None):
        ...
        ToSingle(value: float) -> Single
            ...
            value: The double-precision floating-point number to convert.
            Returns: A single-precision floating-point number that is equivalent to value.value is rounded using rounding to nearest. For example, when rounded to two decimals, the value 2.345 becomes 2.34 and the value 2.355 
             becomes 2.36.
