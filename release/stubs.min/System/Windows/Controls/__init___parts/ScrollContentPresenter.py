class ScrollContentPresenter(ContentPresenter,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IScrollInfo):
 ...
 def LineDown(self):
  ...
  LineDown(self: ScrollContentPresenter)
   Scrolls the System.Windows.Controls.ScrollContentPresenter content downward by 
    one line.
  """
  pass
 def LineLeft(self):
  ...
  LineLeft(self: ScrollContentPresenter)
   Scrolls the System.Windows.Controls.ScrollContentPresenter content to the left 
 ...
 def LineRight(self):
  ...
  LineRight(self: ScrollContentPresenter)
   Scrolls the System.Windows.Controls.ScrollContentPresenter content to the right 
    by a predetermined amount.
  """
  pass
 def LineUp(self):
  ...
  LineUp(self: ScrollContentPresenter)
   Scrolls the System.Windows.Controls.ScrollContentPresenter content upward by 
    one line.
  """
  pass
 ...
 def OnApplyTemplate(self):
  ...
  OnApplyTemplate(self: ScrollContentPresenter)
   Invoked when an internal process or application calls 
    ...
    visual tree of the current template.
  """
  pass
