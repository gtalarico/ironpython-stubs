class StackPanel(Panel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IScrollInfo,IStackMeasure):
 ...
 def MakeVisible(self,visual,rectangle):
  ...
  MakeVisible(self: StackPanel,visual: Visual,rectangle: Rect) -> Rect
   ...
   Scrolls to the specified coordinates and makes that part of a 
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: StackPanel,constraint: Size) -> Size
   ...
   Measures the child elements of a System.Windows.Controls.StackPanel in 
    anticipation of arranging them during the 
    System.Windows.Controls.StackPanel.ArrangeOverride(System.Windows.Size) pass.
 ...
 def MouseWheelDown(self):
  ...
  MouseWheelDown(self: StackPanel)
   Scrolls content logically downward in response to a click of the mouse wheel 
    button.
  """
  pass
 def MouseWheelLeft(self):
  ...
  MouseWheelLeft(self: StackPanel)
   Scrolls content logically to the left in response to a click of the mouse wheel 
    button.
  """
  pass
 def MouseWheelRight(self):
  ...
  MouseWheelRight(self: StackPanel)
   Scrolls content logically to the right in response to a click of the mouse 
    wheel button.
  """
  pass
 def MouseWheelUp(self):
  ...
  MouseWheelUp(self: StackPanel)
   Scrolls content logically upward in response to a click of the mouse wheel 
    button.
  """
  pass
 ...
 def SetHorizontalOffset(self,offset):
  ...
  SetHorizontalOffset(self: StackPanel,offset: float)
   Sets the value of the System.Windows.Controls.StackPanel.HorizontalOffset 
    property.
 ...
 def SetVerticalOffset(self,offset):
  ...
  SetVerticalOffset(self: StackPanel,offset: float)
   Sets the value of the System.Windows.Controls.StackPanel.VerticalOffset 
    property.
