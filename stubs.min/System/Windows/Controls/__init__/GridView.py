class GridView(ViewBase, IAddChild):
    ...
    def GetAutomationPeer(self, *args): #cannot find CLR method
        """
        GetAutomationPeer(self: GridView, parent: ListView) -> IViewAutomationPeer
        
            Gets the System.Windows.Automation.Peers.AutomationPeer implementation for this System.Windows.Controls.GridView object.
        
            parent: The System.Windows.Controls.ListView control that implements this System.Windows.Controls.GridView view.
            Returns: A System.Windows.Automation.Peers.GridViewAutomationPeer for this System.Windows.Controls.GridView.
        """
        pass
    ...
    def GetColumnCollection(element):
        ...
        GetColumnCollection(element: DependencyObject) -> GridViewColumnCollection
            ...
            Returns: The System.Windows.Controls.GridView.ColumnCollection of the specified System.Windows.DependencyObject.
        """
        pass
    ...
    def PrepareItem(self, *args): #cannot find CLR method
        """
        PrepareItem(self: GridView, item: ListViewItem)
            Prepares a System.Windows.Controls.ListViewItem for display according to the definition of this System.Windows.Controls.GridView object.
    ...
    def ShouldSerializeColumnCollection(obj):
        ...
        ShouldSerializeColumnCollection(obj: DependencyObject) -> bool
            ...
            Determines whether to serialize the System.Windows.Controls.GridView.ColumnCollection�attached property.
        
            obj: The object on which the System.Windows.Controls.GridView.ColumnCollection is set.
            Returns: true if the System.Windows.Controls.GridView.ColumnCollection must be serialized; otherwise, false.
        """
        pass
    ...
    AllowsColumnReorder = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeaderContainerStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeaderContextMenu = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeaderStringFormat = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeaderTemplate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeaderTemplateSelector = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeaderToolTip = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ItemContainerDefaultStyleKey = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
