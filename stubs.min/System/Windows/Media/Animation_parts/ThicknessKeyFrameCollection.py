class ThicknessKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: ThicknessKeyFrameCollection,keyFrame: ThicknessKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.ThicknessKeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.ThicknessKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: ThicknessKeyFrameCollection)
   Removes all System.Windows.Media.Animation.ThicknessKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: ThicknessKeyFrameCollection) -> ThicknessKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.ThicknessKeyFrameCollection,making deep copies 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: ThicknessKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.ThicknessKeyFrameCollection. When copying 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: ThicknessKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.ThicknessKeyFrameCollection using current 
 ...
 def Contains(self,keyFrame):
  ...
  Contains(self: ThicknessKeyFrameCollection,keyFrame: ThicknessKeyFrame) -> bool
   ...
   keyFrame: The System.Windows.Media.Animation.ThicknessKeyFrame to locate in the 
    collection.
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: ThicknessKeyFrameCollection,array: Array[ThicknessKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.ThicknessKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: ThicknessKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of 
    System.Windows.Media.Animation.ThicknessKeyFrameCollection read-only or 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: ThicknessKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a clone of the specified 
    System.Windows.Media.Animation.ThicknessKeyFrameCollection object.
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: ThicknessKeyFrameCollection,keyFrame: ThicknessKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.ThicknessKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: ThicknessKeyFrameCollection,index: int,keyFrame: ThicknessKeyFrame)
   Inserts a System.Windows.Media.Animation.ThicknessKeyFrame into a specific 
    location within the collection.
  
  
   index: The index position at which the 
    System.Windows.Media.Animation.ThicknessKeyFrame is inserted.
  
   keyFrame: The System.Windows.Media.Animation.ThicknessKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: ThicknessKeyFrameCollection,keyFrame: ThicknessKeyFrame)
   Removes a System.Windows.Media.Animation.ThicknessKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.ThicknessKeyFrame to remove from 
    the collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: ThicknessKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.ThicknessKeyFrame at the specified 
    index position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.ThicknessKeyFrame to be 
    removed.
  """
  pass
