class ByteAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: ByteAnimationBase) -> ByteAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.ByteAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
