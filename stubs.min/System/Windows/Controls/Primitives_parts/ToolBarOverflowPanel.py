class ToolBarOverflowPanel(Panel, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def ArrangeOverride(self, *args): #cannot find CLR method
        ...
        ArrangeOverride(self: ToolBarOverflowPanel, arrangeBounds: Size) -> Size
            ...
            Arranges and sizes the content of a System.Windows.Controls.Primitives.ToolBarOverflowPanel object.
...
"""
    ...
    WrapWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
