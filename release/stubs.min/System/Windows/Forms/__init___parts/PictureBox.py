class PictureBox:
 ...
 def Dispose(self):
  ...
  Dispose(self: PictureBox,disposing: bool)
   Releases the unmanaged resources used by the System.Windows.Forms.PictureBox and 
    optionally releases the managed resources.
  
  
   disposing: true to release managed and unmanaged resources; false to release unmanaged resources 
    only.
  """
  pass
 ...
 def Load(self,url=None):
  ...
  Load(self: PictureBox)
   Displays the image specified by the System.Windows.Forms.PictureBox.ImageLocation 
    property of the System.Windows.Forms.PictureBox.
  
  Load(self: PictureBox,url: str)
   Sets the System.Windows.Forms.PictureBox.ImageLocation to the specified URL and displays 
    the image indicated.
