class ColumnHeaderConverter:
 ...
 def CanConvertTo(self,*__args):
  ...
  CanConvertTo(self: ColumnHeaderConverter,context: ITypeDescriptorContext,destinationType: Type) -> bool
   ...
   Returns a value indicating whether the System.Windows.Forms.ColumnHeaderConverter can 
    convert a System.Windows.Forms.ColumnHeader to the specified type,using the specified 
    context.
 ...
 def ConvertTo(self,*__args):
  ...
  ConvertTo(self: ColumnHeaderConverter,context: ITypeDescriptorContext,culture: CultureInfo,value: object,destinationType: Type) -> object
   ...
   Converts the specified object to the specified type,using the specified context and 
    culture information.
  
  
   context: An System.ComponentModel.ITypeDescriptorContext that provides a format context.
   culture: A System.Globalization.CultureInfo that represents information about a culture,such as 
    language and calendar system. Can be null.
