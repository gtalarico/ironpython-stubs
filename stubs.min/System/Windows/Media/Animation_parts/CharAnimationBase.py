class CharAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: CharAnimationBase) -> CharAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.CharAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
