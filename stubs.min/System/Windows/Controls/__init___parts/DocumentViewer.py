class DocumentViewer(DocumentViewerBase, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IServiceProvider):
    ...
    def FitToMaxPagesAcross(self, pagesAcross=None):
        ...
        FitToMaxPagesAcross(self: DocumentViewer, pagesAcross: int)
            ...
            pagesAcross: The maximum number of pages to fit in the current System.Windows.Controls.DocumentViewer.ExtentWidth.
        FitToMaxPagesAcross(self: DocumentViewer)
            Fits the document to the current System.Windows.Controls.DocumentViewer.MaxPagesAcross property setting.
        """
        pass
    ...
    def GetMasterPageView(self, *args): #cannot find CLR method
        """
        GetMasterPageView(self: DocumentViewerBase) -> DocumentPageView
            ...
            Returns: The current master System.Windows.Controls.Primitives.DocumentPageView for this viewer, or null if no master System.Windows.Controls.Primitives.DocumentPageView can be found.
        """
        pass

    def GetPageViewsCollection(self, *args): #cannot find CLR method
        """
        GetPageViewsCollection(self: DocumentViewer) -> (ReadOnlyCollection[DocumentPageView], bool)
        
            Returns a collection of System.Windows.Controls.Primitives.DocumentPageView elements that are currently displayed.
            Returns: The collection of System.Windows.Controls.Primitives.DocumentPageView elements that are currently displayed in the System.Windows.Controls.DocumentViewer control.
        """
        pass
    ...
    def InvalidatePageViews(self, *args): #cannot find CLR method
        """
        InvalidatePageViews(self: DocumentViewerBase)
            Causes the working System.Windows.Controls.Primitives.DocumentViewerBase.PageViews collection to be re-built.
        """
        pass
    ...
    def OnBringIntoView(self, *args): #cannot find CLR method
        """
        OnBringIntoView(self: DocumentViewer, element: DependencyObject, rect: Rect, pageNumber: int)
            Responds to the System.Windows.Controls.Primitives.DocumentViewerBase.OnBringIntoView(System.Windows.DependencyObject,System.Windows.Rect,System.Int32) method from the 
    ...
    def OnCancelPrintCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: DocumentViewer) -> AutomationPeer
            ...
            Creates and returns an System.Windows.Automation.Peers.AutomationPeer for this System.Windows.Controls.DocumentViewer control.
            Returns: The new System.Windows.Automation.Peers.DocumentViewerAutomationPeer.
        """
        pass

    def OnDecreaseZoomCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnDocumentChanged(self, *args): #cannot find CLR method
        """
    ...
    def OnFindCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnFirstPageCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnFitToHeightCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnFitToMaxPagesAcrossCommand(self, *args): #cannot find CLR method
        """
        OnFitToMaxPagesAcrossCommand(self: DocumentViewer, pagesAcross: int)
            Responds to calls to the System.Windows.Controls.DocumentViewer.FitToMaxPagesAcross(System.Int32) method.
    ...
    def OnFitToWidthCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnGoToPageCommand(self, *args): #cannot find CLR method
        """
        OnGoToPageCommand(self: DocumentViewer, pageNumber: int)
            Responds to calls to the System.Windows.Controls.Primitives.DocumentViewerBase.GoToPage(System.Int32) method.
    ...
    def OnIncreaseZoomCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnLastPageCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnMasterPageNumberChanged(self, *args): #cannot find CLR method
        """
        OnMasterPageNumberChanged(self: DocumentViewerBase)
            Called whenever the System.Windows.Controls.Primitives.DocumentViewerBase.MasterPageNumber property is modified.
        """
        pass
    ...
    def OnMoveDownCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnMoveLeftCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnMoveRightCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnMoveUpCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnNextPageCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnPageViewsChanged(self, *args): #cannot find CLR method
        """
        OnPageViewsChanged(self: DocumentViewerBase)
            Called whenever the working set of System.Windows.Controls.Primitives.DocumentPageView objects for this viewer (represented by the System.Windows.Controls.Primitives.DocumentViewerBase.PageViews property) 
             is modified.
        """
        pass
    ...
    def OnPreviousPageCommand(self, *args): #cannot find CLR method
        """
        OnPreviousPageCommand(self: DocumentViewer)
            Responds to calls to the System.Windows.Controls.Primitives.DocumentViewerBase.PreviousPage method.
        """
        pass

    def OnPrintCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnScrollPageDownCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnScrollPageLeftCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnScrollPageRightCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnScrollPageUpCommand(self, *args): #cannot find CLR method
        """
    ...
    def OnViewThumbnailsCommand(self, *args): #cannot find CLR method
        """
    ...
    CanDecreaseZoom = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanIncreaseZoom = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanMoveDown = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanMoveLeft = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanMoveRight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanMoveUp = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HorizontalPageSpacing = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MaxPagesAcross = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ShowPageBorders = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    VerticalPageSpacing = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
