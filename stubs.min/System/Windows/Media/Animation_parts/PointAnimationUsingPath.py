class PointAnimationUsingPath(PointAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: PointAnimationUsingPath) -> PointAnimationUsingPath
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.PointAnimationUsingPath, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: PointAnimationUsingPath, defaultOriginValue: Point, defaultDestinationValue: Point, animationClock: AnimationClock) -> Point
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.PointAnimationUsingPath.
