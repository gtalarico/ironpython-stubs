class DataGridViewColumnHeaderCell:
 ...
 def GetContentBounds(self,rowIndex):
  ...
  GetContentBounds(self: DataGridViewColumnHeaderCell,graphics: Graphics,cellStyle: DataGridViewCellStyle,rowIndex: int) -> Rectangle
   ...
   Returns the bounding rectangle that encloses the cell's content area,which is calculated 
    using the specified System.Drawing.Graphics object and cell style.
 ...
 def GetInheritedContextMenuStrip(self,rowIndex):
  ...
  GetInheritedContextMenuStrip(self: DataGridViewColumnHeaderCell,rowIndex: int) -> ContextMenuStrip
   ...
   rowIndex: The index of the row to get the System.Windows.Forms.ContextMenuStrip of. The index must 
    be -1 to indicate the row of column headers.
  
   Returns: The System.Windows.Forms.ContextMenuStrip of the column headers if one exists; otherwise,
