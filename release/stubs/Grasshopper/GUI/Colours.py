...
class GH_MultiColourPalette(UserControl, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent, IContainerControl):
    ...
    def FirstBucket(self, *args): #cannot find CLR method
    ...
    def NextBucket(self, *args): #cannot find CLR method
...
"""
    ...
    BucketCount = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: BucketCount(self: GH_MultiColourPalette) -> int

"""

    Buckets = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    Colours = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
class GH_MultiColourPaletteEventArgs(EventArgs):
    ...
    ActiveBuckets = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: ActiveBuckets(self: GH_MultiColourPaletteEventArgs) -> List[GH_ColourBucket]

"""

    BlankBuckets = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: BlankBuckets(self: GH_MultiColourPaletteEventArgs) -> List[GH_ColourBucket]

"""

    SelectedBuckets = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
