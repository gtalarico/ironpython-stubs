class WrapPanel(Panel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: WrapPanel,finalSize: Size) -> Size
   ...
   finalSize: The System.Windows.Size that this element should use to arrange its child 
    elements.
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: WrapPanel,constraint: Size) -> Size
   ...
   Measures the child elements of a System.Windows.Controls.WrapPanel in 
    anticipation of arranging them during the 
    System.Windows.Controls.WrapPanel.ArrangeOverride(System.Windows.Size) pass.
