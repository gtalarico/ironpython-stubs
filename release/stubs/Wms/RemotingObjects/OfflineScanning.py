...
Set: Name(self: AddScannerArgs) = value
"""

    Serialno = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: Serialno(self: AddScannerArgs) -> str

Set: Serialno(self: AddScannerArgs) = value
"""
...
Set: Serialno(self: DeleteScannerArgs) = value
"""
...
Set: Version(self: GetAppVersionFileSpecArgs) = value
"""
...
Set: Version(self: SetCurrentAppVersionArgs) = value
"""
