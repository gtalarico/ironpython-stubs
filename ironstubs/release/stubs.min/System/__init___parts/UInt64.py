class UInt64(object,IComparable,IFormattable,IConvertible,IComparable[UInt64],IEquatable[UInt64]):
 ...
 def Equals(self,obj):
  ...
  Equals(self: UInt64,obj: object) -> bool
   ...
   Returns: true if obj is an instance of System.UInt64 and equals the value of this 
 ...
 def Parse(s,*__args):
  ...
  Parse(s: str,style: NumberStyles) -> UInt64
   ...
   style: A bitwise combination of the enumeration values that specifies the permitted 
 ...
 def TryParse(s,*__args):
  ...
  TryParse(s: str,style: NumberStyles,provider: IFormatProvider) -> (bool,UInt64)
   ...
   Tries to convert the string representation of a number in a specified style and 
    culture-specific format to its 64-bit unsigned integer equivalent. A return 
