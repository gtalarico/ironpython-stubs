...
"""
    ...
    RootFolder = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ShowNewFolderButton = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
