...
"""
    ...
    CurrencyManager = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsBindingSuspended = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
