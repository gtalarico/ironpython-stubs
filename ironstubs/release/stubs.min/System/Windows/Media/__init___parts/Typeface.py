class Typeface(object):
 ...
 def Equals(self,o):
  ...
  Equals(self: Typeface,o: object) -> bool
   ...
   Gets a value that indicates whether the current typeface and the specified 
    typeface have the same System.Windows.Media.Typeface.FontFamily,
    System.Windows.Media.Typeface.Style,System.Windows.Media.Typeface.Weight,
    System.Windows.Media.Typeface.Stretch,and fallback font values.
  
  
   o: The System.Windows.Media.Typeface to compare.
   Returns: true if o is equal to the current System.Windows.Media.Typeface object; 
    otherwise,false. If o is not a System.Windows.Media.Typeface object,false is 
    returned.
  """
  pass
 def GetHashCode(self):
  ...
  GetHashCode(self: Typeface) -> int
   ...
   Serves as a hash function for System.Windows.Media.Typeface. It is suitable for 
 ...
 def TryGetGlyphTypeface(self,glyphTypeface):
  ...
  TryGetGlyphTypeface(self: Typeface) -> (bool,GlyphTypeface)
   ...
   Retrieves the System.Windows.Media.GlyphTypeface that corresponds to the 
    System.Windows.Media.Typeface.
  
   Returns: true if the out parameter is set to a System.Windows.Media.GlyphTypeface value; 
    otherwise,false.
  """
  pass
...
"""
 ...
 IsBoldSimulated=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 IsObliqueSimulated=property(lambda self: object(),lambda self,v: None,lambda self: None)
