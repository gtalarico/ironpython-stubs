 ...
 def Clone(self):
  ...
  Clone(self: DecimalAnimation) -> DecimalAnimation
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.DecimalAnimation,making deep copies of this 
 ...
 def GetCurrentValueCore(self,*args):
  ...
  GetCurrentValueCore(self: DecimalAnimation,defaultOriginValue: Decimal,defaultDestinationValue: Decimal,animationClock: AnimationClock) -> Decimal
   ...
   Calculates a value that represents the current value of the property being 
    animated,as determined by the System.Windows.Media.Animation.DecimalAnimation.
