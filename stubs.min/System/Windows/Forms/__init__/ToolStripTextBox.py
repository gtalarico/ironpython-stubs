...
"""
    ...
    ShortcutsEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    TextBoxTextAlign = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
