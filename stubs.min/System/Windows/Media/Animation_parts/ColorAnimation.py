class ColorAnimation(ColorAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: ColorAnimation) -> ColorAnimation
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.ColorAnimation, making deep copies of this object's values. When copying dependency properties, this method copies resource references and 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: ColorAnimation, defaultOriginValue: Color, defaultDestinationValue: Color, animationClock: AnimationClock) -> Color
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.ColorAnimation.
