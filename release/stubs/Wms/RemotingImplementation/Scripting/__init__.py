...
class ScriptOverridableAttribute:
    ...
    BaseOutputType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: BaseOutputType(self: ScriptOverridableAttribute) -> Type

Set: BaseOutputType(self: ScriptOverridableAttribute) = value
"""

    CustomLocals = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: CustomLocals(self: ScriptOverridableAttribute) -> Dictionary[str, Type]

"""

    CustomLocalsName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: CustomLocalsName(self: ScriptOverridableAttribute) -> Array[str]

Set: CustomLocalsName(self: ScriptOverridableAttribute) = value
"""

    CustomLocalsType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ReturnName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: ReturnName(self: ScriptOverridableAttribute) -> str

Set: ReturnName(self: ScriptOverridableAttribute) = value
"""

    ShowArguments = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
