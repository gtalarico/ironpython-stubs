...
"""
 ...
 ResourceDictionary=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Get: ResourceDictionary(self: ResourceDictionaryInfo) -> ResourceDictionary

"""

 ResourceDictionaryAssembly=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
class ResourceDictionaryLoadedEventArgs(EventArgs):
 # no doc
 ResourceDictionaryInfo=property(lambda self: object(),lambda self,v: None,lambda self: None)
