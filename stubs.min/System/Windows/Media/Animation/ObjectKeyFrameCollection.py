class ObjectKeyFrameCollection(Freezable, ISealable, IList, ICollection, IEnumerable):
    ...
    def Clone(self):
        ...
        Clone(self: ObjectKeyFrameCollection) -> ObjectKeyFrameCollection
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.ObjectKeyFrameCollection, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: ObjectKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.ObjectKeyFrameCollection. When copying dependency properties, this method copies resource references and data bindings (but 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: ObjectKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.ObjectKeyFrameCollection using current property values. Resource references, data bindings, and animations are not 
    ...
    def Contains(self, keyFrame):
        ...
        Contains(self: ObjectKeyFrameCollection, keyFrame: ObjectKeyFrame) -> bool
            ...
            Indicates whether the collection contains the specified System.Windows.Media.Animation.ObjectKeyFrameCollection.
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: ObjectKeyFrameCollection, array: Array[ObjectKeyFrame], index: int)
            Copies the System.Windows.Media.Animation.ObjectKeyFrameCollection to the specified one dimensional System.Windows.Media.Animation.ObjectKeyFrame array, started at the specified index of the target array.
        
            array: The one-dimensional System.Windows.Media.Animation.ObjectKeyFrame array that is the destination of the key frames copied from this System.Windows.Media.Animation.ObjectKeyFrameCollection. The array must 
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: ObjectKeyFrameCollection, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.ObjectKeyFrameCollection unmodifiable or determines whether it can be made unmodifiable.
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: ObjectKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.ObjectKeyFrameCollection object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: ObjectKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.ObjectKeyFrameCollection. Resource references, data bindings, and animations are not copied, but their current values are.
    ...
    def IndexOf(self, keyFrame):
        ...
        IndexOf(self: ObjectKeyFrameCollection, keyFrame: ObjectKeyFrame) -> int
            ...
            Searches for the specified System.Windows.Media.Animation.ObjectKeyFrame and returns the zero-based index of the first occurrence within the entire collection.
    ...
    def Insert(self, index, keyFrame):
        ...
        Insert(self: ObjectKeyFrameCollection, index: int, keyFrame: ObjectKeyFrame)
            Inserts a System.Windows.Media.Animation.ObjectKeyFrame into a specific location within the collection.
    ...
    def RemoveAt(self, index):
        ...
        RemoveAt(self: ObjectKeyFrameCollection, index: int)
            Removes the System.Windows.Media.Animation.ObjectKeyFrame at the specified index position from the collection.
