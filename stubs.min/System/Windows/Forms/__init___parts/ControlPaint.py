class ControlPaint(object):
 ...
 def CreateHBitmapTransparencyMask(bitmap):
  ...
  CreateHBitmapTransparencyMask(bitmap: Bitmap) -> IntPtr
   ...
   Creates a color mask for the specified bitmap that indicates which color should 
 ...
 def DrawBorder(graphics,bounds,*__args):
  ...
  DrawBorder(graphics: Graphics,bounds: Rectangle,leftColor: Color,leftWidth: int,leftStyle: ButtonBorderStyle,topColor: Color,topWidth: int,topStyle: ButtonBorderStyle,rightColor: Color,rightWidth: int,rightStyle: ButtonBorderStyle,bottomColor: Color,bottomWidth: int,bottomStyle: ButtonBorderStyle)
   Draws a border on a button-style control with the specified styles,colors,and 
   ...
   leftStyle: One of the System.Windows.Forms.ButtonBorderStyle values that specifies the 
    style of the left border.
  
   topColor: The System.Drawing.Color of the top of the border.
   topWidth: The width of the top border.
   topStyle: One of the System.Windows.Forms.ButtonBorderStyle values that specifies the 
   ...
   rightStyle: One of the System.Windows.Forms.ButtonBorderStyle values that specifies the 
   ...
   bottomStyle: One of the System.Windows.Forms.ButtonBorderStyle values that specifies the 
    style of the bottom border.
  
  DrawBorder(graphics: Graphics,bounds: Rectangle,color: Color,style: ButtonBorderStyle)
   Draws a border with the specified style and color,on the specified graphics 
    surface,and within the specified bounds on a button-style control.
  
  
   graphics: The System.Drawing.Graphics to draw on.
   bounds: The System.Drawing.Rectangle that represents the dimensions of the border.
   color: The System.Drawing.Color of the border.
   style: One of the System.Windows.Forms.ButtonBorderStyle values that specifies the 
    style of the border.
  """
  pass
 @staticmethod
 def DrawBorder3D(graphics,*__args):
  ...
  DrawBorder3D(graphics: Graphics,x: int,y: int,width: int,height: int)
   Draws a three-dimensional style border on the specified graphics surface and 
    within the specified bounds on a control.
  ...
  DrawBorder3D(graphics: Graphics,x: int,y: int,width: int,height: int,style: Border3DStyle)
   Draws a three-dimensional style border with the specified style,on the 
    specified graphics surface,and within the specified bounds on a control.
   ...
   width: The width of the border rectangle.
   height: The height of the border rectangle.
   style: One of the System.Windows.Forms.Border3DStyle values that specifies the style 
    of the border.
  
  DrawBorder3D(graphics: Graphics,x: int,y: int,width: int,height: int,style: Border3DStyle,sides: Border3DSide)
   Draws a three-dimensional style border with the specified style,on the 
    specified graphics surface and side,and within the specified bounds on a 
    control.
  ...
  DrawBorder3D(graphics: Graphics,rectangle: Rectangle,style: Border3DStyle,sides: Border3DSide)
   Draws a three-dimensional style border with the specified style,on the 
    specified graphics surface and sides,and within the specified bounds on a 
    control.
   ...
   sides: One of the System.Windows.Forms.Border3DSide values that specifies the side of 
    the rectangle to draw the border on.
  """
  pass
 @staticmethod
 def DrawButton(graphics,*__args):
  ...
  DrawButton(graphics: Graphics,x: int,y: int,width: int,height: int,state: ButtonState)
   Draws a button control in the specified state,on the specified graphics 
   ...
   state: A bitwise combination of the System.Windows.Forms.ButtonState values that 
    specifies the state to draw the button in.
 ...
 def DrawCaptionButton(graphics,*__args):
  ...
  DrawCaptionButton(graphics: Graphics,x: int,y: int,width: int,height: int,button: CaptionButton,state: ButtonState)
   Draws the specified caption button control in the specified state,on the 
   ...
   button: One of the System.Windows.Forms.CaptionButton values that specifies the type of 
    caption button to draw.
  ...
  DrawCaptionButton(graphics: Graphics,rectangle: Rectangle,button: CaptionButton,state: ButtonState)
   ...
   graphics: The System.Drawing.Graphics to draw on.
   rectangle: The System.Drawing.Rectangle that represents the dimensions of the caption 
    button.
 ...
 def DrawCheckBox(graphics,*__args):
  ...
  DrawCheckBox(graphics: Graphics,rectangle: Rectangle,state: ButtonState)
   Draws a check box control in the specified state,on the specified graphics 
    surface,and within the specified bounds.
   ...
   state: A bitwise combination of the System.Windows.Forms.ButtonState values that 
    specifies the state to draw the check box in.
 ...
 def DrawComboButton(graphics,*__args):
  ...
  DrawComboButton(graphics: Graphics,x: int,y: int,width: int,height: int,state: ButtonState)
   Draws a drop-down button on a combo box control in the specified state,on the 
    specified graphics surface,and within the specified bounds.
   ...
   state: A bitwise combination of the System.Windows.Forms.ButtonState values that 
    specifies the state to draw the combo box in.
 ...
 def DrawContainerGrabHandle(graphics,bounds):
  ...
  DrawContainerGrabHandle(graphics: Graphics,bounds: Rectangle)
   Draws a container control grab handle glyph on the specified graphics surface 
    and within the specified bounds.
  
  
   graphics: The System.Drawing.Graphics to draw on.
   bounds: The System.Drawing.Rectangle that represents the dimensions of the grab handle 
    glyph.
  """
  pass
 @staticmethod
 def DrawFocusRectangle(graphics,rectangle,foreColor=None,backColor=None):
  ...
  DrawFocusRectangle(graphics: Graphics,rectangle: Rectangle,foreColor: Color,backColor: Color)
   Draws a focus rectangle on the specified graphics surface and within the 
    specified bounds.
  
  
   graphics: The System.Drawing.Graphics to draw on.
   rectangle: The System.Drawing.Rectangle that represents the dimensions of the grab handle 
    glyph.
  
   foreColor: The System.Drawing.Color that is the foreground color of the object to draw the 
    focus rectangle on.
  
   backColor: The System.Drawing.Color that is the background color of the object to draw the 
    focus rectangle on.
 ...
 def DrawGrabHandle(graphics,rectangle,primary,enabled):
  ...
  DrawGrabHandle(graphics: Graphics,rectangle: Rectangle,primary: bool,enabled: bool)
   Draws a standard selection grab handle glyph on the specified graphics surface,
    within the specified bounds,and in the specified state and style.
 ...
 def DrawGrid(graphics,area,pixelsBetweenDots,backColor):
  ...
  DrawGrid(graphics: Graphics,area: Rectangle,pixelsBetweenDots: Size,backColor: Color)
   ...
   pixelsBetweenDots: The System.Drawing.Size that specified the height and width between the dots of 
    the grid.
 ...
 def DrawLockedFrame(graphics,rectangle,primary):
  ...
  DrawLockedFrame(graphics: Graphics,rectangle: Rectangle,primary: bool)
   Draws a locked selection frame on the screen within the specified bounds and on 
    the specified graphics surface. Specifies whether to draw the frame with the 
    primary selected colors.
  
  
   graphics: The System.Drawing.Graphics to draw on.
   rectangle: The System.Drawing.Rectangle that represents the dimensions of the frame.
   primary: true to draw this frame with the colors used for the primary selection; 
    otherwise,false.
  """
  pass
 @staticmethod
 def DrawMenuGlyph(graphics,*__args):
  ...
  DrawMenuGlyph(graphics: Graphics,x: int,y: int,width: int,height: int,glyph: MenuGlyph)
   Draws the specified menu glyph on a menu item control with the specified bounds 
    and on the specified surface.
   ...
   glyph: One of the System.Windows.Forms.MenuGlyph values that specifies the image to 
    draw.
  
  DrawMenuGlyph(graphics: Graphics,x: int,y: int,width: int,height: int,glyph: MenuGlyph,foreColor: Color,backColor: Color)
   Draws the specified menu glyph on a menu item control within the specified 
    coordinates,height,and width on the specified surface,replacing 
    System.Drawing.Color.White with the color specified in the backColor parameter 
    and replacing System.Drawing.Color.Black with the color specified in the 
    foreColor parameter.
  ...
  DrawMenuGlyph(graphics: Graphics,rectangle: Rectangle,glyph: MenuGlyph)
   Draws the specified menu glyph on a menu item control within the specified 
    bounds and on the specified surface.
  ...
  DrawMenuGlyph(graphics: Graphics,rectangle: Rectangle,glyph: MenuGlyph,foreColor: Color,backColor: Color)
   Draws the specified menu glyph on a menu item control within the specified 
    bounds and on the specified surface,replacing System.Drawing.Color.White with 
    the color specified in the backColor parameter and replacing 
    System.Drawing.Color.Black with the color specified in the foreColor parameter.
 ...
 def DrawMixedCheckBox(graphics,*__args):
  ...
  DrawMixedCheckBox(graphics: Graphics,x: int,y: int,width: int,height: int,state: ButtonState)
   Draws a three-state check box control in the specified state,on the specified 
 ...
 def DrawRadioButton(graphics,*__args):
  ...
  DrawRadioButton(graphics: Graphics,rectangle: Rectangle,state: ButtonState)
   Draws a radio button control in the specified state,on the specified graphics 
    surface,and within the specified bounds.
   ...
   state: A bitwise combination of the System.Windows.Forms.ButtonState values that 
    specifies the state to draw the radio button in.
 ...
 def DrawReversibleFrame(rectangle,backColor,style):
  ...
  DrawReversibleFrame(rectangle: Rectangle,backColor: Color,style: FrameStyle)
   ...
   rectangle: The System.Drawing.Rectangle that represents the dimensions of the rectangle to 
    draw,in screen coordinates.
  
   backColor: The System.Drawing.Color of the background behind the frame.
   style: One of the System.Windows.Forms.FrameStyle values that specifies the style of 
    the frame.
  """
  pass
 @staticmethod
 def DrawReversibleLine(start,end,backColor):
  ...
  DrawReversibleLine(start: Point,end: Point,backColor: Color)
   Draws a reversible line on the screen within the specified starting and ending 
    points and with the specified background color.
 ...
 def DrawScrollButton(graphics,*__args):
  ...
  DrawScrollButton(graphics: Graphics,x: int,y: int,width: int,height: int,button: ScrollButton,state: ButtonState)
   Draws the specified scroll button on a scroll bar control in the specified 
    state,on the specified graphics surface,and within the specified bounds.
   ...
   button: One of the System.Windows.Forms.ScrollButton values that specifies the type of 
    scroll arrow to draw.
  
   state: A bitwise combination of the System.Windows.Forms.ButtonState values that 
    specifies the state to draw the scroll button in.
 ...
 def DrawSelectionFrame(graphics,active,outsideRect,insideRect,backColor):
  ...
  DrawSelectionFrame(graphics: Graphics,active: bool,outsideRect: Rectangle,insideRect: Rectangle,backColor: Color)
   Draws a standard selection frame in the specified state,on the specified 
   ...
   outsideRect: The System.Drawing.Rectangle that represents the outer boundary of the 
    selection frame.
  
   insideRect: The System.Drawing.Rectangle that represents the inner boundary of the 
    selection frame.
 ...
 def DrawSizeGrip(graphics,backColor,*__args):
  ...
  DrawSizeGrip(graphics: Graphics,backColor: Color,x: int,y: int,width: int,height: int)
   Draws a size grip on a form with the specified bounds and background color and 
    on the specified graphics surface.
  
  
   graphics: The System.Drawing.Graphics to draw on.
   backColor: The System.Drawing.Color of the background used to determine the colors of the 
    size grip.
 ...
 def DrawStringDisabled(*__args):
  ...
  DrawStringDisabled(dc: IDeviceContext,s: str,font: Font,color: Color,layoutRectangle: Rectangle,format: TextFormatFlags)
   Draws the specified string in a disabled state on the specified graphics 
    surface,within the specified bounds,and in the specified font,color,and 
    format,using the specified GDI-based System.Windows.Forms.TextRenderer.
