class Animatable(Freezable, ISealable, IAnimatable, IResource):
    ...
    def ApplyAnimationClock(self, dp, clock, handoffBehavior=None):
        ...
        ApplyAnimationClock(self: Animatable, dp: DependencyProperty, clock: AnimationClock, handoffBehavior: HandoffBehavior)
            Applies an System.Windows.Media.Animation.AnimationClock to the specified System.Windows.DependencyProperty. If the property is already animated, the specified 
             System.Windows.Media.Animation.HandoffBehavior is used.
        
        
            dp: The property to animate.
            clock: The clock with which to animate the specified property. If handoffBehavior is System.Windows.Media.Animation.HandoffBehavior.SnapshotAndReplace and clock is null, all animations will be removed from the 
             specified property (but not stopped). If handoffBehavior is System.Windows.Media.Animation.HandoffBehavior.Compose and clock is null, this method has no effect.
        
            handoffBehavior: A value that specifies how the new animation should interact with any current animations already affecting the property value.
        ApplyAnimationClock(self: Animatable, dp: DependencyProperty, clock: AnimationClock)
            Applies an System.Windows.Media.Animation.AnimationClock to the specified System.Windows.DependencyProperty. If the property is already animated, the 
             System.Windows.Media.Animation.HandoffBehavior.SnapshotAndReplace handoff behavior is used.
        
        
            dp: The property to animate.
            clock: The clock with which to animate the specified property. If clock is null, all animations will be removed from the specified property (but not stopped).
        """
        pass
    ...
    def BeginAnimation(self, dp, animation, handoffBehavior=None):
        ...
        BeginAnimation(self: Animatable, dp: DependencyProperty, animation: AnimationTimeline, handoffBehavior: HandoffBehavior)
            Applies an animation to the specified System.Windows.DependencyProperty. The animation is started when the next frame is rendered. If the specified property is already animated, the specified 
             System.Windows.Media.Animation.HandoffBehavior is used.
        
        
            dp: The property to animate.
            animation: The animation used to animate the specified property.If handoffBehavior is System.Windows.Media.Animation.HandoffBehavior.SnapshotAndReplace and the animation's 
             System.Windows.Media.Animation.Timeline.BeginTime is null, any current animations will be removed and the current value of the property will be held. If handoffBehavior is 
             System.Windows.Media.Animation.HandoffBehavior.SnapshotAndReplace and animation is a null reference, all animations will be removed from the property and the property value will revert back to its base 
             value.If handoffBehavior is System.Windows.Media.Animation.HandoffBehavior.Compose, this method will have no effect if the animation or its System.Windows.Media.Animation.Timeline.BeginTime is null.
        
            handoffBehavior: A value that specifies how the new animation should interact with any current animations already affecting the property value.
        BeginAnimation(self: Animatable, dp: DependencyProperty, animation: AnimationTimeline)
            Applies an animation to the specified System.Windows.DependencyProperty. The animation is started when the next frame is rendered. If the specified property is already animated, the 
             System.Windows.Media.Animation.HandoffBehavior.SnapshotAndReplace handoff behavior is used.
        
        
            dp: The property to animate.
            animation: The animation used to animate the specified property.If the animation's System.Windows.Media.Animation.Timeline.BeginTime is null, any current animations will be removed and the current value of the 
             property will be held.If animation is null, all animations will be removed from the property and the property value will revert back to its base value.
        """
        pass
    ...
    def Clone(self):
        ...
        Clone(self: Animatable) -> Animatable
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Animatable, making deep copies of this object's values. When copying this object's dependency properties, this method copies resource 
