class FamilyTypeface(object,IDeviceFont,ITypefaceMetrics):
 ...
 def Equals(self,*__args):
  ...
  Equals(self: FamilyTypeface,o: object) -> bool
   ...
   Returns: true if typeface is not null and has the same properties as this typeface; 
    otherwise,false.
  ...
  Equals(self: FamilyTypeface,typeface: FamilyTypeface) -> bool
   ...
   Returns: true if typeface is not null and has the same properties as this font family 
    typeface; otherwise,false.
  """
  pass
 def GetHashCode(self):
  ...
  GetHashCode(self: FamilyTypeface) -> int
   ...
   Serves as a hash function for a System.Windows.Media.FamilyTypeface object. The 
    System.Windows.Media.FamilyTypeface.GetHashCode method is suitable for use in 
 ...
 def __repr__(self,*args):
  ...
  pass
 AdjustedFaceNames=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 DeviceFontCharacterMetrics=property(lambda self: object(),lambda self,v: None,lambda self: None)
