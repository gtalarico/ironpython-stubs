class ThicknessAnimationUsingKeyFrames(ThicknessAnimationBase, ISealable, IAnimatable, IResource, IKeyFrameAnimation, IAddChild):
    """
    Animates the value of a System.Windows.Thickness property along a set of System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames.KeyFrames.
    
    ThicknessAnimationUsingKeyFrames()
    """
    def AddChild(self, *args): #cannot find CLR method
        """
        AddChild(self: ThicknessAnimationUsingKeyFrames, child: object)
            Adds a child System.Windows.Media.Animation.ThicknessKeyFrame to this System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames.
        
            child: The object to be added as the child of this System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames.
        """
        pass

    def AddText(self, *args): #cannot find CLR method
        """
        AddText(self: ThicknessAnimationUsingKeyFrames, childText: str)
            Adds a text string as a child of this System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames.
        
            childText: The text added to the System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames.
        """
        pass
    ...
    def Clone(self):
        """
        Clone(self: ThicknessAnimationUsingKeyFrames) -> ThicknessAnimationUsingKeyFrames
        
            Creates a modifiable clone of this System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames, making deep copies of this object's values. When copying dependency properties, this method copies 
             resource references and data bindings (but they might no longer resolve) but not animations or their current values.
    ...
    def CloneCore(self, *args): #cannot find CLR method
        """
        CloneCore(self: ThicknessAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames. When copying dependency properties, this method copies resource references and data 
             bindings (but they might no longer resolve) but not animations or their current values.
        
        
            sourceFreezable: The System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames to clone.
        """
        pass

    def CloneCurrentValue(self):
        """
        CloneCurrentValue(self: ThicknessAnimationUsingKeyFrames) -> ThicknessAnimationUsingKeyFrames
        
            Creates a modifiable clone of this System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames object, making deep copies of this object's current values. Resource references, data bindings, and 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        """
        CloneCurrentValueCore(self: ThicknessAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames using current property values. Resource references, data bindings, and animations 
    ...
    def CreateInstanceCore(self, *args): #cannot find CLR method
        """
        CreateInstanceCore(self: ThicknessAnimationUsingKeyFrames) -> Freezable
        
            Creates a new instance of System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames.
            Returns: A new instance of System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames.
        """
        pass

    def FreezeCore(self, *args): #cannot find CLR method
        """
        FreezeCore(self: ThicknessAnimationUsingKeyFrames, isChecking: bool) -> bool
        
            Makes this instance of System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames object unmodifiable or determines whether it can be made unmodifiable..
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        """
        GetAsFrozenCore(self: ThicknessAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames object.
        
            source: The System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames object to clone.
        """
        pass

    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        """
        GetCurrentValueAsFrozenCore(self: ThicknessAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames. Resource references, data bindings, and animations are not copied, but their current 
             values are.
        
        
            source: The System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames to copy and freeze.
        """
        pass

    def GetCurrentValueCore(self, *args): #cannot find CLR method
        """
        GetCurrentValueCore(self: ThicknessAnimationUsingKeyFrames, defaultOriginValue: Thickness, defaultDestinationValue: Thickness, animationClock: AnimationClock) -> Thickness
        
            Calculates a value that represents the current value of the property being animated, as determined by this instance of System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames.
    ...
    def GetNaturalDurationCore(self, *args): #cannot find CLR method
        """
        GetNaturalDurationCore(self: ThicknessAnimationUsingKeyFrames, clock: Clock) -> Duration
    ...
    def OnChanged(self, *args): #cannot find CLR method
        """
        OnChanged(self: ThicknessAnimationUsingKeyFrames)
            Called when the current System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames object is modified.
        """
        pass
    ...
    def ShouldSerializeKeyFrames(self):
        """
        ShouldSerializeKeyFrames(self: ThicknessAnimationUsingKeyFrames) -> bool
        
            Returns true if the value of the System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames.KeyFrames property of this instance of System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames 
...
Get: IsAdditive(self: ThicknessAnimationUsingKeyFrames) -> bool

Set: IsAdditive(self: ThicknessAnimationUsingKeyFrames) = value
"""
...
Get: IsCumulative(self: ThicknessAnimationUsingKeyFrames) -> bool

Set: IsCumulative(self: ThicknessAnimationUsingKeyFrames) = value
"""

    KeyFrames = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the collection of System.Windows.Media.Animation.ThicknessKeyFrame objects that define the animation.

Get: KeyFrames(self: ThicknessAnimationUsingKeyFrames) -> ThicknessKeyFrameCollection

Set: KeyFrames(self: ThicknessAnimationUsingKeyFrames) = value
"""
