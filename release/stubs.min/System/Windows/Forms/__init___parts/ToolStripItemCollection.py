class ToolStripItemCollection(ArrangedElementCollection,IList,ICollection,IEnumerable):
 ...
 def Add(self,*__args):
  ...
  Add(self: ToolStripItemCollection,text: str,image: Image,onClick: EventHandler) -> ToolStripItem
   ...
   Adds a System.Windows.Forms.ToolStripItem that displays the specified image and 
    text to the collection and that raises the 
    System.Windows.Forms.ToolStripItem.Click event.
  
  
   text: The text to be displayed on the System.Windows.Forms.ToolStripItem.
   image: The System.Drawing.Image to be displayed on the 
  ...
  Add(self: ToolStripItemCollection,value: ToolStripItem) -> int
   ...
   Returns: An System.Int32 representing the zero-based index of the new item in the 
    collection.
  ...
  Add(self: ToolStripItemCollection,text: str) -> ToolStripItem
   ...
   Adds a System.Windows.Forms.ToolStripItem that displays the specified text to 
    the collection.
  ...
  Add(self: ToolStripItemCollection,image: Image) -> ToolStripItem
   ...
   Adds a System.Windows.Forms.ToolStripItem that displays the specified image to 
    the collection.
 ...
 def AddRange(self,toolStripItems):
  ...
  AddRange(self: ToolStripItemCollection,toolStripItems: ToolStripItemCollection)
   ...
   toolStripItems: The System.Windows.Forms.ToolStripItemCollection to be added to the current 
    collection.
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: ToolStripItemCollection,array: Array[ToolStripItem],index: int)
   ...
   array: The array of type System.Windows.Forms.ToolStripItem to which to copy the 
    collection.
  
   index: The position in the System.Windows.Forms.ToolStripItem array at which to paste 
    the collection.
  """
  pass
 def Find(self,key,searchAllChildren):
  ...
  Find(self: ToolStripItemCollection,key: str,searchAllChildren: bool) -> Array[ToolStripItem]
   ...
   searchAllChildren: true to search child items of the System.Windows.Forms.ToolStripItem specified 
    by the key parameter; otherwise,false.
 ...
 def IndexOf(self,value):
  ...
  IndexOf(self: ToolStripItemCollection,value: ToolStripItem) -> int
   ...
   Returns: A zero-based index value that represents the position of the specified 
    System.Windows.Forms.ToolStripItem in the 
    System.Windows.Forms.ToolStripItemCollection,if found; otherwise,-1.
  """
  pass
 def IndexOfKey(self,key):
  ...
  IndexOfKey(self: ToolStripItemCollection,key: str) -> int
   ...
   Returns: A zero-based index value that represents the position of the first occurrence 
    of the System.Windows.Forms.ToolStripItem specified by the key parameter,if 
    found; otherwise,-1.
  """
  pass
 def Insert(self,index,value):
  ...
  Insert(self: ToolStripItemCollection,index: int,value: ToolStripItem)
   ...
   index: The location in the System.Windows.Forms.ToolStripItemCollection at which to 
    insert the System.Windows.Forms.ToolStripItem.
