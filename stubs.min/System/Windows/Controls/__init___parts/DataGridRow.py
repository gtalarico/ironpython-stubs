class DataGridRow(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 ...
 def GetIndex(self):
  ...
  GetIndex(self: DataGridRow) -> int
   ...
   Returns the index of the row's data item within the 
    System.Windows.Controls.ItemsControl.Items collection of the 
 ...
 def GetRowContainingElement(element):
  ...
  GetRowContainingElement(element: FrameworkElement) -> DataGridRow
   ...
   Returns the System.Windows.Controls.DataGridRow that contains the specified 
    element.
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: DataGridRow) -> AutomationPeer
   ...
   Returns a new System.Windows.Automation.Peers.DataGridRowAutomationPeer for 
    this row.
 ...
 def OnHeaderChanged(self,*args):
  ...
  OnHeaderChanged(self: DataGridRow,oldHeader: object,newHeader: object)
   Called when the value of the System.Windows.Controls.DataGridRow.Header 
 ...
 def OnItemChanged(self,*args):
  ...
  OnItemChanged(self: DataGridRow,oldItem: object,newItem: object)
   Updates the displayed cells when the System.Windows.Controls.DataGridRow.Item 
