...
"""
    ...
    HandleCreated = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ImageStream = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
