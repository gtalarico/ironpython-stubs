class SplineQuaternionKeyFrame(QuaternionKeyFrame, ISealable, IKeyFrame):
    ...
    def InterpolateValueCore(self, *args): #cannot find CLR method
        ...
        InterpolateValueCore(self: SplineQuaternionKeyFrame, baseValue: Quaternion, keyFrameProgress: float) -> Quaternion
            ...
            Interpolates, in a splined fashion, between the previous key frame value and the value of the current key frame, using the supplied progress increment.
...
"""
    ...
    UseShortestPath = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
