class PointConverter(TypeConverter):
 ...
 def CreateInstance(self,*__args):
  ...
  CreateInstance(self: PointConverter,context: ITypeDescriptorContext,propertyValues: IDictionary) -> object
   ...
   propertyValues: A dictionary of new property values. The dictionary contains a series of name-value pairs,one for each property returned from System.Drawing.PointConverter.GetProperties(System.ComponentModel.ITypeDescriptorContext,System.Object,System.Attribute[]).
 ...
 def GetCreateInstanceSupported(self,context=None):
  ...
  GetCreateInstanceSupported(self: PointConverter,context: ITypeDescriptorContext) -> bool
   ...
   Determines if changing a value on this object should require a call to System.Drawing.PointConverter.CreateInstance(System.ComponentModel.ITypeDescriptorContext,System.Collections.IDictionary) to create a new value.
  
   context: A System.ComponentModel.TypeDescriptor through which additional context can be provided.
   Returns: true if the System.Drawing.PointConverter.CreateInstance(System.ComponentModel.ITypeDescriptorContext,System.Collections.IDictionary) method should be called when a change is made to one or more properties of this object; otherwise,false.
  """
  pass
