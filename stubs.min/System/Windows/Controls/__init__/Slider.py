class Slider(RangeBase, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient):
    ...
    def OnDecreaseLarge(self, *args): #cannot find CLR method
        """
    ...
    def OnDecreaseSmall(self, *args): #cannot find CLR method
        """
    ...
    def OnIncreaseLarge(self, *args): #cannot find CLR method
        """
    ...
    def OnIncreaseSmall(self, *args): #cannot find CLR method
        """
    ...
    def OnMaximizeValue(self, *args): #cannot find CLR method
        """
    ...
    def OnMinimizeValue(self, *args): #cannot find CLR method
        """
    ...
    def OnPreviewMouseLeftButtonDown(self, *args): #cannot find CLR method
        ...
        OnPreviewMouseLeftButtonDown(self: Slider, e: MouseButtonEventArgs)
            Provides class handling for the System.Windows.ContentElement.PreviewMouseLeftButtonDown routed event.
    ...
    def OnThumbDragCompleted(self, *args): #cannot find CLR method
        """
        OnThumbDragCompleted(self: Slider, e: DragCompletedEventArgs)
            Provides class handling for the System.Windows.Controls.Primitives.Thumb.DragCompleted event that occurs when the user stops dragging the System.Windows.Controls.Primitives.Thumb of the 
    ...
    def OnThumbDragDelta(self, *args): #cannot find CLR method
        """
        OnThumbDragDelta(self: Slider, e: DragDeltaEventArgs)
            Provides class handling for the System.Windows.Controls.Primitives.Thumb.DragDelta event that occurs when the user drags the System.Windows.Controls.Primitives.Thumb of the System.Windows.Controls.Slider.
        
            e: The event data.
        """
        pass

    def OnThumbDragStarted(self, *args): #cannot find CLR method
        """
        OnThumbDragStarted(self: Slider, e: DragStartedEventArgs)
            Provides class handling for the System.Windows.Controls.Primitives.Thumb.DragStarted event that occurs when the user starts to drag the System.Windows.Controls.Primitives.Thumb of the 
             System.Windows.Controls.Slider.
    ...
    def OnValueChanged(self, *args): #cannot find CLR method
        ...
        OnValueChanged(self: Slider, oldValue: float, newValue: float)
            Updates the current position of the System.Windows.Controls.Slider when the System.Windows.Controls.Primitives.RangeBase.Value property changes.
    ...
    AutoToolTipPlacement = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AutoToolTipPrecision = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsDirectionReversed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsMoveToPointEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsSelectionRangeEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsSnapToTickEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    TickPlacement = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
