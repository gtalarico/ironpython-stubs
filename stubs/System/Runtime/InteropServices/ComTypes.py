...
class IAdviseSink:
    ...
    def OnDataChange(self, format, stgmedium):
        ...
        OnDataChange(self: IAdviseSink, format: FORMATETC, stgmedium: STGMEDIUM) -> (FORMATETC, STGMEDIUM)
            ...
            format: A System.Runtime.InteropServices.ComTypes.FORMATETC, passed by reference, which 
             describes the format, target device, rendering, and storage information of the 
             calling data object.
        
            stgmedium: A System.Runtime.InteropServices.ComTypes.STGMEDIUM, passed by reference, which 
             defines the storage medium (global memory, disk file, storage object, stream 
             object, Graphics Device Interface (GDI) object, or undefined) and ownership of 
    ...
    def ReleaseBoundObjects(self):
        ...
        ReleaseBoundObjects(self: IBindCtx)
            Releases all the objects currently registered with the bind context by using 
             the 
             System.Runtime.InteropServices.ComTypes.IBindCtx.RegisterObjectBound(System.Obje
             ct) method.
        """
        pass
    ...
    def Unadvise(self, dwCookie):
        ...
        Unadvise(self: IConnectionPoint, dwCookie: int)
            Terminates an advisory connection previously established through the 
             System.Runtime.InteropServices.ComTypes.IConnectionPoint.Advise(System.Object,Sy
             stem.Int32@) method.
...
class IDataObject:
    ...
    def DAdvise(self, pFormatetc, advf, adviseSink, connection):
        ...
        DAdvise(self: IDataObject, pFormatetc: FORMATETC, advf: ADVF, adviseSink: IAdviseSink) -> (int, FORMATETC, int)
            ...
            Creates a connection between a data object and an advisory sink. This method is 
             called by an object that supports an advisory sink and enables the advisory 
            ...
            pFormatetc: A System.Runtime.InteropServices.ComTypes.FORMATETC structure, passed by 
             reference, that defines the format, target device, aspect, and medium that will 
             be used for future notifications.
        
            advf: One of the System.Runtime.InteropServices.ComTypes.ADVF values that specifies a 
             group of flags for controlling the advisory connection.
            ...
            Returns: This method supports the standard return values E_INVALIDARG, E_UNEXPECTED, and 
             E_OUTOFMEMORY, as well as the following: ValueDescriptionS_OKThe advisory 
    ...
    def DUnadvise(self, connection):
        ...
        DUnadvise(self: IDataObject, connection: int)
            ...
            connection: A DWORD token that specifies the connection to remove. Use the value returned 
             by 
             System.Runtime.InteropServices.ComTypes.IDataObject.DAdvise(System.Runtime.Inter
             opServices.ComTypes.FORMATETC@,System.Runtime.InteropServices.ComTypes.ADVF,Syst
             em.Runtime.InteropServices.ComTypes.IAdviseSink,System.Int32@) when the 
    ...
    def EnumFormatEtc(self, direction):
        ...
        EnumFormatEtc(self: IDataObject, direction: DATADIR) -> IEnumFORMATETC
            ...
            Creates an object for enumerating the 
             System.Runtime.InteropServices.ComTypes.FORMATETC structures for a data object. 
             These structures are used in calls to 
             System.Runtime.InteropServices.ComTypes.IDataObject.GetData(System.Runtime.Inter
             opServices.ComTypes.FORMATETC@,System.Runtime.InteropServices.ComTypes.STGMEDIUM
             @) or 
             System.Runtime.InteropServices.ComTypes.IDataObject.SetData(System.Runtime.Inter
             opServices.ComTypes.FORMATETC@,System.Runtime.InteropServices.ComTypes.STGMEDIUM
             @,System.Boolean).
            ...
            Returns: This method supports the standard return values E_INVALIDARG and E_OUTOFMEMORY, 
             as well as the following:ValueDescriptionS_OKThe enumerator object was 
             successfully created.E_NOTIMPLThe direction specified by the direction 
             parameter is not supported.OLE_S_USEREGRequests that OLE enumerate the formats 
             from the registry.
        """
        pass
    ...
    def GetCanonicalFormatEtc(self, formatIn, formatOut):
        ...
        GetCanonicalFormatEtc(self: IDataObject, formatIn: FORMATETC) -> (int, FORMATETC, FORMATETC)
            ...
            Provides a standard System.Runtime.InteropServices.ComTypes.FORMATETC structure 
             that is logically equivalent to a more complex structure. Use this method to 
            ...
            formatIn: A pointer to a System.Runtime.InteropServices.ComTypes.FORMATETC structure, 
             ...
             System.Runtime.InteropServices.ComTypes.IDataObject.GetData(System.Runtime.Inter
             opServices.ComTypes.FORMATETC@,System.Runtime.InteropServices.ComTypes.STGMEDIUM
             @). The System.Runtime.InteropServices.ComTypes.TYMED member is not significant 
    ...
    def GetData(self, format, medium):
        ...
        GetData(self: IDataObject, format: FORMATETC) -> (FORMATETC, STGMEDIUM)
            ...
            Obtains data from a source data object. The 
             System.Runtime.InteropServices.ComTypes.IDataObject.GetData(System.Runtime.Inter
             opServices.ComTypes.FORMATETC@,System.Runtime.InteropServices.ComTypes.STGMEDIUM
             @) method, which is called by a data consumer, renders the data described in 
    ...
    def GetDataHere(self, format, medium):
        ...
        GetDataHere(self: IDataObject, format: FORMATETC, medium: STGMEDIUM) -> (FORMATETC, STGMEDIUM)
            ...
            Obtains data from a source data object. This method, which is called by a data 
             ...
             System.Runtime.InteropServices.ComTypes.IDataObject.GetData(System.Runtime.Inter
             opServices.ComTypes.FORMATETC@,System.Runtime.InteropServices.ComTypes.STGMEDIUM
             @) method in that the caller must allocate and free the specified storage 
             medium.
            ...
            medium: A System.Runtime.InteropServices.ComTypes.STGMEDIUM, passed by reference, that 
             ...
             System.Runtime.InteropServices.ComTypes.IDataObject.GetDataHere(System.Runtime.I
             nteropServices.ComTypes.FORMATETC@,System.Runtime.InteropServices.ComTypes.STGME
             DIUM@). The caller must also free the medium. The implementation of this method 
             must always supply a value of null for the 
             System.Runtime.InteropServices.ComTypes.STGMEDIUM.pUnkForRelease member of the 
             System.Runtime.InteropServices.ComTypes.STGMEDIUM structure that this parameter 
             points to.
        """
        pass
    ...
    def QueryGetData(self, format):
        ...
        QueryGetData(self: IDataObject, format: FORMATETC) -> (int, FORMATETC)
            ...
            Returns: This method supports the standard return values E_INVALIDARG, E_UNEXPECTED, and 
             E_OUTOFMEMORY, as well as the following: ValueDescriptionS_OKA subsequent call 
             to 
             System.Runtime.InteropServices.ComTypes.IDataObject.GetData(System.Runtime.Inter
             opServices.ComTypes.FORMATETC@,System.Runtime.InteropServices.ComTypes.STGMEDIUM
             @) would probably be successful.DV_E_LINDEXAn invalid value for 
             System.Runtime.InteropServices.ComTypes.FORMATETC.lindex; currently, only -1 is 
             supported.DV_E_FORMATETCAn invalid value for the pFormatetc 
    ...
    def SetData(self, formatIn, medium, release):
        ...
        SetData(self: IDataObject, formatIn: FORMATETC, medium: STGMEDIUM, release: bool) -> (FORMATETC, STGMEDIUM)
            ...
            release: true to specify that the data object called, which implements 
             System.Runtime.InteropServices.ComTypes.IDataObject.SetData(System.Runtime.Inter
             opServices.ComTypes.FORMATETC@,System.Runtime.InteropServices.ComTypes.STGMEDIUM
             @,System.Boolean), owns the storage medium after the call returns. This means 
             that the data object must free the medium after it has been used by calling the 
             ReleaseStgMedium function. false to specify that the caller retains ownership 
             of the storage medium, and the data object called uses the storage medium for 
...
class IEnumVARIANT:
    ...
    def Clone(self):
        ...
        Clone(self: IEnumVARIANT) -> IEnumVARIANT
            ...
            Returns: An System.Runtime.InteropServices.ComTypes.IEnumVARIANT  reference to the newly 
             created enumerator.
        """
        pass
    ...
    def ComposeWith(self, pmkRight, fOnlyIfNotGeneric, ppmkComposite):
        ...
        ComposeWith(self: IMoniker, pmkRight: IMoniker, fOnlyIfNotGeneric: bool) -> IMoniker
            ...
            fOnlyIfNotGeneric: true to indicate that the caller requires a nongeneric composition. The 
             operation proceeds only if pmkRight is a moniker class that the current moniker 
             can combine with in some way other than forming a generic composite. false to 
    ...
    def ParseDisplayName(self, pbc, pmkToLeft, pszDisplayName, pchEaten, ppmkOut):
        ...
        ParseDisplayName(self: IMoniker, pbc: IBindCtx, pmkToLeft: IMoniker, pszDisplayName: str) -> (int, IMoniker)
            ...
            Reads as many characters of the specified display name as the 
             System.Runtime.InteropServices.ComTypes.IMoniker.ParseDisplayName(System.Runtime
             .InteropServices.ComTypes.IBindCtx,System.Runtime.InteropServices.ComTypes.IMoni
             ker,System.String,System.Int32@,System.Runtime.InteropServices.ComTypes.IMoniker
             @) understands and builds a moniker corresponding to the portion read.
        
        
            pbc: A reference to the bind context to use in this binding operation.
            pmkToLeft: A reference to the moniker that has been built from the display name up to this 
             point.
        ...
        Register(self: IRunningObjectTable, grfFlags: int, punkObject: object, pmkObjectName: IMoniker) -> int
            ...
            Returns: A value that can be used to identify this ROT entry in subsequent calls to 
             System.Runtime.InteropServices.ComTypes.IRunningObjectTable.Revoke(System.Int32)
              or 
             System.Runtime.InteropServices.ComTypes.IRunningObjectTable.NoteChangeTime(Syste
             m.Int32,System.Runtime.InteropServices.ComTypes.FILETIME@).
        """
        pass
    ...
    def ReleaseFuncDesc(self, pFuncDesc):
        ...
        ReleaseFuncDesc(self: ITypeInfo, pFuncDesc: IntPtr)
            Releases a System.Runtime.InteropServices.FUNCDESC structure previously 
             returned by the 
             System.Runtime.InteropServices.ComTypes.ITypeInfo.GetFuncDesc(System.Int32,Syste
             m.IntPtr@) method.
    ...
    def ReleaseVarDesc(self, pVarDesc):
        ...
        ReleaseVarDesc(self: ITypeInfo, pVarDesc: IntPtr)
            Releases a VARDESC structure previously returned by the 
             System.Runtime.InteropServices.ComTypes.ITypeInfo.GetVarDesc(System.Int32,System
             .IntPtr@) method.
