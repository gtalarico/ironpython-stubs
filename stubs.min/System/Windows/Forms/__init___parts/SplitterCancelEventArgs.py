class SplitterCancelEventArgs(CancelEventArgs):
    ...
    MouseCursorX = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MouseCursorY = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SplitX = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SplitY = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
