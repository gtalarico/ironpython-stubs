class InkCanvasStrokesReplacedEventArgs(EventArgs):
    ...
    NewStrokes = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    PreviousStrokes = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
