class DocumentPaginator(object):
    ...
    def CancelAsync(self, userState):
        ...
        CancelAsync(self: DocumentPaginator, userState: object)
            Cancels a previous erload:System.Windows.Documents.DocumentPaginator.GetPageAsync or erload:System.Windows.Documents.DynamicDocumentPaginator.GetPageNumberAsync operation.
        
            userState: The original userState passed to erload:System.Windows.Documents.DocumentPaginator.GetPageAsync, erload:System.Windows.Documents.DynamicDocumentPaginator.GetPageNumberAsync, or 
             erload:System.Windows.Documents.DocumentPaginator.ComputePageCountAsync that identifies the asynchronous task to cancel.
        """
        pass
    ...
    def ComputePageCount(self):
        ...
        ComputePageCount(self: DocumentPaginator)
            Forces a pagination of the content, updates System.Windows.Documents.DocumentPaginator.PageCount with the new total, and sets System.Windows.Documents.DocumentPaginator.IsPageCountValid to true.
        """
        pass
    ...
    def ComputePageCountAsync(self, userState=None):
        ...
        ComputePageCountAsync(self: DocumentPaginator, userState: object)
            Asynchronously, forces a pagination of the content, updates System.Windows.Documents.DocumentPaginator.PageCount with the new total, sets System.Windows.Documents.DocumentPaginator.IsPageCountValid to true.
        
            userState: A unique identifier for the asynchronous task.
        ComputePageCountAsync(self: DocumentPaginator)
            Asynchronously, forces a pagination of the content, updates System.Windows.Documents.DocumentPaginator.PageCount with the new total, and sets System.Windows.Documents.DocumentPaginator.IsPageCountValid to 
             true.
        """
        pass
    ...
    def GetPage(self, pageNumber):
        ...
        GetPage(self: DocumentPaginator, pageNumber: int) -> DocumentPage
            ...
            When overridden in a derived class, gets the System.Windows.Documents.DocumentPage for the specified page number.
        
            pageNumber: The zero-based page number of the document page that is needed.
            Returns: The System.Windows.Documents.DocumentPage for the specified pageNumber, or System.Windows.Documents.DocumentPage.Missing if the page does not exist.
        """
        pass
    ...
    def GetPageAsync(self, pageNumber, userState=None):
        ...
        GetPageAsync(self: DocumentPaginator, pageNumber: int, userState: object)
            Asynchronously returns (through the System.Windows.Documents.DocumentPaginator.GetPageCompleted event) the System.Windows.Documents.DocumentPage for the specified page number and assigns the specified ID 
        ...
        GetPageAsync(self: DocumentPaginator, pageNumber: int)
            Asynchronously returns (through the System.Windows.Documents.DocumentPaginator.GetPageCompleted event) the System.Windows.Documents.DocumentPage for the specified page number.
