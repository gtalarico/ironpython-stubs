class GradientStopCollection(Animatable,ISealable,IAnimatable,IResource,IFormattable,IList,ICollection,IEnumerable,IList[GradientStop],ICollection[GradientStop],IEnumerable[GradientStop]):
 ...
 def Add(self,value):
  ...
  Add(self: GradientStopCollection,value: GradientStop)
   ...
   value: The System.Windows.Media.GradientStop to add to the end of the 
 ...
 def Clone(self):
  ...
  Clone(self: GradientStopCollection) -> GradientStopCollection
   ...
   Creates a modifiable clone of this System.Windows.Media.GradientStopCollection,
 ...
 def Contains(self,value):
  ...
  Contains(self: GradientStopCollection,value: GradientStop) -> bool
   ...
   value: The System.Windows.Media.GradientStop to locate in the 
    System.Windows.Media.GradientStopCollection.
  
   Returns: true if the System.Windows.Media.GradientStop is found in the 
    System.Windows.Media.GradientStopCollection; otherwise,false.
  """
  pass
 def CopyTo(self,array,index):
  """
  CopyTo(self: GradientStopCollection,array: Array[GradientStop],index: int)
   Copies the entire System.Windows.Media.GradientStopCollection to a compatible 
   ...
   array: The one-dimensional array that is the destination of the items copied from the 
    System.Windows.Media.GradientStopCollection. The array must have zero-based 
    indexing.
 ...
 def GetEnumerator(self):
  ...
  GetEnumerator(self: GradientStopCollection) -> Enumerator
   ...
   Returns: An System.Windows.Media.GradientStopCollection.Enumerator that can iterate 
 ...
 def Insert(self,index,value):
  ...
  Insert(self: GradientStopCollection,index: int,value: GradientStop)
   Inserts a System.Windows.Media.GradientStop at the specified position in the 
    gradient stop list.
 ...
 def Parse(source):
  ...
  Parse(source: str) -> GradientStopCollection
   ...
   Converts a System.String representation of a GradientStopCollection into the 
    equivalent System.Windows.Media.GradientStopCollection.
 ...
 def Remove(self,value):
  ...
  Remove(self: GradientStopCollection,value: GradientStop) -> bool
   ...
   Removes the first occurrence of the specified System.Windows.Media.GradientStop 
     from this System.Windows.Media.GradientStopCollection.
  
  
   value: The System.Windows.Media.GradientStop  to remove from this 
    System.Windows.Media.GradientStopCollection.
  
   Returns: true if value was removed from the System.Windows.Media.GradientStopCollection; 
    otherwise,false.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: GradientStopCollection,index: int)
   Removes the System.Windows.Media.GradientStop  at the specified index from this 
    System.Windows.Media.GradientStopCollection.
 ...
 def ToString(self,provider=None):
  ...
  ToString(self: GradientStopCollection,provider: IFormatProvider) -> str
   ...
   Returns: Returns a System.String containing the values of this 
    System.Windows.Media.GradientStopCollection.
