class DataGridCellsPresenter(ItemsControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: DataGridCellsPresenter,finalSize: Size) -> Size
   ...
   finalSize: The final area within the parent that this object should use to arrange itself 
    and its children.
 ...
 def GetContainerForItemOverride(self,*args):
  ...
  GetContainerForItemOverride(self: DataGridCellsPresenter) -> DependencyObject
   ...
   Returns a new System.Windows.Controls.DataGridCell instance to contain a cell 
    value.
 ...
 def OnItemChanged(self,*args):
  ...
  OnItemChanged(self: DataGridCellsPresenter,oldItem: object,newItem: object)
   Updates the displayed cells when the 
    System.Windows.Controls.Primitives.DataGridCellsPresenter.Item property value 
    has changed.
  
  
   oldItem: The previous value of the 
    System.Windows.Controls.Primitives.DataGridCellsPresenter.Item property.
  
   newItem: The new value of the 
    System.Windows.Controls.Primitives.DataGridCellsPresenter.Item property.
  """
  pass
 ...
 def OnRender(self,*args):
  ...
  OnRender(self: DataGridCellsPresenter,drawingContext: DrawingContext)
   Called by the layout system to draw a horizontal line below the cells if 
    horizontal grid lines are visible.
  
  
   drawingContext: The drawing instructions for the cells. This context is provided to the layout 
    system.
  """
  pass
