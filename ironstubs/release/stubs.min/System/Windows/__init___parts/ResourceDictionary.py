...
"""
 ...
 DeferrableContent=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MergedDictionaries=property(lambda self: object(),lambda self,v: None,lambda self: None)
