...
"""
    ...
    BindingCompleteContext = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    BindingCompleteState = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
