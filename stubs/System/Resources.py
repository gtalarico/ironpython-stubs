...
class IResourceWriter(IDisposable):
    ...
    def Generate(self):
        ...
        Generate(self: IResourceWriter)
            Writes all the resources added by the System.Resources.IResourceWriter.AddResource(System.String,System.String) method to the output file or stream.
        """
        pass
...
class ResourceManager(object):
    ...
    def CreateFileBasedResourceManager(baseName, resourceDir, usingResourceSet):
        ...
        CreateFileBasedResourceManager(baseName: str, resourceDir: str, usingResourceSet: Type) -> ResourceManager
            ...
            Returns a System.Resources.ResourceManager that searches a specific directory for resources instead of in the assembly manifest.
            ...
            usingResourceSet: The System.Type of the custom System.Resources.ResourceSet to use. If null, the default runtime System.Resources.ResourceSet is used.
            Returns: The newly created System.Resources.ResourceManager that searches a specific directory for resources instead of in the assembly manifest.
        """
        pass
    ...
    def GetNeutralResourcesLanguage(self, *args): #cannot find CLR method
        ...
        GetNeutralResourcesLanguage(a: Assembly) -> CultureInfo
            ...
            Returns the System.Globalization.CultureInfo for the main assembly's neutral resources by reading the value of the System.Resources.NeutralResourcesLanguageAttribute on a specified 
             System.Reflection.Assembly.
        
        
            a: The assembly for which to return a System.Globalization.CultureInfo.
            Returns: The culture from the System.Resources.NeutralResourcesLanguageAttribute, if found; otherwise, System.Globalization.CultureInfo.InvariantCulture.
        """
        pass
    ...
    def GetObject(self, name, culture=None):
        ...
        GetObject(self: ResourceManager, name: str, culture: CultureInfo) -> object
            ...
            culture: The culture for which the resource is localized. If the resource is not localized for this culture, the resource manager uses fallback rules to locate an appropriate resource.If this value is null, the 
             System.Globalization.CultureInfo object is obtained using the culture's System.Globalization.CultureInfo.CurrentUICulture property.
        
            Returns: The value of the resource, localized for the specified culture. If an appropriate resource set exists but name cannot be found, the method returns null.
        GetObject(self: ResourceManager, name: str) -> object
        
            Returns the value of the specified non-string resource.
        
            name: The name of the resource to get.
            Returns: The value of the resource localized for the caller's current culture settings. If an appropriate resource set exists but name cannot be found, the method returns null.
        """
        pass
    ...
    def GetResourceSet(self, culture, createIfNotExists, tryParents):
        ...
        GetResourceSet(self: ResourceManager, culture: CultureInfo, createIfNotExists: bool, tryParents: bool) -> ResourceSet
            ...
            tryParents: If the System.Resources.ResourceSet cannot be loaded, try parent System.Globalization.CultureInfo objects to see if they exist.
    ...
    def GetSatelliteContractVersion(self, *args): #cannot find CLR method
        ...
        GetSatelliteContractVersion(a: Assembly) -> Version
            ...
            Returns the System.Version specified by the System.Resources.SatelliteContractVersionAttribute in the given assembly.
        
            a: The System.Reflection.Assembly for which to look up the System.Resources.SatelliteContractVersionAttribute.
    ...
    def GetStream(self, name, culture=None):
        ...
        GetStream(self: ResourceManager, name: str, culture: CultureInfo) -> UnmanagedMemoryStream
            ...
            culture: An object that specifies the culture to use for the resource lookup. If culture is null, the culture for the current thread is used.
    ...
    def GetString(self, name, culture=None):
        ...
        GetString(self: ResourceManager, name: str, culture: CultureInfo) -> str
            ...
            Returns: The value of the resource localized for the specified culture, or null if name cannot be found in a resource set.
        GetString(self: ResourceManager, name: str) -> str
        
            Returns the value of the specified string resource.
        
            name: The name of the resource to retrieve.
            Returns: The value of the resource localized for the caller's current UI culture, or null if name cannot be found in a resource set.
        """
        pass
...
class ResourceReader(object, IResourceReader, IEnumerable, IDisposable):
    ...
    def Close(self):
        ...
        Close(self: ResourceReader)
            Releases all operating system resources associated with this System.Resources.ResourceReader object.
        """
        pass
...
class ResourceSet(object, IDisposable, IEnumerable):
    ...
    def GetDefaultReader(self):
        ...
        GetDefaultReader(self: ResourceSet) -> Type
            ...
            Returns: Returns the System.Type for the preferred resource reader for this kind of System.Resources.ResourceSet.
        """
        pass
    ...
    def GetDefaultWriter(self):
        ...
        GetDefaultWriter(self: ResourceSet) -> Type
            ...
            Returns: Returns the System.Type for the preferred resource writer for this kind of System.Resources.ResourceSet.
        """
        pass
    ...
    def GetEnumerator(self):
        ...
        GetEnumerator(self: ResourceSet) -> IDictionaryEnumerator
            ...
            Returns an System.Collections.IDictionaryEnumerator that can iterate through the System.Resources.ResourceSet.
    ...
    def GetString(self, name, ignoreCase=None):
        ...
        GetString(self: ResourceSet, name: str, ignoreCase: bool) -> str
            ...
            Searches for a System.String resource with the specified name in a case-insensitive manner, if requested.
    ...
    def ReadResources(self, *args): #cannot find CLR method
        ...
        ReadResources(self: ResourceSet)
            Reads all the resources and stores them in a System.Collections.Hashtable indicated in the System.Resources.ResourceSet.Table property.
        """
        pass
...
class ResourceWriter(object, IResourceWriter, IDisposable):
    ...
    def AddResource(self, name, value, closeAfterWrite=None):
        ...
        AddResource(self: ResourceWriter, name: str, value: Stream, closeAfterWrite: bool)
            Adds a named resource specified as a stream to the list of resources to be written, and specifies whether the stream should be closed after the System.Resources.ResourceWriter.Generate method is called.
            ...
            closeAfterWrite: true to close the stream after the System.Resources.ResourceWriter.Generate method is called; otherwise, false.
...
class ResXDataNode(object, ISerializable):
    ...
    def GetNodePosition(self):
        ...
        GetNodePosition(self: ResXDataNode) -> Point
            ...
            Returns: A System.Drawing.Point structure specifying the location of this resource in the resource file as a line position (System.Drawing.Point.X) and a column position (System.Drawing.Point.Y). If this resource 
             is not part of a resource file, returns a System.Drawing.Point structure with an System.Drawing.Point.X of 0 and a System.Drawing.Point.Y of 0.
        """
        pass
...
class ResXFileRef(object):
    ...
    def ToString(self):
        ...
        ToString(self: ResXFileRef) -> str
            ...
            Returns: A string that consists of the concatenated text representations of the parameters specified in the current erload:System.Resources.ResXFileRef.#ctor constructor.
        """
        pass
...
class ResXResourceReader(object, IResourceReader, IEnumerable, IDisposable):
    ...
    def FromFileContents(fileContents, *__args):
        ...
        FromFileContents(fileContents: str, assemblyNames: Array[AssemblyName]) -> ResXResourceReader
            ...
            Creates a new System.Resources.ResXResourceReader object and initializes it to read a string whose contents are in the form of an XML resource file, and to use an array of System.Reflection.AssemblyName 
             objects to resolve type names specified in a resource.
        
        
            fileContents: A string whose contents are in the form of an XML resource file.
            assemblyNames: An array of System.Reflection.AssemblyName objects that specifies one or more assemblies. The assemblies are used to resolve a type name in the resource to an actual type.
        ...
        FromFileContents(fileContents: str, typeResolver: ITypeResolutionService) -> ResXResourceReader
            ...
            Creates a new System.Resources.ResXResourceReader object and initializes it to read a string whose contents are in the form of an XML resource file, and to use an 
             System.ComponentModel.Design.ITypeResolutionService object to resolve type names specified in a resource.
...
class ResXResourceSet(ResourceSet, IDisposable, IEnumerable):
    ...
    def GetDefaultReader(self):
        ...
        GetDefaultReader(self: ResXResourceSet) -> Type
            ...
            Returns: The System.Type of the preferred resource reader for this kind of System.Resources.ResXResourceSet.
        """
        pass
    ...
    def GetDefaultWriter(self):
        ...
        GetDefaultWriter(self: ResXResourceSet) -> Type
            ...
            Returns: The System.Type of the preferred resource writer for this kind of System.Resources.ResXResourceSet.
        """
        pass
...
class ResXResourceWriter(object, IResourceWriter, IDisposable):
    ...
    def Generate(self):
        ...
        Generate(self: ResXResourceWriter)
            Writes all resources added by the System.Resources.ResXResourceWriter.AddResource(System.String,System.Byte[]) method to the output file or stream.
        """
        pass
