...
class MissingSatelliteAssemblyException(SystemException,ISerializable,_Exception):
 ...
 def Instance(self):
  """ This function has been arbitrarily put into the stubs"""
  return MissingSatelliteAssemblyException()
...
class ResourceManager(object):
 ...
 def GetNeutralResourcesLanguage(self,*args):
  ...
  GetNeutralResourcesLanguage(a: Assembly) -> CultureInfo
   ...
   Returns the System.Globalization.CultureInfo for the main assembly's neutral resources by reading the value of the System.Resources.NeutralResourcesLanguageAttribute on a specified System.Reflection.Assembly.
 ...
 def GetObject(self,name,culture=None):
  ...
  GetObject(self: ResourceManager,name: str,culture: CultureInfo) -> object
   ...
   name: The name of the resource to get.
   culture: The culture for which the resource is localized. If the resource is not localized for this culture,the resource manager uses fallback rules to locate an appropriate resource.If this value is null,the System.Globalization.CultureInfo object is obtained using the culture's System.Globalization.CultureInfo.CurrentUICulture property.
...
class ResXDataNode(object,ISerializable):
 ...
 def GetNodePosition(self):
  ...
  GetNodePosition(self: ResXDataNode) -> Point
   ...
   Returns: A System.Drawing.Point structure specifying the location of this resource in the resource file as a line position (System.Drawing.Point.X) and a column position (System.Drawing.Point.Y). If this resource is not part of a resource file,returns a System.Drawing.Point structure with an System.Drawing.Point.X of 0 and a System.Drawing.Point.Y of 0.
  """
  pass
...
class SatelliteContractVersionAttribute(Attribute,_Attribute):
 ...
 def Instance(self):
  """ This function has been arbitrarily put into the stubs"""
  return SatelliteContractVersionAttribute()
