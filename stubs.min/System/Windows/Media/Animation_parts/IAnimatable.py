class IAnimatable:
    ...
    def ApplyAnimationClock(self, dp, clock, handoffBehavior=None):
        ...
        ApplyAnimationClock(self: IAnimatable, dp: DependencyProperty, clock: AnimationClock, handoffBehavior: HandoffBehavior)
            Applies the effect of a given System.Windows.Media.Animation.AnimationClock to a given dependency property. The effect of the new System.Windows.Media.Animation.AnimationClock on any current animations is 
            ...
            handoffBehavior: Determines how the new System.Windows.Media.Animation.AnimationClock will transition from or affect any current animations on the property.
        ApplyAnimationClock(self: IAnimatable, dp: DependencyProperty, clock: AnimationClock)
            Applies the effect of a given System.Windows.Media.Animation.AnimationClock to a given dependency property.
    ...
    def BeginAnimation(self, dp, animation, handoffBehavior=None):
        ...
        BeginAnimation(self: IAnimatable, dp: DependencyProperty, animation: AnimationTimeline, handoffBehavior: HandoffBehavior)
            Initiates an animation sequence for the System.Windows.DependencyProperty.object, based on both the specified System.Windows.Media.Animation.AnimationTimeline and 
        ...
        BeginAnimation(self: IAnimatable, dp: DependencyProperty, animation: AnimationTimeline)
            Initiates an animation sequence for the System.Windows.DependencyProperty object, based on the specified System.Windows.Media.Animation.AnimationTimeline.
