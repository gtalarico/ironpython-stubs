class Glyphs(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IUriContext):
 """
 ...
 def ArrangeOverride(self,*args):
  """ ArrangeOverride(self: Glyphs,finalSize: Size) -> Size """
  pass
 ...
 def MeasureOverride(self,*args):
  """ MeasureOverride(self: Glyphs,constraint: Size) -> Size """
  pass
 ...
 def OnRender(self,*args):
  """ OnRender(self: Glyphs,context: DrawingContext) """
  pass
 ...
 def ToGlyphRun(self):
  """
  ToGlyphRun(self: Glyphs) -> GlyphRun
  
   Creates a System.Windows.Media.GlyphRun from the properties of the 
    System.Windows.Documents.Glyphs object.
  
   Returns: A System.Windows.Media.GlyphRun that was created using the properties of the 
    System.Windows.Documents.Glyphs object.
  """
  pass
 def __init__(self,*args):
  ...
  pass
 BidiLevel=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the bidirectional nesting level of System.Windows.Documents.Glyphs.

Get: BidiLevel(self: Glyphs) -> int

Set: BidiLevel(self: Glyphs)=value
"""

 CaretStops=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the caret stops that correspond to the code points in the Unicode string representing the System.Windows.Documents.Glyphs.

Get: CaretStops(self: Glyphs) -> str

Set: CaretStops(self: Glyphs)=value
"""
...
"""
 ...
 DeviceFontName=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the specific device font for which the System.Windows.Documents.Glyphs object has been optimized.

Get: DeviceFontName(self: Glyphs) -> str

Set: DeviceFontName(self: Glyphs)=value
"""

 Fill=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the sets the System.Windows.Media.Brush that is used for the fill of the System.Windows.Documents.Glyphs class.

Get: Fill(self: Glyphs) -> Brush

Set: Fill(self: Glyphs)=value
"""

 FontRenderingEmSize=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the em size used for rendering the System.Windows.Documents.Glyphs class.

Get: FontRenderingEmSize(self: Glyphs) -> float

Set: FontRenderingEmSize(self: Glyphs)=value
"""

 FontUri=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Uri that represents the location of the font used for rendering the System.Windows.Documents.Glyphs class.

Get: FontUri(self: Glyphs) -> Uri

Set: FontUri(self: Glyphs)=value
"""
 ...
 """Gets or sets a collection of glyph specifications that represents the System.Windows.Documents.Glyphs object.

Get: Indices(self: Glyphs) -> str

Set: Indices(self: Glyphs)=value
"""
...
"""
 ...
 IsSideways=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Determines whether to rotate the System.Windows.Documents.Glyphs object.

Get: IsSideways(self: Glyphs) -> bool

Set: IsSideways(self: Glyphs)=value
"""
...
"""
 ...
 """Gets or sets the value of the x origin for the System.Windows.Documents.Glyphs object.

Get: OriginX(self: Glyphs) -> float

Set: OriginX(self: Glyphs)=value
"""

 OriginY=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the value of the y origin for the System.Windows.Documents.Glyphs object.

Get: OriginY(self: Glyphs) -> float

Set: OriginY(self: Glyphs)=value
"""

 StyleSimulations=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.Media.StyleSimulations for the System.Windows.Documents.Glyphs class.

Get: StyleSimulations(self: Glyphs) -> StyleSimulations

Set: StyleSimulations(self: Glyphs)=value
"""
...
"""
 ...
 UnicodeString=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.String that represents the Unicode string for the System.Windows.Documents.Glyphs object.

Get: UnicodeString(self: Glyphs) -> str

Set: UnicodeString(self: Glyphs)=value
"""
...
"""
 ...
 BidiLevelProperty=None
 CaretStopsProperty=None
 DeviceFontNameProperty=None
 FillProperty=None
 FontRenderingEmSizeProperty=None
 FontUriProperty=None
 IndicesProperty=None
 IsSidewaysProperty=None
 OriginXProperty=None
 OriginYProperty=None
 StyleSimulationsProperty=None
 UnicodeStringProperty=None
