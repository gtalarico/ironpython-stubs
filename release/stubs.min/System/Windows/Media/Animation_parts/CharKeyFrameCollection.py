class CharKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: CharKeyFrameCollection,keyFrame: CharKeyFrame) -> int
   ...
   keyFrame: The System.Windows.Media.Animation.CharKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: CharKeyFrameCollection)
   Removes all System.Windows.Media.Animation.CharKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: CharKeyFrameCollection) -> CharKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.CharKeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: CharKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.CharKeyFrameCollection. When copying dependency 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: CharKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.CharKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: CharKeyFrameCollection,array: Array[CharKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.CharKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: CharKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this System.Windows.Media.Animation.CharKeyFrameCollection read-only or 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: CharKeyFrameCollection,sourceFreezable: Freezable)
   ...
   sourceFreezable: The System.Windows.Media.Animation.CharKeyFrameCollection object to clone and 
    freeze.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: CharKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.CharKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: CharKeyFrameCollection,keyFrame: CharKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.CharKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: CharKeyFrameCollection,index: int,keyFrame: CharKeyFrame)
   Inserts a System.Windows.Media.Animation.CharKeyFrame into a specific location 
    within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.CharKeyFrame is 
    inserted.
  
   keyFrame: The System.Windows.Media.Animation.CharKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: CharKeyFrameCollection,keyFrame: CharKeyFrame)
   Removes a System.Windows.Media.Animation.CharKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.CharKeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: CharKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.CharKeyFrame at the specified index 
