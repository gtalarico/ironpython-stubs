class MatrixAnimationUsingPath(MatrixAnimationBase,ISealable,IAnimatable,IResource):
 ...
 def Clone(self):
  ...
  Clone(self: MatrixAnimationUsingPath) -> MatrixAnimationUsingPath
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.MatrixAnimationUsingPath,making deep copies of 
 ...
 def OnChanged(self,*args):
  ...
  OnChanged(self: MatrixAnimationUsingPath)
   Called when this System.Windows.Media.Animation.MatrixAnimationUsingPath is 
    modified.
  """
  pass
