class DocumentViewerAutomationPeer(DocumentViewerBaseAutomationPeer):
    ...
    def GetPattern(self, patternInterface):
        ...
        GetPattern(self: DocumentViewerAutomationPeer, patternInterface: PatternInterface) -> object
            ...
            Gets the control pattern for the System.Windows.Controls.DocumentViewer that is associated with this System.Windows.Automation.Peers.DocumentViewerAutomationPeer.
        
            patternInterface: One of the enumeration values.
            Returns: If patternInterface is System.Windows.Automation.Peers.PatternInterface.ScrollItem, this method returns the System.Windows.Automation.Peers.ScrollViewerAutomationPeer for this 
             System.Windows.Automation.Peers.DocumentViewerAutomationPeer. This method also sets System.Windows.Automation.Peers.DocumentViewerAutomationPeer as the 
