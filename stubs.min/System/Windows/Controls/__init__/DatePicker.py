class DatePicker(Control, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient):
    ...
    def OnApplyTemplate(self):
        ...
        OnApplyTemplate(self: DatePicker)
            Builds the visual tree for the System.Windows.Controls.DatePicker control when a new template is applied.
        """
        pass

    def OnCalendarClosed(self, *args): #cannot find CLR method
        """
    ...
    def OnCalendarOpened(self, *args): #cannot find CLR method
        """
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: DatePicker) -> AutomationPeer
            ...
            Returns a System.Windows.Automation.Peers.DatePickerAutomationPeer for use by the automation infrastructure.
            Returns: A System.Windows.Automation.Peers.DatePickerAutomationPeer for the System.Windows.Controls.DatePicker object.
        """
        pass

    def OnDateValidationError(self, *args): #cannot find CLR method
        """
    ...
    def OnSelectedDateChanged(self, *args): #cannot find CLR method
        """
    ...
    def ToString(self):
        ...
        ToString(self: DatePicker) -> str
            ...
            Returns: A text representation of the selected date, or an empty string if System.Windows.Controls.DatePicker.SelectedDate is null.
        """
        pass
...
"""
    ...
    CalendarStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectedDateFormat = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
