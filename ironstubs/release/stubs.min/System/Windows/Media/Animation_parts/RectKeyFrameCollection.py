class RectKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: RectKeyFrameCollection,keyFrame: RectKeyFrame) -> int
   ...
   keyFrame: The System.Windows.Media.Animation.RectKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: RectKeyFrameCollection)
   Removes all System.Windows.Media.Animation.RectKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: RectKeyFrameCollection) -> RectKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.RectKeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: RectKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.RectKeyFrameCollection. When copying dependency 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: RectKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.RectKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: RectKeyFrameCollection,array: Array[RectKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.RectKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: RectKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.RectKeyFrameCollection 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: RectKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.RectKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: RectKeyFrameCollection,keyFrame: RectKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.RectKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: RectKeyFrameCollection,index: int,keyFrame: RectKeyFrame)
   Inserts a System.Windows.Media.Animation.RectKeyFrame into a specific location 
    within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.RectKeyFrame is 
    inserted.
  
   keyFrame: The System.Windows.Media.Animation.RectKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: RectKeyFrameCollection,keyFrame: RectKeyFrame)
   Removes a System.Windows.Media.Animation.RectKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.RectKeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: RectKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.RectKeyFrame at the specified index 
