class TextBlock(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IContentHost,IAddChildInternal,IAddChild,IServiceProvider):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: TextBlock,arrangeSize: Size) -> Size
   ...
   arrangeSize: A System.Windows.Size within the hosting parent element that the 
    System.Windows.Controls.TextBlock should use to arrange itself and its child 
    elements. Sizing constraints may affect this requested size.
 ...
 def GetBaselineOffset(element):
  ...
  GetBaselineOffset(element: DependencyObject) -> float
   ...
   Returns the value of the System.Windows.Controls.TextBlock.BaselineOffset�
   ...
   Returns: The current value of the System.Windows.Controls.TextBlock.BaselineOffset 
 ...
 def GetFontFamily(element):
  ...
  GetFontFamily(element: DependencyObject) -> FontFamily
   ...
   Returns: The current value of the System.Windows.Controls.TextBlock.FontFamily attached 
 ...
 def GetFontSize(element):
  ...
  GetFontSize(element: DependencyObject) -> float
   ...
   Returns: The current value of the System.Windows.Controls.TextBlock.FontSize attached 
    property on the specified dependency object.
  """
  pass
 @staticmethod
 def GetFontStretch(element):
  ...
  GetFontStretch(element: DependencyObject) -> FontStretch
   ...
   Returns: The current value of the System.Windows.Controls.TextBlock.FontStretch attached 
    property on the specified dependency object.
  """
  pass
 @staticmethod
 def GetFontStyle(element):
  ...
  GetFontStyle(element: DependencyObject) -> FontStyle
   ...
   Returns: The current value of the System.Windows.Controls.TextBlock.FontStyle attached 
    property on the specified dependency object.
  """
  pass
 @staticmethod
 def GetFontWeight(element):
  ...
  GetFontWeight(element: DependencyObject) -> FontWeight
   ...
   Returns: The current value of the System.Windows.Controls.TextBlock.FontWeight attached 
    property on the specified dependency object.
  """
  pass
 @staticmethod
 def GetForeground(element):
  ...
  GetForeground(element: DependencyObject) -> Brush
   ...
   Returns: The current value of the System.Windows.Controls.TextBlock.Foreground attached 
    property on the specified dependency object.
  """
  pass
 ...
 def GetLineHeight(element):
  ...
  GetLineHeight(element: DependencyObject) -> float
   ...
   Returns: The current value of the System.Windows.Controls.TextBlock.LineHeight attached 
    property on the specified dependency object.
  """
  pass
 @staticmethod
 def GetLineStackingStrategy(element):
  ...
  GetLineStackingStrategy(element: DependencyObject) -> LineStackingStrategy
   ...
   Returns: The current value of the System.Windows.Controls.TextBlock.LineStackingStrategy 
    attached property on the specified dependency object.
  """
  pass
 def GetPositionFromPoint(self,point,snapToText):
  ...
  GetPositionFromPoint(self: TextBlock,point: Point,snapToText: bool) -> TextPointer
   ...
   Returns a System.Windows.Documents.TextPointer to the position closest to a 
    specified System.Windows.Point.
  
  
   point: A System.Windows.Point in the coordinate space of the 
    System.Windows.Controls.TextBlock for which to return a 
    System.Windows.Documents.TextPointer.
  
   snapToText: true to return a System.Windows.Documents.TextPointer to the insertion point 
   ...
   Returns: A System.Windows.Documents.TextPointer to the specified point,or null if 
    snapToText is false and the specified point does not fall within a character 
    bounding box in the System.Windows.Controls.TextBlock content area.
  """
  pass
 def GetRectanglesCore(self,*args):
  ...
  GetRectanglesCore(self: TextBlock,child: ContentElement) -> ReadOnlyCollection[Rect]
   ...
   child: A System.Windows.ContentElement for which to generate and return a collection 
    of bounding rectangles.
  
   Returns: A read-only collection of bounding rectangles for the specified 
    System.Windows.ContentElement.
  """
  pass
 ...
 def GetTextAlignment(element):
  ...
  GetTextAlignment(element: DependencyObject) -> TextAlignment
   ...
   Returns the value of the System.Windows.Controls.TextBlock.TextAlignment�
    attached property for a specified dependency object.
   ...
   Returns: The current value of the System.Windows.Controls.TextBlock.TextAlignment 
    attached property on the specified dependency object.
  """
  pass
 ...
 def GetVisualChild(self,*args):
  ...
  GetVisualChild(self: TextBlock,index: int) -> Visual
   ...
   index: A zero-based index specifying the System.Windows.Media.Visual child to return.  
    This value must be between 0 and 
    (System.Windows.Controls.TextBlock.VisualChildrenCount minus 1)
 ...
 def HitTestCore(self,*args):
  ...
  HitTestCore(self: TextBlock,hitTestParameters: PointHitTestParameters) -> HitTestResult
   ...
   hitTestParameters: A System.Windows.Media.PointHitTestParameters object specifying the parameters 
    to hit test for.
 ...
 def InputHitTestCore(self,*args):
  ...
  InputHitTestCore(self: TextBlock,point: Point) -> IInputElement
   ...
   point: A System.Windows.Point,in the coordinate space of the 
    System.Windows.Controls.TextBlock,for which to return the corresponding 
    System.Windows.IInputElement.
  
   Returns: The System.Windows.IInputElement found at the specified Point,or null if no 
 ...
 def OnChildDesiredSizeChangedCore(self,*args):
  ...
  OnChildDesiredSizeChangedCore(self: TextBlock,child: UIElement)
   ...
   child: The child System.Windows.UIElement element whose 
    System.Windows.UIElement.DesiredSize has changed.
  """
  pass
 ...
 def SetFontFamily(element,value):
  ...
  SetFontFamily(element: DependencyObject,value: FontFamily)
   Sets the value of the System.Windows.Controls.TextBlock.FontFamily�attached 
    property on a specified dependency object.
 ...
 def SetFontSize(element,value):
  ...
  SetFontSize(element: DependencyObject,value: float)
   Sets the value of the System.Windows.Controls.TextBlock.FontSize�attached 
    property on a specified dependency object.
 ...
 def SetFontStyle(element,value):
  ...
  SetFontStyle(element: DependencyObject,value: FontStyle)
   Sets the value of the System.Windows.Controls.TextBlock.FontStyle�attached 
    property on a specified dependency object.
 ...
 def SetFontWeight(element,value):
  ...
  SetFontWeight(element: DependencyObject,value: FontWeight)
   Sets the value of the System.Windows.Controls.TextBlock.FontWeight�attached 
    property on a specified dependency object.
 ...
 def SetForeground(element,value):
  ...
  SetForeground(element: DependencyObject,value: Brush)
   Sets the value of the System.Windows.Controls.TextBlock.Foreground�attached 
    property on a specified dependency object.
 ...
 def SetLineHeight(element,value):
  ...
  SetLineHeight(element: DependencyObject,value: float)
   Sets the value of the System.Windows.Controls.TextBlock.LineHeight�attached 
    property on a specified dependency object.
 ...
 def ShouldSerializeBaselineOffset(self):
  ...
  ShouldSerializeBaselineOffset(self: TextBlock) -> bool
   ...
   Returns a value that indicates whether the effective value of the 
    System.Windows.Controls.TextBlock.BaselineOffset property should be serialized 
    during serialization of a System.Windows.Controls.TextBlock object.
  
   Returns: true if the System.Windows.Controls.TextBlock.BaselineOffset property should be 
 ...
 def ShouldSerializeInlines(self,manager):
  ...
  ShouldSerializeInlines(self: TextBlock,manager: XamlDesignerSerializationManager) -> bool
   ...
   Returns a value that indicates whether the effective value of the 
    System.Windows.Controls.TextBlock.Inlines property should be serialized during 
   ...
   Returns: true if the System.Windows.Controls.TextBlock.Inlines property should be 
    serialized; otherwise,false.
  """
  pass
 ...
 def ShouldSerializeText(self):
  ...
  ShouldSerializeText(self: TextBlock) -> bool
   ...
   Returns a value that indicates whether the effective value of the 
    System.Windows.Controls.TextBlock.Text property should be serialized during 
    serialization of a System.Windows.Controls.TextBlock object.
  
   Returns: true if the System.Windows.Controls.TextBlock.Text property should be 
    serialized; otherwise,false.
  """
  pass
