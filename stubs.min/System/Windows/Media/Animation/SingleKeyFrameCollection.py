class SingleKeyFrameCollection(Freezable, ISealable, IList, ICollection, IEnumerable):
    ...
    def Clone(self):
        ...
        Clone(self: SingleKeyFrameCollection) -> SingleKeyFrameCollection
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.SingleKeyFrameCollection, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: SingleKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.SingleKeyFrameCollection. When copying dependency properties, this method copies resource references and data bindings (but 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: SingleKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.SingleKeyFrameCollection using current property values. Resource references, data bindings, and animations are not 
    ...
    def Contains(self, keyFrame):
        ...
        Contains(self: SingleKeyFrameCollection, keyFrame: SingleKeyFrame) -> bool
            ...
            Gets a value that indicates whether the collection contains the specified System.Windows.Media.Animation.SingleKeyFrame.
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: SingleKeyFrameCollection, array: Array[SingleKeyFrame], index: int)
            Copies all of the System.Windows.Media.Animation.SingleKeyFrame objects in a collection to a specified array.
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: SingleKeyFrameCollection, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.SingleKeyFrameCollection read-only or determines whether it can be made read-only.
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: SingleKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.SingleKeyFrameCollection object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: SingleKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.SingleKeyFrameCollection. Resource references, data bindings, and animations are not copied, but their current values are.
    ...
    def IndexOf(self, keyFrame):
        ...
        IndexOf(self: SingleKeyFrameCollection, keyFrame: SingleKeyFrame) -> int
            ...
            Searches for the specified System.Windows.Media.Animation.SingleKeyFrame and returns the zero-based index of the first occurrence within the entire collection.
    ...
    def Insert(self, index, keyFrame):
        ...
        Insert(self: SingleKeyFrameCollection, index: int, keyFrame: SingleKeyFrame)
            Inserts a System.Windows.Media.Animation.SingleKeyFrame into a specific location within the collection.
    ...
    def RemoveAt(self, index):
        ...
        RemoveAt(self: SingleKeyFrameCollection, index: int)
            Removes the System.Windows.Media.Animation.SingleKeyFrame at the specified index position from the collection.
