class GroupBoxRenderer:
 ...
 def DrawGroupBox(g,bounds,*__args):
  ...
  DrawGroupBox(g: Graphics,bounds: Rectangle,state: GroupBoxState)
   ...
   state: One of the System.Windows.Forms.VisualStyles.GroupBoxState values that specifies the 
    visual state of the group box.
  
  DrawGroupBox(g: Graphics,bounds: Rectangle,groupBoxText: str,font: Font,state: GroupBoxState)
   Draws a group box control in the specified state and bounds,with the specified text and 
    font.
  ...
  DrawGroupBox(g: Graphics,bounds: Rectangle,groupBoxText: str,font: Font,textColor: Color,state: GroupBoxState)
   Draws a group box control in the specified state and bounds,with the specified text,
    font,and color.
  ...
  DrawGroupBox(g: Graphics,bounds: Rectangle,groupBoxText: str,font: Font,textColor: Color,flags: TextFormatFlags,state: GroupBoxState)
   Draws a group box control in the specified state and bounds,with the specified text,
    font,color,and text formatting.
 ...
 def IsBackgroundPartiallyTransparent(state):
  ...
  IsBackgroundPartiallyTransparent(state: GroupBoxState) -> bool
   ...
   Indicates whether the background of the group box has any semitransparent or 
   ...
   Returns: true if the background of the group box has semitransparent or alpha-blended pieces; 
    otherwise,false.
  """
  pass
