class Adorner(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient):
    """ Abstract class that represents a System.Windows.FrameworkElement that decorates a System.Windows.UIElement. """
    ...
    def GetDesiredTransform(self, transform):
        """
        GetDesiredTransform(self: Adorner, transform: GeneralTransform) -> GeneralTransform
            ...
            transform: The transform that is currently applied to the adorned element.
            Returns: A transform to apply to the adorner.
        """
        pass

    def GetLayoutClip(self, *args): #cannot find CLR method
        """
        GetLayoutClip(self: Adorner, layoutSlotSize: Size) -> Geometry
        
            For a description of this member, see System.Windows.UIElement.GetLayoutClip(System.Windows.Size).
        
            layoutSlotSize: The available size provided by the element.
            Returns: The potential clipping geometry. See Remarks.
        """
        pass
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        """
        MeasureOverride(self: Adorner, constraint: Size) -> Size
        
            Implements any custom measuring behavior for the adorner.
        
            constraint: A size to constrain the adorner to.
            Returns: A System.Windows.Size object representing the amount of layout space needed by the adorner.
        """
        pass
    ...
    def __new__(self, *args): #cannot find CLR constructor
        """ __new__(cls: type, adornedElement: UIElement) """
        pass

    AdornedElement = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the System.Windows.UIElement that this adorner is bound to.

Get: AdornedElement(self: Adorner) -> UIElement
...
"""
    ...
    IsClipEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that indicates whether clipping of the adorner is enabled.

Get: IsClipEnabled(self: Adorner) -> bool

Set: IsClipEnabled(self: Adorner) = value
"""
