class ListItemCollection(TextElementCollection[ListItem],IList,ICollection,IEnumerable,ICollection[ListItem],IEnumerable[ListItem]):
 ...
 def __iter__(self,*args):
  ...
  pass
 FirstListItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 LastListItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
