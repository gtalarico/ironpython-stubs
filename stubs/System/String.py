...
def endswith(self, suffix): # real signature unknown; restored from __doc__
    """
...
def format(format_string, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
def replace(self, old, new, count): # real signature unknown; restored from __doc__
...
def startswith(self, prefix): # real signature unknown; restored from __doc__
    """
...
def __ne__(a, b): # real signature unknown; restored from __doc__
    ...
    __ne__(a: str, b: str) -> bool
        ...
        Returns: true if the value of a is different from the value of b; otherwise, false.
    """
    return False
