class FixedPage(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChildInternal,IAddChild,IFixedNavigate,IUriContext):
 ...
 def GetBottom(element):
  ...
  GetBottom(element: UIElement) -> float
   ...
   Returns the distance between the bottom of an element and the bottom of its 
    parent System.Windows.Controls.Canvas.
 ...
 def GetLeft(element):
  ...
  GetLeft(element: UIElement) -> float
   ...
   Returns the distance between the left side of an element and the left side of 
    its parent System.Windows.Controls.Canvas.
  
  
   element: The element from which to get the left offset.
   Returns: The distance between the right side of an element and the right side of its 
    parent canvas.
  """
  pass
 @staticmethod
 def GetNavigateUri(element):
  ...
  GetNavigateUri(element: UIElement) -> Uri
   ...
   Returns the System.Windows.Documents.FixedPage.NavigateUri property for a given 
    element.
 ...
 def GetRight(element):
  ...
  GetRight(element: UIElement) -> float
   ...
   Returns the distance between the right side of an element and the right side of 
    its parent System.Windows.Controls.Canvas.
 ...
 def SetBottom(element,length):
  ...
  SetBottom(element: UIElement,length: float)
   ...
   length: The new distance between the bottom side of the element and the bottom side of 
    its parent canvas.
  """
  pass
 @staticmethod
 def SetLeft(element,length):
  ...
  SetLeft(element: UIElement,length: float)
   Sets the distance between the left side of an element and the left side of its 
    parent System.Windows.Controls.Canvas.
  
  
   element: The element on which to set the left offset.
   length: The new distance between the left side of the element and the left side of its 
    parent canvas.
  """
  pass
 @staticmethod
 def SetNavigateUri(element,uri):
  ...
  SetNavigateUri(element: UIElement,uri: Uri)
   Sets the uniform resource identifier (URI) to navigate to when a hyperlink is 
    clicked.
 ...
 def SetRight(element,length):
  ...
  SetRight(element: UIElement,length: float)
   Sets the distance between the right side of an element and the right side of 
    its parent System.Windows.Controls.Canvas.
  
  
   element: The element on which to set the right offset.
   length: The new distance between the right side of the element and the right side of 
    its parent canvas.
  """
  pass
 @staticmethod
 def SetTop(element,length):
  ...
  SetTop(element: UIElement,length: float)
   ...
   length: The new distance between the top side of the element and the top side of its 
    parent canvas.
  """
  pass
