class ByteKeyFrameCollection(Freezable, ISealable, IList, ICollection, IEnumerable):
    ...
    def Clone(self):
        ...
        Clone(self: ByteKeyFrameCollection) -> ByteKeyFrameCollection
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.ByteKeyFrameCollection, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: ByteKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.ByteKeyFrameCollection. When copying dependency properties, this method copies resource references and data bindings (but 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: ByteKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.ByteKeyFrameCollection using current property values. Resource references, data bindings, and animations are not 
    ...
    def Contains(self, keyFrame):
        ...
        Contains(self: ByteKeyFrameCollection, keyFrame: ByteKeyFrame) -> bool
            ...
            Indicates whether the collection contains the specified System.Windows.Media.Animation.ByteKeyFrame.
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: ByteKeyFrameCollection, array: Array[ByteKeyFrame], index: int)
            Copies all of the System.Windows.Media.Animation.ByteKeyFrame objects in a collection to a specified array.
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: ByteKeyFrameCollection, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.ByteKeyFrameCollection read-only or determines whether it can be made read-only.
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: ByteKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.ByteKeyFrameCollection object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: ByteKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.ByteKeyFrameCollection. Resource references, data bindings, and animations are not copied, but their current values are.
    ...
    def IndexOf(self, keyFrame):
        ...
        IndexOf(self: ByteKeyFrameCollection, keyFrame: ByteKeyFrame) -> int
            ...
            Searches for the specified System.Windows.Media.Animation.ByteKeyFrame and returns the zero-based index of the first occurrence within the entire collection.
    ...
    def Insert(self, index, keyFrame):
        ...
        Insert(self: ByteKeyFrameCollection, index: int, keyFrame: ByteKeyFrame)
            Inserts a System.Windows.Media.Animation.ByteKeyFrame into a specific location within the collection.
    ...
    def RemoveAt(self, index):
        ...
        RemoveAt(self: ByteKeyFrameCollection, index: int)
            Removes the System.Windows.Media.Animation.ByteKeyFrame at the specified index position from the collection.
