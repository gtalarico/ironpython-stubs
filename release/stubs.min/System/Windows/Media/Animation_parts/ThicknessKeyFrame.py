class ThicknessKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: ThicknessKeyFrame,baseValue: Thickness,keyFrameProgress: float) -> Thickness
  
   Returns the interpolated value of a specific key frame at the progress 
    increment provided.
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: ThicknessKeyFrame,baseValue: Thickness,keyFrameProgress: float) -> Thickness
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.ThicknessKeyFrame.Value should be reached.

Get: KeyTime(self: ThicknessKeyFrame) -> KeyTime

Set: KeyTime(self: ThicknessKeyFrame)=value
"""

 Value=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the key frame's target value.

Get: Value(self: ThicknessKeyFrame) -> Thickness

Set: Value(self: ThicknessKeyFrame)=value
"""
