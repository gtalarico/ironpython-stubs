class ScrollContentPresenter(ContentPresenter, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IScrollInfo):
    ...
    def ChooseTemplate(self, *args): #cannot find CLR method
        """
    ...
    def LineLeft(self):
        ...
        LineLeft(self: ScrollContentPresenter)
            Scrolls the System.Windows.Controls.ScrollContentPresenter content to the left by a predetermined amount.
        """
        pass
    ...
    def LineRight(self):
        ...
        LineRight(self: ScrollContentPresenter)
            Scrolls the System.Windows.Controls.ScrollContentPresenter content to the right by a predetermined amount.
        """
        pass
    ...
    def OnApplyTemplate(self):
        ...
        OnApplyTemplate(self: ScrollContentPresenter)
            Invoked when an internal process or application calls System.Windows.FrameworkElement.ApplyTemplate, which is used to build the visual tree of the current template.
        """
        pass
    ...
    def OnContentTemplateSelectorChanged(self, *args): #cannot find CLR method
        ...
        OnContentTemplateSelectorChanged(self: ContentPresenter, oldContentTemplateSelector: DataTemplateSelector, newContentTemplateSelector: DataTemplateSelector)
            Invoked when the System.Windows.Controls.ContentPresenter.ContentTemplateSelector property changes.
