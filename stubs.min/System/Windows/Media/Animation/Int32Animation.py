class Int32Animation(Int32AnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: Int32Animation) -> Int32Animation
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Int32Animation, making deep copies of this object's values. When copying dependency properties, this method copies resource references and 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: Int32Animation, defaultOriginValue: int, defaultDestinationValue: int, animationClock: AnimationClock) -> int
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.Int32Animation.
