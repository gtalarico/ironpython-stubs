class DataGridViewRowPrePaintEventArgs(HandledEventArgs):
    ...
    def DrawFocus(self, bounds, cellsPaintSelectionBackground):
        ...
        DrawFocus(self: DataGridViewRowPrePaintEventArgs, bounds: Rectangle, cellsPaintSelectionBackground: bool)
            ...
            cellsPaintSelectionBackground: true to use the System.Windows.Forms.DataGridViewCellStyle.SelectionBackColor property of the System.Windows.Forms.DataGridViewRow.InheritedStyle property to determine the color of the focus rectangle; 
             false to use the System.Windows.Forms.DataGridViewCellStyle.BackColor property of the System.Windows.Forms.DataGridViewRow.InheritedStyle.
        """
        pass
    ...
    def PaintCellsBackground(self, clipBounds, cellsPaintSelectionBackground):
        ...
        PaintCellsBackground(self: DataGridViewRowPrePaintEventArgs, clipBounds: Rectangle, cellsPaintSelectionBackground: bool)
            ...
            clipBounds: A System.Drawing.Rectangle that specifies the area of the System.Windows.Forms.DataGridView to be painted.
            cellsPaintSelectionBackground: true to paint the background of the specified bounds with the color of the System.Windows.Forms.DataGridViewCellStyle.SelectionBackColor property of the System.Windows.Forms.DataGridViewRow.InheritedStyle; 
             false to paint the background of the specified bounds with the color of the System.Windows.Forms.DataGridViewCellStyle.BackColor property of the System.Windows.Forms.DataGridViewRow.InheritedStyle.
        """
        pass
    ...
    def PaintHeader(self, *__args):
        ...
        PaintHeader(self: DataGridViewRowPrePaintEventArgs, paintSelectionBackground: bool)
            ...
            paintSelectionBackground: true to paint the row header with the color of the System.Windows.Forms.DataGridViewCellStyle.SelectionBackColor property of the System.Windows.Forms.DataGridViewRow.InheritedStyle; false to paint the row 
             header with the System.Windows.Forms.DataGridViewCellStyle.BackColor of the System.Windows.Forms.DataGridView.RowHeadersDefaultCellStyle property.
        """
        pass
...
"""
    ...
    InheritedRowStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsFirstDisplayedRow = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsLastVisibleRow = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    PaintParts = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowBounds = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
