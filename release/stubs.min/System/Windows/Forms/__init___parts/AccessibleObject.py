class AccessibleObject(StandardOleMarshalObject,IMarshal,IReflect,IAccessible,IAccessibleEx,IServiceProvider,IRawElementProviderSimple,IValueProvider,IExpandCollapseProvider,IToggleProvider,ITableProvider,ITableItemProvider,IGridProvider,IGridItemProvider,IEnumVariant,IOleWindow):
 """
 ...
 def GetChild(self,index):
  ...
  GetChild(self: AccessibleObject,index: int) -> AccessibleObject
   ...
   Returns: An System.Windows.Forms.AccessibleObject that represents the accessible child corresponding to the specified index.
  """
  pass
 ...
 def GetFocused(self):
  ...
  GetFocused(self: AccessibleObject) -> AccessibleObject
   ...
   Returns: An System.Windows.Forms.AccessibleObject that specifies the currently focused child. This method returns the calling object if the object itself is focused. Returns null if no object has focus.
  """
  pass
 def GetHelpTopic(self,fileName):
  ...
  GetHelpTopic(self: AccessibleObject) -> (int,str)
   ...
   Returns: An identifier for a Help topic,or -1 if there is no Help topic. On return,the fileName parameter contains the path to the Help file associated with this accessible object.
  """
  pass
 def GetSelected(self):
  ...
  GetSelected(self: AccessibleObject) -> AccessibleObject
   ...
   Returns: An System.Windows.Forms.AccessibleObject that represents the currently selected child. This method returns the calling object if the object itself is selected. Returns null if is no child is currently selected and the object itself does not have focus.
  """
  pass
 def HitTest(self,x,y):
  ...
  HitTest(self: AccessibleObject,x: int,y: int) -> AccessibleObject
   ...
   Returns: An System.Windows.Forms.AccessibleObject that represents the child object at the given screen coordinates. This method returns the calling object if the object itself is at the location specified. Returns null if no object is at the tested location.
  """
  pass
 ...
 def Navigate(self,navdir):
  ...
  Navigate(self: AccessibleObject,navdir: AccessibleNavigation) -> AccessibleObject
   ...
   Returns: An System.Windows.Forms.AccessibleObject that represents one of the System.Windows.Forms.AccessibleNavigation values.
  """
  pass
