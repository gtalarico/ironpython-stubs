class RadioButton(ToggleButton,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ICommandSource):
 ...
 def OnAccessKey(self,*args):
  ...
  OnAccessKey(self: RadioButton,e: AccessKeyEventArgs)
   Called when the System.Windows.Controls.AccessText.AccessKey for a radio button 
    is invoked.
 ...
 def OnChecked(self,*args):
  ...
  OnChecked(self: RadioButton,e: RoutedEventArgs)
   Called when the System.Windows.Controls.Primitives.ToggleButton.IsChecked 
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: RadioButton) -> AutomationPeer
   ...
   Provides an appropriate 
    System.Windows.Automation.Peers.RadioButtonAutomationPeer implementation for 
 ...
 def OnToggle(self,*args):
  ...
  OnToggle(self: RadioButton)
   Called by the System.Windows.Controls.Primitives.ToggleButton.OnClick method to 
    implement a System.Windows.Controls.RadioButton control's toggle behavior.
  """
  pass
