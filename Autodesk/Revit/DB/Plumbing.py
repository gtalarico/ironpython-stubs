...
class FluidTemperatureSetIterator(object):
...
class PipeFittingAndAccessoryConnectorData(object):
...
class PipeFittingAndAccessoryData(object):
    """ The input data used by external servers for calculation of the pipe fitting and pipe accessory coefficient. """
    def Dispose(self):
...
class PipeFittingAndAccessoryPressureDropData(object):
...
class PipeFittingAndAccessoryPressureDropItem(object):
...
class PipeFlowConfigurationType(Enum):
    """
...
class PipePlumbingFixtureFlowData(object):
...
class PipePressureDropData(object):
