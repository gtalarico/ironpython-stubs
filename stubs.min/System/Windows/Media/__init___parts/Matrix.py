class Matrix(object,IFormattable):
 ...
 def Append(self,matrix):
  ...
  Append(self: Matrix,matrix: Matrix)
   Appends the specified System.Windows.Media.Matrix structure to this 
    System.Windows.Media.Matrix structure.
  
  
   matrix: The System.Windows.Media.Matrix structure to append to this 
    System.Windows.Media.Matrix structure.
  """
  pass
 @staticmethod
 def Equals(*__args):
  ...
  Equals(self: Matrix,o: object) -> bool
   ...
   Returns: true if o is a System.Windows.Media.Matrix structure that is identical to this 
 ...
 def Multiply(trans1,trans2):
  ...
  Multiply(trans1: Matrix,trans2: Matrix) -> Matrix
   ...
   Multiplies a System.Windows.Media.Matrix structure by another 
    System.Windows.Media.Matrix structure.
 ...
 def Parse(source):
  ...
  Parse(source: str) -> Matrix
   ...
   Converts a System.String representation of a matrix into the equivalent 
    System.Windows.Media.Matrix structure.
 ...
 def Prepend(self,matrix):
  ...
  Prepend(self: Matrix,matrix: Matrix)
   Prepends the specified System.Windows.Media.Matrix structure onto this 
    System.Windows.Media.Matrix structure.
  
  
   matrix: The System.Windows.Media.Matrix structure to prepend to this 
    System.Windows.Media.Matrix structure.
  """
  pass
 def Rotate(self,angle):
  ...
  Rotate(self: Matrix,angle: float)
   Applies a rotation of the specified angle about the origin of this 
    System.Windows.Media.Matrix structure.
 ...
 def Scale(self,scaleX,scaleY):
  ...
  Scale(self: Matrix,scaleX: float,scaleY: float)
   Appends the specified scale vector to this System.Windows.Media.Matrix 
    structure.
 ...
 def ScalePrepend(self,scaleX,scaleY):
  ...
  ScalePrepend(self: Matrix,scaleX: float,scaleY: float)
   Prepends the specified scale vector to this System.Windows.Media.Matrix 
    structure.
  
  
   scaleX: The value by which to scale this System.Windows.Media.Matrix structure along 
    the x-axis.
  
   scaleY: The value by which to scale this System.Windows.Media.Matrix structure along 
    the y-axis.
  """
  pass
 ...
 def ToString(self,provider=None):
  ...
  ToString(self: Matrix,provider: IFormatProvider) -> str
   ...
   Returns: A System.String containing the System.Windows.Media.Matrix.M11,
    System.Windows.Media.Matrix.M12,System.Windows.Media.Matrix.M21,
    System.Windows.Media.Matrix.M22,System.Windows.Media.Matrix.OffsetX,and 
 ...
 def Transform(self,*__args):
  ...
  Transform(self: Matrix,vectors: Array[Vector])
   ...
   vectors: The vectors to transform. The original vectors in the array are replaced by 
  ...
  Transform(self: Matrix,points: Array[Point])
   ...
   points: The points to transform. The original points in the array are replaced by their 
    transformed values.
  """
  pass
 def Translate(self,offsetX,offsetY):
  ...
  Translate(self: Matrix,offsetX: float,offsetY: float)
   Appends a translation of the specified offsets to this 
    System.Windows.Media.Matrix structure.
...
"""
 ...
 HasInverse=property(lambda self: object(),lambda self,v: None,lambda self: None)
