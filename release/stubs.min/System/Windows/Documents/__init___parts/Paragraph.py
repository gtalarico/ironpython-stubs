class Paragraph(Block,IInputElement,IAnimatable,IFrameworkInputElement,ISupportInitialize,IQueryAmbient,IAddChild):
 ...
 def ShouldSerializeInlines(self,manager):
  ...
  ShouldSerializeInlines(self: Paragraph,manager: XamlDesignerSerializationManager) -> bool
   ...
   Indicates whether the System.Windows.Documents.Paragraph.Inlines property 
    should be persisted.
...
"""
 ...
 KeepTogether=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 KeepWithNext=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MinOrphanLines=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MinWidowLines=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 TextIndent=property(lambda self: object(),lambda self,v: None,lambda self: None)
