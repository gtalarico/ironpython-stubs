class TreeViewItem(HeaderedItemsControl, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IGeneratorHost, IContainItemStorage, IHierarchicalVirtualizationAndScrollInfo):
    ...
    def ExpandSubtree(self):
        ...
        ExpandSubtree(self: TreeViewItem)
            Expands the System.Windows.Controls.TreeViewItem control and all its child System.Windows.Controls.TreeViewItem elements.
        """
        pass
    ...
    def OnCollapsed(self, *args): #cannot find CLR method
        """
        OnCollapsed(self: TreeViewItem, e: RoutedEventArgs)
            Raises a System.Windows.Controls.TreeViewItem.Collapsed event when the System.Windows.Controls.TreeViewItem.IsExpanded property changes from true to false.
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: TreeViewItem) -> AutomationPeer
            ...
            Defines an System.Windows.Automation.Peers.AutomationPeer for the System.Windows.Controls.TreeViewItem.
            Returns: A System.Windows.Automation.Peers.TreeViewItemAutomationPeer object for the System.Windows.Controls.TreeViewItem.
        """
        pass
    ...
    def OnExpanded(self, *args): #cannot find CLR method
        """
        OnExpanded(self: TreeViewItem, e: RoutedEventArgs)
            Raises an System.Windows.Controls.TreeViewItem.Expanded event when the System.Windows.Controls.TreeViewItem.IsExpanded property changes from false to true.
    ...
    def OnItemsChanged(self, *args): #cannot find CLR method
        ...
        OnItemsChanged(self: TreeViewItem, e: NotifyCollectionChangedEventArgs)
            Provides class handling for the System.Windows.Controls.ItemContainerGenerator.ItemsChanged event that occurs when there is a change in the System.Windows.Controls.ItemsControl.Items collection.
    ...
    def OnSelected(self, *args): #cannot find CLR method
        ...
        OnSelected(self: TreeViewItem, e: RoutedEventArgs)
            Raises the System.Windows.Controls.TreeViewItem.Selected routed event when the System.Windows.Controls.TreeViewItem.IsSelected property changes from false to true.
    ...
    def OnUnselected(self, *args): #cannot find CLR method
        ...
        OnUnselected(self: TreeViewItem, e: RoutedEventArgs)
            Raises the System.Windows.Controls.TreeViewItem.Unselected routed event when the System.Windows.Controls.TreeViewItem.IsSelected property changes from true to false.
...
"""
    ...
    IsSelected = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
