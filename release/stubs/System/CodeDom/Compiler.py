...
class ICodeGenerator:
    ...
    def GetTypeOutput(self, type):
        ...
        GetTypeOutput(self: ICodeGenerator, type: CodeTypeReference) -> str
            ...
            Returns: A text representation of the specified type for the language this code generator is designed to generate code in. For example, in Visual Basic, passing in type System.Int32 
             will return "Integer".
        """
        pass
...
class CompilerInfo():
    ...
    def GetHashCode(self):
        ...
        GetHashCode(self: CompilerInfo) -> int
            ...
            Returns: A 32-bit signed integer hash code for the current System.CodeDom.Compiler.CompilerInfo instance, suitable for use in hashing algorithms and data structures such as a hash 
             table.
        """
        pass
...
class Executor():
    ...
    def ExecWaitWithCapture(*__args):
        ...
        ExecWaitWithCapture(cmd: str, currentDir: str, tempFiles: TempFileCollection, outputName: str, errorName: str) -> (int, str, str)
            ...
            Executes the specified command using the specified current directory and temporary files, and waits for the call to return, storing output and error information from the 
        ...
        ExecWaitWithCapture(userToken: IntPtr, cmd: str, tempFiles: TempFileCollection, outputName: str, errorName: str) -> (int, str, str)
            ...
            Executes the specified command using the specified user token and temporary files, and waits for the call to return, storing output and error information from the compiler 
