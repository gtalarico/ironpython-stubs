...
"""
    ...
    ImageLayout = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ValueIsIcon = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
