class Version(object,ICloneable,IComparable,IComparable[Version],IEquatable[Version]):
 ...
 def Clone(self):
  ...
  Clone(self: Version) -> object
   ...
   Returns a new System.Version object whose value is the same as the current 
    System.Version object.
  
   Returns: A new System.Object whose values are a copy of the current System.Version 
    object.
  """
  pass
 def CompareTo(self,*__args):
  ...
  CompareTo(self: Version,value: Version) -> int
   ...
   Compares the current System.Version object to a specified System.Version object 
    and returns an indication of their relative values.
  
  
   value: A System.Version object to compare to the current System.Version object,or 
    null.
   ...
   Returns: A signed integer that indicates the relative values of the two objects,as 
    ...
    System.Version object is a version before value. Zero The current 
    System.Version object is the same version as value. Greater than zero The 
    current System.Version object is a version subsequent to value. -or-value is 
    null.
  
  CompareTo(self: Version,version: object) -> int
  
   Compares the current System.Version object to a specified object and returns an 
   ...
   Returns: A signed integer that indicates the relative values of the two objects,as 
    shown in the following table.Return value Meaning Less than zero The current 
    System.Version object is a version before version. Zero The current 
    System.Version object is the same version as version. Greater than zero The 
    current System.Version object is a version subsequent to version.-or- version 
    is null.
  """
  pass
 def Equals(self,obj):
  ...
  Equals(self: Version,obj: Version) -> bool
   ...
   Returns a value indicating whether the current System.Version object and a 
    specified System.Version object represent the same value.
  
  
   obj: A System.Version object to compare to the current System.Version object,or 
    null.
  
   Returns: true if every component of the current System.Version object matches the 
    corresponding component of the obj parameter; otherwise,false.
  
  Equals(self: Version,obj: object) -> bool
  
   Returns a value indicating whether the current System.Version object is equal 
    to a specified object.
  
  
   obj: An object to compare with the current System.Version object,or null.
   Returns: true if the current System.Version object and obj are both System.Version 
    objects,and every component of the current System.Version object matches the 
    corresponding component of obj; otherwise,false.
  """
  pass
 ...
 def Parse(input):
  ...
  Parse(input: str) -> Version
   ...
   Returns: An object that is equivalent to the version number specified in the input 
    parameter.
  """
  pass
 def ToString(self,fieldCount=None):
  ...
  ToString(self: Version,fieldCount: int) -> str
   ...
   Converts the value of the current System.Version object to its equivalent 
    System.String representation. A specified count indicates the number of 
    components to return.
  
  
   fieldCount: The number of components to return. The fieldCount ranges from 0 to 4.
   Returns: The System.String representation of the values of the major,minor,build,and 
    ...
    are returned.fieldCount Return Value 0 An empty string (""). 1 major 2 
    major.minor 3 major.minor.build 4 major.minor.build.revision For example,if 
    you create System.Version object using the constructor Version(1,3,5),
  ...
  ToString(self: Version) -> str
   ...
   Returns: The System.String representation of the values of the major,minor,build,and 
    revision components of the current System.Version object,as depicted in the 
    following format. Each component is separated by a period character ('.'). 
    Square brackets ('[' and ']') indicate a component that will not appear in the 
    return value if the component is not defined: major.minor[.build[.revision]] 
    ...
    object using the constructor Version(1,3,4,2),the returned string is 
    "1.3.4.2".
  """
  pass
 @staticmethod
 def TryParse(input,result):
  ...
  TryParse(input: str) -> (bool,Version)
   ...
   Tries to convert the string representation of a version number to an equivalent 
    System.Version object,and returns a value that indicates whether the 
