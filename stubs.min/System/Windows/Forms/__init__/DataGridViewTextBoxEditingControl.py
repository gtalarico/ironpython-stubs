class DataGridViewTextBoxEditingControl(TextBox, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent, IDataGridViewEditingControl):
    ...
    def GetEditingControlFormattedValue(self, context):
        ...
        GetEditingControlFormattedValue(self: DataGridViewTextBoxEditingControl, context: DataGridViewDataErrorContexts) -> object
            ...
            context: One of the System.Windows.Forms.DataGridViewDataErrorContexts values that specifies the data error context.
    ...
    def OnTextChanged(self, *args): #cannot find CLR method
        ...
        OnTextChanged(self: DataGridViewTextBoxEditingControl, e: EventArgs)
            Raises the System.Windows.Forms.Control.TextChanged event and notifies the System.Windows.Forms.DataGridView of the text change.
...
"""
    ...
    EditingControlDataGridView = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    EditingControlFormattedValue = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    EditingControlRowIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    EditingControlValueChanged = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    EditingPanelCursor = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RepositionEditingControlOnValueChange = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
