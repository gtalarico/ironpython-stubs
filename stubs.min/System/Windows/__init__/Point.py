class Point(object, IFormattable):
    ...
    def Add(point, vector):
        ...
        Add(point: Point, vector: Vector) -> Point
            ...
            Adds a System.Windows.Vector to a System.Windows.Point and returns the result as a System.Windows.Point structure.
    ...
    def Equals(*__args):
        ...
        Equals(self: Point, value: Point) -> bool
            ...
            Returns: true if both System.Windows.Point structures contain the same System.Windows.Point.X and System.Windows.Point.Y values; otherwise, false.
        Equals(self: Point, o: object) -> bool
        
            Determines whether the specified System.Object is a System.Windows.Point and whether it contains the same coordinates as this System.Windows.Point.
        
            o: The System.Object to compare.
            Returns: true if o is a System.Windows.Point and contains the same System.Windows.Point.X and System.Windows.Point.Y values as this System.Windows.Point; otherwise, false.
        Equals(point1: Point, point2: Point) -> bool
            ...
            Returns: true if point1 and point2 contain the same System.Windows.Point.X and System.Windows.Point.Y values; otherwise, false.
        """
        pass
    ...
    def Multiply(point, matrix):
        ...
        Multiply(point: Point, matrix: Matrix) -> Point
            ...
            Transforms the specified System.Windows.Point structure by the specified System.Windows.Media.Matrix structure.
    ...
    def Offset(self, offsetX, offsetY):
        ...
        Offset(self: Point, offsetX: float, offsetY: float)
            Offsets a point's System.Windows.Point.X and System.Windows.Point.Y coordinates by the specified amounts.
    ...
    def Subtract(*__args):
        ...
        Subtract(point1: Point, point2: Point) -> Vector
            ...
            Subtracts the specified System.Windows.Point from another specified System.Windows.Point and returns the difference as a System.Windows.Vector.
        ...
        Subtract(point: Point, vector: Vector) -> Point
            ...
            Subtracts the specified System.Windows.Vector from the specified System.Windows.Point and returns the resulting System.Windows.Point.
    ...
    def ToString(self, provider=None):
        ...
        ToString(self: Point, provider: IFormatProvider) -> str
            ...
            Returns: A System.String containing the System.Windows.Point.X and System.Windows.Point.Y values of this System.Windows.Point structure.
