class Bold(Span,IInputElement,IAnimatable,IFrameworkInputElement,ISupportInitialize,IQueryAmbient,IAddChild):
 """
 An inline-level flow content element which causes content to render with a bold font weight.
 
 Bold()
 Bold(childInline: Inline)
 Bold(childInline: Inline,insertionPosition: TextPointer)
 Bold(start: TextPointer,end: TextPointer)
 """
