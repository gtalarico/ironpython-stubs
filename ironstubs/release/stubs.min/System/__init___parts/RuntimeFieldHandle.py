class RuntimeFieldHandle(object,ISerializable):
 ...
 def Equals(self,*__args):
  ...
  Equals(self: RuntimeFieldHandle,handle: RuntimeFieldHandle) -> bool
   ...
   Returns: true if the value of handle is equal to the value of the current instance; 
    otherwise,false.
  ...
  Equals(self: RuntimeFieldHandle,obj: object) -> bool
   ...
   Returns: true if obj is a System.RuntimeFieldHandle and equal to the value of the 
 ...
 def GetObjectData(self,info,context):
  ...
  GetObjectData(self: RuntimeFieldHandle,info: SerializationInfo,context: StreamingContext)
   Populates a System.Runtime.Serialization.SerializationInfo with the data 
    necessary to deserialize the field represented by the current instance.
  
  
   info: The System.Runtime.Serialization.SerializationInfo object to populate with 
