class TableColumn(FrameworkContentElement, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IIndexedChild[Table]):
    """
    A flow content element that defines a column within a System.Windows.Documents.Table.
    ...
    """Gets or sets the background System.Windows.Media.Brush used to fill the content of the System.Windows.Documents.TableColumn.

Get: Background(self: TableColumn) -> Brush

Set: Background(self: TableColumn) = value
"""
...
"""
    ...
    """Gets or sets the width of a System.Windows.Documents.TableColumn element. The System.Windows.Documents.TableColumn.Width property measures the sum of the System.Windows.Documents.TableColumn content, padding, and border from side to side.

Get: Width(self: TableColumn) -> GridLength

Set: Width(self: TableColumn) = value
"""
