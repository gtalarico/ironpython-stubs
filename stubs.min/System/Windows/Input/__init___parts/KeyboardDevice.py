class KeyboardDevice(InputDevice):
 ...
 def GetKeyStates(self,key):
  ...
  """
  pass
 def GetKeyStatesFromSystem(self,*args):
  """
...
"""
 ...
 DefaultRestoreFocusMode=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 FocusedElement=property(lambda self: object(),lambda self,v: None,lambda self: None)
