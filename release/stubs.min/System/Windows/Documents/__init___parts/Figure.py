class Figure(AnchoredBlock,IInputElement,IAnimatable,IFrameworkInputElement,ISupportInitialize,IQueryAmbient,IAddChild):
 """
 An inline-level flow content element used to host a figure.  A figure is a portion of flow content with placement properties that can be customized independently from the primary content flow within a System.Windows.Documents.FlowDocument.
 
 Figure()
 Figure(childBlock: Block)
 Figure(childBlock: Block,insertionPosition: TextPointer)
 """
 ...
 def __init__(self,*args):
  ...
  pass
 @staticmethod
 def __new__(self,childBlock=None,insertionPosition=None):
  """
  __new__(cls: type)
  __new__(cls: type,childBlock: Block)
  __new__(cls: type,childBlock: Block,insertionPosition: TextPointer)
  """
  pass
 CanDelayPlacement=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether this figure can delay its placement in the flow of content.

Get: CanDelayPlacement(self: Figure) -> bool

Set: CanDelayPlacement(self: Figure)=value
"""
...
"""
 ...
 """Gets or sets a value that indicates the height of a System.Windows.Documents.Figure element.

Get: Height(self: Figure) -> FigureLength

Set: Height(self: Figure)=value
"""

 HorizontalAnchor=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates the position that content is anchored to in the horizontal direction.

Get: HorizontalAnchor(self: Figure) -> FigureHorizontalAnchor

Set: HorizontalAnchor(self: Figure)=value
"""

 HorizontalOffset=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates the distance that a System.Windows.Documents.Figure is offset from its baseline in the horizontal direction.

Get: HorizontalOffset(self: Figure) -> float

Set: HorizontalOffset(self: Figure)=value
"""
...
"""
 ...
 VerticalAnchor=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates the position that content is anchored to in the vertical direction.

Get: VerticalAnchor(self: Figure) -> FigureVerticalAnchor

Set: VerticalAnchor(self: Figure)=value
"""

 VerticalOffset=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates the distance that a System.Windows.Documents.Figure is offset from its baseline in the vertical direction.

Get: VerticalOffset(self: Figure) -> float

Set: VerticalOffset(self: Figure)=value
"""

 Width=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates the width of a System.Windows.Documents.Figure element.

Get: Width(self: Figure) -> FigureLength

Set: Width(self: Figure)=value
"""

 WrapDirection=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates the allowable ways in which content can flow around a System.Windows.Documents.Figure.

Get: WrapDirection(self: Figure) -> WrapDirection

Set: WrapDirection(self: Figure)=value
"""


 CanDelayPlacementProperty=None
 HeightProperty=None
 HorizontalAnchorProperty=None
 HorizontalOffsetProperty=None
 VerticalAnchorProperty=None
 VerticalOffsetProperty=None
 WidthProperty=None
 WrapDirectionProperty=None
