class Panel(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def GetZIndex(element):
  ...
  GetZIndex(element: UIElement) -> int
   ...
   Gets the value of the System.Windows.Controls.Panel.ZIndex property for a given 
    element.
  
  
   element: The element for which to retrieve the System.Windows.Controls.Panel.ZIndex 
    value.
 ...
 def SetZIndex(element,value):
  ...
  SetZIndex(element: UIElement,value: int)
   Sets the value of the System.Windows.Controls.Panel.ZIndex�attached property 
    for a given element.
 ...
 def ShouldSerializeChildren(self):
  ...
  ShouldSerializeChildren(self: Panel) -> bool
   ...
   Determines whether the System.Windows.Controls.Panel.Children collection of a 
    panel should be serialized.
  
   Returns: true if the System.Windows.Controls.Panel.Children collection should be 
    serialized; otherwise,false. The System.Windows.Controls.Panel.Children 
    collection is only serialized if it is not empty and not null.
  """
  pass
