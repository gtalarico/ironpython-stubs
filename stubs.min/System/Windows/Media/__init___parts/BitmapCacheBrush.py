class BitmapCacheBrush(Brush,ISealable,IAnimatable,IResource,IFormattable,ICyclicBrush):
 ...
 def Clone(self):
  ...
  Clone(self: BitmapCacheBrush) -> BitmapCacheBrush
   ...
   Creates a modifiable clone of the System.Windows.Media.BitmapCacheBrush,making 
    deep copies of the object's values. When copying the object's dependency 
    properties,this method copies expressions (which might no longer resolve) but 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: BitmapCacheBrush) -> BitmapCacheBrush
   ...
   Creates a modifiable clone (deep copy) of the 
    System.Windows.Media.BitmapCacheBrush using its current values.
 ...
 def __str__(self,*args):
  pass
 AutoLayoutContent=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 BitmapCache=property(lambda self: object(),lambda self,v: None,lambda self: None)
