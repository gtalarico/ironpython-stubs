class DoubleCollection(Freezable,ISealable,IFormattable,IList,ICollection,IEnumerable,IList[float],ICollection[float],IEnumerable[float]):
 ...
 def Clone(self):
  ...
  Clone(self: DoubleCollection) -> DoubleCollection
   ...
   Creates a modifiable clone of this System.Windows.Media.DoubleCollection,
 ...
 def Contains(self,value):
  ...
  Contains(self: DoubleCollection,value: float) -> bool
   ...
   Determines whether a System.Double is in this 
    System.Windows.Media.DoubleCollection.
  
  
   value: The item to locate in this collection.
   Returns: true if value,the specified System.Double,is in this 
    System.Windows.Media.DoubleCollection; otherwise,false.
  """
  pass
 def CopyTo(self,array,index):
  """
  CopyTo(self: DoubleCollection,array: Array[float],index: int)
   Copies the items of this System.Windows.Media.DoubleCollection,starting with 
    the specified index,into an array of  System.Double values.
 ...
 def GetEnumerator(self):
  ...
  GetEnumerator(self: DoubleCollection) -> Enumerator
   ...
   Returns: An System.Windows.Media.DoubleCollection.Enumerator that can iterate through 
    the collection.
  """
  pass
 def IndexOf(self,value):
  ...
  IndexOf(self: DoubleCollection,value: float) -> int
   ...
   Returns: The index of value if found in the System.Windows.Media.DoubleCollection; 
    otherwise,-1.
  """
  pass
 def Insert(self,index,value):
  ...
  Insert(self: DoubleCollection,index: int,value: float)
   Inserts a System.Double into this System.Windows.Media.DoubleCollection at the 
    specified index.
 ...
 def Parse(source):
  ...
  Parse(source: str) -> DoubleCollection
   ...
   Converts a System.String representation of a collection of doubles into an 
    equivalent System.Windows.Media.DoubleCollection.
 ...
 def Remove(self,value):
  ...
  Remove(self: DoubleCollection,value: float) -> bool
   ...
   Removes the first occurrence of the specified System.Double from this 
    System.Windows.Media.DoubleCollection.
  
  
   value: The item to remove from this collection.
   Returns: true if value was removed from the System.Windows.Media.DoubleCollection; 
    otherwise,false.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: DoubleCollection,index: int)
   Removes the System.Double at the specified index from this 
    System.Windows.Media.DoubleCollection.
