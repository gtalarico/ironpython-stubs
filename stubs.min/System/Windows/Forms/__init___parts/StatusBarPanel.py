class StatusBarPanel(Component,IComponent,IDisposable,ISupportInitialize):
 ...
 def Dispose(self):
  ...
  Dispose(self: StatusBarPanel,disposing: bool)
   Releases the unmanaged resources used by the 
    System.Windows.Forms.StatusBarPanel and optionally releases the managed 
    resources.
 ...
 def ToString(self):
  ...
  ToString(self: StatusBarPanel) -> str
   ...
   Returns: Returns a string that contains the class name for the control and the text it 
    contains.
  """
  pass
