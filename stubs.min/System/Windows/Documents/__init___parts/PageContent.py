class PageContent(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChildInternal, IAddChild, IUriContext):
    """
    Provides information about the System.Windows.Documents.FixedPage elements within a System.Windows.Documents.FixedDocument.
    ...
    def GetPageRoot(self, forceReload):
        """
        GetPageRoot(self: PageContent, forceReload: bool) -> FixedPage
        
            Loads and returns the System.Windows.Documents.FixedPage content element.
        
            forceReload: true to always reload the System.Windows.Documents.FixedPage even if it has been previously loaded and cached; false to load the System.Windows.Documents.FixedPage only if there is no cached version.
            Returns: The root element of the visual tree for this page.
        """
        pass

    def GetPageRootAsync(self, forceReload):
        """
        GetPageRootAsync(self: PageContent, forceReload: bool)
            Asynchronously loads and returns the System.Windows.Documents.FixedPage content element.
        
            forceReload: true to always reload the System.Windows.Documents.FixedPage even if it has been previously loaded and cached; false to load the System.Windows.Documents.FixedPage only if there is no cached version.
        """
        pass

    def GetPageRootAsyncCancel(self):
        """
        GetPageRootAsyncCancel(self: PageContent)
            Cancels any current System.Windows.Documents.PageContent.GetPageRootAsync(System.Boolean) operation in progress.
        """
        pass
    ...
    def ShouldSerializeChild(self, manager):
        """
        ShouldSerializeChild(self: PageContent, manager: XamlDesignerSerializationManager) -> bool
        
            Gets a value indicating whether the value of the System.Windows.Documents.PageContent.Child property should be serialized when this System.Windows.Documents.PageContent is serialized.
        
            manager: The serialization services provider.
            Returns: true if manager is not null and it does not have an XmlWriter; otherwise, false. The default is false.
        """
        pass
    ...
    """Gets or sets the System.Windows.Documents.FixedPage associated with this System.Windows.Documents.PageContent.

Get: Child(self: PageContent) -> FixedPage

Set: Child(self: PageContent) = value
"""
...
"""
    ...
    LinkTargets = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a collection of System.Windows.Documents.LinkTarget elements that identify the hyperlink-addressable locations on the page.

Get: LinkTargets(self: PageContent) -> LinkTargetCollection
...
"""
    ...
    """Gets or sets the uniform resource identifier (URI) to the System.Windows.Documents.FixedPage content data stream.

Get: Source(self: PageContent) -> Uri

Set: Source(self: PageContent) = value
"""
