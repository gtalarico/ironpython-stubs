class ListBox(ListControl, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent):
    ...
    def IsInputKey(self, *args): #cannot find CLR method
        ...
        IsInputKey(self: ListControl, keyData: Keys) -> bool
            ...
            Returns: true if the keyData parameter specifies the System.Windows.Forms.Keys.End, System.Windows.Forms.Keys.Home, System.Windows.Forms.Keys.PageUp, or System.Windows.Forms.Keys.PageDown key; false if the keyData 
             parameter specifies System.Windows.Forms.Keys.Alt.
        """
        pass
...
"""
    ...
    CustomTabOffsets = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MultiColumn = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ScrollAlwaysVisible = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    TopIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    UseCustomTabOffsets = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    UseTabStops = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
