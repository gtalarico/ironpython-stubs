class SingleAnimation(SingleAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: SingleAnimation) -> SingleAnimation
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.SingleAnimation, making deep copies of this object's values. When copying dependency properties, this method copies resource references and 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: SingleAnimation, defaultOriginValue: Single, defaultDestinationValue: Single, animationClock: AnimationClock) -> Single
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.SingleAnimation.
