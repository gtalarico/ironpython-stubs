class LinkLabel:
 ...
 def CreateHandle(self,*args):
  ...
  CreateHandle(self: LinkLabel)
   Creates a handle for this control. This method is called by the .NET Framework,this 
    should not be called. Inheriting classes should always call base.createHandle when 
 ...
 def OnKeyDown(self,*args):
  ...
  OnKeyDown(self: LinkLabel,e: KeyEventArgs)
   Raises the System.Windows.Forms.Control.OnKeyDown(System.Windows.Forms.KeyEventArgs) 
    event.
 ...
 def OnMouseUp(self,*args):
  ...
  OnMouseUp(self: LinkLabel,e: MouseEventArgs)
   Raises the System.Windows.Forms.Control.OnMouseUp(System.Windows.Forms.MouseEventArgs) 
    event.
 ...
 def OnPaint(self,*args):
  ...
  OnPaint(self: LinkLabel,e: PaintEventArgs)
   Raises the System.Windows.Forms.Control.OnPaint(System.Windows.Forms.PaintEventArgs) 
    event.
 ...
 def SetBoundsCore(self,*args):
  ...
  SetBoundsCore(self: LinkLabel,x: int,y: int,width: int,height: int,specified: BoundsSpecified)
   ...
   specified: Which values were specified. This parameter reflects user intent,not which values have 
    changed.
  """
  pass
