class TabItemAutomationPeer(SelectorItemAutomationPeer, IVirtualizedItemProvider, ISelectionItemProvider):
    ...
    def GetAutomationControlTypeCore(self, *args): #cannot find CLR method
        ...
        GetAutomationControlTypeCore(self: TabItemAutomationPeer) -> AutomationControlType
            ...
            Gets the control type for the System.Windows.Controls.TabItem that is associated with this System.Windows.Automation.Peers.TabItemAutomationPeer. Called by 
    ...
    def GetChildrenCore(self, *args): #cannot find CLR method
        ...
        GetChildrenCore(self: TabItemAutomationPeer) -> List[AutomationPeer]
            ...
            Gets the collection of child elements of the System.Windows.Controls.TabItem that is associated with this System.Windows.Automation.Peers.TabItemAutomationPeer. Called by 
    ...
    def GetClassNameCore(self, *args): #cannot find CLR method
        ...
        GetClassNameCore(self: TabItemAutomationPeer) -> str
            ...
            Gets the name of the System.Windows.Controls.TabItem that is associated with this System.Windows.Automation.Peers.TabItemAutomationPeer. Called by 
    ...
    def GetNameCore(self, *args): #cannot find CLR method
        ...
        GetNameCore(self: TabItemAutomationPeer) -> str
            ...
            Gets the text label of the System.Windows.Controls.TabItem that is associated with this System.Windows.Automation.Peers.TabItemAutomationPeer. Called by 
             System.Windows.Automation.Peers.AutomationPeer.GetName.
        
            Returns: The string that contains the label. If set, this method returns the value of the System.Windows.Automation.AutomationProperties.Name property; otherwise this method will return the value of the 
    ...
    def IsContentElementCore(self, *args): #cannot find CLR method
        ...
        IsContentElementCore(self: ItemAutomationPeer) -> bool
            ...
            Gets a value that indicates whether the specified System.Windows.UIElement contains data that is presented to the user.
