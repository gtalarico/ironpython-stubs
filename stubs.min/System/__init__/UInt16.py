class UInt16(object, IComparable, IFormattable, IConvertible, IComparable[UInt16], IEquatable[UInt16]):
    ...
    def TryParse(s, *__args):
        ...
        TryParse(s: str, style: NumberStyles, provider: IFormatProvider) -> (bool, UInt16)
            ...
            Tries to convert the string representation of a number in a specified style and culture-specific format to its 16-bit unsigned integer equivalent. A return value indicates whether the conversion succeeded 
             or failed.
