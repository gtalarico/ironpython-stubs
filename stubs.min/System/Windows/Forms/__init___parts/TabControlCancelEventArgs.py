...
"""
    ...
    TabPage = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    TabPageIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
