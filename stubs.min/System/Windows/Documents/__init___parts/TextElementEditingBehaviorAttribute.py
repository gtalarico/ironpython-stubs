class TextElementEditingBehaviorAttribute(Attribute, _Attribute):
    ...
    IsMergeable = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsTypographicOnly = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
