class Window(ContentControl, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IWindowService):
    ...
    def GetWindow(dependencyObject):
        ...
        GetWindow(dependencyObject: DependencyObject) -> Window
            ...
            Returns a reference to the System.Windows.Window object that hosts the content tree within which the dependency object is located.
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: Window) -> AutomationPeer
            ...
            Creates and returns a System.Windows.Automation.Peers.WindowAutomationPeer object for this System.Windows.Window.
            Returns: A System.Windows.Automation.Peers.WindowAutomationPeer object for this System.Windows.Window.
        """
        pass
    ...
    def ShowDialog(self):
        ...
        ShowDialog(self: Window) -> Nullable[bool]
            ...
            Returns: A System.Nullable value of type System.Boolean that specifies whether the activity was accepted (true) or canceled (false). The return value is the value of the System.Windows.Window.DialogResult property 
