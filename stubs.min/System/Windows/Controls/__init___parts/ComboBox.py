class ComboBox(Selector, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IGeneratorHost, IContainItemStorage):
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: ComboBox) -> AutomationPeer
            ...
            Provides an appropriate System.Windows.Automation.Peers.ComboBoxAutomationPeer implementation for this control, as part of the WPF infrastructure.
    ...
    def OnSelectionChanged(self, *args): #cannot find CLR method
        ...
        OnSelectionChanged(self: ComboBox, e: SelectionChangedEventArgs)
            Responds to a System.Windows.Controls.ComboBox selection change by raising a System.Windows.Controls.Primitives.Selector.SelectionChanged event.
...
"""
    ...
    IsDropDownOpen = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsSelectionBoxHighlighted = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MaxDropDownHeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectionBoxItem = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectionBoxItemStringFormat = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectionBoxItemTemplate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ShouldPreserveUserEnteredPrefix = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get: ShouldPreserveUserEnteredPrefix(self: ComboBox) -> bool

Set: ShouldPreserveUserEnteredPrefix(self: ComboBox) = value
"""

    StaysOpenOnEdit = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
