class GridViewColumnCollection(ObservableCollection[GridViewColumn], IList[GridViewColumn], ICollection[GridViewColumn], IEnumerable[GridViewColumn], IEnumerable, IList, ICollection, IReadOnlyList[GridViewColumn], IReadOnlyCollection[GridViewColumn], INotifyCollectionChanged, INotifyPropertyChanged):
    ...
    def ClearItems(self, *args): #cannot find CLR method
        ...
        ClearItems(self: GridViewColumnCollection)
            Removes all of the System.Windows.Controls.GridViewColumn objects from the System.Windows.Controls.GridViewColumnCollection.
        """
        pass
    ...
    def OnCollectionChanged(self, *args): #cannot find CLR method
        ...
        OnCollectionChanged(self: GridViewColumnCollection, e: NotifyCollectionChangedEventArgs)
            Raises the System.Collections.ObjectModel.ObservableCollection event when the System.Windows.Controls.GridViewColumnCollection changes.
    ...
    def RemoveItem(self, *args): #cannot find CLR method
        ...
        RemoveItem(self: GridViewColumnCollection, index: int)
            Removes a System.Windows.Controls.GridViewColumn from the System.Windows.Controls.GridViewColumnCollection at the specified index.
    ...
    def SetItem(self, *args): #cannot find CLR method
        ...
        SetItem(self: GridViewColumnCollection, index: int, column: GridViewColumn)
            Replaces the System.Windows.Controls.GridViewColumn that is at the specified index with another System.Windows.Controls.GridViewColumn.
        
            index: The position at which the new System.Windows.Controls.GridViewColumn replaces the old System.Windows.Controls.GridViewColumn.
