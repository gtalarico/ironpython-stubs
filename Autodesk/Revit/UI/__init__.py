...
class ColorSelectionDialog(object):
    """
...
class DockablePaneState(object):
    """
...
class DoubleClickOptions(object):
...
class EditorInteractionType(Enum):
    """
...
class ExternalEventRequest(Enum):
    """
...
class FaceBasedPlacementType(Enum):
    """
...
class FamilyInstancePlacingArgs(object):
...
class ItemSelectionDialogResult(Enum):
    """
...
class PromptForFamilyInstancePlacementOptions(object):
    """
...
class SelectionUIOptions(object):
...
class SetupEnergySimulationDialog(object):
    """
...
class SetupEnergySimulationDialogResult(Enum):
    """
...
class SketchGalleryOptions(Enum):
    """
...
class TaskDialogCommandLinkId(Enum):
    """
...
class TaskDialogCommonButtons(Enum):
    """
...
class TextEditorOptions(object):
...
"""
    ...
    Idling = None
    TransferredProjectStandards = None
    TransferringProjectStandards = None
    ViewActivated = None
    ViewActivating = None
