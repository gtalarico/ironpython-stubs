class ManipulationInertiaStartingEventArgs(InputEventArgs):
 ...
 def SetInertiaParameter(self,parameter):
  ...
  """
  pass
 ExpansionBehavior=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 InitialVelocities=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 RotationBehavior=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 TranslationBehavior=property(lambda self: object(),lambda self,v: None,lambda self: None)
