class Run(Inline, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild):
    """
    An inline-level flow content element intended to contain a run of formatted or unformatted text.
    
    Run()
    Run(text: str)
    Run(text: str, insertionPosition: TextPointer)
    """
    ...
    def ShouldSerializeText(self, manager):
        """
        ShouldSerializeText(self: Run, manager: XamlDesignerSerializationManager) -> bool
        
            Returns a value that indicates whether or not the effective value of the System.Windows.Documents.Run.Text property should be serialized during serialization of a System.Windows.Documents.Run object.
        
            manager: A serialization service manager object for this object.
            Returns: true if the System.Windows.Documents.Run.Text property should be serialized; otherwise, false.
        """
        pass
    ...
    def __new__(self, text=None, insertionPosition=None):
        """
        __new__(cls: type)
        __new__(cls: type, text: str)
        __new__(cls: type, text: str, insertionPosition: TextPointer)
        """
        pass
...
"""
    ...
    """Gets or sets the unformatted text contents of this text System.Windows.Documents.Run.

Get: Text(self: Run) -> str

Set: Text(self: Run) = value
"""
