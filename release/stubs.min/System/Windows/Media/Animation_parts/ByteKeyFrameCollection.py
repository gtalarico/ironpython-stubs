class ByteKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: ByteKeyFrameCollection,keyFrame: ByteKeyFrame) -> int
   ...
   keyFrame: The System.Windows.Media.Animation.ByteKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: ByteKeyFrameCollection)
   Removes all System.Windows.Media.Animation.ByteKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: ByteKeyFrameCollection) -> ByteKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.ByteKeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: ByteKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.ByteKeyFrameCollection. When copying dependency 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: ByteKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.ByteKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: ByteKeyFrameCollection,array: Array[ByteKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.ByteKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: ByteKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.ByteKeyFrameCollection 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: ByteKeyFrameCollection,sourceFreezable: Freezable)
   ...
   sourceFreezable: The System.Windows.Media.Animation.ByteKeyFrameCollection object to clone and 
    freeze.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: ByteKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.ByteKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: ByteKeyFrameCollection,keyFrame: ByteKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.ByteKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: ByteKeyFrameCollection,index: int,keyFrame: ByteKeyFrame)
   Inserts a System.Windows.Media.Animation.ByteKeyFrame into a specific location 
    within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.ByteKeyFrame is 
    inserted.
  
   keyFrame: The System.Windows.Media.Animation.ByteKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: ByteKeyFrameCollection,keyFrame: ByteKeyFrame)
   Removes a System.Windows.Media.Animation.ByteKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.ByteKeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: ByteKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.ByteKeyFrame at the specified index 
