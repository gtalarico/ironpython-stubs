class Type(MemberInfo,ICustomAttributeProvider,_MemberInfo,_Type,IReflect):
 ...
 def Equals(self,o):
  ...
  Equals(self: Type,o: Type) -> bool
   ...
   o: The object whose underlying system type is to be compared with the underlying 
 ...
 def FindInterfaces(self,filter,filterCriteria):
  ...
  FindInterfaces(self: Type,filter: TypeFilter,filterCriteria: object) -> Array[Type]
   ...
   Returns an array of System.Type objects representing a filtered list of 
    interfaces implemented or inherited by the current System.Type.
 ...
 def FindMembers(self,memberType,bindingAttr,filter,filterCriteria):
  ...
  FindMembers(self: Type,memberType: MemberTypes,bindingAttr: BindingFlags,filter: MemberFilter,filterCriteria: object) -> Array[MemberInfo]
   ...
   Returns a filtered array of System.Reflection.MemberInfo objects of the 
 ...
 def GetAttributeFlagsImpl(self,*args):
  ...
  GetAttributeFlagsImpl(self: Type) -> TypeAttributes
   ...
   When overridden in a derived class,implements the System.Type.Attributes 
    property and gets a bitmask indicating the attributes associated with the 
    System.Type.
 ...
 def GetConstructor(self,*__args):
  ...
  GetConstructor(self: Type,types: Array[Type]) -> ConstructorInfo
   ...
   Returns: An object representing the public instance constructor whose parameters match 
  ...
  GetConstructor(self: Type,bindingAttr: BindingFlags,binder: Binder,types: Array[Type],modifiers: Array[ParameterModifier]) -> ConstructorInfo
   ...
   binder: An object that defines a set of properties and enables binding,which can 
    involve selection of an overloaded method,coercion of argument types,and 
    invocation of a member through reflection.-or- A null reference (Nothing in 
    Visual Basic),to use the System.Type.DefaultBinder.
  ...
  GetConstructor(self: Type,bindingAttr: BindingFlags,binder: Binder,callConvention: CallingConventions,types: Array[Type],modifiers: Array[ParameterModifier]) -> ConstructorInfo
   ...
   Searches for a constructor whose parameters match the specified argument types 
    and modifiers,using the specified binding constraints and the specified 
    calling convention.
   ...
   callConvention: The object that specifies the set of rules to use regarding the order and 
    layout of arguments,how the return value is passed,what registers are used 
    for arguments,and the stack is cleaned up.
   ...
   Returns: An object representing the constructor that matches the specified requirements,
 ...
 def GetConstructors(self,bindingAttr=None):
  ...
  GetConstructors(self: Type) -> Array[ConstructorInfo]
   ...
   Returns: An array of System.Reflection.ConstructorInfo objects representing all the 
    ...
    System.Type represents a type parameter in the definition of a generic type or 
    generic method,an empty array of type System.Reflection.ConstructorInfo is 
    returned.
 ...
 def GetElementType(self):
  ...
  GetElementType(self: Type) -> Type
   ...
   When overridden in a derived class,returns the System.Type of the object 
 ...
 def GetEnumName(self,value):
  ...
  GetEnumName(self: Type,value: object) -> str
   ...
   Returns: The name of the member of the current enumeration type that has the specified 
 ...
 def GetEnumValues(self):
  ...
  GetEnumValues(self: Type) -> Array
   ...
   Returns: An array that contains the values. The elements of the array are sorted by the 
 ...
 def GetEvent(self,name,bindingAttr=None):
  ...
  GetEvent(self: Type,name: str,bindingAttr: BindingFlags) -> EventInfo
   ...
   When overridden in a derived class,returns the System.Reflection.EventInfo 
    object representing the specified event,using the specified binding 
    constraints.
  
  
   name: The string containing the name of an event which is declared or inherited by 
    the current System.Type.
  
   bindingAttr: A bitmask comprised of one or more System.Reflection.BindingFlags that specify 
    how the search is conducted.-or- Zero,to return null.
  
   Returns: The object representing the specified event that is declared or inherited by 
  ...
  GetEvent(self: Type,name: str) -> EventInfo
   ...
   name: The string containing the name of an event that is declared or inherited by the 
    current System.Type.
  
   Returns: The object representing the specified public event that is declared or 
 ...
 def GetEvents(self,bindingAttr=None):
  ...
  GetEvents(self: Type) -> Array[EventInfo]
   ...
   Returns: An array of System.Reflection.EventInfo objects representing all the public 
    events which are declared or inherited by the current System.Type.-or- An empty 
 ...
 def GetField(self,name,bindingAttr=None):
  ...
  GetField(self: Type,name: str) -> FieldInfo
   ...
   Returns: An object representing the public field with the specified name,if found; 
    otherwise,null.
  ...
  GetField(self: Type,name: str,bindingAttr: BindingFlags) -> FieldInfo
   ...
   Returns: An object representing the field that matches the specified requirements,if 
 ...
 def GetGenericArguments(self):
  ...
  GetGenericArguments(self: Type) -> Array[Type]
   ...
   Returns an array of System.Type objects that represent the type arguments of a 
 ...
 def GetGenericTypeDefinition(self):
  ...
  GetGenericTypeDefinition(self: Type) -> Type
   ...
   Returns a System.Type object that represents a generic type definition from 
    which the current generic type can be constructed.
  
   Returns: A System.Type object representing a generic type from which the current type 
    can be constructed.
  """
  pass
 ...
 def GetInterface(self,name,ignoreCase=None):
  ...
  GetInterface(self: Type,name: str,ignoreCase: bool) -> Type
   ...
   When overridden in a derived class,searches for the specified interface,
    specifying whether to do a case-insensitive search for the interface name.
  
  
   name: The string containing the name of the interface to get. For generic interfaces,
    this is the mangled name.
  
   ignoreCase: true to ignore the case of that part of name that specifies the simple 
    interface name (the part that specifies the namespace must be correctly 
    cased).-or- false to perform a case-sensitive search for all parts of name.
  
   Returns: An object representing the interface with the specified name,implemented or 
    inherited by the current System.Type,if found; otherwise,null.
 ...
 def GetMember(self,name,*__args):
  ...
  GetMember(self: Type,name: str,type: MemberTypes,bindingAttr: BindingFlags) -> Array[MemberInfo]
   ...
   Searches for the specified members of the specified member type,using the 
 ...
 def GetMethod(self,name,*__args):
  ...
  GetMethod(self: Type,name: str,types: Array[Type]) -> MethodInfo
   ...
   types: An array of System.Type objects representing the number,order,and type of the 
    ...
    provided by the System.Type.EmptyTypes field) to get a method that takes no 
    parameters.
  
   Returns: An object representing the public method whose parameters match the specified 
  ...
  GetMethod(self: Type,name: str,bindingAttr: BindingFlags) -> MethodInfo
   ...
   Returns: An object representing the method that matches the specified requirements,if 
    found; otherwise,null.
  ...
  GetMethod(self: Type,name: str) -> MethodInfo
   ...
   name: The string containing the name of the public method to get.
   Returns: An object that represents the public method with the specified name,if found; 
    otherwise,null.
  ...
  GetMethod(self: Type,name: str,bindingAttr: BindingFlags,binder: Binder,callConvention: CallingConventions,types: Array[Type],modifiers: Array[ParameterModifier]) -> MethodInfo
   ...
   callConvention: The object that specifies the set of rules to use regarding the order and 
    layout of arguments,how the return value is passed,what registers are used 
    for arguments,and how the stack is cleaned up.
   ...
   modifiers: An array of System.Reflection.ParameterModifier objects representing the 
    attributes associated with the corresponding element in the types array. To be 
    only used when calling through COM interop,and only parameters that are passed 
  ...
  GetMethod(self: Type,name: str,types: Array[Type],modifiers: Array[ParameterModifier]) -> MethodInfo
   ...
   Returns: An object representing the public method that matches the specified 
 ...
 def GetMethodImpl(self,*args):
  ...
  GetMethodImpl(self: Type,name: str,bindingAttr: BindingFlags,binder: Binder,callConvention: CallingConventions,types: Array[Type],modifiers: Array[ParameterModifier]) -> MethodInfo
   ...
   When overridden in a derived class,searches for the specified method whose 
    parameters match the specified argument types and modifiers,using the 
   ...
   callConvention: The object that specifies the set of rules to use regarding the order and 
    layout of arguments,how the return value is passed,what registers are used 
    for arguments,and what process cleans up the stack.
  
   types: An array of System.Type objects representing the number,order,and type of the 
    parameters for the method to get.-or- An empty array of the type System.Type 
    (that is,Type[] types=new Type[0]) to get a method that takes no 
    parameters.-or- null. If types is null,arguments are not matched.
 ...
 def GetNestedType(self,name,bindingAttr=None):
  ...
  GetNestedType(self: Type,name: str,bindingAttr: BindingFlags) -> Type
   ...
   Returns: An object representing the nested type that matches the specified requirements,
    if found; otherwise,null.
  ...
  GetNestedType(self: Type,name: str) -> Type
   ...
   name: The string containing the name of the nested type to get.
   Returns: An object representing the public nested type with the specified name,if 
    found; otherwise,null.
  """
  pass
 def GetNestedTypes(self,bindingAttr=None):
  ...
  GetNestedTypes(self: Type,bindingAttr: BindingFlags) -> Array[Type]
   ...
   Returns: An array of System.Type objects representing all the types nested in the 
    current System.Type that match the specified binding constraints (the search is 
    not recursive),or an empty array of type System.Type,if no nested types are 
    found that match the binding constraints.
  
  GetNestedTypes(self: Type) -> Array[Type]
  
   Returns the public types nested in the current System.Type.
   Returns: An array of System.Type objects representing the public types nested in the 
 ...
 def GetProperty(self,name,*__args):
  ...
  GetProperty(self: Type,name: str,types: Array[Type]) -> PropertyInfo
   ...
   Returns: An object representing the public property whose parameters match the specified 
    argument types,if found; otherwise,null.
  ...
  GetProperty(self: Type,name: str,returnType: Type) -> PropertyInfo
   ...
   Returns: An object representing the public property with the specified name,if found; 
    otherwise,null.
  ...
  GetProperty(self: Type,name: str,bindingAttr: BindingFlags,binder: Binder,returnType: Type,types: Array[Type],modifiers: Array[ParameterModifier]) -> PropertyInfo
   ...
   Returns: An object representing the property that matches the specified requirements,if 
    found; otherwise,null.
  ...
  GetProperty(self: Type,name: str,returnType: Type,types: Array[Type],modifiers: Array[ParameterModifier]) -> PropertyInfo
   ...
   Returns: An object representing the public property that matches the specified 
    requirements,if found; otherwise,null.
 ...
 def GetPropertyImpl(self,*args):
  ...
  GetPropertyImpl(self: Type,name: str,bindingAttr: BindingFlags,binder: Binder,returnType: Type,types: Array[Type],modifiers: Array[ParameterModifier]) -> PropertyInfo
   ...
   binder: An object that defines a set of properties and enables binding,which can 
    involve selection of an overloaded member,coercion of argument types,and 
    invocation of a member through reflection.-or- A null reference (Nothing in 
    Visual Basic),to use the System.Type.DefaultBinder.
  ...
  pass
 @staticmethod
 def GetType(typeName=None,*__args):
  """
  ...
  GetType(typeName: str,throwOnError: bool,ignoreCase: bool) -> Type
   ...
   typeName: The assembly-qualified name of the type to get. See 
    System.Type.AssemblyQualifiedName. If the type is in the currently executing 
    assembly or in Mscorlib.dll,it is sufficient to supply the type name qualified 
    by its namespace.
  
   throwOnError: true to throw an exception if the type cannot be found; false to return 
    null.Specifying false also suppresses some other exception conditions,but not 
    all of them. See the Exceptions section.
  
   ignoreCase: true to perform a case-insensitive search for typeName,false to perform a 
    case-sensitive search for typeName.
 ...
 def GetTypeArray(args):
  ...
  GetTypeArray(args: Array[object]) -> Array[Type]
   ...
   Returns: An array of System.Type objects representing the types of the corresponding 
    elements in args.
  """
  pass
 @staticmethod
 ...
 def GetTypeFromCLSID(clsid,*__args):
  ...
  GetTypeFromCLSID(clsid: Guid,server: str,throwOnError: bool) -> Type
   ...
   throwOnError: true to throw any exception that occurs.-or- false to ignore any exception that 
    occurs.
  ...
  GetTypeFromCLSID(clsid: Guid,throwOnError: bool) -> Type
   ...
   Gets the type associated with the specified class identifier (CLSID),
    specifying whether to throw an exception if an error occurs while loading the 
    type.
 ...
 def GetTypeFromProgID(progID,*__args):
  ...
  GetTypeFromProgID(progID: str) -> Type
   ...
   progID: The ProgID of the type to get.
   Returns: The type associated with the specified ProgID,if progID is a valid entry in 
 ...
 def HasElementTypeImpl(self,*args):
  ...
  HasElementTypeImpl(self: Type) -> bool
   ...
   When overridden in a derived class,implements the System.Type.HasElementType 
    ...
    to another type; that is,whether the current System.Type is an array,a 
    pointer,or is passed by reference.
  
   Returns: true if the System.Type is an array,a pointer,or is passed by reference; 
    otherwise,false.
  """
  pass
 def InvokeMember(self,name,invokeAttr,binder,target,args,*__args):
  ...
  InvokeMember(self: Type,name: str,invokeAttr: BindingFlags,binder: Binder,target: object,args: Array[object]) -> object
   ...
   name: The string containing the name of the constructor,method,property,or field 
   ...
   invokeAttr: A bitmask comprised of one or more System.Reflection.BindingFlags that specify 
    ...
    BindingFlags.Public | BindingFlags.Instance | BindingFlags.Static are used.
  
   binder: An object that defines a set of properties and enables binding,which can 
    involve selection of an overloaded method,coercion of argument types,and 
    invocation of a member through reflection.-or- A null reference (Nothing in 
    Visual Basic),to use the System.Type.DefaultBinder. Note that explicitly 
  ...
  InvokeMember(self: Type,name: str,invokeAttr: BindingFlags,binder: Binder,target: object,args: Array[object],culture: CultureInfo) -> object
   ...
   Invokes the specified member,using the specified binding constraints and 
    matching the specified argument list and culture.
   ...
   target: The object on which to invoke the specified member.
   args: An array containing the arguments to pass to the member to invoke.
   culture: The object representing the globalization locale to use,which may be necessary 
    for locale-specific conversions,such as converting a numeric System.String to 
    a System.Double.-or- A null reference (Nothing in Visual Basic) to use the 
    current thread's System.Globalization.CultureInfo.
  ...
  InvokeMember(self: Type,name: str,invokeAttr: BindingFlags,binder: Binder,target: object,args: Array[object],modifiers: Array[ParameterModifier],culture: CultureInfo,namedParameters: Array[str]) -> object
   ...
   When overridden in a derived class,invokes the specified member,using the 
    specified binding constraints and matching the specified argument list,
    modifiers and culture.
   ...
   culture: The System.Globalization.CultureInfo object representing the globalization 
    ...
    converting a numeric String to a Double.-or- A null reference (Nothing in 
    Visual Basic) to use the current thread's System.Globalization.CultureInfo.
 ...
 def IsAssignableFrom(self,c):
  ...
  IsAssignableFrom(self: Type,c: Type) -> bool
   ...
   Determines whether an instance of the current System.Type can be assigned from 
    an instance of the specified Type.
  
  
   c: The type to compare with the current type.
   Returns: true if c and the current Type represent the same type,or if the current Type 
    ...
    represents one of the constraints of c. false if none of these conditions are 
    true,or if c is null.
  """
  pass
 ...
 def IsCOMObjectImpl(self,*args):
  ...
  IsCOMObjectImpl(self: Type) -> bool
   ...
   When overridden in a derived class,implements the System.Type.IsCOMObject 
    property and determines whether the System.Type is a COM object.
 ...
 def IsContextfulImpl(self,*args):
  ...
  IsContextfulImpl(self: Type) -> bool
   ...
   Implements the System.Type.IsContextful property and determines whether the 
    System.Type can be hosted in a context.
 ...
 def IsEnumDefined(self,value):
  ...
  IsEnumDefined(self: Type,value: object) -> bool
   ...
   Returns a value that indicates whether the specified value exists in the 
    current enumeration type.
  
  
   value: The value to be tested.
   Returns: true if the specified value is a member of the current enumeration type; 
    otherwise,false.
  """
  pass
 def IsEquivalentTo(self,other):
  ...
  IsEquivalentTo(self: Type,other: Type) -> bool
   ...
   Returns: true if the COM types are equivalent; otherwise,false. This method also 
    returns false if one type is in an assembly that is loaded for execution,and 
    the other is in an assembly that is loaded into the reflection-only context.
  """
  pass
 def IsInstanceOfType(self,o):
  ...
  IsInstanceOfType(self: Type,o: object) -> bool
   ...
   Returns: true if the current Type is in the inheritance hierarchy of the object 
    represented by o,or if the current Type is an interface that o supports. false 
    if neither of these conditions is the case,or if o is null,or if the current 
    Type is an open generic type (that is,System.Type.ContainsGenericParameters 
    returns true).
  """
  pass
 ...
 def IsPointerImpl(self,*args):
  ...
  IsPointerImpl(self: Type) -> bool
   ...
   When overridden in a derived class,implements the System.Type.IsPointer 
 ...
 def IsPrimitiveImpl(self,*args):
  ...
  IsPrimitiveImpl(self: Type) -> bool
   ...
   When overridden in a derived class,implements the System.Type.IsPrimitive 
    property and determines whether the System.Type is one of the primitive types.
 ...
 def IsSubclassOf(self,c):
  ...
  IsSubclassOf(self: Type,c: Type) -> bool
   ...
   Determines whether the class represented by the current System.Type derives 
    from the class represented by the specified System.Type.
   ...
   Returns: true if the Type represented by the c parameter and the current Type represent 
    ...
    represented by c; otherwise,false. This method also returns false if c and the 
 ...
 def IsValueTypeImpl(self,*args):
  ...
  IsValueTypeImpl(self: Type) -> bool
   ...
   Implements the System.Type.IsValueType property and determines whether the 
    System.Type is a value type; that is,not a class or an interface.
 ...
 def MakeArrayType(self,rank=None):
  ...
  MakeArrayType(self: Type,rank: int) -> Type
   ...
   rank: The number of dimensions for the array. This number must be less than or equal 
    to 32.
  
   Returns: An object representing an array of the current type,with the specified number 
    of dimensions.
 ...
 def MakeByRefType(self):
  ...
  MakeByRefType(self: Type) -> Type
   ...
   Returns a System.Type object that represents the current type when passed as a 
 ...
 def MakeGenericType(self,typeArguments):
  ...
  MakeGenericType(self: Type,*typeArguments: Array[Type]) -> Type
   ...
   typeArguments: An array of types to be substituted for the type parameters of the current 
    generic type.
  
   Returns: A System.Type representing the constructed type formed by substituting the 
    elements of typeArguments for the type parameters of the current generic type.
  """
  pass
 ...
 def ReflectionOnlyGetType(typeName,throwIfNotFound,ignoreCase):
  ...
  ReflectionOnlyGetType(typeName: str,throwIfNotFound: bool,ignoreCase: bool) -> Type
   ...
   throwIfNotFound: true to throw a System.TypeLoadException if the type cannot be found; false to 
   ...
   Returns: The type with the specified name,if found; otherwise,null. If the type is not 
