class FixedDocumentSequence(FrameworkContentElement, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IDocumentPaginatorSource, IAddChildInternal, IAddChild, IServiceProvider, IFixedNavigate, IUriContext):
    """
    Hosts one or more System.Windows.Documents.DocumentReference elements that define a sequence of fixed documents.
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        """
        OnCreateAutomationPeer(self: FixedDocumentSequence) -> AutomationPeer
        
            Creates an automation peer for the sequence.
            Returns: A System.Windows.Automation.Peers.DocumentAutomationPeer that exposes the System.Windows.Documents.FixedDocumentSequence to Microsoft UI Automation.
        """
        pass
...
"""
    ...
    """Gets the paginator for the System.Windows.Documents.FixedDocument that provides page-oriented services such as getting a particular page and repaginating in response to changes.

Get: DocumentPaginator(self: FixedDocumentSequence) -> DocumentPaginator
...
"""
    ...
    """Gets an enumerator for accessing the document sequence's System.Windows.Documents.DocumentReference�child elements.

"""

    PrintTicket = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the System.Printing.PrintTicket that is associated with this document sequence.

Get: PrintTicket(self: FixedDocumentSequence) -> object

Set: PrintTicket(self: FixedDocumentSequence) = value
"""

    References = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a collection of the document sequence's System.Windows.Documents.DocumentReference�child elements.

Get: References(self: FixedDocumentSequence) -> DocumentReferenceCollection
