class FontFamilyMapCollection(object,IList[FontFamilyMap],ICollection[FontFamilyMap],IEnumerable[FontFamilyMap],IEnumerable,IList,ICollection):
 ...
 def Add(self,item):
  ...
  Add(self: FontFamilyMapCollection,item: FontFamilyMap)
   Inserts the specified System.Windows.Media.FontFamilyMap object into the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: FontFamilyMapCollection)
   Removes all System.Windows.Media.FontFamilyMap objects from the 
 ...
 def Contains(self,item):
  ...
  Contains(self: FontFamilyMapCollection,item: FontFamilyMap) -> bool
   ...
   Indicates whether the System.Windows.Media.FontFamilyMapCollection contains the 
    specified System.Windows.Media.FontFamilyMap object.
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: FontFamilyMapCollection,array: Array[FontFamilyMap],index: int)
   Copies the System.Windows.Media.FontFamilyMap objects in the collection into an 
    array of FontFamilyMaps,starting at the specified index position.
 ...
 def IndexOf(self,item):
  ...
  IndexOf(self: FontFamilyMapCollection,item: FontFamilyMap) -> int
   ...
   Returns the index of the specified System.Windows.Media.FontFamilyMap object 
 ...
 def Insert(self,index,item):
  ...
  Insert(self: FontFamilyMapCollection,index: int,item: FontFamilyMap)
   Inserts the specified System.Windows.Media.FontFamilyMap object at the 
 ...
 def Remove(self,item):
  ...
  Remove(self: FontFamilyMapCollection,item: FontFamilyMap) -> bool
   ...
   Removes the specified System.Windows.Media.FontFamilyMap object from the 
    collection.
 ...
 def RemoveAt(self,index):
  ...
  RemoveAt(self: FontFamilyMapCollection,index: int)
   Deletes a System.Windows.Media.FontFamilyMap object from the 
    System.Windows.Media.FontFamilyMapCollection.
