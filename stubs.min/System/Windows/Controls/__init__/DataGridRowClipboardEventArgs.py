class DataGridRowClipboardEventArgs(EventArgs):
    ...
    def FormatClipboardCellValues(self, format):
        ...
        FormatClipboardCellValues(self: DataGridRowClipboardEventArgs, format: str) -> str
            ...
            Returns the System.Windows.Controls.DataGridRowClipboardEventArgs.ClipboardRowContent values as a string in the specified format.
    ...
    ClipboardRowContent = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    EndColumnDisplayIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsColumnHeadersRow = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    StartColumnDisplayIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
