class PictureBox(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,ISupportInitialize):
 ...
 def Dispose(self):
  ...
  Dispose(self: PictureBox,disposing: bool)
   Releases the unmanaged resources used by the System.Windows.Forms.PictureBox 
    and optionally releases the managed resources.
  
  
   disposing: true to release managed and unmanaged resources; false to release unmanaged 
    resources only.
  """
  pass
 ...
 def Load(self,url=None):
  ...
  Load(self: PictureBox,url: str)
   Sets the System.Windows.Forms.PictureBox.ImageLocation to the specified URL and 
    displays the image indicated.
  
  
   url: The path for the image to display in the System.Windows.Forms.PictureBox.
  Load(self: PictureBox)
   Displays the image specified by the 
    System.Windows.Forms.PictureBox.ImageLocation property of the 
