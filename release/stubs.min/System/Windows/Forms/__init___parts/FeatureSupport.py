class FeatureSupport(object,IFeatureSupport):
 ...
 def GetVersionPresent(*__args):
  ...
  GetVersionPresent(featureClassName: str,featureConstName: str) -> Version
   ...
   featureClassName: The fully qualified name of the class to query for information about the specified feature. This class must implement the System.Windows.Forms.IFeatureSupport interface or inherit from a class that implements this interface.
   featureConstName: The fully qualified name of the feature to look for.
   Returns: A System.Version with the version number of the specified feature available on the system; or null if the feature is not installed.
  GetVersionPresent(self: FeatureSupport,feature: object) -> Version
   ...
   Returns: A System.Version representing the version number of the specified feature available on the system; or null if the feature is not installed.
  """
  pass
 @staticmethod
 def IsPresent(*__args):
  ...
  IsPresent(featureClassName: str,featureConstName: str) -> bool
   ...
   featureClassName: The fully qualified name of the class to query for information about the specified feature. This class must implement the System.Windows.Forms.IFeatureSupport interface or inherit from a class that implements this interface.
   featureConstName: The fully qualified name of the feature to look for.
   Returns: true if the specified feature is present; false if the specified feature is not present or if the product containing the feature is not installed.
  IsPresent(featureClassName: str,featureConstName: str,minimumVersion: Version) -> bool
   ...
   Returns: true if the feature is present and its version number is greater than or equal to the specified minimum version number; false if the feature is not installed or its version number is below the specified minimum number.
