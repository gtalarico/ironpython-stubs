class DataGridViewHeaderCell(DataGridViewCell,ICloneable,IDisposable):
 ...
 def GetContentBounds(self,rowIndex):
  ...
  GetContentBounds(self: DataGridViewCell,graphics: Graphics,cellStyle: DataGridViewCellStyle,rowIndex: int) -> Rectangle
   ...
   Returns the bounding rectangle that encloses the cell's content area,which is calculated using the specified System.Drawing.Graphics and cell style.
 ...
 def GetInheritedContextMenuStrip(self,rowIndex):
  ...
  GetInheritedContextMenuStrip(self: DataGridViewHeaderCell,rowIndex: int) -> ContextMenuStrip
   ...
   Returns: A System.Windows.Forms.ContextMenuStrip if the System.Windows.Forms.DataGridViewHeaderCell or System.Windows.Forms.DataGridView has a shortcut menu assigned; otherwise,null.
  """
  pass
 def GetInheritedState(self,rowIndex):
  ...
  GetInheritedState(self: DataGridViewHeaderCell,rowIndex: int) -> DataGridViewElementStates
   ...
   rowIndex: The index of the row containing the cell or -1 if the cell is not a row header cell or is not contained within a System.Windows.Forms.DataGridView control.
 ...
 def MouseLeaveUnsharesRow(self,*args):
  ...
  MouseLeaveUnsharesRow(self: DataGridViewHeaderCell,rowIndex: int) -> bool
   ...
   Returns: true if the System.Windows.Forms.DataGridViewHeaderCell.ButtonState property value is not System.Windows.Forms.ButtonState.Normal,visual styles are enabled,and the System.Windows.Forms.DataGridView.EnableHeadersVisualStyles property is true; otherwise,false.
  """
  pass
 ...
 def Paint(self,*args):
  ...
  Paint(self: DataGridViewHeaderCell,graphics: Graphics,clipBounds: Rectangle,cellBounds: Rectangle,rowIndex: int,dataGridViewElementState: DataGridViewElementStates,value: object,formattedValue: object,errorText: str,cellStyle: DataGridViewCellStyle,advancedBorderStyle: DataGridViewAdvancedBorderStyle,paintParts: DataGridViewPaintParts)
   ...
   dataGridViewElementState: A bitwise combination of System.Windows.Forms.DataGridViewElementStates values that specifies the state of the cell.
