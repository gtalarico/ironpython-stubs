class Figure(AnchoredBlock, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild):
    ...
    CanDelayPlacement = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    WrapDirection = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
