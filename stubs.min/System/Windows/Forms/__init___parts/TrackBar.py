class TrackBar(Control, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent, ISupportInitialize):
    ...
    def OnBackColorChanged(self, *args): #cannot find CLR method
        ...
        OnBackColorChanged(self: TrackBar, e: EventArgs)
            This method is called by the control when any property changes. Inheriting controls can override this method to get property change notification on basic properties. Inheriting controls must call 
...
"""
    ...
    TickStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
