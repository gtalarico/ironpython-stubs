class PointAnimation(PointAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: PointAnimation) -> PointAnimation
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.PointAnimation, making deep copies of this object's values. When copying dependency properties, this method copies resource references and 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: PointAnimation, defaultOriginValue: Point, defaultDestinationValue: Point, animationClock: AnimationClock) -> Point
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.PointAnimation.
