...
class CodeDomProvider(Component, IComponent, IDisposable):
    ...
    def GetTypeOutput(self, type):
        ...
        GetTypeOutput(self: CodeDomProvider, type: CodeTypeReference) -> str
            ...
            type: A System.CodeDom.CodeTypeReference that indicates the type to return.
            Returns: A text representation of the specified type, formatted for the language in which code is generated by this code generator. In Visual Basic, for example, passing in a System.CodeDom.CodeTypeReference for 
             the System.Int32 type will return "Integer".
        """
        pass
...
class Executor(object):
    ...
    def ExecWaitWithCapture(*__args):
        ...
        ExecWaitWithCapture(userToken: IntPtr, cmd: str, currentDir: str, tempFiles: TempFileCollection, outputName: str, errorName: str) -> (int, str, str)
            ...
            Executes the specified command using the specified user token, current directory, and temporary files; then waits for the call to return, storing output and error information from the compiler in the 
             specified strings.
...
class TempFileCollection(object, ICollection, IEnumerable, IDisposable):
    ...
    def AddFile(self, fileName, keepFile):
        ...
        AddFile(self: TempFileCollection, fileName: str, keepFile: bool)
            Adds the specified file to the collection, using the specified value indicating whether to keep the file after the collection is disposed or when the System.CodeDom.Compiler.TempFileCollection.Delete 
             method is called.
