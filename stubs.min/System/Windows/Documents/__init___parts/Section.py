class Section(Block, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild):
    """
    A block-level flow content element used for grouping other System.Windows.Documents.Block elements.
    ...
    def ShouldSerializeBlocks(self, manager):
        """
        ShouldSerializeBlocks(self: Section, manager: XamlDesignerSerializationManager) -> bool
        
            This type or member supports the Windows Presentation Foundation (WPF) infrastructure and is not intended to be used directly from your code.
        
            manager: A serialization service manager object for this object.
            Returns: true if the System.Windows.Documents.Section.Blocks property should be serialized; otherwise, false.
        """
        pass
    ...
    """Gets a System.Windows.Documents.BlockCollection containing the top-level System.Windows.Documents.Block elements that comprise the contents of the System.Windows.Documents.Section.

Get: Blocks(self: Section) -> BlockCollection
...
"""
    ...
    HasTrailingParagraphBreakOnPaste = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets a value that indicates whether or not a trailing paragraph break should be inserted after the last paragraph when placing the contents of a root System.Windows.Documents.Section element on the clipboard.

Get: HasTrailingParagraphBreakOnPaste(self: Section) -> bool

Set: HasTrailingParagraphBreakOnPaste(self: Section) = value
"""
