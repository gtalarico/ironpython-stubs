class DocumentReference(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IUriContext):
 ...
 def GetDocument(self,forceReload):
  ...
  GetDocument(self: DocumentReference,forceReload: bool) -> FixedDocument
   ...
   Synchronously loads and parses the document specified by the 
    System.Windows.Documents.DocumentReference.Source property location.
  
  
   forceReload: true to force a new load of the 
    System.Windows.Documents.DocumentReference.Source document,even if it was 
    previously loaded.
 ...
 def SetDocument(self,doc):
  ...
  SetDocument(self: DocumentReference,doc: FixedDocument)
   Attaches a System.Windows.Documents.FixedDocument to the 
