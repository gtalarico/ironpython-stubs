class ToolStripDropDown(ToolStrip,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,ISupportToolStripPanel):
 ...
 def Close(self,reason=None):
  ...
  Close(self: ToolStripDropDown,reason: ToolStripDropDownCloseReason)
   Closes the System.Windows.Forms.ToolStripDropDown control for the specified 
    reason.
 ...
 def Show(self,*__args):
  ...
  Show(self: ToolStripDropDown,screenLocation: Point)
   Positions the System.Windows.Forms.ToolStripDropDown relative to the specified 
    screen location.
  
  
   screenLocation: The horizontal and vertical location of the screen's upper-left corner,in 
    pixels.
  
  Show(self: ToolStripDropDown,position: Point,direction: ToolStripDropDownDirection)
   Positions the System.Windows.Forms.ToolStripDropDown relative to the specified 
    control location and with the specified direction relative to the parent 
    control.
  
  
   position: The horizontal and vertical location of the reference control's upper-left 
    corner,in pixels.
  ...
  Show(self: ToolStripDropDown,control: Control,x: int,y: int)
   Positions the System.Windows.Forms.ToolStripDropDown relative to the specified 
    control's horizontal and vertical screen coordinates.
  
  
   control: The control (typically,a System.Windows.Forms.ToolStripDropDownButton) that is 
    the reference point for the System.Windows.Forms.ToolStripDropDown position.
  ...
  Show(self: ToolStripDropDown)
   Displays the System.Windows.Forms.ToolStripDropDown control in its default 
    position.
  ...
  Show(self: ToolStripDropDown,control: Control,position: Point,direction: ToolStripDropDownDirection)
   Positions the System.Windows.Forms.ToolStripDropDown relative to the specified 
    control at the specified location and with the specified direction relative to 
    the parent control.
