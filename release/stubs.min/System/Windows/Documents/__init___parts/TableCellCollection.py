class TableCellCollection(object,IList[TableCell],ICollection[TableCell],IEnumerable[TableCell],IEnumerable,IList,ICollection):
 ...
 def Add(self,item):
  ...
  Add(self: TableCellCollection,item: TableCell)
   Appends a specified System.Windows.Documents.TableCell to the collection of 
    table cells.
  
  
   item: The System.Windows.Documents.TableCell to append to the collection of table 
    cells.
  """
  pass
 def Clear(self):
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: TableCellCollection,array: Array[TableCell],index: int)
   Copies the contents of the collection and inserts them into a specified 
    System.Windows.Documents.TableCell array of starting at a specified index 
    position in the array.
  
  
   array: A one-dimensional System.Windows.Documents.TableCell array to which the 
    collection contents will be copied. This array must use zero-based indexing.
  
   index: A zero-based index in array that specifies the position at which to begin 
    inserting the copied collection objects.
 ...
 def TrimToSize(self):
  ...
  TrimToSize(self: TableCellCollection)
   Optimizes memory consumption for the collection by setting the underlying 
    collection System.Windows.Documents.TableCellCollection.Capacity equal to the 
    System.Windows.Documents.TableCellCollection.Count of items currently in the 
    collection.
  """
  pass
