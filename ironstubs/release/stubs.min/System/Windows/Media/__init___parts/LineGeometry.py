class LineGeometry(Geometry,ISealable,IAnimatable,IResource,IFormattable):
 ...
 def Clone(self):
  ...
  Clone(self: LineGeometry) -> LineGeometry
   ...
   Creates a modifiable clone of this System.Windows.Media.LineGeometry,making 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: LineGeometry) -> LineGeometry
   ...
   Creates a modifiable clone of this System.Windows.Media.LineGeometry object,
 ...
 def GetArea(self,tolerance=None,type=None):
  ...
  GetArea(self: LineGeometry,tolerance: float,type: ToleranceType) -> float
   ...
   Gets the area of the filled region of this System.Windows.Media.LineGeometry 
    object.
  
  
   tolerance: The computational tolerance of error.
   type: The specified type for interpreting the error tolerance.
   Returns: The area of the filled region of this System.Windows.Media.LineGeometry object,
    which is always 0 because a line contains no area.
  """
  pass
 ...
 def MayHaveCurves(self):
  ...
  MayHaveCurves(self: LineGeometry) -> bool
   ...
   Determines whether this System.Windows.Media.LineGeometry object can have 
    curved segments.
  
   Returns: true if this System.Windows.Media.LineGeometry object can have curved segments; 
    otherwise,false.
  """
  pass
