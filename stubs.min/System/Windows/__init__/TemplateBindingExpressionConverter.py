class TemplateBindingExpressionConverter(TypeConverter):
    ...
    def CanConvertTo(self, *__args):
        ...
        CanConvertTo(self: TemplateBindingExpressionConverter, context: ITypeDescriptorContext, destinationType: Type) -> bool
            ...
            Returns: true if this converter can perform the requested conversion; otherwise, false. Only a destinationType of System.Windows.Markup.MarkupExtension returns true.
        """
        pass
