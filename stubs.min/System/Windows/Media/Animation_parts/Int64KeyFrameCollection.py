class Int64KeyFrameCollection(Freezable, ISealable, IList, ICollection, IEnumerable):
    ...
    def Clone(self):
        ...
        Clone(self: Int64KeyFrameCollection) -> Int64KeyFrameCollection
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Int64KeyFrameCollection, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: Int64KeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.Int64KeyFrameCollection. When copying dependency properties, this method copies resource references and data bindings (but 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: Int64KeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.Int64KeyFrameCollection using current property values. Resource references, data bindings, and animations are not 
    ...
    def Contains(self, keyFrame):
        ...
        Contains(self: Int64KeyFrameCollection, keyFrame: Int64KeyFrame) -> bool
            ...
            Gets a value that indicates whether the collection contains the specified System.Windows.Media.Animation.Int64KeyFrame.
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: Int64KeyFrameCollection, array: Array[Int64KeyFrame], index: int)
            Copies all of the System.Windows.Media.Animation.Int64KeyFrame objects in a collection to a specified array.
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: Int64KeyFrameCollection, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.Int64KeyFrameCollection unmodifiable or determines whether it can be made unmodifiable.
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: Int64KeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.Int64KeyFrameCollection object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: Int64KeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.Int64KeyFrameCollection. Resource references, data bindings, and animations are not copied, but their current values are.
    ...
    def IndexOf(self, keyFrame):
        ...
        IndexOf(self: Int64KeyFrameCollection, keyFrame: Int64KeyFrame) -> int
            ...
            Searches for the specified System.Windows.Media.Animation.Int64KeyFrame and returns the zero-based index of the first occurrence within the entire collection.
    ...
    def Insert(self, index, keyFrame):
        ...
        Insert(self: Int64KeyFrameCollection, index: int, keyFrame: Int64KeyFrame)
            Inserts a System.Windows.Media.Animation.Int64KeyFrame into a specific location within the collection.
    ...
    def RemoveAt(self, index):
        ...
        RemoveAt(self: Int64KeyFrameCollection, index: int)
            Removes the System.Windows.Media.Animation.Int64KeyFrame at the specified index position from the collection.
