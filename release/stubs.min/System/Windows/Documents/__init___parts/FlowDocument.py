class FlowDocument(FrameworkContentElement,IInputElement,IAnimatable,IFrameworkInputElement,ISupportInitialize,IQueryAmbient,IDocumentPaginatorSource,IServiceProvider,IAddChild):
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: FlowDocument) -> AutomationPeer
   ...
   When overridden in a derived class,provides specific 
    System.Windows.Automation.Peers.AutomationPeer implementations to the Windows 
    Presentation Foundation (WPF) infrastructure.
...
"""
 ...
 ColumnGap=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ColumnRuleBrush=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ColumnRuleWidth=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 IsColumnWidthFlexible=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 IsOptimalParagraphEnabled=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MaxPageHeight=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MaxPageWidth=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MinPageHeight=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MinPageWidth=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 PagePadding=property(lambda self: object(),lambda self,v: None,lambda self: None)
