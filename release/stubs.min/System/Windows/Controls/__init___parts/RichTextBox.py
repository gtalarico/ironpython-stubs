class RichTextBox(TextBoxBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def GetNextSpellingErrorPosition(self,position,direction):
  ...
  GetNextSpellingErrorPosition(self: RichTextBox,position: TextPointer,direction: LogicalDirection) -> TextPointer
   ...
   Returns a System.Windows.Documents.TextPointer that points to the next spelling 
    error in the contents of the System.Windows.Controls.RichTextBox.
  
  
   position: A System.Windows.Documents.TextPointer indicating a position from which to 
    search for the next spelling error.
  
   direction: A System.Windows.Documents.LogicalDirection in which to search for the next 
    spelling error,starting at the specified posision.
  
   Returns: A System.Windows.Documents.TextPointer that points to the next spelling error 
    in the contents of the System.Windows.Controls.RichTextBox,or null if no next 
 ...
 def GetPositionFromPoint(self,point,snapToText):
  ...
  GetPositionFromPoint(self: RichTextBox,point: Point,snapToText: bool) -> TextPointer
   ...
   Returns a System.Windows.Documents.TextPointer that points to the insertion 
    point closest to the specified position.
  
  
   point: A System.Windows.Point object specifying the position to retrieve a 
    System.Windows.Documents.TextPointer for.
  
   snapToText: If true,this method always returns a System.Windows.Documents.TextPointer 
    specifying the closest insertion position for the System.Windows.Point 
    specified,regardless or whether or not the supplied System.Windows.Point is 
    inside a character's bounding box.If false,this method returns null if the 
    specified System.Windows.Point does not fall within any character bounding box.
  
   Returns: A System.Windows.Documents.TextPointer specifying the closest insertion 
    position for the supplied point,or null if snapToText is false and the 
    supplied System.Windows.Point is not within any character's bounding box. Note 
    that the System.Windows.Documents.TextPointer returned is usually the position 
    between two characters. Use the 
    System.Windows.Documents.TextPointer.LogicalDirection property of the returned 
    System.Windows.Documents.TextPointer to determine which of the two characters 
    the System.Windows.Documents.TextPointer corresponds to.
  """
  pass
 def GetSpellingError(self,position):
  ...
  GetSpellingError(self: RichTextBox,position: TextPointer) -> SpellingError
   ...
   Returns a System.Windows.Controls.SpellingError object associated with any 
    spelling error at a specified position in the contents of the 
    System.Windows.Controls.RichTextBox.
  
  
   position: A System.Windows.Documents.TextPointer that specifies a position and logical 
    direction that resolves to a character to examine for a spelling error. Use the 
    System.Windows.Documents.TextPointer.LogicalDirection property of this 
    System.Windows.Documents.TextPointer to specify the direction of the character 
    to examine.
  
   Returns: A System.Windows.Controls.SpellingError object containing the details of the 
    spelling error found at the character indicated by position,or null if no 
    spelling error exists at the specified character.
  """
  pass
 def GetSpellingErrorRange(self,position):
  ...
  GetSpellingErrorRange(self: RichTextBox,position: TextPointer) -> TextRange
   ...
   Returns a System.Windows.Documents.TextRange object covering any misspelled 
    word at a specified position in the contents of the 
    System.Windows.Controls.RichTextBox.
   ...
   Returns: A System.Windows.Documents.TextRange object covering any misspelled word that 
    includes the character specified by position,or null if no spelling error 
    exists at the specified character.
  """
  pass
 ...
 def OnContextMenuOpening(self,*args):
  ...
  OnContextMenuOpening(self: TextBoxBase,e: ContextMenuEventArgs)
   Called whenever an unhandled System.Windows.FrameworkElement.ContextMenuOpening 
    routed event reaches this class in its route. Implement this method to add 
    class handling for this event.
  
  
   e: Arguments of the event.
  OnContextMenuOpening(self: TextBox_18$19,e: ContextMenuEventArgs)
  """
  pass
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: RichTextBox) -> AutomationPeer
   ...
   Creates and returns an System.Windows.Automation.Peers.AutomationPeer object 
    for this System.Windows.Controls.RichTextBox.
 ...
 def OnDragEnter(self,*args):
  ...
  OnDragEnter(self: TextBoxBase,e: DragEventArgs)
   Invoked whenever an unhandled System.Windows.DragDrop.DragEnter attached routed 
    event reaches an element derived from this class in its route. Implement this 
    method to add class handling for this event.
  
  
   e: Provides data about the event.
  OnDragEnter(self: TextBox_18$19,e: DragEventArgs)
  """
  pass
 def OnDragLeave(self,*args):
  """
  OnDragLeave(self: TextBoxBase,e: DragEventArgs)
   Invoked whenever an unhandled System.Windows.DragDrop.DragLeave attached routed 
    event reaches an element derived from this class in its route. Implement this 
    method to add class handling for this event.
  
  
   e: Provides data about the event.
  OnDragLeave(self: TextBox_18$19,e: DragEventArgs)
  """
  pass
 def OnDragOver(self,*args):
  """
  OnDragOver(self: TextBoxBase,e: DragEventArgs)
   Invoked whenever an unhandled System.Windows.DragDrop.DragOver attached routed 
    event reaches an element derived from this class in its route. Implement this 
    method to add class handling for this event.
  
  
   e: Provides data about the event.
  OnDragOver(self: TextBox_18$19,e: DragEventArgs)
  """
  pass
 def OnDrop(self,*args):
  ...
  OnDrop(self: TextBoxBase,e: DragEventArgs)
   ...
   e: Provides data about the event.
  OnDrop(self: TextBox_18$19,e: DragEventArgs)
  """
  pass
 def OnGiveFeedback(self,*args):
  """
  OnGiveFeedback(self: TextBoxBase,e: GiveFeedbackEventArgs)
   Invoked whenever an unhandled System.Windows.DragDrop.GiveFeedback attached 
    routed event reaches an element derived from this class in its route. Implement 
    this method to add class handling for this event.
  
  
   e: Provides data about the event.
  OnGiveFeedback(self: TextBox_18$19,e: GiveFeedbackEventArgs)
  """
  pass
 ...
 def OnGotKeyboardFocus(self,*args):
  ...
  OnGotKeyboardFocus(self: TextBoxBase,e: KeyboardFocusChangedEventArgs)
   ...
   e: Provides data about the event.
  OnGotKeyboardFocus(self: TextBox_18$19,e: KeyboardFocusChangedEventArgs)
  """
  pass
 ...
 def OnKeyUp(self,*args):
  ...
  OnKeyUp(self: TextBoxBase,e: KeyEventArgs)
   Invoked whenever an unhandled System.Windows.Input.Keyboard.KeyUp attached 
    routed event reaches an element derived from this class in its route. Implement 
    this method to add class handling for this event.
 ...
 def OnLostFocus(self,*args):
  ...
  OnLostFocus(self: TextBoxBase,e: RoutedEventArgs)
   Raises the System.Windows.UIElement.LostFocus event (using the provided 
    arguments).
  
  
   e: Provides data about the event.
  OnLostFocus(self: TextBox_18$19,e: RoutedEventArgs)
  """
  pass
 def OnLostKeyboardFocus(self,*args):
  ...
  OnLostKeyboardFocus(self: TextBoxBase,e: KeyboardFocusChangedEventArgs)
   ...
   e: Provides data about the event.
  OnLostKeyboardFocus(self: TextBox_18$19,e: KeyboardFocusChangedEventArgs)
  """
  pass
 ...
 def OnMouseDown(self,*args):
  ...
  OnMouseDown(self: TextBoxBase,e: MouseButtonEventArgs)
   Invoked whenever an unhandled System.Windows.Input.Mouse.MouseDown attached 
    routed event reaches an element derived from this class in its route. Implement 
    this method to add class handling for this event.
  
  
   e: Provides data about the event.
  OnMouseDown(self: TextBox_18$19,e: MouseButtonEventArgs)
  """
  pass
 ...
 def OnMouseMove(self,*args):
  ...
  OnMouseMove(self: TextBoxBase,e: MouseEventArgs)
   Invoked whenever an unhandled System.Windows.Input.Mouse.MouseMove attached 
    routed event reaches an element derived from this class in its route. Implement 
    this method to add class handling for this event.
  
  
   e: Provides data about the event.
  OnMouseMove(self: TextBox_18$19,e: MouseEventArgs)
  """
  pass
 ...
 def OnMouseUp(self,*args):
  ...
  OnMouseUp(self: TextBoxBase,e: MouseButtonEventArgs)
   ...
   e: Arguments of the event. These arguments will include details about which mouse 
    button was depressed,and the handled state.
  
  OnMouseUp(self: TextBox_18$19,e: MouseButtonEventArgs)
  """
  pass
 def OnMouseWheel(self,*args):
  ...
  OnMouseWheel(self: TextBox_18$19,e: MouseWheelEventArgs)
  """
  pass
 ...
 def OnQueryContinueDrag(self,*args):
  ...
  OnQueryContinueDrag(self: TextBoxBase,e: QueryContinueDragEventArgs)
   Invoked whenever an unhandled System.Windows.DragDrop.QueryContinueDrag 
    attached  routed event reaches an element derived from this class in its route. 
    Implement this method to add class handling for this event.
 ...
 def OnQueryCursor(self,*args):
  ...
  OnQueryCursor(self: TextBoxBase,e: QueryCursorEventArgs)
   Invoked whenever an unhandled System.Windows.Input.Mouse.QueryCursor attached 
    routed event reaches an element derived from this class in its route. Implement 
    this method to add class handling for this event.
  
  
   e: Provides data about the event.
  OnQueryCursor(self: TextBox_18$19,e: QueryCursorEventArgs)
  """
  pass
 ...
 def OnSelectionChanged(self,*args):
  ...
  OnSelectionChanged(self: TextBox_18$19,e: RoutedEventArgs)
  """
  pass
 ...
 def OnTemplateChanged(self,*args):
  ...
  OnTemplateChanged(self: TextBoxBase,oldTemplate: ControlTemplate,newTemplate: ControlTemplate)
   ...
   oldTemplate: A System.Windows.Controls.ControlTemplate object that specifies the control 
    template that is currently active.
  
   newTemplate: A System.Windows.Controls.ControlTemplate object that specifies a new control 
    template to use.
  
  OnTemplateChanged(self: TextBox_18$19,oldTemplate: ControlTemplate,newTemplate: ControlTemplate)
  """
  pass
 def OnTextChanged(self,*args):
  ...
  OnTextChanged(self: TextBox_18$19,e: TextChangedEventArgs)
  """
  pass
 def OnTextInput(self,*args):
  ...
  OnTextInput(self: TextBoxBase,e: TextCompositionEventArgs)
   Invoked whenever an unhandled 
    System.Windows.Input.TextCompositionManager.TextInput attached routed event 
    reaches an element derived from this class in its route. Implement this method 
    to add class handling for this event.
  
  
   e: Provides data about the event.
  OnTextInput(self: TextBox_18$19,e: TextCompositionEventArgs)
  """
  pass
 ...
 def ShouldSerializeDocument(self):
  ...
  ShouldSerializeDocument(self: RichTextBox) -> bool
   ...
   Returns a value that indicates whether or not the effective value of the 
    System.Windows.Controls.RichTextBox.Document property should be serialized 
    during serialization of a System.Windows.Controls.RichTextBox object.
  
   Returns: true if the System.Windows.Controls.RichTextBox.Document property should be 
