class DatePickerAutomationPeer(FrameworkElementAutomationPeer, IExpandCollapseProvider, IValueProvider):
    ...
    def GetPattern(self, patternInterface):
        ...
        GetPattern(self: DatePickerAutomationPeer, patternInterface: PatternInterface) -> object
            ...
            Returns: If patternInterface is System.Windows.Automation.Peers.PatternInterface.ExpandCollapse or System.Windows.Automation.Peers.PatternInterface.Value, this method returns a this pointer; otherwise, this method 
             returns null.
        """
        pass
