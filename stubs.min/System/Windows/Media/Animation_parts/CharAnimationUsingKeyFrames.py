class CharAnimationUsingKeyFrames(CharAnimationBase, ISealable, IAnimatable, IResource, IKeyFrameAnimation, IAddChild):
    ...
    def AddChild(self, *args): #cannot find CLR method
        ...
        AddChild(self: CharAnimationUsingKeyFrames, child: object)
            Adds a child System.Windows.Media.Animation.CharKeyFrame to this System.Windows.Media.Animation.CharAnimationUsingKeyFrames.
        
            child: The object to be added as the child of this System.Windows.Media.Animation.CharAnimationUsingKeyFrames.
        """
        pass
    ...
    def Clone(self):
        ...
        Clone(self: CharAnimationUsingKeyFrames) -> CharAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.CharAnimationUsingKeyFrames, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: CharAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.CharAnimationUsingKeyFrames. When copying dependency properties, this method copies resource references and data bindings 
    ...
    def CloneCurrentValue(self):
        ...
        CloneCurrentValue(self: CharAnimationUsingKeyFrames) -> CharAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.CharAnimationUsingKeyFrames object, making deep copies of this object's current values. Resource references, data bindings, and animations 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: CharAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.CharAnimationUsingKeyFrames using current property values. Resource references, data bindings, and animations are 
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: CharAnimationUsingKeyFrames, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.CharAnimationUsingKeyFrames object unmodifiable or determines whether it can be made unmodifiable.
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: CharAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.CharAnimationUsingKeyFrames object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: CharAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.CharAnimationUsingKeyFrames. Resource references, data bindings, and animations are not copied, but their current values 
             are.
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: CharAnimationUsingKeyFrames, defaultOriginValue: Char, defaultDestinationValue: Char, animationClock: AnimationClock) -> Char
            ...
            Calculates a value that represents the current value of the property being animated, as determined by this instance of System.Windows.Media.Animation.CharAnimationUsingKeyFrames.
    ...
    def OnChanged(self, *args): #cannot find CLR method
        ...
        OnChanged(self: CharAnimationUsingKeyFrames)
            Called when the current System.Windows.Media.Animation.CharAnimationUsingKeyFrames object is modified.
        """
        pass
    ...
    def ShouldSerializeKeyFrames(self):
        ...
        ShouldSerializeKeyFrames(self: CharAnimationUsingKeyFrames) -> bool
            ...
            Returns true if the value of the System.Windows.Media.Animation.CharAnimationUsingKeyFrames.KeyFrames property of this instance of System.Windows.Media.Animation.CharAnimationUsingKeyFrames should be 
             value-serialized.
