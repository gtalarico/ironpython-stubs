class Point3DKeyFrameCollection(Freezable, ISealable, IList, ICollection, IEnumerable):
    ...
    def Clone(self):
        ...
        Clone(self: Point3DKeyFrameCollection) -> Point3DKeyFrameCollection
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Point3DKeyFrameCollection, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: Point3DKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.Point3DKeyFrameCollection. When copying dependency properties, this method copies resource references and data bindings (but 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: Point3DKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.Point3DKeyFrameCollection using current property values. Resource references, data bindings, and animations are 
    ...
    def Contains(self, keyFrame):
        ...
        Contains(self: Point3DKeyFrameCollection, keyFrame: Point3DKeyFrame) -> bool
            ...
            Gets a value that indicates whether the collection contains the specified System.Windows.Media.Animation.Point3DKeyFrame.
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: Point3DKeyFrameCollection, array: Array[Point3DKeyFrame], index: int)
            Copies all of the System.Windows.Media.Animation.Point3DKeyFrame objects in a collection to a specified array.
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: Point3DKeyFrameCollection, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.Point3DKeyFrameCollection unmodifiable or determines whether it can be made unmodifiable.
        
            isChecking: true if the System.Windows.Freezable instance should actually freeze itself when this method is called. false if the System.Windows.Freezable should simply return whether it can be frozen.
            Returns: If isChecking is true, this method returns true if the specified System.Windows.Freezable can be made unmodifiable, or false if it cannot be made unmodifiable. If isChecking is false, this method returns 
             true if the if the specified System.Windows.Freezable is now unmodifiable, or false if it cannot be made unmodifiable, with the side effect of having made the actual change in frozen status to this object.
        """
        pass
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: Point3DKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.Point3DKeyFrameCollection object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: Point3DKeyFrameCollection, sourceFreezable: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.Point3DKeyFrameCollection. Resource references, data bindings, and animations are not copied, but their current values are.
    ...
    def IndexOf(self, keyFrame):
        ...
        IndexOf(self: Point3DKeyFrameCollection, keyFrame: Point3DKeyFrame) -> int
            ...
            Searches for the specified System.Windows.Media.Animation.Point3DKeyFrame and returns the zero-based index of the first occurrence within the entire collection.
    ...
    def Insert(self, index, keyFrame):
        ...
        Insert(self: Point3DKeyFrameCollection, index: int, keyFrame: Point3DKeyFrame)
            Inserts a System.Windows.Media.Animation.Point3DKeyFrame into a specific location within the collection.
    ...
    def RemoveAt(self, index):
        ...
        RemoveAt(self: Point3DKeyFrameCollection, index: int)
            Removes the System.Windows.Media.Animation.Point3DKeyFrame at the specified index position from the collection.
