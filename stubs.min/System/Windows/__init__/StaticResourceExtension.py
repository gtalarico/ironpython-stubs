class StaticResourceExtension(MarkupExtension):
    ...
    def ProvideValue(self, serviceProvider):
        ...
        ProvideValue(self: StaticResourceExtension, serviceProvider: IServiceProvider) -> object
            ...
            Returns an object that should be set on the property where this extension is applied. For System.Windows.StaticResourceExtension, this is the object found in a resource dictionary, where the object to find 
             is identified by the System.Windows.StaticResourceExtension.ResourceKey.
        
        
            serviceProvider: Object that can provide services for the markup extension.
            Returns: The object value to set on the property where the markup extension provided value is evaluated.
        """
        pass
