class RectAnimation(RectAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: RectAnimation) -> RectAnimation
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.RectAnimation, making deep copies of this object's values.
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: RectAnimation, defaultOriginValue: Rect, defaultDestinationValue: Rect, animationClock: AnimationClock) -> Rect
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.RectAnimation.
