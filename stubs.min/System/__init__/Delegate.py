class Delegate(object, ICloneable, ISerializable):
    ...
    def Combine(*__args):
        ...
        Combine(*delegates: Array[Delegate]) -> Delegate
            ...
            Returns: A new delegate with an invocation list that concatenates the invocation lists of the delegates in the delegates array. Returns null if delegates is null, if delegates contains zero elements, or if every 
             entry in delegates is null.
        ...
        Combine(a: Delegate, b: Delegate) -> Delegate
            ...
            Returns: A new delegate with an invocation list that concatenates the invocation lists of a and b in that order. Returns a if b is null, returns b if a is a null reference, and returns a null reference if both a 
             and b are null references.
        """
        pass
    ...
    def CombineImpl(self, *args): #cannot find CLR method
        ...
        CombineImpl(self: Delegate, d: Delegate) -> Delegate
            ...
            Returns: A new multicast (combinable) delegate with an invocation list that concatenates the invocation list of the current multicast (combinable) delegate and the invocation list of d, or the current multicast 
             (combinable) delegate if d is null.
        """
        pass
    ...
    def CreateDelegate(type, *__args):
        ...
        CreateDelegate(type: Type, target: object, method: str, ignoreCase: bool, throwOnBindFailure: bool) -> Delegate
            ...
            Creates a delegate of the specified type that represents the specified instance method to invoke on the specified class instance, with the specified case-sensitivity and the specified behavior on failure 
             to bind.
    ...
    def Remove(source, value):
        ...
        Remove(source: Delegate, value: Delegate) -> Delegate
            ...
            Returns: A new delegate with an invocation list formed by taking the invocation list of source and removing the last occurrence of the invocation list of value, if the invocation list of value is found within the 
             invocation list of source. Returns source if value is null or if the invocation list of value is not found within the invocation list of source. Returns a null reference if the invocation list of value is 
             equal to the invocation list of source or if source is a null reference.
        """
        pass
    ...
    def RemoveAll(source, value):
        ...
        RemoveAll(source: Delegate, value: Delegate) -> Delegate
            ...
            source: The delegate from which to remove the invocation list of value.
            value: The delegate that supplies the invocation list to remove from the invocation list of source.
            Returns: A new delegate with an invocation list formed by taking the invocation list of source and removing all occurrences of the invocation list of value, if the invocation list of value is found within the 
             invocation list of source. Returns source if value is null or if the invocation list of value is not found within the invocation list of source. Returns a null reference if the invocation list of value is 
             equal to the invocation list of source, if source contains only a series of invocation lists that are equal to the invocation list of value, or if source is a null reference.
        """
        pass
    ...
    def RemoveImpl(self, *args): #cannot find CLR method
        ...
        RemoveImpl(self: Delegate, d: Delegate) -> Delegate
            ...
            Returns: A new delegate with an invocation list formed by taking the invocation list of the current delegate and removing the invocation list of value, if the invocation list of value is found within the current 
             delegate's invocation list. Returns the current delegate if value is null or if the invocation list of value is not found within the current delegate's invocation list. Returns null if the invocation list 
             of value is equal to the current delegate's invocation list.
        """
        pass
