class DecimalAnimationUsingKeyFrames(DecimalAnimationBase, ISealable, IAnimatable, IResource, IKeyFrameAnimation, IAddChild):
    ...
    def AddChild(self, *args): #cannot find CLR method
        ...
        AddChild(self: DecimalAnimationUsingKeyFrames, child: object)
            Adds a child System.Windows.Media.Animation.DecimalKeyFrame to this System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames.
        
            child: The object to be added as the child of this System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames.
        """
        pass
    ...
    def AddText(self, *args): #cannot find CLR method
        ...
        AddText(self: DecimalAnimationUsingKeyFrames, childText: str)
            Adds a text string as a child of this System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames.
    ...
    def Clone(self):
        ...
        Clone(self: DecimalAnimationUsingKeyFrames) -> DecimalAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: DecimalAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames. When copying dependency properties, this method copies resource references and data bindings 
    ...
    def CloneCurrentValue(self):
        ...
        CloneCurrentValue(self: DecimalAnimationUsingKeyFrames) -> DecimalAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames object, making deep copies of this object's current values. Resource references, data bindings, and 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: DecimalAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames using current property values. Resource references, data bindings, and animations 
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: DecimalAnimationUsingKeyFrames, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames object unmodifiable or determines whether it can be made unmodifiable..
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: DecimalAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: DecimalAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a copy of the specified System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames.
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: DecimalAnimationUsingKeyFrames, defaultOriginValue: Decimal, defaultDestinationValue: Decimal, animationClock: AnimationClock) -> Decimal
            ...
            Calculates a value that represents the current value of the property being animated, as determined by this instance of System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames.
    ...
    def OnChanged(self, *args): #cannot find CLR method
        ...
        OnChanged(self: DecimalAnimationUsingKeyFrames)
            Called when the current System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames object is modified.
        """
        pass
    ...
    def ShouldSerializeKeyFrames(self):
        ...
        ShouldSerializeKeyFrames(self: DecimalAnimationUsingKeyFrames) -> bool
            ...
            Returns true if the value of the System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames.KeyFrames property of this instance of System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames should be 
             value-serialized.
