class Splitter(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def OnSplitterMoved(self,*args):
  ...
  OnSplitterMoved(self: Splitter,sevent: SplitterEventArgs)
   Raises the System.Windows.Forms.Splitter.SplitterMoved event. System.Windows.Forms.Splitter.OnSplitterMoved(System.Windows.Forms.SplitterEventArgs) has been replaced by System.Windows.Forms.SplitContainer.OnSplitterMoved(System.Windows.Forms.SplitterEventArgs) and is provided only for compatibility with previous versions.
 ...
 def OnSplitterMoving(self,*args):
  ...
  OnSplitterMoving(self: Splitter,sevent: SplitterEventArgs)
   Raises the System.Windows.Forms.Splitter.SplitterMoving event. System.Windows.Forms.Splitter.OnSplitterMoving(System.Windows.Forms.SplitterEventArgs) has been replaced by System.Windows.Forms.SplitContainer.OnSplitterMoving(System.Windows.Forms.SplitterCancelEventArgs) and is provided only for compatibility with previous versions.
