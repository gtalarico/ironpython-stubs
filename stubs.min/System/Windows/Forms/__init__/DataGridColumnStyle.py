class DataGridColumnStyle(Component, IComponent, IDisposable, IDataGridColumnStyleEditingNotificationService):
    ...
    def GetPreferredSize(self, *args): #cannot find CLR method
        ...
        GetPreferredSize(self: DataGridColumnStyle, g: Graphics, value: object) -> Size
            ...
            When overridden in a derived class, gets the width and height of the specified value. The width and height are used when the user navigates to System.Windows.Forms.DataGridTableStyle using the 
    ...
    def Paint(self, *args): #cannot find CLR method
        ...
        Paint(self: DataGridColumnStyle, g: Graphics, bounds: Rectangle, source: CurrencyManager, rowNum: int, backBrush: Brush, foreBrush: Brush, alignToRight: bool)
            Paints a System.Windows.Forms.DataGridColumnStyle with the specified System.Drawing.Graphics, System.Drawing.Rectangle, System.Windows.Forms.CurrencyManager, row number, background color, foreground color, 
             and alignment.
        
        
            g: The System.Drawing.Graphics to draw to.
            bounds: The bounding System.Drawing.Rectangle to paint into.
            source: The System.Windows.Forms.CurrencyManager of the System.Windows.Forms.DataGrid control the column belongs to.
        ...
        Paint(self: DataGridColumnStyle, g: Graphics, bounds: Rectangle, source: CurrencyManager, rowNum: int, alignToRight: bool)
            When overridden in a derived class, paints a System.Windows.Forms.DataGridColumnStyle with the specified System.Drawing.Graphics, System.Drawing.Rectangle, System.Windows.Forms.CurrencyManager, row number, 
             and alignment.
            ...
            alignToRight: A value indicating whether to align the column's content to the right. true if the content should be aligned to the right; otherwise false.
    ...
    def SetColumnValueAtRow(self, *args): #cannot find CLR method
        ...
        SetColumnValueAtRow(self: DataGridColumnStyle, source: CurrencyManager, rowNum: int, value: object)
            ...
            source: A System.Windows.Forms.CurrencyManager associated with the System.Windows.Forms.DataGridColumnStyle.
...
"""
    ...
    DataGridTableStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HeaderAccessibleObject = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the System.Windows.Forms.AccessibleObject for the column.
...
"""
    ...
    NullText = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
