class Timer(Component,IComponent,IDisposable):
 ...
 def Dispose(self):
  ...
  Dispose(self: Timer,disposing: bool)
   ...
   disposing: true to release both managed and unmanaged resources. false to release only the 
    unmanaged resources.
  """
  pass
 ...
 def OnTick(self,*args):
  ...
  OnTick(self: Timer,e: EventArgs)
   ...
   e: An System.EventArgs that contains the event data. This is always 
