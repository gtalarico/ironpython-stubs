class Frame(ContentControl, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, INavigator, INavigatorBase, INavigatorImpl, IJournalNavigationScopeHost, IDownloader, IJournalState, IUriContext):
    ...
    def GoBack(self):
        """
        GoBack(self: Frame)
            Navigates to the most recent item in back navigation history, if a System.Windows.Controls.Frame manages its own navigation history.
        """
        pass
    ...
    def GoForward(self):
        ...
        GoForward(self: Frame)
            Navigates to the most recent item in forward navigation history, if a System.Windows.Controls.Frame manages its own navigation history.
        """
        pass
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: Frame) -> AutomationPeer
            ...
            Creates and returns a System.Windows.Automation.Peers.NavigationWindowAutomationPeer object for this System.Windows.Controls.Frame.
            Returns: A System.Windows.Automation.Peers.NavigationWindowAutomationPeer object for this System.Windows.Controls.Frame.
        """
        pass
    ...
    def ShouldSerializeContent(self):
        ...
        ShouldSerializeContent(self: Frame) -> bool
            ...
            Allows derived classes to determine the serialization behavior of the System.Windows.Controls.ContentControl.Content property.
...
"""
    ...
    JournalOwnership = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    NavigationUIVisibility = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
