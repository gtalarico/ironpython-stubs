class Console(object):
    ...
    def ReadKey(intercept=None):
        ...
        ReadKey(intercept: bool) -> ConsoleKeyInfo
            ...
            Returns: A System.ConsoleKeyInfo object that describes the System.ConsoleKey constant and Unicode character, if any, that correspond to the pressed console key. The System.ConsoleKeyInfo object also describes, in a 
             bitwise combination of System.ConsoleModifiers values, whether one or more SHIFT, ALT, or CTRL modifier keys was pressed simultaneously with the console key.
    ...
    KeyAvailable = False
    LargestWindowHeight = 67
    LargestWindowWidth = 236
    NumberLock = True
    Out = None
    OutputEncoding = None
    Title = 'cmd - ipy64  make_stubs.py '
