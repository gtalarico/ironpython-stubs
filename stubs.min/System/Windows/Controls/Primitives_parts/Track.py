class Track(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: Track,arrangeSize: Size) -> Size
   ...
   Returns: The System.Windows.Size to use for the System.Windows.Controls.Primitives.Track 
    content.
  """
  pass
 ...
 def GetVisualChild(self,*args):
  ...
  GetVisualChild(self: Track,index: int) -> Visual
   ...
   Gets the child of the System.Windows.Controls.Primitives.Track at the specified 
    index.
  
  
   index: The index of the child.
   Returns: Returns the object of the System.Windows.Controls.Primitives.Track at the 
    specified index in the list of visual child elements. The index must be a 
    number between zero (0) and the value of the 
    System.Windows.Controls.Primitives.Track.VisualChildrenCount property minus one 
    (1).
  """
  pass
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: Track,availableSize: Size) -> Size
   ...
   Measures the layout size that is required for the 
    System.Windows.Controls.Primitives.Track and its components.
  
  
   availableSize: The size of the available space for the track.
   Returns: The layout System.Windows.Size that is required by the 
 ...
 def ValueFromDistance(self,horizontal,vertical):
  ...
  ValueFromDistance(self: Track,horizontal: float,vertical: float) -> float
   ...
   Calculates the change in the System.Windows.Controls.Primitives.Track.Value of 
    the System.Windows.Controls.Primitives.Track when the 
    System.Windows.Controls.Primitives.Track.Thumb moves.
  
  
   horizontal: The horizontal displacement of the 
   ...
   Returns: The change in System.Windows.Controls.Primitives.Track.Value that corresponds 
    to the displacement of the System.Windows.Controls.Primitives.Track.Thumb of 
    the System.Windows.Controls.Primitives.Track.
  """
  pass
 def ValueFromPoint(self,pt):
  ...
  ValueFromPoint(self: Track,pt: Point) -> float
   ...
   Calculates the distance from the System.Windows.Controls.Primitives.Thumb to a 
    specified point along the System.Windows.Controls.Primitives.Track.
  
  
   pt: The specified point.
   Returns: The distance between the System.Windows.Controls.Primitives.Track.Thumb and the 
    specified pt value.
  """
  pass
