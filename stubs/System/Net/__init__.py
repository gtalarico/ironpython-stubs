...
class Cookie(object):
    ...
    def Equals(self, comparand):
        ...
        Equals(self: Cookie, comparand: object) -> bool
            ...
            Returns: Returns true if the System.Net.Cookie is equal to comparand. Two System.Net.Cookie instances are equal if their System.Net.Cookie.Name, System.Net.Cookie.Value, System.Net.Cookie.Path, 
             System.Net.Cookie.Domain, and System.Net.Cookie.Version properties are equal. System.Net.Cookie.Name and System.Net.Cookie.Domain string comparisons are case-insensitive.
        """
        pass
...
class CredentialCache(object, ICredentials, ICredentialsByHost, IEnumerable):
    ...
    def Add(self, *__args):
        ...
        Add(self: CredentialCache, host: str, port: int, authenticationType: str, credential: NetworkCredential)
            Adds a System.Net.NetworkCredential instance for use with SMTP to the credential cache and associates it with a host computer, port, and authentication protocol. Credentials added using this method are 
             valid for SMTP only. This method does not work for HTTP or FTP requests.
...
class DnsPermission(CodeAccessPermission, IPermission, ISecurityEncodable, IStackWalk, IUnrestrictedPermission):
    ...
    def Intersect(self, target):
        ...
        Intersect(self: DnsPermission, target: IPermission) -> IPermission
            ...
            Returns: A System.Net.DnsPermission instance that represents the intersection of the current System.Net.DnsPermission instance with the specified System.Net.DnsPermission instance, or null if the intersection is 
             empty. If both the current instance and target are unrestricted, this method returns a new System.Net.DnsPermission instance that is unrestricted; otherwise, it returns null.
        """
        pass
    ...
    def Union(self, target):
        ...
        Union(self: DnsPermission, target: IPermission) -> IPermission
            ...
            Returns: A System.Net.DnsPermission instance that represents the union of the current System.Net.DnsPermission instance with the specified System.Net.DnsPermission instance. If target is null, this method returns a 
             copy of the current instance. If the current instance or target is unrestricted, this method returns a System.Net.DnsPermission instance that is unrestricted; otherwise, it returns a 
             System.Net.DnsPermission instance that is restricted.
        """
        pass
...
class ServicePoint(object):
    ...
    def SetTcpKeepAlive(self, enabled, keepAliveTime, keepAliveInterval):
        ...
        SetTcpKeepAlive(self: ServicePoint, enabled: bool, keepAliveTime: int, keepAliveInterval: int)
            ...
            enabled: If set to true, then the TCP keep-alive option on a TCP connection will be enabled using the specified keepAliveTime and keepAliveInterval values. If set to false, then the TCP keep-alive option is 
             disabled and the remaining parameters are ignored.The default value is false.
        
            keepAliveTime: Specifies the timeout, in milliseconds, with no activity until the first keep-alive packet is sent. The value must be greater than 0.  If a value of less than or equal to zero is passed an 
             System.ArgumentOutOfRangeException is thrown.
        
            keepAliveInterval: Specifies the interval, in milliseconds, between when successive keep-alive packets are sent if no acknowledgement is received.The value must be greater than 0.  If a value of less than or equal to zero is 
...
class SocketPermission(CodeAccessPermission, IPermission, ISecurityEncodable, IStackWalk, IUnrestrictedPermission):
    ...
    def Intersect(self, target):
        ...
        Intersect(self: SocketPermission, target: IPermission) -> IPermission
            ...
            Returns: The System.Net.SocketPermission instance that represents the intersection of two System.Net.SocketPermission instances. If the intersection is empty, the method returns null. If the target parameter is a 
             null reference, the method returns null.
        """
        pass
    ...
    def IsSubsetOf(self, target):
        ...
        IsSubsetOf(self: SocketPermission, target: IPermission) -> bool
            ...
            Returns: If target is null, this method returns true if the current instance defines no permissions; otherwise, false. If target is not null, this method returns true if the current instance defines a subset of 
             target permissions; otherwise, false.
        """
        pass
...
class WebClient(Component, IComponent, IDisposable):
    ...
    def UploadValuesAsync(self, address, *__args):
        ...
        UploadValuesAsync(self: WebClient, address: Uri, method: str, data: NameValueCollection, userToken: object)
            Uploads the data in the specified name/value collection to the resource identified by the specified URI, using the specified method. This method does not block the calling thread, and allows the caller to 
...
class WebHeaderCollection(NameValueCollection, ICollection, IEnumerable, ISerializable, IDeserializationCallback):
    ...
    def BaseSet(self, *args): #cannot find CLR method
        ...
        BaseSet(self: NameObjectCollectionBase, name: str, value: object)
            Sets the value of the first entry with the specified key in the System.Collections.Specialized.NameObjectCollectionBase instance, if found; otherwise, adds an entry with the specified key and value into 
             the System.Collections.Specialized.NameObjectCollectionBase instance.
...
class WebPermission(CodeAccessPermission, IPermission, ISecurityEncodable, IStackWalk, IUnrestrictedPermission):
    ...
    def IsSubsetOf(self, target):
        ...
        IsSubsetOf(self: WebPermission, target: IPermission) -> bool
            ...
            Returns: true if the current instance is a subset of the target parameter; otherwise, false. If the target is null, the method returns true for an empty current permission that is not unrestricted and false 
             otherwise.
        """
        pass
    ...
    def Union(self, target):
        ...
        Union(self: WebPermission, target: IPermission) -> IPermission
            ...
            Returns: A System.Net.WebPermission that represents the union of the current instance and the target parameter. If either WebPermission is System.Security.Permissions.PermissionState.Unrestricted, the method 
             returns a System.Net.WebPermission that is System.Security.Permissions.PermissionState.Unrestricted. If the target is null, the method returns a copy of the current System.Net.WebPermission.
        """
        pass
