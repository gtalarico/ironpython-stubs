class IDataObject:
 ...
 def GetDataPresent(self,format,autoConvert=None):
  ...
  GetDataPresent(self: IDataObject,format: str,autoConvert: bool) -> bool
   ...
   format: The format for which to check. See System.Windows.Forms.DataFormats for predefined 
    formats.
  
   autoConvert: true to determine whether data stored in this instance can be converted to the specified 
  ...
  GetDataPresent(self: IDataObject,format: str) -> bool
   ...
   Returns: true if data stored in this instance is associated with,or can be converted to,the 
  ...
  GetDataPresent(self: IDataObject,format: Type) -> bool
   ...
   format: A System.Type representing the format for which to check. See 
    System.Windows.Forms.DataFormats for predefined formats.
 ...
 def GetFormats(self,autoConvert=None):
  ...
  GetFormats(self: IDataObject,autoConvert: bool) -> Array[str]
   ...
   Gets a list of all formats that data stored in this instance is associated with or can be 
    converted to,using a Boolean value to determine whether to retrieve all formats that the 
    data can be converted to or only native data formats.
  
  
   autoConvert: true to retrieve all formats that data stored in this instance is associated with or can 
    be converted to; false to retrieve only native data formats.
  
   Returns: An array of the names that represents a list of all formats that are supported by the 
    data stored in this object.
  
  GetFormats(self: IDataObject) -> Array[str]
  
   Returns a list of all formats that data stored in this instance is associated with or can 
    be converted to.
