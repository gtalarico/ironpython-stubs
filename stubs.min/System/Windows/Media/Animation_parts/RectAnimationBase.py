class RectAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: RectAnimationBase) -> RectAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.RectAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
