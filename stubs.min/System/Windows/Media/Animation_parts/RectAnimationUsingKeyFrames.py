class RectAnimationUsingKeyFrames(RectAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 ...
 def AddText(self,*args):
  ...
  AddText(self: RectAnimationUsingKeyFrames,childText: str)
   ...
   childText: The text to add to the 
    System.Windows.Media.Animation.RectAnimationUsingKeyFrames.
  """
  pass
 ...
 def Clone(self):
  ...
  Clone(self: RectAnimationUsingKeyFrames) -> RectAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.RectAnimationUsingKeyFrames,making deep copies 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: RectAnimationUsingKeyFrames,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.RectAnimationUsingKeyFrames. When copying 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: RectAnimationUsingKeyFrames) -> RectAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.RectAnimationUsingKeyFrames object,making deep 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: RectAnimationUsingKeyFrames,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.RectAnimationUsingKeyFrames using current 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: RectAnimationUsingKeyFrames,isChecking: bool) -> bool
   ...
   Makes this instance of a 
    System.Windows.Media.Animation.RectAnimationUsingKeyFrames object read-only 
    (frozen) or determines whether it can be made read-only.
   ...
   Returns: If isChecking is true,this method returns true if this 
    System.Windows.Media.Animation.RectAnimationUsingKeyFrames can be made 
    read-only,or false if it cannot be made read-only. If isChecking is false,
    this method returns true if this 
    System.Windows.Media.Animation.RectAnimationUsingKeyFrames is now read-only,or 
    false if it cannot be made read-only,with the side effect of having begun to 
    change the frozen status of this object.
  """
  pass
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: RectAnimationUsingKeyFrames,source: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.RectAnimationUsingKeyFrames. Resource 
    references,data bindings,and animations are not copied,but their current 
    values are.
  
  
   source: The System.Windows.Media.Animation.RectAnimationUsingKeyFrames to copy and 
    freeze.
  """
  pass
 ...
 def GetNaturalDurationCore(self,*args):
  ...
  GetNaturalDurationCore(self: RectAnimationUsingKeyFrames,clock: Clock) -> Duration
   ...
   Provides a custom natural System.Windows.Duration when the 
 ...
 def OnChanged(self,*args):
  ...
  OnChanged(self: RectAnimationUsingKeyFrames)
   Called when the current 
    System.Windows.Media.Animation.RectAnimationUsingKeyFrames object is modified.
  """
  pass
 ...
 def ShouldSerializeKeyFrames(self):
  ...
  ShouldSerializeKeyFrames(self: RectAnimationUsingKeyFrames) -> bool
   ...
   Indicates whether the 
    System.Windows.Media.Animation.RectAnimationUsingKeyFrames.KeyFrames property 
    should be persisted.
