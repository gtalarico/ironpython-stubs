class Help(object):
 ...
 def ShowHelp(parent,url,*__args):
  ...
  ShowHelp(parent: Control,url: str,keyword: str)
   Displays the contents of the Help file found at the specified URL for a 
    specific keyword.
  
  
   parent: A System.Windows.Forms.Control that identifies the parent of the Help dialog 
    box.
 ...
 def ShowPopup(parent,caption,location):
  ...
  ShowPopup(parent: Control,caption: str,location: Point)
   ...
   location: A value that specifies the horizontal and vertical coordinates at which to 
    display the pop-up window,relative to the upper-left corner of the screen.
  """
  pass
