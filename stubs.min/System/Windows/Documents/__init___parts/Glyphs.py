class Glyphs(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IUriContext):
    ...
    def ToGlyphRun(self):
        ...
        ToGlyphRun(self: Glyphs) -> GlyphRun
            ...
            Creates a System.Windows.Media.GlyphRun from the properties of the System.Windows.Documents.Glyphs object.
            Returns: A System.Windows.Media.GlyphRun that was created using the properties of the System.Windows.Documents.Glyphs object.
        """
        pass
...
"""
    ...
    UnicodeString = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
