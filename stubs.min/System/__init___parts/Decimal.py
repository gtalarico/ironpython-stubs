class Decimal(object, IFormattable, IComparable, IConvertible, IDeserializationCallback, IComparable[Decimal], IEquatable[Decimal]):
    ...
    def CompareTo(self, value):
        ...
        CompareTo(self: Decimal, value: Decimal) -> int
            ...
            Returns: A signed number indicating the relative values of this instance and value.Return Value Meaning Less than zero This instance is less than value. Zero This instance is equal to value. Greater than zero This 
        ...
        CompareTo(self: Decimal, value: object) -> int
            ...
            Returns: A signed number indicating the relative values of this instance and value.Return Value Meaning Less than zero This instance is less than value. Zero This instance is equal to value. Greater than zero This 
             instance is greater than value.-or- value is null.
        """
        pass
    ...
    def Round(d, *__args):
        ...
        Round(d: Decimal, decimals: int, mode: MidpointRounding) -> Decimal
            ...
            mode: A value that specifies how to round d if it is midway between two other numbers.
            Returns: The number that is nearest to the d parameter with a precision equal to the decimals parameter. If d is halfway between two numbers, one of which is even and the other odd, the mode parameter determines 
             which of the two numbers is returned. If the precision of d is less than decimals, d is returned unchanged.
