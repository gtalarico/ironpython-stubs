class FixedDocumentSequence(FrameworkContentElement,IInputElement,IAnimatable,IFrameworkInputElement,ISupportInitialize,IQueryAmbient,IDocumentPaginatorSource,IAddChildInternal,IAddChild,IServiceProvider,IFixedNavigate,IUriContext):
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: FixedDocumentSequence) -> AutomationPeer
   ...
   Returns: A System.Windows.Automation.Peers.DocumentAutomationPeer that exposes the 
    System.Windows.Documents.FixedDocumentSequence to Microsoft UI Automation.
  """
  pass
