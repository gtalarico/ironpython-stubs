class ToolStripPanel(ContainerControl,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,IContainerControl):
 ...
 def Dispose(self):
  ...
  Dispose(self: ToolStripPanel,disposing: bool)
   Releases the unmanaged resources used by the 
    System.Windows.Forms.ToolStripPanel and optionally releases the managed 
    resources.
 ...
 def Join(self,toolStripToDrag,*__args):
  ...
  Join(self: ToolStripPanel,toolStripToDrag: ToolStrip,row: int)
   Adds the specified System.Windows.Forms.ToolStrip to a 
    System.Windows.Forms.ToolStripPanel in the specified row.
  
  
   toolStripToDrag: The System.Windows.Forms.ToolStrip to add to the 
    System.Windows.Forms.ToolStripPanel.
  
   row: An System.Int32 representing the System.Windows.Forms.ToolStripPanelRow to 
    which the System.Windows.Forms.ToolStrip is added.
  
  Join(self: ToolStripPanel,toolStripToDrag: ToolStrip,x: int,y: int)
   Adds the specified System.Windows.Forms.ToolStrip to a 
    System.Windows.Forms.ToolStripPanel at the specified coordinates.
  ...
  Join(self: ToolStripPanel,toolStripToDrag: ToolStrip,location: Point)
   Adds the specified System.Windows.Forms.ToolStrip to a 
    System.Windows.Forms.ToolStripPanel at the specified location.
  
  
   toolStripToDrag: The System.Windows.Forms.ToolStrip to add to the 
    System.Windows.Forms.ToolStripPanel.
  
   location: A System.Drawing.Point value representing the x- and y-client coordinates,in 
    pixels,of the new location for the System.Windows.Forms.ToolStrip.
 ...
 def PointToRow(self,clientLocation):
  ...
  PointToRow(self: ToolStripPanel,clientLocation: Point) -> ToolStripPanelRow
   ...
   clientLocation: A System.Drawing.Point used as a reference to find the 
    System.Windows.Forms.ToolStripPanelRow.
  
   Returns: The System.Windows.Forms.ToolStripPanelRow that contains the 
    raftingContainerPoint,or null if no such 
    System.Windows.Forms.ToolStripPanelRow exists.
  """
  pass
