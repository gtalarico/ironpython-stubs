class DataGridDetailsPresenter(ContentPresenter,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: DataGridDetailsPresenter) -> AutomationPeer
   ...
   Returns a new 
    System.Windows.Automation.Peers.DataGridDetailsPresenterAutomationPeer for this 
    presenter.
 ...
 def OnRender(self,*args):
  ...
  OnRender(self: DataGridDetailsPresenter,drawingContext: DrawingContext)
   Called by the layout system to draw a horizontal line below the row details 
    section if horizontal grid lines are visible.
  
  
   drawingContext: The drawing instructions for the row details. This context is provided to the 
    layout system.
  """
  pass
