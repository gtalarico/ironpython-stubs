...
class GraphicsPath(MarshalByRefObject, ICloneable, IDisposable):
    ...
    def AddArc(self, *__args):
        ...
        AddArc(self: GraphicsPath, rect: Rectangle, startAngle: Single, sweepAngle: Single)
            ...
            rect: A System.Drawing.Rectangle that represents the rectangular bounds of the ellipse from which the arc is taken.
        ...
        AddArc(self: GraphicsPath, rect: RectangleF, startAngle: Single, sweepAngle: Single)
            ...
            rect: A System.Drawing.RectangleF that represents the rectangular bounds of the ellipse from which the arc is taken.
            startAngle: The starting angle of the arc, measured in degrees clockwise from the x-axis.
            sweepAngle: The angle between startAngle and the end of the arc.
    ...
    def AddCurve(self, points, *__args):
        ...
        AddCurve(self: GraphicsPath, points: Array[Point], offset: int, numberOfSegments: int, tension: Single)
            ...
            numberOfSegments: A value that specifies the amount that the curve bends between control points. Values greater than 1 produce unpredictable results.
            tension: A value that specifies the amount that the curve bends between control points. Values greater than 1 produce unpredictable results.
    ...
    def AddLines(self, points):
        ...
        AddLines(self: GraphicsPath, points: Array[Point])
            ...
            points: An array of System.Drawing.Point structures that represents the points that define the line segments to add.
        AddLines(self: GraphicsPath, points: Array[PointF])
            Appends a series of connected line segments to the end of this System.Drawing.Drawing2D.GraphicsPath.
        
            points: An array of System.Drawing.PointF structures that represents the points that define the line segments to add.
        """
        pass
    ...
    def AddPath(self, addingPath, connect):
        ...
        AddPath(self: GraphicsPath, addingPath: GraphicsPath, connect: bool)
            ...
            connect: A Boolean value that specifies whether the first figure in the added path is part of the last figure in this path. A value of true specifies that (if possible) the first figure in the added path is part of 
             the last figure in this path. A value of false specifies that the first figure in the added path is separate from the last figure in this path.
        """
        pass
    ...
    def AddPie(self, *__args):
        ...
        AddPie(self: GraphicsPath, rect: Rectangle, startAngle: Single, sweepAngle: Single)
            ...
            rect: A System.Drawing.Rectangle that represents the bounding rectangle that defines the ellipse from which the pie is drawn.
            startAngle: The starting angle for the pie section, measured in degrees clockwise from the x-axis.
            sweepAngle: The angle between startAngle and the end of the pie section, measured in degrees clockwise from startAngle.
        """
        pass
    ...
    def AddString(self, s, family, style, emSize, *__args):
        ...
        AddString(self: GraphicsPath, s: str, family: FontFamily, style: int, emSize: Single, layoutRect: RectangleF, format: StringFormat)
            ...
            style: A System.Drawing.FontStyle enumeration that represents style information about the text (bold, italic, and so on). This must be cast as an integer (see the example code later in this section).
            ...
            format: A System.Drawing.StringFormat that specifies text formatting information, such as line spacing and alignment.
    ...
    def CloseFigure(self):
        ...
        CloseFigure(self: GraphicsPath)
            Closes the current figure and starts a new figure. If the current figure contains a sequence of connected lines and curves, the method closes the loop by connecting a line from the endpoint to the starting 
             point.
        """
        pass
    ...
    def Flatten(self, matrix=None, flatness=None):
        ...
        Flatten(self: GraphicsPath, matrix: Matrix, flatness: Single)
            ...
            matrix: A System.Drawing.Drawing2D.Matrix by which to transform this System.Drawing.Drawing2D.GraphicsPath before flattening.
            flatness: Specifies the maximum permitted error between the curve and its flattened approximation. A value of 0.25 is the default. Reducing the flatness value will increase the number of line segments in the 
             approximation.
    ...
    def GetBounds(self, matrix=None, pen=None):
        ...
        GetBounds(self: GraphicsPath, matrix: Matrix, pen: Pen) -> RectangleF
            ...
            Returns a rectangle that bounds this System.Drawing.Drawing2D.GraphicsPath when the current path is transformed by the specified System.Drawing.Drawing2D.Matrix and drawn with the specified 
             System.Drawing.Pen.
        
        
            matrix: The System.Drawing.Drawing2D.Matrix that specifies a transformation to be applied to this path before the bounding rectangle is calculated. This path is not permanently transformed; the transformation is 
             used only during the process of calculating the bounding rectangle.
        
            pen: The System.Drawing.Pen with which to draw the System.Drawing.Drawing2D.GraphicsPath.
            Returns: A System.Drawing.RectangleF that represents a rectangle that bounds this System.Drawing.Drawing2D.GraphicsPath.
    ...
    def GetLastPoint(self):
        ...
        GetLastPoint(self: GraphicsPath) -> PointF
            ...
            Gets the last point in the System.Drawing.Drawing2D.GraphicsPath.PathPoints array of this System.Drawing.Drawing2D.GraphicsPath.
            Returns: A System.Drawing.PointF that represents the last point in this System.Drawing.Drawing2D.GraphicsPath.
        """
        pass
    ...
    def IsOutlineVisible(self, *__args):
        ...
        IsOutlineVisible(self: GraphicsPath, point: Point, pen: Pen) -> bool
            ...
            Returns: This method returns true if the specified point is contained within the outline of this System.Drawing.Drawing2D.GraphicsPath when drawn with the specified System.Drawing.Pen; otherwise, false.
        ...
        IsOutlineVisible(self: GraphicsPath, pt: Point, pen: Pen, graphics: Graphics) -> bool
            ...
            Indicates whether the specified point is contained within (under) the outline of this System.Drawing.Drawing2D.GraphicsPath when drawn with the specified System.Drawing.Pen and using the specified 
            ...
            Returns: This method returns true if the specified point is contained within the outline of this System.Drawing.Drawing2D.GraphicsPath as drawn with the specified System.Drawing.Pen; otherwise, false.
        ...
        IsOutlineVisible(self: GraphicsPath, pt: PointF, pen: Pen, graphics: Graphics) -> bool
            ...
            pen: The System.Drawing.Pen to test.
            graphics: The System.Drawing.Graphics for which to test visibility.
            Returns: This method returns true if the specified point is contained within (under) the outline of this System.Drawing.Drawing2D.GraphicsPath as drawn with the specified System.Drawing.Pen; otherwise, false.
    ...
    def IsVisible(self, *__args):
        ...
        IsVisible(self: GraphicsPath, point: Point) -> bool
            ...
            Returns: This method returns true if the specified point is contained within this System.Drawing.Drawing2D.GraphicsPath; otherwise, false.
    ...
    def Reset(self):
        ...
        Reset(self: GraphicsPath)
            Empties the System.Drawing.Drawing2D.GraphicsPath.PathPoints and System.Drawing.Drawing2D.GraphicsPath.PathTypes arrays and sets the System.Drawing.Drawing2D.FillMode to 
    ...
    def Reverse(self):
        ...
        Reverse(self: GraphicsPath)
            Reverses the order of points in the System.Drawing.Drawing2D.GraphicsPath.PathPoints array of this System.Drawing.Drawing2D.GraphicsPath.
        """
        pass
    ...
    def Warp(self, destPoints, srcRect, matrix=None, warpMode=None, flatness=None):
        ...
        Warp(self: GraphicsPath, destPoints: Array[PointF], srcRect: RectangleF, matrix: Matrix, warpMode: WarpMode)
            ...
            destPoints: An array of System.Drawing.PointF structures that defines a parallelogram to which the rectangle defined by srcRect is transformed. The array can contain either three or four elements. If the array 
             contains three elements, the lower-right corner of the parallelogram is implied by the first three points.
        
            srcRect: A System.Drawing.RectangleF that represents the rectangle that is transformed to the parallelogram defined by destPoints.
            matrix: A System.Drawing.Drawing2D.Matrix that specifies a geometric transform to apply to the path.
            warpMode: A System.Drawing.Drawing2D.WarpMode enumeration that specifies whether this warp operation uses perspective or bilinear mode.
        Warp(self: GraphicsPath, destPoints: Array[PointF], srcRect: RectangleF, matrix: Matrix, warpMode: WarpMode, flatness: Single)
            Applies a warp transform, defined by a rectangle and a parallelogram, to this System.Drawing.Drawing2D.GraphicsPath.
        
            destPoints: An array of System.Drawing.PointF structures that define a parallelogram to which the rectangle defined by srcRect is transformed. The array can contain either three or four elements. If the array contains 
             three elements, the lower-right corner of the parallelogram is implied by the first three points.
        
            srcRect: A System.Drawing.RectangleF that represents the rectangle that is transformed to the parallelogram defined by destPoints.
            matrix: A System.Drawing.Drawing2D.Matrix that specifies a geometric transform to apply to the path.
            warpMode: A System.Drawing.Drawing2D.WarpMode enumeration that specifies whether this warp operation uses perspective or bilinear mode.
            flatness: A value from 0 through 1 that specifies how flat the resulting path is. For more information, see the System.Drawing.Drawing2D.GraphicsPath.Flatten methods.
    ...
    def Widen(self, pen, matrix=None, flatness=None):
        ...
        Widen(self: GraphicsPath, pen: Pen, matrix: Matrix, flatness: Single)
            ...
            pen: A System.Drawing.Pen that specifies the width between the original outline of the path and the new outline this method creates.
            matrix: A System.Drawing.Drawing2D.Matrix that specifies a transform to apply to the path before widening.
...
class GraphicsPathIterator(MarshalByRefObject, IDisposable):
    ...
    def CopyData(self, points, types, startIndex, endIndex):
        ...
        CopyData(self: GraphicsPathIterator, points: Array[PointF], types: Array[Byte], startIndex: int, endIndex: int) -> (int, Array[PointF], Array[Byte])
            ...
            Copies the System.Drawing.Drawing2D.GraphicsPath.PathPoints property and System.Drawing.Drawing2D.GraphicsPath.PathTypes property arrays of the associated System.Drawing.Drawing2D.GraphicsPath into the two 
             specified arrays.
        
        
            points: Upon return, contains an array of System.Drawing.PointF structures that represents the points in the path.
    ...
    def NextMarker(self, *__args):
        ...
        NextMarker(self: GraphicsPathIterator, path: GraphicsPath) -> int
            ...
            This System.Drawing.Drawing2D.GraphicsPathIterator object has a System.Drawing.Drawing2D.GraphicsPath object associated with it. The 
             System.Drawing.Drawing2D.GraphicsPathIterator.NextMarker(System.Drawing.Drawing2D.GraphicsPath) method increments the associated System.Drawing.Drawing2D.GraphicsPath to the next marker in its path and 
             copies all the points contained between the current marker and the next marker (or end of path) to a second System.Drawing.Drawing2D.GraphicsPath object passed in to the parameter.
        ...
        NextMarker(self: GraphicsPathIterator) -> (int, int, int)
            ...
            Increments the System.Drawing.Drawing2D.GraphicsPathIterator to the next marker in the path and returns the start and stop indexes by way of the [out] parameters.
            Returns: The number of points between this marker and the next.
        """
        pass
    ...
    def NextPathType(self, pathType, startIndex, endIndex):
        ...
        NextPathType(self: GraphicsPathIterator) -> (int, Byte, int, int)
            ...
            Returns: This method returns the number of data points in the group. If there are no more groups in the path, this method returns 0.
        """
        pass
    ...
    def NextSubpath(self, *__args):
        ...
        NextSubpath(self: GraphicsPathIterator, path: GraphicsPath) -> (int, bool)
            ...
            Gets the next figure (subpath) from the associated path of this System.Drawing.Drawing2D.GraphicsPathIterator.
        
            path: A System.Drawing.Drawing2D.GraphicsPath that is to have its data points set to match the data points of the retrieved figure (subpath) for this iterator.
            Returns: The number of data points in the retrieved figure (subpath). If there are no more figures to retrieve, zero is returned.
        NextSubpath(self: GraphicsPathIterator) -> (int, int, int, bool)
        
            Moves the System.Drawing.Drawing2D.GraphicsPathIterator to the next subpath in the path. The start index and end index of the next subpath are contained in the [out] parameters.
...
class LinearGradientBrush(Brush, ICloneable, IDisposable):
    ...
    def MultiplyTransform(self, matrix, order=None):
        ...
        MultiplyTransform(self: LinearGradientBrush, matrix: Matrix, order: MatrixOrder)
            Multiplies the System.Drawing.Drawing2D.Matrix that represents the local geometric transform of this System.Drawing.Drawing2D.LinearGradientBrush by the specified System.Drawing.Drawing2D.Matrix in the 
             specified order.
        
        
            matrix: The System.Drawing.Drawing2D.Matrix by which to multiply the geometric transform.
            order: A System.Drawing.Drawing2D.MatrixOrder that specifies in which order to multiply the two matrices.
        MultiplyTransform(self: LinearGradientBrush, matrix: Matrix)
            Multiplies the System.Drawing.Drawing2D.Matrix that represents the local geometric transform of this System.Drawing.Drawing2D.LinearGradientBrush by the specified System.Drawing.Drawing2D.Matrix by 
             prepending the specified System.Drawing.Drawing2D.Matrix.
...
class Matrix(MarshalByRefObject, IDisposable):
    ...
    def Equals(self, obj):
        ...
        Equals(self: Matrix, obj: object) -> bool
            ...
            Tests whether the specified object is a System.Drawing.Drawing2D.Matrix and is identical to this System.Drawing.Drawing2D.Matrix.
        
            obj: The object to test.
            Returns: This method returns true if obj is the specified System.Drawing.Drawing2D.Matrix identical to this System.Drawing.Drawing2D.Matrix; otherwise, false.
        """
        pass
    ...
    def Multiply(self, matrix, order=None):
        ...
        Multiply(self: Matrix, matrix: Matrix, order: MatrixOrder)
            Multiplies this System.Drawing.Drawing2D.Matrix by the matrix specified in the matrix parameter, and in the order specified in the order parameter.
        
            matrix: The System.Drawing.Drawing2D.Matrix by which this System.Drawing.Drawing2D.Matrix is to be multiplied.
        ...
        Multiply(self: Matrix, matrix: Matrix)
            Multiplies this System.Drawing.Drawing2D.Matrix by the matrix specified in the matrix parameter, by prepending the specified System.Drawing.Drawing2D.Matrix.
    ...
    def Rotate(self, angle, order=None):
        ...
        Rotate(self: Matrix, angle: Single, order: MatrixOrder)
            Applies a clockwise rotation of an amount specified in the angle parameter, around the origin (zero x and y coordinates) for this System.Drawing.Drawing2D.Matrix.
        
            angle: The angle (extent) of the rotation, in degrees.
            order: A System.Drawing.Drawing2D.MatrixOrder that specifies the order (append or prepend) in which the rotation is applied to this System.Drawing.Drawing2D.Matrix.
        Rotate(self: Matrix, angle: Single)
            Prepend to this System.Drawing.Drawing2D.Matrix a clockwise rotation, around the origin and by the specified angle.
    ...
    def RotateAt(self, angle, point, order=None):
        ...
        RotateAt(self: Matrix, angle: Single, point: PointF, order: MatrixOrder)
            Applies a clockwise rotation about the specified point to this System.Drawing.Drawing2D.Matrix in the specified order.
        
            angle: The angle of the rotation, in degrees.
            point: A System.Drawing.PointF that represents the center of the rotation.
            order: A System.Drawing.Drawing2D.MatrixOrder that specifies the order (append or prepend) in which the rotation is applied.
        RotateAt(self: Matrix, angle: Single, point: PointF)
            Applies a clockwise rotation to this System.Drawing.Drawing2D.Matrix around the point specified in the point parameter, and by prepending the rotation.
    ...
    def Scale(self, scaleX, scaleY, order=None):
        ...
        Scale(self: Matrix, scaleX: Single, scaleY: Single, order: MatrixOrder)
            Applies the specified scale vector (scaleX and scaleY) to this System.Drawing.Drawing2D.Matrix using the specified order.
            ...
            order: A System.Drawing.Drawing2D.MatrixOrder that specifies the order (append or prepend) in which the scale vector is applied to this System.Drawing.Drawing2D.Matrix.
        Scale(self: Matrix, scaleX: Single, scaleY: Single)
            Applies the specified scale vector to this System.Drawing.Drawing2D.Matrix by prepending the scale vector.
    ...
    def Shear(self, shearX, shearY, order=None):
        ...
        Shear(self: Matrix, shearX: Single, shearY: Single, order: MatrixOrder)
            Applies the specified shear vector to this System.Drawing.Drawing2D.Matrix in the specified order.
        
            shearX: The horizontal shear factor.
            shearY: The vertical shear factor.
            order: A System.Drawing.Drawing2D.MatrixOrder that specifies the order (append or prepend) in which the shear is applied.
        Shear(self: Matrix, shearX: Single, shearY: Single)
            Applies the specified shear vector to this System.Drawing.Drawing2D.Matrix by prepending the shear transformation.
    ...
    def TransformPoints(self, pts):
        ...
        TransformPoints(self: Matrix, pts: Array[Point])
            Applies the geometric transform represented by this System.Drawing.Drawing2D.Matrix to a specified array of points.
    ...
    def TransformVectors(self, pts):
        ...
        TransformVectors(self: Matrix, pts: Array[Point])
            Applies only the scale and rotate components of this System.Drawing.Drawing2D.Matrix to the specified array of points.
    ...
    def Translate(self, offsetX, offsetY, order=None):
        ...
        Translate(self: Matrix, offsetX: Single, offsetY: Single, order: MatrixOrder)
            Applies the specified translation vector to this System.Drawing.Drawing2D.Matrix in the specified order.
            ...
            order: A System.Drawing.Drawing2D.MatrixOrder that specifies the order (append or prepend) in which the translation is applied to this System.Drawing.Drawing2D.Matrix.
        Translate(self: Matrix, offsetX: Single, offsetY: Single)
            Applies the specified translation vector (offsetX and offsetY) to this System.Drawing.Drawing2D.Matrix by prepending the translation vector.
...
class PathGradientBrush(Brush, ICloneable, IDisposable):
    ...
    def MultiplyTransform(self, matrix, order=None):
        ...
        MultiplyTransform(self: PathGradientBrush, matrix: Matrix, order: MatrixOrder)
            ...
            matrix: The System.Drawing.Drawing2D.Matrix that will be multiplied by the brush's current transformation matrix.
            order: A System.Drawing.Drawing2D.MatrixOrder that specifies in which order to multiply the two matrices.
    ...
    def SetBlendTriangularShape(self, focus, scale=None):
        ...
        SetBlendTriangularShape(self: PathGradientBrush, focus: Single, scale: Single)
            ...
            focus: A value from 0 through 1 that specifies where, along any radial from the center of the path to the path's boundary, the center color will be at its highest intensity. A value of 1 (the default) places the 
             highest intensity at the center of the path.
        
            scale: A value from 0 through 1 that specifies the maximum intensity of the center color that gets blended with the boundary color. A value of 1 causes the highest possible intensity of the center color, and it 
