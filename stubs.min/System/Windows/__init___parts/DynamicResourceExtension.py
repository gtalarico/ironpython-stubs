class DynamicResourceExtension(MarkupExtension):
    ...
    def ProvideValue(self, serviceProvider):
        ...
        ProvideValue(self: DynamicResourceExtension, serviceProvider: IServiceProvider) -> object
            ...
            Returns an object that should be set on the property where this extension is applied. For System.Windows.DynamicResourceExtension, this is the object found in a resource dictionary in the current parent 
             chain that is keyed by the System.Windows.DynamicResourceExtension.ResourceKey.
        
        
            serviceProvider: Object that can provide services for the markup extension.
            Returns: The object to set on the property where the extension is applied. Rather than the actual value, this will be an expression that will be evaluated at a later time.
        """
        pass
