class MessageBox(object):
 ...
 def Show(*__args):
  ...
  Show(text: str,caption: str,buttons: MessageBoxButtons,icon: MessageBoxIcon,defaultButton: MessageBoxDefaultButton,options: MessageBoxOptions,displayHelpButton: bool) -> DialogResult
   ...
   options: One of the System.Windows.Forms.MessageBoxOptions values that specifies which display and association options will be used for the message box. You may pass in 0 if you wish to use the defaults.
  ...
  Show(owner: IWin32Window,text: str,caption: str,buttons: MessageBoxButtons,icon: MessageBoxIcon,defaultButton: MessageBoxDefaultButton,options: MessageBoxOptions) -> DialogResult
   ...
   buttons: One of the System.Windows.Forms.MessageBoxButtons values that specifies which buttons to display in the message box.
   icon: One of the System.Windows.Forms.MessageBoxIcon values that specifies which icon to display in the message box.
   defaultButton: One of the System.Windows.Forms.MessageBoxDefaultButton values the specifies the default button for the message box.
   options: One of the System.Windows.Forms.MessageBoxOptions values that specifies which display and association options will be used for the message box. You may pass in 0 if you wish to use the defaults.
   Returns: One of the System.Windows.Forms.DialogResult values.
