class Control(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 ...
 def ToString(self):
  ...
  ToString(self: Window_16$17) -> str
  ToString(self: Label_17$18) -> str
  ToString(self: TextBox_18$19) -> str
  ToString(self: Button_19$20) -> str
  ToString(self: CheckBox_20$21) -> str
  ToString(self: ComboBox_21$22) -> str
  ToString(self: Separator_22$23) -> str
  """
  pass
