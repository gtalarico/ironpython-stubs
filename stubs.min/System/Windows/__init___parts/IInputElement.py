class IInputElement:
    ...
    def Focus(self):
        ...
        Focus(self: IInputElement) -> bool
            ...
            Returns: true if keyboard focus is moved to this element or already was on this element; otherwise, false.
        """
        pass
    ...
    def RaiseEvent(self, e):
        ...
        RaiseEvent(self: IInputElement, e: RoutedEventArgs)
            Raises the routed event that is specified by the System.Windows.RoutedEventArgs.RoutedEvent property within the provided System.Windows.RoutedEventArgs.
        
            e: An instance of the System.Windows.RoutedEventArgs class that contains the identifier for the event to raise.
        """
        pass
    ...
    def RemoveHandler(self, routedEvent, handler):
        ...
        RemoveHandler(self: IInputElement, routedEvent: RoutedEvent, handler: Delegate)
            ...
            handler: The specific handler implementation to remove from this element's event handler collection.
        """
        pass
