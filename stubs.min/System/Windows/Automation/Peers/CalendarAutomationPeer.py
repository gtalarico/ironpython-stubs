class CalendarAutomationPeer(FrameworkElementAutomationPeer, IGridProvider, IMultipleViewProvider, ISelectionProvider, ITableProvider, IItemContainerProvider):
    ...
    def GetPattern(self, patternInterface):
        ...
        GetPattern(self: CalendarAutomationPeer, patternInterface: PatternInterface) -> object
            ...
            Returns: If patternInterface is System.Windows.Automation.Peers.PatternInterface.Grid, System.Windows.Automation.Peers.PatternInterface.Table, System.Windows.Automation.Peers.PatternInterface.MultipleView, or 
             System.Windows.Automation.Peers.PatternInterface.Selection, this method returns a this pointer; otherwise, this method returns null.
        """
        pass
