class GridColumnStylesCollection(BaseCollection, ICollection, IEnumerable, IList):
    ...
    def Contains(self, *__args):
        ...
        Contains(self: GridColumnStylesCollection, propertyDescriptor: PropertyDescriptor) -> bool
            ...
            Gets a value indicating whether the System.Windows.Forms.GridColumnStylesCollection contains a System.Windows.Forms.DataGridColumnStyle associated with the specified 
