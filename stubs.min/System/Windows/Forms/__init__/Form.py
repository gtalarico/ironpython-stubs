class Form(ContainerControl, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent, IContainerControl):
    ...
    def ToString(self):
        ...
        ToString(self: Form) -> str
            ...
            Returns: A string consisting of the fully qualified name of the form object's class, with the System.Windows.Forms.Form.Text property of the form appended to the end. For example, if the form is derived from the 
             class MyForm in the MyNamespace namespace, and the System.Windows.Forms.Form.Text property is set to Hello, World, this method will return MyNamespace.MyForm, Text: Hello, World.
        """
        pass
    ...
    def ValidateChildren(self, validationConstraints=None):
        ...
        ValidateChildren(self: Form, validationConstraints: ValidationConstraints) -> bool
            ...
            Returns: true if all of the children validated successfully; otherwise, false. If called from the System.Windows.Forms.Control.Validating or System.Windows.Forms.Control.Validated event handlers, this method will 
             always return false.
    ...
    AcceptButton = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ActiveMdiChild = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AutoScale = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AutoScaleBaseSize = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AutoValidate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ControlBox = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DesktopBounds = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DesktopLocation = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    FormBorderStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsMdiChild = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsMdiContainer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsRestrictedWindow = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    KeyPreview = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MainMenuStrip = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MaximizeBox = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MdiChildren = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MdiParent = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    Menu = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MergedMenu = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MinimizeBox = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    OwnedForms = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ShowIcon = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SizeGripStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    TransparencyKey = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
