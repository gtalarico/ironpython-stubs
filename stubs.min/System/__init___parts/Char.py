class Char(object, IComparable, IConvertible, IComparable[Char], IEquatable[Char]):
    ...
    def CompareTo(self, value):
        ...
        CompareTo(self: Char, value: Char) -> int
            ...
            Returns: A signed number indicating the position of this instance in the sort order in relation to the value parameter.Return Value Description Less than zero This instance precedes value. Zero This instance has 
             the same position in the sort order as value. Greater than zero This instance follows value.
    ...
    def IsSurrogatePair(*__args):
        ...
        IsSurrogatePair(s: str, index: int) -> bool
            ...
            Returns: true if the s parameter includes adjacent characters at positions index and index + 1, and the numeric value of the character at position index ranges from U+D800 through U+DBFF, and the numeric value of 
             the character at position index+1 ranges from U+DC00 through U+DFFF; otherwise, false.
        """
        pass
