class RectangleGeometry(Geometry,ISealable,IAnimatable,IResource,IFormattable):
 ...
 def Clone(self):
  ...
  Clone(self: RectangleGeometry) -> RectangleGeometry
   ...
   Creates a modifiable clone of this System.Windows.Media.RectangleGeometry,
 ...
 def GetArea(self,tolerance=None,type=None):
  ...
  GetArea(self: RectangleGeometry,tolerance: float,type: ToleranceType) -> float
   ...
   Gets the area of the filled region of this 
    System.Windows.Media.RectangleGeometry object.
  
  
   tolerance: The computational tolerance of error.
   type: Specifies how the error tolerance will be interpreted.
   Returns: The area of the filled region of this System.Windows.Media.RectangleGeometry 
    object.
  """
  pass
 ...
 def MayHaveCurves(self):
  ...
  MayHaveCurves(self: RectangleGeometry) -> bool
   ...
   Determines whether this System.Windows.Media.RectangleGeometry object may have 
    curved segments.
  
   Returns: true if this System.Windows.Media.RectangleGeometry object may have curved 
...
"""
 ...
 Rect=property(lambda self: object(),lambda self,v: None,lambda self: None)
