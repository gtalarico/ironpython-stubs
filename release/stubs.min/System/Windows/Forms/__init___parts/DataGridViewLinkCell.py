class DataGridViewLinkCell(DataGridViewCell,ICloneable,IDisposable):
 ...
 def KeyUpUnsharesRow(self,*args):
  ...
  KeyUpUnsharesRow(self: DataGridViewLinkCell,e: KeyEventArgs,rowIndex: int) -> bool
   ...
   Returns: true if the SPACE key was released,the System.Windows.Forms.DataGridViewLinkCell.TrackVisitedState property is true,the System.Windows.Forms.DataGridViewLinkCell.LinkVisited property is false,and the CTRL,ALT,and SHIFT keys are not pressed; otherwise,false.
  """
  pass
