class DataGridAutomationPeer(ItemsControlAutomationPeer, IItemContainerProvider, IGridProvider, ISelectionProvider, ITableProvider):
    ...
    def GetPattern(self, patternInterface):
        ...
        GetPattern(self: DataGridAutomationPeer, patternInterface: PatternInterface) -> object
            ...
            Returns: If patternInterface is System.Windows.Automation.Peers.PatternInterface.Grid, System.Windows.Automation.Peers.PatternInterface.Selection, or System.Windows.Automation.Peers.PatternInterface.Table, this 
             method returns a this pointer; otherwise, this method returns null.
        """
        pass
