class ControlPaint:
 ...
 def CreateHBitmapTransparencyMask(bitmap):
  ...
  CreateHBitmapTransparencyMask(bitmap: Bitmap) -> IntPtr
   ...
   Creates a color mask for the specified bitmap that indicates which color should be 
 ...
 def Dark(baseColor,percOfDarkDark=None):
  ...
  Dark(baseColor: Color,percOfDarkDark: Single) -> Color
   ...
   Creates a new dark color object for the control from the specified color and darkens it 
 ...
 def DrawBorder(graphics,bounds,*__args):
  ...
  DrawBorder(graphics: Graphics,bounds: Rectangle,color: Color,style: ButtonBorderStyle)
   Draws a border with the specified style and color,on the specified graphics surface,and 
    within the specified bounds on a button-style control.
   ...
   style: One of the System.Windows.Forms.ButtonBorderStyle values that specifies the style of the 
    border.
  ...
  DrawBorder(graphics: Graphics,bounds: Rectangle,leftColor: Color,leftWidth: int,leftStyle: ButtonBorderStyle,topColor: Color,topWidth: int,topStyle: ButtonBorderStyle,rightColor: Color,rightWidth: int,rightStyle: ButtonBorderStyle,bottomColor: Color,bottomWidth: int,bottomStyle: ButtonBorderStyle)
   ...
   leftStyle: One of the System.Windows.Forms.ButtonBorderStyle values that specifies the style of the 
    left border.
  
   topColor: The System.Drawing.Color of the top of the border.
   topWidth: The width of the top border.
   topStyle: One of the System.Windows.Forms.ButtonBorderStyle values that specifies the style of the 
    top border.
  
   rightColor: The System.Drawing.Color of the right of the border.
   rightWidth: The width of the right border.
   rightStyle: One of the System.Windows.Forms.ButtonBorderStyle values that specifies the style of the 
    right border.
  
   bottomColor: The System.Drawing.Color of the bottom of the border.
   bottomWidth: The width of the bottom border.
   bottomStyle: One of the System.Windows.Forms.ButtonBorderStyle values that specifies the style of the 
    bottom border.
  """
  pass
 @staticmethod
 def DrawBorder3D(graphics,*__args):
  ...
  DrawBorder3D(graphics: Graphics,rectangle: Rectangle,style: Border3DStyle)
   Draws a three-dimensional style border with the specified style,on the specified 
    graphics surface,and within the specified bounds on a control.
  
  
   graphics: The System.Drawing.Graphics to draw on.
   rectangle: The System.Drawing.Rectangle that represents the dimensions of the border.
   style: One of the System.Windows.Forms.Border3DStyle values that specifies the style of the 
    border.
  
  DrawBorder3D(graphics: Graphics,rectangle: Rectangle,style: Border3DStyle,sides: Border3DSide)
   Draws a three-dimensional style border with the specified style,on the specified 
    graphics surface and sides,and within the specified bounds on a control.
   ...
   sides: One of the System.Windows.Forms.Border3DSide values that specifies the side of the 
    rectangle to draw the border on.
  ...
  DrawBorder3D(graphics: Graphics,x: int,y: int,width: int,height: int,style: Border3DStyle,sides: Border3DSide)
   Draws a three-dimensional style border with the specified style,on the specified 
    graphics surface and side,and within the specified bounds on a control.
 ...
 def DrawButton(graphics,*__args):
  ...
  DrawButton(graphics: Graphics,rectangle: Rectangle,state: ButtonState)
   Draws a button control in the specified state,on the specified graphics surface,and 
    within the specified bounds.
  
  
   graphics: The System.Drawing.Graphics to draw on.
   rectangle: The System.Drawing.Rectangle that represents the dimensions of the button.
   state: A bitwise combination of the System.Windows.Forms.ButtonState values that specifies the 
 ...
 def DrawCaptionButton(graphics,*__args):
  ...
  DrawCaptionButton(graphics: Graphics,rectangle: Rectangle,button: CaptionButton,state: ButtonState)
   Draws the specified caption button control in the specified state,on the specified 
   ...
   button: One of the System.Windows.Forms.CaptionButton values that specifies the type of caption 
    button to draw.
 ...
 def DrawCheckBox(graphics,*__args):
  ...
  DrawCheckBox(graphics: Graphics,x: int,y: int,width: int,height: int,state: ButtonState)
   Draws a check box control in the specified state,on the specified graphics surface,and 
    within the specified bounds.
 ...
 def DrawComboButton(graphics,*__args):
  ...
  DrawComboButton(graphics: Graphics,rectangle: Rectangle,state: ButtonState)
   ...
   state: A bitwise combination of the System.Windows.Forms.ButtonState values that specifies the 
    state to draw the combo box in.
 ...
 def DrawContainerGrabHandle(graphics,bounds):
  ...
  DrawContainerGrabHandle(graphics: Graphics,bounds: Rectangle)
   Draws a container control grab handle glyph on the specified graphics surface and within 
 ...
 def DrawFocusRectangle(graphics,rectangle,foreColor=None,backColor=None):
  ...
  DrawFocusRectangle(graphics: Graphics,rectangle: Rectangle,foreColor: Color,backColor: Color)
   ...
   graphics: The System.Drawing.Graphics to draw on.
   rectangle: The System.Drawing.Rectangle that represents the dimensions of the grab handle glyph.
   foreColor: The System.Drawing.Color that is the foreground color of the object to draw the focus 
    rectangle on.
  
   backColor: The System.Drawing.Color that is the background color of the object to draw the focus 
    rectangle on.
  """
  pass
 @staticmethod
 def DrawGrabHandle(graphics,rectangle,primary,enabled):
  ...
  DrawGrabHandle(graphics: Graphics,rectangle: Rectangle,primary: bool,enabled: bool)
   Draws a standard selection grab handle glyph on the specified graphics surface,within 
    the specified bounds,and in the specified state and style.
 ...
 def DrawGrid(graphics,area,pixelsBetweenDots,backColor):
  ...
  DrawGrid(graphics: Graphics,area: Rectangle,pixelsBetweenDots: Size,backColor: Color)
   Draws a grid of one-pixel dots with the specified spacing,within the specified bounds,
    on the specified graphics surface,and in the specified color.
 ...
 def DrawLockedFrame(graphics,rectangle,primary):
  ...
  DrawLockedFrame(graphics: Graphics,rectangle: Rectangle,primary: bool)
   Draws a locked selection frame on the screen within the specified bounds and on the 
    specified graphics surface. Specifies whether to draw the frame with the primary selected 
    colors.
 ...
 def DrawMenuGlyph(graphics,*__args):
  ...
  DrawMenuGlyph(graphics: Graphics,rectangle: Rectangle,glyph: MenuGlyph)
   Draws the specified menu glyph on a menu item control within the specified bounds and on 
  ...
  DrawMenuGlyph(graphics: Graphics,rectangle: Rectangle,glyph: MenuGlyph,foreColor: Color,backColor: Color)
   Draws the specified menu glyph on a menu item control within the specified bounds and on 
    the specified surface,replacing System.Drawing.Color.White with the color specified in 
    the backColor parameter and replacing System.Drawing.Color.Black with the color specified 
    in the foreColor parameter.
  ...
  DrawMenuGlyph(graphics: Graphics,x: int,y: int,width: int,height: int,glyph: MenuGlyph)
   Draws the specified menu glyph on a menu item control with the specified bounds and on 
    the specified surface.
  ...
  DrawMenuGlyph(graphics: Graphics,x: int,y: int,width: int,height: int,glyph: MenuGlyph,foreColor: Color,backColor: Color)
   Draws the specified menu glyph on a menu item control within the specified coordinates,
    height,and width on the specified surface,replacing System.Drawing.Color.White with the 
    color specified in the backColor parameter and replacing System.Drawing.Color.Black with 
    the color specified in the foreColor parameter.
 ...
 def DrawMixedCheckBox(graphics,*__args):
  ...
  DrawMixedCheckBox(graphics: Graphics,rectangle: Rectangle,state: ButtonState)
   Draws a three-state check box control in the specified state,on the specified graphics 
 ...
 def DrawRadioButton(graphics,*__args):
  ...
  DrawRadioButton(graphics: Graphics,x: int,y: int,width: int,height: int,state: ButtonState)
   Draws a radio button control in the specified state,on the specified graphics surface,
   ...
   state: A bitwise combination of the System.Windows.Forms.ButtonState values that specifies the 
    state to draw the radio button in.
 ...
 def DrawReversibleFrame(rectangle,backColor,style):
  ...
  DrawReversibleFrame(rectangle: Rectangle,backColor: Color,style: FrameStyle)
   ...
   rectangle: The System.Drawing.Rectangle that represents the dimensions of the rectangle to draw,in 
    screen coordinates.
 ...
 def DrawReversibleLine(start,end,backColor):
  ...
  DrawReversibleLine(start: Point,end: Point,backColor: Color)
   Draws a reversible line on the screen within the specified starting and ending points and 
 ...
 def DrawScrollButton(graphics,*__args):
  ...
  DrawScrollButton(graphics: Graphics,rectangle: Rectangle,button: ScrollButton,state: ButtonState)
   ...
   graphics: The System.Drawing.Graphics to draw on.
   rectangle: The System.Drawing.Rectangle that represents the dimensions of the glyph.
   button: One of the System.Windows.Forms.ScrollButton values that specifies the type of scroll 
    arrow to draw.
  
   state: A bitwise combination of the System.Windows.Forms.ButtonState values that specifies the 
    state to draw the scroll button in.
 ...
 def DrawSelectionFrame(graphics,active,outsideRect,insideRect,backColor):
  ...
  DrawSelectionFrame(graphics: Graphics,active: bool,outsideRect: Rectangle,insideRect: Rectangle,backColor: Color)
   Draws a standard selection frame in the specified state,on the specified graphics 
    surface,with the specified inner and outer dimensions,and with the specified background 
    color.
 ...
 def DrawSizeGrip(graphics,backColor,*__args):
  ...
  DrawSizeGrip(graphics: Graphics,backColor: Color,bounds: Rectangle)
   Draws a size grip on a form with the specified bounds and background color and on the 
 ...
 def DrawStringDisabled(*__args):
  ...
  DrawStringDisabled(graphics: Graphics,s: str,font: Font,color: Color,layoutRectangle: RectangleF,format: StringFormat)
   Draws the specified string in a disabled state on the specified graphics surface; within 
    the specified bounds; and in the specified font,color,and format.
  ...
  DrawStringDisabled(dc: IDeviceContext,s: str,font: Font,color: Color,layoutRectangle: Rectangle,format: TextFormatFlags)
   Draws the specified string in a disabled state on the specified graphics surface,within 
    the specified bounds,and in the specified font,color,and format,using the specified 
    GDI-based System.Windows.Forms.TextRenderer.
 ...
 def FillReversibleRectangle(rectangle,backColor):
  ...
  FillReversibleRectangle(rectangle: Rectangle,backColor: Color)
   ...
   rectangle: The System.Drawing.Rectangle that represents the dimensions of the rectangle to fill,in 
    screen coordinates.
 ...
 def Light(baseColor,percOfLightLight=None):
  ...
  Light(baseColor: Color,percOfLightLight: Single) -> Color
   ...
   Creates a new light color object for the control from the specified color and lightens it 
    by the specified percentage.
