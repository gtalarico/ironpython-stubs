class FontConverter(TypeConverter):
 ...
 def CreateInstance(self,*__args):
  ...
  CreateInstance(self: FontConverter,context: ITypeDescriptorContext,propertyValues: IDictionary) -> object
   ...
   Returns: The newly created object,or null if the object could not be created. The default implementation returns null.System.Drawing.FontConverter.CreateInstance(System.ComponentModel.ITypeDescriptorContext,System.Collections.IDictionary) useful for creating non-changeable objects that have changeable properties.
  """
  pass
 ...
 def GetProperties(self,*__args):
  ...
  GetProperties(self: FontConverter,context: ITypeDescriptorContext,value: object,attributes: Array[Attribute]) -> PropertyDescriptorCollection
   ...
   Returns: The set of properties that should be exposed for this data type. If no properties should be exposed,this may return null. The default implementation always returns null.An easy implementation of this method can call the erload:System.ComponentModel.TypeConverter.GetProperties method for the correct data type.
  """
  pass
 def GetPropertiesSupported(self,context=None):
  ...
  GetPropertiesSupported(self: FontConverter,context: ITypeDescriptorContext) -> bool
   ...
   context: A type descriptor through which additional context can be provided.
   Returns: This method returns true if the System.Drawing.FontConverter.GetPropertiesSupported(System.ComponentModel.ITypeDescriptorContext) method should be called to find the properties of this object; otherwise,false.
  """
  pass
