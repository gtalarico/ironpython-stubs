class ParallelTimeline(TimelineGroup, ISealable, IAnimatable, IResource, IAddChild):
    ...
    def Clone(self):
        ...
        Clone(self: ParallelTimeline) -> ParallelTimeline
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.ParallelTimeline, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
    ...
    def CloneCurrentValue(self):
        ...
        CloneCurrentValue(self: ParallelTimeline) -> ParallelTimeline
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.ParallelTimeline object, making deep copies of this object's current values. Resource references, data bindings, and animations are not 
    ...
    SlipBehavior = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
