class StatusStrip(ToolStrip, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent, ISupportToolStripPanel):
    ...
    def CreateDefaultItem(self, *args): #cannot find CLR method
        ...
        CreateDefaultItem(self: StatusStrip, text: str, image: Image, onClick: EventHandler) -> ToolStripItem
            ...
            text: The text to use for the System.Windows.Forms.ToolStripStatusLabel. If the text parameter is a hyphen (-), this method creates a System.Windows.Forms.ToolStripSeparator.
            image: The System.Drawing.Image to display on the System.Windows.Forms.ToolStripStatusLabel.
            onClick: An event handler that raises the System.Windows.Forms.Control.Click event when the System.Windows.Forms.ToolStripStatusLabel is clicked.
            Returns: A System.Windows.Forms.ToolStripStatusLabel.#ctor(System.String,System.Drawing.Image,System.EventHandler), or a System.Windows.Forms.ToolStripSeparator if the text parameter is a hyphen (-).
        """
        pass
    ...
    def OnPaintBackground(self, *args): #cannot find CLR method
        ...
        OnPaintBackground(self: StatusStrip, e: PaintEventArgs)
            ...
            e: A System.Windows.Forms.PaintEventArgs that contains information about the System.Windows.Forms.StatusStrip to paint.
        """
        pass
...
"""
    ...
    SizeGripBounds = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SizingGrip = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
