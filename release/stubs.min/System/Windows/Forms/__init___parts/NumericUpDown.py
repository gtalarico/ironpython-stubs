class NumericUpDown(UpDownBase,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,IContainerControl,ISupportInitialize):
 ...
 def BeginInit(self):
  ...
  BeginInit(self: NumericUpDown)
   Begins the initialization of a System.Windows.Forms.NumericUpDown control that 
    is used on a form or used by another component. The initialization occurs at 
    run time.
  """
  pass
 ...
 def EndInit(self):
  ...
  EndInit(self: NumericUpDown)
   Ends the initialization of a System.Windows.Forms.NumericUpDown control that is 
    used on a form or used by another component. The initialization occurs at run 
    time.
  """
  pass
 ...
 def ParseEditText(self,*args):
  ...
  ParseEditText(self: NumericUpDown)
   Converts the text displayed in the spin box (also known as an up-down control) 
    to a numeric value and evaluates it.
  """
  pass
 ...
 def ValidateEditText(self,*args):
  ...
  ValidateEditText(self: NumericUpDown)
   Validates and updates the text displayed in the spin box (also known as an 
    up-down control).
  """
  pass
