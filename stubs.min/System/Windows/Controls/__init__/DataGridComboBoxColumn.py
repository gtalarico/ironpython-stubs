class DataGridComboBoxColumn(DataGridColumn):
    ...
    """
    def OnSelectedItemBindingChanged(self, *args): #cannot find CLR method
        """
        OnSelectedItemBindingChanged(self: DataGridComboBoxColumn, oldBinding: BindingBase, newBinding: BindingBase)
            Notifies the System.Windows.Controls.DataGrid when the System.Windows.Controls.DataGridComboBoxColumn.SelectedItemBinding property changes.
    ...
    def OnSelectedValueBindingChanged(self, *args): #cannot find CLR method
        """
        OnSelectedValueBindingChanged(self: DataGridComboBoxColumn, oldBinding: BindingBase, newBinding: BindingBase)
            Notifies the System.Windows.Controls.DataGrid when the System.Windows.Controls.DataGridComboBoxColumn.SelectedValueBinding property changes.
    ...
    def OnTextBindingChanged(self, *args): #cannot find CLR method
        """
        OnTextBindingChanged(self: DataGridComboBoxColumn, oldBinding: BindingBase, newBinding: BindingBase)
            Notifies the System.Windows.Controls.DataGrid when the System.Windows.Controls.DataGridComboBoxColumn.TextBinding property changes.
...
"""
    ...
    EditingElementStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ElementStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectedItemBinding = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectedValueBinding = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    TextBinding = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
