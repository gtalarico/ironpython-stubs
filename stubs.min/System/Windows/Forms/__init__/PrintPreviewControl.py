class PrintPreviewControl(Control, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent):
    ...
    def ResetBackColor(self):
        ...
        ResetBackColor(self: PrintPreviewControl)
            Resets the System.Windows.Forms.Control.BackColor property to System.Drawing.SystemColors.AppWorkspace, which is the default color.
        """
        pass
    ...
    AutoZoom = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    StartPage = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
