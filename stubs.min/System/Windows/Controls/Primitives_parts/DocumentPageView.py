class DocumentPageView(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IServiceProvider,IDisposable):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: DocumentPageView,finalSize: Size) -> Size
   ...
   finalSize: The maximum size that the page view should use to arrange itself and its 
    children.
 ...
 def GetService(self,*args):
  ...
  GetService(self: DocumentPageView,serviceType: Type) -> object
   ...
   Returns: A service object of type serviceType,or null if there is no service object of 
    type serviceType.
  """
  pass
