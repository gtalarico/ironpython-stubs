class MatrixAnimationUsingPath(MatrixAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: MatrixAnimationUsingPath) -> MatrixAnimationUsingPath
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.MatrixAnimationUsingPath, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: MatrixAnimationUsingPath, defaultOriginValue: Matrix, defaultDestinationValue: Matrix, animationClock: AnimationClock) -> Matrix
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.MatrixAnimationUsingPath.
    ...
    DoesRotateWithTangent = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsAngleCumulative = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsOffsetCumulative = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    PathGeometry = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
