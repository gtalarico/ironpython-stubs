class Int64AnimationUsingKeyFrames(Int64AnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 ...
 def Clone(self):
  ...
  Clone(self: Int64AnimationUsingKeyFrames) -> Int64AnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.Int64AnimationUsingKeyFrames,making deep copies 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: Int64AnimationUsingKeyFrames,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.Int64AnimationUsingKeyFrames. When copying 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: Int64AnimationUsingKeyFrames) -> Int64AnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.Int64AnimationUsingKeyFrames object,making deep 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: Int64AnimationUsingKeyFrames,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.Int64AnimationUsingKeyFrames using current 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: Int64AnimationUsingKeyFrames,isChecking: bool) -> bool
   ...
   Makes this instance of 
    System.Windows.Media.Animation.Int64AnimationUsingKeyFrames object unmodifiable 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: Int64AnimationUsingKeyFrames,source: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.Int64AnimationUsingKeyFrames. Resource 
    references,data bindings,and animations are not copied,but their current 
    values are.
  
  
   source: The System.Windows.Media.Animation.Int64AnimationUsingKeyFrames to copy and 
    freeze.
  """
  pass
 ...
 def OnChanged(self,*args):
  ...
  OnChanged(self: Int64AnimationUsingKeyFrames)
   Called when the current 
    System.Windows.Media.Animation.Int64AnimationUsingKeyFrames object is modified.
  """
  pass
 ...
 def ShouldSerializeKeyFrames(self):
  ...
  ShouldSerializeKeyFrames(self: Int64AnimationUsingKeyFrames) -> bool
   ...
   Returns true if the value of the 
    System.Windows.Media.Animation.Int64AnimationUsingKeyFrames.KeyFrames property 
    of this instance of System.Windows.Media.Animation.Int64AnimationUsingKeyFrames 
