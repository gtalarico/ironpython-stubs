class DataGridTemplateColumn(DataGridColumn):
    ...
    """
    CellEditingTemplate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CellEditingTemplateSelector = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
