class ToolStripPanel:
 ...
 def Dispose(self):
  ...
  Dispose(self: ToolStripPanel,disposing: bool)
   Releases the unmanaged resources used by the System.Windows.Forms.ToolStripPanel and 
 ...
 def Join(self,toolStripToDrag,*__args):
  ...
  Join(self: ToolStripPanel,toolStripToDrag: ToolStrip,location: Point)
   ...
   location: A System.Drawing.Point value representing the x- and y-client coordinates,in pixels,of 
    the new location for the System.Windows.Forms.ToolStrip.
 ...
 def PointToRow(self,clientLocation):
  ...
  PointToRow(self: ToolStripPanel,clientLocation: Point) -> ToolStripPanelRow
   ...
   Returns: The System.Windows.Forms.ToolStripPanelRow that contains the raftingContainerPoint,or 
    null if no such System.Windows.Forms.ToolStripPanelRow exists.
  """
  pass
