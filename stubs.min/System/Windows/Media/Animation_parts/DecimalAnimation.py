class DecimalAnimation(DecimalAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: DecimalAnimation) -> DecimalAnimation
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.DecimalAnimation, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: DecimalAnimation, defaultOriginValue: Decimal, defaultDestinationValue: Decimal, animationClock: AnimationClock) -> Decimal
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.DecimalAnimation.
