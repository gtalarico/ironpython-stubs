class FixedDocument(FrameworkContentElement, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IDocumentPaginatorSource, IAddChildInternal, IAddChild, IServiceProvider, IFixedNavigate, IUriContext):
    """
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        """
        OnCreateAutomationPeer(self: FixedDocument) -> AutomationPeer
        
            Creates an automation peer for the document.
            Returns: A System.Windows.Automation.Peers.DocumentAutomationPeer that exposes the System.Windows.Documents.FixedDocument to Microsoft UI Automation.
        """
        pass
...
Get: DocumentPaginator(self: FixedDocument) -> DocumentPaginator
...
"""
    ...
    """Gets an enumerator for accessing the document's System.Windows.Documents.PageContent child elements.

"""

    Pages = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a collection of the document's System.Windows.Documents.PageContent elements.

Get: Pages(self: FixedDocument) -> PageContentCollection

"""

    PrintTicket = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the System.Printing.PrintTicket that is associated with this document.

Get: PrintTicket(self: FixedDocument) -> object

Set: PrintTicket(self: FixedDocument) = value
"""
