class ScrollBar(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def GetScaledBounds(self,*args):
  ...
  GetScaledBounds(self: ScrollBar,bounds: Rectangle,factor: SizeF,specified: BoundsSpecified) -> Rectangle
   ...
   Returns the bounds to use when the System.Windows.Forms.ScrollBar is scaled by 
    a specified amount.
  
  
   bounds: A System.Drawing.Rectangle that specifies the initial bounds.
   factor: A System.Drawing.SizeF that indicates the amount the current bounds should be 
    increased by.
  
   specified: A bitwise combination of the System.Windows.Forms.BoundsSpecified values that 
    indicate the how to define the control's size and position returned by 
    System.Windows.Forms.ScrollBar.GetScaledBounds(System.Drawing.Rectangle,System.D
    rawing.SizeF,System.Windows.Forms.BoundsSpecified).
