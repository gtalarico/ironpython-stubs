class AdornerDecorator(Decorator,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def GetVisualChild(self,*args):
  ...
  GetVisualChild(self: AdornerDecorator,index: int) -> Visual
   ...
   Returns: A System.Windows.Media.Visual child of the parent 
    System.Windows.Controls.Viewbox element.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: AdornerDecorator,constraint: Size) -> Size
   ...
   Returns: A System.Windows.Size object representing the amount of layout space needed by 
    the System.Windows.Documents.AdornerDecorator.
  """
  pass
