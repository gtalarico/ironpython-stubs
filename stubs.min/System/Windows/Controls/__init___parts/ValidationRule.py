class ValidationRule(object):
    ...
    ValidatesOnTargetUpdated = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ValidationStep = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
