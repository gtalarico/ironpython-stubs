class DataGridView(Control, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent, ISupportInitialize):
    ...
    def AdjustColumnHeaderBorderStyle(self, dataGridViewAdvancedBorderStyleInput, dataGridViewAdvancedBorderStylePlaceholder, isFirstDisplayedColumn, isLastVisibleColumn):
        ...
        AdjustColumnHeaderBorderStyle(self: DataGridView, dataGridViewAdvancedBorderStyleInput: DataGridViewAdvancedBorderStyle, dataGridViewAdvancedBorderStylePlaceholder: DataGridViewAdvancedBorderStyle, isFirstDisplayedColumn: bool, isLastVisibleColumn: bool) -> DataGridViewAdvancedBorderStyle
            ...
            Adjusts the System.Windows.Forms.DataGridViewAdvancedBorderStyle for a column header cell of a System.Windows.Forms.DataGridView that is currently being painted.
        
            dataGridViewAdvancedBorderStyleInput: A System.Windows.Forms.DataGridViewAdvancedBorderStyle that that represents the column header border style to modify.
            dataGridViewAdvancedBorderStylePlaceholder: A System.Windows.Forms.DataGridViewAdvancedBorderStyle that is used to store intermediate changes to the column header border style.
            isFirstDisplayedColumn: true to indicate that the System.Windows.Forms.DataGridViewCell that is currently being painted is in the first column displayed on the System.Windows.Forms.DataGridView; otherwise, false.
            isLastVisibleColumn: true to indicate that the System.Windows.Forms.DataGridViewCell that is currently being painted is in the last column in the System.Windows.Forms.DataGridView that has the 
             System.Windows.Forms.DataGridViewColumn.Visible property set to true; otherwise, false.
        
            Returns: A System.Windows.Forms.DataGridViewAdvancedBorderStyle that represents the border style for the current column header.
        """
        pass
    ...
    def AreAllCellsSelected(self, includeInvisibleCells):
        ...
        AreAllCellsSelected(self: DataGridView, includeInvisibleCells: bool) -> bool
            ...
            Returns a value indicating whether all the System.Windows.Forms.DataGridView cells are currently selected.
        
            includeInvisibleCells: true to include the rows and columns with System.Windows.Forms.DataGridViewBand.Visible property values of false; otherwise, false.
            Returns: true if all cells (or all visible cells) are selected or if there are no cells (or no visible cells); otherwise, false.
        """
        pass
    ...
    def CommitEdit(self, context):
        ...
        CommitEdit(self: DataGridView, context: DataGridViewDataErrorContexts) -> bool
            ...
            context: A bitwise combination of System.Windows.Forms.DataGridViewDataErrorContexts values that specifies the context in which an error can occur.
    ...
    def CreateAccessibilityInstance(self, *args): #cannot find CLR method
        ...
        CreateAccessibilityInstance(self: DataGridView) -> AccessibleObject
            ...
            Returns: A new System.Windows.Forms.DataGridView.DataGridViewAccessibleObject for the System.Windows.Forms.DataGridView.
        """
        pass
    ...
    def CreateControlsInstance(self, *args): #cannot find CLR method
        ...
        CreateControlsInstance(self: DataGridView) -> ControlCollection
            ...
            Creates and returns a new System.Windows.Forms.Control.ControlCollection that can be cast to type System.Windows.Forms.DataGridView.DataGridViewControlCollection.
    ...
    def GetCellCount(self, includeFilter):
        ...
        GetCellCount(self: DataGridView, includeFilter: DataGridViewElementStates) -> int
            ...
            includeFilter: A bitwise combination of the System.Windows.Forms.DataGridViewElementStates values specifying the cells to count.
    ...
    def GetColumnDisplayRectangle(self, columnIndex, cutOverflow):
        ...
        GetColumnDisplayRectangle(self: DataGridView, columnIndex: int, cutOverflow: bool) -> Rectangle
            ...
            columnIndex: The column index for the desired cell.
            cutOverflow: true to return the column rectangle visible in the System.Windows.Forms.DataGridView bounds; false to return the entire column rectangle.
    ...
    def GetRowDisplayRectangle(self, rowIndex, cutOverflow):
        ...
        GetRowDisplayRectangle(self: DataGridView, rowIndex: int, cutOverflow: bool) -> Rectangle
            ...
            rowIndex: The row index for the desired cell.
            cutOverflow: true to return the row rectangle visible in the System.Windows.Forms.DataGridView bounds; false to return the entire row rectangle.
    ...
    def InvalidateCell(self, *__args):
        ...
        InvalidateCell(self: DataGridView, dataGridViewCell: DataGridViewCell)
            Invalidates the specified cell of the System.Windows.Forms.DataGridView, forcing it to be repainted.
    ...
    def InvalidateRow(self, rowIndex):
        ...
        InvalidateRow(self: DataGridView, rowIndex: int)
            Invalidates the specified row of the System.Windows.Forms.DataGridView, forcing it to be repainted.
    ...
    def IsInputChar(self, *args): #cannot find CLR method
        ...
        IsInputChar(self: DataGridView, charCode: Char) -> bool
            ...
            Determines whether a character is an input character that the System.Windows.Forms.DataGridView recognizes.
    ...
    def OnCellContentClick(self, *args): #cannot find CLR method
        ...
        OnCellContentClick(self: DataGridView, e: DataGridViewCellEventArgs)
            ...
            e: A System.Windows.Forms.DataGridViewCellEventArgs that contains information regarding the cell whose content was clicked.
        """
        pass
    ...
    def OnCellContextMenuStripNeeded(self, *args): #cannot find CLR method
        ...
        OnCellContextMenuStripNeeded(self: DataGridView, e: DataGridViewCellContextMenuStripNeededEventArgs)
            ...
            e: A System.Windows.Forms.DataGridViewCellContextMenuStripNeededEventArgs that contains the event data.
        """
        pass
    ...
    def OnColumnDividerDoubleClick(self, *args): #cannot find CLR method
        ...
        OnColumnDividerDoubleClick(self: DataGridView, e: DataGridViewColumnDividerDoubleClickEventArgs)
            ...
            e: A System.Windows.Forms.DataGridViewColumnDividerDoubleClickEventArgs that contains the event data.
        """
        pass
    ...
    def OnColumnHeaderMouseDoubleClick(self, *args): #cannot find CLR method
        ...
        OnColumnHeaderMouseDoubleClick(self: DataGridView, e: DataGridViewCellMouseEventArgs)
            ...
            e: A System.Windows.Forms.DataGridViewCellMouseEventArgs that contains information about the cell and the position of the mouse pointer.
        """
        pass
    ...
    def OnCursorChanged(self, *args): #cannot find CLR method
        ...
        OnCursorChanged(self: DataGridView, e: EventArgs)
            Raises the System.Windows.Forms.Control.CursorChanged event and updates the System.Windows.Forms.DataGridView.UserSetCursor property if the cursor was changed in user code.
    ...
    def OnDataError(self, *args): #cannot find CLR method
        ...
        OnDataError(self: DataGridView, displayErrorDialogIfNoHandler: bool, e: DataGridViewDataErrorEventArgs)
            ...
            displayErrorDialogIfNoHandler: true to display an error dialog box if there is no handler for the System.Windows.Forms.DataGridView.DataError event.
    ...
    def OnEditingControlShowing(self, *args): #cannot find CLR method
        ...
        OnEditingControlShowing(self: DataGridView, e: DataGridViewEditingControlShowingEventArgs)
            ...
            e: A System.Windows.Forms.DataGridViewEditingControlShowingEventArgs that contains information about the editing control.
        """
        pass
    ...
    def OnRowContextMenuStripNeeded(self, *args): #cannot find CLR method
        ...
        OnRowContextMenuStripNeeded(self: DataGridView, e: DataGridViewRowContextMenuStripNeededEventArgs)
            ...
            e: A System.Windows.Forms.DataGridViewRowContextMenuStripNeededEventArgs that contains the event data.
        """
        pass
    ...
    def OnRowHeaderMouseClick(self, *args): #cannot find CLR method
        ...
        OnRowHeaderMouseClick(self: DataGridView, e: DataGridViewCellMouseEventArgs)
            ...
            e: A System.Windows.Forms.DataGridViewCellMouseEventArgs that contains information about the mouse and the header cell that was clicked.
        """
        pass
    ...
    def OnRowHeaderMouseDoubleClick(self, *args): #cannot find CLR method
        ...
        OnRowHeaderMouseDoubleClick(self: DataGridView, e: DataGridViewCellMouseEventArgs)
            ...
            e: A System.Windows.Forms.DataGridViewCellMouseEventArgs that contains information about the mouse and the header cell that was double-clicked.
        """
        pass
    ...
    def OnRowsAdded(self, *args): #cannot find CLR method
        ...
        OnRowsAdded(self: DataGridView, e: DataGridViewRowsAddedEventArgs)
            ...
            e: A System.Windows.Forms.DataGridViewRowsAddedEventArgs that contains information about the added rows.
        """
        pass
    ...
    def OnRowsRemoved(self, *args): #cannot find CLR method
        ...
        OnRowsRemoved(self: DataGridView, e: DataGridViewRowsRemovedEventArgs)
            ...
            e: A System.Windows.Forms.DataGridViewRowsRemovedEventArgs that contains information about the deleted rows.
        """
        pass
    ...
    def PaintBackground(self, *args): #cannot find CLR method
        ...
        PaintBackground(self: DataGridView, graphics: Graphics, clipBounds: Rectangle, gridBounds: Rectangle)
            ...
            clipBounds: A System.Drawing.Rectangle that represents the area of the System.Windows.Forms.DataGridView that needs to be painted.
    ...
    def ProcessAKey(self, *args): #cannot find CLR method
        ...
        ProcessAKey(self: DataGridView, keyData: Keys) -> bool
            ...
            keyData: A bitwise combination of System.Windows.Forms.Keys values that represents the key or keys to process.
    ...
    def SetCurrentCellAddressCore(self, *args): #cannot find CLR method
        ...
        SetCurrentCellAddressCore(self: DataGridView, columnIndex: int, rowIndex: int, setAnchorCellAddress: bool, validateCurrentCell: bool, throughMouseClick: bool) -> bool
            ...
            setAnchorCellAddress: true to make the new current cell the anchor cell for a subsequent multicell selection using the SHIFT key; otherwise, false.
            validateCurrentCell: true to validate the value in the old current cell and cancel the change if validation fails; otherwise, false.
    ...
    def Sort(self, *__args):
        ...
        Sort(self: DataGridView, comparer: IComparer)
            Sorts the contents of the System.Windows.Forms.DataGridView control using an implementation of the System.Collections.IComparer interface.
    ...
    AdjustedTopLeftHeaderBorderStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AdvancedCellBorderStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AdvancedColumnHeadersBorderStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AdvancedRowHeadersBorderStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AllowUserToAddRows = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AllowUserToDeleteRows = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AllowUserToOrderColumns = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AllowUserToResizeColumns = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AllowUserToResizeRows = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AlternatingRowsDefaultCellStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AutoSizeColumnsMode = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AutoSizeRowsMode = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CellBorderStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeadersBorderStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeadersDefaultCellStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeadersHeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeadersHeightSizeMode = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ColumnHeadersVisible = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CurrentCellAddress = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CurrentRow = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DisplayRectangle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    EditingControl = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    EditingPanel = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    EnableHeadersVisualStyles = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    FirstDisplayedCell = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    FirstDisplayedScrollingColumnHiddenWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    FirstDisplayedScrollingColumnIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    FirstDisplayedScrollingRowIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HorizontalScrollBar = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the horizontal scroll bar of the control.

"""

    HorizontalScrollingOffset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsCurrentCellDirty = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsCurrentCellInEditMode = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsCurrentRowDirty = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    NewRowIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowHeadersBorderStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowHeadersDefaultCellStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowHeadersVisible = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowHeadersWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowHeadersWidthSizeMode = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowsDefaultCellStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowTemplate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ScrollBars = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectedColumns = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ShowCellErrors = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ShowCellToolTips = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ShowEditingIcon = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ShowRowErrors = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SortedColumn = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    StandardTab = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    TopLeftHeaderCell = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    UserSetCursor = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    VerticalScrollBar = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the vertical scroll bar of the control.

"""

    VerticalScrollingOffset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    VirtualMode = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
