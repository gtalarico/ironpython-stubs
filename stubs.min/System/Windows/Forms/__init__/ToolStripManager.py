class ToolStripManager(object):
    ...
    def FindToolStrip(toolStripName):
        ...
        FindToolStrip(toolStripName: str) -> ToolStrip
            ...
            toolStripName: A string specifying the name of the System.Windows.Forms.ToolStrip or derived System.Windows.Forms.ToolStrip type to find.
            Returns: The System.Windows.Forms.ToolStrip or one of its derived types as specified by the toolStripName parameter, or null if the System.Windows.Forms.ToolStrip is not found.
        """
        pass
    ...
    def IsShortcutDefined(shortcut):
        ...
        IsShortcutDefined(shortcut: Keys) -> bool
            ...
            Returns: true if the shortcut key is used by any System.Windows.Forms.ToolStrip on the form; otherwise, false.
        """
        pass
    ...
    def Merge(sourceToolStrip, *__args):
        ...
        Merge(sourceToolStrip: ToolStrip, targetName: str) -> bool
            ...
            sourceToolStrip: The System.Windows.Forms.ToolStrip to be combined with the System.Windows.Forms.ToolStrip referred to by the targetName parameter.
            targetName: The name of the System.Windows.Forms.ToolStrip that receives the System.Windows.Forms.ToolStrip referred to by the sourceToolStrip parameter.
        ...
        Merge(sourceToolStrip: ToolStrip, targetToolStrip: ToolStrip) -> bool
            ...
            sourceToolStrip: The System.Windows.Forms.ToolStrip to be combined with the System.Windows.Forms.ToolStrip referred to by the targetToolStrip parameter.
            targetToolStrip: The System.Windows.Forms.ToolStrip that receives the System.Windows.Forms.ToolStrip referred to by the sourceToolStrip parameter.
            Returns: true if the merge is successful; otherwise, false.
        """
        pass
    ...
    def RevertMerge(*__args):
        ...
        RevertMerge(targetName: str) -> bool
            ...
            Undoes a merging of two System.Windows.Forms.ToolStrip objects, returning the System.Windows.Forms.ToolStrip with the specified name to its state before the merge and nullifying all previous merge 
             operations.
