class FixedPage(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChildInternal, IAddChild, IFixedNavigate, IUriContext):
    """
    ...
    def ArrangeOverride(self, *args): #cannot find CLR method
        """ ArrangeOverride(self: FixedPage, arrangeSize: Size) -> Size """
        pass
    ...
    def GetBottom(element):
        ...
        GetBottom(element: UIElement) -> float
            ...
            Returns the distance between the bottom of an element and the bottom of its parent System.Windows.Controls.Canvas.
        
            element: The element from which to get the bottom offset.
    ...
    def GetLeft(element):
        ...
        GetLeft(element: UIElement) -> float
            ...
            Returns the distance between the left side of an element and the left side of its parent System.Windows.Controls.Canvas.
        
            element: The element from which to get the left offset.
            Returns: The distance between the right side of an element and the right side of its parent canvas.
        """
        pass

    @staticmethod
    def GetNavigateUri(element):
        """
        GetNavigateUri(element: UIElement) -> Uri
        
            Returns the System.Windows.Documents.FixedPage.NavigateUri property for a given element.
        
            element: The element from which to get the property.
            Returns: The System.Uri of element.
        """
        pass
    ...
    def GetRight(element):
        ...
        GetRight(element: UIElement) -> float
            ...
            Returns the distance between the right side of an element and the right side of its parent System.Windows.Controls.Canvas.
        
            element: The element from which to get the right offset.
            Returns: The distance between the right side of an element and the right side of its parent canvas.
        """
        pass
    ...
    def GetTop(element):
        ...
        GetTop(element: UIElement) -> float
            ...
            Returns the distance between the top of an element and the top of its parent System.Windows.Controls.Canvas.
        
            element: The element from which to get the top offset.
    ...
    def GetVisualChild(self, *args): #cannot find CLR method
        """ GetVisualChild(self: FixedPage, index: int) -> Visual """
        pass
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        """ MeasureOverride(self: FixedPage, constraint: Size) -> Size """
        pass
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        """ OnCreateAutomationPeer(self: FixedPage) -> AutomationPeer """
        pass
    ...
    def OnPreviewMouseWheel(self, *args): #cannot find CLR method
        """ OnPreviewMouseWheel(self: FixedPage, e: MouseWheelEventArgs) """
        pass
    ...
    def OnRender(self, *args): #cannot find CLR method
        """ OnRender(self: FixedPage, dc: DrawingContext) """
        pass
    ...
    def OnVisualParentChanged(self, *args): #cannot find CLR method
        """ OnVisualParentChanged(self: FixedPage, oldParent: DependencyObject) """
        pass
    ...
    def SetBottom(element, length):
        ...
        SetBottom(element: UIElement, length: float)
            Sets the distance between the bottom of an element and the bottom of its parent System.Windows.Controls.Canvas.
        
            element: The element on which to set the bottom offset.
            length: The new distance between the bottom side of the element and the bottom side of its parent canvas.
        """
        pass
    ...
    def SetLeft(element, length):
        ...
        SetLeft(element: UIElement, length: float)
            Sets the distance between the left side of an element and the left side of its parent System.Windows.Controls.Canvas.
        
            element: The element on which to set the left offset.
            length: The new distance between the left side of the element and the left side of its parent canvas.
        """
        pass

    @staticmethod
    def SetNavigateUri(element, uri):
        """
        SetNavigateUri(element: UIElement, uri: Uri)
            Sets the uniform resource identifier (URI) to navigate to when a hyperlink is clicked.
        
            element: The element on which to set the URI offset.
            uri: The URI to navigate to when a hyperlink is clicked.
        """
        pass
    ...
    def SetRight(element, length):
        ...
        SetRight(element: UIElement, length: float)
            Sets the distance between the right side of an element and the right side of its parent System.Windows.Controls.Canvas.
        
            element: The element on which to set the right offset.
            length: The new distance between the right side of the element and the right side of its parent canvas.
        """
        pass
    ...
    def SetTop(element, length):
        ...
        SetTop(element: UIElement, length: float)
            Sets the distance between the top of an element and the top of its parent System.Windows.Controls.Canvas.
        
            element: The element on which to set the top offset.
            length: The new distance between the top side of the element and the top side of its parent canvas.
        """
        pass
    ...
    """Gets or sets the System.Windows.Media.Brush used for rendering the page background.

Get: Background(self: FixedPage) -> Brush

Set: Background(self: FixedPage) = value
"""
...
Get: BleedBox(self: FixedPage) -> Rect

Set: BleedBox(self: FixedPage) = value
"""

    Children = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a collection of the System.Windows.Documents.FixedPage child elements.

Get: Children(self: FixedPage) -> UIElementCollection
...
Get: ContentBox(self: FixedPage) -> Rect

Set: ContentBox(self: FixedPage) = value
"""
...
"""
    ...
    PrintTicket = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the System.Printing.PrintTicket that is associated with the page.

Get: PrintTicket(self: FixedPage) -> object

Set: PrintTicket(self: FixedPage) = value
"""
...
"""
    ...
    BleedBoxProperty = None
    BottomProperty = None
    ContentBoxProperty = None
    LeftProperty = None
    NavigateUriProperty = None
    PrintTicketProperty = None
    RightProperty = None
    TopProperty = None
