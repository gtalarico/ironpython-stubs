class TableColumnCollection(object, IList[TableColumn], ICollection[TableColumn], IEnumerable[TableColumn], IEnumerable, IList, ICollection):
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: TableColumnCollection, array: Array[TableColumn], index: int)
            Copies the contents of the collection and inserts them into a specified System.Windows.Documents.TableColumn array of starting at a specified index position in the array.
        
            array: A one-dimensional System.Windows.Documents.TableColumn array to which the collection contents will be copied.  This array must use zero-based indexing.
    ...
    def TrimToSize(self):
        ...
        TrimToSize(self: TableColumnCollection)
            Optimizes memory consumption for the collection by setting the underlying collection System.Windows.Documents.TableColumnCollection.Capacity equal to the 
             System.Windows.Documents.TableColumnCollection.Count of items currently in the collection.
        """
        pass
