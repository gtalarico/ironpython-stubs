class ThicknessAnimation(ThicknessAnimationBase, ISealable, IAnimatable, IResource):
    """
    Animates the value of a  System.Windows.Thickness property between two target values using      linear interpolation over a specified System.Windows.Media.Animation.Timeline.Duration.
    
    ThicknessAnimation()
    ThicknessAnimation(toValue: Thickness, duration: Duration)
    ThicknessAnimation(toValue: Thickness, duration: Duration, fillBehavior: FillBehavior)
    ThicknessAnimation(fromValue: Thickness, toValue: Thickness, duration: Duration)
    ThicknessAnimation(fromValue: Thickness, toValue: Thickness, duration: Duration, fillBehavior: FillBehavior)
    """
    ...
    def Clone(self):
        """
        Clone(self: ThicknessAnimation) -> ThicknessAnimation
        
            Creates a modifiable clone of this System.Windows.Media.Animation.ThicknessAnimation, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
    ...
    def CreateInstanceCore(self, *args): #cannot find CLR method
        """
        CreateInstanceCore(self: ThicknessAnimation) -> Freezable
        
            Creates a new instance of the System.Windows.Media.Animation.ThicknessAnimation.
            Returns: The new instance.
        """
        pass
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        """
        GetCurrentValueCore(self: ThicknessAnimation, defaultOriginValue: Thickness, defaultDestinationValue: Thickness, animationClock: AnimationClock) -> Thickness
        
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.ThicknessAnimation.
    ...
    def __new__(self, *__args):
        """
        __new__(cls: type)
        __new__(cls: type, toValue: Thickness, duration: Duration)
        __new__(cls: type, toValue: Thickness, duration: Duration, fillBehavior: FillBehavior)
        __new__(cls: type, fromValue: Thickness, toValue: Thickness, duration: Duration)
        __new__(cls: type, fromValue: Thickness, toValue: Thickness, duration: Duration, fillBehavior: FillBehavior)
        """
        pass
...
Get: By(self: ThicknessAnimation) -> Nullable[Thickness]

Set: By(self: ThicknessAnimation) = value
"""

    EasingFunction = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the easing function applied to this animation.

Get: EasingFunction(self: ThicknessAnimation) -> IEasingFunction

Set: EasingFunction(self: ThicknessAnimation) = value
"""

    From = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the animation's starting value.

Get: From(self: ThicknessAnimation) -> Nullable[Thickness]

Set: From(self: ThicknessAnimation) = value
"""
...
Get: IsAdditive(self: ThicknessAnimation) -> bool

Set: IsAdditive(self: ThicknessAnimation) = value
"""
...
Get: IsCumulative(self: ThicknessAnimation) -> bool

Set: IsCumulative(self: ThicknessAnimation) = value
"""

    To = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the animation's ending value.

Get: To(self: ThicknessAnimation) -> Nullable[Thickness]

Set: To(self: ThicknessAnimation) = value
"""
