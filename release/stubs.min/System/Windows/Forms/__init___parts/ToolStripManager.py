class ToolStripManager:
 ...
 def FindToolStrip(toolStripName):
  ...
  FindToolStrip(toolStripName: str) -> ToolStrip
   ...
   Returns: The System.Windows.Forms.ToolStrip or one of its derived types as specified by the 
    toolStripName parameter,or null if the System.Windows.Forms.ToolStrip is not found.
  """
  pass
 @staticmethod
 def IsShortcutDefined(shortcut):
  ...
  IsShortcutDefined(shortcut: Keys) -> bool
   ...
   Returns: true if the shortcut key is used by any System.Windows.Forms.ToolStrip on the form; 
    otherwise,false.
  """
  pass
 @staticmethod
 ...
 def LoadSettings(targetForm,key=None):
  ...
  LoadSettings(targetForm: Form,key: str)
   Loads settings for the specified System.Windows.Forms.Form using the specified settings 
    key.
 ...
 def Merge(sourceToolStrip,*__args):
  ...
  Merge(sourceToolStrip: ToolStrip,targetToolStrip: ToolStrip) -> bool
   ...
   targetToolStrip: The System.Windows.Forms.ToolStrip that receives the System.Windows.Forms.ToolStrip 
 ...
 def RevertMerge(*__args):
  ...
  RevertMerge(targetToolStrip: ToolStrip) -> bool
   ...
   Undoes a merging of two System.Windows.Forms.ToolStrip objects,returning the specified 
    System.Windows.Forms.ToolStrip to its state before the merge and nullifying all previous 
    merge operations.
  ...
  RevertMerge(targetToolStrip: ToolStrip,sourceToolStrip: ToolStrip) -> bool
   ...
   Undoes a merging of two System.Windows.Forms.ToolStrip objects,returning both 
    System.Windows.Forms.ToolStrip controls to their state before the merge and nullifying 
    all previous merge operations.
 ...
 def SaveSettings(sourceForm,key=None):
  ...
  SaveSettings(sourceForm: Form,key: str)
   Saves settings for the specified System.Windows.Forms.Form using the specified settings 
    key.
