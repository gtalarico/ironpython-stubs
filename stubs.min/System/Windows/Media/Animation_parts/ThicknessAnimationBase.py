class ThicknessAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    """ Abstract class that, when implemented, animates a System.Windows.Thickness value. """
    ...
    def Clone(self):
        """
        Clone(self: ThicknessAnimationBase) -> ThicknessAnimationBase
        
            Creates a modifiable clone of this System.Windows.Media.Animation.ThicknessAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def GetCurrentValue(self, defaultOriginValue, defaultDestinationValue, animationClock):
        """
        GetCurrentValue(self: ThicknessAnimationBase, defaultOriginValue: Thickness, defaultDestinationValue: Thickness, animationClock: AnimationClock) -> Thickness
        
            Gets the current value of the animation.
        
            defaultOriginValue: The origin value provided to the animation if the animation does not have its own start value.
            defaultDestinationValue: The destination value provided to the animation if the animation does not have its own destination value.
            animationClock: The System.Windows.Media.Animation.AnimationClock which can generate the System.Windows.Media.Animation.Clock.CurrentTime or System.Windows.Media.Animation.Clock.CurrentProgress value to be used by the 
             animation to generate its output value.
        
            Returns: The current value of this animation.
        GetCurrentValue(self: ThicknessAnimationBase, defaultOriginValue: object, defaultDestinationValue: object, animationClock: AnimationClock) -> object
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        """
        GetCurrentValueCore(self: ThicknessAnimationBase, defaultOriginValue: Thickness, defaultDestinationValue: Thickness, animationClock: AnimationClock) -> Thickness
    ...
    TargetPropertyType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets the type of value this animation generates.

Get: TargetPropertyType(self: ThicknessAnimationBase) -> Type
