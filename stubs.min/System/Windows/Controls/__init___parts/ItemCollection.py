class ItemCollection(CollectionView, ICollectionView, IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, IList, ICollection, IEditableCollectionViewAddNewItem, IEditableCollectionView, ICollectionViewLiveShaping, IItemProperties, IWeakEventListener):
    ...
    def Contains(self, containItem):
        ...
        Contains(self: ItemCollection, containItem: object) -> bool
            ...
            Returns: true to indicate that the item belongs to this collection and passes the active filter; otherwise, false.
        """
        pass
    ...
    def MoveCurrentTo(self, item):
        ...
        MoveCurrentTo(self: ItemCollection, item: object) -> bool
            ...
            Sets the specified item in the collection as the System.Windows.Controls.ItemCollection.CurrentItem.
        
            item: The item to set as the System.Windows.Controls.ItemCollection.CurrentItem.
            Returns: true to indicate that the resulting System.Windows.Controls.ItemCollection.CurrentItem is an item within the view; otherwise, false.
        """
        pass
    ...
    def MoveCurrentToNext(self):
        ...
        MoveCurrentToNext(self: ItemCollection) -> bool
            ...
            Sets the item after the System.Windows.Controls.ItemCollection.CurrentItem in the view as the System.Windows.Controls.ItemCollection.CurrentItem.
            Returns: true to indicate that the resulting System.Windows.Controls.ItemCollection.CurrentItem is an item within the view; otherwise, false.
        """
        pass
    ...
    def MoveCurrentToPosition(self, position):
        ...
        MoveCurrentToPosition(self: ItemCollection, position: int) -> bool
            ...
            Sets the item at the specified index to be the System.Windows.Controls.ItemCollection.CurrentItem in the view.
        
            position: The zero-based index of the item to set as the System.Windows.Controls.ItemCollection.CurrentItem.
            Returns: true to indicate that the resulting System.Windows.Controls.ItemCollection.CurrentItem is an item within the view; otherwise, false.
        """
        pass
    ...
    def MoveCurrentToPrevious(self):
        ...
        MoveCurrentToPrevious(self: ItemCollection) -> bool
            ...
            Sets the item before the System.Windows.Controls.ItemCollection.CurrentItem in the view as the System.Windows.Controls.ItemCollection.CurrentItem.
            Returns: true  to indicate that the resulting System.Windows.Controls.ItemCollection.CurrentItem is an item within the view; otherwise, false.
        """
        pass
    ...
    def PassesFilter(self, item):
        ...
        PassesFilter(self: ItemCollection, item: object) -> bool
            ...
            Returns: true to indicate that the specified item belongs to this view or there is no filter set on this collection view; otherwise, false.
        """
        pass
