...
class RailAngledJoinOption(Enum):
    """
...
class RailConnectionOption(Enum):
    """
...
class RailingHeightCorrectionOption(Enum):
    """
...
class RailingPathCurveJoinOption(Enum):
    """
...
class RailingPlacementPosition(Enum):
    """
...
class RailSupportJustification(Enum):
    """
...
class RailTagentJoinOption(Enum):
    """
...
class RailTransitionOption(Enum):
    """
...
class RailTypeDefaultJoinOption(Enum):
    """
...
class RiserToTreadConnectionOption(Enum):
    """
...
class SketchedCurveSlopeOption(Enum):
    """
...
class StairsComponentConnection(object):
...
class StairsComponentConnectionEndType(Enum):
    """
...
class StairsConstructionMethod(Enum):
    """
...
class StairsEndConnectionType(Enum):
    """
...
class StairsEndNotchOption(Enum):
    """
...
class StairsNumberSystemReferenceOption(Enum):
    """
...
class StairsPathDirection(Enum):
    """
...
class StairsPathLineShapeAtCorner(Enum):
    """
...
class StairsRunJustification(Enum):
    """
    The position of the run relative to the Up-direction path used to create the run.
...
class StairsSupportTopsideSurfaceType(Enum):
    """
...
class StairsTextOrientation(Enum):
    """
...
class StairsUndersideSurfaceStyle(Enum):
    """
...
class TreadNosingPosition(Enum):
    """
    Represents on which edges of the nosing to apply the nosing profile.
