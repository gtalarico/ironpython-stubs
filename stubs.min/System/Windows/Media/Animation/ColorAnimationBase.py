class ColorAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: ColorAnimationBase) -> ColorAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.ColorAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
