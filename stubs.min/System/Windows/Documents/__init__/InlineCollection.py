class InlineCollection(TextElementCollection[Inline], IList, ICollection, IEnumerable, ICollection[Inline], IEnumerable[Inline]):
    ...
    def Add(self, *__args):
        ...
        Add(self: InlineCollection, uiElement: UIElement)
            Adds an implicit System.Windows.Documents.InlineUIContainer with the supplied System.Windows.UIElement already in it.
        
            uiElement: System.Windows.UIElement set as the System.Windows.Documents.InlineUIContainer.Child property for the implicit System.Windows.Documents.InlineUIContainer.
        Add(self: InlineCollection, text: str)
            Adds an implicit System.Windows.Documents.Run element with the given text, supplied as a System.String.
        
            text: Text set as the System.Windows.Documents.Run.Text property for the implicit System.Windows.Documents.Run.
        """
        pass
    ...
    FirstInline = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    LastInline = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
