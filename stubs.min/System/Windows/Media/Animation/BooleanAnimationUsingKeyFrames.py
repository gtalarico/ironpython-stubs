class BooleanAnimationUsingKeyFrames(BooleanAnimationBase, ISealable, IAnimatable, IResource, IKeyFrameAnimation, IAddChild):
    ...
    def AddChild(self, *args): #cannot find CLR method
        ...
        AddChild(self: BooleanAnimationUsingKeyFrames, child: object)
            Adds a child System.Windows.Media.Animation.BooleanKeyFrame to this System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames.
        
            child: The object to be added as the child of this System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames.
        """
        pass
    ...
    def AddText(self, *args): #cannot find CLR method
        ...
        AddText(self: BooleanAnimationUsingKeyFrames, childText: str)
            Adds a text string as a child of this System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames.
    ...
    def Clone(self):
        ...
        Clone(self: BooleanAnimationUsingKeyFrames) -> BooleanAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: BooleanAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames. When copying dependency properties, this method copies resource references and data bindings 
    ...
    def CloneCurrentValue(self):
        ...
        CloneCurrentValue(self: BooleanAnimationUsingKeyFrames) -> BooleanAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames object, making deep copies of this object's current values. Resource references, data bindings, and 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: BooleanAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a modifiable deep copy of the specified System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames using current property values. Resource references, data bindings, and animations 
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: BooleanAnimationUsingKeyFrames, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames object unmodifiable or determines whether it can be made unmodifiable..
            ...
            Returns: If isChecking is true, this method returns true if this object can be made read-only, or false if it cannot be made read-only. If isChecking is false, this method returns true if this object is now 
    ...
    def GetAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetAsFrozenCore(self: BooleanAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames object.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: BooleanAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames. Resource references, data bindings, and animations are not copied, but their current 
             values are.
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: BooleanAnimationUsingKeyFrames, defaultOriginValue: bool, defaultDestinationValue: bool, animationClock: AnimationClock) -> bool
            ...
            Calculates a value that represents the current value of the property being animated, as determined by this instance of System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames.
    ...
    def OnChanged(self, *args): #cannot find CLR method
        ...
        OnChanged(self: BooleanAnimationUsingKeyFrames)
            Called when the current System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames object is modified.
        """
        pass
    ...
    def ShouldSerializeKeyFrames(self):
        ...
        ShouldSerializeKeyFrames(self: BooleanAnimationUsingKeyFrames) -> bool
            ...
            Returns true if the value of the System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames.KeyFrames property of this instance of System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames should be 
             value-serialized.
