class VisualTreeHelper(object):
 ...
 def GetBitmapEffect(reference):
  ...
  GetBitmapEffect(reference: Visual) -> BitmapEffect
   ...
   Returns the System.Windows.Media.Effects.BitmapEffect value for the specified 
    System.Windows.Media.Visual.
  
  
   reference: The System.Windows.Media.Visual that contains the bitmap effect.
   Returns: The System.Windows.Media.Effects.BitmapEffect for this 
    System.Windows.Media.Visual.
  """
  pass
 @staticmethod
 def GetBitmapEffectInput(reference):
  ...
  GetBitmapEffectInput(reference: Visual) -> BitmapEffectInput
   ...
   Returns the System.Windows.Media.Effects.BitmapEffectInput value for the 
    specified System.Windows.Media.Visual.
  
  
   reference: The System.Windows.Media.Visual that contains the bitmap effect input value.
   Returns: The System.Windows.Media.Effects.BitmapEffectInput for this 
    System.Windows.Media.Visual.
  """
  pass
 @staticmethod
 def GetCacheMode(reference):
  ...
  GetCacheMode(reference: Visual) -> CacheMode
   ...
   Retrieves the cached representation of the specified 
    System.Windows.Media.Visual.
 ...
 def GetChild(reference,childIndex):
  ...
  GetChild(reference: DependencyObject,childIndex: int) -> DependencyObject
   ...
   Returns the child visual object from the specified collection index within a 
    specified parent.
 ...
 def GetClip(reference):
  ...
  GetClip(reference: Visual) -> Geometry
   ...
   Return the clip region of the specified System.Windows.Media.Visual as a 
    System.Windows.Media.Geometry value.
  
  
   reference: The System.Windows.Media.Visual whose clip region value is returned.
   Returns: The clip region value of the System.Windows.Media.Visual returned as a 
    System.Windows.Media.Geometry type.
  """
  pass
 @staticmethod
 def GetContentBounds(reference):
  ...
  GetContentBounds(reference: Visual3D) -> Rect3D
   ...
   Returns the cached bounding box rectangle for the specified 
 ...
 def GetDescendantBounds(reference):
  ...
  GetDescendantBounds(reference: Visual3D) -> Rect3D
   ...
   Returns the union of all the content bounding boxes for all the descendants of 
    the specified System.Windows.Media.Media3D.Visual3D,which includes the content 
    bounding box of the System.Windows.Media.Media3D.Visual3D.
  ...
  GetDescendantBounds(reference: Visual) -> Rect
   ...
   Returns the union of all the content bounding boxes for all the descendants of 
    the System.Windows.Media.Visual,which includes the content bounding box of the 
    System.Windows.Media.Visual.
  
  
   reference: The System.Windows.Media.Visual whose bounding box value for all descendants is 
    computed.
 ...
 def GetDrawing(reference):
  ...
  GetDrawing(reference: Visual) -> DrawingGroup
   ...
   Returns: The drawing content of the System.Windows.Media.Visual returned as a 
    System.Windows.Media.DrawingGroup type.
  """
  pass
 @staticmethod
 def GetEdgeMode(reference):
  ...
  GetEdgeMode(reference: Visual) -> EdgeMode
   ...
   Returns the edge mode of the specified System.Windows.Media.Visual as an 
    System.Windows.Media.EdgeMode value.
 ...
 def GetOffset(reference):
  ...
  GetOffset(reference: Visual) -> Vector
   ...
   Returns: A System.Windows.Vector that represents the offset value of the 
    System.Windows.Media.Visual.
  """
  pass
 @staticmethod
 def GetOpacity(reference):
  ...
  GetOpacity(reference: Visual) -> float
   ...
   Returns: A value of type System.Double that represents the opacity value of the 
    System.Windows.Media.Visual.
  """
  pass
 @staticmethod
 def GetOpacityMask(reference):
  ...
  GetOpacityMask(reference: Visual) -> Brush
   ...
   Returns a System.Windows.Media.Brush value that represents the opacity mask of 
    the System.Windows.Media.Visual.
  
  
   reference: The System.Windows.Media.Visual whose opacity mask value is returned.
   Returns: A value of type System.Windows.Media.Brush that represents the opacity mask 
    value of the System.Windows.Media.Visual.
  """
  pass
 @staticmethod
 def GetParent(reference):
  ...
  GetParent(reference: DependencyObject) -> DependencyObject
   ...
   Returns a System.Windows.DependencyObject value that represents the parent of 
    the visual object.
 ...
 def GetTransform(reference):
  ...
  GetTransform(reference: Visual) -> Transform
   ...
   Returns a System.Windows.Media.Transform value for the 
    System.Windows.Media.Visual.
  
  
   reference: The System.Windows.Media.Visual whose transform value is returned.
   Returns: The transform value of the System.Windows.Media.Visual,or null if reference 
 ...
 def GetXSnappingGuidelines(reference):
  ...
  GetXSnappingGuidelines(reference: Visual) -> DoubleCollection
   ...
   reference: The System.Windows.Media.Visual whose X-coordinate guideline collection is 
    returned.
 ...
 def GetYSnappingGuidelines(reference):
  ...
  GetYSnappingGuidelines(reference: Visual) -> DoubleCollection
   ...
   reference: The System.Windows.Media.Visual whose Y-coordinate guideline collection is 
    returned.
 ...
 def HitTest(reference,*__args):
  ...
  HitTest(reference: Visual3D,filterCallback: HitTestFilterCallback,resultCallback: HitTestResultCallback,hitTestParameters: HitTestParameters3D)
   Initiates a hit test on the specified System.Windows.Media.Media3D.Visual3D,
    with caller-defined System.Windows.Media.HitTestFilterCallback and 
    System.Windows.Media.HitTestResultCallback methods.
  ...
  HitTest(reference: Visual,filterCallback: HitTestFilterCallback,resultCallback: HitTestResultCallback,hitTestParameters: HitTestParameters)
   Initiates a hit test on the specified System.Windows.Media.Visual,with 
    caller-defined System.Windows.Media.HitTestFilterCallback and 
    System.Windows.Media.HitTestResultCallback methods.
  ...
  HitTest(reference: Visual,point: Point) -> HitTestResult
   ...
   Returns the topmost System.Windows.Media.Visual object of a hit test by 
    specifying a System.Windows.Point.
  
  
   reference: The System.Windows.Media.Visual to hit test.
   point: The point value to hit test against.
   Returns: The hit test result of the System.Windows.Media.Visual,returned as a 
