class TypedReference(object):
    ...
    def MakeTypedReference(target, flds):
        ...
        MakeTypedReference(target: object, flds: Array[FieldInfo]) -> TypedReference
            ...
            flds: A list of field descriptions where each element describes a field that contains the field described by the succeeding element. Each described field must be a value type. The field descriptions must be 
             RuntimeFieldInfo objects supplied by the type system.
