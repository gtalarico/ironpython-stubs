class UniformGrid(Panel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: UniformGrid,arrangeSize: Size) -> Size
   ...
   Defines the layout of the System.Windows.Controls.Primitives.UniformGrid by 
    distributing space evenly among all of the child elements.
  
  
   arrangeSize: The System.Windows.Size of the area for the grid to use.
   Returns: The actual System.Windows.Size of the grid that is rendered to display the 
    child elements that are visible.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: UniformGrid,constraint: Size) -> Size
   ...
   Computes the desired size of the System.Windows.Controls.Primitives.UniformGrid 
    by measuring all of the child elements.
  
  
   constraint: The System.Windows.Size of the available area for the grid.
   Returns: The desired System.Windows.Size based on the child content of the grid and the 
