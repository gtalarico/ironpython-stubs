class ComboBox(ListControl, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent):
    ...
    def FindString(self, s, startIndex=None):
        ...
        FindString(self: ComboBox, s: str, startIndex: int) -> int
            ...
            Returns: The zero-based index of the first item found; returns -1 if no match is found, or 0 if the s parameter specifies System.String.Empty.
    ...
    def ToString(self):
        ...
        ToString(self: ComboBox) -> str
            ...
            Returns: A System.String that represents the current System.Windows.Forms.ComboBox. The string includes the type and the number of items in the System.Windows.Forms.ComboBox control.
        """
        pass
...
"""
    ...
    AutoCompleteCustomSource = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AutoCompleteMode = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AutoCompleteSource = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DropDownHeight = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DropDownStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DropDownWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DroppedDown = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MaxDropDownItems = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
