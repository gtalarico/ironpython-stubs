class TemplateBindingExtension(MarkupExtension):
    ...
    def ProvideValue(self, serviceProvider):
        ...
        ProvideValue(self: TemplateBindingExtension, serviceProvider: IServiceProvider) -> object
            ...
            Returns an object that should be set as the value on the target object's property for this markup extension. For System.Windows.TemplateBindingExtension, this is an expression 
             (System.Windows.TemplateBindingExpression) that supports the binding.
        
        
            serviceProvider: An object that can provide services for the markup extension. May be null in this implementation.
