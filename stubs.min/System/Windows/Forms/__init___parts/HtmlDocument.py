class HtmlDocument(object):
    ...
    ActiveElement = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DefaultEncoding = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DomDocument = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    Forms = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
