class PageContent(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChildInternal,IAddChild,IUriContext):
 ...
 def GetPageRoot(self,forceReload):
  ...
  GetPageRoot(self: PageContent,forceReload: bool) -> FixedPage
   ...
   forceReload: true to always reload the System.Windows.Documents.FixedPage even if it has 
    been previously loaded and cached; false to load the 
    System.Windows.Documents.FixedPage only if there is no cached version.
 ...
 def GetPageRootAsync(self,forceReload):
  ...
  GetPageRootAsync(self: PageContent,forceReload: bool)
   Asynchronously loads and returns the System.Windows.Documents.FixedPage content 
    element.
 ...
 def GetPageRootAsyncCancel(self):
  ...
  GetPageRootAsyncCancel(self: PageContent)
   Cancels any current 
    System.Windows.Documents.PageContent.GetPageRootAsync(System.Boolean) operation 
    in progress.
  """
  pass
 ...
 def ShouldSerializeChild(self,manager):
  ...
  ShouldSerializeChild(self: PageContent,manager: XamlDesignerSerializationManager) -> bool
   ...
   Gets a value indicating whether the value of the 
    System.Windows.Documents.PageContent.Child property should be serialized when 
    this System.Windows.Documents.PageContent is serialized.
  
  
   manager: The serialization services provider.
   Returns: true if manager is not null and it does not have an XmlWriter; otherwise,
...
"""
 ...
 LinkTargets=property(lambda self: object(),lambda self,v: None,lambda self: None)
