class TreeView:
 ...
 def GetNodeAt(self,*__args):
  ...
  GetNodeAt(self: TreeView,pt: Point) -> TreeNode
   ...
   Returns: The System.Windows.Forms.TreeNode at the specified point,in tree view (client) 
  ...
  GetNodeAt(self: TreeView,x: int,y: int) -> TreeNode
   ...
   Returns: The System.Windows.Forms.TreeNode at the specified location,in tree view (client) 
    coordinates,or null if there is no node at that location.
  """
  pass
 def GetNodeCount(self,includeSubTrees):
  ...
  GetNodeCount(self: TreeView,includeSubTrees: bool) -> int
   ...
   Retrieves the number of tree nodes,optionally including those in all subtrees,assigned 
    to the tree view control.
  
  
   includeSubTrees: true to count the System.Windows.Forms.TreeNode items that the subtrees contain; 
    otherwise,false.
  
   Returns: The number of tree nodes,optionally including those in all subtrees,assigned to the 
    tree view control.
  """
  pass
