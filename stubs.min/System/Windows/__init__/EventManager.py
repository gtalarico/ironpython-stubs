class EventManager(object):
    ...
    def GetRoutedEvents():
        ...
        GetRoutedEvents() -> Array[RoutedEvent]
            ...
            Returns: An array of type System.Windows.RoutedEvent that contains the registered objects.
        """
        pass
    ...
    def GetRoutedEventsForOwner(ownerType):
        ...
        GetRoutedEventsForOwner(ownerType: Type) -> Array[RoutedEvent]
            ...
            Returns: An array of matching routed event identifiers if any match is found; otherwise, null.
        """
        pass
    ...
    def RegisterClassHandler(classType, routedEvent, handler, handledEventsToo=None):
        ...
        RegisterClassHandler(classType: Type, routedEvent: RoutedEvent, handler: Delegate, handledEventsToo: bool)
            ...
            handledEventsToo: true to invoke this class handler even if arguments of the routed event have been marked as handled; false to retain the default behavior of not invoking the handler on any marked-handled event.
    ...
    def RegisterRoutedEvent(name, routingStrategy, handlerType, ownerType):
        ...
        RegisterRoutedEvent(name: str, routingStrategy: RoutingStrategy, handlerType: Type, ownerType: Type) -> RoutedEvent
            ...
            name: The name of the routed event. The name must be unique within the owner type and cannot be null or an empty string.
            ...
            Returns: The identifier for the newly registered routed event. This identifier object can now be stored as a static field in a class and then used as a parameter for methods that attach handlers to the event. The 
             routed event identifier is also used for other event system APIs.
        """
        pass
