class MatrixTransform(Transform,ISealable,IAnimatable,IResource,IFormattable):
 ...
 def Clone(self):
  ...
  Clone(self: MatrixTransform) -> MatrixTransform
   ...
   Creates a modifiable copy of this System.Windows.Media.MatrixTransform by 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: MatrixTransform) -> MatrixTransform
   ...
   Creates a modifiable copy of this System.Windows.Media.MatrixTransform object 
    by making deep copies of its values. This method does not copy resource 
 ...
 def __str__(self,*args):
  pass
 Matrix=property(lambda self: object(),lambda self,v: None,lambda self: None)
