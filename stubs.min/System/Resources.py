...
class IResourceReader(IEnumerable,IDisposable):
 ...
 def GetEnumerator(self):
  ...
  GetEnumerator(self: IResourceReader) -> IDictionaryEnumerator
   ...
   Returns an System.Collections.IDictionaryEnumerator of the resources for this 
    reader.
...
class ResourceManager(object):
 ...
 def CreateFileBasedResourceManager(baseName,resourceDir,usingResourceSet):
  ...
  CreateFileBasedResourceManager(baseName: str,resourceDir: str,usingResourceSet: Type) -> ResourceManager
   ...
   Returns a System.Resources.ResourceManager that searches a specific directory 
    for resources instead of in the assembly manifest.
   ...
   usingResourceSet: The System.Type of the custom System.Resources.ResourceSet to use. If null,the 
    default runtime System.Resources.ResourceSet is used.
  
   Returns: The newly created System.Resources.ResourceManager that searches a specific 
    directory for resources instead of in the assembly manifest.
  """
  pass
 def GetNeutralResourcesLanguage(self,*args):
  ...
  GetNeutralResourcesLanguage(a: Assembly) -> CultureInfo
   ...
   Returns the System.Globalization.CultureInfo for the main assembly's neutral 
    resources by reading the value of the 
    System.Resources.NeutralResourcesLanguageAttribute on a specified 
    System.Reflection.Assembly.
  
  
   a: The assembly for which to return a System.Globalization.CultureInfo.
   Returns: The culture from the System.Resources.NeutralResourcesLanguageAttribute,if 
    found; otherwise,System.Globalization.CultureInfo.InvariantCulture.
  """
  pass
 def GetObject(self,name,culture=None):
  ...
  GetObject(self: ResourceManager,name: str,culture: CultureInfo) -> object
   ...
   Gets the value of the specified non-string  resource localized for the 
    specified culture.
  
  
   name: The name of the resource to get.
   culture: The culture for which the resource is localized. If the resource is not 
    localized for this culture,the resource manager uses fallback rules to locate 
    an appropriate resource.If this value is null,the 
    System.Globalization.CultureInfo object is obtained using the culture's 
    System.Globalization.CultureInfo.CurrentUICulture property.
  
   Returns: The value of the resource,localized for the specified culture. If an 
    appropriate resource set exists but name cannot be found,the method returns 
    null.
 ...
 def GetResourceFileName(self,*args):
  ...
  GetResourceFileName(self: ResourceManager,culture: CultureInfo) -> str
   ...
   Generates the name for the resource file for the given 
    System.Globalization.CultureInfo.
  
  
   culture: The System.Globalization.CultureInfo for which a resource file name is 
    constructed.
 ...
 def GetResourceSet(self,culture,createIfNotExists,tryParents):
  ...
  GetResourceSet(self: ResourceManager,culture: CultureInfo,createIfNotExists: bool,tryParents: bool) -> ResourceSet
   ...
   createIfNotExists: If true and if the System.Resources.ResourceSet has not been loaded yet,load 
    it.
 ...
 def GetSatelliteContractVersion(self,*args):
  ...
  GetSatelliteContractVersion(a: Assembly) -> Version
   ...
   Returns: The satellite contract System.Version of the given assembly,or null if no 
    version was found.
  """
  pass
 ...
 def GetString(self,name,culture=None):
  ...
  GetString(self: ResourceManager,name: str) -> str
   ...
   Returns: The value of the resource localized for the caller's current UI culture,or 
    null if name cannot be found in a resource set.
  """
  pass
 ...
 def ReleaseAllResources(self):
  ...
  ReleaseAllResources(self: ResourceManager)
   Tells the System.Resources.ResourceManager to call 
    System.Resources.ResourceSet.Close on all System.Resources.ResourceSet objects 
...
class ResourceSet(object,IDisposable,IEnumerable):
 ...
 def GetEnumerator(self):
  ...
  GetEnumerator(self: ResourceSet) -> IDictionaryEnumerator
   ...
   Returns an System.Collections.IDictionaryEnumerator that can iterate through 
    the System.Resources.ResourceSet.
  
   Returns: An System.Collections.IDictionaryEnumerator for this 
    System.Resources.ResourceSet.
  """
  pass
 def GetObject(self,name,ignoreCase=None):
  ...
  GetObject(self: ResourceSet,name: str,ignoreCase: bool) -> object
   ...
   Searches for a resource object with the specified name in a case-insensitive 
    manner,if requested.
 ...
 def GetString(self,name,ignoreCase=None):
  ...
  GetString(self: ResourceSet,name: str,ignoreCase: bool) -> str
   ...
   Searches for a System.String resource with the specified name in a 
 ...
 def ReadResources(self,*args):
  ...
  ReadResources(self: ResourceSet)
   Reads all the resources and stores them in a System.Collections.Hashtable 
    indicated in the System.Resources.ResourceSet.Table property.
  """
  pass
 def __enter__(self,*args):
  """ __enter__(self: IDisposable) -> object """
...
class ResourceWriter(object,IResourceWriter,IDisposable):
 ...
 def AddResource(self,name,value,closeAfterWrite=None):
  ...
  AddResource(self: ResourceWriter,name: str,value: Stream,closeAfterWrite: bool)
   Adds a named resource specified as a stream to the list of resources to be 
    written,and specifies whether the stream should be closed after the 
    System.Resources.ResourceWriter.Generate method is called.
  
  
   name: The name of the resource to add.
   value: The value of the resource to add that supports the System.IO.Stream.Length 
    property.
  
   closeAfterWrite: true to close the stream after the System.Resources.ResourceWriter.Generate 
    method is called; otherwise,false.
  ...
  AddResource(self: ResourceWriter,name: str,value: Stream)
   ...
   name: The name of the resource to add.
   value: The value of the resource to add. The resource must support the 
  ...
  AddResource(self: ResourceWriter,name: str,value: object)
   Adds a named resource specified as an object to the list of resources to be 
    written.
...
class ResXDataNode(object,ISerializable):
 ...
 def GetNodePosition(self):
  ...
  GetNodePosition(self: ResXDataNode) -> Point
   ...
   Returns: A System.Drawing.Point structure specifying the location of this resource in 
    the resource file as a line position (System.Drawing.Point.X) and a column 
    position (System.Drawing.Point.Y). If this resource is not part of a resource 
    file,returns a System.Drawing.Point structure with an System.Drawing.Point.X 
    of 0 and a System.Drawing.Point.Y of 0.
  """
  pass
...
class ResXFileRef(object):
 ...
 def ToString(self):
  ...
  ToString(self: ResXFileRef) -> str
   ...
   Returns: A string that consists of the concatenated text representations of the 
    parameters specified in the current erload:System.Resources.ResXFileRef.#ctor 
    constructor.
  """
  pass
 @staticmethod
...
class ResXResourceReader(object,IResourceReader,IEnumerable,IDisposable):
 ...
 def Dispose(self,*args):
  ...
  Dispose(self: ResXResourceReader,disposing: bool)
   Releases the unmanaged resources used by the 
    System.Resources.ResXResourceReader and optionally releases the managed 
    resources.
 ...
 def FromFileContents(fileContents,*__args):
  ...
  FromFileContents(fileContents: str,assemblyNames: Array[AssemblyName]) -> ResXResourceReader
   ...
   Creates a new System.Resources.ResXResourceReader object and initializes it to 
    read a string whose contents are in the form of an XML resource file,and to 
    use an array of System.Reflection.AssemblyName objects to resolve type names 
    specified in a resource.
  
  
   fileContents: A string whose contents are in the form of an XML resource file.
   assemblyNames: An array of System.Reflection.AssemblyName objects that specifies one or more 
    assemblies. The assemblies are used to resolve a type name in the resource to 
    an actual type.
  ...
  FromFileContents(fileContents: str,typeResolver: ITypeResolutionService) -> ResXResourceReader
   ...
   Creates a new System.Resources.ResXResourceReader object and initializes it to 
    read a string whose contents are in the form of an XML resource file,and to 
    use an System.ComponentModel.Design.ITypeResolutionService object to resolve 
    type names specified in a resource.
  ...
  FromFileContents(fileContents: str) -> ResXResourceReader
   ...
   Creates a new System.Resources.ResXResourceReader object and initializes it to 
    read a string whose contents are in the form of an XML resource file.
 ...
 def GetEnumerator(self):
  ...
  GetEnumerator(self: ResXResourceReader) -> IDictionaryEnumerator
   ...
   Returns an enumerator for the current System.Resources.ResXResourceReader 
    object.
 ...
 def GetMetadataEnumerator(self):
  ...
  GetMetadataEnumerator(self: ResXResourceReader) -> IDictionaryEnumerator
   ...
   Provides a dictionary enumerator that can retrieve the design-time properties 
...
class ResXResourceSet(ResourceSet,IDisposable,IEnumerable):
 ...
 def Dispose(self):
  ...
  Dispose(self: ResourceSet,disposing: bool)
   Releases resources (other than memory) associated with the current instance,
    closing internal managed objects if requested.
  
  
   disposing: Indicates whether the objects contained in the current instance should be 
    explicitly closed.
  """
  pass
 def GetDefaultReader(self):
...
class ResXResourceWriter(object,IResourceWriter,IDisposable):
 ...
 def AddMetadata(self,name,value):
  ...
  AddMetadata(self: ResXResourceWriter,name: str,value: object)
   Adds a design-time property whose value is specified as an object to the list 
    of resources to write.
  
  
   name: The name of a property.
   value: An object that is the value of the property to add.
  AddMetadata(self: ResXResourceWriter,name: str,value: str)
   Adds a design-time property whose value is specified as a string to the list of 
    resources to write.
  ...
  AddMetadata(self: ResXResourceWriter,name: str,value: Array[Byte])
   Adds a design-time property whose value is specifed as a byte array to the list 
    of resources to write.
 ...
 def AddResource(self,*__args):
  ...
  AddResource(self: ResXResourceWriter,node: ResXDataNode)
   Adds a named resource specified in a System.Resources.ResXDataNode object to 
    the list of resources to write.
  ...
  AddResource(self: ResXResourceWriter,name: str,value: Array[Byte])
   Adds a named resource specified as a byte array to the list of resources to 
    write.
