class DoubleKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: DoubleKeyFrameCollection,keyFrame: DoubleKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.DoubleKeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.DoubleKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: DoubleKeyFrameCollection)
   Removes all System.Windows.Media.Animation.DoubleKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: DoubleKeyFrameCollection) -> DoubleKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.DoubleKeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: DoubleKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.DoubleKeyFrameCollection. When copying 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: DoubleKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.DoubleKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: DoubleKeyFrameCollection,array: Array[DoubleKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.DoubleKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: DoubleKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.DoubleKeyFrameCollection 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: DoubleKeyFrameCollection,sourceFreezable: Freezable)
   ...
   sourceFreezable: The System.Windows.Media.Animation.DoubleKeyFrameCollection object to clone and 
    freeze.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: DoubleKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.DoubleKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: DoubleKeyFrameCollection,keyFrame: DoubleKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.DoubleKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: DoubleKeyFrameCollection,index: int,keyFrame: DoubleKeyFrame)
   Inserts a System.Windows.Media.Animation.DoubleKeyFrame into a specific 
    location within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.DoubleKeyFrame 
    is inserted.
  
   keyFrame: The System.Windows.Media.Animation.DoubleKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: DoubleKeyFrameCollection,keyFrame: DoubleKeyFrame)
   Removes a System.Windows.Media.Animation.DoubleKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.DoubleKeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: DoubleKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.DoubleKeyFrame at the specified 
    index position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.DoubleKeyFrame to be 
    removed.
  """
  pass
