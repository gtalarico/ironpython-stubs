class Table(Block, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild, IAcceptInsertion):
    """
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        """
        OnCreateAutomationPeer(self: Table) -> AutomationPeer
        
            Creates and returns an System.Windows.Automation.Peers.AutomationPeer object for this System.Windows.Documents.Table.
            Returns: An System.Windows.Automation.Peers.AutomationPeer object for this System.Windows.Documents.Table.
        """
        pass
    ...
    def ShouldSerializeColumns(self):
        """
        ShouldSerializeColumns(self: Table) -> bool
        
            Gets a value that indicates whether or not the effective value of the System.Windows.Documents.Table.Columns property should be serialized during serialization of a System.Windows.Documents.Table object.
            Returns: true if the System.Windows.Documents.Table.Columns property should be serialized; otherwise, false.
        """
        pass
    ...
    CellSpacing = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets or sets the amount of spacing between cells in a table.

Get: CellSpacing(self: Table) -> float

Set: CellSpacing(self: Table) = value
"""

    Columns = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a System.Windows.Documents.TableColumnCollection object that contains the columns hosted by the table.

Get: Columns(self: Table) -> TableColumnCollection
...
"""
    ...
    """Gets an enumerator that can be used to iterate the logical children of the System.Windows.Documents.Table.

"""

    RowGroups = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Gets a System.Windows.Documents.TableRowGroupCollection collection object that contains the row groups hosted by the table.

Get: RowGroups(self: Table) -> TableRowGroupCollection

"""


    CellSpacingProperty = None
