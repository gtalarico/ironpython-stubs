class Point3DKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: Point3DKeyFrameCollection,keyFrame: Point3DKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.Point3DKeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.Point3DKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: Point3DKeyFrameCollection)
   Removes all System.Windows.Media.Animation.Point3DKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: Point3DKeyFrameCollection) -> Point3DKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.Point3DKeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: Point3DKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.Point3DKeyFrameCollection. When copying 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: Point3DKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.Point3DKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: Point3DKeyFrameCollection,array: Array[Point3DKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.Point3DKeyFrame objects in a 
    collection to a specified array.
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: Point3DKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.Point3DKeyFrameCollection 
    unmodifiable or determines whether it can be made unmodifiable.
  
  
   isChecking: true if the System.Windows.Freezable instance should actually freeze itself 
    when this method is called. false if the System.Windows.Freezable should simply 
    return whether it can be frozen.
  
   Returns: If isChecking is true,this method returns true if the specified 
    System.Windows.Freezable can be made unmodifiable,or false if it cannot be 
    made unmodifiable. If isChecking is false,this method returns true if the if 
    the specified System.Windows.Freezable is now unmodifiable,or false if it 
    cannot be made unmodifiable,with the side effect of having made the actual 
    change in frozen status to this object.
  """
  pass
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: Point3DKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.Point3DKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: Point3DKeyFrameCollection,keyFrame: Point3DKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.Point3DKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: Point3DKeyFrameCollection,index: int,keyFrame: Point3DKeyFrame)
   Inserts a System.Windows.Media.Animation.Point3DKeyFrame into a specific 
    location within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.Point3DKeyFrame 
    is inserted.
  
   keyFrame: The System.Windows.Media.Animation.Point3DKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: Point3DKeyFrameCollection,keyFrame: Point3DKeyFrame)
   Removes a System.Windows.Media.Animation.Point3DKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.Point3DKeyFrame to remove from 
    the collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: Point3DKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.Point3DKeyFrame at the specified 
    index position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.Point3DKeyFrame to be 
    removed.
  """
  pass
