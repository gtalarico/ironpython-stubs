class DocumentViewer(DocumentViewerBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IServiceProvider):
 ...
 def FitToMaxPagesAcross(self,pagesAcross=None):
  ...
  FitToMaxPagesAcross(self: DocumentViewer)
   Fits the document to the current 
    System.Windows.Controls.DocumentViewer.MaxPagesAcross property setting.
  """
  pass
 def FitToWidth(self):
  """
 ...
 def GetMasterPageView(self,*args):
  ...
  GetMasterPageView(self: DocumentViewerBase) -> DocumentPageView
   ...
   Returns the current master System.Windows.Controls.Primitives.DocumentPageView 
    for this viewer.
  
   Returns: The current master System.Windows.Controls.Primitives.DocumentPageView for this 
    viewer,or null if no master 
    System.Windows.Controls.Primitives.DocumentPageView can be found.
  """
  pass
 def GetPageViewsCollection(self,*args):
  ...
  GetPageViewsCollection(self: DocumentViewer) -> (ReadOnlyCollection[DocumentPageView],bool)
   ...
   Returns a collection of System.Windows.Controls.Primitives.DocumentPageView 
    elements that are currently displayed.
  
   Returns: The collection of System.Windows.Controls.Primitives.DocumentPageView elements 
    that are currently displayed in the System.Windows.Controls.DocumentViewer 
    control.
  """
  pass
 ...
 def InvalidatePageViews(self,*args):
  ...
  InvalidatePageViews(self: DocumentViewerBase)
   Causes the working 
    System.Windows.Controls.Primitives.DocumentViewerBase.PageViews collection to 
    be re-built.
  """
  pass
 ...
 def OnBringIntoView(self,*args):
  ...
  OnBringIntoView(self: DocumentViewer,element: DependencyObject,rect: Rect,pageNumber: int)
   Responds to the 
    System.Windows.Controls.Primitives.DocumentViewerBase.OnBringIntoView(System.Win
    dows.DependencyObject,System.Windows.Rect,System.Int32) method from the 
 ...
 def OnDecreaseZoomCommand(self,*args):
  ...
  OnDecreaseZoomCommand(self: DocumentViewer)
   Responds to calls to the System.Windows.Controls.DocumentViewer.DecreaseZoom 
    method.
  """
  pass
 ...
 def OnFirstPageCommand(self,*args):
  ...
  OnFirstPageCommand(self: DocumentViewer)
   Responds to calls to the 
    System.Windows.Controls.Primitives.DocumentViewerBase.FirstPage method.
  """
  pass
 def OnFitToHeightCommand(self,*args):
  """
  OnFitToHeightCommand(self: DocumentViewer)
   Responds to calls to the System.Windows.Controls.DocumentViewer.FitToHeight 
    method.
  """
  pass
 def OnFitToMaxPagesAcrossCommand(self,*args):
  ...
  OnFitToMaxPagesAcrossCommand(self: DocumentViewer,pagesAcross: int)
   Responds to calls to the 
    System.Windows.Controls.DocumentViewer.FitToMaxPagesAcross(System.Int32) 
    method.
  ...
  OnFitToMaxPagesAcrossCommand(self: DocumentViewer)
   Responds to calls to the 
    System.Windows.Controls.DocumentViewer.FitToMaxPagesAcross method.
  """
  pass
 def OnFitToWidthCommand(self,*args):
  """
  OnFitToWidthCommand(self: DocumentViewer)
   Responds to calls to the System.Windows.Controls.DocumentViewer.FitToWidth 
    method.
  """
  pass
 ...
 def OnGoToPageCommand(self,*args):
  ...
  OnGoToPageCommand(self: DocumentViewer,pageNumber: int)
   Responds to calls to the 
    System.Windows.Controls.Primitives.DocumentViewerBase.GoToPage(System.Int32) 
    method.
 ...
 def OnIncreaseZoomCommand(self,*args):
  ...
  OnIncreaseZoomCommand(self: DocumentViewer)
   Responds to calls to the System.Windows.Controls.DocumentViewer.IncreaseZoom 
    method.
  """
  pass
 ...
 def OnLastPageCommand(self,*args):
  ...
  OnLastPageCommand(self: DocumentViewer)
   Responds to calls to the 
    System.Windows.Controls.Primitives.DocumentViewerBase.LastPage method.
  """
  pass
 ...
 def OnMasterPageNumberChanged(self,*args):
  ...
  OnMasterPageNumberChanged(self: DocumentViewerBase)
   Called whenever the 
    System.Windows.Controls.Primitives.DocumentViewerBase.MasterPageNumber property 
    is modified.
  """
  pass
 ...
 def OnMoveRightCommand(self,*args):
  ...
  OnMoveRightCommand(self: DocumentViewer)
   Responds to calls to the System.Windows.Controls.DocumentViewer.MoveRight 
    method.
  """
  pass
 ...
 def OnNextPageCommand(self,*args):
  ...
  OnNextPageCommand(self: DocumentViewer)
   Responds to calls to the 
    System.Windows.Controls.Primitives.DocumentViewerBase.NextPage method.
  """
  pass
 def OnPageViewsChanged(self,*args):
  """
  OnPageViewsChanged(self: DocumentViewerBase)
   Called whenever the working set of 
    System.Windows.Controls.Primitives.DocumentPageView objects for this viewer 
    (represented by the 
    System.Windows.Controls.Primitives.DocumentViewerBase.PageViews property) is 
    modified.
  """
  pass
 ...
 def OnPreviousPageCommand(self,*args):
  ...
  OnPreviousPageCommand(self: DocumentViewer)
   Responds to calls to the 
    System.Windows.Controls.Primitives.DocumentViewerBase.PreviousPage method.
  """
  pass
 ...
 def OnScrollPageDownCommand(self,*args):
  ...
  OnScrollPageDownCommand(self: DocumentViewer)
   Responds to calls to the System.Windows.Controls.DocumentViewer.ScrollPageDown 
    method.
  """
  pass
 def OnScrollPageLeftCommand(self,*args):
  ...
  OnScrollPageLeftCommand(self: DocumentViewer)
   Responds to calls to the System.Windows.Controls.DocumentViewer.ScrollPageLeft 
    method.
  """
  pass
 def OnScrollPageRightCommand(self,*args):
  ...
  OnScrollPageRightCommand(self: DocumentViewer)
   Responds to calls to the System.Windows.Controls.DocumentViewer.ScrollPageRight 
    method.
  """
  pass
 def OnScrollPageUpCommand(self,*args):
  ...
  OnScrollPageUpCommand(self: DocumentViewer)
   Responds to calls to the System.Windows.Controls.DocumentViewer.ScrollPageUp 
    method.
  """
  pass
 ...
 def OnViewThumbnailsCommand(self,*args):
  ...
  OnViewThumbnailsCommand(self: DocumentViewer)
   Responds to calls to the System.Windows.Controls.DocumentViewer.ViewThumbnails 
    method.
  """
  pass
