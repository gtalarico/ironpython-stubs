class ToolboxBitmapAttribute(Attribute,_Attribute):
 ...
 def GetImageFromResource(t,imageName,large):
  ...
  GetImageFromResource(t: Type,imageName: str,large: bool) -> Image
   ...
   t: This method searches for an embedded bitmap resource in the assembly that defines the type specified by the t parameter. For example,if you pass typeof(ControlA) to the t parameter,then this method searches the assembly that defines ControlA.
