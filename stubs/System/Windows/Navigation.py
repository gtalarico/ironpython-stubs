...
class CustomContentState(object):
    ...
    def Replay(self, navigationService, mode):
        ...
        Replay(self: CustomContentState, navigationService: NavigationService, mode: NavigationMode)
            ...
            navigationService: The System.Windows.Navigation.NavigationService owned by the navigator 
             responsible for the content to which this 
             System.Windows.Navigation.CustomContentState is being applied.
        
            mode: A System.Windows.Navigation.NavigationMode that specifies how the content to 
             which the System.Windows.Navigation.CustomContentState is being applied was 
             navigated to.
        """
        pass
...
class NavigationWindow(Window, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IWindowService, INavigator, INavigatorBase, INavigatorImpl, IDownloader, IJournalNavigationScopeHost, IUriContext):
    ...
    def Navigate(self, *__args):
        ...
        Navigate(self: NavigationWindow, source: Uri) -> bool
            ...
            Navigates asynchronously to content that is specified by a uniform resource 
             identifier (URI).
        ...
        Navigate(self: NavigationWindow, source: Uri, extraData: object) -> bool
            ...
            Navigates asynchronously to source content located at a uniform resource 
             identifier (URI), and pass an object that contains data to be used for 
             processing during navigation.
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: NavigationWindow) -> AutomationPeer
            ...
            Creates and returns a 
             System.Windows.Automation.Peers.NavigationWindowAutomationPeer object for this 
             System.Windows.Navigation.NavigationWindow.
        
            Returns: A System.Windows.Automation.Peers.NavigationWindowAutomationPeer object for 
             this System.Windows.Navigation.NavigationWindow.
        """
        pass
    ...
    def ShouldSerializeContent(self):
        ...
        ShouldSerializeContent(self: NavigationWindow) -> bool
            ...
            Indicates whether the System.Windows.Controls.ContentControl.Content property 
             should be persisted.
...
class PageFunctionBase(Page, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IWindowService, IAddChild):
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: Page, constraint: Size) -> Size
            ...
            Returns: A System.Windows.Size that is the actual size of the window. The method may 
             return a larger value, in which case the parent may need to add scroll bars.
        """
        pass
    ...
    def Start(self, *args): #cannot find CLR method
        ...
        Start(self: PageFunctionBase)
            Override this method to initialize a System.Windows.Navigation.PageFunction 
             when it is navigated to for the first time.
        """
        pass
...
class PageFunction(PageFunctionBase, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IWindowService, IAddChild):
    ...
    def OnReturn(self, *args): #cannot find CLR method
        ...
        OnReturn(self: PageFunction[T], e: ReturnEventArgs[T])
            A System.Windows.Navigation.PageFunction calls 
             System.Windows.Navigation.PageFunction to return to the caller, passing a 
             return value via a System.Windows.Navigation.ReturnEventArgs object
        
        
            e: A System.Windows.Navigation.ReturnEventArgs object that contains the 
             System.Windows.Navigation.PageFunction return value 
