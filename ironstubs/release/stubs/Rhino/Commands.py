...
class Command(object):
    ...
    def GetCommandNames(english, loaded):
        ...
        GetCommandNames(english: bool, loaded: bool) -> Array[str]
            ...
            Gets list of command names in Rhino. This list does not include Test, Alpha, or 
             System commands.
        
        
            english: if true, retrieve the english name for every command.
                     if false, 
             retrieve the local name for every command.
        
            loaded: if true, only get names of currently loaded commands.
                    if false, get 
             names of all registered (may not be currently loaded) commands.
    ...
    def GetCommandStack():
        ...
        GetCommandStack() -> Array[Guid]
            ...
            Determines if Rhino is currently running a command. Because Rhino allow for 
             transparent commands
                    (commands that can be run from inside of other 
             commands), this method returns the total ids of
                    active commands.
    ...
    def InScriptRunnerCommand():
        ...
        InScriptRunnerCommand() -> bool
            ...
            This is a low level tool to determine if Rhino is currently running
                    a 
             script running command like "ReadCommandFile" or the RhinoScript
    ...
    def LookupCommandId(name, searchForEnglishName):
        ...
        LookupCommandId(name: str, searchForEnglishName: bool) -> Guid
            ...
            searchForEnglishName: true if the name is to searched in English. This ensures that a '_' is prepended 
             to the name.
