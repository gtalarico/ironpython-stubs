class PointAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: PointAnimationBase) -> PointAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.PointAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
