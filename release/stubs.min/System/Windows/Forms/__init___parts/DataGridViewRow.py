class DataGridViewRow(DataGridViewBand,ICloneable,IDisposable):
 ...
 def DrawFocus(self,*args):
  ...
  DrawFocus(self: DataGridViewRow,graphics: Graphics,clipBounds: Rectangle,bounds: Rectangle,rowIndex: int,rowState: DataGridViewElementStates,cellStyle: DataGridViewCellStyle,cellsPaintSelectionBackground: bool)
   ...
   cellsPaintSelectionBackground: true to use the System.Windows.Forms.DataGridViewCellStyle.SelectionBackColor property of cellStyle as the color of the focus rectangle; false to use the System.Windows.Forms.DataGridViewCellStyle.BackColor property of cellStyle as the color of the focus rectangle.
  """
  pass
