class ItemsControl(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 ...
 def BeginInit(self):
  ...
  BeginInit(self: ItemsControl)
   Indicates that the initialization of the System.Windows.Controls.ItemsControl 
    object is about to start.
  
  BeginInit(self: ComboBox_21$22)
  """
  pass
 ...
 def ContainerFromElement(*__args):
  ...
  ContainerFromElement(self: ItemsControl,element: DependencyObject) -> DependencyObject
   ...
   Returns the container that belongs to the current 
    System.Windows.Controls.ItemsControl that owns the given element.
  
  
   element: The element to return the container for.
   Returns: The container that belongs to the current System.Windows.Controls.ItemsControl 
    that owns the given element or null if no such container exists.
  
  ContainerFromElement(itemsControl: ItemsControl,element: DependencyObject) -> DependencyObject
  
   Returns the container that belongs to the specified 
    System.Windows.Controls.ItemsControl that owns the given container element.
  
  
   itemsControl: The System.Windows.Controls.ItemsControl to return the container for.
   element: The element to return the container for.
   Returns: The container that belongs to the specified 
    System.Windows.Controls.ItemsControl that owns the given element,if 
    itemsControl is not null. If itemsControl is null,returns the closest 
 ...
 def GetAlternationIndex(element):
  ...
  GetAlternationIndex(element: DependencyObject) -> int
   ...
   Gets the System.Windows.Controls.ItemsControl.AlternationIndex for the 
    specified object.
  
  
   element: The object from which to get the 
    System.Windows.Controls.ItemsControl.AlternationIndex.
 ...
 def GetContainerForItemOverride(self,*args):
  ...
  GetContainerForItemOverride(self: ComboBox_21$22) -> DependencyObject
  """
  pass
 @staticmethod
 def GetItemsOwner(element):
  ...
  GetItemsOwner(element: DependencyObject) -> ItemsControl
   ...
   Returns: The System.Windows.Controls.ItemsControl that the specified element hosts items 
    for,or null.
  """
  pass
 ...
 def IsItemItsOwnContainerOverride(self,*args):
  ...
  IsItemItsOwnContainerOverride(self: ComboBox_21$22,item: object) -> bool
  """
  pass
 @staticmethod
 def ItemsControlFromItemContainer(container):
  ...
  ItemsControlFromItemContainer(container: DependencyObject) -> ItemsControl
   ...
   Returns: The System.Windows.Controls.ItemsControl that owns the specified container 
    element.
  """
  pass
 ...
 def OnItemsChanged(self,*args):
  ...
  OnItemsChanged(self: ComboBox_21$22,e: NotifyCollectionChangedEventArgs)
  """
  pass
 ...
 def PrepareContainerForItemOverride(self,*args):
  ...
  PrepareContainerForItemOverride(self: ItemsControl,element: DependencyObject,item: object)
   ...
   item: Specified item.
  PrepareContainerForItemOverride(self: ComboBox_21$22,element: DependencyObject,item: object)
  """
  pass
 ...
 def ShouldSerializeGroupStyle(self):
  ...
  ShouldSerializeGroupStyle(self: ItemsControl) -> bool
   ...
   Returns a value that indicates whether serialization processes should serialize 
    the effective value of the System.Windows.Controls.ItemsControl.GroupStyle 
    property.
  
   Returns: true if the System.Windows.Controls.ItemsControl.GroupStyle property value 
 ...
 def ShouldSerializeItems(self):
  ...
  ShouldSerializeItems(self: ItemsControl) -> bool
   ...
   Returns a value that indicates whether serialization processes should serialize 
    the effective value of the System.Windows.Controls.ItemsControl.Items property.
  
   Returns: true if the System.Windows.Controls.ItemsControl.Items property value should be 
 ...
 def ToString(self):
  ...
  ToString(self: ItemsControl) -> str
   ...
   Provides a string representation of the System.Windows.Controls.ItemsControl 
    object.
  
   Returns: The string representation of the object.
  ToString(self: ComboBox_21$22) -> str
  """
  pass
