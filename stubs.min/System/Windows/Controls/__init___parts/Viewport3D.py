class Viewport3D(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: Viewport3D,finalSize: Size) -> Size
   ...
   Causes the System.Windows.Controls.Viewport3D to arrange its visual content to 
    fit a specified size.
 ...
 def GetVisualChild(self,*args):
  ...
  GetVisualChild(self: Viewport3D,index: int) -> Visual
   ...
   Returns: Visual at the specified position in the 
    System.Windows.Controls.Viewport3D.Children collection.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: Viewport3D) -> AutomationPeer
   ...
   Creates and returns a System.Windows.Automation.Peers.Viewport3DAutomationPeer 
    object for this System.Windows.Controls.Viewport3D.
