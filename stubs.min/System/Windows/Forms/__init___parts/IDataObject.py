class IDataObject:
    ...
    def GetData(self, format, autoConvert=None):
        ...
        GetData(self: IDataObject, format: Type) -> object
            ...
            format: A System.Type representing the format of the data to retrieve. See System.Windows.Forms.DataFormats for predefined formats.
    ...
    def GetDataPresent(self, format, autoConvert=None):
        ...
        GetDataPresent(self: IDataObject, format: Type) -> bool
            ...
            format: A System.Type representing the format for which to check. See System.Windows.Forms.DataFormats for predefined formats.
            Returns: true if data stored in this instance is associated with, or can be converted to, the specified format; otherwise, false.
        ...
        GetDataPresent(self: IDataObject, format: str, autoConvert: bool) -> bool
            ...
            format: The format for which to check. See System.Windows.Forms.DataFormats for predefined formats.
            autoConvert: true to determine whether data stored in this instance can be converted to the specified format; false to check whether the data is in the specified format.
    ...
    def GetFormats(self, autoConvert=None):
        ...
        GetFormats(self: IDataObject) -> Array[str]
            ...
            Returns: An array of the names that represents a list of all formats that are supported by the data stored in this object.
        GetFormats(self: IDataObject, autoConvert: bool) -> Array[str]
        
            Gets a list of all formats that data stored in this instance is associated with or can be converted to, using a Boolean value to determine whether to retrieve all formats that the data can be converted to 
             or only native data formats.
        
        
            autoConvert: true to retrieve all formats that data stored in this instance is associated with or can be converted to; false to retrieve only native data formats.
            Returns: An array of the names that represents a list of all formats that are supported by the data stored in this object.
        """
        pass
    ...
    def SetData(self, *__args):
        ...
        SetData(self: IDataObject, format: Type, data: object)
            ...
            format: A System.Type representing the format associated with the data. See System.Windows.Forms.DataFormats for predefined formats.
