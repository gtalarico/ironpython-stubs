class PopupEventArgs(CancelEventArgs):
    ...
    AssociatedControl = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AssociatedWindow = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ToolTipSize = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
