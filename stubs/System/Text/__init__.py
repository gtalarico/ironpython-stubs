...
class Encoding(object, ICloneable):
    ...
    def Equals(self, value):
        ...
        Equals(self: Encoding, value: object) -> bool
            ...
            Returns: true if value is an instance of System.Text.Encoding and is equal to the current instance; otherwise, false.
        """
        pass
    ...
    def GetEncoding(*__args):
        ...
        GetEncoding(name: str) -> Encoding
            ...
            name: The code page name of the preferred encoding. Any value returned by the System.Text.Encoding.WebName property is valid. Possible values are listed in the Name column of the table that appears in the 
        ...
        GetEncoding(codepage: int) -> Encoding
            ...
            codepage: The code page identifier of the preferred encoding. Possible values are listed in the Code Page column of the table that appears in the System.Text.Encoding class topic.-or- 0 (zero), to use the default 
             encoding.
    ...
    def IsAlwaysNormalized(self, form=None):
        ...
        IsAlwaysNormalized(self: Encoding, form: NormalizationForm) -> bool
            ...
            Returns: true if the current System.Text.Encoding object is always normalized using the specified System.Text.NormalizationForm value; otherwise, false. The default is false.
        IsAlwaysNormalized(self: Encoding) -> bool
            ...
            Returns: true if the current System.Text.Encoding is always normalized; otherwise, false. The default is false.
        """
        pass
...
class ASCIIEncoding(Encoding, ICloneable):
    ...
    def GetByteCount(self, chars, *__args):
        ...
        GetByteCount(self: ASCIIEncoding, chars: str) -> int
            ...
            Calculates the number of bytes produced by encoding the characters in the specified System.String.
    ...
    def GetDecoder(self):
        ...
        GetDecoder(self: ASCIIEncoding) -> Decoder
            ...
            Returns: A System.Text.Decoder that converts an ASCII encoded sequence of bytes into a sequence of Unicode characters.
        """
        pass
    ...
    def GetEncoder(self):
        ...
        GetEncoder(self: ASCIIEncoding) -> Encoder
            ...
            Returns: An System.Text.Encoder that converts a sequence of Unicode characters into an ASCII encoded sequence of bytes.
        """
        pass
...
class Decoder(object):
    ...
    def Convert(self, bytes, *__args):
        ...
        Convert(self: Decoder, bytes: Array[Byte], byteIndex: int, byteCount: int, chars: Array[Char], charIndex: int, charCount: int, flush: bool) -> (int, int, bool)
            ...
            Converts an array of encoded bytes to UTF-16 encoded characters and stores the result in a byte array.
    ...
    def GetCharCount(self, bytes, *__args):
        ...
        GetCharCount(self: Decoder, bytes: Byte*, count: int, flush: bool) -> int
            ...
            When overridden in a derived class, calculates the number of characters produced by decoding a sequence of bytes starting at the specified byte pointer. A parameter indicates whether to clear the internal 
             state of the decoder after the calculation.
        ...
        GetCharCount(self: Decoder, bytes: Array[Byte], index: int, count: int, flush: bool) -> int
            ...
            When overridden in a derived class, calculates the number of characters produced by decoding a sequence of bytes from the specified byte array. A parameter indicates whether to clear the internal state of 
             the decoder after the calculation.
    ...
    def GetChars(self, bytes, *__args):
        ...
        GetChars(self: Decoder, bytes: Byte*, byteCount: int, chars: Char*, charCount: int, flush: bool) -> int
            ...
            When overridden in a derived class, decodes a sequence of bytes starting at the specified byte pointer and any bytes in the internal buffer into a set of characters that are stored starting at the 
             specified character pointer. A parameter indicates whether to clear the internal state of the decoder after the conversion.
        ...
        GetChars(self: Decoder, bytes: Array[Byte], byteIndex: int, byteCount: int, chars: Array[Char], charIndex: int, flush: bool) -> int
            ...
            When overridden in a derived class, decodes a sequence of bytes from the specified byte array and any bytes in the internal buffer into the specified character array. A parameter indicates whether to clear 
             the internal state of the decoder after the conversion.
...
class DecoderFallbackBuffer(object):
    ...
    def Fallback(self, bytesUnknown, index):
        ...
        Fallback(self: DecoderFallbackBuffer, bytesUnknown: Array[Byte], index: int) -> bool
            ...
            Returns: true if the fallback buffer can process bytesUnknown; false if the fallback buffer ignores bytesUnknown.
        """
        pass
    ...
    def MovePrevious(self):
        ...
        MovePrevious(self: DecoderFallbackBuffer) -> bool
            ...
            When overridden in a derived class, causes the next call to the System.Text.DecoderFallbackBuffer.GetNextChar method to access the data buffer character position that is prior to the current character 
             position.
...
class DecoderExceptionFallbackBuffer(DecoderFallbackBuffer):
    ...
    def Fallback(self, bytesUnknown, index):
        ...
        Fallback(self: DecoderExceptionFallbackBuffer, bytesUnknown: Array[Byte], index: int) -> bool
            ...
            Returns: None. No value is returned because the System.Text.DecoderExceptionFallbackBuffer.Fallback(System.Byte[],System.Int32) method always throws an exception. The nominal return value is true. A return value is 
...
class DecoderReplacementFallback(DecoderFallback):
    ...
    def CreateFallbackBuffer(self):
        ...
        CreateFallbackBuffer(self: DecoderReplacementFallback) -> DecoderFallbackBuffer
            ...
            Returns: A System.Text.DecoderFallbackBuffer object that specifies a string to use instead of the original decoding operation input.
        """
        pass
...
class DecoderReplacementFallbackBuffer(DecoderFallbackBuffer):
    ...
    def Reset(self):
        ...
        Reset(self: DecoderReplacementFallbackBuffer)
            Initializes all internal state information and data in the System.Text.DecoderReplacementFallbackBuffer object.
        """
        pass
...
class Encoder(object):
    ...
    def GetByteCount(self, chars, *__args):
        ...
        GetByteCount(self: Encoder, chars: Char*, count: int, flush: bool) -> int
            ...
            When overridden in a derived class, calculates the number of bytes produced by encoding a set of characters starting at the specified character pointer. A parameter indicates whether to clear the internal 
             state of the encoder after the calculation.
        ...
        GetByteCount(self: Encoder, chars: Array[Char], index: int, count: int, flush: bool) -> int
            ...
            When overridden in a derived class, calculates the number of bytes produced by encoding a set of characters from the specified character array. A parameter indicates whether to clear the internal state of 
             the encoder after the calculation.
    ...
    def GetBytes(self, chars, *__args):
        ...
        GetBytes(self: Encoder, chars: Char*, charCount: int, bytes: Byte*, byteCount: int, flush: bool) -> int
            ...
            When overridden in a derived class, encodes a set of characters starting at the specified character pointer and any characters in the internal buffer into a sequence of bytes that are stored starting at 
             the specified byte pointer. A parameter indicates whether to clear the internal state of the encoder after the conversion.
        ...
        GetBytes(self: Encoder, chars: Array[Char], charIndex: int, charCount: int, bytes: Array[Byte], byteIndex: int, flush: bool) -> int
            ...
            When overridden in a derived class, encodes a set of characters from the specified character array and any characters in the internal buffer into the specified byte array. A parameter indicates whether to 
...
class EncoderExceptionFallback(EncoderFallback):
    ...
    def Equals(self, value):
        ...
        Equals(self: EncoderExceptionFallback, value: object) -> bool
            ...
            Returns: true if value is not null (Nothing in Visual Basic .NET) and is a System.Text.EncoderExceptionFallback object; otherwise, false.
        """
        pass
...
class EncoderFallbackBuffer(object):
    ...
    def Fallback(self, *__args):
        ...
        Fallback(self: EncoderFallbackBuffer, charUnknownHigh: Char, charUnknownLow: Char, index: int) -> bool
            ...
            Returns: true if the fallback buffer can process charUnknownHigh and charUnknownLow; false if the fallback buffer ignores the surrogate pair.
        Fallback(self: EncoderFallbackBuffer, charUnknown: Char, index: int) -> bool
            ...
            Returns: true if the fallback buffer can process charUnknown; false if the fallback buffer ignores charUnknown.
        """
        pass
    ...
    def MovePrevious(self):
        ...
        MovePrevious(self: EncoderFallbackBuffer) -> bool
            ...
            When overridden in a derived class, causes the next call to the System.Text.EncoderFallbackBuffer.GetNextChar method to access the data buffer character position that is prior to the current character 
             position.
...
class EncoderExceptionFallbackBuffer(EncoderFallbackBuffer):
    ...
    def Fallback(self, *__args):
        ...
        Fallback(self: EncoderExceptionFallbackBuffer, charUnknownHigh: Char, charUnknownLow: Char, index: int) -> bool
            ...
            charUnknownLow: The low surrogate of the input pair.
            index: The index position of the surrogate pair in the input buffer.
            Returns: None. No value is returned because the System.Text.EncoderExceptionFallbackBuffer.Fallback(System.Char,System.Char,System.Int32) method always throws an exception.
...
class EncoderReplacementFallback(EncoderFallback):
    ...
    def CreateFallbackBuffer(self):
        ...
        CreateFallbackBuffer(self: EncoderReplacementFallback) -> EncoderFallbackBuffer
            ...
            Creates a System.Text.EncoderFallbackBuffer object that is initialized with the replacement string of this System.Text.EncoderReplacementFallback object.
            Returns: A System.Text.EncoderFallbackBuffer object equal to this System.Text.EncoderReplacementFallback object.
        """
        pass
...
class EncoderReplacementFallbackBuffer(EncoderFallbackBuffer):
    ...
    def Fallback(self, *__args):
        ...
        Fallback(self: EncoderReplacementFallbackBuffer, charUnknownHigh: Char, charUnknownLow: Char, index: int) -> bool
            ...
            Indicates whether a replacement string can be used when an input surrogate pair cannot be encoded, or whether the surrogate pair can be ignored. Parameters specify the surrogate pair and the index position 
             of the pair in the input.
        ...
        Fallback(self: EncoderReplacementFallbackBuffer, charUnknown: Char, index: int) -> bool
            ...
            index: The index position of the character in the input buffer. This parameter is ignored in this operation.
            Returns: true if the replacement string is not empty; false if the replacement string is empty.
        """
        pass
...
class EncodingInfo(object):
    ...
    def Equals(self, value):
        ...
        Equals(self: EncodingInfo, value: object) -> bool
            ...
            Returns: true if value is a System.Text.EncodingInfo object and is equal to the current System.Text.EncodingInfo object; otherwise, false.
        """
        pass
...
class StringBuilder(object, ISerializable):
    ...
    def AppendFormat(self, *__args):
        ...
        AppendFormat(self: StringBuilder, provider: IFormatProvider, format: str, *args: Array[object]) -> StringBuilder
            ...
            Appends the string returned by processing a composite format string, which contains zero or more format items, to this instance. Each format item is replaced by the string representation of a corresponding 
            ...
            Returns: A reference to this instance after the append operation has completed. After the append operation, this instance contains any data that existed before the operation, suffixed by a copy of format where any 
             format specification is replaced by the string representation of the corresponding object argument.
        ...
        AppendFormat(self: StringBuilder, format: str, arg0: object, arg1: object) -> StringBuilder
            ...
            Appends the string returned by processing a composite format string, which contains zero or more format items, to this instance. Each format item is replaced by the string representation of either of two 
             arguments.
        ...
        AppendFormat(self: StringBuilder, format: str, arg0: object) -> StringBuilder
            ...
            Appends the string returned by processing a composite format string, which contains zero or more format items, to this instance. Each format item is replaced by the string representation of a single 
             argument.
        ...
        AppendFormat(self: StringBuilder, format: str, arg0: object, arg1: object, arg2: object) -> StringBuilder
            ...
            Appends the string returned by processing a composite format string, which contains zero or more format items, to this instance. Each format item is replaced by the string representation of either of three 
             arguments.
    ...
    def Equals(self, *__args):
        ...
        Equals(self: StringBuilder, sb: StringBuilder) -> bool
            ...
            Returns: true if this instance and sb have equal string, System.Text.StringBuilder.Capacity, and System.Text.StringBuilder.MaxCapacity values; otherwise, false.
        """
        pass
...
class UnicodeEncoding(Encoding, ICloneable):
    ...
    def Equals(self, value):
        ...
        Equals(self: UnicodeEncoding, value: object) -> bool
            ...
            Determines whether the specified System.Object is equal to the current System.Text.UnicodeEncoding object.
        
            value: The System.Object to compare with the current object.
            Returns: true if value is an instance of System.Text.UnicodeEncoding and is equal to the current object; otherwise, false.
        """
        pass
    ...
    def GetDecoder(self):
        ...
        GetDecoder(self: UnicodeEncoding) -> Decoder
            ...
            Returns: A System.Text.Decoder that converts a UTF-16 encoded sequence of bytes into a sequence of Unicode characters.
        """
        pass
    ...
    def GetEncoder(self):
        ...
        GetEncoder(self: UnicodeEncoding) -> Encoder
            ...
            Returns: A System.Text.Encoder object that converts a sequence of Unicode characters into a UTF-16 encoded sequence of bytes.
        """
        pass
...
class UTF32Encoding(Encoding, ICloneable):
    ...
    def Equals(self, value):
        ...
        Equals(self: UTF32Encoding, value: object) -> bool
            ...
            Determines whether the specified System.Object is equal to the current System.Text.UTF32Encoding object.
        
            value: The System.Object to compare with the current object.
            Returns: true if value is an instance of System.Text.UTF32Encoding and is equal to the current object; otherwise, false.
        """
        pass
    ...
    def GetDecoder(self):
        ...
        GetDecoder(self: UTF32Encoding) -> Decoder
            ...
            Returns: A System.Text.Decoder that converts a UTF-32 encoded sequence of bytes into a sequence of Unicode characters.
        """
        pass
    ...
    def GetEncoder(self):
        ...
        GetEncoder(self: UTF32Encoding) -> Encoder
            ...
            Returns: A System.Text.Encoder that converts a sequence of Unicode characters into a UTF-32 encoded sequence of bytes.
        """
        pass
...
class UTF7Encoding(Encoding, ICloneable):
    ...
    def Equals(self, value):
        ...
        Equals(self: UTF7Encoding, value: object) -> bool
            ...
            Returns: true if value is a System.Text.UTF7Encoding object and is equal to the current System.Text.UTF7Encoding object; otherwise, false.
        """
        pass
    ...
    def GetByteCount(self, *__args):
        ...
        GetByteCount(self: UTF7Encoding, s: str) -> int
            ...
            Calculates the number of bytes produced by encoding the characters in the specified System.String object.
    ...
    def GetDecoder(self):
        ...
        GetDecoder(self: UTF7Encoding) -> Decoder
            ...
            Returns: A System.Text.Decoder that converts a UTF-7 encoded sequence of bytes into a sequence of Unicode characters.
        """
        pass
    ...
    def GetEncoder(self):
        ...
        GetEncoder(self: UTF7Encoding) -> Encoder
            ...
            Returns: A System.Text.Encoder that converts a sequence of Unicode characters into a UTF-7 encoded sequence of bytes.
        """
        pass
...
class UTF8Encoding(Encoding, ICloneable):
    ...
    def Equals(self, value):
        ...
        Equals(self: UTF8Encoding, value: object) -> bool
            ...
            Determines whether the specified System.Object is equal to the current System.Text.UTF8Encoding object.
        
            value: The System.Object to compare with the current instance.
            Returns: true if value is an instance of System.Text.UTF8Encoding and is equal to the current object; otherwise, false.
        """
        pass
    ...
    def GetDecoder(self):
        ...
        GetDecoder(self: UTF8Encoding) -> Decoder
            ...
            Returns: A System.Text.Decoder that converts a UTF-8 encoded sequence of bytes into a sequence of Unicode characters.
        """
        pass
    ...
    def GetEncoder(self):
        ...
        GetEncoder(self: UTF8Encoding) -> Encoder
            ...
            Returns: A System.Text.Encoder that converts a sequence of Unicode characters into a UTF-8 encoded sequence of bytes.
        """
        pass
