class Italic(Span, IInputElement, IAnimatable, IFrameworkInputElement, ISupportInitialize, IQueryAmbient, IAddChild):
    """
    Provides an inline-level flow content element that causes content to render with an italic font style.
    
    Italic()
    Italic(childInline: Inline)
    Italic(childInline: Inline, insertionPosition: TextPointer)
    Italic(start: TextPointer, end: TextPointer)
    """
