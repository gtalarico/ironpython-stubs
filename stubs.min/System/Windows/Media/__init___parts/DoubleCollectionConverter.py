class DoubleCollectionConverter(TypeConverter):
 ...
 def CanConvertFrom(self,*__args):
  ...
  CanConvertFrom(self: DoubleCollectionConverter,context: ITypeDescriptorContext,sourceType: Type) -> bool
   ...
   Determines whether an object can be converted from a specified type to an 
    instance of a System.Windows.Media.DoubleCollection.
  
  
   context: The context information of a type.
   sourceType: The type of the source that is being evaluated for conversion.
   Returns: true if the type can be converted to a System.Windows.Media.DoubleCollection; 
    otherwise,false.
  """
  pass
 def CanConvertTo(self,*__args):
  ...
  CanConvertTo(self: DoubleCollectionConverter,context: ITypeDescriptorContext,destinationType: Type) -> bool
   ...
   Determines whether an instance of a System.Windows.Media.DoubleCollection can 
    be converted to a different type.
  
  
   context: The context information of a type.
   destinationType: The needed type for which you are evaluating this 
    System.Windows.Media.DoubleCollection for conversion.
  
   Returns: true if this System.Windows.Media.DoubleCollection can be converted to 
 ...
 def ConvertTo(self,*__args):
  ...
  ConvertTo(self: DoubleCollectionConverter,context: ITypeDescriptorContext,culture: CultureInfo,value: object,destinationType: Type) -> object
   ...
   Returns: The object you create when you convert this 
    System.Windows.Media.DoubleCollection.
  """
  pass
