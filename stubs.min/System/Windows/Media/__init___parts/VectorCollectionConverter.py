class VectorCollectionConverter(TypeConverter):
 ...
 def CanConvertFrom(self,*__args):
  ...
  CanConvertFrom(self: VectorCollectionConverter,context: ITypeDescriptorContext,sourceType: Type) -> bool
   ...
   Determines whether an object can be converted from a specified type to an 
    instance of a System.Windows.Media.VectorCollection.
  
  
   context: The context information of a type.
   sourceType: The type of the source to evaluate for conversion.
   Returns: true if you can convert the type to a System.Windows.Media.VectorCollection; 
    otherwise,false.
  """
  pass
 def CanConvertTo(self,*__args):
  ...
  CanConvertTo(self: VectorCollectionConverter,context: ITypeDescriptorContext,destinationType: Type) -> bool
   ...
   Determines whether an instance of a System.Windows.Media.VectorCollection can 
    be converted to a different type.
  
  
   context: The context information of a type.
   destinationType: The needed type for which you are evaluating this 
    System.Windows.Media.VectorCollection for conversion.
  
   Returns: true if this System.Windows.Media.VectorCollection can be converted to 
