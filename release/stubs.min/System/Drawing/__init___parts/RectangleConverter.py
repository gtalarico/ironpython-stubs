class RectangleConverter(TypeConverter):
 ...
 def CanConvertFrom(self,*__args):
  ...
  CanConvertFrom(self: RectangleConverter,context: ITypeDescriptorContext,sourceType: Type) -> bool
   ...
   context: A formatter context. This object can be used to get additional information about the environment this converter is being called from. This may be null,so you should always check. Also,properties on the context object may also return null.
 ...
 def ConvertFrom(self,*__args):
  ...
  ConvertFrom(self: RectangleConverter,context: ITypeDescriptorContext,culture: CultureInfo,value: object) -> object
   ...
   context: A System.ComponentModel.ITypeDescriptorContext that can be used to get additional information about the environment this converter is being called from. This may be null,so you should always check. Also,properties on the context object may also return null.
   culture: An System.Globalization.CultureInfo that contains culture specific information,such as the language,calendar,and cultural conventions associated with a specific culture. It is based on the RFC 1766 standard.
 ...
 def CreateInstance(self,*__args):
  ...
  CreateInstance(self: RectangleConverter,context: ITypeDescriptorContext,propertyValues: IDictionary) -> object
   ...
   propertyValues: A dictionary of new property values. The dictionary contains a series of name-value pairs,one for each property returned from a call to the System.Drawing.RectangleConverter.GetProperties(System.ComponentModel.ITypeDescriptorContext,System.Object,System.Attribute[]) method.
 ...
 def GetCreateInstanceSupported(self,context=None):
  ...
  GetCreateInstanceSupported(self: RectangleConverter,context: ITypeDescriptorContext) -> bool
   ...
   Determines if changing a value on this object should require a call to System.Drawing.RectangleConverter.CreateInstance(System.ComponentModel.ITypeDescriptorContext,System.Collections.IDictionary) to create a new value.
  
   context: A type descriptor through which additional context can be provided.
   Returns: This method returns true if System.Drawing.RectangleConverter.CreateInstance(System.ComponentModel.ITypeDescriptorContext,System.Collections.IDictionary) should be called when a change is made to one or more properties of this object; otherwise,false.
  """
  pass
 ...
 def GetPropertiesSupported(self,context=None):
  ...
  GetPropertiesSupported(self: RectangleConverter,context: ITypeDescriptorContext) -> bool
   ...
   context: A System.ComponentModel.ITypeDescriptorContext through which additional context can be provided.
   Returns: This method returns true if System.Drawing.RectangleConverter.GetProperties(System.ComponentModel.ITypeDescriptorContext,System.Object,System.Attribute[]) should be called to find the properties of this object; otherwise,false.
  """
  pass
