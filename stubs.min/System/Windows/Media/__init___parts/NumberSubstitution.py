class NumberSubstitution(object):
 ...
 def Equals(self,obj):
  ...
  Equals(self: NumberSubstitution,obj: object) -> bool
   ...
   Determines whether the specified object is equal to the current 
    System.Windows.Media.NumberSubstitution object.
  
  
   obj: The System.Object to compare with the current 
    System.Windows.Media.NumberSubstitution object.
  
   Returns: true if o is equal to the current System.Windows.Media.NumberSubstitution 
    object; otherwise,false. If o is not a System.Windows.Media.NumberSubstitution 
 ...
 def GetCultureOverride(target):
  ...
  GetCultureOverride(target: DependencyObject) -> CultureInfo
   ...
   Returns the value of System.Windows.Media.NumberSubstitution.CultureOverride 
    from the provided element.
  
  
   target: The element to return a System.Windows.Media.NumberSubstitution.CultureOverride 
    value for.
  
   Returns: A System.Globalization.CultureInfo value that represents the culture that is 
    used as an override.
  """
  pass
 @staticmethod
 def GetCultureSource(target):
  ...
  GetCultureSource(target: DependencyObject) -> NumberCultureSource
   ...
   Returns the value of System.Windows.Media.NumberSubstitution.CultureSource from 
    the provided element.
  
  
   target: The element to return a System.Windows.Media.NumberSubstitution.CultureSource 
    value for.
 ...
 def GetHashCode(self):
  ...
  GetHashCode(self: NumberSubstitution) -> int
   ...
   Serves as a hash function for System.Windows.Media.NumberSubstitution. It is 
 ...
 def GetSubstitution(target):
  ...
  GetSubstitution(target: DependencyObject) -> NumberSubstitutionMethod
   ...
   Returns the value of System.Windows.Media.NumberSubstitution.Substitution from 
    the provided element.
  
  
   target: The element to return a System.Windows.Media.NumberSubstitution.Substitution 
    value for.
 ...
 def SetCultureOverride(target,value):
  ...
  SetCultureOverride(target: DependencyObject,value: CultureInfo)
   Sets the value of System.Windows.Media.NumberSubstitution.CultureOverride for a 
    provided element.
 ...
 def SetCultureSource(target,value):
  ...
  SetCultureSource(target: DependencyObject,value: NumberCultureSource)
   Sets the value of System.Windows.Media.NumberSubstitution.CultureSource for a 
    provided element.
 ...
 def SetSubstitution(target,value):
  ...
  SetSubstitution(target: DependencyObject,value: NumberSubstitutionMethod)
   Sets the value of System.Windows.Media.NumberSubstitution.Substitution for a 
    provided element.
  
  
   target: Element that is specifying a substitution method.
   value: A substitution method value of type 
 ...
 def __ne__(self,*args):
  pass
 CultureOverride=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 CultureSource=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 Substitution=property(lambda self: object(),lambda self,v: None,lambda self: None)
