class Int16KeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: Int16KeyFrameCollection,keyFrame: Int16KeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.Int16KeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.Int16KeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: Int16KeyFrameCollection)
   Removes all System.Windows.Media.Animation.Int16KeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: Int16KeyFrameCollection) -> Int16KeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.Int16KeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: Int16KeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.Int16KeyFrameCollection. When copying dependency 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: Int16KeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.Int16KeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: Int16KeyFrameCollection,array: Array[Int16KeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.Int16KeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: Int16KeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.Int16KeyFrameCollection 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: Int16KeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.Int16KeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: Int16KeyFrameCollection,keyFrame: Int16KeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.Int16KeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: Int16KeyFrameCollection,index: int,keyFrame: Int16KeyFrame)
   Inserts a System.Windows.Media.Animation.Int16KeyFrame into a specific location 
    within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.Int16KeyFrame is 
    inserted.
  
   keyFrame: The System.Windows.Media.Animation.Int16KeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: Int16KeyFrameCollection,keyFrame: Int16KeyFrame)
   Removes a System.Windows.Media.Animation.Int16KeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.Int16KeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: Int16KeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.Int16KeyFrame at the specified index 
    position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.Int16KeyFrame to be 
    removed.
  """
  pass
