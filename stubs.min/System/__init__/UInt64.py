class UInt64(object, IComparable, IFormattable, IConvertible, IComparable[UInt64], IEquatable[UInt64]):
    ...
    def TryParse(s, *__args):
        ...
        TryParse(s: str, style: NumberStyles, provider: IFormatProvider) -> (bool, UInt64)
            ...
            Tries to convert the string representation of a number in a specified style and culture-specific format to its 64-bit unsigned integer equivalent. A return value indicates whether the conversion succeeded 
             or failed.
