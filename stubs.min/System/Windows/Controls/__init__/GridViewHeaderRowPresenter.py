class GridViewHeaderRowPresenter(GridViewRowPresenterBase, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IWeakEventListener):
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: GridViewHeaderRowPresenter) -> AutomationPeer
            ...
            Returns: A System.Windows.Automation.Peers.GridViewHeaderRowPresenterAutomationPeer object for this column header row.
        """
        pass
    ...
    def OnLostMouseCapture(self, *args): #cannot find CLR method
        ...
        OnLostMouseCapture(self: GridViewHeaderRowPresenter, e: MouseEventArgs)
            Provides class handling for the System.Windows.UIElement.LostMouseCapture event for the System.Windows.Controls.GridViewColumnHeader.
    ...
    def OnMouseLeftButtonDown(self, *args): #cannot find CLR method
        ...
        OnMouseLeftButtonDown(self: GridViewHeaderRowPresenter, e: MouseButtonEventArgs)
            Provides class handling for the System.Windows.UIElement.MouseLeftButtonDown event that occurs when the user presses the left mouse button inside a System.Windows.Controls.GridViewColumnHeader.
    ...
    def OnMouseLeftButtonUp(self, *args): #cannot find CLR method
        ...
        OnMouseLeftButtonUp(self: GridViewHeaderRowPresenter, e: MouseButtonEventArgs)
            Provides class handling for the System.Windows.UIElement.MouseLeftButtonUp event that occurs when the user releases the left mouse button.
    ...
    def OnMouseMove(self, *args): #cannot find CLR method
        ...
        OnMouseMove(self: GridViewHeaderRowPresenter, e: MouseEventArgs)
            Provides class handling for the System.Windows.UIElement.MouseMove event that occurs when the user moves the mouse.
