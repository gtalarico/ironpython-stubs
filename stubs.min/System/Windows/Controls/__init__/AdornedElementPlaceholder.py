class AdornedElementPlaceholder(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def ArrangeOverride(self, *args): #cannot find CLR method
        ...
        ArrangeOverride(self: AdornedElementPlaceholder, arrangeBounds: Size) -> Size
            ...
            Positions the first visual child object and returns the size in layout required by this System.Windows.Controls.AdornedElementPlaceholder object.
        
            arrangeBounds: The size that this System.Windows.Controls.AdornedElementPlaceholder object should use to arrange its child element.
    ...
    def OnInitialized(self, *args): #cannot find CLR method
        ...
        OnInitialized(self: AdornedElementPlaceholder, e: EventArgs)
            Raises the System.Windows.FrameworkElement.IsInitialized event. This method is called when System.Windows.FrameworkElement.IsInitialized is set to true internally.
