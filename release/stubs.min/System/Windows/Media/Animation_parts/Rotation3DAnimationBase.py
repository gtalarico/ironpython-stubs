 ...
 def Clone(self):
  ...
  Clone(self: Rotation3DAnimationBase) -> Rotation3DAnimationBase
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.Rotation3DAnimationBase,making deep copies of 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  ...
  GetCurrentValue(self: Rotation3DAnimationBase,defaultOriginValue: Rotation3D,defaultDestinationValue: Rotation3D,animationClock: AnimationClock) -> Rotation3D
   ...
   defaultOriginValue: The origin value provided to the animation if the animation does not have its 
    ...
    be the base value of the property being animated; otherwise it will be the 
    value returned by the previous animation in the chain.
