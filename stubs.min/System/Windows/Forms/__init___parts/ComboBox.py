class ComboBox(ListControl,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def Dispose(self):
  ...
  Dispose(self: ComboBox,disposing: bool)
   Releases the unmanaged resources used by the System.Windows.Forms.ComboBox and 
 ...
 def EndUpdate(self):
  ...
  EndUpdate(self: ComboBox)
   Resumes painting the System.Windows.Forms.ComboBox control after painting is 
    suspended by the System.Windows.Forms.ComboBox.BeginUpdate method.
  """
  pass
 ...
 def FindString(self,s,startIndex=None):
  ...
  FindString(self: ComboBox,s: str,startIndex: int) -> int
   ...
   Returns the index of the first item in the System.Windows.Forms.ComboBox beyond 
    the specified index that contains the specified string. The search is not case 
    sensitive.
  
  
   s: The System.String to search for.
   startIndex: The zero-based index of the item before the first item to be searched. Set to 
    -1 to search from the beginning of the control.
  ...
  FindString(self: ComboBox,s: str) -> int
   ...
   Returns the index of the first item in the System.Windows.Forms.ComboBox that 
 ...
 def Select(self,start=None,length=None):
  ...
  Select(self: ComboBox,start: int,length: int)
   ...
   start: The position of the first character in the current text selection within the 
    text box.
 ...
 def SetItemCore(self,*args):
  ...
  SetItemCore(self: ComboBox,index: int,value: object)
   When overridden in a derived class,sets the object with the specified index in 
    the derived class.
 ...
 def SetItemsCore(self,*args):
  ...
  SetItemsCore(self: ComboBox,value: IList)
   When overridden in a derived class,sets the specified array of objects in a 
    collection in the derived class.
 ...
 def ToString(self):
  ...
  ToString(self: ComboBox) -> str
   ...
   Returns: A System.String that represents the current System.Windows.Forms.ComboBox. The 
    string includes the type and the number of items in the 
