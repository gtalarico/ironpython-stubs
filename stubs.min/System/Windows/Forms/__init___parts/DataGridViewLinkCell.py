class DataGridViewLinkCell(DataGridViewCell, ICloneable, IDisposable):
    ...
    def CreateAccessibilityInstance(self, *args): #cannot find CLR method
        ...
        CreateAccessibilityInstance(self: DataGridViewLinkCell) -> AccessibleObject
            ...
            Returns: A new System.Windows.Forms.DataGridViewLinkCell.DataGridViewLinkCellAccessibleObject for the System.Windows.Forms.DataGridViewLinkCell.
        """
        pass
    ...
    def KeyUpUnsharesRow(self, *args): #cannot find CLR method
        ...
        KeyUpUnsharesRow(self: DataGridViewLinkCell, e: KeyEventArgs, rowIndex: int) -> bool
            ...
            Indicates whether the row containing the cell will be unshared when a key is released and the cell has focus.
            ...
            Returns: true if the SPACE key was released, the System.Windows.Forms.DataGridViewLinkCell.TrackVisitedState property is true, the System.Windows.Forms.DataGridViewLinkCell.LinkVisited property is false, and the 
             CTRL, ALT, and SHIFT keys are not pressed; otherwise, false.
        """
        pass
    ...
    def MouseMoveUnsharesRow(self, *args): #cannot find CLR method
        ...
        MouseMoveUnsharesRow(self: DataGridViewLinkCell, e: DataGridViewCellMouseEventArgs) -> bool
            ...
            e: A System.Windows.Forms.DataGridViewCellMouseEventArgs that contains data about the mouse click.
            Returns: true if the mouse pointer is over the link and the link is has not yet changed color to reflect the hover state; otherwise, false.
        """
        pass
...
"""
    ...
    TrackVisitedState = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    UseColumnTextForLinkValue = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
