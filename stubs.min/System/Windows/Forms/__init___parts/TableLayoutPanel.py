...
"""
    ...
    GrowStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowStyles = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
