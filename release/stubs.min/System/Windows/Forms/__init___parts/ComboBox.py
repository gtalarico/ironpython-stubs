class ComboBox:
 ...
 def BeginUpdate(self):
  ...
  BeginUpdate(self: ComboBox)
   Maintains performance when items are added to the System.Windows.Forms.ComboBox one at a 
    time.
  """
  pass
 ...
 def EndUpdate(self):
  ...
  EndUpdate(self: ComboBox)
   Resumes painting the System.Windows.Forms.ComboBox control after painting is suspended by 
    the System.Windows.Forms.ComboBox.BeginUpdate method.
  """
  pass
 ...
 def FindString(self,s,startIndex=None):
  ...
  FindString(self: ComboBox,s: str) -> int
   ...
   Returns the index of the first item in the System.Windows.Forms.ComboBox that starts with 
  ...
  FindString(self: ComboBox,s: str,startIndex: int) -> int
   ...
   Returns the index of the first item in the System.Windows.Forms.ComboBox beyond the 
    specified index that contains the specified string. The search is not case sensitive.
   ...
   Returns: The zero-based index of the first item found; returns -1 if no match is found,or 0 if 
    the s parameter specifies System.String.Empty.
  """
  pass
 ...
 def ToString(self):
  ...
  ToString(self: ComboBox) -> str
   ...
   Returns: A System.String that represents the current System.Windows.Forms.ComboBox. The string 
    includes the type and the number of items in the System.Windows.Forms.ComboBox control.
  """
  pass
