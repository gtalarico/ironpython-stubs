class TextSearch(DependencyObject):
    ...
    def SetText(element, text):
        ...
        SetText(element: DependencyObject, text: str)
            Writes the System.Windows.Controls.TextSearch.Text�attached property value to the specified element.
    ...
    def SetTextPath(element, path):
        ...
        SetTextPath(element: DependencyObject, path: str)
            Writes the System.Windows.Controls.TextSearch.TextPath�attached property to the specified element.
