class PointAnimationUsingPath(PointAnimationBase,ISealable,IAnimatable,IResource):
 ...
 def Clone(self):
  ...
  Clone(self: PointAnimationUsingPath) -> PointAnimationUsingPath
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.PointAnimationUsingPath,making deep copies of 
 ...
 def OnChanged(self,*args):
  ...
  OnChanged(self: PointAnimationUsingPath)
   Called when this System.Windows.Media.Animation.PointAnimationUsingPath is 
    modified.
  """
  pass
