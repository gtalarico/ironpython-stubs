class DataFormats(object):
    ...
    def GetDataFormat(*__args):
        ...
        GetDataFormat(format: str) -> DataFormat
            ...
            Returns a System.Windows.DataFormat object that defines a name and numeric ID for the specified data format. The desired data format is specified by name (a string).
        
            format: The name of the data format to request a System.Windows.DataFormat object for.
            Returns: A System.Windows.DataFormat object that contains the numeric ID and the name of the requested data format.
        GetDataFormat(id: int) -> DataFormat
        
            Returns a System.Windows.DataFormat object that defines a name and numeric ID for the specified data format. The desired data format is specified by numeric ID.
        
            id: The numeric ID of the data format to request a System.Windows.DataFormat object for.
            Returns: A System.Windows.DataFormat object that contains the numeric ID and the name of the requested data format.
        """
        pass
