class UInt64:
 ...
 def CompareTo(self,value):
  ...
  CompareTo(self: UInt64,value: UInt64) -> int
   ...
   Compares this instance to a specified 64-bit unsigned integer and returns an indication 
 ...
 def Equals(self,obj):
  ...
  Equals(self: UInt64,obj: object) -> bool
   ...
   Returns: true if obj is an instance of System.UInt64 and equals the value of this instance; 
    otherwise,false.
  
  Equals(self: UInt64,obj: UInt64) -> bool
  
   Returns a value indicating whether this instance is equal to a specified System.UInt64 
    value.
 ...
 def Parse(s,*__args):
  ...
  Parse(s: str,style: NumberStyles) -> UInt64
   ...
   style: A bitwise combination of the enumeration values that specifies the permitted format of s. 
  ...
  Parse(s: str,provider: IFormatProvider) -> UInt64
   ...
   Converts the string representation of a number in a specified culture-specific format to 
    its 64-bit unsigned integer equivalent.
 ...
 def ToString(self,*__args):
  ...
  ToString(self: UInt64) -> str
   ...
   Returns: The string representation of the value of this instance,consisting of a sequence of 
    digits ranging from 0 to 9,without a sign or leading zeroes.
