class StringFormat(MarshalByRefObject,ICloneable,IDisposable):
 ...
 def SetDigitSubstitution(self,language,substitute):
  ...
  SetDigitSubstitution(self: StringFormat,language: int,substitute: StringDigitSubstitute)
   ...
   language: A National Language Support (NLS) language identifier that identifies the language that will be used when local digits are substituted for western digits. You can pass the System.Globalization.CultureInfo.LCID property of a System.Globalization.CultureInfo object as the NLS language identifier. For example,suppose you create a System.Globalization.CultureInfo object by passing the string "ar-EG" to a 
    System.Globalization.CultureInfo constructor. If you pass the System.Globalization.CultureInfo.LCID property of that System.Globalization.CultureInfo object along with System.Drawing.StringDigitSubstitute.Traditional to the System.Drawing.StringFormat.SetDigitSubstitution(System.Int32,System.Drawing.StringDigitSubstitute) method,then Arabic-Indic digits will be substituted for western digits at display time.
 ...
 def SetMeasurableCharacterRanges(self,ranges):
  ...
  SetMeasurableCharacterRanges(self: StringFormat,ranges: Array[CharacterRange])
   Specifies an array of System.Drawing.CharacterRange structures that represent the ranges of characters measured by a call to the System.Drawing.Graphics.MeasureCharacterRanges(System.String,System.Drawing.Font,System.Drawing.RectangleF,System.Drawing.StringFormat) method.
  
   ranges: An array of System.Drawing.CharacterRange structures that specifies the ranges of characters measured by a call to the System.Drawing.Graphics.MeasureCharacterRanges(System.String,System.Drawing.Font,System.Drawing.RectangleF,System.Drawing.StringFormat) method.
  """
  pass
