class DiscreteThicknessKeyFrame(ThicknessKeyFrame, ISealable, IKeyFrame):
    """
    Animates from the System.Windows.Thickness value of the previous key frame to its own System.Windows.Media.Animation.ThicknessKeyFrame.Value using discrete interpolation.
    
    DiscreteThicknessKeyFrame()
    DiscreteThicknessKeyFrame(value: Thickness)
    DiscreteThicknessKeyFrame(value: Thickness, keyTime: KeyTime)
    """
    ...
    def CreateInstanceCore(self, *args): #cannot find CLR method
        """
        CreateInstanceCore(self: DiscreteThicknessKeyFrame) -> Freezable
        
            Creates a new instance of System.Windows.Media.Animation.DiscreteThicknessKeyFrame.
            Returns: A new System.Windows.Media.Animation.DiscreteThicknessKeyFrame.
        """
        pass
    ...
    def InterpolateValueCore(self, *args): #cannot find CLR method
        """
        InterpolateValueCore(self: DiscreteThicknessKeyFrame, baseValue: Thickness, keyFrameProgress: float) -> Thickness
            ...
            keyFrameProgress: A value from 0.0 through 1.0 that specifies the percentage of time that has elapsed for this key frame.
