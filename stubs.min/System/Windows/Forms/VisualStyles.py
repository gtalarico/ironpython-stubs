...
class VisualStyleElement(object):
 ...
 def CreateElement(className,part,state):
  ...
  CreateElement(className: str,part: int,state: int) -> VisualStyleElement
   ...
   Returns: A System.Windows.Forms.VisualStyles.VisualStyleElement with the System.Windows.Forms.VisualStyles.VisualStyleElement.ClassName,System.Windows.Forms.VisualStyles.VisualStyleElement.Part,and 
    System.Windows.Forms.VisualStyles.VisualStyleElement.State properties initialized to the className,part,and state parameters.
  """
  pass
...
class VisualStyleRenderer(object):
 ...
 def IsElementDefined(element):
  ...
  IsElementDefined(element: VisualStyleElement) -> bool
   ...
   Returns: true if the combination of the System.Windows.Forms.VisualStyles.VisualStyleElement.ClassName and System.Windows.Forms.VisualStyles.VisualStyleElement.Part properties of element are defined; otherwise,
    false.
  """
  pass
 def SetParameters(self,*__args):
  ...
  SetParameters(self: VisualStyleRenderer,element: VisualStyleElement)
   ...
   element: A System.Windows.Forms.VisualStyles.VisualStyleElement that specifies the new values of the System.Windows.Forms.VisualStyles.VisualStyleRenderer.Class,
    System.Windows.Forms.VisualStyles.VisualStyleRenderer.Part,and System.Windows.Forms.VisualStyles.VisualStyleRenderer.State properties.
  """
  pass
 @staticmethod
