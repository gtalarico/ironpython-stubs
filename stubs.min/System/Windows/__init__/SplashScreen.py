class SplashScreen(object):
    ...
    def Close(self, fadeoutDuration):
        ...
        Close(self: SplashScreen, fadeoutDuration: TimeSpan)
            ...
            fadeoutDuration: A System.TimeSpan that specifies how long it will take for the splash screen to fade after the close operation has been initiated.
        """
        pass
    ...
    def Show(self, autoClose, topMost=None):
        ...
        Show(self: SplashScreen, autoClose: bool, topMost: bool)
            ...
            autoClose: true to automatically close the splash screen; false to close the splash screen manually.
            topMost: true if the splash screen window should use the WS_EX_TOPMOST style; otherwise false.
