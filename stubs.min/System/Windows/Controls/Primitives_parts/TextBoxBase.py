class TextBoxBase(Control, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient):
    ...
    def Cut(self):
        ...
        Cut(self: TextBoxBase)
            Removes the current selection from the text editing control and copies it to the System.Windows.Clipboard.
        """
        pass
    ...
    def Redo(self):
        ...
        Redo(self: TextBoxBase) -> bool
            ...
            Returns: true if the redo operation was successful; otherwise, false. This method returns false if there is no undo command available (the undo stack is empty).
        """
        pass
    ...
    def Undo(self):
        ...
        Undo(self: TextBoxBase) -> bool
            ...
            Returns: true if the undo operation was successful; otherwise, false. This method returns false if the undo stack is empty.
        """
        pass
    ...
    AcceptsReturn = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AcceptsTab = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AutoWordSelection = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CaretBrush = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsInactiveSelectionHighlightEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsReadOnlyCaretVisible = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsSelectionActive = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectionBrush = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectionOpacity = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SpellCheck = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    UndoLimit = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
