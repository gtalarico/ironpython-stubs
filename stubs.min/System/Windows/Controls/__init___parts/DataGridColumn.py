class DataGridColumn(DependencyObject):
    ...
    def CancelCellEdit(self, *args): #cannot find CLR method
        """
    ...
    def CommitCellEdit(self, *args): #cannot find CLR method
        """
    ...
    def GenerateEditingElement(self, *args): #cannot find CLR method
        """
        GenerateEditingElement(self: DataGridColumn, cell: DataGridCell, dataItem: object) -> FrameworkElement
        
            When overridden in a derived class, gets an editing element that is bound to the System.Windows.Controls.DataGridBoundColumn.Binding property value of the column.
            ...
            Returns: A new editing element that is bound to the System.Windows.Controls.DataGridBoundColumn.Binding property value of the column.
        """
        pass

    def GenerateElement(self, *args): #cannot find CLR method
        """
        GenerateElement(self: DataGridColumn, cell: DataGridCell, dataItem: object) -> FrameworkElement
        
            When overridden in a derived class, gets a read-only element that is bound to the System.Windows.Controls.DataGridBoundColumn.Binding property value of the column.
        
            cell: The cell that will contain the generated element.
            dataItem: The data item that is represented by the row that contains the intended cell.
            Returns: A new read-only element that is bound to the System.Windows.Controls.DataGridBoundColumn.Binding property value of the column.
        """
        pass
    ...
    def GetCellContent(self, *__args):
        ...
        GetCellContent(self: DataGridColumn, dataGridRow: DataGridRow) -> FrameworkElement
            ...
            Retrieves the System.Windows.Controls.ContentControl.Content property value for the cell at the intersection of this column and the specified row.
        ...
        GetCellContent(self: DataGridColumn, dataItem: object) -> FrameworkElement
            ...
            Gets the System.Windows.Controls.ContentControl.Content property value for the cell at the intersection of this column and the row that represents the specified data item.
    ...
    def NotifyPropertyChanged(self, *args): #cannot find CLR method
        """
        NotifyPropertyChanged(self: DataGridColumn, propertyName: str)
            Notifies the System.Windows.Controls.DataGrid that contains this column that a column property has changed.
        
            propertyName: The name of the column property that changed.
        """
        pass

    def OnCoerceIsReadOnly(self, *args): #cannot find CLR method
        """
        OnCoerceIsReadOnly(self: DataGridColumn, baseValue: bool) -> bool
        
            Determines the value of the System.Windows.Controls.DataGridColumn.IsReadOnly property based on the property rules of the System.Windows.Controls.DataGrid that contains this column.
        
            baseValue: The value that was passed to the delegate.
            Returns: true if cells in the column cannot be edited based on rules from the System.Windows.Controls.DataGrid; otherwise, false.
        """
        pass
    ...
    def PrepareCellForEdit(self, *args): #cannot find CLR method
        """
        PrepareCellForEdit(self: DataGridColumn, editingElement: FrameworkElement, editingEventArgs: RoutedEventArgs) -> object
            ...
            Returns: When returned by a derived class, the unedited cell value. This implementation returns null in all cases.
        """
        pass

    def RefreshCellContent(self, *args): #cannot find CLR method
        """
...
"""
    ...
    CanUserReorder = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanUserResize = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CanUserSort = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ClipboardContentBinding = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DataGridOwner = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HeaderStringFormat = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HeaderTemplate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HeaderTemplateSelector = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SortMemberPath = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
