class TextBox(TextBoxBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ITextBoxViewHost):
 ...
 def GetCharacterIndexFromPoint(self,point,snapToText):
  ...
  GetCharacterIndexFromPoint(self: TextBox,point: Point,snapToText: bool) -> int
   ...
   point: A point in System.Windows.Controls.TextBox coordinate-space for which to return 
    an index.
  
   snapToText: true to return the nearest index if there is no character at the specified 
 ...
 def GetLineIndexFromCharacterIndex(self,charIndex):
  ...
  GetLineIndexFromCharacterIndex(self: TextBox,charIndex: int) -> int
   ...
   Returns the zero-based line index for the line that contains the specified 
    character index.
 ...
 def GetNextSpellingErrorCharacterIndex(self,charIndex,direction):
  ...
  GetNextSpellingErrorCharacterIndex(self: TextBox,charIndex: int,direction: LogicalDirection) -> int
   ...
   Returns the beginning character index for the next spelling error in the 
    contents of the text box.
  
  
   charIndex: The zero-based character index indicating a position from which to search for 
    the next spelling error.
  
   direction: One of the System.Windows.Documents.LogicalDirection values that specifies the 
    direction in which to search for the next spelling error,starting at the 
    specified charIndex.
  
   Returns: The character index for the beginning of the next spelling error in the 
    """
  pass
 def GetRectFromCharacterIndex(self,charIndex,trailingEdge=None):
  ...
  GetRectFromCharacterIndex(self: TextBox,charIndex: int,trailingEdge: bool) -> Rect
   ...
   charIndex: The zero-based character index of the character for which to retrieve the 
    rectangle.
  
   trailingEdge: true to get the trailing edge of the character; false to get the leading edge 
    of the character.
  ...
  GetRectFromCharacterIndex(self: TextBox,charIndex: int) -> Rect
   ...
   Returns: A rectangle for the leading edge of the character at the specified character 
    index,or System.Windows.Rect.Empty if a bounding rectangle cannot be 
    determined.
  """
  pass
 def GetSpellingError(self,charIndex):
  ...
  GetSpellingError(self: TextBox,charIndex: int) -> SpellingError
   ...
   Returns a System.Windows.Controls.SpellingError object associated with any 
    spelling error at the specified character index.
  
  
   charIndex: The zero-based character index of a position in content to examine for a 
    spelling error.
  
   Returns: A System.Windows.Controls.SpellingError object containing the details of the 
    spelling error found at the character indicated by charIndex,or null if no 
 ...
 def GetSpellingErrorLength(self,charIndex):
  ...
  GetSpellingErrorLength(self: TextBox,charIndex: int) -> int
   ...
   Returns: The length of any spelling error that includes the character specified by 
    charIndex,or 0 if the specified character is not part of a spelling error.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: TextBox,constraint: Size) -> Size
   ...
   constraint: A System.Windows.Size structure that specifies the constraints on the size of 
    the text box.
 ...
 def OnPropertyChanged(self,*args):
  ...
  OnPropertyChanged(self: TextBox_18$19,e: DependencyPropertyChangedEventArgs)
  """
  pass
 ...
 def ShouldSerializeText(self,manager):
  ...
  ShouldSerializeText(self: TextBox,manager: XamlDesignerSerializationManager) -> bool
   ...
   Returns a value that indicates whether the effective value of the 
    System.Windows.Controls.TextBox.Text property should be serialized during 
    serialization of the System.Windows.Controls.TextBox object.
  
  
   manager: A serialization service manager object for this object.
   Returns: true if the System.Windows.Controls.TextBox.Text property should be serialized; 
    otherwise,false.
  """
  pass
