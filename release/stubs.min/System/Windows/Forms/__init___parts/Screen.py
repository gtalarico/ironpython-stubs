class Screen(object):
 ...
 def Equals(self,obj):
  ...
  Equals(self: Screen,obj: object) -> bool
   ...
   Gets or sets a value indicating whether the specified object is equal to this 
    Screen.
  
  
   obj: The object to compare to this System.Windows.Forms.Screen.
   Returns: true if the specified object is equal to this System.Windows.Forms.Screen; 
    otherwise,false.
  """
  pass
 @staticmethod
 def FromControl(control):
  ...
  FromControl(control: Control) -> Screen
   ...
   control: A System.Windows.Forms.Control for which to retrieve a 
    System.Windows.Forms.Screen.
  
   Returns: A System.Windows.Forms.Screen for the display that contains the largest region 
 ...
 def FromHandle(hwnd):
  ...
  FromHandle(hwnd: IntPtr) -> Screen
   ...
   Returns: A System.Windows.Forms.Screen for the display that contains the largest region 
    of the object. In multiple display environments where no display contains any 
    portion of the specified window,the display closest to the object is returned.
  """
  pass
 @staticmethod
 def FromPoint(point):
  ...
  FromPoint(point: Point) -> Screen
   ...
   Returns: A System.Windows.Forms.Screen for the display that contains the point. In 
 ...
 def FromRectangle(rect):
  ...
  FromRectangle(rect: Rectangle) -> Screen
   ...
   rect: A System.Drawing.Rectangle that specifies the area for which to retrieve the 
    display.
 ...
 def GetBounds(*__args):
  ...
  GetBounds(ctl: Control) -> Rectangle
   ...
   Retrieves the bounds of the display that contains the largest portion of the 
    specified control.
  
  
   ctl: The System.Windows.Forms.Control for which to retrieve the display bounds.
   Returns: A System.Drawing.Rectangle that specifies the bounds of the display that 
    contains the specified control. In multiple display environments where no 
    display contains the specified control,the display closest to the control is 
    returned.
  ...
  GetBounds(rect: Rectangle) -> Rectangle
   ...
   Returns: A System.Drawing.Rectangle that specifies the bounds of the display that 
    contains the specified rectangle. In multiple display environments where no 
    monitor contains the specified rectangle,the monitor closest to the rectangle 
    is returned.
  ...
  GetBounds(pt: Point) -> Rectangle
   ...
   pt: A System.Drawing.Point that specifies the coordinates for which to retrieve the 
    display bounds.
 ...
 def GetWorkingArea(*__args):
  ...
  GetWorkingArea(ctl: Control) -> Rectangle
   ...
   Retrieves the working area for the display that contains the largest region of 
    the specified control. The working area is the desktop area of the display,
  ...
  GetWorkingArea(rect: Rectangle) -> Rectangle
   ...
   Retrieves the working area for the display that contains the largest portion of 
    the specified rectangle. The working area is the desktop area of the display,
    excluding taskbars,docked windows,and docked tool bars.
  
  
   rect: The System.Drawing.Rectangle that specifies the area for which to retrieve the 
    working area.
  ...
  GetWorkingArea(pt: Point) -> Rectangle
   ...
   Retrieves the working area closest to the specified point. The working area is 
    the desktop area of the display,excluding taskbars,docked windows,and docked 
    tool bars.
