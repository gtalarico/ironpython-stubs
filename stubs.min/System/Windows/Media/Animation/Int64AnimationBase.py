class Int64AnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: Int64AnimationBase) -> Int64AnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Int64AnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
