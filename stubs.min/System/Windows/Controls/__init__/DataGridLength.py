class DataGridLength(object, IEquatable[DataGridLength]):
    ...
    def Equals(self, *__args):
        ...
        Equals(self: DataGridLength, other: DataGridLength) -> bool
            ...
            Returns: true if the specified object is a System.Windows.Controls.DataGridLength with the same value or sizing mode as the current System.Windows.Controls.DataGridLength; otherwise, false.
    ...
    DesiredValue = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DisplayValue = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsSizeToCells = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsSizeToHeader = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
