class VectorAnimation(VectorAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: VectorAnimation) -> VectorAnimation
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.VectorAnimation, making deep copies of this object's values. When copying dependency properties, this method copies resource references and 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: VectorAnimation, defaultOriginValue: Vector, defaultDestinationValue: Vector, animationClock: AnimationClock) -> Vector
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.VectorAnimation.
