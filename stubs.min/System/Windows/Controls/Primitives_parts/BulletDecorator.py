class BulletDecorator(Decorator,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: BulletDecorator,arrangeSize: Size) -> Size
   ...
   Returns: The computed size of the System.Windows.Controls.Primitives.BulletDecorator 
    control.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: BulletDecorator,constraint: Size) -> Size
   ...
   constraint: The upper System.Windows.Size limit of the 
    System.Windows.Controls.Primitives.BulletDecorator.
  
   Returns: The required System.Windows.Size for the 
    System.Windows.Controls.Primitives.BulletDecorator control,based on the size 
    of its System.Windows.Controls.Primitives.BulletDecorator.Bullet and 
 ...
 def OnRender(self,*args):
  ...
  OnRender(self: BulletDecorator,dc: DrawingContext)
   Renders the content of a System.Windows.Controls.Primitives.BulletDecorator 
    control.
