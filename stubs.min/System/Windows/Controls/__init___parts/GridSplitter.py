class GridSplitter(Thumb,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: GridSplitter) -> AutomationPeer
   ...
   Creates the implementation of System.Windows.Automation.Peers.AutomationPeer 
    for the System.Windows.Controls.GridSplitter control.
 ...
 def OnDraggingChanged(self,*args):
  ...
  OnDraggingChanged(self: Thumb,e: DependencyPropertyChangedEventArgs)
   Responds to a change in the value of the 
    System.Windows.Controls.Primitives.Thumb.IsDragging property.
 ...
 def OnLostKeyboardFocus(self,*args):
  ...
  OnLostKeyboardFocus(self: GridSplitter,e: KeyboardFocusChangedEventArgs)
   Called when the System.Windows.Controls.GridSplitter control loses keyboard 
    focus.
  
  
   e: A System.Windows.Input.KeyboardFocusChangedEventArgs that contains the event 
    data.
  """
  pass
 ...
 def OnMouseLeftButtonDown(self,*args):
  ...
  OnMouseLeftButtonDown(self: Thumb,e: MouseButtonEventArgs)
   Provides class handling for the 
    System.Windows.ContentElement.MouseLeftButtonDown event.
 ...
 def OnMouseLeftButtonUp(self,*args):
  ...
  OnMouseLeftButtonUp(self: Thumb,e: MouseButtonEventArgs)
   Provides class handling for the System.Windows.ContentElement.MouseLeftButtonUp 
    event.
 ...
 def OnRenderSizeChanged(self,*args):
  ...
  OnRenderSizeChanged(self: GridSplitter,sizeInfo: SizeChangedInfo)
   Responds to a change in the dimensions of the 
    System.Windows.Controls.GridSplitter control.
  
  
   sizeInfo: Information about the change in size of the 
