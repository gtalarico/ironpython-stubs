class TabControl(Selector, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IGeneratorHost, IContainItemStorage):
    ...
    def OnKeyDown(self, *args): #cannot find CLR method
        ...
        OnKeyDown(self: TabControl, e: KeyEventArgs)
            Provides class handling for the System.Windows.ContentElement.KeyDown routed event that occurs when the user presses a key.
    ...
    ContentStringFormat = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ContentTemplate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ContentTemplateSelector = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectedContent = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectedContentStringFormat = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectedContentTemplate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SelectedContentTemplateSelector = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    TabStripPlacement = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
