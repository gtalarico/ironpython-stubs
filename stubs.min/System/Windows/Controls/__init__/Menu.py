class Menu(MenuBase, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IGeneratorHost, IContainItemStorage):
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: Menu) -> AutomationPeer
            ...
            Provides an appropriate System.Windows.Automation.Peers.MenuAutomationPeer implementation for this control, as part of the WPF automation infrastructure.
    ...
    def OnTextInput(self, *args): #cannot find CLR method
        ...
        OnTextInput(self: Menu, e: TextCompositionEventArgs)
            Handles the System.Windows.UIElement.TextInput routed event that occurs when the menu receives text input from any device.
...
"""
    ...
    IsMainMenu = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
