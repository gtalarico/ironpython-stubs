class SizeKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: SizeKeyFrameCollection,keyFrame: SizeKeyFrame) -> int
   ...
   keyFrame: The System.Windows.Media.Animation.SizeKeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: SizeKeyFrameCollection)
   Removes all System.Windows.Media.Animation.SizeKeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: SizeKeyFrameCollection) -> SizeKeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.SizeKeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: SizeKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.SizeKeyFrameCollection. When copying dependency 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: SizeKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.SizeKeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: SizeKeyFrameCollection,array: Array[SizeKeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.SizeKeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: SizeKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.SizeKeyFrameCollection 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: SizeKeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.SizeKeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: SizeKeyFrameCollection,keyFrame: SizeKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.SizeKeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: SizeKeyFrameCollection,index: int,keyFrame: SizeKeyFrame)
   Inserts a System.Windows.Media.Animation.SizeKeyFrame into a specific location 
    within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.SizeKeyFrame is 
    inserted.
  
   keyFrame: The System.Windows.Media.Animation.SizeKeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: SizeKeyFrameCollection,keyFrame: SizeKeyFrame)
   Removes a System.Windows.Media.Animation.SizeKeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.SizeKeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: SizeKeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.SizeKeyFrame at the specified index 
