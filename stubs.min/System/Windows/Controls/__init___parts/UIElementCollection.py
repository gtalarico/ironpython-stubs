class UIElementCollection(object, IList, ICollection, IEnumerable):
    ...
    def ClearLogicalParent(self, *args): #cannot find CLR method
        """
        ClearLogicalParent(self: UIElementCollection, element: UIElement)
            Clears the logical parent of an element when the element leaves a System.Windows.Controls.UIElementCollection.
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: UIElementCollection, array: Array[UIElement], index: int)
            Copies a System.Windows.UIElement from a System.Windows.Controls.UIElementCollection to an array, starting at a specified index position.
    ...
    def IndexOf(self, element):
        ...
        IndexOf(self: UIElementCollection, element: UIElement) -> int
            ...
            Returns the index position of a specified element in a System.Windows.Controls.UIElementCollection.
    ...
    def SetLogicalParent(self, *args): #cannot find CLR method
        """
