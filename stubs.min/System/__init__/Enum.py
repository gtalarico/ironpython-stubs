class Enum(object, IComparable, IFormattable, IConvertible):
    ...
    def CompareTo(self, target):
        ...
        CompareTo(self: Enum, target: object) -> int
            ...
            Returns: A signed number that indicates the relative values of this instance and target.Value Meaning Less than zero The value of this instance is less than the value of target. Zero The value of this instance is 
             equal to the value of target. Greater than zero The value of this instance is greater than the value of target.-or- target is null.
        """
        pass
