class RichTextBox(TextBoxBase, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def GetNextSpellingErrorPosition(self, position, direction):
        ...
        GetNextSpellingErrorPosition(self: RichTextBox, position: TextPointer, direction: LogicalDirection) -> TextPointer
            ...
            Returns a System.Windows.Documents.TextPointer that points to the next spelling error in the contents of the System.Windows.Controls.RichTextBox.
        
            position: A System.Windows.Documents.TextPointer indicating a position from which to search for the next spelling error.
            direction: A System.Windows.Documents.LogicalDirection in which to search for the next spelling error, starting at the specified posision.
            Returns: A System.Windows.Documents.TextPointer that points to the next spelling error in the contents of the System.Windows.Controls.RichTextBox, or null if no next spelling error exists.
        """
        pass
    ...
    def GetPositionFromPoint(self, point, snapToText):
        ...
        GetPositionFromPoint(self: RichTextBox, point: Point, snapToText: bool) -> TextPointer
            ...
            Returns a System.Windows.Documents.TextPointer that points to the insertion point closest to the specified position.
        
            point: A System.Windows.Point object specifying the position to retrieve a System.Windows.Documents.TextPointer for.
            snapToText: If true, this method always returns a System.Windows.Documents.TextPointer specifying the closest insertion position for the System.Windows.Point specified, regardless or whether or not the supplied 
             System.Windows.Point is inside a character's bounding box.If false, this method returns null if the specified System.Windows.Point does not fall within any character bounding box.
        
            Returns: A System.Windows.Documents.TextPointer specifying the closest insertion position for the supplied point, or null if snapToText is false and the supplied System.Windows.Point is not within any character's 
             bounding box. Note that the System.Windows.Documents.TextPointer returned is usually the position between two characters. Use the System.Windows.Documents.TextPointer.LogicalDirection property of the 
             returned System.Windows.Documents.TextPointer to determine which of the two characters the System.Windows.Documents.TextPointer corresponds to.
        """
        pass
    ...
    def GetSpellingError(self, position):
        ...
        GetSpellingError(self: RichTextBox, position: TextPointer) -> SpellingError
            ...
            Returns a System.Windows.Controls.SpellingError object associated with any spelling error at a specified position in the contents of the System.Windows.Controls.RichTextBox.
        
            position: A System.Windows.Documents.TextPointer that specifies a position and logical direction that resolves to a character to examine for a spelling error. Use the 
             System.Windows.Documents.TextPointer.LogicalDirection property of this System.Windows.Documents.TextPointer to specify the direction of the character to examine.
        
            Returns: A System.Windows.Controls.SpellingError object containing the details of the spelling error found at the character indicated by position, or null if no spelling error exists at the specified character.
        """
        pass
    ...
    def GetSpellingErrorRange(self, position):
        ...
        GetSpellingErrorRange(self: RichTextBox, position: TextPointer) -> TextRange
            ...
            Returns a System.Windows.Documents.TextRange object covering any misspelled word at a specified position in the contents of the System.Windows.Controls.RichTextBox.
        
            position: A System.Windows.Documents.TextPointer that specifies a position and logical direction that resolves to a character to examine for a spelling error. Use the 
             System.Windows.Documents.TextPointer.LogicalDirection property of this System.Windows.Documents.TextPointer to specify the direction of the character to examine.
        
            Returns: A System.Windows.Documents.TextRange object covering any misspelled word that includes the character specified by position, or null if no spelling error exists at the specified character.
        """
        pass
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: RichTextBox, constraint: Size) -> Size
            ...
            constraint: A System.Windows.Size structure specifying constraints on the size of the System.Windows.Controls.RichTextBox.
            Returns: A System.Windows.Size structure indicating the new size of the System.Windows.Controls.RichTextBox.
        """
        pass
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: RichTextBox) -> AutomationPeer
            ...
            Creates and returns an System.Windows.Automation.Peers.AutomationPeer object for this System.Windows.Controls.RichTextBox.
            Returns: An System.Windows.Automation.Peers.AutomationPeer object for this System.Windows.Controls.RichTextBox.
        """
        pass
    ...
    def OnGiveFeedback(self, *args): #cannot find CLR method
        ...
        OnGiveFeedback(self: TextBoxBase, e: GiveFeedbackEventArgs)
            Invoked whenever an unhandled System.Windows.DragDrop.GiveFeedback attached routed event reaches an element derived from this class in its route. Implement this method to add class handling for this event.
    ...
    def OnGotKeyboardFocus(self, *args): #cannot find CLR method
        ...
        OnGotKeyboardFocus(self: TextBoxBase, e: KeyboardFocusChangedEventArgs)
            Invoked whenever an unhandled System.Windows.Input.Keyboard.GotKeyboardFocus attached routed event reaches an element derived from this class in its route. Implement this method to add class handling for 
             this event.
    ...
    def OnLostKeyboardFocus(self, *args): #cannot find CLR method
        ...
        OnLostKeyboardFocus(self: TextBoxBase, e: KeyboardFocusChangedEventArgs)
            Invoked whenever an unhandled System.Windows.Input.Keyboard.LostKeyboardFocus attached routed event reaches an element derived from this class in its route. Implement this method to add class handling for 
             this event.
    ...
    def OnMouseMove(self, *args): #cannot find CLR method
        ...
        OnMouseMove(self: TextBoxBase, e: MouseEventArgs)
            Invoked whenever an unhandled System.Windows.Input.Mouse.MouseMove attached routed event reaches an element derived from this class in its route. Implement this method to add class handling for this event.
    ...
    def OnMouseUp(self, *args): #cannot find CLR method
        ...
        OnMouseUp(self: TextBoxBase, e: MouseButtonEventArgs)
            Invoked whenever an unhandled System.Windows.Input.Mouse.MouseUp event reaches an element derived from this class in its route. Implement this method to add class handling for this event.
        
            e: Arguments of the event. These arguments will include details about which mouse button was depressed, and the handled state.
        """
        pass
    ...
    def OnMouseWheel(self, *args): #cannot find CLR method
        ...
        OnMouseWheel(self: TextBoxBase, e: MouseWheelEventArgs)
            Is called when a System.Windows.UIElement.MouseWheel event is routed to this class (or to a class that inherits from this class).
    ...
    def OnQueryContinueDrag(self, *args): #cannot find CLR method
        ...
        OnQueryContinueDrag(self: TextBoxBase, e: QueryContinueDragEventArgs)
            Invoked whenever an unhandled System.Windows.DragDrop.QueryContinueDrag attached  routed event reaches an element derived from this class in its route. Implement this method to add class handling for this 
             event.
    ...
    def OnQueryCursor(self, *args): #cannot find CLR method
        ...
        OnQueryCursor(self: TextBoxBase, e: QueryCursorEventArgs)
            Invoked whenever an unhandled System.Windows.Input.Mouse.QueryCursor attached routed event reaches an element derived from this class in its route. Implement this method to add class handling for this 
             event.
    ...
    def OnSelectionChanged(self, *args): #cannot find CLR method
        ...
        OnSelectionChanged(self: TextBoxBase, e: RoutedEventArgs)
            ...
            e: The arguments that are associated with the System.Windows.Controls.Primitives.TextBoxBase.SelectionChanged event.
        """
        pass
    ...
    def OnTemplateChanged(self, *args): #cannot find CLR method
        ...
        OnTemplateChanged(self: TextBoxBase, oldTemplate: ControlTemplate, newTemplate: ControlTemplate)
            ...
            oldTemplate: A System.Windows.Controls.ControlTemplate object that specifies the control template that is currently active.
    ...
    def OnTextChanged(self, *args): #cannot find CLR method
        ...
        OnTextChanged(self: TextBoxBase, e: TextChangedEventArgs)
            ...
            e: The arguments that are associated with the System.Windows.Controls.Primitives.TextBoxBase.TextChanged event.
        """
        pass
    ...
    def OnTextInput(self, *args): #cannot find CLR method
        ...
        OnTextInput(self: TextBoxBase, e: TextCompositionEventArgs)
            Invoked whenever an unhandled System.Windows.Input.TextCompositionManager.TextInput attached routed event reaches an element derived from this class in its route. Implement this method to add class 
             handling for this event.
    ...
    def ShouldSerializeDocument(self):
        ...
        ShouldSerializeDocument(self: RichTextBox) -> bool
            ...
            Returns a value that indicates whether or not the effective value of the System.Windows.Controls.RichTextBox.Document property should be serialized during serialization of a 
             System.Windows.Controls.RichTextBox object.
        
            Returns: true if the System.Windows.Controls.RichTextBox.Document property should be serialized; otherwise, false.
        """
        pass
...
"""
    ...
    IsDocumentEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
