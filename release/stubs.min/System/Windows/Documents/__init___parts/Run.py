 ...
 def ShouldSerializeText(self,manager):
  ...
  ShouldSerializeText(self: Run,manager: XamlDesignerSerializationManager) -> bool
   ...
   Returns a value that indicates whether or not the effective value of the 
    System.Windows.Documents.Run.Text property should be serialized during 
    serialization of a System.Windows.Documents.Run object.
  
  
   manager: A serialization service manager object for this object.
   Returns: true if the System.Windows.Documents.Run.Text property should be serialized; 
    otherwise,false.
  """
  pass
