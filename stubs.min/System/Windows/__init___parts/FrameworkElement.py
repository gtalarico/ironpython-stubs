...
"""
 ...
 LayoutTransform=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 UseLayoutRounding=property(lambda self: object(),lambda self,v: None,lambda self: None)
