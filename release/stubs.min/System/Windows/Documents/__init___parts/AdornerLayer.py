class AdornerLayer(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: AdornerLayer,finalSize: Size) -> Size
   ...
   Returns: The actual size needed by the element.  This return value is typically the same 
    as the value passed to finalSize.
  """
  pass
 @staticmethod
 def GetAdornerLayer(visual):
  ...
  GetAdornerLayer(visual: Visual) -> AdornerLayer
   ...
   Returns: An adorner layer for the specified visual,or null if no adorner layer can be 
    found.
  """
  pass
 def GetAdorners(self,element):
  ...
  GetAdorners(self: AdornerLayer,element: UIElement) -> Array[Adorner]
   ...
   Returns: An array of adorners that decorate the specified System.Windows.UIElement,or 
    null if there are no adorners bound to the specified element.
  """
  pass
 ...
 def GetVisualChild(self,*args):
  ...
  GetVisualChild(self: AdornerLayer,index: int) -> Visual
   ...
   Returns: A System.Windows.Media.Visual child of the parent 
    System.Windows.Documents.AdornerLayer element.
  """
  pass
 ...
 def Update(self,element=None):
  ...
  Update(self: AdornerLayer,element: UIElement)
   Updates the layout and redraws all of the adorners in the adorner layer that 
    are bound to the specified System.Windows.UIElement.
