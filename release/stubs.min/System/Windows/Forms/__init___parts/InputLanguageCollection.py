class InputLanguageCollection:
 """ Stores System.Windows.Forms.InputLanguage objects. """
 def Contains(self,value):
  """
  Contains(self: InputLanguageCollection,value: InputLanguage) -> bool
  
   Gets a value indicating whether the System.Windows.Forms.InputLanguageCollection contains 
    the specified System.Windows.Forms.InputLanguage.
  
  
   value: The System.Windows.Forms.InputLanguage to locate.
   Returns: true if the System.Windows.Forms.InputLanguage is contained in the collection; otherwise,
    false.
  """
  pass
 def CopyTo(self,array,index):
  ...
  CopyTo(self: InputLanguageCollection,array: Array[InputLanguage],index: int)
   Copies the System.Windows.Forms.InputLanguageCollection values to a one-dimensional 
