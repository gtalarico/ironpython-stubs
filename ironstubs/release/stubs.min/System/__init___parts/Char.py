class Char(object,IComparable,IConvertible,IComparable[Char],IEquatable[Char]):
 ...
 def CompareTo(self,value):
  ...
  CompareTo(self: Char,value: object) -> int
   ...
   Returns: A signed number indicating the position of this instance in the sort order in 
    relation to the value parameter.Return Value Description Less than zero This 
    instance precedes value. Zero This instance has the same position in the sort 
    order as value. Greater than zero This instance follows value.-or- value is 
    null.
  """
  pass
 @staticmethod
 def ConvertFromUtf32(utf32):
  ...
  ConvertFromUtf32(utf32: int) -> str
   ...
   Returns: A string consisting of one System.Char object or a surrogate pair of 
    System.Char objects equivalent to the code point specified by the utf32 
    parameter.
  """
  pass
 @staticmethod
 def ConvertToUtf32(*__args):
  ...
  ConvertToUtf32(s: str,index: int) -> int
   ...
   Converts the value of a UTF-16 encoded character or surrogate pair at a 
    specified position in a string into a Unicode code point.
  
  
   s: A string that contains a character or surrogate pair.
   index: The index position of the character or surrogate pair in s.
   Returns: The 21-bit Unicode code point represented by the character or surrogate pair at 
    the position in the s parameter specified by the index parameter.
  
  ConvertToUtf32(highSurrogate: Char,lowSurrogate: Char) -> int
  
   Converts the value of a UTF-16 encoded surrogate pair into a Unicode code point.
  
   highSurrogate: A high surrogate code unit (that is,a code unit ranging from U+D800 through 
    U+DBFF).
  
   lowSurrogate: A low surrogate code unit (that is,a code unit ranging from U+DC00 through 
    U+DFFF).
 ...
 def Equals(self,obj):
  ...
  Equals(self: Char,obj: object) -> bool
   ...
   Returns: true if obj is an instance of System.Char and equals the value of this 
 ...
 def GetUnicodeCategory(*__args):
  ...
  GetUnicodeCategory(s: str,index: int) -> UnicodeCategory
   ...
   Categorizes the character at the specified position in a specified string into 
    a group identified by one of the System.Globalization.UnicodeCategory values.
  
  
   s: A System.String.
   index: The character position in s.
   Returns: A System.Globalization.UnicodeCategory enumerated constant that identifies the 
    group that contains the character at position index in s.
  ...
  GetUnicodeCategory(c: Char) -> UnicodeCategory
   ...
   Returns: A System.Globalization.UnicodeCategory value that identifies the group that 
    contains c.
  """
  pass
 @staticmethod
 def IsControl(*__args):
  ...
  IsControl(s: str,index: int) -> bool
   ...
   Returns: true if the character at position index in s is a control character; otherwise,
    false.
 ...
 def IsDigit(*__args):
  ...
  IsDigit(s: str,index: int) -> bool
   ...
   Indicates whether the character at the specified position in a specified string 
    is categorized as a decimal digit.
  
  
   s: A string.
   index: The position of the character to evaluate in s.
   Returns: true if the character at position index in s is a decimal digit; otherwise,
    false.
 ...
 def IsHighSurrogate(*__args):
  ...
  IsHighSurrogate(s: str,index: int) -> bool
   ...
   Indicates whether the System.Char object at the specified position in a string 
    is a high surrogate.
 ...
 def IsLetter(*__args):
  ...
  IsLetter(s: str,index: int) -> bool
   ...
   Indicates whether the character at the specified position in a specified string 
    is categorized as a Unicode letter.
 ...
 def IsLetterOrDigit(*__args):
  ...
  IsLetterOrDigit(s: str,index: int) -> bool
   ...
   Indicates whether the character at the specified position in a specified string 
    is categorized as a letter or a decimal digit.
  
  
   s: A string.
   index: The position of the character to evaluate in s.
   Returns: true if the character at position index in s is a letter or a decimal digit; 
    otherwise,false.
 ...
 def IsLower(*__args):
  ...
  IsLower(s: str,index: int) -> bool
   ...
   Indicates whether the character at the specified position in a specified string 
    is categorized as a lowercase letter.
  
  
   s: A string.
   index: The position of the character to evaluate in s.
   Returns: true if the character at position index in s is a lowercase letter; otherwise,
    false.
 ...
 def IsPunctuation(*__args):
  ...
  IsPunctuation(s: str,index: int) -> bool
   ...
   Indicates whether the character at the specified position in a specified string 
    is categorized as a punctuation mark.
  
  
   s: A string.
   index: The position of the character to evaluate in s.
   Returns: true if the character at position index in s is a punctuation mark; otherwise,
    false.
 ...
 def IsSeparator(*__args):
  ...
  IsSeparator(s: str,index: int) -> bool
   ...
   Indicates whether the character at the specified position in a specified string 
    is categorized as a separator character.
  
  
   s: A string.
   index: The position of the character to evaluate in s.
   Returns: true if the character at position index in s is a separator character; 
    otherwise,false.
 ...
 def IsSurrogate(*__args):
  ...
  IsSurrogate(s: str,index: int) -> bool
   ...
   Indicates whether the character at the specified position in a specified string 
    has a surrogate code unit.
  
  
   s: A string.
   index: The position of the character to evaluate in s.
   Returns: true if the character at position index in s is a either a high surrogate or a 
 ...
 def IsSurrogatePair(*__args):
  ...
  IsSurrogatePair(highSurrogate: Char,lowSurrogate: Char) -> bool
   ...
   Returns: true if the numeric value of the highSurrogate parameter ranges from U+D800 
    through U+DBFF,and the numeric value of the lowSurrogate parameter ranges from 
    U+DC00 through U+DFFF; otherwise,false.
  
  IsSurrogatePair(s: str,index: int) -> bool
  
   Indicates whether two adjacent System.Char objects at a specified position in a 
    string form a surrogate pair.
  
  
   s: A string.
   index: The starting position of the pair of characters to evaluate within s.
   Returns: true if the s parameter includes adjacent characters at positions index and 
    index + 1,and the numeric value of the character at position index ranges from 
    U+D800 through U+DBFF,and the numeric value of the character at position 
 ...
 def IsSymbol(*__args):
  ...
  IsSymbol(s: str,index: int) -> bool
   ...
   Indicates whether the character at the specified position in a specified string 
    is categorized as a symbol character.
  
  
   s: A string.
   index: The position of the character to evaluate in s.
   Returns: true if the character at position index in s is a symbol character; otherwise,
    false.
 ...
 def IsUpper(*__args):
  ...
  IsUpper(s: str,index: int) -> bool
   ...
   Indicates whether the character at the specified position in a specified string 
    is categorized as an uppercase letter.
  
  
   s: A string.
   index: The position of the character to evaluate in s.
   Returns: true if the character at position index in s is an uppercase letter; otherwise,
    false.
 ...
 def ToLower(c,culture=None):
  ...
  ToLower(c: Char) -> Char
   ...
   c: The Unicode character to convert.
   Returns: The lowercase equivalent of c,or the unchanged value of c,if c is already 
  ...
  ToLower(c: Char,culture: CultureInfo) -> Char
   ...
   Returns: The lowercase equivalent of c,modified according to culture,or the unchanged 
 ...
 def ToLowerInvariant(c):
  ...
  ToLowerInvariant(c: Char) -> Char
   ...
   c: The Unicode character to convert.
   Returns: The lowercase equivalent of the c parameter,or the unchanged value of c,if c 
 ...
 def ToString(self,*__args):
  ...
  ToString(c: Char) -> str
   ...
   Converts the specified Unicode character to its equivalent string 
    representation.
 ...
 def ToUpper(c,culture=None):
  ...
  ToUpper(c: Char) -> Char
   ...
   c: The Unicode character to convert.
   Returns: The uppercase equivalent of c,or the unchanged value of c if c is already 
  ...
  ToUpper(c: Char,culture: CultureInfo) -> Char
   ...
   c: The Unicode character to convert.
   culture: An object that supplies culture-specific casing rules.
   Returns: The uppercase equivalent of c,modified according to culture,or the unchanged 
 ...
 def ToUpperInvariant(c):
  ...
  ToUpperInvariant(c: Char) -> Char
   ...
   c: The Unicode character to convert.
   Returns: The uppercase equivalent of the c parameter,or the unchanged value of c,if c 
    is already uppercase or not alphabetic.
  """
  pass
 @staticmethod
