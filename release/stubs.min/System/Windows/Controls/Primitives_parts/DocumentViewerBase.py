class DocumentViewerBase(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IServiceProvider):
 ...
 def CanGoToPage(self,pageNumber):
  ...
  CanGoToPage(self: DocumentViewerBase,pageNumber: int) -> bool
   ...
   Returns a value that indicates whether or the viewer is able to jump to the 
    specified page number.
  
  
   pageNumber: A page number to check for as a valid jump target.
   Returns: A Boolean value that indicates whether or the viewer is able to jump to the 
    specified page number.
  """
  pass
 def FirstPage(self):
  ...
  FirstPage(self: DocumentViewerBase)
   Causes the viewer to jump to the first page of the current document 
    (represented by the 
 ...
 def GetIsMasterPage(element):
  ...
  GetIsMasterPage(element: DependencyObject) -> bool
   ...
   Returns the value of the 
    System.Windows.Controls.Primitives.DocumentViewerBase.IsMasterPage attached 
 ...
 def GetPageViewsCollection(self,*args):
  ...
  GetPageViewsCollection(self: DocumentViewerBase) -> (ReadOnlyCollection[DocumentPageView],bool)
   ...
   Creates and returns a new,read-only collection of 
    System.Windows.Controls.Primitives.DocumentPageView objects that are associated 
    with the current display document (represented by the 
    System.Windows.Controls.Primitives.DocumentViewerBase.Document property).
  
   Returns: A read-only collection of System.Windows.Controls.Primitives.DocumentPageView 
    objects that are associated with the current display document.
  """
  pass
 ...
 def LastPage(self):
  ...
  LastPage(self: DocumentViewerBase)
   Causes the viewer to jump to the last page in the current document (represented 
    by the System.Windows.Controls.Primitives.DocumentViewerBase.Document 
    property).
  """
  pass
 ...
 def NextPage(self):
  ...
  NextPage(self: DocumentViewerBase)
   Causes the viewer to jump to the next page in the current document (represented 
    by the System.Windows.Controls.Primitives.DocumentViewerBase.Document 
    property).
  """
  pass
 ...
 def OnBringIntoView(self,*args):
  ...
  OnBringIntoView(self: DocumentViewerBase,element: DependencyObject,rect: Rect,pageNumber: int)
   Invoked whenever the System.Windows.FrameworkElement.RequestBringIntoView event 
    reaches an element derived from this class in its route.  Implement this method 
    to add class handling for this event.
  
  
   element: The element from which the System.Windows.FrameworkElement.RequestBringIntoView 
    event originated.
  
   rect: A rectangular region,in the coordinate space of element,which should be made 
    visible.
 ...
 def OnDocumentChanged(self,*args):
  ...
  OnDocumentChanged(self: DocumentViewerBase)
   Called whenever the 
    System.Windows.Controls.Primitives.DocumentViewerBase.Document property is 
    modified.
  """
  pass
 ...
 def PreviousPage(self):
  ...
  PreviousPage(self: DocumentViewerBase)
   Causes the viewer to jump to the previous page of the current document 
    (represented by the 
    System.Windows.Controls.Primitives.DocumentViewerBase.Document property).
  """
  pass
 def Print(self):
  ...
  Print(self: DocumentViewerBase)
   Invokes a standard Print dialog which can be used to print the contents of the 
    viewer and configure printing preferences.
  """
  pass
 ...
 def SetIsMasterPage(element,value):
  ...
  SetIsMasterPage(element: DependencyObject,value: bool)
   Sets the System.Windows.Controls.Primitives.DocumentViewerBase.IsMasterPage�
