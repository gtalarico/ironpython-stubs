class ListBindingHelper(object):
    ...
    def GetList(*__args):
        ...
        GetList(list: object) -> object
            ...
            Returns: An System.Object representing the underlying list if it exists; otherwise, the original data source specified by list.
        """
        pass
    ...
    def GetListItemProperties(*__args):
        ...
        GetListItemProperties(dataSource: object, dataMember: str, listAccessors: Array[PropertyDescriptor]) -> PropertyDescriptorCollection
            ...
            Returns the System.ComponentModel.PropertyDescriptorCollection that describes the properties of an item type contained in the specified data member of a data source. Uses the specified 
            ...
            listAccessors: The System.ComponentModel.PropertyDescriptor array describing which properties of the data member to examine. This can be null.
            Returns: The System.ComponentModel.PropertyDescriptorCollection describing the properties of an item type contained in a collection property of the specified data source.
        GetListItemProperties(list: object, listAccessors: Array[PropertyDescriptor]) -> PropertyDescriptorCollection
        
            Returns the System.ComponentModel.PropertyDescriptorCollection that describes the properties of an item type contained in a collection property of a data source. Uses the specified 
             System.ComponentModel.PropertyDescriptor array to indicate which properties to examine.
        
        
            list: The data source to be examined for property information.
            listAccessors: The System.ComponentModel.PropertyDescriptor array describing which properties of the data source to examine. This can be null.
            Returns: The System.ComponentModel.PropertyDescriptorCollection describing the properties of the item type contained in a collection property of the data source.
        GetListItemProperties(list: object) -> PropertyDescriptorCollection
            ...
            Returns: The System.ComponentModel.PropertyDescriptorCollection containing the properties of the items contained in list, or properties of list.
        """
        pass
    ...
    def GetListItemType(*__args):
        ...
        GetListItemType(dataSource: object, dataMember: str) -> Type
            ...
            dataMember: The optional name of the property on the data source that is to be used as the data member. This can be null.
            Returns: For complex data binding, the System.Type of the items represented by the dataMember in the data source; otherwise, the System.Type of the item in the list itself.
    ...
    def GetListName(list, listAccessors):
        ...
        GetListName(list: object, listAccessors: Array[PropertyDescriptor]) -> str
            ...
            listAccessors: An array of System.ComponentModel.PropertyDescriptor objects to find in the data source. This can be null.
            Returns: The name of the list in the data source, as described by listAccessors, orthe name of the data source type.
        """
        pass
