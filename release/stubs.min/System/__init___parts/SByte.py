class SByte(object,IComparable,IFormattable,IConvertible,IComparable[SByte],IEquatable[SByte]):
 ...
 def CompareTo(self,*__args):
  ...
  CompareTo(self: SByte,value: SByte) -> int
   ...
   Compares this instance to a specified 8-bit signed integer and returns an 
  ...
  CompareTo(self: SByte,obj: object) -> int
   ...
   Returns: A signed number indicating the relative values of this instance and obj.Return 
    Value Description Less than zero This instance is less than obj. Zero This 
    instance is equal to obj. Greater than zero This instance is greater than 
    obj.-or- obj is null.
  """
  pass
 ...
 def Equals(self,obj):
  ...
  Equals(self: SByte,obj: object) -> bool
   ...
   Returns: true if obj is an instance of System.SByte and equals the value of this 
 ...
 def Parse(s,*__args):
  ...
  Parse(s: str,provider: IFormatProvider) -> SByte
   ...
   s: A string that represents a number to convert. The string is interpreted using 
  ...
  Parse(s: str,style: NumberStyles,provider: IFormatProvider) -> SByte
   ...
   s: A string that contains the number to convert. The string is interpreted by 
    using the style specified by style.
   ...
   Returns: An 8-bit signed byte value that is equivalent to the number specified in the s 
    parameter.
  ...
  Parse(s: str) -> SByte
   ...
   Returns: An 8-bit signed integer that is equivalent to the number contained in the s 
    parameter.
 ...
 def ToString(self,*__args):
  ...
  ToString(self: SByte) -> str
   ...
   Returns: The string representation of the value of this instance,consisting of a 
 ...
 def TryParse(s,*__args):
  ...
  TryParse(s: str,style: NumberStyles,provider: IFormatProvider) -> (bool,SByte)
   ...
   Tries to convert the string representation of a number in a specified style and 
    culture-specific format to its System.SByte equivalent,and returns a value 
  ...
  TryParse(s: str) -> (bool,SByte)
   ...
   Tries to convert the string representation of a number to its System.SByte 
