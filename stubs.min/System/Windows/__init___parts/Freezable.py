class Freezable(DependencyObject, ISealable):
    ...
    def Clone(self):
        ...
        Clone(self: Freezable) -> Freezable
            ...
            Creates a modifiable clone of the System.Windows.Freezable, making deep copies of the object's values. When copying the object's dependency properties, this method copies expressions (which might no longer 
    ...
    def CloneCurrentValue(self):
        ...
        CloneCurrentValue(self: Freezable) -> Freezable
            ...
            Creates a modifiable clone (deep copy) of the System.Windows.Freezable using its current values.
            Returns: A modifiable clone of the current object. The cloned object's System.Windows.Freezable.IsFrozen property is false even if the source's System.Windows.Freezable.IsFrozen property is true.
        """
        pass
    ...
    def Freeze(self):
        ...
        Freeze(self: Freezable)
            Makes the current object unmodifiable and sets its System.Windows.Freezable.IsFrozen property to true.
        """
        pass
    ...
    def GetAsFrozen(self):
        ...
        GetAsFrozen(self: Freezable) -> Freezable
            ...
            Creates a frozen copy of the System.Windows.Freezable, using base (non-animated) property values. Because the copy is frozen, any frozen sub-objects are copied by reference.
            Returns: A frozen copy of the System.Windows.Freezable. The copy's System.Windows.Freezable.IsFrozen property is set to true.
        """
        pass
    ...
    def GetCurrentValueAsFrozen(self):
        ...
        GetCurrentValueAsFrozen(self: Freezable) -> Freezable
            ...
            Creates a frozen copy of the System.Windows.Freezable using current property values. Because the copy is frozen, any frozen sub-objects are copied by reference.
            Returns: A frozen copy of the System.Windows.Freezable. The copy's System.Windows.Freezable.IsFrozen property is set to true.
        """
        pass
