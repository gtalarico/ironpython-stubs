class Array:
 ...
 def BinarySearch(array,*__args):
  ...
  BinarySearch(array: Array,value: object) -> int
   ...
   Returns: The index of the specified value in the specified array,if value is found. If value is 
    not found and value is less than one or more elements in array,a negative number which 
    is the bitwise complement of the index of the first element that is larger than value. If 
    value is not found and value is greater than any of the elements in array,a negative 
  ...
  BinarySearch(array: Array,index: int,length: int,value: object) -> int
   ...
   Searches a range of elements in a one-dimensional sorted System.Array for a value,using 
    the System.IComparable interface implemented by each element of the System.Array and by 
    the specified value.
 ...
 def Clear(array,index,length):
  ...
  Clear(array: Array,index: int,length: int)
   Sets a range of elements in the System.Array to zero,to false,or to null,depending on 
    the element type.
 ...
 def ConstrainedCopy(sourceArray,sourceIndex,destinationArray,destinationIndex,length):
  ...
  ConstrainedCopy(sourceArray: Array,sourceIndex: int,destinationArray: Array,destinationIndex: int,length: int)
   Copies a range of elements from an System.Array starting at the specified source index 
    and pastes them to another System.Array starting at the specified destination index.  
   ...
   destinationIndex: A 32-bit integer that represents the index in the destinationArray at which storing 
    begins.
 ...
 def Copy(sourceArray,*__args):
  ...
  Copy(sourceArray: Array,destinationArray: Array,length: int)
   Copies a range of elements from an System.Array starting at the first element and pastes 
    them into another System.Array starting at the first element. The length is specified as 
    a 32-bit integer.
  ...
  Copy(sourceArray: Array,sourceIndex: int,destinationArray: Array,destinationIndex: int,length: int)
   Copies a range of elements from an System.Array starting at the specified source index 
    and pastes them to another System.Array starting at the specified destination index. The 
  ...
  Copy(sourceArray: Array,destinationArray: Array,length: Int64)
   ...
   sourceArray: The System.Array that contains the data to copy.
   destinationArray: The System.Array that receives the data.
   length: A 64-bit integer that represents the number of elements to copy. The integer must be 
    between zero and System.Int32.MaxValue,inclusive.
  
  Copy(sourceArray: Array,sourceIndex: Int64,destinationArray: Array,destinationIndex: Int64,length: Int64)
   Copies a range of elements from an System.Array starting at the specified source index 
    and pastes them to another System.Array starting at the specified destination index. The 
    length and the indexes are specified as 64-bit integers.
  
  
   sourceArray: The System.Array that contains the data to copy.
   sourceIndex: A 64-bit integer that represents the index in the sourceArray at which copying begins.
   destinationArray: The System.Array that receives the data.
   destinationIndex: A 64-bit integer that represents the index in the destinationArray at which storing 
    begins.
 ...
 def CreateInstance(elementType,*__args):
  ...
  CreateInstance(elementType: Type,length: int) -> Array
   ...
   Creates a one-dimensional System.Array of the specified System.Type and length,with 
    zero-based indexing.
  
  
   elementType: The System.Type of the System.Array to create.
   length: The size of the System.Array to create.
   Returns: A new one-dimensional System.Array of the specified System.Type with the specified 
    length,using zero-based indexing.
  
  CreateInstance(elementType: Type,length1: int,length2: int) -> Array
  
   Creates a two-dimensional System.Array of the specified System.Type and dimension 
    lengths,with zero-based indexing.
   ...
   Returns: A new two-dimensional System.Array of the specified System.Type with the specified length 
    for each dimension,using zero-based indexing.
  
  CreateInstance(elementType: Type,length1: int,length2: int,length3: int) -> Array
  
   Creates a three-dimensional System.Array of the specified System.Type and dimension 
    lengths,with zero-based indexing.
   ...
   Returns: A new three-dimensional System.Array of the specified System.Type with the specified 
    length for each dimension,using zero-based indexing.
  ...
  CreateInstance(elementType: Type,*lengths: Array[int]) -> Array
   ...
   Creates a multidimensional System.Array of the specified System.Type and dimension 
    lengths,with zero-based indexing. The dimension lengths are specified in an array of 
    32-bit integers.
  
  
   elementType: The System.Type of the System.Array to create.
   lengths: An array of 32-bit integers that represent the size of each dimension of the System.Array 
    to create.
  
   Returns: A new multidimensional System.Array of the specified System.Type with the specified 
    length for each dimension,using zero-based indexing.
  ...
  CreateInstance(elementType: Type,*lengths: Array[Int64]) -> Array
   ...
   elementType: The System.Type of the System.Array to create.
   lengths: An array of 64-bit integers that represent the size of each dimension of the System.Array 
    to create. Each integer in the array must be between zero and System.Int32.MaxValue,
    inclusive.
  ...
  CreateInstance(elementType: Type,lengths: Array[int],lowerBounds: Array[int]) -> Array
   ...
   elementType: The System.Type of the System.Array to create.
   lengths: A one-dimensional array that contains the size of each dimension of the System.Array to 
    create.
  
   lowerBounds: A one-dimensional array that contains the lower bound (starting index) of each dimension 
    of the System.Array to create.
 ...
 def GetValue(self,*__args):
  ...
  GetValue(self: Array,*indices: Array[int]) -> object
   ...
   Gets the value at the specified position in the multidimensional System.Array. The 
    indexes are specified as an array of 32-bit integers.
  
  
   indices: A one-dimensional array of 32-bit integers that represent the indexes specifying the 
    position of the System.Array element to get.
  
   Returns: The value at the specified position in the multidimensional System.Array.
  GetValue(self: Array,index: int) -> object
  
   Gets the value at the specified position in the one-dimensional System.Array. The index 
  ...
  GetValue(self: Array,index1: int,index2: int) -> object
   ...
   Gets the value at the specified position in the two-dimensional System.Array. The indexes 
    are specified as 32-bit integers.
  
  
   index1: A 32-bit integer that represents the first-dimension index of the System.Array element to 
    get.
  
   index2: A 32-bit integer that represents the second-dimension index of the System.Array element 
    to get.
  ...
  GetValue(self: Array,index1: int,index2: int,index3: int) -> object
   ...
   Gets the value at the specified position in the three-dimensional System.Array. The 
   ...
   index3: A 32-bit integer that represents the third-dimension index of the System.Array element to 
    get.
  ...
  GetValue(self: Array,index1: Int64,index2: Int64) -> object
   ...
   index1: A 64-bit integer that represents the first-dimension index of the System.Array element to 
    get.
  
   index2: A 64-bit integer that represents the second-dimension index of the System.Array element 
    to get.
  ...
  GetValue(self: Array,index1: Int64,index2: Int64,index3: Int64) -> object
   ...
   index3: A 64-bit integer that represents the third-dimension index of the System.Array element to 
    get.
  ...
  GetValue(self: Array,*indices: Array[Int64]) -> object
   ...
   indices: A one-dimensional array of 64-bit integers that represent the indexes specifying the 
    position of the System.Array element to get.
 ...
 def IndexOf(array,value,startIndex=None,count=None):
  ...
  IndexOf(array: Array,value: object) -> int
   ...
   Searches for the specified object and returns the index of the first occurrence within 
    the entire one-dimensional System.Array.
  
  
   array: The one-dimensional System.Array to search.
   value: The object to locate in array.
   Returns: The index of the first occurrence of value within the entire array,if found; otherwise,
    the lower bound of the array minus 1.
  
  IndexOf(array: Array,value: object,startIndex: int) -> int
  
   Searches for the specified object and returns the index of the first occurrence within 
    the range of elements in the one-dimensional System.Array that extends from the specified 
   ...
   Returns: The index of the first occurrence of value within the range of elements in array that 
    extends from startIndex to the last element,if found; otherwise,the lower bound of the 
    array minus 1.
  
  IndexOf(array: Array,value: object,startIndex: int,count: int) -> int
  
   Searches for the specified object and returns the index of the first occurrence within 
    the range of elements in the one-dimensional System.Array that starts at the specified 
   ...
   Returns: The index of the first occurrence of value within the range of elements in array that 
    starts at startIndex and contains the number of elements specified in count,if found; 
 ...
 def LastIndexOf(array,value,startIndex=None,count=None):
  ...
  LastIndexOf(array: Array,value: object) -> int
   ...
   array: The one-dimensional System.Array to search.
   value: The object to locate in array.
   Returns: The index of the last occurrence of value within the entire array,if found; otherwise,
    the lower bound of the array minus 1.
  
  LastIndexOf(array: Array,value: object,startIndex: int) -> int
  
   Searches for the specified object and returns the index of the last occurrence within the 
    range of elements in the one-dimensional System.Array that extends from the first element 
   ...
   Returns: The index of the last occurrence of value within the range of elements in array that 
    extends from the first element to startIndex,if found; otherwise,the lower bound of the 
    array minus 1.
  
  LastIndexOf(array: Array,value: object,startIndex: int,count: int) -> int
  
   Searches for the specified object and returns the index of the last occurrence within the 
    range of elements in the one-dimensional System.Array that contains the specified number 
   ...
   count: The number of elements in the section to search.
   Returns: The index of the last occurrence of value within the range of elements in array that 
    contains the number of elements specified in count and ends at startIndex,if found; 
    otherwise,the lower bound of the array minus 1.
 ...
 def Sort(*__args):
  ...
  Sort(keys: Array,items: Array,comparer: IComparer)
   ...
   items: The one-dimensional System.Array that contains the items that correspond to each of the 
    keys in the keysSystem.Array.-or-null to sort only the keysSystem.Array.
  ...
  Sort(keys: Array,items: Array,index: int,length: int)
   Sorts a range of elements in a pair of one-dimensional System.Array objects (one contains 
