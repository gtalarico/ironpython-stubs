class Int64KeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: Int64KeyFrameCollection,keyFrame: Int64KeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.Int64KeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.Int64KeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: Int64KeyFrameCollection)
   Removes all System.Windows.Media.Animation.Int64KeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: Int64KeyFrameCollection) -> Int64KeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.Int64KeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: Int64KeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.Int64KeyFrameCollection. When copying dependency 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: Int64KeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.Int64KeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: Int64KeyFrameCollection,array: Array[Int64KeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.Int64KeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: Int64KeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.Int64KeyFrameCollection 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: Int64KeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.Int64KeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: Int64KeyFrameCollection,keyFrame: Int64KeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.Int64KeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: Int64KeyFrameCollection,index: int,keyFrame: Int64KeyFrame)
   Inserts a System.Windows.Media.Animation.Int64KeyFrame into a specific location 
    within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.Int64KeyFrame is 
    inserted.
  
   keyFrame: The System.Windows.Media.Animation.Int64KeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: Int64KeyFrameCollection,keyFrame: Int64KeyFrame)
   Removes a System.Windows.Media.Animation.Int64KeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.Int64KeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: Int64KeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.Int64KeyFrame at the specified index 
    position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.Int64KeyFrame to be 
    removed.
  """
  pass
