class Application(object):
    ...
    def SetCompatibleTextRenderingDefault(defaultValue):
        ...
        SetCompatibleTextRenderingDefault(defaultValue: bool)
            ...
            defaultValue: The default value to use for new controls. If true, new controls that support UseCompatibleTextRendering use the GDI+ based System.Drawing.Graphics class for text rendering; if false, new controls use the 
             GDI�based System.Windows.Forms.TextRenderer class.
        """
        pass
    ...
    ExecutablePath = 'C:\\Program Files (x86)\\IronPython-2.7.7\\ipy64.exe'
    Idle = None
