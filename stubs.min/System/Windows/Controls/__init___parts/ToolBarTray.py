class ToolBarTray(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def GetIsLocked(element):
        ...
        GetIsLocked(element: DependencyObject) -> bool
            ...
            Reads the value of the System.Windows.Controls.ToolBarTray.IsLocked property from the specified element.
        
            element: The element from which to read the property.
            Returns: true if the toolbar cannot be moved inside the toolbar tray; otherwise, false. The default is false.
        """
        pass
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: ToolBarTray, constraint: Size) -> Size
            ...
            constraint: The measurement constraints; a System.Windows.Controls.ToolBarTray cannot return a size larger than the constraint.
            Returns: The size of the control.
        """
        pass
    ...
    def OnRender(self, *args): #cannot find CLR method
        ...
        OnRender(self: ToolBarTray, dc: DrawingContext)
            Called when a System.Windows.Controls.ToolBarTray is displayed to get the Drawing Context (DC) to use to render the System.Windows.Controls.ToolBarTray.
    ...
    def SetIsLocked(element, value):
        ...
        SetIsLocked(element: DependencyObject, value: bool)
            Writes the value of the System.Windows.Controls.ToolBarTray.IsLocked property to the specified element.
