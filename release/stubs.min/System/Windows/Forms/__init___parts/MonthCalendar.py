class MonthCalendar:
 ...
 def CreateAccessibilityInstance(self,*args):
  """ CreateAccessibilityInstance(self: MonthCalendar) -> AccessibleObject """
  pass
 ...
 def GetDisplayRange(self,visible):
  ...
  GetDisplayRange(self: MonthCalendar,visible: bool) -> SelectionRange
   ...
   Retrieves date information that represents the low and high limits of the displayed dates 
    of the control.
  
  
   visible: true to retrieve only the dates that are fully contained in displayed months; otherwise,
    false.
 ...
 def HitTest(self,*__args):
  ...
  HitTest(self: MonthCalendar,x: int,y: int) -> HitTestInfo
   ...
   Returns a System.Windows.Forms.MonthCalendar.HitTestInfo with information on which 
    portion of a month calendar control is at a specified x- and y-coordinate.
   ...
   Returns: A System.Windows.Forms.MonthCalendar.HitTestInfo that contains information about the 
    specified point on the System.Windows.Forms.MonthCalendar.
  
  HitTest(self: MonthCalendar,point: Point) -> HitTestInfo
  
   Returns an object with information on which portion of a month calendar control is at a 
    location specified by a System.Drawing.Point.
 ...
 def SetBoundsCore(self,*args):
  ...
  SetBoundsCore(self: MonthCalendar,x: int,y: int,width: int,height: int,specified: BoundsSpecified)
   Overrides the 
    ...
    nt32,System.Windows.Forms.BoundsSpecified) method.
