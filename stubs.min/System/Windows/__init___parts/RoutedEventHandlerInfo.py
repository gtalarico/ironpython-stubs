class RoutedEventHandlerInfo(object):
 ...
 def __ne__(self,*args):
  pass
 Handler=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 InvokeHandledEventsToo=property(lambda self: object(),lambda self,v: None,lambda self: None)
