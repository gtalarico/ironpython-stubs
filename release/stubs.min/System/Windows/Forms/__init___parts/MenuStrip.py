class MenuStrip:
 ...
 def CreateDefaultItem(self,*args):
  ...
  CreateDefaultItem(self: MenuStrip,text: str,image: Image,onClick: EventHandler) -> ToolStripItem
   ...
   Creates a System.Windows.Forms.ToolStripMenuItem with the specified text,image,and 
    event handler on a new System.Windows.Forms.MenuStrip.
   ...
   Returns: A 
    System.Windows.Forms.ToolStripMenuItem.#ctor(System.String,System.Drawing.Image,System.Eve
    ntHandler),or a System.Windows.Forms.ToolStripSeparator if the text parameter is a 
    hyphen (-).
  """
  pass
