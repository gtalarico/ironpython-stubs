class Track(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient):
    ...
    def GetVisualChild(self, *args): #cannot find CLR method
        ...
        GetVisualChild(self: Track, index: int) -> Visual
            ...
            Returns: Returns the object of the System.Windows.Controls.Primitives.Track at the specified index in the list of visual child elements. The index must be a number between zero (0) and the value of the 
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: Track, availableSize: Size) -> Size
            ...
            Measures the layout size that is required for the System.Windows.Controls.Primitives.Track and its components.
    ...
    def ValueFromDistance(self, horizontal, vertical):
        ...
        ValueFromDistance(self: Track, horizontal: float, vertical: float) -> float
            ...
            Calculates the change in the System.Windows.Controls.Primitives.Track.Value of the System.Windows.Controls.Primitives.Track when the System.Windows.Controls.Primitives.Track.Thumb moves.
            ...
            Returns: The change in System.Windows.Controls.Primitives.Track.Value that corresponds to the displacement of the System.Windows.Controls.Primitives.Track.Thumb of the System.Windows.Controls.Primitives.Track.
        """
        pass
    ...
    def ValueFromPoint(self, pt):
        ...
        ValueFromPoint(self: Track, pt: Point) -> float
            ...
            Calculates the distance from the System.Windows.Controls.Primitives.Thumb to a specified point along the System.Windows.Controls.Primitives.Track.
        
            pt: The specified point.
            Returns: The distance between the System.Windows.Controls.Primitives.Track.Thumb and the specified pt value.
        """
        pass
    ...
    DecreaseRepeatButton = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IncreaseRepeatButton = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    Thumb = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ViewportSize = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
