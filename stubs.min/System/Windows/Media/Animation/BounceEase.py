class BounceEase(EasingFunctionBase, ISealable, IEasingFunction):
    ...
    Bounces = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    Bounciness = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
