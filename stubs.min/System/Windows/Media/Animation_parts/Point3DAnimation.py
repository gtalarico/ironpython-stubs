class Point3DAnimation(Point3DAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: Point3DAnimation) -> Point3DAnimation
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.Point3DAnimation, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
