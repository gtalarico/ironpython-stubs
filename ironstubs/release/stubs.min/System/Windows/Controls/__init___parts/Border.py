class Border(Decorator,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def ArrangeOverride(self,*args):
  ...
  ArrangeOverride(self: Border,finalSize: Size) -> Size
   ...
   Returns: The System.Windows.Size that represents the arranged size of this 
    System.Windows.Controls.Border element and its child element.
  """
  pass
 ...
 def GetVisualChild(self,*args):
  ...
  GetVisualChild(self: Decorator,index: int) -> Visual
   ...
   Gets the child System.Windows.Media.Visual element at the specified index 
    position.
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: Border,constraint: Size) -> Size
   ...
   Measures the child elements of a System.Windows.Controls.Border before they are 
    arranged during the 
    System.Windows.Controls.Border.ArrangeOverride(System.Windows.Size) pass.
 ...
 def OnRender(self,*args):
  ...
  OnRender(self: Border,dc: DrawingContext)
   Draws the contents of a System.Windows.Media.DrawingContext object during the 
