class MenuItem(HeaderedItemsControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage,ICommandSource):
 ...
 def ClearContainerForItemOverride(self,*args):
  ...
  ClearContainerForItemOverride(self: ItemsControl,element: DependencyObject,item: object)
   When overridden in a derived class,undoes the effects of the 
    System.Windows.Controls.ItemsControl.PrepareContainerForItemOverride(System.Wind
    ows.DependencyObject,System.Object) method.
  
  
   element: The container element.
   item: The item.
  ClearContainerForItemOverride(self: ComboBox_21$22,element: DependencyObject,item: object)
  """
  pass
 ...
 def OnChecked(self,*args):
  ...
  OnChecked(self: MenuItem,e: RoutedEventArgs)
   Called when the System.Windows.Controls.MenuItem.IsChecked property becomes 
    true. This method raises the System.Windows.Controls.MenuItem.Checked routed 
    event.
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: MenuItem) -> AutomationPeer
   ...
   Provides an appropriate System.Windows.Automation.Peers.MenuItemAutomationPeer 
    implementation for this control,as part of the WPF automation infrastructure.
 ...
 def OnHeaderChanged(self,*args):
  ...
  OnHeaderChanged(self: HeaderedItemsControl,oldHeader: object,newHeader: object)
   Called when the System.Windows.Controls.HeaderedItemsControl.Header property of 
    a System.Windows.Controls.HeaderedItemsControl changes.
  
  
   oldHeader: The old value of the System.Windows.Controls.HeaderedItemsControl.Header 
    property.
  
   newHeader: The new value of the System.Windows.Controls.HeaderedItemsControl.Header 
    property.
  """
  pass
 def OnHeaderStringFormatChanged(self,*args):
  ...
  OnHeaderStringFormatChanged(self: HeaderedItemsControl,oldHeaderStringFormat: str,newHeaderStringFormat: str)
   Occurs when the System.Windows.Controls.HeaderedItemsControl.HeaderStringFormat 
    property changes.
  
  
   oldHeaderStringFormat: The old value of the 
    System.Windows.Controls.HeaderedItemsControl.HeaderStringFormat property.
 ...
 def OnHeaderTemplateChanged(self,*args):
  ...
  OnHeaderTemplateChanged(self: HeaderedItemsControl,oldHeaderTemplate: DataTemplate,newHeaderTemplate: DataTemplate)
   Called when the System.Windows.Controls.HeaderedItemsControl.HeaderTemplate 
    property changes.
  
  
   oldHeaderTemplate: The old value of the 
    System.Windows.Controls.HeaderedItemsControl.HeaderTemplate property.
  
   newHeaderTemplate: The new value of the 
    System.Windows.Controls.HeaderedItemsControl.HeaderTemplate property.
  """
  pass
 def OnHeaderTemplateSelectorChanged(self,*args):
  ...
  OnHeaderTemplateSelectorChanged(self: HeaderedItemsControl,oldHeaderTemplateSelector: DataTemplateSelector,newHeaderTemplateSelector: DataTemplateSelector)
   Called when the 
    System.Windows.Controls.HeaderedItemsControl.HeaderTemplateSelector property 
    changes.
  
  
   oldHeaderTemplateSelector: The old value of the 
    System.Windows.Controls.HeaderedItemsControl.HeaderTemplateSelector property.
  
   newHeaderTemplateSelector: The new value of the 
    System.Windows.Controls.HeaderedItemsControl.HeaderTemplateSelector property.
  """
  pass
 def OnInitialized(self,*args):
  ...
  OnInitialized(self: MenuItem,e: EventArgs)
   Called when the System.Windows.FrameworkElement.IsInitialized property is set 
    to true and raises an System.Windows.FrameworkElement.Initialized event.
 ...
 def OnIsKeyboardFocusWithinChanged(self,*args):
  ...
  OnIsKeyboardFocusWithinChanged(self: MenuItem,e: DependencyPropertyChangedEventArgs)
   ...
   e: The event data for the 
    System.Windows.ContentElement.IsKeyboardFocusWithinChanged event.
  """
  pass
 ...
 def OnItemsChanged(self,*args):
  ...
  OnItemsChanged(self: MenuItem,e: NotifyCollectionChangedEventArgs)
   ...
   e: The event data for the 
    System.Windows.Controls.ItemContainerGenerator.ItemsChanged event.
  """
  pass
 ...
 def OnItemsSourceChanged(self,*args):
  ...
  OnItemsSourceChanged(self: ItemsControl,oldValue: IEnumerable,newValue: IEnumerable)
   Called when the System.Windows.Controls.ItemsControl.ItemsSource property 
    changes.
  ...
  OnItemsSourceChanged(self: ComboBox_21$22,oldValue: IEnumerable,newValue: IEnumerable)
  """
  pass
 ...
 def OnTextInput(self,*args):
  ...
  OnTextInput(self: ComboBox_21$22,e: TextCompositionEventArgs)
  """
  pass
 ...
 def OnUnchecked(self,*args):
  ...
  OnUnchecked(self: MenuItem,e: RoutedEventArgs)
   Called when the System.Windows.Controls.MenuItem.IsChecked property becomes 
    false. This method raises the System.Windows.Controls.MenuItem.Unchecked routed 
    event.
 ...
 def OnVisualParentChanged(self,*args):
  ...
  OnVisualParentChanged(self: MenuItem,oldParent: DependencyObject)
   ...
   oldParent: Old value of the parent of the visual,or null if the visual did not have a 
    parent.
  """
  pass
 ...
 def ShouldApplyItemContainerStyle(self,*args):
  ...
  ShouldApplyItemContainerStyle(self: MenuItem,container: DependencyObject,item: object) -> bool
   ...
   Returns: true if the System.Windows.Controls.MenuItem is not a 
    System.Windows.Controls.Separator; otherwise,false.
  """
  pass
