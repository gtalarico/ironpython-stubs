class CacheMode(Animatable,ISealable,IAnimatable,IResource):
 ...
 def Clone(self):
  ...
  Clone(self: CacheMode) -> CacheMode
   ...
   Creates a modifiable clone of the System.Windows.Media.CacheMode,making deep 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: CacheMode) -> CacheMode
   ...
   Creates a modifiable clone (deep copy) of the System.Windows.Media.CacheMode 
