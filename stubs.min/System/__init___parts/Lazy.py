class Lazy(object):
    ...
    def ToString(self):
        ...
        ToString(self: Lazy[T]) -> str
            ...
            Returns: The result of calling the System.Object.ToString method on the System.Lazy property for this instance, if the value has been created (that is, if the System.Lazy property returns true). Otherwise, a string 
             indicating that the value has not been created.
        """
        pass
