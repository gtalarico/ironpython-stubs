class InkCanvas(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def GetBottom(element):
  ...
  GetBottom(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.InkCanvas.Bottom attached 
 ...
 def GetLeft(element):
  ...
  GetLeft(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.InkCanvas.Left attached property 
 ...
 def GetRight(element):
  ...
  GetRight(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.InkCanvas.Right attached property 
    for a given dependency object.
 ...
 def GetTop(element):
  ...
  GetTop(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.InkCanvas.Top attached property 
    for a given dependency object.
 ...
 def HitTestSelection(self,point):
  ...
  HitTestSelection(self: InkCanvas,point: Point) -> InkCanvasSelectionHitResult
   ...
   Returns a value that indicates which part of the selection adorner intersects 
    or surrounds the specified point.
  
  
   point: The point to hit test.
   Returns: A value that indicates which part of the selection adorner intersects or 
    surrounds a specified point.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: InkCanvas) -> AutomationPeer
   ...
   Provides an appropriate System.Windows.Automation.Peers.InkCanvasAutomationPeer 
 ...
 def OnDefaultDrawingAttributesReplaced(self,*args):
  ...
  OnDefaultDrawingAttributesReplaced(self: InkCanvas,e: DrawingAttributesReplacedEventArgs)
   Raises the System.Windows.Controls.InkCanvas.DefaultDrawingAttributesReplaced 
    event.
 ...
 def OnSelectionMoved(self,*args):
  ...
  OnSelectionMoved(self: InkCanvas,e: EventArgs)
   An event announcing that the user selected and moved a selection of strokes 
    and/or elements.
 ...
 def Paste(self,point=None):
  ...
  Paste(self: InkCanvas,point: Point)
   Pastes the contents of the Clipboard to the System.Windows.Controls.InkCanvas 
    at a given point.
 ...
 def SetBottom(element,length):
  ...
  SetBottom(element: UIElement,length: float)
   Sets the value of the System.Windows.Controls.InkCanvas.Bottom attached 
    property for a given dependency object.
 ...
 def SetLeft(element,length):
  ...
  SetLeft(element: UIElement,length: float)
   Sets the value of the System.Windows.Controls.InkCanvas.Left attached property 
    for a given dependency object.
 ...
 def SetRight(element,length):
  ...
  SetRight(element: UIElement,length: float)
   Sets the value of the System.Windows.Controls.InkCanvas.Right attached property 
    for a given dependency object.
 ...
 def SetTop(element,length):
  ...
  SetTop(element: UIElement,length: float)
   Sets the value of the System.Windows.Controls.InkCanvas.Top attached property 
    for a given dependency object.
