class DrawingGroup(Drawing,ISealable,IAnimatable,IResource,IDrawingContent):
 ...
 def Append(self):
  ...
  Append(self: DrawingGroup) -> DrawingContext
   ...
   Opens the System.Windows.Media.DrawingGroup in order to populate its 
    System.Windows.Media.DrawingGroup.Children. This method enables you to append 
    additional System.Windows.Media.DrawingGroup.Children to this 
    System.Windows.Media.DrawingGroup.
  
   Returns: A System.Windows.Media.DrawingContext that you can use to describe the contents 
    of this System.Windows.Media.DrawingGroup object.
  """
  pass
 def Clone(self):
  """
  Clone(self: DrawingGroup) -> DrawingGroup
   ...
   Creates a modifiable deep copy of this System.Windows.Media.DrawingGroup and 
    makes deep copies of its values.
  
   Returns: A modifiable clone of the current object. The System.Windows.Freezable.IsFrozen 
    property of the cloned object returns false even if the 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: DrawingGroup) -> DrawingGroup
   ...
   Creates a modifiable deep copy of this System.Windows.Media.DrawingGroup object 
    and makes deep copies of its current values.
  
   Returns: A modifiable clone of the current object. The System.Windows.Freezable.IsFrozen 
    property of the cloned object is false even if the 
    System.Windows.Freezable.IsFrozen property of the source is true.
  """
  pass
 ...
 def Open(self):
  ...
  Open(self: DrawingGroup) -> DrawingContext
   ...
   Opens the System.Windows.Media.DrawingGroup in order to populate its 
    System.Windows.Media.DrawingGroup.Children and clears any existing 
    System.Windows.Media.DrawingGroup.Children.
  
   Returns: A System.Windows.Media.DrawingContext that can be used to describe the contents 
    of this System.Windows.Media.DrawingGroup object.
  """
  pass
...
"""
 ...
 ClipGeometry=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 GuidelineSet=property(lambda self: object(),lambda self,v: None,lambda self: None)
