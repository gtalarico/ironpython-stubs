class MainMenu(Menu,IComponent,IDisposable):
 ...
 def GetForm(self):
  ...
  GetForm(self: MainMenu) -> Form
   ...
   Returns: A System.Windows.Forms.Form that is the container for this control. Returns 
    null if the System.Windows.Forms.MainMenu is not currently hosted on a form.
  """
  pass
