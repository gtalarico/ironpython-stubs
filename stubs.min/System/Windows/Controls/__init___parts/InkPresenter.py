class InkPresenter(Decorator, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def AttachVisuals(self, visual, drawingAttributes):
        ...
        AttachVisuals(self: InkPresenter, visual: Visual, drawingAttributes: DrawingAttributes)
            Attaches the visual of a System.Windows.Input.StylusPlugIns.DynamicRenderer to an System.Windows.Controls.InkPresenter.
        
            visual: The visual of a System.Windows.Input.StylusPlugIns.DynamicRenderer.
            drawingAttributes: The System.Windows.Ink.DrawingAttributes that specifies the appearance of the dynamically rendered ink.
        """
        pass
    ...
    def DetachVisuals(self, visual):
        ...
        DetachVisuals(self: InkPresenter, visual: Visual)
            Detaches the visual of the System.Windows.Input.StylusPlugIns.DynamicRenderer from the System.Windows.Controls.InkPresenter.
    ...
    def GetLayoutClip(self, *args): #cannot find CLR method
        ...
        GetLayoutClip(self: InkPresenter, layoutSlotSize: Size) -> Geometry
            ...
            Returns: A System.Windows.Media.Geometry that represents the area that is clipped when System.Windows.UIElement.ClipToBounds is true.
        """
        pass
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: InkPresenter) -> AutomationPeer
            ...
            Provides an appropriate System.Windows.Automation.Peers.InkPresenterAutomationPeer implementation for this control, as part of the WPF infrastructure.
        """
        pass
