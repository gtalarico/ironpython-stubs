class GeneralTransformGroup(GeneralTransform,ISealable,IAnimatable,IResource,IFormattable):
 ...
 def Clone(self):
  ...
  Clone(self: GeneralTransformGroup) -> GeneralTransformGroup
   ...
   Creates a modifiable clone of this System.Windows.Media.GeneralTransformGroup,
 ...
 def TransformBounds(self,rect):
  ...
  TransformBounds(self: GeneralTransformGroup,rect: Rect) -> Rect
   ...
   Transforms the specified bounding box to the smallest axis-aligned bounding box 
    possible that contains all the points in the original bounding box.
  
  
   rect: The bounding box to transform.
   Returns: The transformed bounding box,which is the smallest axis-aligned bounding box 
    possible that contains all the points in the original bounding box.
  """
  pass
