class StatusStrip:
 ...
 def CreateDefaultItem(self,*args):
  ...
  CreateDefaultItem(self: StatusStrip,text: str,image: Image,onClick: EventHandler) -> ToolStripItem
   ...
   Creates a default System.Windows.Forms.ToolStripStatusLabel with the specified text,
    image,and event handler on a new System.Windows.Forms.StatusStrip instance.
  
  
   text: The text to use for the System.Windows.Forms.ToolStripStatusLabel. If the text parameter 
   ...
   Returns: A 
    System.Windows.Forms.ToolStripStatusLabel.#ctor(System.String,System.Drawing.Image,System.
    EventHandler),or a System.Windows.Forms.ToolStripSeparator if the text parameter is a 
    hyphen (-).
  """
  pass
 ...
 def Dispose(self):
  ...
  Dispose(self: StatusStrip,disposing: bool)
   Releases the unmanaged resources used by the System.Windows.Forms.StatusStrip and 
