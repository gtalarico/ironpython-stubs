class ItemsPresenter(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient):
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: ItemsPresenter, constraint: Size) -> Size
            ...
            Overrides the base class implementation of System.Windows.FrameworkElement.MeasureOverride(System.Windows.Size) to measure the size of the System.Windows.Controls.ItemsPresenter object and return proper 
