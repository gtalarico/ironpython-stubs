...
# Error generating skeleton for function SetEnumValue: Method must be called on a Type for which Type.IsGenericParameter is false.
...
class CurveList(RhinoList[Curve]):
    """
    CurveList()
...
class Point3dList(RhinoList[Point3d]):
    """
    Point3dList()
