class ListView(ListBox, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, IGeneratorHost, IContainItemStorage):
    ...
    def ClearContainerForItemOverride(self, *args): #cannot find CLR method
        ...
        ClearContainerForItemOverride(self: ListView, element: DependencyObject, item: object)
            Removes all templates, styles, and bindings for the object that is displayed as a System.Windows.Controls.ListViewItem.
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: ListView) -> AutomationPeer
            ...
            Defines an System.Windows.Automation.Peers.AutomationPeer for the System.Windows.Controls.ListView control.
            Returns: Returns a System.Windows.Automation.Peers.ListViewAutomationPeer object for the System.Windows.Controls.ListView control.
        """
        pass
    ...
    def OnSelectionChanged(self, *args): #cannot find CLR method
        ...
        OnSelectionChanged(self: ListBox, e: SelectionChangedEventArgs)
            Responds to a list box selection change by raising a System.Windows.Controls.Primitives.Selector.SelectionChanged event.
    ...
    def SetSelectedItems(self, *args): #cannot find CLR method
        """
    ...
    AnchorItem = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
