class TextEffectCollection(Animatable,ISealable,IAnimatable,IResource,IList,ICollection,IEnumerable,IList[TextEffect],ICollection[TextEffect],IEnumerable[TextEffect]):
 ...
 def Clone(self):
  ...
  Clone(self: TextEffectCollection) -> TextEffectCollection
   ...
   Creates a modifiable clone of this System.Windows.Media.TextEffectCollection,
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: TextEffectCollection,array: Array[TextEffect],index: int)
   Copies the entire System.Windows.Media.TextEffectCollection to a 
    one-dimensional array of type System.Windows.Media.TextEffect,starting at the 
 ...
 def IndexOf(self,value):
  ...
  IndexOf(self: TextEffectCollection,value: TextEffect) -> int
   ...
   Searches for the specified System.Windows.Media.TextEffect and returns the 
 ...
 def Insert(self,index,value):
  ...
  Insert(self: TextEffectCollection,index: int,value: TextEffect)
   Inserts a System.Windows.Media.TextEffect into a specific location in the 
    collection.
  
  
   index: The zero-based index at which the value System.Windows.Media.TextEffect be 
    inserted.
 ...
 def Remove(self,value):
  ...
  Remove(self: TextEffectCollection,value: TextEffect) -> bool
   ...
   Removes the specified System.Windows.Media.TextEffect object from the 
    collection.
 ...
 def RemoveAt(self,index):
  ...
  RemoveAt(self: TextEffectCollection,index: int)
   Removes the System.Windows.Media.TextEffect at the specified index in the 
    collection.
