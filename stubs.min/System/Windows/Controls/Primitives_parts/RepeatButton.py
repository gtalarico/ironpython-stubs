class RepeatButton(ButtonBase, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild, ICommandSource):
    ...
    def OnClick(self, *args): #cannot find CLR method
        ...
        OnClick(self: RepeatButton)
            Raises an automation event and calls the base method to raise the System.Windows.Controls.Primitives.ButtonBase.Click event.
        """
        pass
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: RepeatButton) -> AutomationPeer
            ...
            Provides an appropriate System.Windows.Automation.Peers.RepeatButtonAutomationPeer implementation for this control, as part of the WPF infrastructure.
