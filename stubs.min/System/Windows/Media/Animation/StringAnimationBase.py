class StringAnimationBase(AnimationTimeline, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: StringAnimationBase) -> StringAnimationBase
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.StringAnimationBase, making deep copies of this object's values. When copying dependency properties, this method copies resource references 
