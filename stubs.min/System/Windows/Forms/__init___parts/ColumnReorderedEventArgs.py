...
"""
    ...
    NewDisplayIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    OldDisplayIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
