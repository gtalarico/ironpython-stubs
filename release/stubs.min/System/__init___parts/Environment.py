class Environment:
 ...
 def ExpandEnvironmentVariables(name):
  ...
  ExpandEnvironmentVariables(name: str) -> str
   ...
   name: A string containing the names of zero or more environment variables. Each environment 
 ...
 def FailFast(message,exception=None):
  ...
  FailFast(message: str)
   Immediately terminates a process after writing a message to the Windows Application event 
    log,and then includes the message in error reporting to Microsoft.
  
  
   message: A message that explains why the process was terminated,or null if no explanation is 
    provided.
  
  FailFast(message: str,exception: Exception)
   Immediately terminates a process after writing a message to the Windows Application event 
    log,and then includes the message and exception information in error reporting to 
    Microsoft.
 ...
 def GetCommandLineArgs():
  ...
  GetCommandLineArgs() -> Array[str]
   ...
   Returns: An array of string where each element contains a command-line argument. The first element 
    is the executable file name,and the following zero or more elements contain the 
 ...
 def GetEnvironmentVariable(variable,target=None):
  ...
  GetEnvironmentVariable(variable: str) -> str
   ...
   Returns: The value of the environment variable specified by variable,or null if the environment 
  ...
  GetEnvironmentVariable(variable: str,target: EnvironmentVariableTarget) -> str
   ...
   Returns: The value of the environment variable specified by the variable and target parameters,or 
 ...
 def GetEnvironmentVariables(target=None):
  ...
  GetEnvironmentVariables() -> IDictionary
   ...
   Returns: A dictionary that contains all environment variable names and their values; otherwise,an 
    empty dictionary if no environment variables are found.
  ...
  GetEnvironmentVariables(target: EnvironmentVariableTarget) -> IDictionary
   ...
   target: One of the System.EnvironmentVariableTarget values.
   Returns: A dictionary that contains all environment variable names and their values from the 
    source specified by the target parameter; otherwise,an empty dictionary if no 
 ...
 def GetLogicalDrives():
  ...
  GetLogicalDrives() -> Array[str]
   ...
   Returns: An array of strings where each element contains the name of a logical drive. For example,
    if the computer's hard drive is the first logical drive,the first element returned is 
    "C:\".
  """
  pass
 @staticmethod
 def SetEnvironmentVariable(variable,value,target=None):
  ...
  """
  pass
 CommandLine='ipy  -m ironstubs make --all --overwrite'
