class QuaternionAnimationUsingKeyFrames(QuaternionAnimationBase, ISealable, IAnimatable, IResource, IKeyFrameAnimation, IAddChild):
    ...
    def AddChild(self, *args): #cannot find CLR method
        ...
        AddChild(self: QuaternionAnimationUsingKeyFrames, child: object)
            Adds a child System.Windows.Media.Animation.QuaternionKeyFrame to this System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames.
        
            child: The object to be added as the child of this System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames.
        """
        pass
    ...
    def AddText(self, *args): #cannot find CLR method
        ...
        AddText(self: QuaternionAnimationUsingKeyFrames, childText: str)
            Adds a text string as a child of this System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames.
    ...
    def Clone(self):
        ...
        Clone(self: QuaternionAnimationUsingKeyFrames) -> QuaternionAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames, making deep copies of this object's values. When copying dependency properties, this method copies 
    ...
    def CloneCore(self, *args): #cannot find CLR method
        ...
        CloneCore(self: QuaternionAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a deep copy of the specified System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames. When copying dependency properties, this method copies resource references and data 
    ...
    def CloneCurrentValue(self):
        ...
        CloneCurrentValue(self: QuaternionAnimationUsingKeyFrames) -> QuaternionAnimationUsingKeyFrames
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames object, making deep copies of this object's current values. Resource references, data bindings, and 
    ...
    def CloneCurrentValueCore(self, *args): #cannot find CLR method
        ...
        CloneCurrentValueCore(self: QuaternionAnimationUsingKeyFrames, sourceFreezable: Freezable)
            Makes this instance a clone of the specified System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames object.
    ...
    def FreezeCore(self, *args): #cannot find CLR method
        ...
        FreezeCore(self: QuaternionAnimationUsingKeyFrames, isChecking: bool) -> bool
            ...
            Makes this instance of System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames object unmodifiable or determines whether it can be made unmodifiable.
    ...
    def GetCurrentValueAsFrozenCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueAsFrozenCore(self: QuaternionAnimationUsingKeyFrames, source: Freezable)
            Makes this instance a frozen clone of the specified System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames. Resource references, data bindings, and animations are not copied, but their current 
             values are.
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: QuaternionAnimationUsingKeyFrames, defaultOriginValue: Quaternion, defaultDestinationValue: Quaternion, animationClock: AnimationClock) -> Quaternion
            ...
            Calculates a value that represents the current value of the property being animated, as determined by this instance of System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames.
    ...
    def OnChanged(self, *args): #cannot find CLR method
        ...
        OnChanged(self: QuaternionAnimationUsingKeyFrames)
            Called when the current System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames object is modified.
        """
        pass
    ...
    def ShouldSerializeKeyFrames(self):
        ...
        ShouldSerializeKeyFrames(self: QuaternionAnimationUsingKeyFrames) -> bool
            ...
            Returns true if the value of the System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames.KeyFrames property of this instance of System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames 
