class GetPageRootCompletedEventHandler(MulticastDelegate,ICloneable,ISerializable):
 """
 Represents the method that will handle the System.Windows.Documents.PageContent.GetPageRootCompleted  event of the System.Windows.Documents.PageContent  class.
 
 GetPageRootCompletedEventHandler(object: object,method: IntPtr)
 """
 def BeginInvoke(self,sender,e,callback,object):
  """ BeginInvoke(self: GetPageRootCompletedEventHandler,sender: object,e: GetPageRootCompletedEventArgs,callback: AsyncCallback,object: object) -> IAsyncResult """
  pass
 ...
 def EndInvoke(self,result):
  """ EndInvoke(self: GetPageRootCompletedEventHandler,result: IAsyncResult) """
  pass
 ...
 def Invoke(self,sender,e):
  """ Invoke(self: GetPageRootCompletedEventHandler,sender: object,e: GetPageRootCompletedEventArgs) """
  pass
