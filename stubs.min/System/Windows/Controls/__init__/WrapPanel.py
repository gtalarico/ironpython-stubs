class WrapPanel(Panel, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IAddChild):
    ...
    def ArrangeOverride(self, *args): #cannot find CLR method
        ...
        ArrangeOverride(self: WrapPanel, finalSize: Size) -> Size
            ...
            Returns: The System.Windows.Size that represents the arranged size of this System.Windows.Controls.WrapPanel element and its children.
        """
        pass
...
"""
    ...
    ItemWidth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
