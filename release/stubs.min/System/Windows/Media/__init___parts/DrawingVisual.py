class DrawingVisual(ContainerVisual,IResource):
 ...
 def HitTestCore(self,*args):
  ...
  HitTestCore(self: DrawingVisual,hitTestParameters: GeometryHitTestParameters) -> GeometryHitTestResult
   ...
   hitTestParameters: A value of type System.Windows.Media.GeometryHitTestParameters that specifies 
    the System.Windows.Media.Geometry to hit test against.
  ...
  HitTestCore(self: DrawingVisual,hitTestParameters: PointHitTestParameters) -> HitTestResult
   ...
   Determines whether a point coordinate value is within the bounds of the 
    System.Windows.Media.DrawingVisual object.
  
  
   hitTestParameters: A value of type System.Windows.Media.PointHitTestParameters that specifies the 
    System.Windows.Point to hit test against.
  
   Returns: A value of type System.Windows.Media.HitTestResult,representing the 
    System.Windows.Media.Visual returned from a hit test.
  """
  pass
 ...
 def RenderOpen(self):
  ...
  RenderOpen(self: DrawingVisual) -> DrawingContext
   ...
   Opens the System.Windows.Media.DrawingVisual object for rendering. The returned 
    System.Windows.Media.DrawingContext value can be used to render into the 
 ...
 def __init__(self,*args):
  ...
  pass
 Drawing=property(lambda self: object(),lambda self,v: None,lambda self: None)
