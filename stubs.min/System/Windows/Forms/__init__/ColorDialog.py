class ColorDialog(CommonDialog, IComponent, IDisposable):
    ...
    AllowFullOpen = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AnyColor = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CustomColors = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    FullOpen = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SolidColorOnly = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
