class TrackBar:
 ...
 def BeginInit(self):
  ...
  BeginInit(self: TrackBar)
   Begins the initialization of a System.Windows.Forms.TrackBar that is used on a form or 
 ...
 def EndInit(self):
  ...
  EndInit(self: TrackBar)
   Ends the initialization of a System.Windows.Forms.TrackBar that is used on a form or used 
 ...
 def OnBackColorChanged(self,*args):
  ...
  OnBackColorChanged(self: TrackBar,e: EventArgs)
   This method is called by the control when any property changes. Inheriting controls can 
    override this method to get property change notification on basic properties. Inheriting 
    controls must call base.propertyChanged.
