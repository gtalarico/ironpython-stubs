class WebBrowserBase(Control, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent):
    ...
    def CreateWebBrowserSiteBase(self, *args): #cannot find CLR method
        ...
        CreateWebBrowserSiteBase(self: WebBrowserBase) -> WebBrowserSiteBase
            ...
            Returns: A System.Windows.Forms.WebBrowserSiteBase that represents the site of the underlying ActiveX control.
        """
        pass
    ...
    ActiveXInstance = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
