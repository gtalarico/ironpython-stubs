class Hyperlink(Span,IInputElement,IAnimatable,IFrameworkInputElement,ISupportInitialize,IQueryAmbient,IAddChild,ICommandSource,IUriContext):
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: Hyperlink) -> AutomationPeer
   ...
   Creates and returns an System.Windows.Automation.Peers.AutomationPeer object 
    for this System.Windows.Documents.Hyperlink.
 ...
 def OnMouseLeftButtonDown(self,*args):
  ...
  OnMouseLeftButtonDown(self: Hyperlink,e: MouseButtonEventArgs)
   ...
   e: Arguments associated with the System.Windows.ContentElement.MouseLeftButtonDown 
    event.
  """
  pass
 def OnMouseLeftButtonUp(self,*args):
  ...
  OnMouseLeftButtonUp(self: Hyperlink,e: MouseButtonEventArgs)
   ...
   e: Arguments associated with the System.Windows.ContentElement.MouseLeftButtonUp 
    event.
  """
  pass
...
"""
 ...
 NavigateUri=property(lambda self: object(),lambda self,v: None,lambda self: None)
