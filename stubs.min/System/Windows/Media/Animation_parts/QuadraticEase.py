class QuadraticEase(EasingFunctionBase,ISealable,IEasingFunction):
 ...
 def EaseInCore(self,*args):
  ...
  EaseInCore(self: QuadraticEase,normalizedTime: float) -> float
   ...
   Provides the logic portion of the easing function that you can override to 
    produce the System.Windows.Media.Animation.EasingMode.EaseIn mode of the custom 
    easing function.
