class RepeatBehavior(object, IFormattable):
    ...
    def Equals(self, *__args):
        ...
        Equals(repeatBehavior1: RepeatBehavior, repeatBehavior2: RepeatBehavior) -> bool
            ...
            Indicates whether the two specified System.Windows.Media.Animation.RepeatBehavior structures are equal.
        
            repeatBehavior1: The first value to compare.
            repeatBehavior2: The second value to compare.
            Returns: true if both the type and repeat behavior of repeatBehavior1 are equal to that of repeatBehavior2; otherwise, false.
        Equals(self: RepeatBehavior, repeatBehavior: RepeatBehavior) -> bool
        
            Returns a value that indicates whether this instance is equal to the specified System.Windows.Media.Animation.RepeatBehavior.
        
            repeatBehavior: The value to compare to this instance.
            Returns: true if both the type and repeat behavior of repeatBehavior are equal to this instance; otherwise, false.
        Equals(self: RepeatBehavior, value: object) -> bool
        
            Indicates whether this instance is equal to the specified object.
        
            value: The object to compare with this instance.
            Returns: true if value is a System.Windows.Media.Animation.RepeatBehavior that represents the same repeat behavior as this instance; otherwise, false.
        """
        pass
    ...
    def ToString(self, formatProvider=None):
        ...
        ToString(self: RepeatBehavior, formatProvider: IFormatProvider) -> str
            ...
            Returns a string representation of this System.Windows.Media.Animation.RepeatBehavior instance with the specified format.
...
"""
    ...
    HasCount = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    HasDuration = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
