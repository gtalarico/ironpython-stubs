class GlyphRun(object,IResource,ISupportInitialize):
 ...
 def BuildGeometry(self):
  ...
  BuildGeometry(self: GlyphRun) -> Geometry
   ...
   Retrieves the System.Windows.Media.Geometry for the 
    System.Windows.Media.GlyphRun.
  
   Returns: The System.Windows.Media.Geometry corresponding to the 
    System.Windows.Media.GlyphRun.
  """
  pass
 def ComputeAlignmentBox(self):
  ...
  ComputeAlignmentBox(self: GlyphRun) -> Rect
   ...
   Returns: A System.Windows.Rect that represents the alignment box for the 
    System.Windows.Media.GlyphRun.
  """
  pass
 def ComputeInkBoundingBox(self):
  ...
  ComputeInkBoundingBox(self: GlyphRun) -> Rect
   ...
   Returns: A System.Windows.Rect that represents the ink bounding box the 
    System.Windows.Media.GlyphRun.
  """
  pass
 def GetCaretCharacterHitFromDistance(self,distance,isInside):
  ...
  GetCaretCharacterHitFromDistance(self: GlyphRun,distance: float) -> (CharacterHit,bool)
   ...
   Retrieves the System.Windows.Media.TextFormatting.CharacterHit value that 
    represents the character hit of the caret of the System.Windows.Media.GlyphRun.
  
  
   distance: Offset to use for computing the caret character hit.
   Returns: A System.Windows.Media.TextFormatting.CharacterHit value that represents the 
    character hit that is closest to the distance value. The out parameter isInside 
    returns true if the character hit is inside the System.Windows.Media.GlyphRun; 
    otherwise,false.
  """
  pass
 def GetDistanceFromCaretCharacterHit(self,characterHit):
  ...
  GetDistanceFromCaretCharacterHit(self: GlyphRun,characterHit: CharacterHit) -> float
   ...
   Retrieves the offset from the leading edge of the System.Windows.Media.GlyphRun 
    to the leading or trailing edge of a caret stop containing the specified 
    character hit.
  
  
   characterHit: The System.Windows.Media.TextFormatting.CharacterHit to use for computing the 
    offset.
  
   Returns: A System.Double that represents the offset from the leading edge of the 
    System.Windows.Media.GlyphRun to the leading or trailing edge of a caret stop 
 ...
 def GetNextCaretCharacterHit(self,characterHit):
  ...
  GetNextCaretCharacterHit(self: GlyphRun,characterHit: CharacterHit) -> CharacterHit
   ...
   Returns: A System.Windows.Media.TextFormatting.CharacterHit that represents the next 
    valid caret character hit in the logical direction. If the return value is 
    equal to characterHit,no further navigation is possible in the 
    System.Windows.Media.GlyphRun.
  """
  pass
 def GetPreviousCaretCharacterHit(self,characterHit):
  ...
  GetPreviousCaretCharacterHit(self: GlyphRun,characterHit: CharacterHit) -> CharacterHit
   ...
   Retrieves the previous valid caret character hit in the logical direction in 
    the System.Windows.Media.GlyphRun.
  
  
   characterHit: The System.Windows.Media.TextFormatting.CharacterHit to use for computing the 
    previous hit value.
  
   Returns: A System.Windows.Media.TextFormatting.CharacterHit that represents the previous 
    valid caret character hit in the logical direction. If the return value is 
    equal to characterHit,no further navigation is possible in the 
    System.Windows.Media.GlyphRun.
  """
...
"""
 ...
 BaselineOrigin=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 Characters=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ClusterMap=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 GlyphIndices=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 GlyphOffsets=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 GlyphTypeface=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 IsHitTestable=property(lambda self: object(),lambda self,v: None,lambda self: None)
