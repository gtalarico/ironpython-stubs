class DoubleAnimationUsingPath(DoubleAnimationBase, ISealable, IAnimatable, IResource):
    ...
    def Clone(self):
        ...
        Clone(self: DoubleAnimationUsingPath) -> DoubleAnimationUsingPath
            ...
            Creates a modifiable clone of this System.Windows.Media.Animation.DoubleAnimationUsingPath, making deep copies of this object's values. When copying dependency properties, this method copies resource 
    ...
    def GetCurrentValueCore(self, *args): #cannot find CLR method
        ...
        GetCurrentValueCore(self: DoubleAnimationUsingPath, defaultOriginValue: float, defaultDestinationValue: float, animationClock: AnimationClock) -> float
            ...
            Calculates a value that represents the current value of the property being animated, as determined by the System.Windows.Media.Animation.DoubleAnimationUsingPath.
