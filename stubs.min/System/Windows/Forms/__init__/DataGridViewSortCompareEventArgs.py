class DataGridViewSortCompareEventArgs(HandledEventArgs):
    ...
    CellValue1 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    CellValue2 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowIndex1 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RowIndex2 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SortResult = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
