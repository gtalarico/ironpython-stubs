class CacheModeConverter(TypeConverter):
 ...
 def CanConvertFrom(self,*__args):
  ...
  CanConvertFrom(self: CacheModeConverter,context: ITypeDescriptorContext,sourceType: Type) -> bool
   ...
   Determines whether this System.Windows.Media.CacheModeConverter can convert an 
    instance of the specified type to a System.Windows.Media.CacheMode,using the 
    specified context.
  
  
   context: An System.ComponentModel.ITypeDescriptorContext that provides a format context.
   sourceType: A System.Type that specifies the type you want to convert from.
   Returns: true if this System.Windows.Media.CacheModeConverter can perform the 
 ...
 def CanConvertTo(self,*__args):
  ...
  CanConvertTo(self: CacheModeConverter,context: ITypeDescriptorContext,destinationType: Type) -> bool
   ...
   Determines whether this System.Windows.Media.CacheModeConverter can convert a 
    System.Windows.Media.CacheMode to an instance of a specified type,using the 
    specified context.
 ...
 def ConvertFrom(self,*__args):
  ...
  ConvertFrom(self: CacheModeConverter,context: ITypeDescriptorContext,culture: CultureInfo,value: object) -> object
   ...
   Returns: The System.Windows.Media.CacheMode that is created by converting value; 
