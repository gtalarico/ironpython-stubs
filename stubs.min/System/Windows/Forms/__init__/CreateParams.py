...
"""
    ...
    ClassStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ExStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
