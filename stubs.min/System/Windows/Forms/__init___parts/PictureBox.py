class PictureBox(Control, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent, ISupportInitialize):
    ...
    def Load(self, url=None):
        ...
        Load(self: PictureBox, url: str)
            Sets the System.Windows.Forms.PictureBox.ImageLocation to the specified URL and displays the image indicated.
        
            url: The path for the image to display in the System.Windows.Forms.PictureBox.
        Load(self: PictureBox)
            Displays the image specified by the System.Windows.Forms.PictureBox.ImageLocation property of the System.Windows.Forms.PictureBox.
        """
        pass
...
"""
    ...
    ErrorImage = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    ImageLocation = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    InitialImage = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    WaitOnLoad = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
