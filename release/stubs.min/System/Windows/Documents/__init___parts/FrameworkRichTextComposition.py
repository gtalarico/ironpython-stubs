class FrameworkRichTextComposition(FrameworkTextComposition):
 ...
 CompositionEnd=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 CompositionStart=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ResultEnd=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ResultStart=property(lambda self: object(),lambda self,v: None,lambda self: None)
