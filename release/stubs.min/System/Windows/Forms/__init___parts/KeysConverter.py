class KeysConverter:
 ...
 def CanConvertFrom(self,*__args):
  ...
  CanConvertFrom(self: KeysConverter,context: ITypeDescriptorContext,sourceType: Type) -> bool
   ...
   Returns a value indicating whether this converter can convert an object in the specified 
    source type to the native type of the converter using the specified context.
  
  
   context: An System.ComponentModel.ITypeDescriptorContext that provides a format context,which can 
    be used to extract additional information about the environment this converter is being 
 ...
 def Compare(self,a,b):
  ...
  Compare(self: KeysConverter,a: object,b: object) -> int
   ...
   Returns: An integer indicating the relationship between the two parameters.Value Type Condition A 
    negative integer. a is less than b. zero a equals b. A positive integer. a is greater 
    than b.
  """
  pass
 ...
 def GetStandardValues(self,context=None):
  ...
  GetStandardValues(self: KeysConverter,context: ITypeDescriptorContext) -> StandardValuesCollection
   ...
   Returns a collection of standard values for the data type that this type converter is 
   ...
   Returns: A System.ComponentModel.TypeConverter.StandardValuesCollection that holds a standard set 
    of valid values,which can be empty if the data type does not support a standard set of 
    values.
  """
  pass
 def GetStandardValuesExclusive(self,context=None):
  ...
  GetStandardValuesExclusive(self: KeysConverter,context: ITypeDescriptorContext) -> bool
   ...
   Determines if the list of standard values returned from GetStandardValues is an exclusive 
    list using the specified System.ComponentModel.ITypeDescriptorContext.
  
  
   context: A formatter context. This object can be used to extract additional information about the 
    environment this converter is being invoked from. This may be null,so you should always 
    check. Also,properties on the context object may also return null.
  
   Returns: true if the collection returned from 
    erload:System.Windows.Forms.KeysConverter.GetStandardValues is an exhaustive list of 
    possible values; otherwise,false if other values are possible. The default 
    implementation for this method always returns false.
  """
  pass
