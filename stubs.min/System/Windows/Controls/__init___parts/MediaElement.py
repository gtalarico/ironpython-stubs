class MediaElement(FrameworkElement, IResource, IAnimatable, IInputElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient, IUriContext):
    ...
    def MeasureOverride(self, *args): #cannot find CLR method
        ...
        MeasureOverride(self: MediaElement, availableSize: Size) -> Size
            ...
            Updates the System.Windows.UIElement.DesiredSize of the System.Windows.Controls.MediaElement. This method is called by a parent System.Windows.UIElement. This is the first pass of layout.
    ...
    def OnCreateAutomationPeer(self, *args): #cannot find CLR method
        ...
        OnCreateAutomationPeer(self: MediaElement) -> AutomationPeer
            ...
            Creates and returns an System.Windows.Automation.Peers.AutomationPeer object for this System.Windows.Controls.MediaElement.
    ...
    def OnRender(self, *args): #cannot find CLR method
        ...
        OnRender(self: MediaElement, drawingContext: DrawingContext)
            Draws the content of a System.Windows.Media.DrawingContext object during the render pass of a System.Windows.Controls.MediaElement control.
...
"""
    ...
    LoadedBehavior = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    StretchDirection = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    UnloadedBehavior = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
