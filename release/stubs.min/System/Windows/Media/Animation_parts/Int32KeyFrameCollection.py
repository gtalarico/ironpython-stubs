class Int32KeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: Int32KeyFrameCollection,keyFrame: Int32KeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.Int32KeyFrame to the end of the 
    collection.
  
  
   keyFrame: The System.Windows.Media.Animation.Int32KeyFrame to add to the end of the 
    collection.
 ...
 def Clear(self):
  ...
  Clear(self: Int32KeyFrameCollection)
   Removes all System.Windows.Media.Animation.Int32KeyFrame objects from the 
    collection.
  """
  pass
 def Clone(self):
  ...
  Clone(self: Int32KeyFrameCollection) -> Int32KeyFrameCollection
   ...
   Creates a modifiable clone of this 
    System.Windows.Media.Animation.Int32KeyFrameCollection,making deep copies of 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: Int32KeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a deep copy of the specified 
    System.Windows.Media.Animation.Int32KeyFrameCollection. When copying dependency 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: Int32KeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a modifiable deep copy of the specified 
    System.Windows.Media.Animation.Int32KeyFrameCollection using current property 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: Int32KeyFrameCollection,array: Array[Int32KeyFrame],index: int)
   Copies all of the System.Windows.Media.Animation.Int32KeyFrame objects in a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: Int32KeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.Int32KeyFrameCollection 
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: Int32KeyFrameCollection,sourceFreezable: Freezable)
   Makes this instance a frozen clone of the specified 
    System.Windows.Media.Animation.Int32KeyFrameCollection. Resource references,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: Int32KeyFrameCollection,keyFrame: Int32KeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.Int32KeyFrame and 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: Int32KeyFrameCollection,index: int,keyFrame: Int32KeyFrame)
   Inserts a System.Windows.Media.Animation.Int32KeyFrame into a specific location 
    within the collection.
  
  
   index: The index position at which the System.Windows.Media.Animation.Int32KeyFrame is 
    inserted.
  
   keyFrame: The System.Windows.Media.Animation.Int32KeyFrame object to insert in the 
    collection.
  """
  pass
 ...
 def Remove(self,keyFrame):
  ...
  Remove(self: Int32KeyFrameCollection,keyFrame: Int32KeyFrame)
   Removes a System.Windows.Media.Animation.Int32KeyFrame object from the 
    collection.
  
  
   keyFrame: Identifies the System.Windows.Media.Animation.Int32KeyFrame to remove from the 
    collection.
  """
  pass
 def RemoveAt(self,index):
  ...
  RemoveAt(self: Int32KeyFrameCollection,index: int)
   Removes the System.Windows.Media.Animation.Int32KeyFrame at the specified index 
    position from the collection.
  
  
   index: Index position of the System.Windows.Media.Animation.Int32KeyFrame to be 
    removed.
  """
  pass
