class ImageIndexConverter(Int32Converter):
    ...
    def ConvertTo(self, *__args):
        ...
        ConvertTo(self: ImageIndexConverter, context: ITypeDescriptorContext, culture: CultureInfo, value: object, destinationType: Type) -> object
            ...
            context: An System.ComponentModel.ITypeDescriptorContext that provides a format context, which can be used to extract additional information about the environment this type converter is being invoked from. This 
    ...
    def GetStandardValues(self, context=None):
        ...
        GetStandardValues(self: ImageIndexConverter, context: ITypeDescriptorContext) -> StandardValuesCollection
            ...
            Returns: A System.ComponentModel.TypeConverter.StandardValuesCollection that holds a standard set of valid index values. If no image list is found, this collection will contain a single object with a value of -1.
        """
        pass
    ...
    def GetStandardValuesExclusive(self, context=None):
        ...
        GetStandardValuesExclusive(self: ImageIndexConverter, context: ITypeDescriptorContext) -> bool
            ...
            Determines if the list of standard values returned from the erload:System.Windows.Forms.ImageIndexConverter.GetStandardValues method is an exclusive list.
        
            context: A formatter context.
            Returns: true if the erload:System.Windows.Forms.ImageIndexConverter.GetStandardValues method returns an exclusive list of valid values; otherwise, false. This implementation always returns false.
        """
        pass
    ...
    def GetStandardValuesSupported(self, context=None):
        ...
        GetStandardValuesSupported(self: ImageIndexConverter, context: ITypeDescriptorContext) -> bool
            ...
            Returns: true if the erload:System.Windows.Forms.ImageIndexConverter.GetStandardValues method returns a standard set of values; otherwise, false. Always returns true.
        """
        pass

    IncludeNoneAsStandardValue = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
